...
class AoD:
    ...
    def merge_aod(
        ...
        match method:
            case 'unpack':
                return cls.merge_aod_by_unpack(aod0, aod1)
            case 'update':
                return cls.merge_aod_by_update(aod0, aod1)
            case _:
                return cls.merge_aod_by_assignment(aod0, aod1)

    @staticmethod
    def merge_aod_by_unpack(aod0: TyAoD, aod1: TyAoD) -> TyAoD:
        """
        Merge two array of dictionaries by the unpack method.
        """
    ...
    @staticmethod
    def merge_aod_by_update(aod0: TyAoD, aod1: TyAoD) -> TyAoD:
        """
        Merge two array of dictionaries by the update method.
        """
    ...
    @staticmethod
    def merge_aod_by_assignment(aod0: TyAoD, aod1: TyAoD) -> TyAoD:
        """
        Merge two array of dictionaries by the assignment method.
        """
    ...
    @staticmethod
    def xto_dod_by_key(iter_dic, key: Any) -> TyDoD:
        """
        find first dictionary whose key is equal to value
        """
        dod: TyDoD = {}
    ...
    @staticmethod
    def xto_doa_by_lc_of_keys(iter_dic: TyIoD, key0: Any, key1: Any) -> TyDoA:
    ...
    @staticmethod
    def union_distinct_set(aod1: TnAoD, aod2: TnAoD) -> TnAoD:
        if aod1 is None:
            return aod2
        if aod2 is None:
            return aod1
        _aod = list(set(aod1) | set(aod2))
        return _aod

    @staticmethod
    def union_distinct_cmp(aod1: TnAoD, aod2: TnAoD) -> TnAoD:
        if aod1 is None:
            return aod2
        if aod2 is None:
            return aod1
        _aod = aod1 + [item for item in aod2 if item not in aod1]
        return _aod
