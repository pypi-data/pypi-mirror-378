...
def add_attach_table_parser(add_parser):
    ...
    parser.add_argument(
        ...
        help=("Specify this flag to allow attaching sources even if their schemas are incompatible "
    ...
    parser.add_argument(
        "--source-format", type=str, choices=["parquet", "jsonl", "csv"],
        help="Format of source files. If not specified, it is deduced from file extension.")
