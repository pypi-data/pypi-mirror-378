...
class Evup:
    ...
    def sh_aod_evup_adm(
        ...
        if Cfg.DoSwAdm.use_evex:
            _keys = ['new', 'ch_y']
            _aod = DoAoD.union_distinct_set_by_keys(_doaod_evup_adm, _keys)
            print("=== Begin use_evex ==================")
            print(f"_doaod_evup_adm = {_doaod_evup_adm}")
            print(f"_aod = {_aod}")
            print("=== end use_evex ====================")
        else:
            _aod = DoAoD.union_distinct_set(_doaod_evup_adm)
            print("=== Begin not use_evex ==============")
            print(f"aod_evin = {aod_evin}")
            print(f"pddf_evex = {pddf_evex}")
            print(f"_doaod_evup_adm = {_doaod_evup_adm}")
            print(f"_aod = {_aod}")
            print("=== end not use_evex ====================")
    ...
    def sh_aod_evup_del_use_evex(
        ...
        _aod_evup_del: TnAoD = AoD.union_distinct_set(_aod_evup_del0, _aod_evup_del1)
...
class Evin:
    ...
    def sh_doaod_adm_new(cls, aod_evin: TyAoD) -> TyDoAoD:
        ...
        for _d_evin in aod_evin:
            _d_evup = cls.sh_d_evup_adm(_d_evin)
            DoA.append_key_unique_value(_doaod_evup, 'new', _d_evup)
        return _doaod_evup
    ...
    def join_adm(cls, aod_evin: TnAoD, df_evex: TnPdDf) -> TyDoAoD:
        ...
        for _d_evin in aod_evin:
            ...
            if _df is None:
                ...
                DoA.append_key_unique_value(_doaod_evup, _change_status, _d_evup)
        return _doaod_evup
