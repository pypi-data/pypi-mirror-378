...
def _query_hougarden_info_core(query: str, page: int = 1, page_size: int = 10, sort: int = 0) -> Dict[str, Any]:
    ...
    pg = int(page or parsed.get("page") or 1)
    ps = int(page_size or parsed.get("pageSize") or 10)
    srt = int(sort or parsed.get("sort") or 0)
...
def query_hougarden_info(query: str, page: int = 1, page_size: int = 10, sort: int = 0) -> Dict[str, Any]:
    """
    Agno Tool 包装：转调核心实现。
    """
