...
impl RefServiceImpl {
    ...
    async fn inner_find_local_branches(
        ...
        tracing_span_id!();
        fallback_if_feature_disabled(metadata, "rhgitaly-find-local-branches", true)?;
        find_many::local_branches(&self.config, request).await
    }

    #[instrument(
        name = "find_all_branches",
        skip(self, request, metadata),
        fields(span_id)
    )]
    async fn inner_find_all_branches(
        ...
        tracing_span_id!();
        fallback_if_feature_disabled(metadata, "rhgitaly-find-all-branches", true)?;
        find_many::all_branches(&self.config, request).await
    }

    #[instrument(name = "find_all_tags", skip(self, request, metadata), fields(span_id))]
    async fn inner_find_all_tags(
        ...
        tracing_span_id!();
        fallback_if_feature_disabled(metadata, "rhgitaly-find-all-tags", true)?;
    ...
    #[instrument(name = "find_branch", skip(self, request, metadata), fields(span_id))]
    async fn inner_find_branch(
        ...
        tracing_span_id!();
        fallback_if_feature_disabled(metadata, "rhgitaly-find-branch", true)?;
        info!(
            "Processing, request={:?}",
