...
AllExceptionType = Union[
    ...
    Type[Conflict[AuthenticationT, AuthorizationT]],
    Type[UnprocessableEntity[AuthenticationT, AuthorizationT]],
    Type[TooManyRequests[AuthenticationT, AuthorizationT]],
    Type[InternalServerError[AuthenticationT, AuthorizationT]],
    Type[NotImplemented[AuthenticationT, AuthorizationT]],
    Type[BadGateway[AuthenticationT, AuthorizationT]],
    Type[ServiceUnavailable[AuthenticationT, AuthorizationT]],
]
