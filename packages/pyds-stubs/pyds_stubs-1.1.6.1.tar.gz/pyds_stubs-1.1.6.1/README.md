...
![Static Badge](https://img.shields.io/badge/pyds%20Version-1.1.6-blue?style=for-the-badge)
![Python Version from PEP 621 TOML](https://img.shields.io/python/required-version-toml?tomlFilePath=https%3A%2F%2Fraw.githubusercontent.com%2Fnkaaf%2Fpyds-stubs%2Frefs%2Ftags%2F1.1.6.1%2Fpyproject.toml&style=for-the-badge)
...
The stub versions matches the versions of pyds. For example, stub version `1.1.6` fits to pyds
version
`1.1.6`. If any fix has to be applied, the fourth position would be incremented. So the first fix of
`1.1.6` results in `1.1.6.1`.

Please pin your version directly or limit it upper-wise like:

`pyds-stubs>=1.1.6,<1.1.7`
