...
def process_file(
    ...
    Args:
        ...
        ppg_sample_rate: Override PPG sample rate detection with specified value
    ...
    with open(input_path, "rb") as f:
        data = read_data(f, fail_on_errors, sample_rate, ppg_sample_rate, max_ecg_channels, max_ppg_channels)
