...
from typing import Any, Final, TypeAlias, TypeGuard, Union
...
# DefaultType : TypeAlias = _Default

# def is_default(x : Any) -> TypeGuard[DefaultType]:
#     return x is DEFAULT

DEFAULT : EllipsisType = ...
DefaultType : TypeAlias = EllipsisType
