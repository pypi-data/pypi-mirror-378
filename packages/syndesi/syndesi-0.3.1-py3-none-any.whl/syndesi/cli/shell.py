...
class Shell:
    ...
    def __init__(self, on_command : Callable[[str], None], history_file_name: str, commands: list[str] = []):
        ...
        self.kb = KeyBindings()
        self.temporary_prompt : Optional[FormattedText] = None
        self.prompt = self.DEFAULT_PROMPT
        self.reverse_search_mode = [False]
        self.reverse_search_selection = 0
        self.ask_event = asyncio.Event()
        self.ask_callback : Optional[Callable[[str], None]] = None
    ...
    def reverse_search_capture(self, event: prompt_toolkit.key_binding.KeyPressEvent) -> None:
    ...
    def reprompt(self, text : Optional[str] = None) -> None:
