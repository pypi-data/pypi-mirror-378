...
extern "C" int launch(void* __raw_Q, void* __raw_K, void* __raw_V, void* __raw_O, void* __raw_l) {
    ...
    using GQSlab = decltype(static_tree_cast<int64_t>(Layout<Shape<Int<4096>, Int<64>, Int<4>>, Stride<Int<64>, Int<1>, Int<262144>>>{}));
    using GKSlab = decltype(static_tree_cast<int64_t>(Layout<Shape<Int<4096>, Int<64>, Int<4>>, Stride<Int<64>, Int<1>, Int<262144>>>{}));
    using GVSlab = decltype(static_tree_cast<int64_t>(Layout<Shape<Int<64>, Int<4096>, Int<4>>, Stride<Int<1>, Int<64>, Int<262144>>>{}));
    using GOSlab = decltype(static_tree_cast<int64_t>(Layout<Shape<Int<4096>, Int<64>, Int<4>>, Stride<Int<64>, Int<1>, Int<262144>>>{}));
    using GLSlab = decltype(static_tree_cast<int64_t>(Layout<Shape<Int<4096>, Int<4>>, Stride<Int<1>, Int<4096>>>{}));
