        ...
        if ProcedureChecker.is_procedure(node):
            ...
            try:
                book_procedure = BookProcedureFactory.create(
                    node.name, english_signature, python_signature, docstring, override_connection_required=ConnectionRequired.NEVER, is_mutation=self.procedure_is_mutation(node)
                )
