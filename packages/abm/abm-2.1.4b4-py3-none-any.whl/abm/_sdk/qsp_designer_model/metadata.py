...
class QspDesignerModelMetadata:
    ...
    description: str = ""
    documentation: str = ""
    thumbnail: UUID | None = None  # TBD, base64 encoding of compressed image, or ID to some asset
    diagram: UUID | None = None  # TBD as above
    pharmacology_diagram: UUID | None = None  # TBD as above
