		...
		with localcontext() as ctx:
			with Session(ENGINE) as session:
				...
				if weight:
					...
					num=0
					view=[]
					view.append(f"{Fore.Fore.light_steel_blue}Weight : {Fore.sea_green_2}{weight.Weight} {Fore.green_3b}Unit:{Fore.sea_green_2}{weight.WeightUnitName} {Fore.green_3b}HLID: {Fore.sea_green_2}{weight.HLID} {Fore.green_3b}DTOE: {Fore.sea_green_2}{weight.DTOE}{Style.reset}")
					msg=f"{'|'.join(view)}"
					print(std_colorize(msg,num,ct))
				else:
					status+=1
				...
				if heartRate:
					print(f"{Fore.Fore.light_steel_blue}Heart Rate : HowLongAgo({Fore.sea_green_2}{datetime.now()-heartRate.DTOE})")
					num=0
					view=[]
