			...
			with Session(ENGINE) as session:
				...
				if lai:
					...
					for x in lai.__table__.columns:
						if getattr(laii,str(x.name)) not in [None]:
				...
				if sai:
					...
					for x in sai.__table__.columns:
						if getattr(saii,str(x.name)) not in [None]:
				...
				if last_carb:
					...
					for x in last_carb.__table__.columns:
						if getattr(last_carbi,str(x.name)) not in [None]:
				...
				if drug:
					...
					for x in drug.__table__.columns:
						if getattr(drugi,str(x.name)) not in [None]:
