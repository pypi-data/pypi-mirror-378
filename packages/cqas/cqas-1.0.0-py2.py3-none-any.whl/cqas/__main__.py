...
Examples:
  ...
  %(prog)s . -p -f --max-files 500         # Full analysis with recommendations
    ...
    analysis_group.add_argument(
        ...
        "-p",
        action="store_true",
        help="Perform comprehensive project-level analysis",
    )
    analysis_group.add_argument(
        "--max-files",
        "-m",
    ...
    advanced_group.add_argument(
        "--config", help="Configuration file for custom analysis settings"
    )
...
def main() -> int:  # pylint: disable=R0911,R0912
    ...
    try:
        ...
        # Configure reporter
        reporter: CQaSReporter = CQaSReporter(colour=args.colour, top_n=args.top_n)
