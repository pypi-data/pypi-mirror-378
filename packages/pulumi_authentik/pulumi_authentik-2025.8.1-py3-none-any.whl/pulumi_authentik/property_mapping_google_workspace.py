...
class PropertyMappingGoogleWorkspaceArgs:
    def __init__(__self__, *,
                 ...
                 property_mapping_google_workspace_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def property_mapping_google_workspace_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "property_mapping_google_workspace_id")

    @property_mapping_google_workspace_id.setter
    def property_mapping_google_workspace_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/propertyMappingGoogleWorkspace:PropertyMappingGoogleWorkspace")
class PropertyMappingGoogleWorkspace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            expression: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            property_mapping_google_workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PropertyMappingGoogleWorkspace':
        """
    ...
    @property
    @pulumi.getter(name="propertyMappingGoogleWorkspaceId")
    def property_mapping_google_workspace_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "property_mapping_google_workspace_id")
