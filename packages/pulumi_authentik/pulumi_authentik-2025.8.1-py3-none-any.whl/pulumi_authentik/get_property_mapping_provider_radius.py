...
def get_property_mapping_provider_radius(id: Optional[builtins.str] = None,
...
def get_property_mapping_provider_radius_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                ...
                                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPropertyMappingProviderRadiusResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
