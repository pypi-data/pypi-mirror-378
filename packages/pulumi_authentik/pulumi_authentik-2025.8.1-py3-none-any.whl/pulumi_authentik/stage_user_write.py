...
class StageUserWriteArgs:
    def __init__(__self__, *,
                 create_users_as_inactive: Optional[pulumi.Input[builtins.bool]] = None,
                 create_users_group: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 stage_user_write_id: Optional[pulumi.Input[builtins.str]] = None,
                 user_creation_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] create_users_as_inactive: Defaults to `true`.
        :param pulumi.Input[builtins.str] user_creation_mode: Allowed values: - `never_create` - `create_when_required` - `always_create` Defaults to `create_when_required`.
        :param pulumi.Input[builtins.str] user_path_template: Defaults to ``.
        :param pulumi.Input[builtins.str] user_type: Allowed values: - `internal` - `external` - `service_account` Defaults to `external`.
        """
    ...
    def create_users_as_inactive(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `true`.
        """
    ...
    def create_users_as_inactive(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "create_users_as_inactive", value)

    @property
    @pulumi.getter(name="createUsersGroup")
    def create_users_group(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "create_users_group")

    @create_users_group.setter
    def create_users_group(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def stage_user_write_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "stage_user_write_id")

    @stage_user_write_id.setter
    def stage_user_write_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "stage_user_write_id", value)

    @property
    @pulumi.getter(name="userCreationMode")
    def user_creation_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def user_creation_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/stageUserWrite:StageUserWrite")
class StageUserWrite(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_creation_mode: Optional[pulumi.Input[builtins.str]] = None,
            user_path_template: Optional[pulumi.Input[builtins.str]] = None,
            user_type: Optional[pulumi.Input[builtins.str]] = None) -> 'StageUserWrite':
        """
    ...
    @property
    @pulumi.getter(name="createUsersAsInactive")
    def create_users_as_inactive(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `true`.
        """
        return pulumi.get(self, "create_users_as_inactive")
    ...
    @property
    @pulumi.getter(name="createUsersGroup")
    def create_users_group(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "create_users_group")
    ...
    @property
    @pulumi.getter(name="stageUserWriteId")
    def stage_user_write_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "stage_user_write_id")

    @property
    @pulumi.getter(name="userCreationMode")
    def user_creation_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Allowed values: - `never_create` - `create_when_required` - `always_create` Defaults to `create_when_required`.
        """
        return pulumi.get(self, "user_creation_mode")
