...
class PolicyExpiryArgs:
    def __init__(__self__, *,
                 days: pulumi.Input[builtins.float],
                 deny_only: Optional[pulumi.Input[builtins.bool]] = None,
                 execution_logging: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 policy_expiry_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a PolicyExpiry resource.
        :param pulumi.Input[builtins.bool] deny_only: Defaults to `false`.
    ...
    @property
    @pulumi.getter
    def days(self) -> pulumi.Input[builtins.float]:
        return pulumi.get(self, "days")

    @days.setter
    def days(self, value: pulumi.Input[builtins.float]):
        pulumi.set(self, "days", value)

    @property
    @pulumi.getter(name="denyOnly")
    def deny_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `false`.
        """
    ...
    @deny_only.setter
    def deny_only(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def policy_expiry_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "policy_expiry_id")

    @policy_expiry_id.setter
    def policy_expiry_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/policyExpiry:PolicyExpiry")
class PolicyExpiry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            execution_logging: Optional[pulumi.Input[builtins.bool]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            policy_expiry_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PolicyExpiry':
        """
    ...
    @property
    @pulumi.getter
    def days(self) -> pulumi.Output[builtins.float]:
        return pulumi.get(self, "days")

    @property
    @pulumi.getter(name="denyOnly")
    def deny_only(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `false`.
        """
        return pulumi.get(self, "deny_only")
    ...
    @property
    @pulumi.getter(name="policyExpiryId")
    def policy_expiry_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "policy_expiry_id")
