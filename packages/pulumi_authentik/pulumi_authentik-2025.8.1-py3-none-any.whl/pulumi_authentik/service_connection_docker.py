...
class ServiceConnectionDockerArgs:
    def __init__(__self__, *,
                 ...
                 service_connection_docker_id: Optional[pulumi.Input[builtins.str]] = None,
                 tls_authentication: Optional[pulumi.Input[builtins.str]] = None,
                 tls_verification: Optional[pulumi.Input[builtins.str]] = None,
                 url: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ServiceConnectionDocker resource.
        :param pulumi.Input[builtins.bool] local: Defaults to `false`.
        :param pulumi.Input[builtins.str] url: Defaults to `http+unix:///var/run/docker.sock`.
        """
    ...
    def service_connection_docker_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "service_connection_docker_id")

    @service_connection_docker_id.setter
    def service_connection_docker_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def tls_verification(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "tls_verification")

    @tls_verification.setter
    def tls_verification(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/serviceConnectionDocker:ServiceConnectionDocker")
class ServiceConnectionDocker(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tls_authentication: Optional[pulumi.Input[builtins.str]] = None,
            tls_verification: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceConnectionDocker':
        """
    ...
    @property
    @pulumi.getter(name="serviceConnectionDockerId")
    def service_connection_docker_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "service_connection_docker_id")

    @property
    @pulumi.getter(name="tlsAuthentication")
    def tls_authentication(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "tls_authentication")

    @property
    @pulumi.getter(name="tlsVerification")
    def tls_verification(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "tls_verification")
