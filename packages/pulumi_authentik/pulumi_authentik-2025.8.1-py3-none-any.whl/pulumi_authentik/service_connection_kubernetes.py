...
class ServiceConnectionKubernetesArgs:
    def __init__(__self__, *,
                 ...
                 service_connection_kubernetes_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] kubeconfig: JSON format expected. Use `jsonencode()` to pass objects. Defaults to `{}`.
        :param pulumi.Input[builtins.bool] local: Defaults to `false`.
        :param pulumi.Input[builtins.bool] verify_ssl: Defaults to `true`.
        """
    ...
    def service_connection_kubernetes_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "service_connection_kubernetes_id")

    @service_connection_kubernetes_id.setter
    def service_connection_kubernetes_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/serviceConnectionKubernetes:ServiceConnectionKubernetes")
class ServiceConnectionKubernetes(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            service_connection_kubernetes_id: Optional[pulumi.Input[builtins.str]] = None,
            verify_ssl: Optional[pulumi.Input[builtins.bool]] = None) -> 'ServiceConnectionKubernetes':
        """
    ...
    @property
    @pulumi.getter
    def kubeconfig(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        JSON format expected. Use `jsonencode()` to pass objects. Defaults to `{}`.
        """
        return pulumi.get(self, "kubeconfig")
    ...
    @property
    @pulumi.getter(name="serviceConnectionKubernetesId")
    def service_connection_kubernetes_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "service_connection_kubernetes_id")
