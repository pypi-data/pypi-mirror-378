...
class StagePromptFieldArgs:
    def __init__(__self__, *,
                 field_key: pulumi.Input[builtins.str],
                 label: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str],
                 initial_value: Optional[pulumi.Input[builtins.str]] = None,
                 initial_value_expression: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 order: Optional[pulumi.Input[builtins.float]] = None,
                 placeholder: Optional[pulumi.Input[builtins.str]] = None,
                 placeholder_expression: Optional[pulumi.Input[builtins.bool]] = None,
                 required: Optional[pulumi.Input[builtins.bool]] = None,
                 stage_prompt_field_id: Optional[pulumi.Input[builtins.str]] = None,
                 sub_text: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a StagePromptField resource.
        :param pulumi.Input[builtins.str] type: Allowed values: - `text` - `text_area` - `text_read_only` - `text_area_read_only` - `username` - `email` - `password` -
               `number` - `checkbox` - `radio-button-group` - `dropdown` - `date` - `date-time` - `file` - `separator` - `hidden` -
               `static` - `ak-locale`
        :param pulumi.Input[builtins.bool] initial_value_expression: Defaults to `false`.
        :param pulumi.Input[builtins.bool] placeholder_expression: Defaults to `false`.
        :param pulumi.Input[builtins.bool] required: Defaults to `false`.
        :param pulumi.Input[builtins.str] sub_text: Defaults to ``.
        """
    ...
    def field_key(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "field_key")

    @field_key.setter
    def field_key(self, value: pulumi.Input[builtins.str]):
    ...
    def initial_value(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "initial_value")

    @initial_value.setter
    def initial_value(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "initial_value", value)

    @property
    @pulumi.getter(name="initialValueExpression")
    def initial_value_expression(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `false`.
        """
    ...
    def initial_value_expression(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def placeholder(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "placeholder")

    @placeholder.setter
    def placeholder(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "placeholder", value)

    @property
    @pulumi.getter(name="placeholderExpression")
    def placeholder_expression(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `false`.
        """
    ...
    def placeholder_expression(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def stage_prompt_field_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "stage_prompt_field_id")

    @stage_prompt_field_id.setter
    def stage_prompt_field_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "stage_prompt_field_id", value)

    @property
    @pulumi.getter(name="subText")
    def sub_text(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Defaults to ``.
        """
    ...
    @sub_text.setter
    def sub_text(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _StagePromptFieldState:
    def __init__(__self__, *,
                 field_key: Optional[pulumi.Input[builtins.str]] = None,
                 initial_value: Optional[pulumi.Input[builtins.str]] = None,
                 initial_value_expression: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="fieldKey")
    def field_key(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "field_key")

    @field_key.setter
    def field_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "field_key", value)
...
@pulumi.type_token("authentik:index/stagePromptField:StagePromptField")
class StagePromptField(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            stage_prompt_field_id: Optional[pulumi.Input[builtins.str]] = None,
            sub_text: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'StagePromptField':
        """
    ...
    @property
    @pulumi.getter(name="fieldKey")
    def field_key(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "field_key")

    @property
    @pulumi.getter(name="initialValue")
    def initial_value(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "initial_value")

    @property
    @pulumi.getter(name="initialValueExpression")
    def initial_value_expression(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `false`.
        """
        return pulumi.get(self, "initial_value_expression")
    ...
    @property
    @pulumi.getter
    def order(self) -> pulumi.Output[Optional[builtins.float]]:
        return pulumi.get(self, "order")

    @property
    @pulumi.getter
    def placeholder(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "placeholder")

    @property
    @pulumi.getter(name="placeholderExpression")
    def placeholder_expression(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `false`.
        """
        return pulumi.get(self, "placeholder_expression")
    ...
    @property
    @pulumi.getter(name="stagePromptFieldId")
    def stage_prompt_field_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "stage_prompt_field_id")

    @property
    @pulumi.getter(name="subText")
    def sub_text(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defaults to ``.
        """
        return pulumi.get(self, "sub_text")
