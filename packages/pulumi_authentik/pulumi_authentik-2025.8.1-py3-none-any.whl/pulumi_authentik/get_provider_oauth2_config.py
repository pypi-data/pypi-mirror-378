...
class GetProviderOauth2ConfigResult:
    ...
    def provider_id(self) -> Optional[builtins.float]:
        return pulumi.get(self, "provider_id")

    @property
    @pulumi.getter(name="providerInfoUrl")
    def provider_info_url(self) -> builtins.str:
...
def get_provider_oauth2_config(id: Optional[builtins.str] = None,
                               name: Optional[builtins.str] = None,
                               provider_id: Optional[builtins.float] = None,
...
def get_provider_oauth2_config_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                      name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                      provider_id: Optional[pulumi.Input[Optional[builtins.float]]] = None,
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetProviderOauth2ConfigResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
