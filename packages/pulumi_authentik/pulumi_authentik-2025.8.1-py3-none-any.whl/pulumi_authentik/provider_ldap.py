...
class ProviderLdapArgs:
    def __init__(__self__, *,
                 ...
                 bind_flow: pulumi.Input[builtins.str],
                 unbind_flow: pulumi.Input[builtins.str],
                 bind_mode: Optional[pulumi.Input[builtins.str]] = None,
                 certificate: Optional[pulumi.Input[builtins.str]] = None,
                 gid_start_number: Optional[pulumi.Input[builtins.float]] = None,
                 mfa_support: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 provider_ldap_id: Optional[pulumi.Input[builtins.str]] = None,
                 search_mode: Optional[pulumi.Input[builtins.str]] = None,
                 tls_server_name: Optional[pulumi.Input[builtins.str]] = None,
                 uid_start_number: Optional[pulumi.Input[builtins.float]] = None):
        """
        The set of arguments for constructing a ProviderLdap resource.
        :param pulumi.Input[builtins.str] bind_mode: Defaults to `direct`.
        :param pulumi.Input[builtins.float] gid_start_number: Defaults to `4000`.
        :param pulumi.Input[builtins.bool] mfa_support: Defaults to `true`.
        :param pulumi.Input[builtins.str] search_mode: Defaults to `direct`.
        :param pulumi.Input[builtins.float] uid_start_number: Defaults to `2000`.
        """
    ...
    def bind_flow(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "bind_flow")

    @bind_flow.setter
    def bind_flow(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "bind_flow", value)

    @property
    @pulumi.getter(name="unbindFlow")
    def unbind_flow(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "unbind_flow")

    @unbind_flow.setter
    def unbind_flow(self, value: pulumi.Input[builtins.str]):
    ...
    def gid_start_number(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Defaults to `4000`.
        """
    ...
    def gid_start_number(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "gid_start_number", value)

    @property
    @pulumi.getter(name="mfaSupport")
    def mfa_support(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `true`.
        """
    ...
    @mfa_support.setter
    def mfa_support(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def provider_ldap_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "provider_ldap_id")

    @provider_ldap_id.setter
    def provider_ldap_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_ldap_id", value)

    @property
    @pulumi.getter(name="searchMode")
    def search_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Defaults to `direct`.
        """
    ...
    @search_mode.setter
    def search_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def uid_start_number(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Defaults to `2000`.
        """
    ...
    def uid_start_number(self, value: Optional[pulumi.Input[builtins.float]]):
...
class _ProviderLdapState:
    def __init__(__self__, *,
                 ...
                 bind_flow: Optional[pulumi.Input[builtins.str]] = None,
                 bind_mode: Optional[pulumi.Input[builtins.str]] = None,
                 certificate: Optional[pulumi.Input[builtins.str]] = None,
                 gid_start_number: Optional[pulumi.Input[builtins.float]] = None,
                 mfa_support: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 tls_server_name: Optional[pulumi.Input[builtins.str]] = None,
                 uid_start_number: Optional[pulumi.Input[builtins.float]] = None,
                 unbind_flow: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="bindFlow")
    def bind_flow(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "bind_flow")

    @bind_flow.setter
    def bind_flow(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bind_flow", value)
    ...
    @property
    @pulumi.getter(name="unbindFlow")
    def unbind_flow(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "unbind_flow")

    @unbind_flow.setter
    def unbind_flow(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "unbind_flow", value)


@pulumi.type_token("authentik:index/providerLdap:ProviderLdap")
class ProviderLdap(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tls_server_name: Optional[pulumi.Input[builtins.str]] = None,
            uid_start_number: Optional[pulumi.Input[builtins.float]] = None,
            unbind_flow: Optional[pulumi.Input[builtins.str]] = None) -> 'ProviderLdap':
        """
    ...
    @property
    @pulumi.getter(name="bindFlow")
    def bind_flow(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "bind_flow")

    @property
    @pulumi.getter(name="bindMode")
    def bind_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defaults to `direct`.
        """
        return pulumi.get(self, "bind_mode")
    ...
    @property
    @pulumi.getter(name="gidStartNumber")
    def gid_start_number(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Defaults to `4000`.
        """
        return pulumi.get(self, "gid_start_number")
    ...
    @property
    @pulumi.getter(name="mfaSupport")
    def mfa_support(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `true`.
        """
        return pulumi.get(self, "mfa_support")
    ...
    @property
    @pulumi.getter(name="providerLdapId")
    def provider_ldap_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "provider_ldap_id")

    @property
    @pulumi.getter(name="searchMode")
    def search_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defaults to `direct`.
        """
        return pulumi.get(self, "search_mode")
    ...
    @property
    @pulumi.getter(name="uidStartNumber")
    def uid_start_number(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Defaults to `2000`.
        """
        return pulumi.get(self, "uid_start_number")
    ...
    @property
    @pulumi.getter(name="unbindFlow")
    def unbind_flow(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "unbind_flow")
