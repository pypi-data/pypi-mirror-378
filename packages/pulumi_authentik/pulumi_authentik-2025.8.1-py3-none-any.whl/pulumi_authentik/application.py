...
class ApplicationArgs:
    def __init__(__self__, *,
                 ...
                 backchannel_providers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]] = None,
                 group: Optional[pulumi.Input[builtins.str]] = None,
                 meta_description: Optional[pulumi.Input[builtins.str]] = None,
                 meta_icon: Optional[pulumi.Input[builtins.str]] = None,
                 meta_launch_url: Optional[pulumi.Input[builtins.str]] = None,
                 meta_publisher: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 open_in_new_tab: Optional[pulumi.Input[builtins.bool]] = None,
                 policy_engine_mode: Optional[pulumi.Input[builtins.str]] = None,
                 protocol_provider: Optional[pulumi.Input[builtins.float]] = None,
                 uuid: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Application resource.
        :param pulumi.Input[builtins.bool] open_in_new_tab: Defaults to `false`.
    ...
    def backchannel_providers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]]:
        return pulumi.get(self, "backchannel_providers")

    @backchannel_providers.setter
    def backchannel_providers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.float]]]]):
    ...
    def meta_description(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "meta_description")

    @meta_description.setter
    def meta_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "meta_description", value)

    @property
    @pulumi.getter(name="metaIcon")
    def meta_icon(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "meta_icon")

    @meta_icon.setter
    def meta_icon(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "meta_icon", value)

    @property
    @pulumi.getter(name="metaLaunchUrl")
    def meta_launch_url(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "meta_launch_url")

    @meta_launch_url.setter
    def meta_launch_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "meta_launch_url", value)

    @property
    @pulumi.getter(name="metaPublisher")
    def meta_publisher(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "meta_publisher")

    @meta_publisher.setter
    def meta_publisher(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def open_in_new_tab(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `false`.
        """
    ...
    def open_in_new_tab(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def protocol_provider(self) -> Optional[pulumi.Input[builtins.float]]:
        return pulumi.get(self, "protocol_provider")

    @protocol_provider.setter
    def protocol_provider(self, value: Optional[pulumi.Input[builtins.float]]):
...
@pulumi.type_token("authentik:index/application:Application")
class Application(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            protocol_provider: Optional[pulumi.Input[builtins.float]] = None,
            slug: Optional[pulumi.Input[builtins.str]] = None,
            uuid: Optional[pulumi.Input[builtins.str]] = None) -> 'Application':
        """
    ...
    @property
    @pulumi.getter(name="backchannelProviders")
    def backchannel_providers(self) -> pulumi.Output[Optional[Sequence[builtins.float]]]:
        return pulumi.get(self, "backchannel_providers")
    ...
    @property
    @pulumi.getter(name="metaDescription")
    def meta_description(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "meta_description")

    @property
    @pulumi.getter(name="metaIcon")
    def meta_icon(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "meta_icon")

    @property
    @pulumi.getter(name="metaLaunchUrl")
    def meta_launch_url(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "meta_launch_url")

    @property
    @pulumi.getter(name="metaPublisher")
    def meta_publisher(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "meta_publisher")
    ...
    @property
    @pulumi.getter(name="openInNewTab")
    def open_in_new_tab(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `false`.
        """
        return pulumi.get(self, "open_in_new_tab")
    ...
    @property
    @pulumi.getter(name="protocolProvider")
    def protocol_provider(self) -> pulumi.Output[Optional[builtins.float]]:
        return pulumi.get(self, "protocol_provider")
