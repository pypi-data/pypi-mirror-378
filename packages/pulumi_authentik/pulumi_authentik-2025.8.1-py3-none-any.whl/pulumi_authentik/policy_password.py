...
class PolicyPasswordArgs:
    def __init__(__self__, *,
                 ...
                 amount_digits: Optional[pulumi.Input[builtins.float]] = None,
                 amount_lowercase: Optional[pulumi.Input[builtins.float]] = None,
                 amount_symbols: Optional[pulumi.Input[builtins.float]] = None,
                 amount_uppercase: Optional[pulumi.Input[builtins.float]] = None,
                 check_have_i_been_pwned: Optional[pulumi.Input[builtins.bool]] = None,
                 check_static_rules: Optional[pulumi.Input[builtins.bool]] = None,
                 check_zxcvbn: Optional[pulumi.Input[builtins.bool]] = None,
                 execution_logging: Optional[pulumi.Input[builtins.bool]] = None,
                 hibp_allowed_count: Optional[pulumi.Input[builtins.float]] = None,
                 length_min: Optional[pulumi.Input[builtins.float]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 password_field: Optional[pulumi.Input[builtins.str]] = None,
                 policy_password_id: Optional[pulumi.Input[builtins.str]] = None,
                 symbol_charset: Optional[pulumi.Input[builtins.str]] = None,
                 zxcvbn_score_threshold: Optional[pulumi.Input[builtins.float]] = None):
        """
        The set of arguments for constructing a PolicyPassword resource.
        :param pulumi.Input[builtins.bool] check_have_i_been_pwned: Defaults to `false`.
        :param pulumi.Input[builtins.bool] check_static_rules: Defaults to `true`.
        :param pulumi.Input[builtins.bool] check_zxcvbn: Defaults to `false`.
        :param pulumi.Input[builtins.bool] execution_logging: Defaults to `false`.
        :param pulumi.Input[builtins.float] hibp_allowed_count: Defaults to `1`.
        :param pulumi.Input[builtins.str] password_field: Defaults to `password`.
        :param pulumi.Input[builtins.str] symbol_charset: Defaults to `!\\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~`.
        :param pulumi.Input[builtins.float] zxcvbn_score_threshold: Defaults to `2`.
        """
    ...
    def amount_digits(self) -> Optional[pulumi.Input[builtins.float]]:
        return pulumi.get(self, "amount_digits")

    @amount_digits.setter
    def amount_digits(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "amount_digits", value)

    @property
    @pulumi.getter(name="amountLowercase")
    def amount_lowercase(self) -> Optional[pulumi.Input[builtins.float]]:
        return pulumi.get(self, "amount_lowercase")

    @amount_lowercase.setter
    def amount_lowercase(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "amount_lowercase", value)

    @property
    @pulumi.getter(name="amountSymbols")
    def amount_symbols(self) -> Optional[pulumi.Input[builtins.float]]:
        return pulumi.get(self, "amount_symbols")

    @amount_symbols.setter
    def amount_symbols(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "amount_symbols", value)

    @property
    @pulumi.getter(name="amountUppercase")
    def amount_uppercase(self) -> Optional[pulumi.Input[builtins.float]]:
        return pulumi.get(self, "amount_uppercase")

    @amount_uppercase.setter
    def amount_uppercase(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "amount_uppercase", value)

    @property
    @pulumi.getter(name="checkHaveIBeenPwned")
    def check_have_i_been_pwned(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `false`.
        """
    ...
    def check_have_i_been_pwned(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "check_have_i_been_pwned", value)

    @property
    @pulumi.getter(name="checkStaticRules")
    def check_static_rules(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `true`.
        """
    ...
    def check_static_rules(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "check_static_rules", value)

    @property
    @pulumi.getter(name="checkZxcvbn")
    def check_zxcvbn(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `false`.
        """
    ...
    @check_zxcvbn.setter
    def check_zxcvbn(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def hibp_allowed_count(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Defaults to `1`.
        """
    ...
    def hibp_allowed_count(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "hibp_allowed_count", value)

    @property
    @pulumi.getter(name="lengthMin")
    def length_min(self) -> Optional[pulumi.Input[builtins.float]]:
        return pulumi.get(self, "length_min")

    @length_min.setter
    def length_min(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def policy_password_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "policy_password_id")

    @policy_password_id.setter
    def policy_password_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "policy_password_id", value)

    @property
    @pulumi.getter(name="symbolCharset")
    def symbol_charset(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Defaults to `!\\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~`.
        """
    ...
    def symbol_charset(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "symbol_charset", value)

    @property
    @pulumi.getter(name="zxcvbnScoreThreshold")
    def zxcvbn_score_threshold(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Defaults to `2`.
        """
    ...
    def zxcvbn_score_threshold(self, value: Optional[pulumi.Input[builtins.float]]):
...
@pulumi.type_token("authentik:index/policyPassword:PolicyPassword")
class PolicyPassword(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_password_id: Optional[pulumi.Input[builtins.str]] = None,
            symbol_charset: Optional[pulumi.Input[builtins.str]] = None,
            zxcvbn_score_threshold: Optional[pulumi.Input[builtins.float]] = None) -> 'PolicyPassword':
        """
    ...
    @property
    @pulumi.getter(name="amountDigits")
    def amount_digits(self) -> pulumi.Output[Optional[builtins.float]]:
        return pulumi.get(self, "amount_digits")

    @property
    @pulumi.getter(name="amountLowercase")
    def amount_lowercase(self) -> pulumi.Output[Optional[builtins.float]]:
        return pulumi.get(self, "amount_lowercase")

    @property
    @pulumi.getter(name="amountSymbols")
    def amount_symbols(self) -> pulumi.Output[Optional[builtins.float]]:
        return pulumi.get(self, "amount_symbols")

    @property
    @pulumi.getter(name="amountUppercase")
    def amount_uppercase(self) -> pulumi.Output[Optional[builtins.float]]:
        return pulumi.get(self, "amount_uppercase")

    @property
    @pulumi.getter(name="checkHaveIBeenPwned")
    def check_have_i_been_pwned(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `false`.
        """
        return pulumi.get(self, "check_have_i_been_pwned")
    ...
    @property
    @pulumi.getter(name="checkStaticRules")
    def check_static_rules(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `true`.
        """
        return pulumi.get(self, "check_static_rules")
    ...
    @property
    @pulumi.getter(name="checkZxcvbn")
    def check_zxcvbn(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `false`.
        """
        return pulumi.get(self, "check_zxcvbn")
    ...
    @property
    @pulumi.getter(name="hibpAllowedCount")
    def hibp_allowed_count(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Defaults to `1`.
        """
        return pulumi.get(self, "hibp_allowed_count")
    ...
    @property
    @pulumi.getter(name="lengthMin")
    def length_min(self) -> pulumi.Output[Optional[builtins.float]]:
        return pulumi.get(self, "length_min")
    ...
    @property
    @pulumi.getter(name="policyPasswordId")
    def policy_password_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "policy_password_id")

    @property
    @pulumi.getter(name="symbolCharset")
    def symbol_charset(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defaults to `!\\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~`.
        """
        return pulumi.get(self, "symbol_charset")
    ...
    @property
    @pulumi.getter(name="zxcvbnScoreThreshold")
    def zxcvbn_score_threshold(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Defaults to `2`.
        """
        return pulumi.get(self, "zxcvbn_score_threshold")
