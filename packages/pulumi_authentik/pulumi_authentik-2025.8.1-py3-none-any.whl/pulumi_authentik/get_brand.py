...
class GetBrandResult:
    ...
    """
    def __init__(__self__, branding_custom_css=None, branding_default_flow_background=None, branding_favicon=None, branding_logo=None, branding_title=None, client_certificates=None, default=None, default_application=None, domain=None, flow_authentication=None, flow_device_code=None, flow_invalidation=None, flow_recovery=None, flow_unenrollment=None, flow_user_settings=None, id=None, web_certificate=None):
        if branding_custom_css and not isinstance(branding_custom_css, str):
            raise TypeError("Expected argument 'branding_custom_css' to be a str")
        pulumi.set(__self__, "branding_custom_css", branding_custom_css)
        if branding_default_flow_background and not isinstance(branding_default_flow_background, str):
            raise TypeError("Expected argument 'branding_default_flow_background' to be a str")
        ...
        if client_certificates and not isinstance(client_certificates, list):
            raise TypeError("Expected argument 'client_certificates' to be a list")
    ...
    def default_application(self) -> builtins.str:
    ...
    def web_certificate(self) -> builtins.str:
...
class AwaitableGetBrandResult(GetBrandResult):
    ...
    def __await__(self):
        ...
        return GetBrandResult(
            branding_custom_css=self.branding_custom_css,
            branding_default_flow_background=self.branding_default_flow_background,
...
def get_brand(branding_custom_css: Optional[builtins.str] = None,
              branding_default_flow_background: Optional[builtins.str] = None,
              branding_favicon: Optional[builtins.str] = None,
              branding_logo: Optional[builtins.str] = None,
              branding_title: Optional[builtins.str] = None,
              client_certificates: Optional[Sequence[builtins.str]] = None,
              default: Optional[builtins.bool] = None,
              default_application: Optional[builtins.str] = None,
              domain: Optional[builtins.str] = None,
              flow_authentication: Optional[builtins.str] = None,
              flow_device_code: Optional[builtins.str] = None,
              flow_invalidation: Optional[builtins.str] = None,
              flow_recovery: Optional[builtins.str] = None,
              flow_unenrollment: Optional[builtins.str] = None,
              flow_user_settings: Optional[builtins.str] = None,
              id: Optional[builtins.str] = None,
              web_certificate: Optional[builtins.str] = None,
              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBrandResult:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    __args__['brandingCustomCss'] = branding_custom_css
    __args__['brandingDefaultFlowBackground'] = branding_default_flow_background
    __args__['brandingFavicon'] = branding_favicon
    __args__['brandingLogo'] = branding_logo
    __args__['brandingTitle'] = branding_title
    __args__['clientCertificates'] = client_certificates
    ...
    return AwaitableGetBrandResult(
        branding_custom_css=pulumi.get(__ret__, 'branding_custom_css'),
        branding_default_flow_background=pulumi.get(__ret__, 'branding_default_flow_background'),
        ...
        client_certificates=pulumi.get(__ret__, 'client_certificates'),
...
def get_brand_output(branding_custom_css: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     branding_default_flow_background: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     branding_favicon: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     branding_logo: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     branding_title: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     client_certificates: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                     default: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                     default_application: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     flow_authentication: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     flow_device_code: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     flow_invalidation: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     flow_recovery: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     flow_unenrollment: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     flow_user_settings: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     web_certificate: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetBrandResult(
        branding_custom_css=pulumi.get(__response__, 'branding_custom_css'),
        branding_default_flow_background=pulumi.get(__response__, 'branding_default_flow_background'),
        ...
        client_certificates=pulumi.get(__response__, 'client_certificates'),
