...
def get_provider_saml_metadata(id: Optional[builtins.str] = None,
...
def get_provider_saml_metadata_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                      name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                      provider_id: Optional[pulumi.Input[Optional[builtins.float]]] = None,
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetProviderSamlMetadataResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
