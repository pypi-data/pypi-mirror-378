...
class PropertyMappingScimArgs:
    def __init__(__self__, *,
                 ...
                 property_mapping_scim_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def property_mapping_scim_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "property_mapping_scim_id")

    @property_mapping_scim_id.setter
    def property_mapping_scim_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/propertyMappingScim:PropertyMappingScim")
class PropertyMappingScim(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            expression: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            property_mapping_scim_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PropertyMappingScim':
        """
    ...
    @property
    @pulumi.getter(name="propertyMappingScimId")
    def property_mapping_scim_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "property_mapping_scim_id")
