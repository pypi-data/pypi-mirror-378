...
class ProviderRacArgs:
    def __init__(__self__, *,
                 ...
                 connection_expiry: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 property_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 provider_rac_id: Optional[pulumi.Input[builtins.str]] = None,
                 settings: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ProviderRac resource.
        :param pulumi.Input[builtins.str] connection_expiry: Format: hours=1;minutes=2;seconds=3. Defaults to `seconds=0`.
        :param pulumi.Input[builtins.str] settings: JSON format expected. Use `jsonencode()` to pass objects. Defaults to `{}`.
        """
    ...
    def connection_expiry(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connection_expiry(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def provider_rac_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "provider_rac_id")

    @provider_rac_id.setter
    def provider_rac_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/providerRac:ProviderRac")
class ProviderRac(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            property_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            provider_rac_id: Optional[pulumi.Input[builtins.str]] = None,
            settings: Optional[pulumi.Input[builtins.str]] = None) -> 'ProviderRac':
        """
    ...
    @property
    @pulumi.getter(name="connectionExpiry")
    def connection_expiry(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Format: hours=1;minutes=2;seconds=3. Defaults to `seconds=0`.
        """
        return pulumi.get(self, "connection_expiry")
    ...
    @property
    @pulumi.getter(name="providerRacId")
    def provider_rac_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "provider_rac_id")

    @property
    @pulumi.getter
    def settings(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        JSON format expected. Use `jsonencode()` to pass objects. Defaults to `{}`.
        """
        return pulumi.get(self, "settings")
