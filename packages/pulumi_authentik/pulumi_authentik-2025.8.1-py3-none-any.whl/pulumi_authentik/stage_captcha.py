...
class StageCaptchaArgs:
    def __init__(__self__, *,
                 ...
                 error_on_invalid_score: Optional[pulumi.Input[builtins.bool]] = None,
                 interactive: Optional[pulumi.Input[builtins.bool]] = None,
                 js_url: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 score_max_threshold: Optional[pulumi.Input[builtins.float]] = None,
                 score_min_threshold: Optional[pulumi.Input[builtins.float]] = None,
                 stage_captcha_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a StageCaptcha resource.
        :param pulumi.Input[builtins.str] api_url: Defaults to `https://www.recaptcha.net/recaptcha/api/siteverify`.
        :param pulumi.Input[builtins.bool] error_on_invalid_score: Defaults to `true`.
        :param pulumi.Input[builtins.bool] interactive: Defaults to `false`.
        :param pulumi.Input[builtins.str] js_url: Defaults to `https://www.recaptcha.net/recaptcha/api.js`.
        :param pulumi.Input[builtins.float] score_max_threshold: Defaults to `0.5`.
        :param pulumi.Input[builtins.float] score_min_threshold: Defaults to `1`.
        """
    ...
    def error_on_invalid_score(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `true`.
        """
    ...
    def error_on_invalid_score(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def js_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @js_url.setter
    def js_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def score_max_threshold(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Defaults to `0.5`.
        """
    ...
    def score_max_threshold(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "score_max_threshold", value)

    @property
    @pulumi.getter(name="scoreMinThreshold")
    def score_min_threshold(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Defaults to `1`.
        """
    ...
    def score_min_threshold(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "score_min_threshold", value)

    @property
    @pulumi.getter(name="stageCaptchaId")
    def stage_captcha_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "stage_captcha_id")

    @stage_captcha_id.setter
    def stage_captcha_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/stageCaptcha:StageCaptcha")
class StageCaptcha(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            score_max_threshold: Optional[pulumi.Input[builtins.float]] = None,
            score_min_threshold: Optional[pulumi.Input[builtins.float]] = None,
            stage_captcha_id: Optional[pulumi.Input[builtins.str]] = None) -> 'StageCaptcha':
        """
    ...
    @property
    @pulumi.getter(name="errorOnInvalidScore")
    def error_on_invalid_score(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `true`.
        """
        return pulumi.get(self, "error_on_invalid_score")
    ...
    @property
    @pulumi.getter
    def interactive(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `false`.
        """
        return pulumi.get(self, "interactive")
    ...
    @property
    @pulumi.getter(name="jsUrl")
    def js_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defaults to `https://www.recaptcha.net/recaptcha/api.js`.
        """
        return pulumi.get(self, "js_url")
    ...
    @property
    @pulumi.getter(name="scoreMaxThreshold")
    def score_max_threshold(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Defaults to `0.5`.
        """
        return pulumi.get(self, "score_max_threshold")
    ...
    @property
    @pulumi.getter(name="scoreMinThreshold")
    def score_min_threshold(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Defaults to `1`.
        """
        return pulumi.get(self, "score_min_threshold")
    ...
    @property
    @pulumi.getter(name="stageCaptchaId")
    def stage_captcha_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "stage_captcha_id")
