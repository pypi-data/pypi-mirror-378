...
class EnterpriseLicenseArgs:
    def __init__(__self__, *,
                 ...
                 enterprise_license_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def enterprise_license_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "enterprise_license_id")

    @enterprise_license_id.setter
    def enterprise_license_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EnterpriseLicenseState:
    def __init__(__self__, *,
                 enterprise_license_id: Optional[pulumi.Input[builtins.str]] = None,
                 expiry: Optional[pulumi.Input[builtins.float]] = None,
                 external_users: Optional[pulumi.Input[builtins.float]] = None,
                 internal_users: Optional[pulumi.Input[builtins.float]] = None,
                 key: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering EnterpriseLicense resources.
        :param pulumi.Input[builtins.float] expiry: Generated.
        :param pulumi.Input[builtins.float] external_users: Generated.
        :param pulumi.Input[builtins.float] internal_users: Generated.
        :param pulumi.Input[builtins.str] name: Generated.
        """
        if enterprise_license_id is not None:
            pulumi.set(__self__, "enterprise_license_id", enterprise_license_id)
    ...
    @property
    @pulumi.getter
    def expiry(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Generated.
        """
    ...
    @expiry.setter
    def expiry(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "expiry", value)

    @property
    @pulumi.getter(name="externalUsers")
    def external_users(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Generated.
        """
    ...
    def external_users(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "external_users", value)

    @property
    @pulumi.getter(name="internalUsers")
    def internal_users(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Generated.
        """
    ...
    def internal_users(self, value: Optional[pulumi.Input[builtins.float]]):
...
@pulumi.type_token("authentik:index/enterpriseLicense:EnterpriseLicense")
class EnterpriseLicense(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            internal_users: Optional[pulumi.Input[builtins.float]] = None,
            key: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'EnterpriseLicense':
        """
    ...
    @property
    @pulumi.getter(name="enterpriseLicenseId")
    def enterprise_license_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "enterprise_license_id")

    @property
    @pulumi.getter
    def expiry(self) -> pulumi.Output[builtins.float]:
        """
        Generated.
        """
        return pulumi.get(self, "expiry")
    ...
    @property
    @pulumi.getter(name="externalUsers")
    def external_users(self) -> pulumi.Output[builtins.float]:
        """
        Generated.
        """
        return pulumi.get(self, "external_users")
    ...
    @property
    @pulumi.getter(name="internalUsers")
    def internal_users(self) -> pulumi.Output[builtins.float]:
        """
        Generated.
        """
        return pulumi.get(self, "internal_users")
