...
def get_property_mapping_provider_rac(id: Optional[builtins.str] = None,
...
def get_property_mapping_provider_rac_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                             ...
                                             settings: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPropertyMappingProviderRacResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
