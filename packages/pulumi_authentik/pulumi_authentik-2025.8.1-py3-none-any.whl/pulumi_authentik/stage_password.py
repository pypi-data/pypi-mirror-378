...
class StagePasswordArgs:
    def __init__(__self__, *,
                 ...
                 allow_show_password: Optional[pulumi.Input[builtins.bool]] = None,
                 configure_flow: Optional[pulumi.Input[builtins.str]] = None,
                 failed_attempts_before_cancel: Optional[pulumi.Input[builtins.float]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 stage_password_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a StagePassword resource.
        :param pulumi.Input[builtins.bool] allow_show_password: Defaults to `false`.
        :param pulumi.Input[builtins.float] failed_attempts_before_cancel: Defaults to `5`.
        """
    ...
    def allow_show_password(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `false`.
        """
    ...
    def allow_show_password(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def failed_attempts_before_cancel(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Defaults to `5`.
        """
    ...
    def failed_attempts_before_cancel(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def stage_password_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "stage_password_id")

    @stage_password_id.setter
    def stage_password_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/stagePassword:StagePassword")
class StagePassword(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            failed_attempts_before_cancel: Optional[pulumi.Input[builtins.float]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            stage_password_id: Optional[pulumi.Input[builtins.str]] = None) -> 'StagePassword':
        """
    ...
    @property
    @pulumi.getter(name="allowShowPassword")
    def allow_show_password(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `false`.
        """
        return pulumi.get(self, "allow_show_password")
    ...
    @property
    @pulumi.getter(name="failedAttemptsBeforeCancel")
    def failed_attempts_before_cancel(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Defaults to `5`.
        """
        return pulumi.get(self, "failed_attempts_before_cancel")
    ...
    @property
    @pulumi.getter(name="stagePasswordId")
    def stage_password_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "stage_password_id")
