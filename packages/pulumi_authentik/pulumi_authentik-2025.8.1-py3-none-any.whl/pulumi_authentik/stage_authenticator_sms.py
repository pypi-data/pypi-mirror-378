...
class StageAuthenticatorSmsArgs:
    def __init__(__self__, *,
                 ...
                 auth: pulumi.Input[builtins.str],
                 ...
                 stage_authenticator_sms_id: Optional[pulumi.Input[builtins.str]] = None,
                 verify_only: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a StageAuthenticatorSms resource.
        :param pulumi.Input[builtins.str] auth_type: Allowed values: - `basic` - `bearer` Defaults to `basic`.
        :param pulumi.Input[builtins.str] sms_provider: Allowed values: - `twilio` - `generic` Defaults to `twilio`.
        :param pulumi.Input[builtins.bool] verify_only: Defaults to `false`.
        """
    ...
    @property
    @pulumi.getter
    def auth(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "auth")

    @auth.setter
    def auth(self, value: pulumi.Input[builtins.str]):
    ...
    def stage_authenticator_sms_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "stage_authenticator_sms_id")

    @stage_authenticator_sms_id.setter
    def stage_authenticator_sms_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "stage_authenticator_sms_id", value)

    @property
    @pulumi.getter(name="verifyOnly")
    def verify_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `false`.
        """
    ...
    @verify_only.setter
    def verify_only(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _StageAuthenticatorSmsState:
    def __init__(__self__, *,
                 account_sid: Optional[pulumi.Input[builtins.str]] = None,
                 auth: Optional[pulumi.Input[builtins.str]] = None,
                 auth_password: Optional[pulumi.Input[builtins.str]] = None,
                 auth_type: Optional[pulumi.Input[builtins.str]] = None,
                 configure_flow: Optional[pulumi.Input[builtins.str]] = None,
                 friendly_name: Optional[pulumi.Input[builtins.str]] = None,
                 from_number: Optional[pulumi.Input[builtins.str]] = None,
                 mapping: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 sms_provider: Optional[pulumi.Input[builtins.str]] = None,
                 stage_authenticator_sms_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="accountSid")
    def account_sid(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "account_sid")

    @account_sid.setter
    def account_sid(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "account_sid", value)
    ...
    @property
    @pulumi.getter(name="fromNumber")
    def from_number(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "from_number")

    @from_number.setter
    def from_number(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "from_number", value)
...
@pulumi.type_token("authentik:index/stageAuthenticatorSms:StageAuthenticatorSms")
class StageAuthenticatorSms(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sms_provider: Optional[pulumi.Input[builtins.str]] = None,
            stage_authenticator_sms_id: Optional[pulumi.Input[builtins.str]] = None,
            verify_only: Optional[pulumi.Input[builtins.bool]] = None) -> 'StageAuthenticatorSms':
        """
    ...
    @property
    @pulumi.getter(name="accountSid")
    def account_sid(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "account_sid")
    ...
    @property
    @pulumi.getter(name="authPassword")
    def auth_password(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "auth_password")
    ...
    @property
    @pulumi.getter(name="fromNumber")
    def from_number(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "from_number")

    @property
    @pulumi.getter
    def mapping(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "mapping")
    ...
    @property
    @pulumi.getter(name="smsProvider")
    def sms_provider(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Allowed values: - `twilio` - `generic` Defaults to `twilio`.
        """
        return pulumi.get(self, "sms_provider")
    ...
    @property
    @pulumi.getter(name="stageAuthenticatorSmsId")
    def stage_authenticator_sms_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "stage_authenticator_sms_id")

    @property
    @pulumi.getter(name="verifyOnly")
    def verify_only(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `false`.
        """
        return pulumi.get(self, "verify_only")
