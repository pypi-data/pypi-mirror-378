...
class CertificateKeyPairArgs:
    def __init__(__self__, *,
                 ...
                 certificate_key_pair_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def certificate_key_pair_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "certificate_key_pair_id")

    @certificate_key_pair_id.setter
    def certificate_key_pair_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/certificateKeyPair:CertificateKeyPair")
class CertificateKeyPair(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            certificate_key_pair_id: Optional[pulumi.Input[builtins.str]] = None,
            key_data: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'CertificateKeyPair':
        """
    ...
    @property
    @pulumi.getter(name="certificateKeyPairId")
    def certificate_key_pair_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "certificate_key_pair_id")

    @property
    @pulumi.getter(name="keyData")
    def key_data(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "key_data")
