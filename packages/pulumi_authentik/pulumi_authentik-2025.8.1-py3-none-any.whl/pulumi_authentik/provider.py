...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] token: The authentik API token, can optionally be passed as `AUTHENTIK_TOKEN` environmental variable
        :param pulumi.Input[builtins.str] url: The authentik API endpoint, can optionally be passed as `AUTHENTIK_URL` environmental variable
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] headers: Optional HTTP headers sent with every request
        :param pulumi.Input[builtins.bool] insecure: Whether to skip TLS verification, can optionally be passed as `AUTHENTIK_INSECURE` environmental variable
        """
...
@pulumi.type_token("pulumi:providers:authentik")
class Provider(pulumi.ProviderResource):
    ...
    def terraform_config(__self__) -> pulumi.Output['Provider.TerraformConfigResult']:
        ...
        return pulumi.runtime.call('pulumi:providers:authentik/terraformConfig', __args__, res=__self__, typ=Provider.TerraformConfigResult, package_ref=_utilities.get_package())
