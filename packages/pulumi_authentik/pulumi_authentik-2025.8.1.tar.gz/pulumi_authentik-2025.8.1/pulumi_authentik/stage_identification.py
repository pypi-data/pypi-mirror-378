...
class StageIdentificationArgs:
    def __init__(__self__, *,
                 captcha_stage: Optional[pulumi.Input[builtins.str]] = None,
                 case_insensitive_matching: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_remember_me: Optional[pulumi.Input[builtins.bool]] = None,
                 enrollment_flow: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 password_stage: Optional[pulumi.Input[builtins.str]] = None,
                 passwordless_flow: Optional[pulumi.Input[builtins.str]] = None,
                 pretend_user_exists: Optional[pulumi.Input[builtins.bool]] = None,
                 recovery_flow: Optional[pulumi.Input[builtins.str]] = None,
                 show_matched_user: Optional[pulumi.Input[builtins.bool]] = None,
                 show_source_labels: Optional[pulumi.Input[builtins.bool]] = None,
                 sources: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 stage_identification_id: Optional[pulumi.Input[builtins.str]] = None,
                 user_fields: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a StageIdentification resource.
        :param pulumi.Input[builtins.bool] enable_remember_me: Defaults to `false`.
        :param pulumi.Input[builtins.bool] pretend_user_exists: Defaults to `true`.
        :param pulumi.Input[builtins.bool] show_matched_user: Defaults to `true`.
        :param pulumi.Input[builtins.bool] show_source_labels: Defaults to `false`.
        """
        ...
        if enable_remember_me is not None:
            pulumi.set(__self__, "enable_remember_me", enable_remember_me)
    ...
    def captcha_stage(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "captcha_stage")

    @captcha_stage.setter
    def captcha_stage(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "captcha_stage", value)

    @property
    @pulumi.getter(name="caseInsensitiveMatching")
    def case_insensitive_matching(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "case_insensitive_matching")

    @case_insensitive_matching.setter
    def case_insensitive_matching(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "case_insensitive_matching", value)

    @property
    @pulumi.getter(name="enableRememberMe")
    def enable_remember_me(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `false`.
        """
        return pulumi.get(self, "enable_remember_me")

    @enable_remember_me.setter
    def enable_remember_me(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_remember_me", value)
    ...
    def password_stage(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "password_stage")

    @password_stage.setter
    def password_stage(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "password_stage", value)

    @property
    @pulumi.getter(name="passwordlessFlow")
    def passwordless_flow(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "passwordless_flow")

    @passwordless_flow.setter
    def passwordless_flow(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "passwordless_flow", value)

    @property
    @pulumi.getter(name="pretendUserExists")
    def pretend_user_exists(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `true`.
        """
    ...
    def pretend_user_exists(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "pretend_user_exists", value)

    @property
    @pulumi.getter(name="recoveryFlow")
    def recovery_flow(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "recovery_flow")

    @recovery_flow.setter
    def recovery_flow(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "recovery_flow", value)

    @property
    @pulumi.getter(name="showMatchedUser")
    def show_matched_user(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `true`.
        """
    ...
    def show_matched_user(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "show_matched_user", value)

    @property
    @pulumi.getter(name="showSourceLabels")
    def show_source_labels(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `false`.
        """
    ...
    def show_source_labels(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def stage_identification_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "stage_identification_id")

    @stage_identification_id.setter
    def stage_identification_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "stage_identification_id", value)

    @property
    @pulumi.getter(name="userFields")
    def user_fields(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "user_fields")

    @user_fields.setter
    def user_fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("authentik:index/stageIdentification:StageIdentification")
class StageIdentification(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["enable_remember_me"] = enable_remember_me
    ...
    def get(resource_name: str,
            ...
            sources: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            stage_identification_id: Optional[pulumi.Input[builtins.str]] = None,
            user_fields: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'StageIdentification':
        """
    ...
    @property
    @pulumi.getter(name="captchaStage")
    def captcha_stage(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "captcha_stage")

    @property
    @pulumi.getter(name="caseInsensitiveMatching")
    def case_insensitive_matching(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "case_insensitive_matching")

    @property
    @pulumi.getter(name="enableRememberMe")
    def enable_remember_me(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `false`.
        """
        return pulumi.get(self, "enable_remember_me")
    ...
    @property
    @pulumi.getter(name="passwordStage")
    def password_stage(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "password_stage")

    @property
    @pulumi.getter(name="passwordlessFlow")
    def passwordless_flow(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "passwordless_flow")

    @property
    @pulumi.getter(name="pretendUserExists")
    def pretend_user_exists(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `true`.
        """
        return pulumi.get(self, "pretend_user_exists")
    ...
    @property
    @pulumi.getter(name="recoveryFlow")
    def recovery_flow(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "recovery_flow")

    @property
    @pulumi.getter(name="showMatchedUser")
    def show_matched_user(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `true`.
        """
        return pulumi.get(self, "show_matched_user")
    ...
    @property
    @pulumi.getter(name="showSourceLabels")
    def show_source_labels(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `false`.
        """
        return pulumi.get(self, "show_source_labels")
    ...
    @property
    @pulumi.getter(name="stageIdentificationId")
    def stage_identification_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "stage_identification_id")

    @property
    @pulumi.getter(name="userFields")
    def user_fields(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "user_fields")
