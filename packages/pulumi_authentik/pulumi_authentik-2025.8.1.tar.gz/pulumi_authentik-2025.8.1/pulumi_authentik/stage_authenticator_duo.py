...
class StageAuthenticatorDuoArgs:
    def __init__(__self__, *,
                 ...
                 admin_integration_key: Optional[pulumi.Input[builtins.str]] = None,
                 admin_secret_key: Optional[pulumi.Input[builtins.str]] = None,
                 configure_flow: Optional[pulumi.Input[builtins.str]] = None,
                 friendly_name: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 stage_authenticator_duo_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def admin_integration_key(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "admin_integration_key")

    @admin_integration_key.setter
    def admin_integration_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "admin_integration_key", value)

    @property
    @pulumi.getter(name="adminSecretKey")
    def admin_secret_key(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "admin_secret_key")

    @admin_secret_key.setter
    def admin_secret_key(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def stage_authenticator_duo_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "stage_authenticator_duo_id")

    @stage_authenticator_duo_id.setter
    def stage_authenticator_duo_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/stageAuthenticatorDuo:StageAuthenticatorDuo")
class StageAuthenticatorDuo(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            friendly_name: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            stage_authenticator_duo_id: Optional[pulumi.Input[builtins.str]] = None) -> 'StageAuthenticatorDuo':
        """
    ...
    @property
    @pulumi.getter(name="adminIntegrationKey")
    def admin_integration_key(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "admin_integration_key")

    @property
    @pulumi.getter(name="adminSecretKey")
    def admin_secret_key(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "admin_secret_key")
    ...
    @property
    @pulumi.getter(name="stageAuthenticatorDuoId")
    def stage_authenticator_duo_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "stage_authenticator_duo_id")
