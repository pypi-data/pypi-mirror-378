...
class BlueprintArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] context: JSON format expected. Use `jsonencode()` to pass objects. Defaults to `{}`.
...
@pulumi.type_token("authentik:index/blueprint:Blueprint")
class Blueprint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enabled: Optional[pulumi.Input[builtins.bool]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            path: Optional[pulumi.Input[builtins.str]] = None) -> 'Blueprint':
        """
