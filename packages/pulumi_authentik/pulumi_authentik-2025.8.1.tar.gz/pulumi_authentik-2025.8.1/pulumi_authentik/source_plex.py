...
class SourcePlexArgs:
    def __init__(__self__, *,
                 ...
                 plex_token: pulumi.Input[builtins.str],
                 slug: pulumi.Input[builtins.str],
                 allow_friends: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 source_plex_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] allow_friends: Defaults to `true`.
    ...
    def plex_token(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "plex_token")

    @plex_token.setter
    def plex_token(self, value: pulumi.Input[builtins.str]):
    ...
    def allow_friends(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `true`.
        """
    ...
    def allow_friends(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def source_plex_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "source_plex_id")

    @source_plex_id.setter
    def source_plex_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SourcePlexState:
    def __init__(__self__, *,
                 ...
                 group_matching_mode: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 plex_token: Optional[pulumi.Input[builtins.str]] = None,
                 policy_engine_mode: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="plexToken")
    def plex_token(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "plex_token")

    @plex_token.setter
    def plex_token(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "plex_token", value)
...
@pulumi.type_token("authentik:index/sourcePlex:SourcePlex")
class SourcePlex(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_matching_mode: Optional[pulumi.Input[builtins.str]] = None,
            user_path_template: Optional[pulumi.Input[builtins.str]] = None,
            uuid: Optional[pulumi.Input[builtins.str]] = None) -> 'SourcePlex':
        """
    ...
    @property
    @pulumi.getter(name="allowFriends")
    def allow_friends(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `true`.
        """
        return pulumi.get(self, "allow_friends")
    ...
    @property
    @pulumi.getter(name="allowedServers")
    def allowed_servers(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "allowed_servers")
    ...
    @property
    @pulumi.getter(name="plexToken")
    def plex_token(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "plex_token")
    ...
    @property
    @pulumi.getter(name="sourcePlexId")
    def source_plex_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "source_plex_id")
