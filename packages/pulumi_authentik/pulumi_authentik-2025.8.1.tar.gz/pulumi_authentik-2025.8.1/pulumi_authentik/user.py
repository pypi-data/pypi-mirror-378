...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] groups: Generated.
        :param pulumi.Input[builtins.bool] is_active: Defaults to `true`.
        :param pulumi.Input[builtins.str] name: Defaults to ``.
        :param pulumi.Input[builtins.str] password: Optionally set the user's password. Changing the password in authentik will not trigger an update here.
        :param pulumi.Input[builtins.str] path: Defaults to `users`.
        :param pulumi.Input[builtins.str] type: Allowed values: - `internal` - `external` - `service_account` - `internal_service_account` Defaults to `internal`.
        """
...
@pulumi.type_token("authentik:index/user:User")
