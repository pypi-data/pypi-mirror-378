...
class ProviderRadiusArgs:
    def __init__(__self__, *,
                 ...
                 client_networks: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 provider_radius_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ProviderRadius resource.
        :param pulumi.Input[builtins.str] client_networks: Defaults to `0.0.0.0/0, ::/0`.
    ...
    def client_networks(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_networks(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def provider_radius_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "provider_radius_id")

    @provider_radius_id.setter
    def provider_radius_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/providerRadius:ProviderRadius")
class ProviderRadius(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            property_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            provider_radius_id: Optional[pulumi.Input[builtins.str]] = None,
            shared_secret: Optional[pulumi.Input[builtins.str]] = None) -> 'ProviderRadius':
        """
    ...
    @property
    @pulumi.getter(name="clientNetworks")
    def client_networks(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Defaults to `0.0.0.0/0, ::/0`.
        """
        return pulumi.get(self, "client_networks")
    ...
    @property
    @pulumi.getter(name="providerRadiusId")
    def provider_radius_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "provider_radius_id")
