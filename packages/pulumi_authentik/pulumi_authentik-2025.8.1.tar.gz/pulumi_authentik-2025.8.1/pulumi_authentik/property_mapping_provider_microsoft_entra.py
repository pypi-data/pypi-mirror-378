...
class PropertyMappingProviderMicrosoftEntraArgs:
    def __init__(__self__, *,
                 ...
                 property_mapping_provider_microsoft_entra_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def property_mapping_provider_microsoft_entra_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "property_mapping_provider_microsoft_entra_id")

    @property_mapping_provider_microsoft_entra_id.setter
    def property_mapping_provider_microsoft_entra_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/propertyMappingProviderMicrosoftEntra:PropertyMappingProviderMicrosoftEntra")
class PropertyMappingProviderMicrosoftEntra(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            expression: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            property_mapping_provider_microsoft_entra_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PropertyMappingProviderMicrosoftEntra':
        """
    ...
    @property
    @pulumi.getter(name="propertyMappingProviderMicrosoftEntraId")
    def property_mapping_provider_microsoft_entra_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "property_mapping_provider_microsoft_entra_id")
