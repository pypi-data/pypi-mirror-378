...
class PolicyBindingArgs:
    def __init__(__self__, *,
                 ...
                 failure_result: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] target: ID of the object this binding should apply to
        :param pulumi.Input[builtins.bool] enabled: Defaults to `true`.
        :param pulumi.Input[builtins.bool] failure_result: Defaults to `false`.
        :param pulumi.Input[builtins.str] group: UUID of the group
        :param pulumi.Input[builtins.bool] negate: Defaults to `false`.
        :param pulumi.Input[builtins.str] policy: UUID of the policy
        :param pulumi.Input[builtins.float] timeout: Defaults to `30`.
        :param pulumi.Input[builtins.float] user: PK of the user
        """
    ...
    def failure_result(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `false`.
        """
    ...
    def failure_result(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("authentik:index/policyBinding:PolicyBinding")
class PolicyBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target: Optional[pulumi.Input[builtins.str]] = None,
            timeout: Optional[pulumi.Input[builtins.float]] = None,
            user: Optional[pulumi.Input[builtins.float]] = None) -> 'PolicyBinding':
        """
    ...
    @property
    @pulumi.getter(name="failureResult")
    def failure_result(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `false`.
        """
        return pulumi.get(self, "failure_result")
    ...
    @property
    @pulumi.getter
    def negate(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `false`.
        """
        return pulumi.get(self, "negate")
    ...
    @property
    @pulumi.getter
    def user(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        PK of the user
        """
        return pulumi.get(self, "user")
