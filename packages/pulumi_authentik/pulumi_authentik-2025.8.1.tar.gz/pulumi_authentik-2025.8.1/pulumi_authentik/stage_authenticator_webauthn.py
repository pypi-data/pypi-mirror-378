...
class StageAuthenticatorWebauthnArgs:
    def __init__(__self__, *,
                 ...
                 device_type_restrictions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 friendly_name: Optional[pulumi.Input[builtins.str]] = None,
                 max_attempts: Optional[pulumi.Input[builtins.float]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 resident_key_requirement: Optional[pulumi.Input[builtins.str]] = None,
                 stage_authenticator_webauthn_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] authenticator_attachment: Allowed values: - `platform` - `cross-platform`
        :param pulumi.Input[builtins.str] resident_key_requirement: Allowed values: - `discouraged` - `preferred` - `required` Defaults to `preferred`.
        :param pulumi.Input[builtins.str] user_verification: Allowed values: - `required` - `preferred` - `discouraged` Defaults to `preferred`.
        """
    ...
    def device_type_restrictions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "device_type_restrictions")

    @device_type_restrictions.setter
    def device_type_restrictions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def max_attempts(self) -> Optional[pulumi.Input[builtins.float]]:
        return pulumi.get(self, "max_attempts")

    @max_attempts.setter
    def max_attempts(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def resident_key_requirement(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resident_key_requirement(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resident_key_requirement", value)

    @property
    @pulumi.getter(name="stageAuthenticatorWebauthnId")
    def stage_authenticator_webauthn_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "stage_authenticator_webauthn_id")

    @stage_authenticator_webauthn_id.setter
    def stage_authenticator_webauthn_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/stageAuthenticatorWebauthn:StageAuthenticatorWebauthn")
class StageAuthenticatorWebauthn(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resident_key_requirement: Optional[pulumi.Input[builtins.str]] = None,
            stage_authenticator_webauthn_id: Optional[pulumi.Input[builtins.str]] = None,
            user_verification: Optional[pulumi.Input[builtins.str]] = None) -> 'StageAuthenticatorWebauthn':
        """
    ...
    @property
    @pulumi.getter(name="authenticatorAttachment")
    def authenticator_attachment(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Allowed values: - `platform` - `cross-platform`
        """
        return pulumi.get(self, "authenticator_attachment")
    ...
    @property
    @pulumi.getter(name="deviceTypeRestrictions")
    def device_type_restrictions(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "device_type_restrictions")
    ...
    @property
    @pulumi.getter(name="maxAttempts")
    def max_attempts(self) -> pulumi.Output[Optional[builtins.float]]:
        return pulumi.get(self, "max_attempts")
    ...
    @property
    @pulumi.getter(name="residentKeyRequirement")
    def resident_key_requirement(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Allowed values: - `discouraged` - `preferred` - `required` Defaults to `preferred`.
        """
        return pulumi.get(self, "resident_key_requirement")
    ...
    @property
    @pulumi.getter(name="stageAuthenticatorWebauthnId")
    def stage_authenticator_webauthn_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "stage_authenticator_webauthn_id")

    @property
    @pulumi.getter(name="userVerification")
    def user_verification(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Allowed values: - `required` - `preferred` - `discouraged` Defaults to `preferred`.
        """
        return pulumi.get(self, "user_verification")
