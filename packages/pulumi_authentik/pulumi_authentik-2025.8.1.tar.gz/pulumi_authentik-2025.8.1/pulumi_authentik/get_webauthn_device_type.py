...
def get_webauthn_device_type(description: Optional[builtins.str] = None,
...
def get_webauthn_device_type_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWebauthnDeviceTypeResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
