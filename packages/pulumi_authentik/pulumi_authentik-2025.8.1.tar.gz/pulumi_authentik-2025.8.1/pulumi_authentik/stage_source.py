...
class StageSourceArgs:
    def __init__(__self__, *,
                 ...
                 resume_timeout: Optional[pulumi.Input[builtins.str]] = None,
                 source: Optional[pulumi.Input[builtins.str]] = None,
                 stage_source_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a StageSource resource.
        :param pulumi.Input[builtins.str] resume_timeout: Format: hours=1;minutes=2;seconds=3. Defaults to `minutes=10`.
        """
        if name is not None:
    ...
    def resume_timeout(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resume_timeout(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def stage_source_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "stage_source_id")

    @stage_source_id.setter
    def stage_source_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/stageSource:StageSource")
class StageSource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resume_timeout: Optional[pulumi.Input[builtins.str]] = None,
            source: Optional[pulumi.Input[builtins.str]] = None,
            stage_source_id: Optional[pulumi.Input[builtins.str]] = None) -> 'StageSource':
        """
    ...
    @property
    @pulumi.getter(name="resumeTimeout")
    def resume_timeout(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Format: hours=1;minutes=2;seconds=3. Defaults to `minutes=10`.
        """
        return pulumi.get(self, "resume_timeout")
    ...
    @property
    @pulumi.getter(name="stageSourceId")
    def stage_source_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "stage_source_id")
