...
class SourceSamlArgs:
    def __init__(__self__, *,
                 pre_authentication_flow: pulumi.Input[builtins.str],
                 slug: pulumi.Input[builtins.str],
                 sso_url: pulumi.Input[builtins.str],
                 allow_idp_initiated: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 encryption_kp: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 name_id_policy: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 signing_kp: Optional[pulumi.Input[builtins.str]] = None,
                 slo_url: Optional[pulumi.Input[builtins.str]] = None,
                 source_saml_id: Optional[pulumi.Input[builtins.str]] = None,
                 temporary_user_delete_after: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 verification_kp: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SourceSaml resource.
        :param pulumi.Input[builtins.bool] allow_idp_initiated: Defaults to `false`.
        :param pulumi.Input[builtins.str] binding_type: Allowed values: - `REDIRECT` - `POST` - `POST_AUTO` Defaults to `REDIRECT`.
        :param pulumi.Input[builtins.str] digest_algorithm: Allowed values: - `http://www.w3.org/2000/09/xmldsig#sha1` - `http://www.w3.org/2001/04/xmlenc#sha256` -
        ...
        :param pulumi.Input[builtins.str] name_id_policy: Allowed values: - `urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress` -
        ...
        :param pulumi.Input[builtins.str] signature_algorithm: Allowed values: - `http://www.w3.org/2000/09/xmldsig#rsa-sha1` - `http://www.w3.org/2001/04/xmldsig-more#rsa-sha256` -
        ...
        :param pulumi.Input[builtins.str] temporary_user_delete_after: Format: hours=1;minutes=2;seconds=3. Defaults to `days=1`.
    ...
    def pre_authentication_flow(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "pre_authentication_flow")

    @pre_authentication_flow.setter
    def pre_authentication_flow(self, value: pulumi.Input[builtins.str]):
    ...
    def allow_idp_initiated(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `false`.
        """
    ...
    def allow_idp_initiated(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def encryption_kp(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "encryption_kp")

    @encryption_kp.setter
    def encryption_kp(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def name_id_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def name_id_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def signing_kp(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "signing_kp")

    @signing_kp.setter
    def signing_kp(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "signing_kp", value)

    @property
    @pulumi.getter(name="sloUrl")
    def slo_url(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "slo_url")

    @slo_url.setter
    def slo_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "slo_url", value)

    @property
    @pulumi.getter(name="sourceSamlId")
    def source_saml_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "source_saml_id")

    @source_saml_id.setter
    def source_saml_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_saml_id", value)

    @property
    @pulumi.getter(name="temporaryUserDeleteAfter")
    def temporary_user_delete_after(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def temporary_user_delete_after(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def verification_kp(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "verification_kp")

    @verification_kp.setter
    def verification_kp(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SourceSamlState:
    def __init__(__self__, *,
                 ...
                 name_id_policy: Optional[pulumi.Input[builtins.str]] = None,
                 policy_engine_mode: Optional[pulumi.Input[builtins.str]] = None,
                 pre_authentication_flow: Optional[pulumi.Input[builtins.str]] = None,
                 property_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 property_mappings_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 signature_algorithm: Optional[pulumi.Input[builtins.str]] = None,
                 signing_kp: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] enabled: Defaults to `true`.
        :param pulumi.Input[builtins.str] group_matching_mode: Allowed values: - `identifier` - `name_link` - `name_deny` Defaults to `identifier`.
        :param pulumi.Input[builtins.str] metadata: SAML Metadata Generated.
        :param pulumi.Input[builtins.str] name_id_policy: Allowed values: - `urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress` -
               `urn:oasis:names:tc:SAML:2.0:nameid-format:persistent` - `urn:oasis:names:tc:SAML:1.1:nameid-format:X509SubjectName` -
               `urn:oasis:names:tc:SAML:2.0:nameid-format:WindowsDomainQualifiedName` -
               `urn:oasis:names:tc:SAML:2.0:nameid-format:transient` - `urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified` Defaults
    ...
    @property
    @pulumi.getter(name="preAuthenticationFlow")
    def pre_authentication_flow(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "pre_authentication_flow")

    @pre_authentication_flow.setter
    def pre_authentication_flow(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "pre_authentication_flow", value)
...
@pulumi.type_token("authentik:index/sourceSaml:SourceSaml")
class SourceSaml(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_path_template: Optional[pulumi.Input[builtins.str]] = None,
            uuid: Optional[pulumi.Input[builtins.str]] = None,
            verification_kp: Optional[pulumi.Input[builtins.str]] = None) -> 'SourceSaml':
        """
    ...
    @property
    @pulumi.getter(name="allowIdpInitiated")
    def allow_idp_initiated(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `false`.
        """
        return pulumi.get(self, "allow_idp_initiated")
    ...
    @property
    @pulumi.getter(name="encryptionKp")
    def encryption_kp(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "encryption_kp")
    ...
    @property
    @pulumi.getter(name="nameIdPolicy")
    def name_id_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Allowed values: - `urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress` -
        `urn:oasis:names:tc:SAML:2.0:nameid-format:persistent` - `urn:oasis:names:tc:SAML:1.1:nameid-format:X509SubjectName` -
        `urn:oasis:names:tc:SAML:2.0:nameid-format:WindowsDomainQualifiedName` -
    ...
    @property
    @pulumi.getter(name="preAuthenticationFlow")
    def pre_authentication_flow(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "pre_authentication_flow")
    ...
    @property
    @pulumi.getter(name="signingKp")
    def signing_kp(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "signing_kp")

    @property
    @pulumi.getter(name="sloUrl")
    def slo_url(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "slo_url")
    ...
    @property
    @pulumi.getter(name="sourceSamlId")
    def source_saml_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "source_saml_id")
    ...
    @property
    @pulumi.getter(name="temporaryUserDeleteAfter")
    def temporary_user_delete_after(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Format: hours=1;minutes=2;seconds=3. Defaults to `days=1`.
        """
        return pulumi.get(self, "temporary_user_delete_after")
    ...
    @property
    @pulumi.getter(name="verificationKp")
    def verification_kp(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "verification_kp")
