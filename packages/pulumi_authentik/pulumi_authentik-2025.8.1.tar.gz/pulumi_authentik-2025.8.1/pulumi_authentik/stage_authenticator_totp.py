...
class StageAuthenticatorTotpArgs:
    def __init__(__self__, *,
                 ...
                 stage_authenticator_totp_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a StageAuthenticatorTotp resource.
        :param pulumi.Input[builtins.str] digits: Allowed values: - `6` - `8` Defaults to `6`.
        """
    ...
    def stage_authenticator_totp_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "stage_authenticator_totp_id")

    @stage_authenticator_totp_id.setter
    def stage_authenticator_totp_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/stageAuthenticatorTotp:StageAuthenticatorTotp")
class StageAuthenticatorTotp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            friendly_name: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            stage_authenticator_totp_id: Optional[pulumi.Input[builtins.str]] = None) -> 'StageAuthenticatorTotp':
        """
    ...
    @property
    @pulumi.getter
    def digits(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Allowed values: - `6` - `8` Defaults to `6`.
        """
        return pulumi.get(self, "digits")
    ...
    @property
    @pulumi.getter(name="stageAuthenticatorTotpId")
    def stage_authenticator_totp_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "stage_authenticator_totp_id")
