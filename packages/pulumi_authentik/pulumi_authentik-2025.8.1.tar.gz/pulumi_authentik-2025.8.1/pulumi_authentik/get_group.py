...
class GetGroupResult:
    ...
    @property
    @pulumi.getter
    def pk(self) -> Optional[builtins.str]:
...
def get_group_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     include_users: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                     name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     pk: Optional[pulumi.Input[Optional[builtins.str]]] = None,
