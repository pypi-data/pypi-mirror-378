...
class PolicyEventMatcherArgs:
    def __init__(__self__, *,
                 ...
                 policy_event_matcher_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a PolicyEventMatcher resource.
        :param pulumi.Input[builtins.str] app: Allowed values: - `authentik.tenants` - `authentik.tasks` - `authentik.admin` - `authentik.api` - `authentik.core` -
    ...
    def policy_event_matcher_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "policy_event_matcher_id")

    @policy_event_matcher_id.setter
    def policy_event_matcher_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/policyEventMatcher:PolicyEventMatcher")
class PolicyEventMatcher(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            model: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            policy_event_matcher_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PolicyEventMatcher':
        """
    ...
    @property
    @pulumi.getter(name="policyEventMatcherId")
    def policy_event_matcher_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "policy_event_matcher_id")
