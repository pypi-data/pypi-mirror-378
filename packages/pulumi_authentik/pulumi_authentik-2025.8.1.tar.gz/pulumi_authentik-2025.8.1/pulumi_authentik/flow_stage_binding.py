...
class FlowStageBindingArgs:
    def __init__(__self__, *,
                 order: pulumi.Input[builtins.float],
                 stage: pulumi.Input[builtins.str],
                 target: pulumi.Input[builtins.str],
                 evaluate_on_plan: Optional[pulumi.Input[builtins.bool]] = None,
                 flow_stage_binding_id: Optional[pulumi.Input[builtins.str]] = None,
                 invalid_response_action: Optional[pulumi.Input[builtins.str]] = None,
                 policy_engine_mode: Optional[pulumi.Input[builtins.str]] = None,
                 re_evaluate_policies: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a FlowStageBinding resource.
        :param pulumi.Input[builtins.bool] evaluate_on_plan: Evaluate policies during the Flow planning process. Defaults to `true`.
        :param pulumi.Input[builtins.str] invalid_response_action: Allowed values: - `retry` - `restart` - `restart_with_context` Defaults to `retry`.
        :param pulumi.Input[builtins.str] policy_engine_mode: Allowed values: - `all` - `any` Defaults to `any`.
        :param pulumi.Input[builtins.bool] re_evaluate_policies: Evaluate policies when the Stage is present to the user. Defaults to `false`.
        """
    ...
    @property
    @pulumi.getter
    def order(self) -> pulumi.Input[builtins.float]:
        return pulumi.get(self, "order")

    @order.setter
    def order(self, value: pulumi.Input[builtins.float]):
    ...
    def evaluate_on_plan(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def evaluate_on_plan(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "evaluate_on_plan", value)

    @property
    @pulumi.getter(name="flowStageBindingId")
    def flow_stage_binding_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "flow_stage_binding_id")

    @flow_stage_binding_id.setter
    def flow_stage_binding_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "flow_stage_binding_id", value)

    @property
    @pulumi.getter(name="invalidResponseAction")
    def invalid_response_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def invalid_response_action(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def re_evaluate_policies(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def re_evaluate_policies(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("authentik:index/flowStageBinding:FlowStageBinding")
class FlowStageBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            re_evaluate_policies: Optional[pulumi.Input[builtins.bool]] = None,
            stage: Optional[pulumi.Input[builtins.str]] = None,
            target: Optional[pulumi.Input[builtins.str]] = None) -> 'FlowStageBinding':
        """
    ...
    @property
    @pulumi.getter(name="evaluateOnPlan")
    def evaluate_on_plan(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Evaluate policies during the Flow planning process. Defaults to `true`.
        """
        return pulumi.get(self, "evaluate_on_plan")
    ...
    @property
    @pulumi.getter(name="flowStageBindingId")
    def flow_stage_binding_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "flow_stage_binding_id")

    @property
    @pulumi.getter(name="invalidResponseAction")
    def invalid_response_action(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Allowed values: - `retry` - `restart` - `restart_with_context` Defaults to `retry`.
        """
        return pulumi.get(self, "invalid_response_action")
    ...
    @property
    @pulumi.getter
    def order(self) -> pulumi.Output[builtins.float]:
        return pulumi.get(self, "order")
    ...
    @property
    @pulumi.getter(name="reEvaluatePolicies")
    def re_evaluate_policies(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Evaluate policies when the Stage is present to the user. Defaults to `false`.
        """
        return pulumi.get(self, "re_evaluate_policies")
