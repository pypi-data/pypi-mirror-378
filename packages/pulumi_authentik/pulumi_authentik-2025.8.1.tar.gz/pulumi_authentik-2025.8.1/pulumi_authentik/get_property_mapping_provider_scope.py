...
class GetPropertyMappingProviderScopeResult:
    ...
    @property
    @pulumi.getter
    def managed(self) -> Optional[builtins.str]:
        return pulumi.get(self, "managed")

    @property
    @pulumi.getter(name="managedLists")
    def managed_lists(self) -> Optional[Sequence[builtins.str]]:
...
def get_property_mapping_provider_scope(id: Optional[builtins.str] = None,
                                        ids: Optional[Sequence[builtins.str]] = None,
                                        managed: Optional[builtins.str] = None,
                                        managed_lists: Optional[Sequence[builtins.str]] = None,
...
def get_property_mapping_provider_scope_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                               ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                               managed: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                               managed_lists: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                               name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                               scope_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPropertyMappingProviderScopeResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
