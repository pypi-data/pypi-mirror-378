...
class GetCertificateKeyPairResult:
    ...
    def fetch_certificate(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "fetch_certificate")

    @property
    @pulumi.getter(name="fetchKey")
    def fetch_key(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "fetch_key")

    @property
    @pulumi.getter
    def fingerprint1(self) -> builtins.str:
        return pulumi.get(self, "fingerprint1")

    @property
    @pulumi.getter
    def fingerprint256(self) -> builtins.str:
...
def get_certificate_key_pair(fetch_certificate: Optional[builtins.bool] = None,
                             fetch_key: Optional[builtins.bool] = None,
...
def get_certificate_key_pair_output(fetch_certificate: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                    fetch_key: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                    key_data: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    name: Optional[pulumi.Input[builtins.str]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCertificateKeyPairResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
