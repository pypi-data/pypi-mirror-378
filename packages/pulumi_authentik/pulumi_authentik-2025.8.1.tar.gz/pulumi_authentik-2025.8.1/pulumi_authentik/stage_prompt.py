...
class StagePromptArgs:
    def __init__(__self__, *,
                 ...
                 stage_prompt_id: Optional[pulumi.Input[builtins.str]] = None,
                 validation_policies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
    ...
    def stage_prompt_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "stage_prompt_id")

    @stage_prompt_id.setter
    def stage_prompt_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "stage_prompt_id", value)

    @property
    @pulumi.getter(name="validationPolicies")
    def validation_policies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "validation_policies")

    @validation_policies.setter
    def validation_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("authentik:index/stagePrompt:StagePrompt")
class StagePrompt(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            stage_prompt_id: Optional[pulumi.Input[builtins.str]] = None,
            validation_policies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'StagePrompt':
        """
    ...
    @property
    @pulumi.getter(name="stagePromptId")
    def stage_prompt_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "stage_prompt_id")

    @property
    @pulumi.getter(name="validationPolicies")
    def validation_policies(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "validation_policies")
