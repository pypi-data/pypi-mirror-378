...
class SourceKerberosArgs:
    def __init__(__self__, *,
                 ...
                 krb5_conf: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 source_kerberos_id: Optional[pulumi.Input[builtins.str]] = None,
                 spnego_ccache: Optional[pulumi.Input[builtins.str]] = None,
                 spnego_keytab: Optional[pulumi.Input[builtins.str]] = None,
                 spnego_server_name: Optional[pulumi.Input[builtins.str]] = None,
                 sync_ccache: Optional[pulumi.Input[builtins.str]] = None,
                 sync_keytab: Optional[pulumi.Input[builtins.str]] = None,
                 sync_password: Optional[pulumi.Input[builtins.str]] = None,
                 sync_principal: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] realm: Kerberos realm
        ...
        :param pulumi.Input[builtins.str] krb5_conf: Custom krb5.conf to use. Uses the system one by default
        :param pulumi.Input[builtins.bool] password_login_update_internal_password: If enabled, the authentik-stored password will be updated upon login with the Kerberos password backend Defaults to
               `false`.
        :param pulumi.Input[builtins.str] policy_engine_mode: Allowed values: - `all` - `any` Defaults to `any`.
        :param pulumi.Input[builtins.str] spnego_ccache: Credential cache to use for SPNEGO in form type:residual
        :param pulumi.Input[builtins.str] spnego_keytab: SPNEGO keytab base64-encoded or path to keytab in the form FILE:path
        :param pulumi.Input[builtins.str] spnego_server_name: Force the use of a specific server name for SPNEGO
        :param pulumi.Input[builtins.str] sync_ccache: Credentials cache to authenticate to kadmin for sync. Must be in the form TYPE:residual
        :param pulumi.Input[builtins.str] sync_keytab: Keytab to authenticate to kadmin for sync. Must be base64-encoded or in the form TYPE:residual
        :param pulumi.Input[builtins.str] sync_password: Password to authenticate to kadmin for sync
        :param pulumi.Input[builtins.str] sync_principal: Principal to authenticate to kadmin for sync.
        :param pulumi.Input[builtins.bool] sync_users: Sync users from Kerberos into authentik Defaults to `true`.
        :param pulumi.Input[builtins.bool] sync_users_password: When a user changes their password, sync it back to Kerberos Defaults to `true`.
    ...
    def krb5_conf(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @krb5_conf.setter
    def krb5_conf(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_kerberos_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "source_kerberos_id")

    @source_kerberos_id.setter
    def source_kerberos_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_kerberos_id", value)

    @property
    @pulumi.getter(name="spnegoCcache")
    def spnego_ccache(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def spnego_ccache(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "spnego_ccache", value)

    @property
    @pulumi.getter(name="spnegoKeytab")
    def spnego_keytab(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def spnego_keytab(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "spnego_keytab", value)

    @property
    @pulumi.getter(name="spnegoServerName")
    def spnego_server_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def spnego_server_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "spnego_server_name", value)

    @property
    @pulumi.getter(name="syncCcache")
    def sync_ccache(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sync_ccache.setter
    def sync_ccache(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sync_ccache", value)

    @property
    @pulumi.getter(name="syncKeytab")
    def sync_keytab(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sync_keytab.setter
    def sync_keytab(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sync_principal(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sync_principal(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/sourceKerberos:SourceKerberos")
class SourceKerberos(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_matching_mode: Optional[pulumi.Input[builtins.str]] = None,
            user_path_template: Optional[pulumi.Input[builtins.str]] = None,
            uuid: Optional[pulumi.Input[builtins.str]] = None) -> 'SourceKerberos':
        """
    ...
    @property
    @pulumi.getter(name="krb5Conf")
    def krb5_conf(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Custom krb5.conf to use. Uses the system one by default
        """
        return pulumi.get(self, "krb5_conf")
    ...
    @property
    @pulumi.getter(name="sourceKerberosId")
    def source_kerberos_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "source_kerberos_id")

    @property
    @pulumi.getter(name="spnegoCcache")
    def spnego_ccache(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Credential cache to use for SPNEGO in form type:residual
        """
        return pulumi.get(self, "spnego_ccache")
    ...
    @property
    @pulumi.getter(name="spnegoKeytab")
    def spnego_keytab(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        SPNEGO keytab base64-encoded or path to keytab in the form FILE:path
        """
        return pulumi.get(self, "spnego_keytab")
    ...
    @property
    @pulumi.getter(name="spnegoServerName")
    def spnego_server_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Force the use of a specific server name for SPNEGO
        """
        return pulumi.get(self, "spnego_server_name")
    ...
    @property
    @pulumi.getter(name="syncCcache")
    def sync_ccache(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Credentials cache to authenticate to kadmin for sync. Must be in the form TYPE:residual
        """
        return pulumi.get(self, "sync_ccache")
    ...
    @property
    @pulumi.getter(name="syncKeytab")
    def sync_keytab(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Keytab to authenticate to kadmin for sync. Must be base64-encoded or in the form TYPE:residual
        """
        return pulumi.get(self, "sync_keytab")
    ...
    @property
    @pulumi.getter(name="syncPrincipal")
    def sync_principal(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Principal to authenticate to kadmin for sync.
        """
        return pulumi.get(self, "sync_principal")
