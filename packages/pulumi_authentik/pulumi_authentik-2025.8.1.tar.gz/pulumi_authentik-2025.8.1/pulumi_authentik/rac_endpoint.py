...
class RacEndpointArgs:
    def __init__(__self__, *,
                 ...
                 protocol_provider: pulumi.Input[builtins.float],
                 maximum_connections: Optional[pulumi.Input[builtins.float]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 property_mappings: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 rac_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
                 settings: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RacEndpoint resource.
        :param pulumi.Input[builtins.str] protocol: Allowed values: - `rdp` - `vnc` - `ssh`
        :param pulumi.Input[builtins.float] maximum_connections: Defaults to `0`.
    ...
    def protocol_provider(self) -> pulumi.Input[builtins.float]:
        return pulumi.get(self, "protocol_provider")

    @protocol_provider.setter
    def protocol_provider(self, value: pulumi.Input[builtins.float]):
        pulumi.set(self, "protocol_provider", value)

    @property
    @pulumi.getter(name="maximumConnections")
    def maximum_connections(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Defaults to `0`.
        """
    ...
    def maximum_connections(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def rac_endpoint_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "rac_endpoint_id")

    @rac_endpoint_id.setter
    def rac_endpoint_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/racEndpoint:RacEndpoint")
class RacEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            protocol_provider: Optional[pulumi.Input[builtins.float]] = None,
            rac_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
            settings: Optional[pulumi.Input[builtins.str]] = None) -> 'RacEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="maximumConnections")
    def maximum_connections(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Defaults to `0`.
        """
        return pulumi.get(self, "maximum_connections")
    ...
    @property
    @pulumi.getter(name="protocolProvider")
    def protocol_provider(self) -> pulumi.Output[builtins.float]:
        return pulumi.get(self, "protocol_provider")

    @property
    @pulumi.getter(name="racEndpointId")
    def rac_endpoint_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "rac_endpoint_id")
