...
class StageAuthenticatorStaticArgs:
    def __init__(__self__, *,
                 ...
                 stage_authenticator_static_id: Optional[pulumi.Input[builtins.str]] = None,
                 token_count: Optional[pulumi.Input[builtins.float]] = None,
                 token_length: Optional[pulumi.Input[builtins.float]] = None):
        """
        The set of arguments for constructing a StageAuthenticatorStatic resource.
        :param pulumi.Input[builtins.float] token_count: Defaults to `6`.
        :param pulumi.Input[builtins.float] token_length: Defaults to `12`.
        """
    ...
    def stage_authenticator_static_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "stage_authenticator_static_id")

    @stage_authenticator_static_id.setter
    def stage_authenticator_static_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "stage_authenticator_static_id", value)

    @property
    @pulumi.getter(name="tokenCount")
    def token_count(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Defaults to `6`.
        """
    ...
    @token_count.setter
    def token_count(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "token_count", value)

    @property
    @pulumi.getter(name="tokenLength")
    def token_length(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Defaults to `12`.
        """
    ...
    @token_length.setter
    def token_length(self, value: Optional[pulumi.Input[builtins.float]]):
...
@pulumi.type_token("authentik:index/stageAuthenticatorStatic:StageAuthenticatorStatic")
class StageAuthenticatorStatic(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            stage_authenticator_static_id: Optional[pulumi.Input[builtins.str]] = None,
            token_count: Optional[pulumi.Input[builtins.float]] = None,
            token_length: Optional[pulumi.Input[builtins.float]] = None) -> 'StageAuthenticatorStatic':
        """
    ...
    @property
    @pulumi.getter(name="stageAuthenticatorStaticId")
    def stage_authenticator_static_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "stage_authenticator_static_id")

    @property
    @pulumi.getter(name="tokenCount")
    def token_count(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Defaults to `6`.
        """
        return pulumi.get(self, "token_count")
    ...
    @property
    @pulumi.getter(name="tokenLength")
    def token_length(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        Defaults to `12`.
        """
        return pulumi.get(self, "token_length")
