...
class ProviderOauth2Args:
    def __init__(__self__, *,
                 ...
                 access_code_validity: Optional[pulumi.Input[builtins.str]] = None,
                 access_token_validity: Optional[pulumi.Input[builtins.str]] = None,
                 allowed_redirect_uris: Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]]] = None,
                 authentication_flow: Optional[pulumi.Input[builtins.str]] = None,
                 backchannel_logout_uri: Optional[pulumi.Input[builtins.str]] = None,
                 client_secret: Optional[pulumi.Input[builtins.str]] = None,
                 client_type: Optional[pulumi.Input[builtins.str]] = None,
                 encryption_key: Optional[pulumi.Input[builtins.str]] = None,
                 include_claims_in_id_token: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 provider_oauth2_id: Optional[pulumi.Input[builtins.str]] = None,
                 refresh_token_validity: Optional[pulumi.Input[builtins.str]] = None,
                 signing_key: Optional[pulumi.Input[builtins.str]] = None,
                 sub_mode: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ProviderOauth2 resource.
        :param pulumi.Input[builtins.str] access_code_validity: Format: hours=1;minutes=2;seconds=3. Defaults to `minutes=1`.
        :param pulumi.Input[builtins.str] access_token_validity: Format: hours=1;minutes=2;seconds=3. Defaults to `minutes=10`.
        :param pulumi.Input[builtins.str] client_secret: Generated.
        :param pulumi.Input[builtins.str] client_type: Allowed values: - `confidential` - `public` Defaults to `confidential`.
        :param pulumi.Input[builtins.bool] include_claims_in_id_token: Defaults to `true`.
        :param pulumi.Input[builtins.str] issuer_mode: Allowed values: - `global` - `per_provider` Defaults to `per_provider`.
        ...
        :param pulumi.Input[builtins.str] sub_mode: Allowed values: - `hashed_user_id` - `user_id` - `user_uuid` - `user_username` - `user_email` - `user_upn` Defaults to
               `hashed_user_id`.
        """
        ...
        if backchannel_logout_uri is not None:
            pulumi.set(__self__, "backchannel_logout_uri", backchannel_logout_uri)
    ...
    def access_code_validity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def access_code_validity(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def allowed_redirect_uris(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]]]:
        return pulumi.get(self, "allowed_redirect_uris")

    @allowed_redirect_uris.setter
    def allowed_redirect_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]]]):
    ...
    def backchannel_logout_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "backchannel_logout_uri")

    @backchannel_logout_uri.setter
    def backchannel_logout_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "backchannel_logout_uri", value)
    ...
    def include_claims_in_id_token(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defaults to `true`.
        """
    ...
    def include_claims_in_id_token(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def provider_oauth2_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "provider_oauth2_id")

    @provider_oauth2_id.setter
    def provider_oauth2_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sub_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sub_mode.setter
    def sub_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("authentik:index/providerOauth2:ProviderOauth2")
class ProviderOauth2(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["backchannel_logout_uri"] = backchannel_logout_uri
    ...
    def get(resource_name: str,
            ...
            refresh_token_validity: Optional[pulumi.Input[builtins.str]] = None,
            signing_key: Optional[pulumi.Input[builtins.str]] = None,
            sub_mode: Optional[pulumi.Input[builtins.str]] = None) -> 'ProviderOauth2':
        """
    ...
    @property
    @pulumi.getter(name="accessCodeValidity")
    def access_code_validity(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Format: hours=1;minutes=2;seconds=3. Defaults to `minutes=1`.
        """
        return pulumi.get(self, "access_code_validity")
    ...
    @property
    @pulumi.getter(name="allowedRedirectUris")
    def allowed_redirect_uris(self) -> pulumi.Output[Optional[Sequence[Mapping[str, builtins.str]]]]:
        return pulumi.get(self, "allowed_redirect_uris")
    ...
    @property
    @pulumi.getter(name="backchannelLogoutUri")
    def backchannel_logout_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "backchannel_logout_uri")
    ...
    @property
    @pulumi.getter(name="includeClaimsInIdToken")
    def include_claims_in_id_token(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to `true`.
        """
        return pulumi.get(self, "include_claims_in_id_token")
    ...
    @property
    @pulumi.getter(name="providerOauth2Id")
    def provider_oauth2_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "provider_oauth2_id")
    ...
    @property
    @pulumi.getter(name="subMode")
    def sub_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Allowed values: - `hashed_user_id` - `user_id` - `user_uuid` - `user_username` - `user_email` - `user_upn` Defaults to
        `hashed_user_id`.
        """
