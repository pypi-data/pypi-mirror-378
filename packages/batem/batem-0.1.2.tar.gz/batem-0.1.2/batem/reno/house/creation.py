...
from batem.reno.house.services import (
    ...
    ConsumptionAggregator, ConsumptionExporter)
...
if __name__ == "__main__":
    ...
    # python -m batem.reno.house.creation

    # python -m cProfile -o batem/reno/house/house_creation.prof batem.reno.house.creation
    # snakeviz batem/reno/house/house_creation.prof

    house: House | None = HouseBuilder().build_house_by_id(house_id=2000900)
    if house is None:
