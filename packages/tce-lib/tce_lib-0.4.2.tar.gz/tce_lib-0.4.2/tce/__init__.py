...
This makes it easier to generate data - but what if you already have data sitting around? Most atomistic softwares 
(all that I am familiar with) store the energy separate from the configuration. You can load these in by attaching a 
