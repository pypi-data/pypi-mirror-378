...
class GetObjectstorageBucketResult:
    ...
    """
    def __init__(__self__, endpoint=None, id=None, name=None, object_lock_enabled=None, organisation_id=None, policy=None, public=None, region=None, status=None, versioning=None):
