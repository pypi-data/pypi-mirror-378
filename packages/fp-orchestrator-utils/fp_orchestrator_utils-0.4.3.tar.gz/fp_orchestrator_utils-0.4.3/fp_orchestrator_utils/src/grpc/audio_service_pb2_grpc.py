...
class AudioServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessAudioPayload = channel.unary_unary(
                '/audio_service.AudioService/ProcessAudioPayload',
...
class AudioServiceServicer(object):
    ...
    def ProcessAudioPayload(self, request, context):
...
def add_AudioServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ProcessAudioPayload': grpc.unary_unary_rpc_method_handler(
                    servicer.ProcessAudioPayload,
...
class AudioService(object):
    ...
    @staticmethod
    def ProcessAudioPayload(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
