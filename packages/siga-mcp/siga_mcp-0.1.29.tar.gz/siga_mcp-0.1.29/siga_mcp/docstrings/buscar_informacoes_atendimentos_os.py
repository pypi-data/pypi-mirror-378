...
def docs() -> str:
    return dedent("""\
            ...
            Args:
                codigo_atendimento (int): Código único identificador do atendimento OS. Deve ser um número inteiro válido correspondente a um atendimento existente no sistema SIGA.
                codigo_analista (str | Literal["CURRENT_USER"]): Matrícula do analista/usuário responsável pelo atendimento OS.
