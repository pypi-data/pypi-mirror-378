...
The system uses a base class [`GenericDimension`][pyballistic.unit.GenericDimension] with specialized subclasses for each physical dimension.
...
# Local imports
from pyballistic.exceptions import UnitTypeError, UnitConversionError, UnitAliasError
