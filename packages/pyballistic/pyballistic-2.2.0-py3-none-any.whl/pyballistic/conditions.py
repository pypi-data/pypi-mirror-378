...
>>> from pyballistic import Unit
>>> breeze = Wind(velocity=Unit.FPS(10), direction_from=Unit.Degree(90))

See also
- Engines consuming these types: pyballistic.engines.*
- Units and conversions: pyballistic.unit
"""
...
from pyballistic.constants import (cStandardDensity, cLapseRateKperFoot, cLowestTempF, cStandardDensityMetric,
...
from pyballistic.munition import Weapon, Ammo
from pyballistic.trajectory_data import TrajFlag
from pyballistic.unit import Angular, Distance, PreferredUnits, Pressure, Temperature, Velocity, Weight
...
class Shot:
    ...
    def __init__(self,
        ...
        Example:
            ```python
            from pyballistic import Weapon, Ammo, Atmo, Wind
            shot = Shot(
                ammo=Ammo(...),
                weapon=Weapon(...),
