...
Examples:
    ...
    >>> calc = Calculator(engine="pyballistic:EulerIntegrationEngine")
...
See Also:
    pyballistic.engines.rk4: More accurate RK4 integration
    pyballistic.engines.velocity_verlet: Energy-conservative integration
