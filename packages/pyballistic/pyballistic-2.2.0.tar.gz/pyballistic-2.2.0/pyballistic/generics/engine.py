"""Engine protocol module for pyballistic.
...
class EngineProtocol(Protocol[ConfigT]):
    ...
    See Also:
        - pyballistic.engines.base_engine.BaseIntegrationEngine: Base implementation
        - pyballistic.interface.Calculator: Uses EngineProtocol implementations
