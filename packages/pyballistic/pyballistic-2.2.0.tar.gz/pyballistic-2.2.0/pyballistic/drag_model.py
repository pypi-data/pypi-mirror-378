...
# Local imports
from pyballistic.constants import cDegreesCtoK, cSpeedOfSoundMetric, cStandardTemperatureC
from pyballistic.drag_tables import DragTablePointDictType
from pyballistic.unit import Distance, PreferredUnits, Velocity, Weight
...
def DragModelMultiBC(bc_points: List[BCPoint],
    ...
    Example:
        ```python
        from pyballistic.drag_tables import TableG7
