...
from proto.agentlab.agent.v1.agent_service_pb2_connect import AgentServiceClient, AsyncAgentServiceClient
...
class AgentLabClient:
    ...
    def __init__(self, options: Optional[AgentLabClientOptions] = None):
        ...
        self.agents = AgentServiceClient(self._base_url, self._http_client)
