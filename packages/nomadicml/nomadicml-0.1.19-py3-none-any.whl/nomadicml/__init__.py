...
__version__ = "0.1.19"  # This will be the clean version for PyPI (Overwritten by CI)
__build__ = "8bd4dca"      # This will hold the commit hash or full build string, populated by CI
