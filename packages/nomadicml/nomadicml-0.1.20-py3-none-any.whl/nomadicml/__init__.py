...
__version__ = "0.1.20"  # This will be the clean version for PyPI (Overwritten by CI)
__build__ = "9c937be"      # This will hold the commit hash or full build string, populated by CI
