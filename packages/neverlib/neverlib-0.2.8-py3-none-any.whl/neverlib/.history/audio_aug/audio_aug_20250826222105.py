...
def snr_aug_Interpolation(clean, noise, target_snr, hp=False ,sr=16000):
    """
    ...
    if hp:
        clean = HPFilter(clean, sr=sr, order=4, cutoff=100)
        noise = HPFilter(noise, sr=sr, order=4, cutoff=100)
