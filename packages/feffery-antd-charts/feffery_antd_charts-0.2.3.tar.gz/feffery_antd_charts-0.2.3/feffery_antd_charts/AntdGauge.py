...
- state (optional):
    ...
    Range = TypedDict(
        "Range",
            {
            "ticks": NotRequired[typing.Sequence[NumberType]],
    ...
    Meter = TypedDict(
        "Meter",
            {
            "steps": NotRequired[NumberType],
            "stepRatio": NotRequired[NumberType]
        }
    )
...
setattr(AntdGauge, "__init__", _explicitize_args(AntdGauge.__init__))
