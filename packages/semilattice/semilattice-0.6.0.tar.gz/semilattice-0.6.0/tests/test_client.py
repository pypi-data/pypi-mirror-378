...
class TestSemilattice:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Semilattice) -> None:
        respx_mock.post("/v1/predictions").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Semilattice) -> None:
        respx_mock.post("/v1/predictions").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/v1/predictions").mock(side_effect=retry_handler)
