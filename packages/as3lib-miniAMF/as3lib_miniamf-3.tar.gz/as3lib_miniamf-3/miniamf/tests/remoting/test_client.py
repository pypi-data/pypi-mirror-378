...
from miniamf.remoting import client
    ...
    def test_call(self):
        class DummyGateway(object):
            ...
            def execute_single(self, request):
                ...
                return miniamf.ASObject(body=None, status=None)
    ...
    def test_service_call(self):
        class DummyGateway(object):
            ...
            def addRequest(self, method_proxy, *args):
                ...
                return miniamf.ASObject(method_proxy=method_proxy, args=args)
...
class RequestWrapperTestCase(unittest.TestCase):
    ...
    def test_set_response(self):
        ...
        y = miniamf.ASObject(body='spam.eggs')
...
class RemotingServiceTestCase(BaseServiceTestCase):
    ...
    def test_create(self):
        ...
        # amf version
        x = client.RemotingService('http://example.org', miniamf.AMF3)
        self.assertEqual(x.amf_version, miniamf.AMF3)
    ...
    def test_get_amf_request(self):
        gw = client.RemotingService('http://example.org', miniamf.AMF3)
        ...
        self.assertEqual(envelope.amfVersion, miniamf.AMF3)
        ...
        self.assertEqual(envelope2.amfVersion, miniamf.AMF3)
