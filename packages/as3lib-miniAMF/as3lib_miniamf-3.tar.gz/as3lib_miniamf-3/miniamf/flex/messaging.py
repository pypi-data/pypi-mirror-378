...
miniamf.register_package(globals(), package=NAMESPACE)
miniamf.register_class(AcknowledgeMessageExt, 'DSK')
miniamf.register_class(CommandMessageExt, 'DSC')
miniamf.register_class(AsyncMessageExt, 'DSA')
