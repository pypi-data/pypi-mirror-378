...
HOTEL_LINK_TEMPLATE = '<a href="/hotel-detail/{hotel_id}" class="hotel-link" style="color:#007AFF;text-decoration:underline">查看详情</a>'
...
def search_hotels_by_name(hotel_name: str) -> Dict[str, Any]:
    """
        Search for hotels by exact or partial name (English or Chinese).
        Use this when the user asks for a specific hotel.
    """
...
def search_hotels_by_city(city_name: str) -> Dict[str, Any]:
    """
        Search for hotels by city name (English or Chinese).
        Use this when planning a trip or when user asks for hotels in a location.
    """
