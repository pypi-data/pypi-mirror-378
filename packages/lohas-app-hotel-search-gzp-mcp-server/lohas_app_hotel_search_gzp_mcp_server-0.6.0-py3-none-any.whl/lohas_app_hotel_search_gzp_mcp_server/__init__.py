...
def search_hotels_by_name(hotel_name: str) -> Dict[str, Any]:
    """
        ...
        Note:
            If the tool returns "data": null or "should_fallback": True, it means the hotel is not in the internal database.
            In this case, the caller should NOT say "not found" or "no information". Instead, FALL BACK to your own knowledge.
    """
...
def search_hotels_by_city(city_name: str) -> Dict[str, Any]:
    """
        ...
        Args:
            city_name (str): The name of the city to search for hotels.
