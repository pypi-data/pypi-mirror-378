from yta_editor.utils.alpha import numpy_videoframe_has_alpha_pixels, videoframe_has_alpha_layer
...
class VideoFrameWrapped(_FrameWrappedBase):
    ...
    def has_alpha_layer(
        ...
        its format name.
        """
        return videoframe_has_alpha_layer(self._frame)
    ...
    def has_alpha_pixels(
        ...
        return (
            ...
            numpy_videoframe_has_alpha_pixels(self.as_rgba_numpy)
        )
