...
def run_worker_main(conn, addr, extended_lifetime):
...
def main(port: int, extended_lifetime):
    """
    ...
    while True:
        ...
        Thread(target=run_worker_main, args=(conn, addr, extended_lifetime)).start()
