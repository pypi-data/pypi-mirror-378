...
from bear_dereth.async_helpers import AsyncResponseModel, create_async_task, is_async
...
class FunctionResponse(BaseModel):
    ...
    def done(self, to_dict: bool = False, suppress: list[str] | None = None) -> dict | Self:
        ...
        return self.internal_dump(exclude=set(suppress or []), exclude_none=True)
