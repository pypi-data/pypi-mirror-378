...
from ba.thread import Thread, AgentRun, BAThread
from ba.models import ChatMessage
...
class TestThread:
    ...
    async def test_add_message(self, mock_thread):
        ...
        mock_thread._client.add_message_to_thread.assert_called_once_with("thread-123", "Hello, world!")
    ...
    async def test_delete_message(self, mock_thread):
        ...
        mock_thread._client.delete_message_from_thread.assert_called_once_with("thread-123", "msg-123")
...
class TestAgentRun:
    ...
    async def test_get_stream(self, mock_agent_run):
        ...
        with pytest.Mock() as mock_stream_from_url:
            mock_stream_from_url.return_value = mock_stream()
            
            # Import and patch the function
            from ba.api.utils import stream_from_url
            with pytest.patch('ba.api.utils.stream_from_url', mock_stream_from_url):
                ...
                mock_threads_client.get_agent_run_stream_url.assert_called_once_with("run-123")
