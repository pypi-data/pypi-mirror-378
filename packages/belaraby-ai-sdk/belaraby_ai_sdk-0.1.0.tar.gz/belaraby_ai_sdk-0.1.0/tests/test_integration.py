...
class TestSDKIntegration:
    ...
    async def test_complete_workflow(self):
        ...
        # Mock stream URL
        mock_threads_client.get_agent_run_stream_url.return_value = "http://example.com/stream"
        ...
        with patch('ba.ba.agents.create_agents_client', return_value=mock_agents_client), \
             patch('ba.ba.threads.create_threads_client', return_value=mock_threads_client), \
             patch('ba.api.utils.stream_from_url', return_value=mock_stream()):
