...
class BASdk:
    ...
    def __init__(self, api_key: str, api_url: str = "https://belaraby.ai"):
        ...
        # Ensure API URL includes /api path for API endpoints
        api_base_url = api_url if api_url.endswith('/api') else f"{api_url}/api"
        
        self._agents_client = agents.create_agents_client(api_base_url, api_key)
        self._threads_client = threads.create_threads_client(api_base_url, api_key)
