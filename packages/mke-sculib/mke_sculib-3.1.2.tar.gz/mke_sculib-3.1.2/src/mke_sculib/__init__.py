...
def load_passive(antenna_id='', debug=False, url_qry = 'http://10.98.76.45:8990/antennas', **kwargs):
    return load(antenna_id=antenna_id, readonly=True, use_socket=True, debug=debug, url_qry=url_qry, **kwargs)
