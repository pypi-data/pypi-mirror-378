...
def slurm_schedule_remote(command,
                          ...
                          exclusive = True,
                          pre_cmds = '',
                          log_dir = '/shared/labdata/remote_jobs',
                          key_dir = None,
                          container_path = None,
                          project = None,
                          database_user = None,
...
#SBATCH --job-name={jobname}
#SBATCH --output={log_dir}/{jobname}_%j.stdout
#SBATCH --error={log_dir}/{jobname}_%j.stdout
#SBATCH --open-mode=append
#SBATCH --ntasks=1
'''
    ...
    if not database_user is None:
        sjobfile += '\n' + f'export LABDATA_DATABASE_USER={database_user}'+'\n'
    if not database_password is None:
        sjobfile += '\n' + f'export LABDATA_DATABASE_PASSWORD={database_password}'+'\n'
