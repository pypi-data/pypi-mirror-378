...
class ConnectionContext(BaseModel):
    ...
    origin: Annotated[OptionalString, Field(None, description="Origin header")]
    ...
    @classmethod
    def as_dependency(cls) -> Callable[..., "ConnectionContext"]:
        def dependency(conn: Union[Request, WebSocket]) -> "ConnectionContext":
