...
AnyFailedRequestOperationType = Union[
    Type[
...
AnyFailedRequestOperation = Union[
    CreateFailedRequestOperation[
...
AnyFailedRequestOperationT = TypeVar(
    "AnyFailedRequestOperationT", bound=AnyFailedRequestOperation
)
...
AnySuccessfulRequestOperation = Union[
    ...
    ReadSuccessfulRequestOperation[OptionalAnyAuthenticationT, OptionalAuthorizationT],
    UpdateSuccessfulRequestOperation[
        OptionalAnyAuthenticationT, OptionalAuthorizationT
    ],
    DeleteSuccessfulRequestOperation[
...
AnySuccessfulRequestOperationT = TypeVar(
    "AnySuccessfulRequestOperationT", bound=AnySuccessfulRequestOperation
)


AnyRequestOperation = Union[AnyFailedRequestOperation, AnySuccessfulRequestOperation]
AnyRequestOperationT = TypeVar("AnyRequestOperationT", bound=AnyRequestOperation)
