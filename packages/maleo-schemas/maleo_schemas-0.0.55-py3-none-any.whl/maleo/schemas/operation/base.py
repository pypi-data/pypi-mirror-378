...
from ..contexts.request import OptionalRequestContextT, RequestContextMixin
from ..contexts.response import OptionalResponseContextT, ResponseContextMixin
...
class BaseOperation(
    ...
    RequestContextMixin[OptionalRequestContextT],
