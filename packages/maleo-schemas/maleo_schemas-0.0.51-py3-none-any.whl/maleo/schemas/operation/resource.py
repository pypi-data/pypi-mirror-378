...
AnyFailedResourceOperation = Union[
    CreateFailedResourceOperation[
...
AnyFailedResourceOperationT = TypeVar(
    "AnyFailedResourceOperationT", bound=AnyFailedResourceOperation
)
