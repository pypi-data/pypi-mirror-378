...
ErrorResponseT = TypeVar("ErrorResponseT", bound=AllErrorResponse)
...
AllSuccessResponse = Union[
    AnyDataResponse[ModelDataT, OptionalPaginationT, MetadataT],
    NoDataResponse[MetadataT],
    SingleDataResponse[ModelDataT, MetadataT],
    CreateSingleDataResponse[ModelDataT, MetadataT],
    ReadSingleDataResponse[ModelDataT, MetadataT],
...
AllResponse = Union[AllErrorResponse, AllSuccessResponse]
