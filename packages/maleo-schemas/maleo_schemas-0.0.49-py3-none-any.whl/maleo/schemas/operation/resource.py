...
from ..contexts.request import OptionalRequestContext
...
AnyFailedResourceOperationType = Union[
    Type[
...
AllFailedResourceOperation = Union[
    CreateFailedResourceOperation[
...
AllFailedResourceOperationT = TypeVar(
    "AllFailedResourceOperationT", bound=AllFailedResourceOperation
)
...
class FailedFactory(
    ...
    ) -> AnyFailedResourceOperationType[
        AnyErrorT, OptionalAnyAuthenticationT, OptionalAuthorizationT, ErrorResponseT
    ]: ...
    @classmethod
    def operation_cls_from_action(
    ...
    def generate(
        ...
        *,
        ...
        summary: str,
        error: AnyErrorT,
        request_context: OptionalRequestContext = None,
