...
class TestHeySolClientLiveAPI:
    ...
    def test_live_search_knowledge_graph(self, live_client):
        ...
        try:
            ...
            print(
                f"✅ Live knowledge graph search completed: {len(result.get('nodes', []))} nodes found"
            )
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(
            "  pytest test_integration_live_api.py::TestHeySolClientLiveAPI::test_live_get_user_profile -v"
        )
