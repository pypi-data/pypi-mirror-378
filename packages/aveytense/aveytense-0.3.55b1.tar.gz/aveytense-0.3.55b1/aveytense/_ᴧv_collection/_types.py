...
class AVT_Slice(Generic[_T_start_cov, _T_stop_cov, _T_step_cov]):
    ...
    @overload
    def __new__(cls, start: None, stop: None = None, step: None = None, /) -> AVT_Slice[Any, Any, Any]: ...
    # unary overloads ------------------------------------------------------------------
    @overload
    def __new__(cls, stop: _T2, /) -> AVT_Slice[Any, _T2, Any]: ...
    # binary overloads -----------------------------------------------------------------
    @overload
    def __new__(cls, start: _T1, stop: None, step: None = None, /) -> AVT_Slice[_T1, Any, Any]: ...
    @overload
    def __new__(cls, start: None, stop: _T2, step: None = None, /) -> AVT_Slice[Any, _T2, Any]: ...
    @overload
    def __new__(cls, start: _T1, stop: _T2, step: None = None, /) -> AVT_Slice[_T1, _T2, Any]: ...
    # ternary overloads ----------------------------------------------------------------
    @overload
    def __new__(cls, start: None, stop: None, step: _T3, /) -> AVT_Slice[Any, Any, _T3]: ...
    @overload
    def __new__(cls, start: _T1, stop: None, step: _T3, /) -> AVT_Slice[_T1, Any, _T3]: ...
    @overload
    def __new__(cls, start: None, stop: _T2, step: _T3, /) -> AVT_Slice[Any, _T2, _T3]: ...
    @overload
    def __new__(cls, start: _T1, stop: _T2, step: _T3, /) -> AVT_Slice[_T1, _T2, _T3]: ...
...
# 'itertools', 0.3.55a2+
class AVT_Accumulate(Generic[_T]):
...
class AVT_Product(product, AVT_Iterable[_T_cov]):
