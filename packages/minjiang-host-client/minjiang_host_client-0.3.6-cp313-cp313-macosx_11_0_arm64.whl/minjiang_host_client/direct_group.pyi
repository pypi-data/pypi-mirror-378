...
class DirectGroup(CloudGroup):
    ...
    def __init__(self, group_name: str = None, space_name: str = None, space_version: int = None, space_parameters: dict[str, Any] = None, temporary_parameters: dict[str, Any] = None, direct_server_port: int = 6887) -> None: ...
    def submit_direct_exp(self, exp_obj: Experiment, reg_cloud_exp_id: bool = False, task_id: int = None) -> int: ...
    def pull_direct_result(self, direct_exp_id: int, waiting_for_finished: bool = True, timeout: int = 300) -> Result | None: ...
    def reg_exp_id(self, task_id: int, exp_obj: Experiment = None, data_shape: dict = None, title: str = None, desc: str = None, space_timestamp: int = None): ...
    ...
    def fit_tbl(self, exp_id: int, device_group_name: str, create_time: int, data: dict = None): ...
    def submit_fit(self, task_id: int, exp_id: int, fit_png: str, fit_tbl: str, space_parameters: dict = None): ...
    def terminate_direct_exp(self, direct_exp_id: int = None) -> bool: ...
