...
from .input_signal_subsampled import SubsampledSignal, Signal
from .utils import bin_to_dec, qary_vec_to_dec, sort_qary_vecs, calc_hamming_weight, dec_to_qary_vec, load_data
...
class QSFT(Signal):
    ...
    def transform(self, signal, verbosity=0, report=False, timing_verbose=False, **kwargs):
        ...
        if isinstance(signal, SubsampledSignal):
            ...
            raise NotImplementedError("fourier currently only supports signals that inherit from SubsampledSignal")
