...
class DevtronConfigMapSecret:
    ...
    def update_base_cm_cs(self, config_data: dict = None, config_approval_in_base_config_map=None,config_approval_in_base_secret=None):
        ...
        # print(cm_to_update_data)
        # print(cm_to_create_data)
        # print(cm_to_delete)
