...
class KnowledgeEntity(BaseModel):
    ...
    soruce_id: Optional[StrictStr] = None
    source_updated_at: Optional[StrictInt] = None
    ts_updated: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["client_id", "data", "ext", "extra", "kind", "name", "relations", "schema", "soruce_id", "source_updated_at", "ts_updated"]
