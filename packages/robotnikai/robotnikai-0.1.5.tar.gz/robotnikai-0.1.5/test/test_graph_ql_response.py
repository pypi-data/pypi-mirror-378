    ...
    def make_instance(self, include_optional) -> GraphQLResponse:
        ...
        if include_optional:
            return GraphQLResponse(
                data = {"listCities":{"items":[{"id":"123","name":"New York","area":783.8},{"id":"124","name":"Los Angeles","area":1302.15}],"paginationInfo":{"page":1,"limit":10,"totalItems":50,"totalPages":5,"hasNextPage":true,"hasPreviousPage":false}}},
                errors = [
