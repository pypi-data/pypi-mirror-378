...
class MongoMigration(BaseModel):
    ...
    collection_name: Annotated[str, Field(strict=True, max_length=150)]
    migration_name: Annotated[str, Field(strict=True, max_length=150)]
    old_schema: Optional[Any] = None
    new_schema: Optional[Any] = None
    old_unique_together: Optional[Any] = None
    new_unique_together: Optional[Any] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "collection_name", "migration_name", "old_schema", "new_schema", "old_unique_together", "new_unique_together", "renamed", "added", "removed", "changed", "task_id", "type_conversion_policy", "created_at", "application"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MongoMigration from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if old_unique_together (nullable) is None
        # and model_fields_set contains the field
        if self.old_unique_together is None and "old_unique_together" in self.model_fields_set:
            _dict['old_unique_together'] = None

        # set to None if new_unique_together (nullable) is None
        # and model_fields_set contains the field
        if self.new_unique_together is None and "new_unique_together" in self.model_fields_set:
            _dict['new_unique_together'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MongoMigration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "old_unique_together": obj.get("old_unique_together"),
            "new_unique_together": obj.get("new_unique_together"),
