...
class PatchedCsvExportRequest(BaseModel):
    """
    PatchedCsvExportRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["collection_name", "file", "task_id", "application", "user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchedCsvExportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchedCsvExportRequest from a dict"""
        if obj is None:
            return None
