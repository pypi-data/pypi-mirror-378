...
class PatchedMongoMigrationRequest(BaseModel):
    """
    PatchedMongoMigrationRequest
    """ # noqa: E501
    ...
    migration_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=150)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatchedMongoMigrationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatchedMongoMigrationRequest from a dict"""
        if obj is None:
            return None
