...
class IntegrationsSocialAccountsApi:
    ...
    def get_oauth_accounts(
        ...
        List all connected social accounts for user's organization.
        ...
        _param = self._get_oauth_accounts_serialize(
    ...
    @validate_call
    def get_oauth_accounts_with_http_info(
        self,
        integration_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_oauth_accounts_without_preload_content(
        self,
        integration_id: Annotated[str, Field(strict=True)],
        _request_timeout: Union[
            None,
    ...
    def _get_oauth_accounts_serialize(
        self,
        integration_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/integrations/{integration_id}/accounts/',
