...
class CsvExport(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "collection_name", "file", "task_id", "created_at", "file_upload_at", "application", "organization"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CsvExport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CsvExport from a dict"""
        if obj is None:
            return None
