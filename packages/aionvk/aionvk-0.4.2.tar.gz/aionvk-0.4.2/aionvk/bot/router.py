...
class Router:
    ...
    def _prepare_and_wrap_filters(self, custom_filters: tuple, kwargs: Dict[str, Any]) -> BaseFilter:
        """
        ...
        for f in custom_filters:
            if isinstance(f, MagicFilter):
                ...
                raise TypeError(f"Недопустимый тип фильтра: {type(f)}. Ожидался BaseFilter или MagicFilter.")
