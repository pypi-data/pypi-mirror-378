...
class IdentityVerification:
    ...
    def extract_front_id_info(self, front_id, country, nationality):
        ...
        if country == 'QAT':
            ...
            from idvpackage.common import load_and_process_image_deepface_serial
            ...
            try:
                ...
                front_face_locations, front_face_encodings = load_and_process_image_deepface_serial(front_id)
