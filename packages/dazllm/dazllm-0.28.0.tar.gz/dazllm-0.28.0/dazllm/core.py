...
class Llm:
    ...
    def cli(cls):
        ...
        Returns an LlmCliMeta instance that automatically tries all available CLI providers
        and captures comprehensive execution logs.

        Returns:
            LlmCliMeta: Meta-provider with logging for codex, gemini, and claude CLIs
        """
        from .llm_cli_interface import LlmCliMeta
