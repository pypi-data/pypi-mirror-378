...
class ZaloAPI(object):
	...
	def _encode(self, params):
		return _util.encodeAES(params, self._state._config.get("secret_key"))
		
	def _decode(self, params):
		return _util.decodeAES(params, self._state._config.get("secret_key")) 
	...
	async def _handler_listen(self, data):
		...
		try:
			...
			parsed_data = _util.decodeZWS(parsed, self.ws_key)
