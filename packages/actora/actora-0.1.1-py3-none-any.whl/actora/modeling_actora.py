...
AutoConfig.register("actora", ActoraConfig)
AutoModel.register(ActoraConfig, ActoraModel)
AutoModelForSequenceClassification.register(ActoraConfig, ActoraForSequenceClassification)