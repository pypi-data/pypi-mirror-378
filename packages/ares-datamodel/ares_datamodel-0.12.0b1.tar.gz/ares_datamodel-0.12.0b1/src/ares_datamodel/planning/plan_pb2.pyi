...
class PlanningRequest(_message.Message):
    __slots__ = ("planning_parameters", "adapter_settings")
    ...
    def __init__(self, planning_parameters: _Optional[_Iterable[_Union[PlanningParameter, _Mapping]]] = ..., adapter_settings: _Optional[_Union[_ares_struct_pb2.AresStruct, _Mapping]] = ...) -> None: ...
...
class PlanningParameter(_message.Message):
    __slots__ = ("parameter_name", "minimum_value", "maximum_value", "minimum_precision", "parameter_history", "analysis_results", "data_type", "metadata", "is_planned", "is_result", "planner_name")
    ...
    parameter_history: _containers.RepeatedCompositeFieldContainer[_ares_struct_pb2.AresValue]
    ...
    is_result: bool
    planner_name: str
    def __init__(self, parameter_name: _Optional[str] = ..., minimum_value: _Optional[float] = ..., maximum_value: _Optional[float] = ..., minimum_precision: _Optional[float] = ..., parameter_history: _Optional[_Iterable[_Union[_ares_struct_pb2.AresValue, _Mapping]]] = ..., analysis_results: _Optional[_Iterable[float]] = ..., data_type: _Optional[_Union[_ares_data_type_pb2.AresDataType, str]] = ..., metadata: _Optional[_Union[PlannerMetadata, _Mapping]] = ..., is_planned: bool = ..., is_result: bool = ..., planner_name: _Optional[str] = ...) -> None: ...
