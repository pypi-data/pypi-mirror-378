...
from src.config.config import NamesEnum
...
from src.helpers.common.formatting.number_formatting import truncate_number
...
from src.helpers.common.processing.collections_processing import generate_group_from_list
from src.helpers.common.processing.data_cleaning import (
    clean_dataframe_integers,
)

from src.helpers.common.validation.proportionality_data_validation import (
    get_valids_codes_from_description,
    build_subdatasets,
)
from src.models import SpProportionality, SpDescription, SpValue, SpComposition
from src.validators.spreadsheets.base.validator_model_abc import (
    ValidatorModelABC,
)
from src.helpers.common.formatting.number_formatting import format_number_brazilian
