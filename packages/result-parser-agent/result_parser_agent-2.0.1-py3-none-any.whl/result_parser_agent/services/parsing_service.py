...
class ParsingService(BaseService):
    ...
    def cleanup(self) -> None:
        ...
        self.logger.info("Cleaning up parsing service")
    ...
    def analyze_results(
        ...
        if expected_metrics:
            missing_metrics = set(expected_metrics) - set(analysis["extracted_metrics"])
            unexpected_metrics = set(analysis["extracted_metrics"]) - set(
                expected_metrics
            )
