...
class DataCategory(str, Enum):
    ...
    FINANCE = "finance"          # Financial markets and instruments
    TECHNOLOGY = "technology"    # Technology sector events
...
class OracleRoutingResponse(BaseModel):
    ...
    market_labels: Optional[List[str]] = Field(None, description="Market category labels for classification")
