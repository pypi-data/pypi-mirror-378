...
class AssetManager:
    ...
    def __init__(self, templates_dir: str):
        ...
        # Use docs folder for images (logo and favicon)
        # Get the DeepBridge root directory (2 levels up from templates: templates -> deepbridge -> DeepBridge)
        deepbridge_root = os.path.dirname(os.path.dirname(self.templates_dir))
        self.images_dir = os.path.join(deepbridge_root, 'docs', 'assets', 'images')
