...
from ....types.api.v1 import member_list_params, member_create_params, member_update_params
from ....types.api.v1.get_member_response import GetMemberResponse
from ....types.api.v1.member_list_response import MemberListResponse
from ....types.api.v1.member_create_response import MemberCreateResponse
...
class MembersResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        id: str | Omit = omit,
        create_time: Union[str, datetime] | Omit = omit,
        email: str | Omit = omit,
        ...
        user_profile: member_create_params.UserProfile | Omit = omit,
