...
class TestContexts:
    ...
    def test_method_create(self, client: ScalekitDemo) -> None:
        context = client.api.v1.environments.contexts.create(
    ...
    def test_raw_response_create(self, client: ScalekitDemo) -> None:
        response = client.api.v1.environments.contexts.with_raw_response.create(
            environment_id="environment_id",
            body={},
        )
    ...
    def test_streaming_response_create(self, client: ScalekitDemo) -> None:
        with client.api.v1.environments.contexts.with_streaming_response.create(
            environment_id="environment_id",
            body={},
        ) as response:
    ...
    def test_path_params_create(self, client: ScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `environment_id` but received ''"):
            client.api.v1.environments.contexts.with_raw_response.create(
                environment_id="",
                body={},
            )
    ...
    def test_method_list(self, client: ScalekitDemo) -> None:
        context = client.api.v1.environments.contexts.list(
            "environment_id",
        )
    ...
    def test_raw_response_list(self, client: ScalekitDemo) -> None:
        response = client.api.v1.environments.contexts.with_raw_response.list(
            "environment_id",
        )
    ...
    def test_streaming_response_list(self, client: ScalekitDemo) -> None:
        with client.api.v1.environments.contexts.with_streaming_response.list(
            "environment_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: ScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `environment_id` but received ''"):
            client.api.v1.environments.contexts.with_raw_response.list(
                "",
            )
...
class TestAsyncContexts:
    ...
    async def test_method_create(self, async_client: AsyncScalekitDemo) -> None:
        context = await async_client.api.v1.environments.contexts.create(
            environment_id="environment_id",
            body={},
        )
        assert context is None
    ...
    async def test_raw_response_create(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.environments.contexts.with_raw_response.create(
            environment_id="environment_id",
            body={},
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.environments.contexts.with_streaming_response.create(
            environment_id="environment_id",
            body={},
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_create(self, async_client: AsyncScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `environment_id` but received ''"):
            await async_client.api.v1.environments.contexts.with_raw_response.create(
                environment_id="",
                body={},
            )
    ...
    async def test_method_list(self, async_client: AsyncScalekitDemo) -> None:
        context = await async_client.api.v1.environments.contexts.list(
            "environment_id",
        )
        assert_matches_type(ContextListResponse, context, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.environments.contexts.with_raw_response.list(
            "environment_id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.environments.contexts.with_streaming_response.list(
            "environment_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `environment_id` but received ''"):
            await async_client.api.v1.environments.contexts.with_raw_response.list(
                "",
            )
