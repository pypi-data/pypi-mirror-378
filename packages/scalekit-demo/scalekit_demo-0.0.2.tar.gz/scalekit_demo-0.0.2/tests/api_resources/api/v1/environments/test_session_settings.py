...
class TestSessionSettings:
    ...
    def test_method_retrieve_session_settings(self, client: ScalekitDemo) -> None:
        session_setting = client.api.v1.environments.session_settings.retrieve_session_settings(
            "id",
        )
    ...
    def test_raw_response_retrieve_session_settings(self, client: ScalekitDemo) -> None:
        response = client.api.v1.environments.session_settings.with_raw_response.retrieve_session_settings(
            "id",
        )
    ...
    def test_streaming_response_retrieve_session_settings(self, client: ScalekitDemo) -> None:
        with client.api.v1.environments.session_settings.with_streaming_response.retrieve_session_settings(
            "id",
        ) as response:
    ...
    def test_path_params_retrieve_session_settings(self, client: ScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v1.environments.session_settings.with_raw_response.retrieve_session_settings(
                "",
            )
    ...
    def test_method_session_settings(self, client: ScalekitDemo) -> None:
        session_setting = client.api.v1.environments.session_settings.session_settings(
            id="id",
        )
    ...
    def test_method_session_settings_with_all_params(self, client: ScalekitDemo) -> None:
        session_setting = client.api.v1.environments.session_settings.session_settings(
            ...
            client_access_token_expiry=0,
            cookie_custom_domain="cookie_custom_domain",
            cookie_persistence_type=0,
            cookie_same_site_setting=0,
    ...
    def test_raw_response_session_settings(self, client: ScalekitDemo) -> None:
        response = client.api.v1.environments.session_settings.with_raw_response.session_settings(
            id="id",
        )
    ...
    def test_streaming_response_session_settings(self, client: ScalekitDemo) -> None:
        with client.api.v1.environments.session_settings.with_streaming_response.session_settings(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_session_settings(self, client: ScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v1.environments.session_settings.with_raw_response.session_settings(
                id="",
            )
    ...
    def test_method_update_session_settings(self, client: ScalekitDemo) -> None:
        session_setting = client.api.v1.environments.session_settings.update_session_settings(
            id="id",
        )
    ...
    def test_raw_response_update_session_settings(self, client: ScalekitDemo) -> None:
        response = client.api.v1.environments.session_settings.with_raw_response.update_session_settings(
            id="id",
        )
    ...
    def test_streaming_response_update_session_settings(self, client: ScalekitDemo) -> None:
        with client.api.v1.environments.session_settings.with_streaming_response.update_session_settings(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_update_session_settings(self, client: ScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v1.environments.session_settings.with_raw_response.update_session_settings(
                id="",
            )
...
class TestAsyncSessionSettings:
    ...
    async def test_method_retrieve_session_settings(self, async_client: AsyncScalekitDemo) -> None:
        session_setting = await async_client.api.v1.environments.session_settings.retrieve_session_settings(
            "id",
        )
        assert_matches_type(SessionSettingRetrieveSessionSettingsResponse, session_setting, path=["response"])
    ...
    async def test_raw_response_retrieve_session_settings(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.environments.session_settings.with_raw_response.retrieve_session_settings(
            "id",
        )
    ...
    async def test_streaming_response_retrieve_session_settings(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.environments.session_settings.with_streaming_response.retrieve_session_settings(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve_session_settings(self, async_client: AsyncScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v1.environments.session_settings.with_raw_response.retrieve_session_settings(
                "",
            )
    ...
    async def test_method_session_settings(self, async_client: AsyncScalekitDemo) -> None:
        session_setting = await async_client.api.v1.environments.session_settings.session_settings(
            id="id",
        )
        assert_matches_type(SessionSettingSessionSettingsResponse, session_setting, path=["response"])
    ...
    async def test_raw_response_session_settings(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.environments.session_settings.with_raw_response.session_settings(
            id="id",
        )
    ...
    async def test_streaming_response_session_settings(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.environments.session_settings.with_streaming_response.session_settings(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_session_settings(self, async_client: AsyncScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v1.environments.session_settings.with_raw_response.session_settings(
                id="",
            )
    ...
    async def test_method_update_session_settings(self, async_client: AsyncScalekitDemo) -> None:
        session_setting = await async_client.api.v1.environments.session_settings.update_session_settings(
            id="id",
        )
        assert_matches_type(SessionSettingUpdateSessionSettingsResponse, session_setting, path=["response"])
    ...
    async def test_raw_response_update_session_settings(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.environments.session_settings.with_raw_response.update_session_settings(
            id="id",
        )
    ...
    async def test_streaming_response_update_session_settings(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.environments.session_settings.with_streaming_response.update_session_settings(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update_session_settings(self, async_client: AsyncScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v1.environments.session_settings.with_raw_response.update_session_settings(
                id="",
            )
