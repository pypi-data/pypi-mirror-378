...
from scalekit_demo.types.api.v1.organizations.users import RoleListResponse, RoleCreateResponse
...
class TestRoles:
    ...
    def test_method_create(self, client: ScalekitDemo) -> None:
        role = client.api.v1.organizations.users.roles.create(
            user_id="user_id",
    ...
    def test_raw_response_create(self, client: ScalekitDemo) -> None:
        response = client.api.v1.organizations.users.roles.with_raw_response.create(
            user_id="user_id",
            organization_id="organization_id",
        )
    ...
    def test_streaming_response_create(self, client: ScalekitDemo) -> None:
        with client.api.v1.organizations.users.roles.with_streaming_response.create(
            user_id="user_id",
            organization_id="organization_id",
        ) as response:
    ...
    def test_path_params_create(self, client: ScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            client.api.v1.organizations.users.roles.with_raw_response.create(
                user_id="user_id",
                organization_id="",
            )
    ...
    def test_method_list(self, client: ScalekitDemo) -> None:
        role = client.api.v1.organizations.users.roles.list(
            user_id="user_id",
            organization_id="organization_id",
        )
    ...
    def test_raw_response_list(self, client: ScalekitDemo) -> None:
        response = client.api.v1.organizations.users.roles.with_raw_response.list(
            user_id="user_id",
            organization_id="organization_id",
        )
    ...
    def test_streaming_response_list(self, client: ScalekitDemo) -> None:
        with client.api.v1.organizations.users.roles.with_streaming_response.list(
            user_id="user_id",
            organization_id="organization_id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_list(self, client: ScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            client.api.v1.organizations.users.roles.with_raw_response.list(
                user_id="user_id",
                organization_id="",
            )
    ...
    def test_method_delete(self, client: ScalekitDemo) -> None:
        role = client.api.v1.organizations.users.roles.delete(
            role_name="role_name",
            organization_id="organization_id",
            user_id="user_id",
        )
    ...
    def test_raw_response_delete(self, client: ScalekitDemo) -> None:
        response = client.api.v1.organizations.users.roles.with_raw_response.delete(
            role_name="role_name",
            organization_id="organization_id",
            user_id="user_id",
        )
    ...
    def test_streaming_response_delete(self, client: ScalekitDemo) -> None:
        with client.api.v1.organizations.users.roles.with_streaming_response.delete(
            role_name="role_name",
            organization_id="organization_id",
            user_id="user_id",
        ) as response:
    ...
    def test_path_params_delete(self, client: ScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            client.api.v1.organizations.users.roles.with_raw_response.delete(
                role_name="role_name",
                organization_id="",
                user_id="user_id",
            )
...
class TestAsyncRoles:
    ...
    async def test_method_create(self, async_client: AsyncScalekitDemo) -> None:
        role = await async_client.api.v1.organizations.users.roles.create(
            user_id="user_id",
            organization_id="organization_id",
        )
        assert_matches_type(RoleCreateResponse, role, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.organizations.users.roles.with_raw_response.create(
            user_id="user_id",
            organization_id="organization_id",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.organizations.users.roles.with_streaming_response.create(
            user_id="user_id",
            organization_id="organization_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_create(self, async_client: AsyncScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            await async_client.api.v1.organizations.users.roles.with_raw_response.create(
                user_id="user_id",
                organization_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncScalekitDemo) -> None:
        role = await async_client.api.v1.organizations.users.roles.list(
            user_id="user_id",
            organization_id="organization_id",
        )
        assert_matches_type(RoleListResponse, role, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.organizations.users.roles.with_raw_response.list(
            user_id="user_id",
            organization_id="organization_id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.organizations.users.roles.with_streaming_response.list(
            user_id="user_id",
            organization_id="organization_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            await async_client.api.v1.organizations.users.roles.with_raw_response.list(
                user_id="user_id",
                organization_id="",
            )
    ...
    async def test_method_delete(self, async_client: AsyncScalekitDemo) -> None:
        role = await async_client.api.v1.organizations.users.roles.delete(
            role_name="role_name",
            organization_id="organization_id",
            user_id="user_id",
        )
    ...
    async def test_raw_response_delete(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.organizations.users.roles.with_raw_response.delete(
            role_name="role_name",
            organization_id="organization_id",
            user_id="user_id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.organizations.users.roles.with_streaming_response.delete(
            role_name="role_name",
            organization_id="organization_id",
            user_id="user_id",
        ) as response:
    ...
    async def test_path_params_delete(self, async_client: AsyncScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `organization_id` but received ''"):
            await async_client.api.v1.organizations.users.roles.with_raw_response.delete(
                role_name="role_name",
                organization_id="",
                user_id="user_id",
            )
