...
class TestFsa:
    ...
    def test_method_disable(self, client: ScalekitDemo) -> None:
        fsa = client.api.v1.features.fsa.disable(
            body={},
        )
        assert fsa is None
    ...
    def test_raw_response_disable(self, client: ScalekitDemo) -> None:
        response = client.api.v1.features.fsa.with_raw_response.disable(
            body={},
        )
    ...
    def test_streaming_response_disable(self, client: ScalekitDemo) -> None:
        with client.api.v1.features.fsa.with_streaming_response.disable(
            body={},
        ) as response:
    ...
    def test_method_enable(self, client: ScalekitDemo) -> None:
        fsa = client.api.v1.features.fsa.enable()
        assert fsa is None
    ...
    def test_raw_response_enable(self, client: ScalekitDemo) -> None:
        response = client.api.v1.features.fsa.with_raw_response.enable()
    ...
    def test_streaming_response_enable(self, client: ScalekitDemo) -> None:
        with client.api.v1.features.fsa.with_streaming_response.enable() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncFsa:
    ...
    async def test_method_disable(self, async_client: AsyncScalekitDemo) -> None:
        fsa = await async_client.api.v1.features.fsa.disable(
            body={},
        )
        assert fsa is None
    ...
    async def test_raw_response_disable(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.features.fsa.with_raw_response.disable(
            body={},
        )
    ...
    async def test_streaming_response_disable(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.features.fsa.with_streaming_response.disable(
            body={},
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_enable(self, async_client: AsyncScalekitDemo) -> None:
        fsa = await async_client.api.v1.features.fsa.enable()
        assert fsa is None
    ...
    async def test_raw_response_enable(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.features.fsa.with_raw_response.enable()
    ...
    async def test_streaming_response_enable(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.features.fsa.with_streaming_response.enable() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
