...
class TestMembers:
    ...
    def test_method_create(self, client: ScalekitDemo) -> None:
        member = client.api.v1.members.create()
    ...
    def test_raw_response_create(self, client: ScalekitDemo) -> None:
        response = client.api.v1.members.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: ScalekitDemo) -> None:
        with client.api.v1.members.with_streaming_response.create() as response:
    ...
    def test_method_retrieve(self, client: ScalekitDemo) -> None:
        member = client.api.v1.members.retrieve(
            "id",
        )
        assert_matches_type(GetMemberResponse, member, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_retrieve(self, client: ScalekitDemo) -> None:
        response = client.api.v1.members.with_raw_response.retrieve(
            "id",
        )
    ...
    def test_streaming_response_retrieve(self, client: ScalekitDemo) -> None:
        with client.api.v1.members.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: ScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v1.members.with_raw_response.retrieve(
                "",
            )
    ...
    def test_method_update(self, client: ScalekitDemo) -> None:
        member = client.api.v1.members.update(
            id="id",
        )
        assert_matches_type(UpdateMemberResponse, member, path=["response"])
    ...
    def test_raw_response_update(self, client: ScalekitDemo) -> None:
        response = client.api.v1.members.with_raw_response.update(
            id="id",
        )
    ...
    def test_streaming_response_update(self, client: ScalekitDemo) -> None:
        with client.api.v1.members.with_streaming_response.update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_update(self, client: ScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v1.members.with_raw_response.update(
                id="",
            )
    ...
    def test_method_list(self, client: ScalekitDemo) -> None:
        member = client.api.v1.members.list()
    ...
    def test_raw_response_list(self, client: ScalekitDemo) -> None:
        response = client.api.v1.members.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: ScalekitDemo) -> None:
        with client.api.v1.members.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: ScalekitDemo) -> None:
        member = client.api.v1.members.delete(
            "id",
        )
    ...
    def test_raw_response_delete(self, client: ScalekitDemo) -> None:
        response = client.api.v1.members.with_raw_response.delete(
            "id",
        )
    ...
    def test_streaming_response_delete(self, client: ScalekitDemo) -> None:
        with client.api.v1.members.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: ScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v1.members.with_raw_response.delete(
                "",
            )
...
class TestAsyncMembers:
    ...
    async def test_method_create(self, async_client: AsyncScalekitDemo) -> None:
        member = await async_client.api.v1.members.create()
        assert_matches_type(MemberCreateResponse, member, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.members.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.members.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_retrieve(self, async_client: AsyncScalekitDemo) -> None:
        member = await async_client.api.v1.members.retrieve(
            "id",
        )
        assert_matches_type(GetMemberResponse, member, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.members.with_raw_response.retrieve(
            "id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.members.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v1.members.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_method_update(self, async_client: AsyncScalekitDemo) -> None:
        member = await async_client.api.v1.members.update(
            id="id",
        )
        assert_matches_type(UpdateMemberResponse, member, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.members.with_raw_response.update(
            id="id",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.members.with_streaming_response.update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update(self, async_client: AsyncScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v1.members.with_raw_response.update(
                id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncScalekitDemo) -> None:
        member = await async_client.api.v1.members.list()
        assert_matches_type(MemberListResponse, member, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.members.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.members.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncScalekitDemo) -> None:
        member = await async_client.api.v1.members.delete(
            "id",
        )
        assert member is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.members.with_raw_response.delete(
            "id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.members.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v1.members.with_raw_response.delete(
                "",
            )
