...
class TestScopes:
    ...
    def test_method_create(self, client: ScalekitDemo) -> None:
        scope = client.api.v1.environments.scopes.create(
            env_id="env_id",
        )
    ...
    def test_raw_response_create(self, client: ScalekitDemo) -> None:
        response = client.api.v1.environments.scopes.with_raw_response.create(
            env_id="env_id",
        )
    ...
    def test_streaming_response_create(self, client: ScalekitDemo) -> None:
        with client.api.v1.environments.scopes.with_streaming_response.create(
            env_id="env_id",
        ) as response:
    ...
    def test_path_params_create(self, client: ScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `env_id` but received ''"):
            client.api.v1.environments.scopes.with_raw_response.create(
                env_id="",
            )
    ...
    def test_method_list(self, client: ScalekitDemo) -> None:
        scope = client.api.v1.environments.scopes.list(
            "env_id",
        )
    ...
    def test_raw_response_list(self, client: ScalekitDemo) -> None:
        response = client.api.v1.environments.scopes.with_raw_response.list(
            "env_id",
        )
    ...
    def test_streaming_response_list(self, client: ScalekitDemo) -> None:
        with client.api.v1.environments.scopes.with_streaming_response.list(
            "env_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: ScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `env_id` but received ''"):
            client.api.v1.environments.scopes.with_raw_response.list(
                "",
            )
...
class TestAsyncScopes:
    ...
    async def test_method_create(self, async_client: AsyncScalekitDemo) -> None:
        scope = await async_client.api.v1.environments.scopes.create(
            env_id="env_id",
        )
        assert_matches_type(CreateScopeResponse, scope, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.environments.scopes.with_raw_response.create(
            env_id="env_id",
        )
    ...
    async def test_streaming_response_create(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.environments.scopes.with_streaming_response.create(
            env_id="env_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_create(self, async_client: AsyncScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `env_id` but received ''"):
            await async_client.api.v1.environments.scopes.with_raw_response.create(
                env_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncScalekitDemo) -> None:
        scope = await async_client.api.v1.environments.scopes.list(
            "env_id",
        )
        assert_matches_type(ListScopesResponse, scope, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncScalekitDemo) -> None:
        response = await async_client.api.v1.environments.scopes.with_raw_response.list(
            "env_id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncScalekitDemo) -> None:
        async with async_client.api.v1.environments.scopes.with_streaming_response.list(
            "env_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncScalekitDemo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `env_id` but received ''"):
            await async_client.api.v1.environments.scopes.with_raw_response.list(
                "",
            )
