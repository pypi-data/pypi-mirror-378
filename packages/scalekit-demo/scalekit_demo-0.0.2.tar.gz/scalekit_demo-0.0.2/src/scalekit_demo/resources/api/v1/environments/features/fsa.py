...
from ......types.api.v1.environments.features import fsa_enable_params
...
class FsaResource(SyncAPIResource):
    ...
    def enable(
        ...
        *,
        ...
        return self._post(
            f"/api/v1/environments/{path_id}/features/fsa/enable",
            body=maybe_transform({"body_id": body_id}, fsa_enable_params.FsaEnableParams),
    ...
    async def enable(
        ...
        *,
        ...
        return await self._post(
            f"/api/v1/environments/{path_id}/features/fsa/enable",
            body=await async_maybe_transform({"body_id": body_id}, fsa_enable_params.FsaEnableParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
