...
class RequestFailed(TException):
    ...
    def __init__(self, errorCode = None, message = None, extraInfo = None,):
        super(RequestFailed, self).__setattr__('errorCode', errorCode)
        super(RequestFailed, self).__setattr__('message', message)
        super(RequestFailed, self).__setattr__('extraInfo', extraInfo)
    ...
    def __hash__(self):
        return hash(self.__class__) ^ hash((self.errorCode, self.message, self.extraInfo, ))
