...
from maskinfo import SensitiveMasker, SensitiveDetector
...
def demonstrate_selective_masking():
    ...
    for scenario in scenarios:
        ...
        temp_patterns = {name: detector.patterns[name] for name in scenario['patterns'] if name in detector.patterns}
