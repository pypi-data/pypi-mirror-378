...
class TestAuthentication:
    ...
    def test_login_with_totp(self, mock_client_class: MagicMock, mock_get_config: MagicMock,
        ...
        assert result.exit_code == 0
        mock_client.login.assert_called_with("admin", "password", "123456")
    ...
    def test_whoami(self, mock_client_class: MagicMock, mock_get_config: MagicMock,
        ...
        assert "https://test.api" in result.output
...
class TestUserManagement:
    ...
    def test_users_list_with_filters(self, mock_client_class: MagicMock,
        ...
        mock_client = MagicMock()
        mock_client.is_token_valid.return_value = True
        mock_client.get_users.return_value = {"count": 0, "users": []}
        mock_client_class.return_value = mock_client
        ...
        assert call_args.kwargs["filter"] == "john"
    ...
    def test_users_list_json_output(self, mock_client_class: MagicMock,
        ...
        mock_client.get_users.return_value = {
            "count": 1,
            "users": [{"username": "test@example.com", "name": "Test User"}],
        }
        mock_client_class.return_value = mock_client
    ...
    def test_users_get(self, mock_client_class: MagicMock, mock_get_config: MagicMock,
        ...
        assert "daily_quota" in result.output
    ...
    def test_users_add(self, mock_client_class: MagicMock, mock_get_config: MagicMock,
        ...
        mock_client = MagicMock()
        mock_client.is_token_valid.return_value = True
        mock_client.add_user.return_value = {
    ...
    def test_users_update(self, mock_client_class: MagicMock, mock_get_config: MagicMock,
        ...
        mock_client = MagicMock()
        mock_client.is_token_valid.return_value = True
        mock_client.update_user.return_value = {"status": True}
        mock_client_class.return_value = mock_client
    ...
    def test_users_delete(self, mock_client_class: MagicMock, mock_get_config: MagicMock,
        ...
        mock_client = MagicMock()
        mock_client.is_token_valid.return_value = True
        mock_client.delete_user.return_value = {"status": True}
        mock_client_class.return_value = mock_client
    ...
    def test_users_reset_password(self, mock_client_class: MagicMock,
        ...
        mock_client = MagicMock()
        mock_client.is_token_valid.return_value = True
        mock_client.reset_user_password.return_value = {
            "status": True,
...
class TestProfileManagement:
    ...
    def test_profiles_list_with_filters(self, mock_client_class: MagicMock,
        ...
        mock_client = MagicMock()
        mock_client.is_token_valid.return_value = True
        mock_client.get_profiles.return_value = {"count": 0, "profiles": []}
        mock_client_class.return_value = mock_client
    ...
    def test_profiles_add(self, mock_client_class: MagicMock, mock_get_config: MagicMock,
        ...
        mock_client = MagicMock()
        mock_client.is_token_valid.return_value = True
        mock_client.add_profile.return_value = {"status": True}
        mock_client_class.return_value = mock_client
    ...
    def test_profiles_delete(self, mock_client_class: MagicMock,
        ...
        mock_client = MagicMock()
        mock_client.is_token_valid.return_value = True
        mock_client.delete_profile.return_value = {"status": True}
        mock_client_class.return_value = mock_client
...
class TestConfiguration:
    ...
    def test_config_roles_expert(self, mock_client_class: MagicMock,
        ...
        mock_client = MagicMock()
        mock_client.is_token_valid.return_value = True
        mock_client.get_roles_expert.return_value = {
            "roles": [
                {
                    "id": "analyst",
                    "label": "Analyst",
    ...
    def test_config_roles_detect(self, mock_client_class: MagicMock,
        ...
        mock_client = MagicMock()
        mock_client.is_token_valid.return_value = True
        mock_client.get_roles_detect.return_value = {
            "roles": [
                {
                    "id": "detect_submitter",
                    "label": "Submitter",
    ...
    def test_config_permissions_detect(self, mock_client_class: MagicMock,
        ...
        mock_client = MagicMock()
        mock_client.is_token_valid.return_value = True
        mock_client.get_permissions_detect.return_value = {
            "permissions": {
                "can_submit": {
                    "label": "Submit Files",
    ...
    def test_config_permissions_expert(self, mock_client_class: MagicMock,
        ...
        mock_client = MagicMock()
        mock_client.is_token_valid.return_value = True
        mock_client.get_permissions_expert.return_value = {
            "permissions": {
                "view_results": {
                    "label": "View Results",
...
class TestServiceManagement:
    ...
    def test_services_list_json(self, mock_client_class: MagicMock, mock_get_config: MagicMock,
        ...
        mock_client.is_token_valid.return_value = True
        mock_client.get_services.return_value = {
            "services": [{"name": "Service1", "enabled": True}],
        }
        mock_client_class.return_value = mock_client
    ...
    @patch("gmadmin.cli.get_config")
    @patch("gmadmin.cli.GlimpsAdminClient")
    def test_services_enable(self, mock_client_class: MagicMock, mock_get_config: MagicMock,
                             runner: CliRunner) -> None:
        """Test enabling a service."""
        mock_client = MagicMock()
        mock_client.is_token_valid.return_value = True
        mock_client.update_service.return_value = {"status": True}
        mock_client_class.return_value = mock_client
        ...
        result = runner.invoke(gcli, ["services", "enable", "TestService"])
        assert result.exit_code == 0
        assert "enabled" in result.output

        mock_client.update_service.assert_called_with("TestService", enabled=True)

    @patch("gmadmin.cli.get_config")
    @patch("gmadmin.cli.GlimpsAdminClient")
    def test_services_disable(self, mock_client_class: MagicMock, mock_get_config: MagicMock,
                              runner: CliRunner) -> None:
        ...
        result = runner.invoke(gcli, ["services", "disable", "TestService"])
        assert result.exit_code == 0
        assert "disabled" in result.output

        mock_client.update_service.assert_called_with("TestService", enabled=False)
...
class TestComplexScenarios:
    ...
    def test_multiple_operations_sequence(self, mock_client_class: MagicMock,
        ...
        mock_client.get_users.return_value = {"count": 1, "users": [{"username": "test@example.com"}]}
        mock_client.add_user.return_value = {"username": "new@example.com", "password": "Pass123!"}
        mock_client.get_profiles.return_value = {"count": 1, "profiles": [{"name": "profile1"}]}
    ...
    def test_pagination_parameters(self, mock_client_class: MagicMock,
        ...
        mock_client = MagicMock()
        mock_client.is_token_valid.return_value = True
        mock_client.get_users.return_value = {"count": 100, "users": []}
        mock_client.get_profiles.return_value = {"count": 50, "profiles": []}
        ...
        assert result.exit_code == 0
        mock_client.get_users.assert_called_with(filter=None, size=100, types=None, groups=None, tags=None)
