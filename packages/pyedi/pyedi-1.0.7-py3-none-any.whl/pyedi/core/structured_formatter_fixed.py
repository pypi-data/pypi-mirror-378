...
class StructuredFormatterFixed:
    """Fixed version of StructuredFormatter that handles multiple transactions properly"""
...
def format_structured_fixed(generic_json: Dict[str, Any], include_technical: bool = True) -> Union[Dict[str, Any], List[Dict[str, Any]]]:
    """
    Format generic X12 JSON to structured format (FIXED VERSION)
    ...
    Returns:
        Single structured JSON for single transaction, or list for multiple transactions
    """
    formatter = StructuredFormatterFixed()
