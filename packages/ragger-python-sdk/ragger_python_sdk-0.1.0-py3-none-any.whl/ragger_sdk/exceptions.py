...
from typing import Optional, Dict, Any        # Type hints for better code clarity
...
class RaggerAPIError(Exception):
    ...
    def is_server_error(self) -> bool:
        ...
        return self.code == ErrorCodes.UNEXPECTED_ERROR or (self.status_code and self.status_code >= 500)


def create_exception_from_response(response, request_data: Optional[Dict[str, Any]] = None) -> RaggerAPIError:
    """
