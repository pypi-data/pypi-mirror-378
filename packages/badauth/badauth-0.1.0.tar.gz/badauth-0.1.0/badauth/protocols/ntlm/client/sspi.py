from badauth.common.winapi.winsspi import WinSSPI, SSPIPackage
from badauth.common.winapi.constants import ISC_REQ, SSPIResult
from badauth.protocols.ntlm.client.native import NTLMClientNative
