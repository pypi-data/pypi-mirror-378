...
`},21554:(e,t,n)=>{n.r(t),n.d(t,{datasetReducer:()=>dt,default:()=>ht});var a=n(2445),i=n(96540),l=n(61574),o=n(79378),r=n(74098),s=n(75574),d=n(58561),c=n.n(d),h=n(91412);const p=(e,t)=>{const[n,a]=(0,i.useState)([]),l=t?encodeURIComponent(t):void 0,d=(0,i.useCallback)((async e=>{let t,n=[],i=0;for(;void 0===t||n.length<t;){const a=c().encode_uri({filters:e,page:i});try{const e=await o.A.get({endpoint:`/api/v1/dataset/?q=${a}`});({count:t}=e.json);const{json:{result:l}}=e;n=[...n,...l],i+=1}catch(e){(0,h.iB)((0,r.t)("There was an error fetching dataset")),s.A.error((0,r.t)("There was an error fetching dataset"),e)}}a(n)}),[]);(0,i.useEffect)((()=>{const n=[{col:"database",opr:"rel_o_m",value:null==e?void 0:e.id},{col:"schema",opr:"eq",value:l},{col:"sql",opr:"dataset_is_null_or_empty",value:!0}];t&&d(n)}),[null==e?void 0:e.id,t,l,d]);const p=(0,i.useMemo)((()=>null==n?void 0:n.map((e=>e.table_name))),[n]);return{datasets:n,datasetNames:p}};var u,m=n(73306),g=n(88217),b=n(8558),f=n(85600);!function(e){e[e.SelectDatabase=0]="SelectDatabase",e[e.SelectCatalog=1]="SelectCatalog",e[e.SelectSchema=2]="SelectSchema",e[e.SelectTable=3]="SelectTable",e[e.ChangeDataset=4]="ChangeDataset"}(u||(u={}));var v=n(50290),x=n(17437);const y=v.I4.div`
  flex-grow: 1;
  display: flex;
...
`,F=(0,r.t)("New dataset"),P={text:(0,r.t)("Select a database table and create dataset"),placement:"bottomRight"},N=()=>(0,a.FD)(g.$,{buttonStyle:"primary",tooltip:null==P?void 0:P.text,placement:null==P?void 0:P.placement,disabled:!0,css:E,children:[(0,a.Y)(b.F.SaveOutlined,{iconSize:"m"}),(0,r.t)("Save")]}),L=()=>(0,a.Y)(f.W1,{items:[{key:"settings",label:(0,r.t)("Settings")},{key:"delete",label:(0,r.t)("Delete")}]});function R({setDataset:e,title:t=F,editing:n=!1}){const i={title:null!=t?t:F,placeholder:F,onSave:t=>{e({type:u.ChangeDataset,payload:{name:"dataset_name",value:t}})},canEdit:!1,label:(0,r.t)("dataset name")};return(0,a.Y)(A,{children:n?(0,a.Y)(m.U,{editableTitleProps:i,showTitlePanelItems:!1,showFaveStar:!1,faveStarProps:{itemId:1,saveFaveStar:()=>{}},titlePanelAdditionalItems:(0,a.Y)(a.FK,{}),rightPanelAdditionalItems:N(),additionalActionsMenu:L(),menuDropdownProps:{disabled:!0},tooltipProps:P}):(0,a.Y)(I,{children:t||F})})}var M=n(13410),B=n(21325),O=n(71519),W=n(90924),H=n(18009),j=n(38134),q=n(89232),K=n(32023),X=n(64457),V=n(86784),G=n(59674),Q=n(8903),Z=n(95018);const J=v.I4.div`
  & > span {
    width: 100%;
    display: flex;
...
`;function ie({items:e,renderVisibleItem:t=e=>e,renderTooltipItem:n=e=>e,getKey:l=e=>e,maxLinks:o=20}){const[s,d,c,h]=(0,Q.A)(),p=(0,i.useMemo)((()=>e.length>o?e.length-o:void 0),[e,o]),u=(0,i.useMemo)((()=>(0,a.Y)(ee,{ref:s,children:e.map((e=>(0,a.Y)(te,{children:t(e)},l(e))))})),[l,e,t]),m=(0,i.useMemo)((()=>e.slice(0,o).map((e=>(0,a.Y)(ne,{children:n(e)},l(e))))),[l,e,o,n]);return(0,a.Y)(J,{children:(0,a.FD)(Z.m,{placement:"top",title:c?(0,a.FD)(a.FK,{children:[m,p&&(0,a.Y)("span",{children:(0,r.t)("+ %s more",p)})]}):null,children:[u,h&&(0,a.FD)(ae,{ref:d,children:["+",c]})]})})}const le=e=>({key:e.id,to:`/superset/dashboard/${e.id}`,target:"_blank",rel:"noreferer noopener",children:e.dashboard_title}),oe=e=>x.AH`
...
`,w=({editableTitleProps:e,showTitlePanelItems:t,certificatiedBadgeProps:n,showFaveStar:i,faveStarProps:d,titlePanelAdditionalItems:c,rightPanelAdditionalItems:h,additionalActionsMenu:p,menuDropdownProps:u,showMenuDropdown:w=!0,tooltipProps:S})=>{const z=(0,l.DP)();return(0,a.FD)("div",{css:x,className:"header-with-actions",children:[(0,a.FD)("div",{className:"title-panel",children:[(0,a.Y)(m,{...e}),t&&(0,a.FD)("div",{css:y,children:[(null==n?void 0:n.certifiedBy)&&(0,a.Y)(b.T,{...n}),i&&(0,a.Y)(s.$,{...d}),c]})]}),(0,a.FD)("div",{className:"right-button-panel",children:[h,(0,a.Y)("div",{css:$,children:w&&(0,a.Y)(g.ms,{trigger:["click"],popupRender:()=>p,...u,children:(0,a.Y)(f.$,{css:v,buttonStyle:"tertiary","aria-label":(0,o.t)("Menu actions trigger"),tooltip:null==S?void 0:S.text,placement:null==S?void 0:S.placement,children:(0,a.Y)(r.F.EllipsisOutlined,{iconColor:z.colorPrimary,iconSize:"l"})})})})]})]})}},81574:(e,t,n)=>{n.d(t,{g:()=>c});var a=n(20249),i=n.n(a),l=n(2445),o=n(88603),r=n(50290),s=n(17437),d=n(95018);const c=({popupRender:e,tooltip:t,tooltipPlacement:n,children:a,...c})=>{const h=(0,r.DP)(),{type:p}=c,u=s.AH`
  ...
  `,m=(0,l.Y)(o.A.Button,{popupRender:e,...c,css:[u,s.AH`
        ...
        `],children:a});return t?(0,l.Y)(d.m,{placement:n,id:`${i()(t)}-tooltip`,title:t,children:m}):m}},94083:(e,t,n)=>{n.d(t,{Ay:()=>w,Kt:()=>$,cs:()=>x});var a=n(2445),i=n(96540),l=n(50290),o=n(74098),r=n(59744),s=n(54569),d=n(23195),c=n(2801),h=n(89232),p=n(8558),u=n(9992),m=n(35273),g=n(64457),b=n(98244);const f=l.I4.div`
...
`,x=({table:e})=>{const{value:t,type:n,extra:i}=e;return(0,a.FD)(v,{title:t,children:["view"===n?(0,a.Y)(p.F.EyeOutlined,{iconSize:"m"}):(0,a.Y)(p.F.InsertRowAboveOutlined,{iconSize:"m"}),(null==i?void 0:i.certification)&&(0,a.Y)(s.T,{certifiedBy:i.certification.certified_by,details:i.certification.details,size:"l"}),(null==i?void 0:i.warning_markdown)&&(0,a.Y)(m.A,{warningMarkdown:i.warning_markdown,size:"l",marginRight:4}),t]})},y=({database:e,emptyState:t,formMode:n=!1,getDbList:l,handleError:s,isDatabaseSelectEnabled:p=!0,onDbChange:m,onCatalogChange:v,onSchemaChange:y,readOnly:$=!1,onEmptyResults:w,catalog:S,schema:z,sqlLabMode:Y=!0,tableSelectMode:C="single",tableValue:U,onTableSelectChange:I,customTableOptionLabelRenderer:T})=>{const{addSuccessToast:D}=(0,g.Yf)(),[_,k]=(0,i.useState)(S),[A,E]=(0,i.useState)(z),[F,P]=(0,i.useState)(void 0),{currentData:N,isFetching:L,refetch:R}=(0,b.ty)({dbId:null==e?void 0:e.id,catalog:_,schema:A,onSuccess:(e,t)=>{t&&D((0,o.t)("List updated"))},onError:e=>{(0,r.h4)(e).then((e=>{s((0,r.hi)((0,o.t)("There was an error loading the tables"),e))}))}}),M=(0,i.useMemo)((()=>N?N.options.map((e=>({value:e.value,label:T?T(e):(0,a.Y)(x,{table:e}),text:e.value}))):[]),[N,T]);(0,i.useEffect)((()=>{void 0===e&&(k(void 0),E(void 0),P(void 0))}),[e,C]),(0,i.useEffect)((()=>{P("single"===C?M.find((e=>e.value===U)):(null==M?void 0:M.filter((e=>e&&(null==U?void 0:U.includes(e.value)))))||[])}),[M,U,C]);const B=(0,i.useMemo)((()=>(e,t)=>{const n=e.trim().toLowerCase(),{value:a}=t;return a.toLowerCase().includes(n)}),[]);return(0,a.FD)(f,{children:[(0,a.Y)(h.RA,{db:e,emptyState:t,formMode:n,getDbList:l,handleError:s,onDbChange:$?void 0:e=>{m&&m(e),k(void 0),E(void 0),P("single"===C?void 0:[])},onEmptyResults:w,onCatalogChange:$?void 0:e=>{k(e),v&&v(e),E(void 0),P("single"===C?void 0:[])},catalog:_,onSchemaChange:$?void 0:e=>{E(e),y&&y(e),P("single"===C?void 0:[])},schema:A,sqlLabMode:Y,isDatabaseSelectEnabled:p&&!$,readOnly:$}),Y&&!n&&(0,a.Y)("div",{className:"divider"}),function(){const e=A&&!n&&$||!A,t=Y?(0,a.Y)(d.l,{children:(0,o.t)("See table schema")}):(0,a.Y)(d.l,{children:(0,o.t)("Table")});return i=(0,a.Y)(c.A,{ariaLabel:(0,o.t)("Select table or type to search tables"),disabled:e,filterOption:B,header:t,labelInValue:!0,loading:L,name:"select-table",onChange:e=>{return t=e,void(A?null==I||I(Array.isArray(t)?t.map((e=>null==e?void 0:e.value)):null==t?void 0:t.value,_,A):P(t));var t},options:M,placeholder:(0,o.t)("Select table or type to search tables"),showSearch:!0,mode:C,value:F,allowClear:"multiple"===C,allowSelectAll:!1}),l=!$&&(0,a.Y)(u.A,{onClick:()=>R(),tooltipContent:(0,o.t)("Force refresh table list")}),(0,a.FD)("div",{className:"section",children:[(0,a.Y)("span",{className:"select",children:i}),(0,a.Y)("span",{className:"refresh",children:l})]});var i,l}()]})},$=e=>(0,a.Y)(y,{tableSelectMode:"multiple",...e}),w=y}}]);