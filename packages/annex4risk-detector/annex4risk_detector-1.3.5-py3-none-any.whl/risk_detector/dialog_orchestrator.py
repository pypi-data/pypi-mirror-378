...
def classify_from_answers(answers: dict) -> dict:
    ...
    if not answers:
        return {"category": "minimal_risk", "score": 0.0, "legal_refs": [], "exception_applied": False, "obligations": []}
...
ARTICLE 49:\n{art49}\n\nANNEX VIII:\n{annex8}"""
            ...
            if isinstance(annex3_item, str) and annex3_item in all_items:
                ...
                res = {
                    ...
                    "obligations": _llm_obligations("high_risk", False) if category == "high_risk" else [],
                }
                return res
