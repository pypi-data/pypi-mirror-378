...
class FloorplanLoader:
    ...
    def acquire_usd(self, layout_id: int = None, style_id: int = None, *, scene: str = "robocasakitchen", backend="robocasa", cancel_previous_download: bool = True, version=None):
        try:
            self.check_version()
            ...
            self._latest_future = self.executor.submit(self.get_usd, scene, layout_id, style_id, backend, version=version)
    ...
    def get_usd(self, scene: str, layout_id: int = None, style_id: int = None, backend: str = "robocasa", version=None):
        try:
            return self._get_usd(scene, layout_id, style_id, backend=backend, version=version)
        except ApiException as e:
            print(e)
        finally:
            pass
    ...
    def _get_usd(self, scene: str, layout_id: int = None, style_id: int = None, backend: str = "robocasa", version=None):
        """
