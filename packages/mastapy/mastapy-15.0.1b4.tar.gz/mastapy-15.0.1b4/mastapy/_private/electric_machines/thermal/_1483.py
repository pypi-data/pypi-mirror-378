...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.thermal import _1484
...
class ThermalEndWinding(_0.APIBase):
    ...
    @property
    @exception_bridge
    def inner_surfaces(self: "Self") -> "_1484.ThermalEndWindingSurfaceCollection":
    ...
    @property
    @exception_bridge
    def outer_surfaces(self: "Self") -> "_1484.ThermalEndWindingSurfaceCollection":
        """mastapy.electric_machines.thermal.ThermalEndWindingSurfaceCollection
    ...
    @property
    @exception_bridge
    def side_surfaces(self: "Self") -> "_1484.ThermalEndWindingSurfaceCollection":
        """mastapy.electric_machines.thermal.ThermalEndWindingSurfaceCollection
