...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility_gui.charts import _2070, _2074
...
class ElectricMachineHarmonicLoadDataBase(_1568.SpeedDependentHarmonicLoadData):
    ...
    @property
    @exception_bridge
    def force_distribution_3d(self: "Self") -> "_2074.ThreeDVectorChartDefinition":
    ...
    @property
    @exception_bridge
    def rotor_x_force(self: "Self") -> "_1706.MultipleFourierSeriesInterpolator":
    ...
    @property
    @exception_bridge
    def rotor_y_force(self: "Self") -> "_1706.MultipleFourierSeriesInterpolator":
        """mastapy.math_utility.MultipleFourierSeriesInterpolator
