...
class TwodimensionalFunctionLookupTable(
    _1755.LookupTableBase["TwodimensionalFunctionLookupTable"]
):
    """TwodimensionalFunctionLookupTable
    ...
    @property
    @exception_bridge
    def lookup_table(self: "Self") -> "_1754.GriddedSurfaceAccessor":
    ...
    def lookup_table(self: "Self", value: "_1754.GriddedSurfaceAccessor") -> None:
