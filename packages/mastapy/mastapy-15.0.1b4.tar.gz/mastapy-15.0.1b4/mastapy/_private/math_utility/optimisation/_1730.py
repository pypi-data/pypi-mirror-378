...
class _Cast_Optimisable:
    ...
    @property
    def abstract_optimisable(self: "CastSelf") -> "_1727.AbstractOptimisable":
        return self.__parent__._cast(_1727.AbstractOptimisable)
...
class Optimisable(_1727.AbstractOptimisable):
    """Optimisable
