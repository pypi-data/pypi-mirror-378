...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1730
...
class _Cast_AbstractOptimisable:
    ...
    @property
    def optimisable(self: "CastSelf") -> "_1730.Optimisable":
        from mastapy._private.math_utility.optimisation import _1730

        return self.__parent__._cast(_1730.Optimisable)
