...
class OptimisationHistory(_0.APIBase):
    ...
    @property
    @exception_bridge
    def input_history(self: "Self") -> "List[_1734.OptimizationVariable]":
    ...
    @property
    @exception_bridge
    def target_history(self: "Self") -> "List[_1734.OptimizationVariable]":
        """List[mastapy.math_utility.optimisation.OptimizationVariable]
    ...
    def add_input_history(self: "Self", value: "_1734.OptimizationVariable") -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def add_target_history(self: "Self", value: "_1734.OptimizationVariable") -> None:
        """Method does not return.
