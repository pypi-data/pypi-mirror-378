...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization.machine_learning import _2459
...
class _Cast_OptimizationProperty:
    ...
    def cylindrical_gear_flank_optimisation_parameter(
        self: "CastSelf",
    ) -> "_2459.CylindricalGearFlankOptimisationParameter":
        from mastapy._private.system_model.optimization.machine_learning import _2459

        return self.__parent__._cast(_2459.CylindricalGearFlankOptimisationParameter)
