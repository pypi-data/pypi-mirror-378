...
class _Cast_ForceAndDisplacementResults:
    ...
    def abstract_force_and_displacement_results(
        self: "CastSelf",
    ) -> "_1748.AbstractForceAndDisplacementResults":
        return self.__parent__._cast(_1748.AbstractForceAndDisplacementResults)
...
class ForceAndDisplacementResults(_1748.AbstractForceAndDisplacementResults):
    """ForceAndDisplacementResults
    ...
    @property
    @exception_bridge
    def displacement(self: "Self") -> "_1753.VectorWithLinearAndAngularComponents":
