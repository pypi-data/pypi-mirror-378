...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.measured_vectors import _1749, _1750, _1753
...
class _Cast_AbstractForceAndDisplacementResults:
    ...
    def force_and_displacement_results(
        self: "CastSelf",
    ) -> "_1749.ForceAndDisplacementResults":
        from mastapy._private.math_utility.measured_vectors import _1749

        return self.__parent__._cast(_1749.ForceAndDisplacementResults)

    @property
    def force_results(self: "CastSelf") -> "_1750.ForceResults":
        from mastapy._private.math_utility.measured_vectors import _1750

        return self.__parent__._cast(_1750.ForceResults)
...
class AbstractForceAndDisplacementResults(_0.APIBase):
    ...
    @property
    @exception_bridge
    def force(self: "Self") -> "_1753.VectorWithLinearAndAngularComponents":
