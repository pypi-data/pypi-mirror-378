...
class PIDControlSettings(_0.APIBase):
    ...
    @property
    @exception_bridge
    def integral_gain_vs_time_and_error(self: "Self") -> "_1754.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @property
    @exception_bridge
    def update_method(self: "Self") -> "_1712.PIDControlUpdateMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1712", "PIDControlUpdateMethod"
        )(value)

    @update_method.setter
    @exception_bridge
    @enforce_parameter_types
    def update_method(self: "Self", value: "_1712.PIDControlUpdateMethod") -> None:
