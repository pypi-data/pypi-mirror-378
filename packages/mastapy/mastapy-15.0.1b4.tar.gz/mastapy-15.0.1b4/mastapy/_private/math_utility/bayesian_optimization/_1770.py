...
_ML1_OPTIMISER_SNAPSHOT = python_net_import(
    "SMT.MastaAPI.MathUtility.BayesianOptimization", "ML1OptimiserSnapshot"
)

if TYPE_CHECKING:
    from typing import Any, List, Type, TypeVar

    from mastapy._private.math_utility.bayesian_optimization import _1768, _1769, _1774
...
class ML1OptimiserSnapshot(_0.APIBase):
    ...
    @property
    @exception_bridge
    def optimization_stage(self: "Self") -> "_1774.OptimizationStage":
        """mastapy.math_utility.bayesian_optimization.OptimizationStage
        ...
        value = conversion.pn_to_mp_enum(
            temp, "SMT.MastaAPI.MathUtility.BayesianOptimization.OptimizationStage"
        )
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility.bayesian_optimization._1774",
            "OptimizationStage",
        )(value)

    @property
    @exception_bridge
    def constraint_values(self: "Self") -> "List[_1768.ConstraintResult]":
        """List[mastapy.math_utility.bayesian_optimization.ConstraintResult]
    ...
    @property
    @exception_bridge
    def input_values(self: "Self") -> "List[_1769.InputResult]":
        """List[mastapy.math_utility.bayesian_optimization.InputResult]
