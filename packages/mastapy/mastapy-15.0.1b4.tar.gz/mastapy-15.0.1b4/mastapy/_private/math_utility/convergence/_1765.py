...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.convergence import _1764
...
class _Cast_DataLogger:
    ...
    @property
    def convergence_logger(self: "CastSelf") -> "_1764.ConvergenceLogger":
        from mastapy._private.math_utility.convergence import _1764

        return self.__parent__._cast(_1764.ConvergenceLogger)

    @property
    def data_logger_with_charts(self: "CastSelf") -> "_2058.DataLoggerWithCharts":
        from mastapy._private.utility_gui import _2058

        return self.__parent__._cast(_2058.DataLoggerWithCharts)
