...
from mastapy._private.math_utility.optimisation import _1739
...
class _Cast_BarForPareto:
    ...
    def pareto_optimisation_strategy_bars(
        self: "CastSelf",
    ) -> "_1739.ParetoOptimisationStrategyBars":
        return self.__parent__._cast(_1739.ParetoOptimisationStrategyBars)
...
class BarForPareto(
    _1739.ParetoOptimisationStrategyBars, Generic[TAnalysis, TCandidate]
):
    """BarForPareto
