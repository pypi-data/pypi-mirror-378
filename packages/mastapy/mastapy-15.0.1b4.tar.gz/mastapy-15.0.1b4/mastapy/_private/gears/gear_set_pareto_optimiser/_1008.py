...
class CylindricalGearSetParetoOptimiser(_1015.GearSetParetoOptimiser):
    """CylindricalGearSetParetoOptimiser
    ...
    @property
    @exception_bridge
    def selected_candidate_geometry(self: "Self") -> "_1138.CylindricalGearSetDesign":
    ...
    @property
    @exception_bridge
    def all_candidate_gear_sets(self: "Self") -> "List[_1138.CylindricalGearSetDesign]":
    ...
    @property
    @exception_bridge
    def candidate_gear_sets(self: "Self") -> "List[_1138.CylindricalGearSetDesign]":
        """List[mastapy.gears.gear_designs.cylindrical.CylindricalGearSetDesign]
