...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _546, _570
...
class GearSetDesignGroup(_0.APIBase):
    ...
    @enforce_parameter_types
    def micro_geometry_model_for_simple_mesh_stiffness(
        self: "Self", value: "_428.MicroGeometryModel"
    ) -> None:
    ...
    def general_transmission_properties(
        self: "Self",
    ) -> "_346.GeneralTransmissionProperties":
    ...
    @property
    @exception_bridge
    def settings(self: "Self") -> "_546.CylindricalGearDesignAndRatingSettingsItem":
