...
class _Cast_StraightBevelDiffMeshedGearRating:
    ...
    @property
    def conical_meshed_gear_rating(self: "CastSelf") -> "_637.ConicalMeshedGearRating":
        return self.__parent__._cast(_637.ConicalMeshedGearRating)
...
class StraightBevelDiffMeshedGearRating(_637.ConicalMeshedGearRating):
    """StraightBevelDiffMeshedGearRating
