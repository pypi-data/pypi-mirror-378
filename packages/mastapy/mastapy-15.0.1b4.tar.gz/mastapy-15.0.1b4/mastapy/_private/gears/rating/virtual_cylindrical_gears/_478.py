...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.virtual_cylindrical_gears import _476, _477, _481
...
class KlingelnbergVirtualCylindricalGear(_480.VirtualCylindricalGear):
    """KlingelnbergVirtualCylindricalGear
