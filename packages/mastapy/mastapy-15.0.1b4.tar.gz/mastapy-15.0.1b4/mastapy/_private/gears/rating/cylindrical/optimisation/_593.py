...
from mastapy._private.gears.rating.cylindrical.optimisation import _597, _598, _599
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.optimisation import _594, _595
...
class CylindricalGearSetRatingOptimisationHelper(_0.APIBase):
    ...
    def helix_angle_optimisation_results(
        self: "Self",
    ) -> "_594.OptimisationResultsPair[_597.SafetyFactorOptimisationStepResultAngle]":
        ...
        return constructor.new(type_.Namespace, type_.Name)[
            _597.SafetyFactorOptimisationStepResultAngle
        ](temp)
    ...
    def maximum_transverse_contact_ratio_optimisation_results(
        self: "Self",
    ) -> "_594.OptimisationResultsPair[_598.SafetyFactorOptimisationStepResultNumber]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[
            _598.SafetyFactorOptimisationStepResultNumber
        ](temp)
    ...
    def normal_module_optimisation_results(
        self: "Self",
    ) -> "_594.OptimisationResultsPair[_599.SafetyFactorOptimisationStepResultShortLength]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[
            _599.SafetyFactorOptimisationStepResultShortLength
        ](temp)
    ...
    def all_helix_angle_optimisation_results(
        self: "Self",
    ) -> "List[_595.SafetyFactorOptimisationResults[_597.SafetyFactorOptimisationStepResultAngle]]":
    ...
    def all_normal_module_optimisation_results(
        self: "Self",
    ) -> "List[_595.SafetyFactorOptimisationResults[_599.SafetyFactorOptimisationStepResultShortLength]]":
    ...
    def all_profile_shift_optimisation_results(
        self: "Self",
    ) -> "List[_595.SafetyFactorOptimisationResults[_598.SafetyFactorOptimisationStepResultNumber]]":
