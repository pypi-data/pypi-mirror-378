...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _559, _573, _574
    from mastapy._private.gears.rating.cylindrical.iso6336 import _610, _612
...
class DIN3990MeshSingleFlankRating(_604.ISO63361996MeshSingleFlankRating):
    """DIN3990MeshSingleFlankRating
    ...
    def scuffing_rating_method_flash_temperature_method(
        self: "Self",
    ) -> "_573.ScuffingFlashTemperatureRatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._573",
    ...
    def scuffing_rating_method_integral_temperature_method(
        self: "Self",
    ) -> "_574.ScuffingIntegralTemperatureRatingMethod":
