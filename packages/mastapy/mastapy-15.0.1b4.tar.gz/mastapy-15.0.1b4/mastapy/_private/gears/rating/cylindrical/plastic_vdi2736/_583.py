...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials import _375, _376
...
class PlasticGearVDI2736AbstractGearSingleFlankRating(
    ...
    def standard_plastic_sn_curve_for_the_specified_operating_conditions(
        self: "Self",
    ) -> "_587.PlasticSNCurveForTheSpecifiedOperatingConditions":
    ...
    def bending_stress_cycle_data_for_damage_tables(
        self: "Self",
    ) -> "List[_375.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]":
    ...
    def contact_stress_cycle_data_for_damage_tables(
        self: "Self",
    ) -> "List[_376.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]":
