...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.concept import _642, _643
...
class ConceptGearSetRating(_455.GearSetRating):
    """ConceptGearSetRating
    ...
    @property
    @exception_bridge
    def gear_ratings(self: "Self") -> "List[_643.ConceptGearRating]":
    ...
    @property
    @exception_bridge
    def gear_mesh_ratings(self: "Self") -> "List[_642.ConceptGearMeshRating]":
    ...
    @property
    @exception_bridge
    def concept_mesh_ratings(self: "Self") -> "List[_642.ConceptGearMeshRating]":
        """List[mastapy.gears.rating.concept.ConceptGearMeshRating]
