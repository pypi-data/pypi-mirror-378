...
from mastapy._private.gears.rating.cylindrical.iso6336 import _619
...
class _Cast_ToothFlankFractureAnalysisRowN1457:
    ...
    def tooth_flank_fracture_analysis_contact_point_n1457(
        ...
        return self.__parent__._cast(_619.ToothFlankFractureAnalysisContactPointN1457)
...
class ToothFlankFractureAnalysisRowN1457(
    ...
    def analysis_point_with_maximum_fatigue_damage(
        self: "Self",
    ) -> "_621.ToothFlankFractureAnalysisPointN1457":
    ...
    @property
    @exception_bridge
    def watch_points(self: "Self") -> "List[_621.ToothFlankFractureAnalysisPointN1457]":
