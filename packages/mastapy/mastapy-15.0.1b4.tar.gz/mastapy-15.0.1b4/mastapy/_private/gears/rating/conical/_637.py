...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.straight_bevel_diff import _493
...
class _Cast_ConicalMeshedGearRating:
    ...
    def straight_bevel_diff_meshed_gear_rating(
        self: "CastSelf",
    ) -> "_493.StraightBevelDiffMeshedGearRating":
        from mastapy._private.gears.rating.straight_bevel_diff import _493

        return self.__parent__._cast(_493.StraightBevelDiffMeshedGearRating)
