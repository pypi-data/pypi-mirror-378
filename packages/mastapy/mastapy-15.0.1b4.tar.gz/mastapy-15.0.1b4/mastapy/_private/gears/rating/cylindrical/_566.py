...
class _Cast_ISOScuffingResultsRow:
    ...
    @property
    def scuffing_results_row(self: "CastSelf") -> "_576.ScuffingResultsRow":
        return self.__parent__._cast(_576.ScuffingResultsRow)
...
class ISOScuffingResultsRow(_576.ScuffingResultsRow):
    """ISOScuffingResultsRow
