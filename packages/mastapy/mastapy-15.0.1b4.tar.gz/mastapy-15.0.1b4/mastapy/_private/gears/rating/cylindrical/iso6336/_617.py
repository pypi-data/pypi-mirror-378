...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.iso6336 import _616, _618, _620
...
class _Cast_ToothFlankFractureAnalysisContactPointCommon:
    ...
    def tooth_flank_fracture_analysis_contact_point(
        self: "CastSelf",
    ) -> "_616.ToothFlankFractureAnalysisContactPoint":
        from mastapy._private.gears.rating.cylindrical.iso6336 import _616

        return self.__parent__._cast(_616.ToothFlankFractureAnalysisContactPoint)

    @property
    def tooth_flank_fracture_analysis_contact_point_method_a(
        self: "CastSelf",
    ) -> "_618.ToothFlankFractureAnalysisContactPointMethodA":
        from mastapy._private.gears.rating.cylindrical.iso6336 import _618

        return self.__parent__._cast(_618.ToothFlankFractureAnalysisContactPointMethodA)
...
class ToothFlankFractureAnalysisContactPointCommon(_0.APIBase):
    ...
    def analysis_point_with_maximum_local_material_exposure(
        self: "Self",
    ) -> "_620.ToothFlankFractureAnalysisPoint":
    ...
    @property
    @exception_bridge
    def watch_points(self: "Self") -> "List[_620.ToothFlankFractureAnalysisPoint]":
