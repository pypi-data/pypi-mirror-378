...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _552, _555, _567
...
class CylindricalGearDutyCycleRating(_449.GearDutyCycleRating):
    """CylindricalGearDutyCycleRating
    ...
    def cylindrical_gear_mesh_ratings(
        self: "Self",
    ) -> "List[_567.MeshRatingForReports]":
