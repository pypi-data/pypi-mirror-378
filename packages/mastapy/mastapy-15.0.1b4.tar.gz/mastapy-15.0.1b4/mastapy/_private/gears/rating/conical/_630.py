...
class ConicalGearDutyCycleRating(_449.GearDutyCycleRating):
    """ConicalGearDutyCycleRating
    ...
    @property
    @exception_bridge
    def gear_ratings(self: "Self") -> "List[_632.ConicalGearRating]":
    ...
    @property
    @exception_bridge
    def conical_gear_ratings(self: "Self") -> "List[_632.ConicalGearRating]":
        """List[mastapy.gears.rating.conical.ConicalGearRating]
