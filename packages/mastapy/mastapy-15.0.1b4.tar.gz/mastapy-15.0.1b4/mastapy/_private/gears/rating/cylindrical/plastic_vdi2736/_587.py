...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials import _379
...
class _Cast_PlasticSNCurveForTheSpecifiedOperatingConditions:
    ...
    @property
    def plastic_sn_curve(self: "CastSelf") -> "_707.PlasticSNCurve":
        return self.__parent__._cast(_707.PlasticSNCurve)
...
class PlasticSNCurveForTheSpecifiedOperatingConditions(_707.PlasticSNCurve):
    """PlasticSNCurveForTheSpecifiedOperatingConditions
    ...
    @property
    @exception_bridge
    def lubricant(self: "Self") -> "_379.VDI2736LubricantType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._379", "VDI2736LubricantType"
        )(value)

    @lubricant.setter
    @exception_bridge
    @enforce_parameter_types
    def lubricant(self: "Self", value: "_379.VDI2736LubricantType") -> None:
