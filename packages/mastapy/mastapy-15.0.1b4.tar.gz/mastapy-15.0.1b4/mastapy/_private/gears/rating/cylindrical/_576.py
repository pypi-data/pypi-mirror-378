...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _543, _566, _577
...
class _Cast_ScuffingResultsRow:
    ...
    @property
    def agma_scuffing_results_row(self: "CastSelf") -> "_543.AGMAScuffingResultsRow":
        from mastapy._private.gears.rating.cylindrical import _543

        return self.__parent__._cast(_543.AGMAScuffingResultsRow)

    @property
    def iso_scuffing_results_row(self: "CastSelf") -> "_566.ISOScuffingResultsRow":
        from mastapy._private.gears.rating.cylindrical import _566

        return self.__parent__._cast(_566.ISOScuffingResultsRow)
...
class ScuffingResultsRow(_0.APIBase):
    ...
    @property
    @exception_bridge
    def pinion(self: "Self") -> "_577.ScuffingResultsRowGear":
