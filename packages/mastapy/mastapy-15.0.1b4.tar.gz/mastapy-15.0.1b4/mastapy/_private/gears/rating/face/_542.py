...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.face import _539, _540
...
class FaceGearSetRating(_455.GearSetRating):
    """FaceGearSetRating
    ...
    @property
    @exception_bridge
    def gear_ratings(self: "Self") -> "List[_540.FaceGearRating]":
    ...
    @property
    @exception_bridge
    def gear_mesh_ratings(self: "Self") -> "List[_539.FaceGearMeshRating]":
    ...
    @property
    @exception_bridge
    def face_mesh_ratings(self: "Self") -> "List[_539.FaceGearMeshRating]":
        """List[mastapy.gears.rating.face.FaceGearMeshRating]
