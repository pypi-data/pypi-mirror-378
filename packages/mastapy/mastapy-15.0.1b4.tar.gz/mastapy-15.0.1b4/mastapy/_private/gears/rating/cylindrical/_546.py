...
from mastapy._private.gears import _409, _425
from mastapy._private.gears.rating.cylindrical import _573, _574
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _405, _435
    ...
    from mastapy._private.utility.units_and_measurements import _1804
...
class CylindricalGearDesignAndRatingSettingsItem(_2033.NamedDatabaseItem):
    """CylindricalGearDesignAndRatingSettingsItem
    ...
    @property
    @exception_bridge
    def agma_quality_grade_type(self: "Self") -> "_435.QualityGradeTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._435", "QualityGradeTypes"
        )(value)

    @agma_quality_grade_type.setter
    @exception_bridge
    @enforce_parameter_types
    def agma_quality_grade_type(self: "Self", value: "_435.QualityGradeTypes") -> None:
    ...
    @property
    @exception_bridge
    def agma_tolerances_standard(self: "Self") -> "_405.AGMAToleranceStandard":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._405", "AGMAToleranceStandard"
        )(value)
    ...
    def agma_tolerances_standard(
        self: "Self", value: "_405.AGMAToleranceStandard"
    ) -> None:
    ...
    def chosen_tooth_thickness_for_bending_strength(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._579", "ToothThicknesses"
        )(value)
    ...
    @enforce_parameter_types
    def chosen_tooth_thickness_for_bending_strength(
        self: "Self", value: "_579.ToothThicknesses"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def dynamic_factor_method(self: "Self") -> "_564.DynamicFactorMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._564", "DynamicFactorMethods"
        )(value)

    @dynamic_factor_method.setter
    @exception_bridge
    @enforce_parameter_types
    def dynamic_factor_method(self: "Self", value: "_564.DynamicFactorMethods") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def film_thickness_equation_for_scuffing(self: "Self") -> "_575.ScuffingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._575", "ScuffingMethods"
        )(value)
    ...
    def film_thickness_equation_for_scuffing(
        self: "Self", value: "_575.ScuffingMethods"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def gear_blank_factor_calculation_option(
        self: "Self",
    ) -> "_565.GearBlankFactorCalculationOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._565",
    ...
    @enforce_parameter_types
    def gear_blank_factor_calculation_option(
        self: "Self", value: "_565.GearBlankFactorCalculationOptions"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Cylindrical.GearBlankFactorCalculationOptions",
    ...
    def iso_tolerances_standard(
        self: "Self",
        value: "Union[_425.ISOToleranceStandard, Tuple[_425.ISOToleranceStandard, bool]]",
    ) -> None:
    ...
    @property
    @exception_bridge
    def micropitting_rating_method(self: "Self") -> "_568.MicropittingRatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._568", "MicropittingRatingMethod"
        )(value)
    ...
    def micropitting_rating_method(
        self: "Self", value: "_568.MicropittingRatingMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def permissible_bending_stress_method(self: "Self") -> "_571.RatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._571", "RatingMethod"
        )(value)
    ...
    def permissible_bending_stress_method(
        self: "Self", value: "_571.RatingMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @exception_bridge
    @enforce_parameter_types
    def rating_method(self: "Self", value: "_339.CylindricalGearRatingMethods") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @enforce_parameter_types
    def scuffing_rating_method_flash_temperature_method(
        self: "Self", value: "_573.ScuffingFlashTemperatureRatingMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @enforce_parameter_types
    def scuffing_rating_method_integral_temperature_method(
        self: "Self", value: "_574.ScuffingIntegralTemperatureRatingMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def tip_relief_in_scuffing_calculation(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical._578", "TipReliefScuffingOptions"
        )(value)
    ...
    @enforce_parameter_types
    def tip_relief_in_scuffing_calculation(
        self: "Self", value: "_578.TipReliefScuffingOptions"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def tolerance_rounding_system(self: "Self") -> "_1804.MeasurementSystem":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.units_and_measurements._1804", "MeasurementSystem"
        )(value)
    ...
    def tolerance_rounding_system(
        self: "Self", value: "_1804.MeasurementSystem"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def vdi_rating_geometry_calculation_method(
        self: "Self",
        value: "Union[_339.CylindricalGearRatingMethods, Tuple[_339.CylindricalGearRatingMethods, bool]]",
    ) -> None:
        wrapper_type = (
