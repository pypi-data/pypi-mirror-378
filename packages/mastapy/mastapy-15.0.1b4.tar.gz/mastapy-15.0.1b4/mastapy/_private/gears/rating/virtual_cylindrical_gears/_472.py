...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.virtual_cylindrical_gears import _484
...
class _Cast_BevelVirtualCylindricalGearSetISO10300MethodB2:
    ...
    def virtual_cylindrical_gear_set(
        self: "CastSelf",
    ) -> "_484.VirtualCylindricalGearSet":
        pass

        from mastapy._private.gears.rating.virtual_cylindrical_gears import _484

        return self.__parent__._cast(_484.VirtualCylindricalGearSet)
