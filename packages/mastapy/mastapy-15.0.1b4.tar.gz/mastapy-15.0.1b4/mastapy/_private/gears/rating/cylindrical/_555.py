...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _558, _572
...
class CylindricalGearSetDutyCycleRating(_454.GearSetDutyCycleRating):
    """CylindricalGearSetDutyCycleRating
    ...
    def gear_mesh_duty_cycle_ratings(
        self: "Self",
    ) -> "List[_558.CylindricalMeshDutyCycleRating]":
