...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _548, _549
...
class _Cast_GearFlankRating:
    ...
    def cylindrical_gear_flank_duty_cycle_rating(
        self: "CastSelf",
    ) -> "_548.CylindricalGearFlankDutyCycleRating":
        from mastapy._private.gears.rating.cylindrical import _548

        return self.__parent__._cast(_548.CylindricalGearFlankDutyCycleRating)

    @property
    def cylindrical_gear_flank_rating(
        self: "CastSelf",
    ) -> "_549.CylindricalGearFlankRating":
        from mastapy._private.gears.rating.cylindrical import _549

        return self.__parent__._cast(_549.CylindricalGearFlankRating)
