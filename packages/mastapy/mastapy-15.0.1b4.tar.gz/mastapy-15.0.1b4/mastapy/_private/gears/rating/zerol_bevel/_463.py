...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.zerol_bevel import _461, _462
...
class ZerolBevelGearSetRating(_648.BevelGearSetRating):
    """ZerolBevelGearSetRating
    ...
    @property
    @exception_bridge
    def zerol_bevel_mesh_ratings(self: "Self") -> "List[_461.ZerolBevelGearMeshRating]":
