...
class _Cast_CutterProcessSimulation:
    ...
    def form_wheel_grinding_process_simulation(
        self: "CastSelf",
    ) -> "_744.FormWheelGrindingProcessSimulation":
        from mastapy._private.gears.manufacturing.cylindrical.process_simulation import (
            _744,
        )

        return self.__parent__._cast(_744.FormWheelGrindingProcessSimulation)

    @property
    def shaping_process_simulation(self: "CastSelf") -> "_745.ShapingProcessSimulation":
        from mastapy._private.gears.manufacturing.cylindrical.process_simulation import (
            _745,
        )

        return self.__parent__._cast(_745.ShapingProcessSimulation)
