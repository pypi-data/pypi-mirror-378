...
from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _749, _750
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _757
...
class PlungeShaverInputsAndMicroGeometry(_0.APIBase):
    ...
    @enforce_parameter_types
    def micro_geometry_source(
        self: "Self", value: "_750.MicroGeometryDefinitionType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    @exception_bridge
    def points_of_interest_left_flank(self: "Self") -> "List[_757.PointOfInterest]":
    ...
    @property
    @exception_bridge
    def points_of_interest_right_flank(self: "Self") -> "List[_757.PointOfInterest]":
        """List[mastapy.gears.manufacturing.cylindrical.plunge_shaving.PointOfInterest]
