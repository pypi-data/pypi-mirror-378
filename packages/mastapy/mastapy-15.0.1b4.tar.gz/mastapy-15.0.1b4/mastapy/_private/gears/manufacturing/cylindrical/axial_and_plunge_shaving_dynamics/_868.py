...
class _Cast_ShaverRedressing:
    ...
    @property
    def axial_shaver_redressing(self: "CastSelf") -> "_854.AxialShaverRedressing":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _854,
        )

        return self.__parent__._cast(_854.AxialShaverRedressing)

    @property
    def plunge_shaver_redressing(self: "CastSelf") -> "_861.PlungeShaverRedressing":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _861,
        )

        return self.__parent__._cast(_861.PlungeShaverRedressing)
