...
class CylindricalMeshManufacturingConfig(_1345.GearMeshImplementationDetail):
    """CylindricalMeshManufacturingConfig
    ...
    def nominal_meshed_gear_a_as_manufactured_virtual(
        self: "Self",
    ) -> "_839.CylindricalManufacturedVirtualGearInMesh":
    ...
    @property
    @exception_bridge
    def gear_a_as_manufactured(self: "Self") -> "List[_835.CutterSimulationCalc]":
    ...
    @property
    @exception_bridge
    def gear_b_as_manufactured(self: "Self") -> "List[_835.CutterSimulationCalc]":
        """List[mastapy.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc]
    ...
    def meshed_gear_a_as_manufactured(
        self: "Self",
    ) -> "List[_838.CylindricalManufacturedRealGearInMesh]":
    ...
    def meshed_gear_a_as_manufactured_virtual(
        self: "Self",
    ) -> "List[_839.CylindricalManufacturedVirtualGearInMesh]":
