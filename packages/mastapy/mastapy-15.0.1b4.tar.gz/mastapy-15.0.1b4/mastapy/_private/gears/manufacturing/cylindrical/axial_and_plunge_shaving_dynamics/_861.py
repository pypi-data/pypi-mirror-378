...
class _Cast_PlungeShaverRedressing:
    ...
    @property
    def shaver_redressing(self: "CastSelf") -> "_868.ShaverRedressing":
        return self.__parent__._cast(_868.ShaverRedressing)
...
class PlungeShaverRedressing(_868.ShaverRedressing[_859.PlungeShaverDynamics]):
    """PlungeShaverRedressing
