...
class ShavingDynamicsViewModel(_875.ShavingDynamicsViewModelBase, Generic[T]):
    """ShavingDynamicsViewModel
    ...
    def active_profile_range_calculation_source(
        self: "Self",
    ) -> "_853.ActiveProfileRangeCalculationSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics._853",
    ...
    def active_profile_range_calculation_source(
        self: "Self", value: "_853.ActiveProfileRangeCalculationSource"
    ) -> None:
    ...
    @property
    @exception_bridge
    def redressing_chart(self: "Self") -> "_2075.TwoDChartDefinition":
    ...
    @exception_bridge
    @enforce_parameter_types
    def selected_measurement_method(self: "Self", value: "_1192.ThicknessType") -> None:
    ...
    @property
    @exception_bridge
    def calculation(self: "Self") -> "_870.ShavingDynamicsCalculation[T]":
