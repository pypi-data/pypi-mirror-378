...
class _Cast_WormGrinderManufactureError:
    ...
    @property
    def rack_manufacture_error(self: "CastSelf") -> "_793.RackManufactureError":
        return self.__parent__._cast(_793.RackManufactureError)
...
class WormGrinderManufactureError(_793.RackManufactureError):
    """WormGrinderManufactureError
