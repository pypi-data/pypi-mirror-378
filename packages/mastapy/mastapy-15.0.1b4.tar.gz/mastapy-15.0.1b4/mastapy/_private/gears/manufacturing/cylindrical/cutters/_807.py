...
class _Cast_CurveInLinkedList:
    ...
    @property
    def mutable_common(self: "CastSelf") -> "_823.MutableCommon":
        from mastapy._private.gears.manufacturing.cylindrical.cutters import _823

        return self.__parent__._cast(_823.MutableCommon)
