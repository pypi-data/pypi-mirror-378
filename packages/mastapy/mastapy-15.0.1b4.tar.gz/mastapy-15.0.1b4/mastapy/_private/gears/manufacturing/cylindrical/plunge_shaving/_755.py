...
class _Cast_PlungeShaverOutputs:
    ...
    @property
    def real_plunge_shaver_outputs(self: "CastSelf") -> "_758.RealPlungeShaverOutputs":
        from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _758

        return self.__parent__._cast(_758.RealPlungeShaverOutputs)

    @property
    def virtual_plunge_shaver_outputs(
        self: "CastSelf",
    ) -> "_761.VirtualPlungeShaverOutputs":
        from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _761

        return self.__parent__._cast(_761.VirtualPlungeShaverOutputs)
...
class PlungeShaverOutputs(_0.APIBase):
    ...
    def chart(self: "Self", value: "_747.ChartType") -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def selected_flank(self: "Self", value: "_731.Flank") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    @exception_bridge
    def calculation_details(self: "Self") -> "_753.PlungeShaverGeneration":
