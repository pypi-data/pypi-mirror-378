...
T = TypeVar("T", bound="_789.ProcessSimulationInput")
...
class _Cast_ProcessSimulationNew:
    ...
    def hobbing_process_simulation_new(
        self: "CastSelf",
    ) -> "_777.HobbingProcessSimulationNew":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _777,
        )

        return self.__parent__._cast(_777.HobbingProcessSimulationNew)

    @property
    def worm_grinding_process_simulation_new(
        self: "CastSelf",
    ) -> "_804.WormGrindingProcessSimulationNew":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _804,
        )

        return self.__parent__._cast(_804.WormGrindingProcessSimulationNew)
...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    @property
    @exception_bridge
    def gear_tooth_shape_calculation(self: "Self") -> "_785.ProcessGearShape":
    ...
    @property
    @exception_bridge
    def lead_calculation(self: "Self") -> "_786.ProcessLeadCalculation":
    ...
    @property
    @exception_bridge
    def pitch_calculation(self: "Self") -> "_787.ProcessPitchCalculation":
    ...
    @property
    @exception_bridge
    def profile_calculation(self: "Self") -> "_788.ProcessProfileCalculation":
    ...
    def total_modification_calculation(
        self: "Self",
    ) -> "_792.ProcessTotalModificationCalculation":
