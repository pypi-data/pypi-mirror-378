...
from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import _843
...
class _Cast_FinishCutterSimulation:
    ...
    @property
    def gear_cutter_simulation(self: "CastSelf") -> "_843.GearCutterSimulation":
        return self.__parent__._cast(_843.GearCutterSimulation)
...
class FinishCutterSimulation(_843.GearCutterSimulation):
    """FinishCutterSimulation
