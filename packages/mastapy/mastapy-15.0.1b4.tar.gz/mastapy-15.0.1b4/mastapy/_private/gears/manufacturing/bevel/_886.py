...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _885, _887
...
class _Cast_ConicalMeshFlankMicroGeometryConfig:
    ...
    def conical_mesh_flank_manufacturing_config(
        ...
        return self.__parent__._cast(_885.ConicalMeshFlankManufacturingConfig)
    ...
    def conical_mesh_flank_nurbs_micro_geometry_config(
        ...
        return self.__parent__._cast(_887.ConicalMeshFlankNURBSMicroGeometryConfig)
