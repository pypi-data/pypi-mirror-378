...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel.cutters import _919, _920
...
class ConicalWheelManufacturingConfig(_880.ConicalGearManufacturingConfig):
    """ConicalWheelManufacturingConfig
    ...
    def specified_machine_settings(
        self: "Self",
    ) -> "_925.BasicConicalGearMachineSettings":
    ...
    @property
    @exception_bridge
    def wheel_finish_cutter(self: "Self") -> "_919.WheelFinishCutter":
    ...
    @property
    @exception_bridge
    def wheel_rough_cutter(self: "Self") -> "_920.WheelRoughCutter":
