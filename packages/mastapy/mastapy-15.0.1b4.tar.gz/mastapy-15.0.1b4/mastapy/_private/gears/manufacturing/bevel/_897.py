...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _895, _896
...
class ConicalSetMicroGeometryConfigBase(_1351.GearSetImplementationDetail):
    ...
    @enforce_parameter_types
    def contact_chart_results_type(
        self: "Self", value: "_931.ContactResultType"
    ) -> None:
    ...
    def deflection_from_bending_option(
        self: "Self",
    ) -> "_415.DeflectionFromBendingOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._415", "DeflectionFromBendingOption"
        )(value)
    ...
    @enforce_parameter_types
    def deflection_from_bending_option(
        self: "Self", value: "_415.DeflectionFromBendingOption"
    ) -> None:
