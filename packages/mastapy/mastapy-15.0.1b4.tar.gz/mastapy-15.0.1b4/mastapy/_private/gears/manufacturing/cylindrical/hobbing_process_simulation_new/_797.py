...
class WormGrindingLeadCalculation(_798.WormGrindingProcessCalculation):
    """WormGrindingLeadCalculation
    ...
    @property
    @exception_bridge
    def left_flank(self: "Self") -> "_764.CalculateLeadDeviationAccuracy":
    ...
    @property
    @exception_bridge
    def right_flank(self: "Self") -> "_764.CalculateLeadDeviationAccuracy":
        """mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new.CalculateLeadDeviationAccuracy
