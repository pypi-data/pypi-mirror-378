...
class _Cast_ShavingDynamicsCalculationForHobbedGears:
    ...
    def shaving_dynamics_calculation(
        self: "CastSelf",
    ) -> "_870.ShavingDynamicsCalculation":
        return self.__parent__._cast(_870.ShavingDynamicsCalculation)
...
class ShavingDynamicsCalculationForHobbedGears(_870.ShavingDynamicsCalculation[T]):
    """ShavingDynamicsCalculationForHobbedGears
