...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _899
...
class _Cast_AbstractTCA:
    ...
    @property
    def ease_off_based_tca(self: "CastSelf") -> "_899.EaseOffBasedTCA":
        from mastapy._private.gears.manufacturing.bevel import _899

        return self.__parent__._cast(_899.EaseOffBasedTCA)
...
class AbstractTCA(_0.APIBase):
    ...
    @property
    @exception_bridge
    def conical_mesh_misalignments(self: "Self") -> "_1280.ConicalMeshMisalignments":
