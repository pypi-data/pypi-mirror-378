...
class _Cast_ShaverPointCalculationError:
    ...
    @property
    def calculation_error(self: "CastSelf") -> "_746.CalculationError":
        return self.__parent__._cast(_746.CalculationError)
...
class ShaverPointCalculationError(_746.CalculationError):
    """ShaverPointCalculationError
