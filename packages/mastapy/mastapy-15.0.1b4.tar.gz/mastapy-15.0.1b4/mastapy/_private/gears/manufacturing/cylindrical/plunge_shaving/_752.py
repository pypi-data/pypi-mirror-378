...
class PlungeShaverCalculationInputs(_0.APIBase):
    ...
    @property
    @exception_bridge
    def shaver_hand(self: "Self") -> "_424.Hand":
        """mastapy.gears.Hand"""
    ...
    @exception_bridge
    @enforce_parameter_types
    def shaver_hand(self: "Self", value: "_424.Hand") -> None:
    ...
    @property
    @exception_bridge
    def input_gear_geometry(self: "Self") -> "_836.CylindricalCutterSimulatableGear":
