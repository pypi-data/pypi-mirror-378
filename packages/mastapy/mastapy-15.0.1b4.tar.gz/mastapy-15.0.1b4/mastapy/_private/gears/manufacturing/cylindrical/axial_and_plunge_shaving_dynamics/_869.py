...
class _Cast_ShavingDynamics:
    ...
    def conventional_shaving_dynamics(
        self: "CastSelf",
    ) -> "_855.ConventionalShavingDynamics":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _855,
        )

        return self.__parent__._cast(_855.ConventionalShavingDynamics)

    @property
    def plunge_shaver_dynamics(self: "CastSelf") -> "_859.PlungeShaverDynamics":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _859,
        )

        return self.__parent__._cast(_859.PlungeShaverDynamics)
...
class ShavingDynamics(_0.APIBase):
    ...
    def crossed_axis_calculation_details(
        self: "Self",
    ) -> "_1109.CrossedAxisCylindricalGearPairPointContact":
