...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _830
...
class ShaperSimulationCalculator(_835.CutterSimulationCalc):
    """ShaperSimulationCalculator
    ...
    @property
    @exception_bridge
    def shaper(self: "Self") -> "_830.CylindricalGearShaperTangible":
