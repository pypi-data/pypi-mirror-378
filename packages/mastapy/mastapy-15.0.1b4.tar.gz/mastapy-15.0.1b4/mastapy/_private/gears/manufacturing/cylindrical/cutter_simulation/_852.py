...
from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import _847
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import _835
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _832
...
class _Cast_WormGrinderSimulationCalculator:
    ...
    @property
    def cutter_simulation_calc(self: "CastSelf") -> "_835.CutterSimulationCalc":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _835,
        )

        return self.__parent__._cast(_835.CutterSimulationCalc)
...
class WormGrinderSimulationCalculator(_847.RackSimulationCalculator):
    """WormGrinderSimulationCalculator
    ...
    @property
    @exception_bridge
    def worm_grinder(self: "Self") -> "_832.CylindricalGearWormGrinderShape":
