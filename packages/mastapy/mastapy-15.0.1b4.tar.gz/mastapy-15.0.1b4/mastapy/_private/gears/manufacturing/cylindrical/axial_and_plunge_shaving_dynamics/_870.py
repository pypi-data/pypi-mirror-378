...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import _836
...
T = TypeVar("T", bound="_869.ShavingDynamics")
...
class _Cast_ShavingDynamicsCalculation:
    ...
    def conventional_shaving_dynamics_calculation_for_designed_gears(
        self: "CastSelf",
    ) -> "_856.ConventionalShavingDynamicsCalculationForDesignedGears":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _856,
        )
    ...
    def conventional_shaving_dynamics_calculation_for_hobbed_gears(
        self: "CastSelf",
    ) -> "_857.ConventionalShavingDynamicsCalculationForHobbedGears":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _857,
        )
    ...
    def plunge_shaving_dynamics_calculation_for_designed_gears(
        self: "CastSelf",
    ) -> "_862.PlungeShavingDynamicsCalculationForDesignedGears":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _862,
        )
    ...
    def plunge_shaving_dynamics_calculation_for_hobbed_gears(
        self: "CastSelf",
    ) -> "_863.PlungeShavingDynamicsCalculationForHobbedGears":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _863,
        )
    ...
    def shaving_dynamics_calculation_for_designed_gears(
        self: "CastSelf",
    ) -> "_871.ShavingDynamicsCalculationForDesignedGears":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _871,
        )

        return self.__parent__._cast(_871.ShavingDynamicsCalculationForDesignedGears)

    @property
    def shaving_dynamics_calculation_for_hobbed_gears(
        self: "CastSelf",
    ) -> "_872.ShavingDynamicsCalculationForHobbedGears":
        from mastapy._private.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import (
            _872,
        )

        return self.__parent__._cast(_872.ShavingDynamicsCalculationForHobbedGears)
...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    @property
    @exception_bridge
    def accuracy_level_iso6(self: "Self") -> "_866.RollAngleRangeRelativeToAccuracy":
    ...
    @property
    @exception_bridge
    def accuracy_level_iso7(self: "Self") -> "_866.RollAngleRangeRelativeToAccuracy":
        """mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics.RollAngleRangeRelativeToAccuracy
    ...
    @property
    @exception_bridge
    def designed_gear(self: "Self") -> "_836.CylindricalCutterSimulatableGear":
    ...
    def life_cutter_start_of_shaving(
        self: "Self",
    ) -> "_1135.CylindricalGearProfileMeasurement":
    ...
    @property
    @exception_bridge
    def life_shaver(self: "Self") -> "_819.CylindricalGearShaver":
    ...
    @property
    @exception_bridge
    def shaver(self: "Self") -> "_819.CylindricalGearShaver":
        """mastapy.gears.manufacturing.cylindrical.cutters.CylindricalGearShaver
    ...
    @property
    @exception_bridge
    def redressing_settings(self: "Self") -> "List[_865.RedressingSettings[T]]":
