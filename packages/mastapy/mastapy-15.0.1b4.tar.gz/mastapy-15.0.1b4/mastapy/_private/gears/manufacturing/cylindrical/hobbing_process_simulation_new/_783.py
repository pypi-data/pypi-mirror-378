...
class _Cast_MountingError:
    ...
    @property
    def gear_mounting_error(self: "CastSelf") -> "_769.GearMountingError":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _769,
        )

        return self.__parent__._cast(_769.GearMountingError)

    @property
    def rack_mounting_error(self: "CastSelf") -> "_794.RackMountingError":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _794,
        )

        return self.__parent__._cast(_794.RackMountingError)
