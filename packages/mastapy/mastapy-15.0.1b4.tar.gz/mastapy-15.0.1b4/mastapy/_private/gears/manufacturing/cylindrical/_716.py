...
class CylindricalGearManufacturingConfig(_1341.GearImplementationDetail):
    ...
    @property
    @exception_bridge
    def finish_cutter(self: "Self") -> "_817.CylindricalGearRealCutterDesign":
    ...
    @property
    @exception_bridge
    def finish_cutter_simulation(self: "Self") -> "_843.GearCutterSimulation":
    ...
    @property
    @exception_bridge
    def finish_process_simulation(self: "Self") -> "_743.CutterProcessSimulation":
    ...
    def finished_gear_specification(
        self: "Self",
    ) -> "_837.CylindricalGearSpecification":
    ...
    @property
    @exception_bridge
    def gear_blank(self: "Self") -> "_715.CylindricalGearBlank":
    ...
    @property
    @exception_bridge
    def rough_cutter(self: "Self") -> "_817.CylindricalGearRealCutterDesign":
        """mastapy.gears.manufacturing.cylindrical.cutters.CylindricalGearRealCutterDesign
    ...
    @property
    @exception_bridge
    def rough_cutter_simulation(self: "Self") -> "_843.GearCutterSimulation":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.GearCutterSimulation
    ...
    @property
    @exception_bridge
    def rough_gear_specification(self: "Self") -> "_837.CylindricalGearSpecification":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.CylindricalGearSpecification
    ...
    @property
    @exception_bridge
    def rough_process_simulation(self: "Self") -> "_743.CutterProcessSimulation":
        """mastapy.gears.manufacturing.cylindrical.process_simulation.CutterProcessSimulation
