...
class _Cast_GearCutterSimulation:
    ...
    @property
    def finish_cutter_simulation(self: "CastSelf") -> "_840.FinishCutterSimulation":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _840,
        )

        return self.__parent__._cast(_840.FinishCutterSimulation)

    @property
    def rough_cutter_simulation(self: "CastSelf") -> "_848.RoughCutterSimulation":
        from mastapy._private.gears.manufacturing.cylindrical.cutter_simulation import (
            _848,
        )

        return self.__parent__._cast(_848.RoughCutterSimulation)
...
class GearCutterSimulation(_0.APIBase):
    ...
    @property
    @exception_bridge
    def average_thickness(self: "Self") -> "_835.CutterSimulationCalc":
    ...
    @property
    @exception_bridge
    def average_thickness_virtual(self: "Self") -> "_851.VirtualSimulationCalculator":
    ...
    @property
    @exception_bridge
    def least_profile(self: "Self") -> "_835.CutterSimulationCalc":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc
    ...
    @property
    @exception_bridge
    def least_profile_virtual(self: "Self") -> "_851.VirtualSimulationCalculator":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.VirtualSimulationCalculator
    ...
    @property
    @exception_bridge
    def maximum_thickness(self: "Self") -> "_835.CutterSimulationCalc":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc
    ...
    @property
    @exception_bridge
    def maximum_thickness_virtual(self: "Self") -> "_851.VirtualSimulationCalculator":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.VirtualSimulationCalculator
    ...
    @property
    @exception_bridge
    def minimum_thickness(self: "Self") -> "_835.CutterSimulationCalc":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc
    ...
    @property
    @exception_bridge
    def minimum_thickness_virtual(self: "Self") -> "_851.VirtualSimulationCalculator":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.VirtualSimulationCalculator
    ...
    @property
    @exception_bridge
    def thickness_calculators(self: "Self") -> "List[_835.CutterSimulationCalc]":
    ...
    def virtual_thickness_calculators(
        self: "Self",
    ) -> "List[_851.VirtualSimulationCalculator]":
