...
class _Cast_HobbingProcessSimulationInput:
    ...
    @property
    def process_simulation_input(self: "CastSelf") -> "_789.ProcessSimulationInput":
        return self.__parent__._cast(_789.ProcessSimulationInput)
...
class HobbingProcessSimulationInput(_789.ProcessSimulationInput):
    """HobbingProcessSimulationInput
    ...
    def process_method(self: "Self", value: "_762.ActiveProcessMethod") -> None:
    ...
    @property
    @exception_bridge
    def hob_manufacture_error(self: "Self") -> "_780.HobManufactureError":
    ...
    @property
    @exception_bridge
    def hob_resharpening_error(self: "Self") -> "_781.HobResharpeningError":
