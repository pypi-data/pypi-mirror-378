...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials import _328, _329, _330, _359
...
class AGMACylindricalGearMaterial(_685.CylindricalGearMaterial):
    """AGMACylindricalGearMaterial
    ...
    @property
    @exception_bridge
    def grade(self: "Self") -> "_330.AGMAMaterialGrade":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._330", "AGMAMaterialGrade"
        )(value)

    @grade.setter
    @exception_bridge
    @enforce_parameter_types
    def grade(self: "Self", value: "_330.AGMAMaterialGrade") -> None:
    ...
    @property
    @exception_bridge
    def material_application(self: "Self") -> "_328.AGMAMaterialApplications":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._328", "AGMAMaterialApplications"
        )(value)
    ...
    def material_application(
        self: "Self", value: "_328.AGMAMaterialApplications"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def material_class(self: "Self") -> "_329.AGMAMaterialClasses":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._329", "AGMAMaterialClasses"
        )(value)

    @material_class.setter
    @exception_bridge
    @enforce_parameter_types
    def material_class(self: "Self", value: "_329.AGMAMaterialClasses") -> None:
        value = conversion.mp_to_pn_enum(
