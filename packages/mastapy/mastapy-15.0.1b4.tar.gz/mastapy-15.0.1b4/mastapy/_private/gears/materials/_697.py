...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials import _359, _368
...
class ISOCylindricalGearMaterial(_685.CylindricalGearMaterial):
    """ISOCylindricalGearMaterial
    ...
    @property
    @exception_bridge
    def quality_grade(self: "Self") -> "_368.QualityGrade":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._368", "QualityGrade"
        )(value)

    @quality_grade.setter
    @exception_bridge
    @enforce_parameter_types
    def quality_grade(self: "Self", value: "_368.QualityGrade") -> None:
