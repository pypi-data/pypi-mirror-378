...
class LeadModification(_671.Modification):
    """LeadModification
    ...
    @property
    @exception_bridge
    def measured_data(self: "Self") -> "_1723.Vector2DListAccessor":
    ...
    @exception_bridge
    @enforce_parameter_types
    def measured_data(self: "Self", value: "_1723.Vector2DListAccessor") -> None:
