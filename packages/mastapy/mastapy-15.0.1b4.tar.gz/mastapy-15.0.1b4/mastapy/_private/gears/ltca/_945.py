...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _944, _946
...
class GearMeshLoadDistributionAnalysis(_1343.GearMeshImplementationAnalysis):
    """GearMeshLoadDistributionAnalysis
    ...
    @property
    @exception_bridge
    def moment_about_centre_fourier_series(self: "Self") -> "_1698.FourierSeries":
    ...
    @property
    @exception_bridge
    def transmission_error_fourier_series(self: "Self") -> "_1698.FourierSeries":
        """mastapy.math_utility.FourierSeries
    ...
    def load_distribution_analyses_at_single_rotation(
        self: "Self",
    ) -> "List[_946.GearMeshLoadDistributionAtRotation]":
    ...
    def maximum_root_stress_with_flanks(
        self: "Self",
        gear: "_944.GearLoadDistributionAnalysis",
        flank: "_416.GearFlanks",
