...
from mastapy._private.gears.ltca import _946
...
class _Cast_ConicalMeshLoadDistributionAtRotation:
    ...
    def gear_mesh_load_distribution_at_rotation(
        self: "CastSelf",
    ) -> "_946.GearMeshLoadDistributionAtRotation":
        return self.__parent__._cast(_946.GearMeshLoadDistributionAtRotation)
...
class ConicalMeshLoadDistributionAtRotation(_946.GearMeshLoadDistributionAtRotation):
    """ConicalMeshLoadDistributionAtRotation
