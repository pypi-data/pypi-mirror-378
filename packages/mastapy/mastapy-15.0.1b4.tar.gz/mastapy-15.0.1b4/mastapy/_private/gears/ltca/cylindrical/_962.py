...
class _Cast_CylindricalGearMeshLoadedContactPoint:
    ...
    def gear_mesh_loaded_contact_point(
        self: "CastSelf",
    ) -> "_948.GearMeshLoadedContactPoint":
        return self.__parent__._cast(_948.GearMeshLoadedContactPoint)
...
class CylindricalGearMeshLoadedContactPoint(_948.GearMeshLoadedContactPoint):
    """CylindricalGearMeshLoadedContactPoint
