...
class _Cast_CylindricalGearRootFilletStressResults:
    ...
    def gear_root_fillet_stress_results(
        self: "CastSelf",
    ) -> "_949.GearRootFilletStressResults":
        return self.__parent__._cast(_949.GearRootFilletStressResults)
...
class CylindricalGearRootFilletStressResults(_949.GearRootFilletStressResults):
    """CylindricalGearRootFilletStressResults
