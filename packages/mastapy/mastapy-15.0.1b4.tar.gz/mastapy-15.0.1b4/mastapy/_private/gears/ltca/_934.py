...
class _Cast_CylindricalGearFilletNodeStressResultsRow:
    ...
    def gear_fillet_node_stress_results_row(
        self: "CastSelf",
    ) -> "_943.GearFilletNodeStressResultsRow":
        return self.__parent__._cast(_943.GearFilletNodeStressResultsRow)
...
class CylindricalGearFilletNodeStressResultsRow(_943.GearFilletNodeStressResultsRow):
    """CylindricalGearFilletNodeStressResultsRow
