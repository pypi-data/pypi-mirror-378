...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _546, _555
...
class CylindricalGearSetDesign(_1054.GearSetDesign):
    ...
    def helical_gear_micro_geometry_option(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.cylindrical.iso6336._602",
    ...
    @enforce_parameter_types
    def helical_gear_micro_geometry_option(
        self: "Self", value: "_602.HelicalGearMicroGeometryOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Cylindrical.ISO6336.HelicalGearMicroGeometryOption",
    ...
    def manufacturing_configurations(
        self: "Self",
    ) -> "List[_729.CylindricalSetManufacturingConfig]":
    ...
    def create_optimiser(
        self: "Self", duty_cycle: "_555.CylindricalGearSetDutyCycleRating"
    ...
    def delete_manufacturing_configuration(
        self: "Self", config: "_729.CylindricalSetManufacturingConfig"
    ) -> None:
        """Method does not return.
    ...
    def set_active_manufacturing_configuration(
        self: "Self", value: "_729.CylindricalSetManufacturingConfig"
    ) -> None:
        """Method does not return.
