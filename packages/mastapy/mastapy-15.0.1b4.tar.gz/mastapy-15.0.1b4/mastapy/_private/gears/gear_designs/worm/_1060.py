...
class WormDesign(_1061.WormGearDesign):
    """WormDesign
    ...
    @property
    @exception_bridge
    def addendum_factor(self: "Self") -> "_441.WormAddendumFactor":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._441", "WormAddendumFactor"
        )(value)

    @addendum_factor.setter
    @exception_bridge
    @enforce_parameter_types
    def addendum_factor(self: "Self", value: "_441.WormAddendumFactor") -> None:
