...
from mastapy._private.gears.gear_designs import _1048
...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.property import _2044
...
class DesignConstraintsCollection(_2033.NamedDatabaseItem):
    """DesignConstraintsCollection
    ...
    def design_constraints(
        self: "Self",
    ) -> "List[_2044.DeletableCollectionMember[_1048.DesignConstraint]]":
