...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _436, _439
    ...
    from mastapy._private.gears.gear_designs.conical import _1285
    ...
    from mastapy._private.gleason_smt_link import _395
...
class AGMAGleasonConicalGearSetDesign(_1276.ConicalGearSetDesign):
    """AGMAGleasonConicalGearSetDesign
    ...
    def design_method(
        self: "Self", value: "_1299.AGMAGleasonConicalGearGeometryMethods"
    ) -> None:
    ...
    @property
    @exception_bridge
    def manufacturing_method(self: "Self") -> "_395.CutterMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gleason_smt_link._395", "CutterMethod"
        )(value)

    @manufacturing_method.setter
    @exception_bridge
    @enforce_parameter_types
    def manufacturing_method(self: "Self", value: "_395.CutterMethod") -> None:
    ...
    @property
    @exception_bridge
    def reliability_requirement_agma(self: "Self") -> "_436.SafetyRequirementsAGMA":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._436", "SafetyRequirementsAGMA"
        )(value)
    ...
    def reliability_requirement_agma(
        self: "Self", value: "_436.SafetyRequirementsAGMA"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def reliability_requirement_gleason(
        self: "Self",
    ) -> "_1285.GleasonSafetyRequirements":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.conical._1285",
    ...
    @enforce_parameter_types
    def reliability_requirement_gleason(
        self: "Self", value: "_1285.GleasonSafetyRequirements"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def tooth_taper(self: "Self") -> "_439.SpiralBevelToothTaper":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._439", "SpiralBevelToothTaper"
        )(value)

    @tooth_taper.setter
    @exception_bridge
    @enforce_parameter_types
    def tooth_taper(self: "Self", value: "_439.SpiralBevelToothTaper") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def conical_meshes(self: "Self") -> "List[_1314.AGMAGleasonConicalGearMeshDesign]":
    ...
    @property
    @exception_bridge
    def meshes(self: "Self") -> "List[_1314.AGMAGleasonConicalGearMeshDesign]":
        """List[mastapy.gears.gear_designs.agma_gleason_conical.AGMAGleasonConicalGearMeshDesign]
