...
class _Cast_AGMAGleasonConicalAccuracyGrades:
    ...
    @property
    def accuracy_grades(self: "CastSelf") -> "_404.AccuracyGrades":
        return self.__parent__._cast(_404.AccuracyGrades)
...
class AGMAGleasonConicalAccuracyGrades(_404.AccuracyGrades):
    """AGMAGleasonConicalAccuracyGrades
