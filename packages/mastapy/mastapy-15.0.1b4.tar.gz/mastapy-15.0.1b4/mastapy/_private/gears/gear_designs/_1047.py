...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.hypoid import _533
    from mastapy._private.gears.rating.iso_10300 import _512, _520, _527
...
class BevelHypoidGearRatingSettingsItem(_2033.NamedDatabaseItem):
    """BevelHypoidGearRatingSettingsItem
    ...
    @property
    @exception_bridge
    def bevel_gear_rating_method(self: "Self") -> "_708.RatingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.materials._708", "RatingMethods"
        )(value)

    @bevel_gear_rating_method.setter
    @exception_bridge
    @enforce_parameter_types
    def bevel_gear_rating_method(self: "Self", value: "_708.RatingMethods") -> None:
    ...
    def bevel_general_load_factors_k_method(
        self: "Self",
    ) -> "_512.GeneralLoadFactorCalculationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._512", "GeneralLoadFactorCalculationMethod"
        )(value)
    ...
    @enforce_parameter_types
    def bevel_general_load_factors_k_method(
        self: "Self", value: "_512.GeneralLoadFactorCalculationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Iso10300.GeneralLoadFactorCalculationMethod",
    ...
    def bevel_pitting_factor_calculation_method(
        self: "Self",
    ) -> "_527.PittingFactorCalculationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._527", "PittingFactorCalculationMethod"
        )(value)
    ...
    @enforce_parameter_types
    def bevel_pitting_factor_calculation_method(
        self: "Self", value: "_527.PittingFactorCalculationMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def hypoid_gear_rating_method(self: "Self") -> "_533.HypoidRatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating.hypoid._533", "HypoidRatingMethod"
        )(value)
    ...
    def hypoid_gear_rating_method(
        self: "Self", value: "_533.HypoidRatingMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def iso_rating_method_for_bevel_gears(self: "Self") -> "_520.ISO10300RatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._520", "ISO10300RatingMethod"
        )(value)
    ...
    def iso_rating_method_for_bevel_gears(
        self: "Self", value: "_520.ISO10300RatingMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def iso_rating_method_for_hypoid_gears(self: "Self") -> "_520.ISO10300RatingMethod":
        """mastapy.gears.rating.isoISO10300RatingMethod"""
