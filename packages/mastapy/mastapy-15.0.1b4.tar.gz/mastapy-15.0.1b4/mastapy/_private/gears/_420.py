...
class GearSetOptimisationResult(_0.APIBase):
    ...
    @property
    @exception_bridge
    def optimisation_history(self: "Self") -> "_1731.OptimisationHistory":
    ...
    def optimisation_history(self: "Self", value: "_1731.OptimisationHistory") -> None:
        pythonnet_property_set(self.wrapped, "OptimisationHistory", value.wrapped)

    @property
    @exception_bridge
    def rating(self: "Self") -> "_446.AbstractGearSetRating":
