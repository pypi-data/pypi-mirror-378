...
class ShaftSectionEndDamageResults(_0.APIBase):
    ...
    @property
    @exception_bridge
    def sn_curve(self: "Self") -> "_371.SNCurve":
    ...
    @property
    @exception_bridge
    def sn_curve_axial(self: "Self") -> "_371.SNCurve":
        """mastapy.materials.SNCurve
    ...
    @property
    @exception_bridge
    def sn_curve_bending_x(self: "Self") -> "_371.SNCurve":
        """mastapy.materials.SNCurve
    ...
    @property
    @exception_bridge
    def sn_curve_bending_y(self: "Self") -> "_371.SNCurve":
        """mastapy.materials.SNCurve
    ...
    @property
    @exception_bridge
    def sn_curve_torsional(self: "Self") -> "_371.SNCurve":
        """mastapy.materials.SNCurve
