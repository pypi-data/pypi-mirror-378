...
if TYPE_CHECKING:
    ...
    from mastapy._private.html import _394
    from mastapy._private.utility.report import _1963, _1971
...
class CustomReportText(_1960.CustomReportDefinitionItem):
    """CustomReportText
    ...
    @property
    @exception_bridge
    def heading_type(self: "Self") -> "_394.HeadingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.html._394", "HeadingType"
        )(value)

    @heading_type.setter
    @exception_bridge
    @enforce_parameter_types
    def heading_type(self: "Self", value: "_394.HeadingType") -> None:
