...
class SystemDirectoryPopulator(_0.APIBase):
    ...
    @exception_bridge
    @enforce_parameter_types
    def selected_version(self: "Self", value: "_1797.SystemDirectory") -> None:
        generic_type = (
    ...
    @property
    @exception_bridge
    def current_version(self: "Self") -> "_1797.SystemDirectory":
    ...
    @property
    @exception_bridge
    def version_to_copy(self: "Self") -> "_1797.SystemDirectory":
        """mastapy.utility.SystemDirectory
