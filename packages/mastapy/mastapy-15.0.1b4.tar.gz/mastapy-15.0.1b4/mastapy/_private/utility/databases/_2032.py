...
from mastapy._private.utility.databases import _2034, _2036
...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.databases import _2028, _2033

    Self = TypeVar("Self", bound="NamedDatabase")
    CastSelf = TypeVar("CastSelf", bound="NamedDatabase._Cast_NamedDatabase")

TValue = TypeVar("TValue", bound="_2033.NamedDatabaseItem")
...
class NamedDatabase(_2036.SQLDatabase[_2034.NamedKey, TValue]):
    """NamedDatabase
    ...
    @enforce_parameter_types
    def duplicate(
        self: "Self", new_name: "str", item: "_2033.NamedDatabaseItem"
    ) -> "_2033.NamedDatabaseItem":
    ...
    @enforce_parameter_types
    def rename(
        self: "Self", item: "_2033.NamedDatabaseItem", new_name: "str"
    ) -> "bool":
        """bool
