...
class _Cast_MethodOutcomeWithResult:
    ...
    @property
    def method_outcome(self: "CastSelf") -> "_1787.MethodOutcome":
        return self.__parent__._cast(_1787.MethodOutcome)
...
class MethodOutcomeWithResult(_1787.MethodOutcome, Generic[T]):
    """MethodOutcomeWithResult
