...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.modal_analysis.gears import _2001, _2004
...
class GearOrderForTE(_2006.OrderWithRadius):
    """GearOrderForTE
    ...
    @property
    @exception_bridge
    def position(self: "Self") -> "_2001.GearPositions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.modal_analysis.gears._2001", "GearPositions"
        )(value)

    @property
    @exception_bridge
    def additional_orders_and_harmonics(self: "Self") -> "List[_2004.OrderForTE]":
