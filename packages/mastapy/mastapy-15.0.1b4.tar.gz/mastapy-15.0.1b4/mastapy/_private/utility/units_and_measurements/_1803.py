...
if TYPE_CHECKING:
    ...
    from mastapy._private.units_and_measurements import _7908
...
class MeasurementSettings(_1791.PerMachineSettings):
    """MeasurementSettings
    ...
    @exception_bridge
    @enforce_parameter_types
    def selected_measurement(self: "Self", value: "_1802.MeasurementBase") -> None:
        generic_type = (
    ...
    @property
    @exception_bridge
    def current_selected_measurement(self: "Self") -> "_1802.MeasurementBase":
    ...
    @exception_bridge
    @enforce_parameter_types
    def find_measurement_by_name(self: "Self", name: "str") -> "_1802.MeasurementBase":
        """mastapy.utility.units_and_measurements.MeasurementBase
    ...
    @enforce_parameter_types
    def get_measurement(
        self: "Self", measurement_type: "_7908.MeasurementType"
    ) -> "_1802.MeasurementBase":
        """mastapy.utility.units_and_measurements.MeasurementBase
