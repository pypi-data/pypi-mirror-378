...
class Force(_1802.MeasurementBase):
    """Force
    ...
    @property
    @exception_bridge
    def kilograms_force(self: "Self") -> "_1807.Unit":
    ...
    @property
    @exception_bridge
    def kilonewtons(self: "Self") -> "_1807.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    @exception_bridge
    def millinewtons(self: "Self") -> "_1807.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    @exception_bridge
    def newtons(self: "Self") -> "_1807.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    @exception_bridge
    def ounces_force(self: "Self") -> "_1807.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    @exception_bridge
    def pounds_force(self: "Self") -> "_1807.Unit":
        """mastapy.utility.units_and_measurements.Unit
