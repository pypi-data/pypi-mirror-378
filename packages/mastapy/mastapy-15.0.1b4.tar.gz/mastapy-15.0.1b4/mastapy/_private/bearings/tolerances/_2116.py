...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.tolerances import _2119, _2124, _2128
...
class InterferenceDetail(_2109.BearingConnectionComponent):
    """InterferenceDetail
    ...
    @property
    @exception_bridge
    def material(self: "Self") -> "_359.Material":
