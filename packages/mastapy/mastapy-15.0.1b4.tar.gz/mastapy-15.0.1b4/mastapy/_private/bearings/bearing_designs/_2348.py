...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2085, _2090
...
class LinearBearing(_2345.BearingDesign):
    """LinearBearing
    ...
    @property
    @exception_bridge
    def stiffness_options(self: "Self") -> "_2090.BearingStiffnessMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2090", "BearingStiffnessMatrixOption"
        )(value)
    ...
    def stiffness_options(
        self: "Self", value: "_2090.BearingStiffnessMatrixOption"
    ) -> None:
