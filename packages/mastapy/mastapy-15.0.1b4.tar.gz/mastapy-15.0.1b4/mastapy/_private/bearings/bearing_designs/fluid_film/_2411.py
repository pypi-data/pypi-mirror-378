...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2085, _2108
...
class TiltingPadThrustBearing(_2403.PadFluidFilmBearing):
    """TiltingPadThrustBearing
    ...
    @property
    @exception_bridge
    def tilting_pad_type(self: "Self") -> "_2108.TiltingPadTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2108", "TiltingPadTypes"
        )(value)

    @tilting_pad_type.setter
    @exception_bridge
    @enforce_parameter_types
    def tilting_pad_type(self: "Self", value: "_2108.TiltingPadTypes") -> None:
