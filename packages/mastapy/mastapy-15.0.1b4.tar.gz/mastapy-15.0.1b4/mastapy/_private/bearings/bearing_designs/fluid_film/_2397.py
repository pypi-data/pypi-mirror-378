...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.fluid_film import _2398, _2399
...
class _Cast_AxialFeedJournalBearing:
    ...
    def axial_groove_journal_bearing(
        self: "CastSelf",
    ) -> "_2398.AxialGrooveJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2398

        return self.__parent__._cast(_2398.AxialGrooveJournalBearing)

    @property
    def axial_hole_journal_bearing(self: "CastSelf") -> "_2399.AxialHoleJournalBearing":
        from mastapy._private.bearings.bearing_designs.fluid_film import _2399

        return self.__parent__._cast(_2399.AxialHoleJournalBearing)
