...
class BearingProtectionDetailsModifier(_0.APIBase):
    ...
    @property
    @exception_bridge
    def current_protection_level(self: "Self") -> "_2360.BearingProtectionLevel":
    ...
    @property
    @exception_bridge
    def new_protection_level(self: "Self") -> "_2360.BearingProtectionLevel":
        """mastapy.bearings.bearing_designs.rolling.BearingProtectionLevel"""
    ...
    def new_protection_level(
        self: "Self", value: "_2360.BearingProtectionLevel"
    ) -> None:
