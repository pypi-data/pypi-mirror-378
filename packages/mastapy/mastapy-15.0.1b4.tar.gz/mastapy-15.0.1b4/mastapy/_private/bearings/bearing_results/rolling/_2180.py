...
class _Cast_BallISO179562025Results:
    ...
    @property
    def iso179562025_results(self: "CastSelf") -> "_2190.ISO179562025Results":
        return self.__parent__._cast(_2190.ISO179562025Results)
...
class BallISO179562025Results(_2190.ISO179562025Results):
    """BallISO179562025Results
