...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2273, _2274
...
class _Cast_MaximumStaticContactStressResultsAbstract:
    ...
    def maximum_static_contact_stress(
        ...
        return self.__parent__._cast(_2273.MaximumStaticContactStress)

    @property
    def maximum_static_contact_stress_duty_cycle(
        self: "CastSelf",
    ) -> "_2274.MaximumStaticContactStressDutyCycle":
        from mastapy._private.bearings.bearing_results.rolling import _2274

        return self.__parent__._cast(_2274.MaximumStaticContactStressDutyCycle)
