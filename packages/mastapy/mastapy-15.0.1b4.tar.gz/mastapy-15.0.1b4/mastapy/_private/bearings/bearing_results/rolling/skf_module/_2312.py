...
class SKFModuleResults(_0.APIBase):
    ...
    @property
    @exception_bridge
    def adjusted_speed(self: "Self") -> "_2290.AdjustedSpeed":
    ...
    @property
    @exception_bridge
    def bearing_loads(self: "Self") -> "_2292.BearingLoads":
    ...
    @property
    @exception_bridge
    def bearing_rating_life(self: "Self") -> "_2293.BearingRatingLife":
    ...
    @property
    @exception_bridge
    def frequencies(self: "Self") -> "_2295.Frequencies":
    ...
    @property
    @exception_bridge
    def friction(self: "Self") -> "_2297.Friction":
    ...
    @property
    @exception_bridge
    def minimum_load(self: "Self") -> "_2305.MinimumLoad":
    ...
    @property
    @exception_bridge
    def static_safety_factors(self: "Self") -> "_2313.StaticSafetyFactors":
    ...
    @property
    @exception_bridge
    def viscosities(self: "Self") -> "_2314.Viscosities":
