...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results import _2160, _2167, _2170
...
class LoadedBearingDutyCycle(_0.APIBase):
    ...
    @property
    @exception_bridge
    def bearing_design(self: "Self") -> "_2345.BearingDesign":
    ...
    @property
    @exception_bridge
    def bearing_load_case_results(self: "Self") -> "List[_2160.LoadedBearingResults]":
