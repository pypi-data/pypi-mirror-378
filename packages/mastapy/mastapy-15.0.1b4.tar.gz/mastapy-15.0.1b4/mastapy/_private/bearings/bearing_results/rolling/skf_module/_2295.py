...
class Frequencies(_2310.SKFCalculationResult):
    """Frequencies
    ...
    @property
    @exception_bridge
    def frequency_of_over_rolling(self: "Self") -> "_2296.FrequencyOfOverRolling":
    ...
    @property
    @exception_bridge
    def rotational_frequency(self: "Self") -> "_2308.RotationalFrequency":
