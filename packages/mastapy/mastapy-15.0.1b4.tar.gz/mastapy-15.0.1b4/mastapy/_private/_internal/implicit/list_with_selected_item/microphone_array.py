...
class ListWithSelectedItem_MicrophoneArray(
    _2697.MicrophoneArray, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_MicrophoneArray]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2697.MicrophoneArray.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2697.MicrophoneArray":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2697.MicrophoneArray]":
