...
class ListWithSelectedItem_FESubstructure(
    _2610.FESubstructure, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_FESubstructure]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2610.FESubstructure.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2610.FESubstructure":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2610.FESubstructure]":
