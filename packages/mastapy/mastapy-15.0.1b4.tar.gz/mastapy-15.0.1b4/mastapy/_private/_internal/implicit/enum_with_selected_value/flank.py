...
class EnumWithSelectedValue_Flank(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[EnumWithSelectedValue_Flank]") -> "_731.Flank":
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_Flank]") -> "Any":
        ...
        Returns:
            Any
        """
        return _731.Flank.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_731.Flank":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_731.Flank]":
