...
class ListWithSelectedItem_DutyCycle(_5959.DutyCycle, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_DutyCycle]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5959.DutyCycle.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_5959.DutyCycle":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_5959.DutyCycle]":
