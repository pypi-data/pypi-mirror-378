...
class EnumWithSelectedValue_PowerLoadType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_PowerLoadType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2435.PowerLoadType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2435.PowerLoadType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2435.PowerLoadType]":
