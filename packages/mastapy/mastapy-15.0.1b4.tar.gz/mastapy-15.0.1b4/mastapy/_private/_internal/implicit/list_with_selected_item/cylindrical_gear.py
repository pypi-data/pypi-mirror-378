...
class ListWithSelectedItem_CylindricalGear(
    _2767.CylindricalGear, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGear]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2767.CylindricalGear.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2767.CylindricalGear":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2767.CylindricalGear]":
