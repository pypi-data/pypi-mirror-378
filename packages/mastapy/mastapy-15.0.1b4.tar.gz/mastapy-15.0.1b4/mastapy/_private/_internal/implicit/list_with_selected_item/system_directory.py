...
from mastapy._private.utility import _1797
...
class ListWithSelectedItem_SystemDirectory(
    _1797.SystemDirectory, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_SystemDirectory]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1797.SystemDirectory.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1797.SystemDirectory":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1797.SystemDirectory]":
