...
class EnumWithSelectedValue_SplineRatingTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1602.SplineRatingTypes
        """
        return _1602.SplineRatingTypes
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_SplineRatingTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1602.SplineRatingTypes.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1602.SplineRatingTypes":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1602.SplineRatingTypes]":
