...
class EnumWithSelectedValue_StressConcentrationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_StressConcentrationMethod]",
    ) -> "_2323.StressConcentrationMethod":
        ...
        Returns:
            _2323.StressConcentrationMethod
        """
        return _2323.StressConcentrationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2323.StressConcentrationMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2323.StressConcentrationMethod":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2323.StressConcentrationMethod]":
