...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RigidConnectorToothSpacingType]",
    ) -> "_2841.RigidConnectorToothSpacingType":
        ...
        Returns:
            _2841.RigidConnectorToothSpacingType
        """
        return _2841.RigidConnectorToothSpacingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2841.RigidConnectorToothSpacingType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2841.RigidConnectorToothSpacingType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2841.RigidConnectorToothSpacingType]":
