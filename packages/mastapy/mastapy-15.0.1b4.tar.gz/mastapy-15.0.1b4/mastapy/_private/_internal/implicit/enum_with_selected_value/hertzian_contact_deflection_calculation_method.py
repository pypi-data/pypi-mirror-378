...
from mastapy._private.math_utility.hertzian_contact import _1763
...
class EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod]",
    ) -> "_1763.HertzianContactDeflectionCalculationMethod":
        ...
        Returns:
            _1763.HertzianContactDeflectionCalculationMethod
        """
        return _1763.HertzianContactDeflectionCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1763.HertzianContactDeflectionCalculationMethod.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1763.HertzianContactDeflectionCalculationMethod]":
