...
class Overridable_MicroGeometryModel(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _428.MicroGeometryModel
        """
        return _428.MicroGeometryModel
    ...
    def implicit_type(cls: "Type[Overridable_MicroGeometryModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _428.MicroGeometryModel.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_428.MicroGeometryModel":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_428.MicroGeometryModel":
        """mastapy.gears.MicroGeometryModel
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_428.MicroGeometryModel":
        """mastapy.gears.MicroGeometryModel
