...
class ListWithSelectedItem_DesignState(
    _5958.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_DesignState]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5958.DesignState.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_5958.DesignState":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_5958.DesignState]":
