...
class EnumWithSelectedValue_ComponentOrientationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ComponentOrientationOption]",
    ) -> "_2592.ComponentOrientationOption":
        ...
        Returns:
            _2592.ComponentOrientationOption
        """
        return _2592.ComponentOrientationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2592.ComponentOrientationOption.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2592.ComponentOrientationOption":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2592.ComponentOrientationOption]":
