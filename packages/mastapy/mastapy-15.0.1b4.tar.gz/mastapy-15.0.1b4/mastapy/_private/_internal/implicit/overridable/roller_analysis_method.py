...
class Overridable_RollerAnalysisMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2282.RollerAnalysisMethod
        """
        return _2282.RollerAnalysisMethod
    ...
    def implicit_type(cls: "Type[Overridable_RollerAnalysisMethod]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2282.RollerAnalysisMethod.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_2282.RollerAnalysisMethod":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_2282.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_2282.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod
