...
class ListWithSelectedItem_Datum(_2679.Datum, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_Datum]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2679.Datum.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2679.Datum":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2679.Datum]":
