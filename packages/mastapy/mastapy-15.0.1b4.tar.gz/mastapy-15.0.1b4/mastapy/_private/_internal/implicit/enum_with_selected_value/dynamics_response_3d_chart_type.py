...
class EnumWithSelectedValue_DynamicsResponse3DChartType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DynamicsResponse3DChartType]",
    ) -> "_4901.DynamicsResponse3DChartType":
        ...
        Returns:
            _4901.DynamicsResponse3DChartType
        """
        return _4901.DynamicsResponse3DChartType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _4901.DynamicsResponse3DChartType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_4901.DynamicsResponse3DChartType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_4901.DynamicsResponse3DChartType]":
