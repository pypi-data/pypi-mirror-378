...
class EnumWithSelectedValue_DegreeOfFreedom(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DegreeOfFreedom]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1688.DegreeOfFreedom.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1688.DegreeOfFreedom":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1688.DegreeOfFreedom]":
