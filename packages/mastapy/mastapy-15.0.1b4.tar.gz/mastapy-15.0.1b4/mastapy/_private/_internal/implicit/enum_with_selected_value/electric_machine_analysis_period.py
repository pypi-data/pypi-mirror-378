...
class EnumWithSelectedValue_ElectricMachineAnalysisPeriod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ElectricMachineAnalysisPeriod]",
    ) -> "_250.ElectricMachineAnalysisPeriod":
        ...
        Returns:
            _250.ElectricMachineAnalysisPeriod
        """
        return _250.ElectricMachineAnalysisPeriod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _250.ElectricMachineAnalysisPeriod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_250.ElectricMachineAnalysisPeriod":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_250.ElectricMachineAnalysisPeriod]":
