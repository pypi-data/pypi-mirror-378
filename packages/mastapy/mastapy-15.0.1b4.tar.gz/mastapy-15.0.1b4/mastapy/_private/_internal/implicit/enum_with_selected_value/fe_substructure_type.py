...
class EnumWithSelectedValue_FESubstructureType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2615.FESubstructureType
        """
        return _2615.FESubstructureType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_FESubstructureType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2615.FESubstructureType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2615.FESubstructureType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2615.FESubstructureType]":
