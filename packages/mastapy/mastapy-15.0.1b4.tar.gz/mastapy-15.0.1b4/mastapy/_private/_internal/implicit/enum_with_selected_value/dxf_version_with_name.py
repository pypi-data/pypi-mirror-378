...
from mastapy._private.utility.cad_export import _2040
...
class EnumWithSelectedValue_DxfVersionWithName(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2040.DxfVersionWithName
        """
        return _2040.DxfVersionWithName
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DxfVersionWithName]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2040.DxfVersionWithName.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2040.DxfVersionWithName":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2040.DxfVersionWithName]":
