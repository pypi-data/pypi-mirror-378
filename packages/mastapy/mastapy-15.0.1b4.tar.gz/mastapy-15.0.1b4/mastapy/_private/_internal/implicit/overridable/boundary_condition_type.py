...
class Overridable_BoundaryConditionType(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _246.BoundaryConditionType
        """
        return _246.BoundaryConditionType
    ...
    def implicit_type(cls: "Type[Overridable_BoundaryConditionType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _246.BoundaryConditionType.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_246.BoundaryConditionType":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_246.BoundaryConditionType":
        """mastapy.nodal_analysis.fe_export_utility.BoundaryConditionType
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_246.BoundaryConditionType":
        """mastapy.nodal_analysis.fe_export_utility.BoundaryConditionType
