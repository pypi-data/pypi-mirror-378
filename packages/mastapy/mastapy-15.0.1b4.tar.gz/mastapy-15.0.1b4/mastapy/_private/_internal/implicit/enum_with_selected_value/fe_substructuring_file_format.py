...
from mastapy._private.nodal_analysis.fe_export_utility import _248
...
class EnumWithSelectedValue_FESubstructuringFileFormat(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_FESubstructuringFileFormat]",
    ) -> "_248.FESubstructuringFileFormat":
        ...
        Returns:
            _248.FESubstructuringFileFormat
        """
        return _248.FESubstructuringFileFormat
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _248.FESubstructuringFileFormat.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_248.FESubstructuringFileFormat":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_248.FESubstructuringFileFormat]":
