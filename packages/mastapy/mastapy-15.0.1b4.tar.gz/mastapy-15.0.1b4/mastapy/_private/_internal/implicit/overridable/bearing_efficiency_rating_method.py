...
class Overridable_BearingEfficiencyRatingMethod(mixins.OverridableMixin, Enum):
    ...
    @property
    @exception_bridge
    def value(self: "Self") -> "_383.BearingEfficiencyRatingMethod":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_383.BearingEfficiencyRatingMethod":
        """mastapy.materials.efficiency.BearingEfficiencyRatingMethod
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_383.BearingEfficiencyRatingMethod":
        """mastapy.materials.efficiency.BearingEfficiencyRatingMethod
