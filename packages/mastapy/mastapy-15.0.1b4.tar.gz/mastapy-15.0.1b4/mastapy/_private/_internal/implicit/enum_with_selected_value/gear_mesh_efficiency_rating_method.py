...
class EnumWithSelectedValue_GearMeshEfficiencyRatingMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_GearMeshEfficiencyRatingMethod]",
    ) -> "_451.GearMeshEfficiencyRatingMethod":
        ...
        Returns:
            _451.GearMeshEfficiencyRatingMethod
        """
        return _451.GearMeshEfficiencyRatingMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _451.GearMeshEfficiencyRatingMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_451.GearMeshEfficiencyRatingMethod":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_451.GearMeshEfficiencyRatingMethod]":
