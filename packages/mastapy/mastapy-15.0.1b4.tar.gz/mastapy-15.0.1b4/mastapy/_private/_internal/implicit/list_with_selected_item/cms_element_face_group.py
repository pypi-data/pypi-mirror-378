...
class ListWithSelectedItem_CMSElementFaceGroup(
    _311.CMSElementFaceGroup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CMSElementFaceGroup]") -> "Any":
        ...
        Returns:
            Any
        """
        return _311.CMSElementFaceGroup.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_311.CMSElementFaceGroup":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_311.CMSElementFaceGroup]":
