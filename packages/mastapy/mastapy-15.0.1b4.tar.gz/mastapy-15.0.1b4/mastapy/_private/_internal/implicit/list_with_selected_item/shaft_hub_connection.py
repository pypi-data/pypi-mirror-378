...
class ListWithSelectedItem_ShaftHubConnection(
    _2845.ShaftHubConnection, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ShaftHubConnection]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2845.ShaftHubConnection.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2845.ShaftHubConnection":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2845.ShaftHubConnection]":
