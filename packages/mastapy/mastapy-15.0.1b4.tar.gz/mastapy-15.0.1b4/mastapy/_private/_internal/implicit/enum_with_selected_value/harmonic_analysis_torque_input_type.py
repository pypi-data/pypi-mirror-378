...
class EnumWithSelectedValue_HarmonicAnalysisTorqueInputType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HarmonicAnalysisTorqueInputType]",
    ) -> "_6067.HarmonicAnalysisTorqueInputType":
        ...
        Returns:
            _6067.HarmonicAnalysisTorqueInputType
        """
        return _6067.HarmonicAnalysisTorqueInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _6067.HarmonicAnalysisTorqueInputType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_6067.HarmonicAnalysisTorqueInputType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_6067.HarmonicAnalysisTorqueInputType]":
