...
class EnumWithSelectedValue_FrictionModelForGyroscopicMoment(
    ...
    def wrapped_type(
        ...
        Returns:
            _2184.FrictionModelForGyroscopicMoment
        """
        return _2184.FrictionModelForGyroscopicMoment
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2184.FrictionModelForGyroscopicMoment.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2184.FrictionModelForGyroscopicMoment":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2184.FrictionModelForGyroscopicMoment]":
