...
class EnumWithSelectedValue_ShaftAndHousingFlexibilityOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ShaftAndHousingFlexibilityOption]",
    ) -> "_5775.ShaftAndHousingFlexibilityOption":
        ...
        Returns:
            _5775.ShaftAndHousingFlexibilityOption
        """
        return _5775.ShaftAndHousingFlexibilityOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5775.ShaftAndHousingFlexibilityOption.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_5775.ShaftAndHousingFlexibilityOption":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5775.ShaftAndHousingFlexibilityOption]":
