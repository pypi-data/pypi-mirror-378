...
from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _747
...
class EnumWithSelectedValue_ChartType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[EnumWithSelectedValue_ChartType]") -> "_747.ChartType":
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ChartType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _747.ChartType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_747.ChartType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_747.ChartType]":
