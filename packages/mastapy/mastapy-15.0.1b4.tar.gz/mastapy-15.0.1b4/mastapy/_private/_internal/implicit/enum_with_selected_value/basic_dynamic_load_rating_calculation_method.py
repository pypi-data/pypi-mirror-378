...
class EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod]",
    ) -> "_2078.BasicDynamicLoadRatingCalculationMethod":
        ...
        Returns:
            _2078.BasicDynamicLoadRatingCalculationMethod
        """
        return _2078.BasicDynamicLoadRatingCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2078.BasicDynamicLoadRatingCalculationMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2078.BasicDynamicLoadRatingCalculationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2078.BasicDynamicLoadRatingCalculationMethod]":
