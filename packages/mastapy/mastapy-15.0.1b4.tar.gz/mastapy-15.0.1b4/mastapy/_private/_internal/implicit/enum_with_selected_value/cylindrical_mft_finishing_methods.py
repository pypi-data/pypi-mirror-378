...
class EnumWithSelectedValue_CylindricalMftFinishingMethods(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_CylindricalMftFinishingMethods]",
    ) -> "_727.CylindricalMftFinishingMethods":
        ...
        Returns:
            _727.CylindricalMftFinishingMethods
        """
        return _727.CylindricalMftFinishingMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _727.CylindricalMftFinishingMethods.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_727.CylindricalMftFinishingMethods":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_727.CylindricalMftFinishingMethods]":
