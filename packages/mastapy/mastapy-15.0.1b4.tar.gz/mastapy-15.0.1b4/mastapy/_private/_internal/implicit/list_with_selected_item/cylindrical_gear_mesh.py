...
class ListWithSelectedItem_CylindricalGearMesh(
    _2535.CylindricalGearMesh, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGearMesh]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2535.CylindricalGearMesh.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2535.CylindricalGearMesh":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2535.CylindricalGearMesh]":
