...
class EnumWithSelectedValue_LocationOfEvaluationLowerLimit(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfEvaluationLowerLimit]",
    ) -> "_665.LocationOfEvaluationLowerLimit":
        ...
        Returns:
            _665.LocationOfEvaluationLowerLimit
        """
        return _665.LocationOfEvaluationLowerLimit
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _665.LocationOfEvaluationLowerLimit.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_665.LocationOfEvaluationLowerLimit":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_665.LocationOfEvaluationLowerLimit]":
