...
from mastapy._private.geometry.two_d.curves import _403
...
class EnumWithSelectedValue_BasicCurveTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_BasicCurveTypes]") -> "Any":
        ...
        Returns:
            Any
        """
        return _403.BasicCurveTypes.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_403.BasicCurveTypes":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_403.BasicCurveTypes]":
