...
class Overridable_FrictionModelForGyroscopicMoment(mixins.OverridableMixin, Enum):
    ...
    @property
    @exception_bridge
    def value(self: "Self") -> "_2184.FrictionModelForGyroscopicMoment":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_2184.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_2184.FrictionModelForGyroscopicMoment":
        """mastapy.bearings.bearing_results.rolling.FrictionModelForGyroscopicMoment
