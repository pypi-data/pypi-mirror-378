...
class EnumWithSelectedValue_LubricationMethods(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _426.LubricationMethods
        """
        return _426.LubricationMethods
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_LubricationMethods]") -> "Any":
        ...
        Returns:
            Any
        """
        return _426.LubricationMethods.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_426.LubricationMethods":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_426.LubricationMethods]":
