...
class EnumWithSelectedValue_BearingNodeOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2589.BearingNodeOption
        """
        return _2589.BearingNodeOption
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_BearingNodeOption]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2589.BearingNodeOption.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2589.BearingNodeOption":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2589.BearingNodeOption]":
