...
class Overridable_CoefficientOfFrictionCalculationMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _409.CoefficientOfFrictionCalculationMethod
        """
        return _409.CoefficientOfFrictionCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _409.CoefficientOfFrictionCalculationMethod.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_409.CoefficientOfFrictionCalculationMethod":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_409.CoefficientOfFrictionCalculationMethod":
        """mastapy.gears.CoefficientOfFrictionCalculationMethod
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_409.CoefficientOfFrictionCalculationMethod":
        """mastapy.gears.CoefficientOfFrictionCalculationMethod
