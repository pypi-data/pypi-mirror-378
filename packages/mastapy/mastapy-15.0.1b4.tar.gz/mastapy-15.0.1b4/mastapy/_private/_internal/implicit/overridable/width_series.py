...
class Overridable_WidthSeries(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[Overridable_WidthSeries]") -> "_2391.WidthSeries":
    ...
    def implicit_type(cls: "Type[Overridable_WidthSeries]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2391.WidthSeries.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_2391.WidthSeries":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_2391.WidthSeries":
        """mastapy.bearings.bearing_designs.rolling.WidthSeries
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_2391.WidthSeries":
        """mastapy.bearings.bearing_designs.rolling.WidthSeries
