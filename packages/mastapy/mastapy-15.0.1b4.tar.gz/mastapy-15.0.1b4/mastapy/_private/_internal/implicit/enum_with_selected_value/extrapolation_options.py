...
class EnumWithSelectedValue_ExtrapolationOptions(
    ...
    def wrapped_type(
        ...
        Returns:
            _1695.ExtrapolationOptions
        """
        return _1695.ExtrapolationOptions
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ExtrapolationOptions]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1695.ExtrapolationOptions.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1695.ExtrapolationOptions":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1695.ExtrapolationOptions]":
