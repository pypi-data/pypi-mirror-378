...
class EnumWithSelectedValue_RollingBearingArrangement(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_RollingBearingArrangement]",
    ) -> "_2100.RollingBearingArrangement":
        ...
        Returns:
            _2100.RollingBearingArrangement
        """
        return _2100.RollingBearingArrangement
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2100.RollingBearingArrangement.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2100.RollingBearingArrangement":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2100.RollingBearingArrangement]":
