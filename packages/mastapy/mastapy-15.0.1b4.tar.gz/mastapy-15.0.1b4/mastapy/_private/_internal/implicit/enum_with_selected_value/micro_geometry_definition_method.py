...
class EnumWithSelectedValue_MicroGeometryDefinitionMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _749.MicroGeometryDefinitionMethod
        """
        return _749.MicroGeometryDefinitionMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _749.MicroGeometryDefinitionMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_749.MicroGeometryDefinitionMethod":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_749.MicroGeometryDefinitionMethod]":
