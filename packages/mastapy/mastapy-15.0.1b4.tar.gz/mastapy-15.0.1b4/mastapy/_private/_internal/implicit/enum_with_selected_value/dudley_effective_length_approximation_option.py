...
class EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption]",
    ) -> "_1579.DudleyEffectiveLengthApproximationOption":
        ...
        Returns:
            _1579.DudleyEffectiveLengthApproximationOption
        """
        return _1579.DudleyEffectiveLengthApproximationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1579.DudleyEffectiveLengthApproximationOption.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_1579.DudleyEffectiveLengthApproximationOption]":
