...
class EnumWithSelectedValue_ActiveProcessMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _762.ActiveProcessMethod
        """
        return _762.ActiveProcessMethod
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_ActiveProcessMethod]") -> "Any":
        ...
        Returns:
            Any
        """
        return _762.ActiveProcessMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_762.ActiveProcessMethod":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_762.ActiveProcessMethod]":
