...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.report import _1943, _1948
...
class ThreeDChartDefinition(_2067.NDChartDefinition):
    """ThreeDChartDefinition
    ...
    @property
    @exception_bridge
    def z_axis(self: "Self") -> "_1943.AxisSettings":
    ...
    @exception_bridge
    def data_points_for_surfaces(self: "Self") -> "List[_2069.PointsForSurface]":
