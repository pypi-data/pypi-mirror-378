...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.couplings import _2859, _2861
...
class TorqueConverter(_2828.Coupling):
    """TorqueConverter
    ...
    @property
    @exception_bridge
    def pump(self: "Self") -> "_2859.TorqueConverterPump":
    ...
    @property
    @exception_bridge
    def turbine(self: "Self") -> "_2861.TorqueConverterTurbine":
