...
from mastapy._private.system_model.part_model import _2665, _2687
...
class Shaft(_2665.AbstractShaft):
    """Shaft
    ...
    @exception_bridge
    @enforce_parameter_types
    def cad_model(self: "Self", value: "_2687.GuideDxfModel") -> None:
        generic_type = (
    ...
    @property
    @exception_bridge
    def guide_image(self: "Self") -> "_2688.GuideImage":
    ...
    @property
    @exception_bridge
    def fe_substructure_replacing_this(self: "Self") -> "_2610.FESubstructure":
    ...
    @enforce_parameter_types
    def mount_component(
        self: "Self", component: "_2698.MountableComponent", offset: "float"
    ) -> None:
        """Method does not return.
