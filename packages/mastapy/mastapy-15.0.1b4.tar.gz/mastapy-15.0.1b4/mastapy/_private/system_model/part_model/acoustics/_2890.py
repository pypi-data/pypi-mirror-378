...
from mastapy._private.system_model import _2420
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2887, _2888
...
class _Cast_ResultSurfaceOptions:
    ...
    @property
    def result_plane_options(self: "CastSelf") -> "_2887.ResultPlaneOptions":
        from mastapy._private.system_model.part_model.acoustics import _2887

        return self.__parent__._cast(_2887.ResultPlaneOptions)

    @property
    def result_sphere_options(self: "CastSelf") -> "_2888.ResultSphereOptions":
        from mastapy._private.system_model.part_model.acoustics import _2888

        return self.__parent__._cast(_2888.ResultSphereOptions)
...
class ResultSurfaceOptions(_0.APIBase):
    ...
    @exception_bridge
    @enforce_parameter_types
    def reference_component(self: "Self", value: "_2675.Component") -> None:
        generic_type = (
    ...
    @exception_bridge
    @enforce_parameter_types
    def reference_component_type(self: "Self", value: "_2420.DesignEntityId") -> None:
