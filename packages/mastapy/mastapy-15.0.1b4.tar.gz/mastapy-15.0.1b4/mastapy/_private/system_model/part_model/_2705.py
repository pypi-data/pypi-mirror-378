...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2675, _2693, _2703
...
class PlanetCarrier(_2698.MountableComponent):
    """PlanetCarrier
    ...
    @property
    @exception_bridge
    def planetary_sockets(self: "Self") -> "List[_2514.PlanetarySocket]":
