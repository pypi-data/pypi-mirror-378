...
class SplinePitchErrorOptions(_0.APIBase):
    ...
    def pitch_error_input_type(
        self: "Self",
        value: "Union[_2849.SplinePitchErrorInputType, Tuple[_2849.SplinePitchErrorInputType, bool]]",
    ) -> None:
    ...
    @property
    @exception_bridge
    def pitch_error_options_left_flank(self: "Self") -> "_2835.PitchErrorFlankOptions":
    ...
    @property
    @exception_bridge
    def pitch_error_options_right_flank(self: "Self") -> "_2835.PitchErrorFlankOptions":
        """mastapy.system_model.part_model.couplings.PitchErrorFlankOptions
    ...
    @property
    @exception_bridge
    def pitch_error_flank_options(self: "Self") -> "List[_2835.PitchErrorFlankOptions]":
