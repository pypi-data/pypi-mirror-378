...
class SpiralBevelGearSet(_2762.BevelGearSet):
    """SpiralBevelGearSet
    ...
    @property
    @exception_bridge
    def spiral_bevel_gears(self: "Self") -> "List[_2786.SpiralBevelGear]":
    ...
    @property
    @exception_bridge
    def spiral_bevel_meshes(self: "Self") -> "List[_2549.SpiralBevelGearMesh]":
