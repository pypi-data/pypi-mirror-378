...
from mastapy._private.system_model.part_model.configurations import _2869
from mastapy._private.system_model.part_model.gears import _2753, _2774
...
class _Cast_ActiveGearSetDesignSelectionGroup:
    ...
    @property
    def part_detail_configuration(self: "CastSelf") -> "_2869.PartDetailConfiguration":
        return self.__parent__._cast(_2869.PartDetailConfiguration)
...
class ActiveGearSetDesignSelectionGroup(
    _2869.PartDetailConfiguration[
        _2753.ActiveGearSetDesignSelection, _2774.GearSet, _1054.GearSetDesign
    ]
):
    """ActiveGearSetDesignSelectionGroup
