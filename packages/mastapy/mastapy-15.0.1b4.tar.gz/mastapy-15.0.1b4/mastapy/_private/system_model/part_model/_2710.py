...
class _Cast_RollingBearingElementLoadCase:
    ...
    @property
    def rolling_bearing_element(self: "CastSelf") -> "_2381.RollingBearingElement":
        return self.__parent__._cast(_2381.RollingBearingElement)
...
class RollingBearingElementLoadCase(_2381.RollingBearingElement):
    """RollingBearingElementLoadCase
