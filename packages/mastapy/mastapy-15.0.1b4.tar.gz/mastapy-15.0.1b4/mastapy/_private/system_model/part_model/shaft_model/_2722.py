...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2767, _2772
...
class WindageLossCalculationParametersForCurvedSurfaceOfSection(_0.APIBase):
    ...
    @property
    @exception_bridge
    def cylindrical_gear(self: "Self") -> "_2767.CylindricalGear":
