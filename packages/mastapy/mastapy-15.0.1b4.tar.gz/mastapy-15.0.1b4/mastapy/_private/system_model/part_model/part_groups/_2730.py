...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2727, _2731, _2732
...
class ParallelPartGroup(_2726.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    @property
    @exception_bridge
    def concentric_part_groups(self: "Self") -> "List[_2727.ConcentricPartGroup]":
