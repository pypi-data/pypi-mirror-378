...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2767, _2784
...
class CylindricalGearSet(_2774.GearSet):
    """CylindricalGearSet
    ...
    def axial_contact_ratio_requirement(
        self: "Self",
        value: "Union[_412.ContactRatioRequirements, Tuple[_412.ContactRatioRequirements, bool]]",
    ) -> None:
    ...
    @property
    @exception_bridge
    def supercharger_rotor_set(self: "Self") -> "_2806.SuperchargerRotorSet":
    ...
    @exception_bridge
    def add_gear(self: "Self") -> "_2767.CylindricalGear":
