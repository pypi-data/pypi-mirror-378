...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2752, _2753
...
class _Cast_PartDetailSelection:
    ...
    def active_cylindrical_gear_set_design_selection(
        self: "CastSelf",
    ) -> "_2752.ActiveCylindricalGearSetDesignSelection":
        from mastapy._private.system_model.part_model.gears import _2752

        return self.__parent__._cast(_2752.ActiveCylindricalGearSetDesignSelection)
    ...
    def active_fe_substructure_selection(
        self: "CastSelf",
    ) -> "_2862.ActiveFESubstructureSelection":
        from mastapy._private.system_model.part_model.configurations import _2862

        return self.__parent__._cast(_2862.ActiveFESubstructureSelection)

    @property
    def active_shaft_design_selection(
        self: "CastSelf",
    ) -> "_2864.ActiveShaftDesignSelection":
        from mastapy._private.system_model.part_model.configurations import _2864

        return self.__parent__._cast(_2864.ActiveShaftDesignSelection)

    @property
    def bearing_detail_selection(self: "CastSelf") -> "_2867.BearingDetailSelection":
        from mastapy._private.system_model.part_model.configurations import _2867

        return self.__parent__._cast(_2867.BearingDetailSelection)
