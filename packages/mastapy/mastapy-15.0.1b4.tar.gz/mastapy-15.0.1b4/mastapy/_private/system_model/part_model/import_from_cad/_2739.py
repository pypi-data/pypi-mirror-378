...
class CylindricalGearFromCAD(_2745.MountableComponentFromCAD):
    """CylindricalGearFromCAD
    ...
    @exception_bridge
    @enforce_parameter_types
    def existing_gear_set(self: "Self", value: "_2768.CylindricalGearSet") -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def meshing_gear(self: "Self", value: "_2767.CylindricalGear") -> None:
        generic_type = (
