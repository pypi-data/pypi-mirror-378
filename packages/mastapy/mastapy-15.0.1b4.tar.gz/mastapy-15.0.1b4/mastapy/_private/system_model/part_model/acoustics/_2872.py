...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2871, _2873, _2876
...
class AcousticAnalysisSetup(_0.APIBase):
    ...
    @property
    @exception_bridge
    def analysis_options(self: "Self") -> "_2871.AcousticAnalysisOptions":
    ...
    @property
    @exception_bridge
    def cache_reporting(self: "Self") -> "_2873.AcousticAnalysisSetupCacheReporting":
    ...
    @property
    @exception_bridge
    def input_surface_options(self: "Self") -> "_2876.AcousticInputSurfaceOptions":
