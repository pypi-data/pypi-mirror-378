...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.configurations import _2870
...
class _Cast_ActiveCylindricalGearSetDesignSelection:
    ...
    def active_gear_set_design_selection(
        self: "CastSelf",
    ) -> "_2753.ActiveGearSetDesignSelection":
        return self.__parent__._cast(_2753.ActiveGearSetDesignSelection)

    @property
    def part_detail_selection(self: "CastSelf") -> "_2870.PartDetailSelection":
        pass

        from mastapy._private.system_model.part_model.configurations import _2870

        return self.__parent__._cast(_2870.PartDetailSelection)
...
class ActiveCylindricalGearSetDesignSelection(_2753.ActiveGearSetDesignSelection):
    """ActiveCylindricalGearSetDesignSelection
