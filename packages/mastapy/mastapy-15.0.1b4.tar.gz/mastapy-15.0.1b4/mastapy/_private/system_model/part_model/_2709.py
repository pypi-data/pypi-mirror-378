...
class _Cast_RadialInternalClearanceTolerance:
    ...
    def internal_clearance_tolerance(
        self: "CastSelf",
    ) -> "_2691.InternalClearanceTolerance":
        return self.__parent__._cast(_2691.InternalClearanceTolerance)
...
class RadialInternalClearanceTolerance(_2691.InternalClearanceTolerance):
    """RadialInternalClearanceTolerance
