...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2667, _2692
...
class LoadSharingSettings(_0.APIBase):
    ...
    @property
    @exception_bridge
    def planetary_load_sharing(self: "Self") -> "_2692.LoadSharingModes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model._2692", "LoadSharingModes"
        )(value)

    @planetary_load_sharing.setter
    @exception_bridge
    @enforce_parameter_types
    def planetary_load_sharing(self: "Self", value: "_2692.LoadSharingModes") -> None:
    ...
    def planetary_load_sharing_agma_application_level(
        self: "Self",
    ) -> "_2667.AGMALoadSharingTableApplicationLevel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model._2667",
    ...
    @enforce_parameter_types
    def planetary_load_sharing_agma_application_level(
        self: "Self", value: "_2667.AGMALoadSharingTableApplicationLevel"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.AGMALoadSharingTableApplicationLevel",
