...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.part_groups import _2726, _2729, _2732
...
class _Cast_ParallelPartGroupSelection:
    ...
    def concentric_or_parallel_part_group(
        self: "CastSelf",
    ) -> "_2726.ConcentricOrParallelPartGroup":
        from mastapy._private.system_model.part_model.part_groups import _2726

        return self.__parent__._cast(_2726.ConcentricOrParallelPartGroup)
...
class ParallelPartGroupSelection(_2730.ParallelPartGroup):
    """ParallelPartGroupSelection
    ...
    @property
    @exception_bridge
    def design_measurements(self: "Self") -> "List[_2729.DesignMeasurements]":
