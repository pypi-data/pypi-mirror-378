...
class SuperchargerRotorSet(_2033.NamedDatabaseItem):
    """SuperchargerRotorSet
    ...
    @property
    @exception_bridge
    def y_variable_for_imported_data(self: "Self") -> "_2808.YVariableForImportedData":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.gears.supercharger_rotor_set._2808",
    ...
    def y_variable_for_imported_data(
        self: "Self", value: "_2808.YVariableForImportedData"
    ) -> None:
    ...
    @property
    @exception_bridge
    def boost_pressure(self: "Self") -> "_2798.BoostPressureInputOptions":
    ...
    @property
    @exception_bridge
    def file(self: "Self") -> "_2801.RotorSetDataInputFileOptions":
    ...
    @property
    @exception_bridge
    def input_power(self: "Self") -> "_2799.InputPowerInputOptions":
    ...
    @property
    @exception_bridge
    def pressure_ratio(self: "Self") -> "_2800.PressureRatioInputOptions":
    ...
    @property
    @exception_bridge
    def rotor_speed(self: "Self") -> "_2803.RotorSpeedInputOptions":
    ...
    @property
    @exception_bridge
    def measured_points(self: "Self") -> "List[_2802.RotorSetMeasuredPoint]":
