...
class Synchroniser(_2713.SpecialisedAssembly):
    """Synchroniser
    ...
    @property
    @exception_bridge
    def clutch_connection_left(self: "Self") -> "_2568.ClutchConnection":
    ...
    @property
    @exception_bridge
    def clutch_connection_right(self: "Self") -> "_2568.ClutchConnection":
        """mastapy.system_model.connections_and_sockets.couplings.ClutchConnection
    ...
    @property
    @exception_bridge
    def hub_and_sleeve(self: "Self") -> "_2857.SynchroniserSleeve":
    ...
    @property
    @exception_bridge
    def left_cone(self: "Self") -> "_2855.SynchroniserHalf":
    ...
    @property
    @exception_bridge
    def right_cone(self: "Self") -> "_2855.SynchroniserHalf":
        """mastapy.system_model.part_model.couplings.SynchroniserHalf
