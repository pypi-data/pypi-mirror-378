...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization.machine_learning import _2463, _2465
...
class _Cast_LoadCaseSettings:
    ...
    @property
    def load_case_constraint(self: "CastSelf") -> "_2463.LoadCaseConstraint":
        from mastapy._private.system_model.optimization.machine_learning import _2463

        return self.__parent__._cast(_2463.LoadCaseConstraint)

    @property
    def load_case_target(self: "CastSelf") -> "_2465.LoadCaseTarget":
        from mastapy._private.system_model.optimization.machine_learning import _2465

        return self.__parent__._cast(_2465.LoadCaseTarget)
...
class LoadCaseSettings(_0.APIBase):
    ...
    def load_case_selection(self: "Self", value: "_7679.StaticLoadCase") -> None:
        generic_type = (
    ...
    @exception_bridge
    @enforce_parameter_types
    def mesh(self: "Self", value: "_2535.CylindricalGearMesh") -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def target_property(self: "Self", value: "_2449.OptimizationParameter") -> None:
