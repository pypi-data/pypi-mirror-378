...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2768, _2774
    from mastapy._private.utility.logging import _2010
...
class SystemOptimiser(_0.APIBase):
    ...
    def selected_duty_cycle_for_system_optimiser(
        self: "Self", value: "_5959.DutyCycle"
    ) -> None:
        generic_type = (
    ...
    @property
    @exception_bridge
    def design(self: "Self") -> "_2416.Design":
    ...
    @property
    @exception_bridge
    def details(self: "Self") -> "_2457.SystemOptimiserDetails":
    ...
    @property
    @exception_bridge
    def log(self: "Self") -> "_2010.Logger":
    ...
    @property
    @exception_bridge
    def tooth_number_finder(self: "Self") -> "_2458.ToothNumberFinder":
    ...
    def system_optimisation_gear_sets(
        self: "Self",
    ) -> "List[_5963.SystemOptimisationGearSet]":
    ...
    @property
    @exception_bridge
    def target_ratios(self: "Self") -> "List[_2454.DesignStateTargetRatio]":
    ...
    @property
    @exception_bridge
    def system_optimiser_duty_cycle(self: "Self") -> "_5959.DutyCycle":
    ...
    @exception_bridge
    @enforce_parameter_types
    def system_optimiser_duty_cycle(self: "Self", value: "_5959.DutyCycle") -> None:
