...
from mastapy._private.system_model.optimization import _2450
...
class _Cast_CylindricalGearOptimizationStep:
    ...
    @property
    def optimization_step(self: "CastSelf") -> "_2450.OptimizationStep":
        return self.__parent__._cast(_2450.OptimizationStep)
...
class CylindricalGearOptimizationStep(_2450.OptimizationStep):
    """CylindricalGearOptimizationStep
