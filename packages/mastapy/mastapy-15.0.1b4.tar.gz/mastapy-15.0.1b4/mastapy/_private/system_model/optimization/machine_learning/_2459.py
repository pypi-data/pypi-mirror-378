...
class _Cast_CylindricalGearFlankOptimisationParameter:
    ...
    @property
    def optimization_property(self: "CastSelf") -> "_1733.OptimizationProperty":
        return self.__parent__._cast(_1733.OptimizationProperty)
...
class CylindricalGearFlankOptimisationParameter(_1733.OptimizationProperty):
    """CylindricalGearFlankOptimisationParameter
