...
class PowerLoadCompoundModalAnalysis(_5130.VirtualComponentCompoundModalAnalysis):
    """PowerLoadCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4948.PowerLoadModalAnalysis]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4948.PowerLoadModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PowerLoadModalAnalysis]
