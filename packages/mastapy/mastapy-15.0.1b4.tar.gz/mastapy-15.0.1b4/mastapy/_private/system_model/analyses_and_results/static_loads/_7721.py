...
class ConicalGearSetHarmonicLoadData(_7768.GearSetHarmonicLoadData):
    """ConicalGearSetHarmonicLoadData
    ...
    @property
    @exception_bridge
    def te_specification_type(self: "Self") -> "_440.TESpecificationType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._440", "TESpecificationType"
        )(value)

    @te_specification_type.setter
    @exception_bridge
    @enforce_parameter_types
    def te_specification_type(self: "Self", value: "_440.TESpecificationType") -> None:
