...
from mastapy._private.math_utility import _1679, _1716
...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1705, _1722
    from mastapy._private.math_utility.measured_data_scaling import _1758
    ...
    from mastapy._private.system_model.drawing.options import _2487, _2489
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @exception_bridge
    @enforce_parameter_types
    def chart_type(self: "Self", value: "_4901.DynamicsResponse3DChartType") -> None:
    ...
    @property
    @exception_bridge
    def connected_component_type(self: "Self") -> "_6155.ConnectedComponentType":
    ...
    def connected_component_type(
        self: "Self", value: "_6155.ConnectedComponentType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ConnectedComponentType",
    ...
    @property
    @exception_bridge
    def coordinate_system(self: "Self") -> "_4884.CoordinateSystemForWhine":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4884",
    ...
    def coordinate_system(
        self: "Self", value: "_4884.CoordinateSystemForWhine"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.CoordinateSystemForWhine",
    ...
    @exception_bridge
    @enforce_parameter_types
    def response_type(self: "Self", value: "_4902.DynamicsResponseType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def speed_range_for_combining_excitations(
        self: "Self",
    ) -> "_4937.MultipleExcitationsSpeedRangeOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4937",
    ...
    @enforce_parameter_types
    def speed_range_for_combining_excitations(
        self: "Self", value: "_4937.MultipleExcitationsSpeedRangeOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.MultipleExcitationsSpeedRangeOption",
    ...
    @property
    @exception_bridge
    def translation_or_rotation(self: "Self") -> "_1722.TranslationRotation":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1722", "TranslationRotation"
        )(value)
    ...
    def translation_or_rotation(
        self: "Self", value: "_1722.TranslationRotation"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def vector_magnitude_method(self: "Self") -> "_1705.ComplexMagnitudeMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1705", "ComplexMagnitudeMethod"
        )(value)
    ...
    def vector_magnitude_method(
        self: "Self", value: "_1705.ComplexMagnitudeMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def whine_waterfall_export_option(
        self: "Self",
    ) -> "_4986.WhineWaterfallExportOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.modal_analyses._4986",
    ...
    @enforce_parameter_types
    def whine_waterfall_export_option(
        self: "Self", value: "_4986.WhineWaterfallExportOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.WhineWaterfallExportOption",
    ...
    @property
    @exception_bridge
    def data_scaling(self: "Self") -> "_1758.DataScalingOptions":
    ...
    def modal_contribution_view_options(
        self: "Self",
    ) -> "_2489.ModalContributionViewOptions":
    ...
    def mode_view_options(
        self: "Self",
    ) -> "_2487.AdvancedTimeSteppingAnalysisForModulationModeViewOptions":
    ...
    @property
    @exception_bridge
    def order_cuts_chart_settings(self: "Self") -> "_4939.OrderCutsChartSettings":
    ...
    def result_location_selection_groups(
        self: "Self",
    ) -> "_6163.ResultLocationSelectionGroups":
    ...
    @property
    @exception_bridge
    def selected_excitations(self: "Self") -> "_6158.ExcitationSourceSelectionGroup":
    ...
    @property
    @exception_bridge
    def waterfall_chart_settings(self: "Self") -> "_4985.WaterfallChartSettings":
    ...
    @property
    @exception_bridge
    def active_result_locations(self: "Self") -> "List[_6164.ResultNodeSelection]":
    ...
    def degrees_of_freedom(
        self: "Self",
    ) -> "List[_2051.EnumWithBoolean[_1716.ResultOptionsFor3DVector]]":
