...
from mastapy._private.system_model.analyses_and_results.rotor_dynamics import _4295
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results.rotor_dynamics import _4293
...
class _Cast_ShaftModalComplexShapeAtStiffness:
    ...
    @property
    def shaft_complex_shape(self: "CastSelf") -> "_4293.ShaftComplexShape":
        pass
        ...
        return self.__parent__._cast(_4293.ShaftComplexShape)
...
class ShaftModalComplexShapeAtStiffness(_4295.ShaftModalComplexShape):
    """ShaftModalComplexShapeAtStiffness
