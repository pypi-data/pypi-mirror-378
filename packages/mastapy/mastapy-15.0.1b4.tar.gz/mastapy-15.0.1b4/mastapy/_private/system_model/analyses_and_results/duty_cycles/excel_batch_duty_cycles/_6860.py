...
class ExcelFileDetails(_0.APIBase):
    ...
    @exception_bridge
    @enforce_parameter_types
    def cycles_unit(self: "Self", value: "_1807.Unit") -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def duration_unit(self: "Self", value: "_1807.Unit") -> None:
        generic_type = list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        value = promote_to_list_with_selected_item(value)
        value = conversion.mp_to_pn_smt_list_with_selected_item(
            self, value, generic_type
    ...
    @exception_bridge
    @enforce_parameter_types
    def speed_unit(self: "Self", value: "_1807.Unit") -> None:
        generic_type = list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        value = promote_to_list_with_selected_item(value)
        value = conversion.mp_to_pn_smt_list_with_selected_item(
            self, value, generic_type
    ...
    @exception_bridge
    @enforce_parameter_types
    def torque_unit(self: "Self", value: "_1807.Unit") -> None:
        generic_type = list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        value = promote_to_list_with_selected_item(value)
        value = conversion.mp_to_pn_smt_list_with_selected_item(
            self, value, generic_type
