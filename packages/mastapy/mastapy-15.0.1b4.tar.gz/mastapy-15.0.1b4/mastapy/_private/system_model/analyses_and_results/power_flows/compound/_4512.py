...
class MicrophoneArrayCompoundPowerFlow(_4535.SpecialisedAssemblyCompoundPowerFlow):
    """MicrophoneArrayCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4378.MicrophoneArrayPowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4378.MicrophoneArrayPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.MicrophoneArrayPowerFlow]
