...
class _Cast_HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation:
    ...
    @property
    def harmonic_analysis_options(self: "CastSelf") -> "_6063.HarmonicAnalysisOptions":
        return self.__parent__._cast(_6063.HarmonicAnalysisOptions)
