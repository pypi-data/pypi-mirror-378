...
class ModalAnalysis(_7897.StaticLoadAnalysisCase):
    """ModalAnalysis
    ...
    @property
    @exception_bridge
    def analysis_settings(self: "Self") -> "_4935.ModalAnalysisOptions":
    ...
    @property
    @exception_bridge
    def bar_model_export(self: "Self") -> "_4933.ModalAnalysisBarModelFEExportOptions":
    ...
    @property
    @exception_bridge
    def modal_analysis_results(self: "Self") -> "_6646.DynamicAnalysis":
    ...
    @property
    @exception_bridge
    def normal_modes(self: "Self") -> "List[_1692.Eigenmode]":
