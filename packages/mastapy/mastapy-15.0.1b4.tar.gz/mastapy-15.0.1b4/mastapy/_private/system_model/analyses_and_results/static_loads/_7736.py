...
class _Cast_CylindricalGearManufactureError:
    ...
    @property
    def gear_manufacture_error(self: "CastSelf") -> "_7765.GearManufactureError":
        return self.__parent__._cast(_7765.GearManufactureError)
...
class CylindricalGearManufactureError(_7765.GearManufactureError):
    """CylindricalGearManufactureError
    ...
    @property
    @exception_bridge
    def pitch_errors_left_flank(self: "Self") -> "_1723.Vector2DListAccessor":
    ...
    @property
    @exception_bridge
    def pitch_errors_right_flank(self: "Self") -> "_1723.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
