...
class _Cast_HarmonicAnalysisExportOptions:
    ...
    def harmonic_analysis_shaft_export_options(
        self: "CastSelf",
    ) -> "_6066.HarmonicAnalysisShaftExportOptions":
        from mastapy._private.system_model.analyses_and_results.harmonic_analyses import (
            _6066,
        )

        return self.__parent__._cast(_6066.HarmonicAnalysisShaftExportOptions)
...
class HarmonicAnalysisExportOptions(_0.APIBase, Generic[TPartAnalysis, TPart]):
    ...
    def distance_units_for_export(self: "Self", value: "_1807.Unit") -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def export_type(self: "Self", value: "_6041.ExportOutputType") -> None:
    ...
    @enforce_parameter_types
    def type_of_result_to_export(
        self: "Self", value: "_4902.DynamicsResponseType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    @exception_bridge
    def analysis_options(self: "Self") -> "_6063.HarmonicAnalysisOptions":
