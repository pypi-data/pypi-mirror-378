...
class RollingRingAssemblySystemDeflection(_3054.SpecialisedAssemblySystemDeflection):
    """RollingRingAssemblySystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4396.RollingRingAssemblyPowerFlow":
