...
class PowerLoadAdvancedSystemDeflection(_7528.VirtualComponentAdvancedSystemDeflection):
    """PowerLoadAdvancedSystemDeflection
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_3040.PowerLoadSystemDeflection]":
    ...
    def transmission_error_to_other_power_loads(
        self: "Self",
    ) -> "List[_7526.TransmissionErrorToOtherPowerLoad]":
