...
class ConicalGearSetMultibodyDynamicsAnalysis(_5729.GearSetMultibodyDynamicsAnalysis):
    """ConicalGearSetMultibodyDynamicsAnalysis
    ...
    def gears_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5701.ConicalGearMultibodyDynamicsAnalysis]":
    ...
    def meshes_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5700.ConicalGearMeshMultibodyDynamicsAnalysis]":
