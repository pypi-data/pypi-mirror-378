...
class HypoidGearSetLoadCase(_7689.AGMAGleasonConicalGearSetLoadCase):
    """HypoidGearSetLoadCase
    ...
    @property
    @exception_bridge
    def hypoid_gears_load_case(self: "Self") -> "List[_7779.HypoidGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.HypoidGearLoadCase]
    ...
    def agma_gleason_conical_meshes_load_case(
        self: "Self",
    ) -> "List[_7780.HypoidGearMeshLoadCase]":
    ...
    @property
    @exception_bridge
    def hypoid_meshes_load_case(self: "Self") -> "List[_7780.HypoidGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.HypoidGearMeshLoadCase]
