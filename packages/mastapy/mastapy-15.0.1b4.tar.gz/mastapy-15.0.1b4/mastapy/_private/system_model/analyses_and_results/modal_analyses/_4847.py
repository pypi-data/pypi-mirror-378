...
class AbstractAssemblyModalAnalysis(_4940.PartModalAnalysis):
    """AbstractAssemblyModalAnalysis
    ...
    @property
    @exception_bridge
    def gear_meshes(self: "Self") -> "List[_4910.GearMeshModalAnalysis]":
    ...
    @property
    @exception_bridge
    def rigidly_connected_groups(self: "Self") -> "List[_4872.ComponentModalAnalysis]":
