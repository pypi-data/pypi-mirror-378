...
class SpringDamperConnectionSystemDeflection(_2975.CouplingConnectionSystemDeflection):
    """SpringDamperConnectionSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4407.SpringDamperConnectionPowerFlow":
