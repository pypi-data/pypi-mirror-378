...
class ConicalGearManufactureError(_7765.GearManufactureError):
    """ConicalGearManufactureError
    ...
    @property
    @exception_bridge
    def pitch_errors_concave_flank(self: "Self") -> "_1723.Vector2DListAccessor":
    ...
    @property
    @exception_bridge
    def pitch_errors_convex_flank(self: "Self") -> "_1723.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
