...
class CylindricalMeshedGearSystemDeflection(_0.APIBase):
    ...
    @property
    @exception_bridge
    def left_flank(self: "Self") -> "_2994.CylindricalMeshedGearFlankSystemDeflection":
    ...
    @property
    @exception_bridge
    def right_flank(self: "Self") -> "_2994.CylindricalMeshedGearFlankSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalMeshedGearFlankSystemDeflection
    ...
    def flanks(
        self: "Self",
    ) -> "List[_2994.CylindricalMeshedGearFlankSystemDeflection]":
    ...
    @property
    @exception_bridge
    def both_flanks(self: "Self") -> "_2994.CylindricalMeshedGearFlankSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalMeshedGearFlankSystemDeflection
