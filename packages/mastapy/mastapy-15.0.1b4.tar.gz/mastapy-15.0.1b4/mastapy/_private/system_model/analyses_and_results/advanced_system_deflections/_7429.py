...
class ConceptGearAdvancedSystemDeflection(_7460.GearAdvancedSystemDeflection):
    """ConceptGearAdvancedSystemDeflection
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_643.ConceptGearRating":
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7715.ConceptGearLoadCase":
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_2968.ConceptGearSystemDeflection]":
