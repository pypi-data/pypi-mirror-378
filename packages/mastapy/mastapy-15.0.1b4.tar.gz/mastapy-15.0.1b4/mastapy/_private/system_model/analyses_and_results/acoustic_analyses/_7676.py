...
from mastapy._private.system_model.analyses_and_results.acoustic_analyses import _7675
...
class _Cast_SingleHarmonicExcitationAnalysisDetail:
    ...
    @property
    def single_excitation_details(self: "CastSelf") -> "_7675.SingleExcitationDetails":
        return self.__parent__._cast(_7675.SingleExcitationDetails)
...
class SingleHarmonicExcitationAnalysisDetail(_7675.SingleExcitationDetails):
    """SingleHarmonicExcitationAnalysisDetail
