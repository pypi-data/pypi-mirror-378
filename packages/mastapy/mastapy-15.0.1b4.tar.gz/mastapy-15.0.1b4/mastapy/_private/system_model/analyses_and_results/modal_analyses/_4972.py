...
class StraightBevelGearSetModalAnalysis(_4865.BevelGearSetModalAnalysis):
    """StraightBevelGearSetModalAnalysis
    ...
    def bevel_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4971.StraightBevelGearModalAnalysis]":
    ...
    def bevel_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4970.StraightBevelGearMeshModalAnalysis]":
