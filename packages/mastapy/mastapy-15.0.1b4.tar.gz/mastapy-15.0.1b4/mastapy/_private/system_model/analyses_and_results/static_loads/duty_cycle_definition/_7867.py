...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5958
from mastapy._private.utility_gui import _2055
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2423
...
class _Cast_DesignStateOptions:
    ...
    @property
    def column_input_options(self: "CastSelf") -> "_2055.ColumnInputOptions":
        return self.__parent__._cast(_2055.ColumnInputOptions)
...
class DesignStateOptions(_2055.ColumnInputOptions):
    """DesignStateOptions
    ...
    @exception_bridge
    @enforce_parameter_types
    def design_state(self: "Self", value: "_5958.DesignState") -> None:
        generic_type = (
    ...
    def design_state_destinations(
        self: "Self",
    ) -> "List[_2423.DutyCycleImporterDesignEntityMatch[_5958.DesignState]]":
