...
class StraightBevelGearSetCompoundDynamicAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6708.StraightBevelGearSetDynamicAnalysis]":
    ...
    def straight_bevel_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6837.StraightBevelGearCompoundDynamicAnalysis]":
    ...
    def straight_bevel_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6838.StraightBevelGearMeshCompoundDynamicAnalysis]":
