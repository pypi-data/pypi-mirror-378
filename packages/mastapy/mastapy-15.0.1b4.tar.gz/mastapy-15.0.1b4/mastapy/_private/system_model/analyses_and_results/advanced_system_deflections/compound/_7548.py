...
class BevelDifferentialGearSetCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_7413.BevelDifferentialGearSetAdvancedSystemDeflection]":
    ...
    def bevel_differential_gears_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7546.BevelDifferentialGearCompoundAdvancedSystemDeflection]":
    ...
    def bevel_differential_meshes_compound_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7547.BevelDifferentialGearMeshCompoundAdvancedSystemDeflection]":
