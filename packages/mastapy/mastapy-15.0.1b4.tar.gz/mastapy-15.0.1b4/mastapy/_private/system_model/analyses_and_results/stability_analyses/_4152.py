...
class TorqueConverterTurbineStabilityAnalysis(_4063.CouplingHalfStabilityAnalysis):
    """TorqueConverterTurbineStabilityAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7852.TorqueConverterTurbineLoadCase":
