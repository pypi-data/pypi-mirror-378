...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    @exception_bridge
    def analysis_type(self: "Self") -> "_5671.AnalysisTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5671",
            "AnalysisTypes",
        )(value)
    ...
    def analysis_type(self: "Self", value: "_5671.AnalysisTypes") -> None:
    ...
    def method_to_define_period(
        self: "Self",
    ) -> "_5734.InertiaAdjustedLoadCasePeriodMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5734",
    ...
    @enforce_parameter_types
    def method_to_define_period(
        self: "Self", value: "_5734.InertiaAdjustedLoadCasePeriodMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCasePeriodMethod",
    ...
    @enforce_parameter_types
    def reference_power_load_to_define_period(
        self: "Self", value: "_2708.PowerLoad"
    ) -> None:
        generic_type = (
    ...
    def static_load_cases_to_create(
        self: "Self",
    ) -> "_5735.InertiaAdjustedLoadCaseResultsToCreate":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5735",
    ...
    @enforce_parameter_types
    def static_load_cases_to_create(
        self: "Self", value: "_5735.InertiaAdjustedLoadCaseResultsToCreate"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCaseResultsToCreate",
    ...
    def external_interface_options(
        self: "Self",
    ) -> "_5821.DynamicExternalInterfaceOptions":
    ...
    def frequency_response_options(
        self: "Self",
    ) -> "_4909.FrequencyResponseAnalysisOptions":
    ...
    @property
    @exception_bridge
    def run_up_analysis_options(self: "Self") -> "_5751.MBDRunUpAnalysisOptions":
    ...
    @property
    @exception_bridge
    def spline_damping_options(self: "Self") -> "_5784.SplineDampingOptions":
    ...
    def add_logging_variable(
        self: "Self",
        design_entity: "_2419.DesignEntity",
        path: "List[str]",
    ...
    def remove_logging_variable(
        self: "Self", logging_variable: "_2894.AnalysisCaseVariable"
    ) -> None:
