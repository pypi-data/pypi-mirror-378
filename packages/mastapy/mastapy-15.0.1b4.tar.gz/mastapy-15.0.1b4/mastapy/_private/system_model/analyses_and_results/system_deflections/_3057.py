...
class SpiralBevelGearSystemDeflection(_2954.BevelGearSystemDeflection):
    """SpiralBevelGearSystemDeflection
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_495.SpiralBevelGearRating":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4405.SpiralBevelGearPowerFlow":
