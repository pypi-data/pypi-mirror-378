...
class SpiralBevelGearSetPowerFlow(_4316.BevelGearSetPowerFlow):
    """SpiralBevelGearSetPowerFlow
    ...
    @property
    @exception_bridge
    def bevel_gears_power_flow(self: "Self") -> "List[_4405.SpiralBevelGearPowerFlow]":
    ...
    def spiral_bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4405.SpiralBevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SpiralBevelGearPowerFlow]
