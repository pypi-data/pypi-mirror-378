...
TConnection = TypeVar("TConnection", bound="_2498.Connection")
TConnectionStaticLoad = TypeVar(
    "TConnectionStaticLoad", bound="_7723.ConnectionLoadCase"
)
...
class ConnectionStaticLoadCaseGroup(
    _5970.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]
):
    """ConnectionStaticLoadCaseGroup
