...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6720
...
class PointLoadDynamicAnalysis(_6720.VirtualComponentDynamicAnalysis):
    """PointLoadDynamicAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7814.PointLoadLoadCase":
