...
class HypoidGearSetPowerFlow(_4304.AGMAGleasonConicalGearSetPowerFlow):
    """HypoidGearSetPowerFlow
    ...
    @property
    @exception_bridge
    def rating(self: "Self") -> "_532.HypoidGearSetRating":
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_532.HypoidGearSetRating":
        """mastapy.gears.rating.hypoid.HypoidGearSetRating
    ...
    def agma_gleason_conical_gears_power_flow(
        self: "Self",
    ) -> "List[_4364.HypoidGearPowerFlow]":
    ...
    @property
    @exception_bridge
    def hypoid_gears_power_flow(self: "Self") -> "List[_4364.HypoidGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearPowerFlow]
    ...
    def agma_gleason_conical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4363.HypoidGearMeshPowerFlow]":
    ...
    @property
    @exception_bridge
    def hypoid_meshes_power_flow(self: "Self") -> "List[_4363.HypoidGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearMeshPowerFlow]
