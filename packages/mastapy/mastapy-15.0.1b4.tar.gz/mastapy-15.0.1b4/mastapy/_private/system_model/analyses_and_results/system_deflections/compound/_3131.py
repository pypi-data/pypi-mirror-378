...
class ConicalGearCompoundSystemDeflection(_3158.GearCompoundSystemDeflection):
    """ConicalGearCompoundSystemDeflection
    ...
    @property
    @exception_bridge
    def duty_cycle_rating(self: "Self") -> "_630.ConicalGearDutyCycleRating":
    ...
    @property
    @exception_bridge
    def conical_duty_cycle_rating(self: "Self") -> "_630.ConicalGearDutyCycleRating":
        """mastapy.gears.rating.conical.ConicalGearDutyCycleRating
