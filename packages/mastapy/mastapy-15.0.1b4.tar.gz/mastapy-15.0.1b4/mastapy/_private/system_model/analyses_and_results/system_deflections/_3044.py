...
class RingPinToDiscContactReporting(_0.APIBase):
    ...
    @property
    @exception_bridge
    def contact(self: "Self") -> "_3098.SplineFlankContactReporting":
    ...
    def information_at_ring_pin_to_disc_contact_point_from_geometry(
        self: "Self",
    ) -> "_7783.InformationAtRingPinToDiscContactPointFromGeometry":
    ...
    def information_for_contact_points_along_face_width(
        self: "Self",
    ) -> "List[_3012.InformationForContactAtPointAlongFaceWidth]":
