...
class _Cast_HarmonicAnalysisBarModelFEExportOptions:
    ...
    def modal_analysis_bar_model_base_fe_export_options(
        self: "CastSelf",
    ) -> "_4932.ModalAnalysisBarModelBaseFEExportOptions":
        return self.__parent__._cast(_4932.ModalAnalysisBarModelBaseFEExportOptions)
...
class HarmonicAnalysisBarModelFEExportOptions(
    ...
    @exception_bridge
    @enforce_parameter_types
    def fe_package(self: "Self", value: "_247.FEExportFormat") -> None:
