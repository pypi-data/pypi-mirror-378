...
class RingPinsSystemDeflection(_3030.MountableComponentSystemDeflection):
    """RingPinsSystemDeflection
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7819.RingPinsLoadCase":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4394.RingPinsPowerFlow":
