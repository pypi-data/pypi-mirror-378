...
class ShaftHarmonicAnalysis(
    _5975.AbstractShaftHarmonicAnalysis, _2902.IHaveShaftHarmonicResults
):
    """ShaftHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def coupled_modal_analysis(self: "Self") -> "_4957.ShaftModalAnalysis":
    ...
    @property
    @exception_bridge
    def export(self: "Self") -> "_6066.HarmonicAnalysisShaftExportOptions":
