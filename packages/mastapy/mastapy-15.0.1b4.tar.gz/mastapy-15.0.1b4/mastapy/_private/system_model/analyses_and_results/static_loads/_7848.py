...
class TimeSeriesLoadCase(_7678.LoadCase):
    """TimeSeriesLoadCase
    ...
    @property
    @exception_bridge
    def driva_analysis_options(self: "Self") -> "_5750.MBDAnalysisOptions":
    ...
    @property
    @exception_bridge
    def multibody_dynamics_analysis(self: "Self") -> "_5756.MultibodyDynamicsAnalysis":
    ...
    @property
    @exception_bridge
    def time_series_load_case_group(self: "Self") -> "_5966.TimeSeriesLoadCaseGroup":
    ...
    def duplicate(
        self: "Self",
        new_load_case_group: "_5966.TimeSeriesLoadCaseGroup",
        name: "str" = "None",
    ) -> "TimeSeriesLoadCase":
