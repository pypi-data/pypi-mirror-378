...
class ZerolBevelGearSetCompoundPowerFlow(_4453.BevelGearSetCompoundPowerFlow):
    """ZerolBevelGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4434.ZerolBevelGearSetPowerFlow]":
    ...
    def zerol_bevel_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4563.ZerolBevelGearCompoundPowerFlow]":
    ...
    def zerol_bevel_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4564.ZerolBevelGearMeshCompoundPowerFlow]":
