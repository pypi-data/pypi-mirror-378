...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2930
...
class AdvancedTimeSteppingAnalysisForModulationOptions(_0.APIBase):
    ...
    def advanced_time_stepping_analysis_method(
        self: "Self",
    ) -> "_7686.AdvancedTimeSteppingAnalysisForModulationType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7686",
    ...
    def advanced_time_stepping_analysis_method(
        self: "Self", value: "_7686.AdvancedTimeSteppingAnalysisForModulationType"
    ) -> None:
    ...
    @property
    @exception_bridge
    def time_options(self: "Self") -> "_2930.TimeOptions":
