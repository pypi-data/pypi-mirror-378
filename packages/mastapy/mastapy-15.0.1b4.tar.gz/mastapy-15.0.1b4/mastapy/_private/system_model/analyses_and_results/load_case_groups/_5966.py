...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2893, _2921
...
class TimeSeriesLoadCaseGroup(_5954.AbstractLoadCaseGroup):
    """TimeSeriesLoadCaseGroup
    ...
    @property
    @exception_bridge
    def load_cases(self: "Self") -> "List[_7848.TimeSeriesLoadCase]":
