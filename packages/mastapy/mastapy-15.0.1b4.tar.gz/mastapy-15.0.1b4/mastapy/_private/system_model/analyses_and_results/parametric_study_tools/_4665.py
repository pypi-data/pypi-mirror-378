...
class _Cast_ParametricStudyVariable:
    ...
    @property
    def analysis_case_variable(self: "CastSelf") -> "_2894.AnalysisCaseVariable":
        return self.__parent__._cast(_2894.AnalysisCaseVariable)
...
class ParametricStudyVariable(_2894.AnalysisCaseVariable):
    """ParametricStudyVariable
    ...
    @property
    @exception_bridge
    def dimension(self: "Self") -> "_4657.ParametricStudyDimension":
    ...
    def dimension(self: "Self", value: "_4657.ParametricStudyDimension") -> None:
    ...
    @property
    @exception_bridge
    def distribution(self: "Self") -> "_4652.MonteCarloDistribution":
    ...
    @exception_bridge
    @enforce_parameter_types
    def distribution(self: "Self", value: "_4652.MonteCarloDistribution") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ParametricStudyTools.MonteCarloDistribution",
        )
    ...
    @property
    @exception_bridge
    def doe_variable_setter(self: "Self") -> "_4618.DesignOfExperimentsVariableSetter":
