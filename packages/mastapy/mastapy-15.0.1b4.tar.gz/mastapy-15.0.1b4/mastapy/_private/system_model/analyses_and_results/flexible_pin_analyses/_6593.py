...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5959
...
class _Cast_WindTurbineCertificationReport:
    ...
    @property
    def combination_analysis(self: "CastSelf") -> "_6585.CombinationAnalysis":
        return self.__parent__._cast(_6585.CombinationAnalysis)
...
class WindTurbineCertificationReport(_6585.CombinationAnalysis):
    """WindTurbineCertificationReport
    ...
    def extreme_load_case(self: "Self", value: "_7679.StaticLoadCase") -> None:
        generic_type = (
    ...
    @exception_bridge
    @enforce_parameter_types
    def ldd(self: "Self", value: "_5959.DutyCycle") -> None:
        generic_type = (
    ...
    @exception_bridge
    @enforce_parameter_types
    def nominal_load_case(self: "Self", value: "_7679.StaticLoadCase") -> None:
        generic_type = (
            list_with_selected_item.ListWithSelectedItem_StaticLoadCase.implicit_type()
        )
        value = promote_to_list_with_selected_item(value)
    ...
    @property
    @exception_bridge
    def design(self: "Self") -> "_2711.RootAssembly":
