...
class HarmonicAnalysisResultsBrokenDownByComponentWithinAHarmonic(
    ...
    def dynamic_mesh_force(
        self: "Self",
    ) -> "_6184.ResultsForResponseOfAComponentOrSurfaceInAHarmonic":
    ...
    @property
    @exception_bridge
    def sound_intensity(self: "Self") -> "_6185.ResultsForResponseOfANodeOnAHarmonic":
    ...
    @property
    @exception_bridge
    def sound_velocity(self: "Self") -> "_6185.ResultsForResponseOfANodeOnAHarmonic":
        """mastapy.system_model.analyses_and_results.harmonic_analyses.reportable_property_results.ResultsForResponseOfANodeOnAHarmonic
