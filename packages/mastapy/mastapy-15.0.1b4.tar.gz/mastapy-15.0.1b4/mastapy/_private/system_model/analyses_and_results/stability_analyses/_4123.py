...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _4032
...
class RootAssemblyStabilityAnalysis(_4032.AssemblyStabilityAnalysis):
    """RootAssemblyStabilityAnalysis
    ...
    @property
    @exception_bridge
    def stability_analysis_inputs(self: "Self") -> "_4134.StabilityAnalysis":
