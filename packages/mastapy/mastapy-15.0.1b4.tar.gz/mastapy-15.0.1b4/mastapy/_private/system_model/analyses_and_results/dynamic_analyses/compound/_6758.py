...
class ConceptGearSetCompoundDynamicAnalysis(_6787.GearSetCompoundDynamicAnalysis):
    """ConceptGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6625.ConceptGearSetDynamicAnalysis]":
    ...
    def concept_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6756.ConceptGearCompoundDynamicAnalysis]":
    ...
    def concept_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6757.ConceptGearMeshCompoundDynamicAnalysis]":
