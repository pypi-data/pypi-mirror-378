...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility import _1795
...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    @exception_bridge
    def excel_file_details(self: "Self") -> "_6860.ExcelFileDetails":
    ...
    @property
    @exception_bridge
    def masta_file_details(self: "Self") -> "_6863.MASTAFileDetails":
    ...
    @property
    @exception_bridge
    def working_folder(self: "Self") -> "_1795.SelectableFolder":
    ...
    def excel_sheet_design_state_selection(
        self: "Self",
    ) -> "List[_6862.ExcelSheetDesignStateSelector]":
