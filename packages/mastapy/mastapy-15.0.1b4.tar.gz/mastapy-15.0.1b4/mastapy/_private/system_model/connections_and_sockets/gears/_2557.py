...
class ZerolBevelGearMesh(_2529.BevelGearMesh):
    """ZerolBevelGearMesh
    ...
    @property
    @exception_bridge
    def bevel_gear_mesh_design(self: "Self") -> "_1057.ZerolBevelGearMeshDesign":
    ...
    @property
    @exception_bridge
    def zerol_bevel_gear_mesh_design(self: "Self") -> "_1057.ZerolBevelGearMeshDesign":
        """mastapy.gears.gear_designs.zerol_bevel.ZerolBevelGearMeshDesign
