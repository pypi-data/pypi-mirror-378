...
class FaceGearMesh(_2539.GearMesh):
    """FaceGearMesh
    ...
    @property
    @exception_bridge
    def active_gear_mesh_design(self: "Self") -> "_1095.FaceGearMeshDesign":
    ...
    @property
    @exception_bridge
    def face_gear_mesh_design(self: "Self") -> "_1095.FaceGearMeshDesign":
        """mastapy.gears.gear_designs.face.FaceGearMeshDesign
