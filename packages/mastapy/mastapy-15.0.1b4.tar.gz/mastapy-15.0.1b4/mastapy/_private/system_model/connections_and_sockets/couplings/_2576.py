...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2417, _2419
...
class SpringDamperConnection(_2572.CouplingConnection):
    """SpringDamperConnection
    ...
    @property
    @exception_bridge
    def damping_option(self: "Self") -> "_2417.ComponentDampingOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2417", "ComponentDampingOption"
        )(value)

    @damping_option.setter
    @exception_bridge
    @enforce_parameter_types
    def damping_option(self: "Self", value: "_2417.ComponentDampingOption") -> None:
