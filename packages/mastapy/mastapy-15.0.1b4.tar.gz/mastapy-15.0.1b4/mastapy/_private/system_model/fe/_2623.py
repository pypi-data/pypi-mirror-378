...
class IndependentMASTACreatedCondensationNode(
    ...
    @property
    @exception_bridge
    def rigid_coupling_type(self: "Self") -> "_289.RigidCouplingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.dev_tools_analyses._289",
            "RigidCouplingType",
        )(value)
    ...
    def rigid_coupling_type(self: "Self", value: "_289.RigidCouplingType") -> None:
    ...
    @property
    @exception_bridge
    def fe_substructure_node(self: "Self") -> "_2612.FESubstructureNode":
