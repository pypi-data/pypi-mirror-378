...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2623, _2626
...
class _Cast_IndependentMASTACreatedConstrainedNodes:
    ...
    def independent_masta_created_condensation_node(
        self: "CastSelf",
    ) -> "_2623.IndependentMASTACreatedCondensationNode":
        from mastapy._private.system_model.fe import _2623

        return self.__parent__._cast(_2623.IndependentMASTACreatedCondensationNode)

    @property
    def independent_masta_created_rigidly_connected_node_group(
        self: "CastSelf",
    ) -> "_2626.IndependentMASTACreatedRigidlyConnectedNodeGroup":
