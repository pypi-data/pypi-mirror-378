...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.drawing import _2470, _2472, _2486
...
class _Cast_AbstractSystemDeflectionViewable:
    ...
    def advanced_system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2470.AdvancedSystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2470

        return self.__parent__._cast(_2470.AdvancedSystemDeflectionViewable)

    @property
    def system_deflection_viewable(
        self: "CastSelf",
    ) -> "_2486.SystemDeflectionViewable":
        from mastapy._private.system_model.drawing import _2486

        return self.__parent__._cast(_2486.SystemDeflectionViewable)
...
class AbstractSystemDeflectionViewable(_2479.PartAnalysisCaseWithContourViewable):
    """AbstractSystemDeflectionViewable
