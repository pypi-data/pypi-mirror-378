...
from mastapy._private.system_model.drawing.options import _2488
...
class HarmonicAnalysisViewable(_2474.DynamicAnalysisViewable):
    """HarmonicAnalysisViewable
    ...
    @enforce_parameter_types
    def excitation(
        self: "Self", value: "_5974.AbstractPeriodicExcitationDetail"
    ) -> None:
    ...
    @enforce_parameter_types
    def harmonic_analysis_with_varying_stiffness_step(
        self: "Self", value: "_6068.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase"
    ) -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def order(self: "Self", value: "_1718.RoundedOrder") -> None:
        generic_type = (
    ...
    @exception_bridge
    @enforce_parameter_types
    def sound_response_type(self: "Self", value: "_4902.DynamicsResponseType") -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def uncoupled_mesh(self: "Self", value: "_3005.GearMeshSystemDeflection") -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def view_type(self: "Self", value: "_2488.ExcitationAnalysisViewOption") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
