...
class _Cast_CriticalSpeedAnalysisViewable:
    ...
    @property
    def rotor_dynamics_viewable(self: "CastSelf") -> "_2481.RotorDynamicsViewable":
        return self.__parent__._cast(_2481.RotorDynamicsViewable)
...
class CriticalSpeedAnalysisViewable(_2481.RotorDynamicsViewable):
    """CriticalSpeedAnalysisViewable
