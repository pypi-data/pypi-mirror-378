...
from mastapy._private.nodal_analysis.geometry_modeller_link import _235
...
if TYPE_CHECKING:
    ...
    from mastapy._private.geometry.two_d import _401
    from mastapy._private.math_utility import _1677, _1696
    ...
    from mastapy._private.utility.operation_modes import _1990
...
class MASTAGUI(_0.APIBase):
    ...
    @property
    @exception_bridge
    def active_design(self: "Self") -> "_2416.Design":
    ...
    @exception_bridge
    @enforce_parameter_types
    def active_design(self: "Self", value: "_2416.Design") -> None:
    ...
    @enforce_parameter_types
    def gear_tip_radius_clash_test_request(
        self: "Self", value: "_231.GearTipRadiusClashTest"
    ) -> None:
        pythonnet_property_set(
    ...
    @property
    @exception_bridge
    def open_designs(self: "Self") -> "List[_2416.Design]":
    ...
    @property
    @exception_bridge
    def operation_mode(self: "Self") -> "_1990.OperationMode":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.operation_modes._1990", "OperationMode"
        )(value)

    @operation_mode.setter
    @exception_bridge
    @enforce_parameter_types
    def operation_mode(self: "Self", value: "_1990.OperationMode") -> None:
    ...
    @property
    @exception_bridge
    def selected_design_entity(self: "Self") -> "_2419.DesignEntity":
    ...
    @exception_bridge
    @enforce_parameter_types
    def selected_design_entity(self: "Self", value: "_2419.DesignEntity") -> None:
    ...
    def add_electric_machine_from_cad_face_group(
        self: "Self",
        cad_face_group: "_401.CADFaceGroup",
        geometry_modeller_design_information: "_234.GeometryModellerDesignInformation",
        dimensions: "Dict[str, _235.GeometryModellerDimension]",
    ) -> None:
        """Method does not return.
    ...
    def add_fe_substructure_from_data(
        self: "Self",
        vertices_and_facets: "_1696.FacetedBody",
        geometry_modeller_design_information: "_234.GeometryModellerDesignInformation",
        dimensions: "Dict[str, _235.GeometryModellerDimension]",
    ...
    def add_line_from_geometry_modeller(
        self: "Self", circles_on_axis: "_1677.CirclesOnAxis"
    ) -> None:
        """Method does not return.
    ...
    @exception_bridge
    def are_new_input_available(self: "Self") -> "_242.MeshRequest":
    ...
    def circle_pairs_from_geometry_modeller(
        self: "Self",
        preselection_circles: "_1677.CirclesOnAxis",
        selected_circles: "List[_1677.CirclesOnAxis]",
    ) -> None:
        """Method does not return.
    ...
    def create_geometry_modeller_dimension(
        self: "Self",
    ) -> "_235.GeometryModellerDimension":
    ...
    @exception_bridge
    def create_mesh_request_result(self: "Self") -> "_243.MeshRequestResult":
    ...
    @exception_bridge
    def create_new_cad_face_group(self: "Self") -> "_401.CADFaceGroup":
    ...
    @exception_bridge
    def create_new_circles_on_axis(self: "Self") -> "_1677.CirclesOnAxis":
    ...
    @exception_bridge
    def create_new_faceted_body(self: "Self") -> "_1696.FacetedBody":
    ...
    @exception_bridge
    @enforce_parameter_types
    def open_design_in_new_tab(self: "Self", design: "_2416.Design") -> None:
        """Method does not return.
    ...
    def set_gear_tip_diameter_clash_test_result(
        self: "Self", result: "_231.GearTipRadiusClashTest"
    ) -> None:
        """Method does not return.
    ...
    def set_mesh_request_result(
        self: "Self", mesh_request_result: "_243.MeshRequestResult"
    ) -> None:
        """Method does not return.
