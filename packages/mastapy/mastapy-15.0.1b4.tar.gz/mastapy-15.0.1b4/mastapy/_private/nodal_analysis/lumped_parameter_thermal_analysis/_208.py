...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.lumped_parameter_thermal_analysis import _209
...
class InterfaceGap(_0.APIBase):
    ...
    def specification_method(
        self: "Self",
    ) -> "_209.InterfaceGapResistanceSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.lumped_parameter_thermal_analysis._209",
    ...
    @enforce_parameter_types
    def specification_method(
        self: "Self", value: "_209.InterfaceGapResistanceSpecificationMethod"
    ) -> None:
