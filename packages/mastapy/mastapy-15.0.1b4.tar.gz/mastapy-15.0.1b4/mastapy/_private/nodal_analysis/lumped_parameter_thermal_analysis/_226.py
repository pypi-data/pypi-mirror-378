...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.lumped_parameter_thermal_analysis import _210
...
class UserDefinedNodeInformation(_0.APIBase):
    ...
    def nodes_to_connect_to(
        self: "Self",
    ) -> "List[_210.NodeConnectedToUserDefinedNode]":
    ...
    def set_nodes_to_connect_to(
        self: "Self", nodes: "List[_210.NodeConnectedToUserDefinedNode]"
    ) -> None:
        """Method does not return.
