...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.elmer import _253, _254
...
class _Cast_ElmerResults:
    ...
    def elmer_results_from_electromagnetic_analysis(
        self: "CastSelf",
    ) -> "_253.ElmerResultsFromElectromagneticAnalysis":
        from mastapy._private.nodal_analysis.elmer import _253

        return self.__parent__._cast(_253.ElmerResultsFromElectromagneticAnalysis)

    @property
    def elmer_results_from_mechanical_analysis(
        self: "CastSelf",
    ) -> "_254.ElmerResultsFromMechanicalAnalysis":
        from mastapy._private.nodal_analysis.elmer import _254

        return self.__parent__._cast(_254.ElmerResultsFromMechanicalAnalysis)
