...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1509, _1521
    from mastapy._private.nodal_analysis.elmer import _251, _259
...
class _Cast_ElmerResultsViewable:
    ...
    def electric_machine_mechanical_results_viewable(
        self: "CastSelf",
    ) -> "_1509.ElectricMachineMechanicalResultsViewable":
        from mastapy._private.electric_machines.results import _1509

        return self.__parent__._cast(_1509.ElectricMachineMechanicalResultsViewable)

    @property
    def electric_machine_results_viewable(
        self: "CastSelf",
    ) -> "_1521.ElectricMachineResultsViewable":
        from mastapy._private.electric_machines.results import _1521

        return self.__parent__._cast(_1521.ElectricMachineResultsViewable)
...
class ElmerResultsViewable(_0.APIBase):
    ...
    @enforce_parameter_types
    def degree_of_freedom(
        self: "Self", value: "_1716.ResultOptionsFor3DVector"
    ) -> None:
    ...
    @property
    @exception_bridge
    def elemental_or_nodal_data(self: "Self") -> "_251.ElmerResultEntityType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.elmer._251", "ElmerResultEntityType"
        )(value)
    ...
    def elemental_or_nodal_data(
        self: "Self", value: "_251.ElmerResultEntityType"
    ) -> None:
    ...
    @property
    @exception_bridge
    def nodal_average_type(self: "Self") -> "_259.NodalAverageType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.elmer._259", "NodalAverageType"
        )(value)

    @nodal_average_type.setter
    @exception_bridge
    @enforce_parameter_types
    def nodal_average_type(self: "Self", value: "_259.NodalAverageType") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @exception_bridge
    @enforce_parameter_types
    def result_type(self: "Self", value: "_256.ElmerResultType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    @exception_bridge
    def scaling_draw_style(self: "Self") -> "_2059.ScalingDrawStyle":
