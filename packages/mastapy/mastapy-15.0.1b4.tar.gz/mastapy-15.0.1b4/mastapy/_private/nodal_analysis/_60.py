...
class DiagonalNonLinearStiffness(_0.APIBase):
    ...
    @property
    @exception_bridge
    def theta_x_stiffness(self: "Self") -> "_1723.Vector2DListAccessor":
    ...
    def theta_x_stiffness(self: "Self", value: "_1723.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "ThetaXStiffness", value.wrapped)

    @property
    @exception_bridge
    def theta_y_stiffness(self: "Self") -> "_1723.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @exception_bridge
    @enforce_parameter_types
    def theta_y_stiffness(self: "Self", value: "_1723.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "ThetaYStiffness", value.wrapped)

    @property
    @exception_bridge
    def theta_z_stiffness(self: "Self") -> "_1723.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @exception_bridge
    @enforce_parameter_types
    def theta_z_stiffness(self: "Self", value: "_1723.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "ThetaZStiffness", value.wrapped)

    @property
    @exception_bridge
    def x_stiffness(self: "Self") -> "_1723.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @exception_bridge
    @enforce_parameter_types
    def x_stiffness(self: "Self", value: "_1723.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "XStiffness", value.wrapped)

    @property
    @exception_bridge
    def y_stiffness(self: "Self") -> "_1723.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @exception_bridge
    @enforce_parameter_types
    def y_stiffness(self: "Self", value: "_1723.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "YStiffness", value.wrapped)

    @property
    @exception_bridge
    def z_stiffness(self: "Self") -> "_1723.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @exception_bridge
    @enforce_parameter_types
    def z_stiffness(self: "Self", value: "_1723.Vector2DListAccessor") -> None:
