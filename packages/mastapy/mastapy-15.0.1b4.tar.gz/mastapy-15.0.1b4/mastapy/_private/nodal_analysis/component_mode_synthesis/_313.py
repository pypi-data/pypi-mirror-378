...
class CMSModel(_0.APIBase):
    ...
    def software_used_for_reduction(
        self: "Self",
    ) -> "_322.SoftwareUsedForReductionType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.component_mode_synthesis._322",
    ...
    @property
    @exception_bridge
    def reduction_information(self: "Self") -> "_1776.AnalysisRunInformation":
    ...
    @property
    @exception_bridge
    def reduction_options(self: "Self") -> "_315.CMSOptions":
    ...
    @property
    @exception_bridge
    def element_face_groups(self: "Self") -> "List[_311.CMSElementFaceGroup]":
