...
class MeshRequestResult(_0.APIBase):
    ...
    @property
    @exception_bridge
    def cad_face_group(self: "Self") -> "_401.CADFaceGroup":
    ...
    @exception_bridge
    @enforce_parameter_types
    def cad_face_group(self: "Self", value: "_401.CADFaceGroup") -> None:
    ...
    @property
    @exception_bridge
    def faceted_body(self: "Self") -> "_1696.FacetedBody":
    ...
    @exception_bridge
    @enforce_parameter_types
    def faceted_body(self: "Self", value: "_1696.FacetedBody") -> None:
    ...
    @enforce_parameter_types
    def geometry_modeller_design_information(
        self: "Self", value: "_234.GeometryModellerDesignInformation"
    ) -> None:
        pythonnet_property_set(
    ...
    def set_geometry_modeller_dimensions(
        self: "Self", dimensions: "Dict[str, _235.GeometryModellerDimension]"
    ) -> None:
    ...
    def set_named_selections(
        ...
        edge_named_selections: "Dict[str, _1691.EdgeNamedSelectionDetails]",
    ) -> None:
        """Method does not return.
