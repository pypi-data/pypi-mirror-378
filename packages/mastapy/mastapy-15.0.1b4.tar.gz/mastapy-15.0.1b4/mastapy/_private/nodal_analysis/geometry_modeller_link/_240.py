...
from mastapy._private.nodal_analysis.geometry_modeller_link import _230
...
class _Cast_GeometryModellerUnitlessDimension:
    ...
    def base_geometry_modeller_dimension(
        self: "CastSelf",
    ) -> "_230.BaseGeometryModellerDimension":
        return self.__parent__._cast(_230.BaseGeometryModellerDimension)
...
class GeometryModellerUnitlessDimension(_230.BaseGeometryModellerDimension):
    """GeometryModellerUnitlessDimension
