...
from mastapy._private.nodal_analysis.dev_tools_analyses.full_fe_reporting import _295
...
class ElementPropertiesRigid(_295.ElementPropertiesBase):
    """ElementPropertiesRigid
    ...
    def degrees_of_freedom_list(
        self: "Self",
    ) -> "List[_307.RigidElementNodeDegreesOfFreedom]":
