...
class _Cast_FEModelTabDrawStyle:
    ...
    def fe_model_harmonic_analysis_draw_style(
        self: "CastSelf",
    ) -> "_272.FEModelHarmonicAnalysisDrawStyle":
        from mastapy._private.nodal_analysis.dev_tools_analyses import _272

        return self.__parent__._cast(_272.FEModelHarmonicAnalysisDrawStyle)

    @property
    def fe_model_modal_analysis_draw_style(
        self: "CastSelf",
    ) -> "_274.FEModelModalAnalysisDrawStyle":
        from mastapy._private.nodal_analysis.dev_tools_analyses import _274

        return self.__parent__._cast(_274.FEModelModalAnalysisDrawStyle)

    @property
    def fe_model_static_analysis_draw_style(
        self: "CastSelf",
    ) -> "_277.FEModelStaticAnalysisDrawStyle":
        from mastapy._private.nodal_analysis.dev_tools_analyses import _277

        return self.__parent__._cast(_277.FEModelStaticAnalysisDrawStyle)
