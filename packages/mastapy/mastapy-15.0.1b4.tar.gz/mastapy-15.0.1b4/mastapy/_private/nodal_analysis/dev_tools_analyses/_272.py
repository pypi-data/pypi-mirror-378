...
class _Cast_FEModelHarmonicAnalysisDrawStyle:
    ...
    @property
    def fe_model_tab_draw_style(self: "CastSelf") -> "_278.FEModelTabDrawStyle":
        return self.__parent__._cast(_278.FEModelTabDrawStyle)
...
class FEModelHarmonicAnalysisDrawStyle(_278.FEModelTabDrawStyle):
    """FEModelHarmonicAnalysisDrawStyle
