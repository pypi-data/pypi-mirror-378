...
class BHCurveSpecification(_0.APIBase):
    ...
    @property
    @exception_bridge
    def bh_curve(self: "Self") -> "_1723.Vector2DListAccessor":
    ...
    def bh_curve(self: "Self", value: "_1723.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "BHCurve", value.wrapped)

    @property
    @exception_bridge
    def bh_curve_plot(self: "Self") -> "_2075.TwoDChartDefinition":
    ...
    def bh_curve_extrapolation_method(
        self: "Self",
    ) -> "_335.BHCurveExtrapolationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._335", "BHCurveExtrapolationMethod"
        )(value)
    ...
    @enforce_parameter_types
    def bh_curve_extrapolation_method(
        self: "Self", value: "_335.BHCurveExtrapolationMethod"
    ) -> None:
