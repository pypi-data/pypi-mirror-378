...
class GeneralTransmissionProperties(_0.APIBase):
    ...
    def bearing_iso762006_static_safety_factor_limit(
        self: "Self",
    ) -> "_349.ISO76StaticSafetyFactorLimits":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._349", "ISO76StaticSafetyFactorLimits"
        )(value)
    ...
    @enforce_parameter_types
    def bearing_iso762006_static_safety_factor_limit(
        self: "Self", value: "_349.ISO76StaticSafetyFactorLimits"
    ) -> None:
    ...
    @property
    @exception_bridge
    def driven_machine_characteristics(self: "Self") -> "_382.WorkingCharacteristics":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._382", "WorkingCharacteristics"
        )(value)
    ...
    def driven_machine_characteristics(
        self: "Self", value: "_382.WorkingCharacteristics"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def driving_machine_characteristics(self: "Self") -> "_382.WorkingCharacteristics":
        """mastapy.materials.WorkingCharacteristics"""
    ...
    @property
    @exception_bridge
    def gearing_type(self: "Self") -> "_345.GearingTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._345", "GearingTypes"
        )(value)

    @gearing_type.setter
    @exception_bridge
    @enforce_parameter_types
    def gearing_type(self: "Self", value: "_345.GearingTypes") -> None:
    ...
    @property
    @exception_bridge
    def transmission_application(self: "Self") -> "_378.TransmissionApplications":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._378", "TransmissionApplications"
        )(value)
    ...
    def transmission_application(
        self: "Self", value: "_378.TransmissionApplications"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def wind_turbine_standard(self: "Self") -> "_381.WindTurbineStandards":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._381", "WindTurbineStandards"
        )(value)

    @wind_turbine_standard.setter
    @exception_bridge
    @enforce_parameter_types
    def wind_turbine_standard(self: "Self", value: "_381.WindTurbineStandards") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def air_properties(self: "Self") -> "_331.AirProperties":
    ...
    @property
    @exception_bridge
    def vehicle_dynamics(self: "Self") -> "_380.VehicleDynamicsProperties":
