...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials.efficiency import _385, _387
...
class _Cast_PowerLoss:
    ...
    @property
    def independent_power_loss(self: "CastSelf") -> "_385.IndependentPowerLoss":
        from mastapy._private.materials.efficiency import _385

        return self.__parent__._cast(_385.IndependentPowerLoss)

    @property
    def load_and_speed_combined_power_loss(
        self: "CastSelf",
    ) -> "_387.LoadAndSpeedCombinedPowerLoss":
        from mastapy._private.materials.efficiency import _387

        return self.__parent__._cast(_387.LoadAndSpeedCombinedPowerLoss)
