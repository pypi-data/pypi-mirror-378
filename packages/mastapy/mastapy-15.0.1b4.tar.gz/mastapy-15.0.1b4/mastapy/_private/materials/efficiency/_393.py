...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials.efficiency import _384, _386
...
class _Cast_ResistiveTorque:
    ...
    @property
    def combined_resistive_torque(self: "CastSelf") -> "_384.CombinedResistiveTorque":
        from mastapy._private.materials.efficiency import _384

        return self.__parent__._cast(_384.CombinedResistiveTorque)

    @property
    def independent_resistive_torque(
        self: "CastSelf",
    ) -> "_386.IndependentResistiveTorque":
        from mastapy._private.materials.efficiency import _386

        return self.__parent__._cast(_386.IndependentResistiveTorque)
