...
class ListWithSelectedItem_GearSetDesign(
    _1054.GearSetDesign, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_GearSetDesign]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1054.GearSetDesign.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1054.GearSetDesign":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1054.GearSetDesign]":
