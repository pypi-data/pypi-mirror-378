...
class ListWithSelectedItem_GuideDxfModel(
    _2687.GuideDxfModel, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_GuideDxfModel]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2687.GuideDxfModel.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2687.GuideDxfModel":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2687.GuideDxfModel]":
