...
class ListWithSelectedItem_Unit(_1807.Unit, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_Unit]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1807.Unit.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1807.Unit":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1807.Unit]":
