...
class ListWithSelectedItem_PowerLoad(_2708.PowerLoad, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_PowerLoad]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2708.PowerLoad.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2708.PowerLoad":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2708.PowerLoad]":
