...
class ListWithSelectedItem_Component(_2675.Component, mixins.ListWithSelectedItemMixin):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_Component]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2675.Component.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2675.Component":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2675.Component]":
