...
class ListWithSelectedItem_ColumnTitle(
    _2019.ColumnTitle, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_ColumnTitle]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2019.ColumnTitle.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2019.ColumnTitle":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2019.ColumnTitle]":
