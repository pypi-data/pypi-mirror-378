...
from mastapy._private.electric_machines.harmonic_load_data import _1567
...
class ListWithSelectedItem_SimpleElectricMachineTooth(
    _1567.SimpleElectricMachineTooth, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1567.SimpleElectricMachineTooth.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1567.SimpleElectricMachineTooth":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1567.SimpleElectricMachineTooth]":
