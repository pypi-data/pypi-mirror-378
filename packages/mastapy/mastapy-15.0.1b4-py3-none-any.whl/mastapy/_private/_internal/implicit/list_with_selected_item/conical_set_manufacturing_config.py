...
class ListWithSelectedItem_ConicalSetManufacturingConfig(
    _895.ConicalSetManufacturingConfig, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _895.ConicalSetManufacturingConfig.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_895.ConicalSetManufacturingConfig":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_895.ConicalSetManufacturingConfig]":
