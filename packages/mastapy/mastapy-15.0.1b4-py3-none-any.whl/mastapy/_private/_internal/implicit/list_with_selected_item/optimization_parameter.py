...
from mastapy._private.system_model.optimization import _2449
...
class ListWithSelectedItem_OptimizationParameter(
    _2449.OptimizationParameter, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_OptimizationParameter]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2449.OptimizationParameter.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2449.OptimizationParameter":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2449.OptimizationParameter]":
