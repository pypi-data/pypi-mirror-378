...
class ListWithSelectedItem_MeasurementBase(
    _1802.MeasurementBase, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_MeasurementBase]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1802.MeasurementBase.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1802.MeasurementBase":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1802.MeasurementBase]":
