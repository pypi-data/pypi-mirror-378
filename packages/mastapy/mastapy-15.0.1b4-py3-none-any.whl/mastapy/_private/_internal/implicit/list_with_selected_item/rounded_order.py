...
class ListWithSelectedItem_RoundedOrder(
    _1718.RoundedOrder, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_RoundedOrder]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1718.RoundedOrder.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1718.RoundedOrder":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1718.RoundedOrder]":
