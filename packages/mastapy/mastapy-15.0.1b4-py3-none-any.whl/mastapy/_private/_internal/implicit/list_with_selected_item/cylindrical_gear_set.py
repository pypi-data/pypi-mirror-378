...
class ListWithSelectedItem_CylindricalGearSet(
    _2768.CylindricalGearSet, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_CylindricalGearSet]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2768.CylindricalGearSet.TYPE

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2768.CylindricalGearSet":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2768.CylindricalGearSet]":
