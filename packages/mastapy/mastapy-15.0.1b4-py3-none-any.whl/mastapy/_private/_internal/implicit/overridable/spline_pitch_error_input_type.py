...
class Overridable_SplinePitchErrorInputType(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
    ...
    ) -> "_2849.SplinePitchErrorInputType":
        ...
        Returns:
            _2849.SplinePitchErrorInputType
        """
        return _2849.SplinePitchErrorInputType
    ...
    def implicit_type(cls: "Type[Overridable_SplinePitchErrorInputType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2849.SplinePitchErrorInputType.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_2849.SplinePitchErrorInputType":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_2849.SplinePitchErrorInputType":
        """mastapy.system_model.part_model.couplings.SplinePitchErrorInputType
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_2849.SplinePitchErrorInputType":
        """mastapy.system_model.part_model.couplings.SplinePitchErrorInputType
