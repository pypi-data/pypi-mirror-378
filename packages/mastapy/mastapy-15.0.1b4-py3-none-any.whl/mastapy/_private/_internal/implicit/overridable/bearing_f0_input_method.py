...
class Overridable_BearingF0InputMethod(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _2670.BearingF0InputMethod
        """
        return _2670.BearingF0InputMethod
    ...
    def implicit_type(cls: "Type[Overridable_BearingF0InputMethod]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2670.BearingF0InputMethod.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_2670.BearingF0InputMethod":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_2670.BearingF0InputMethod":
        """mastapy.system_model.part_model.BearingF0InputMethod
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_2670.BearingF0InputMethod":
        """mastapy.system_model.part_model.BearingF0InputMethod
