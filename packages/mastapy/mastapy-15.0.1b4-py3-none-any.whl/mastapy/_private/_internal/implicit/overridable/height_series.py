...
class Overridable_HeightSeries(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls: "Type[Overridable_HeightSeries]") -> "_2373.HeightSeries":
    ...
    def implicit_type(cls: "Type[Overridable_HeightSeries]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2373.HeightSeries.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_2373.HeightSeries":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_2373.HeightSeries":
        """mastapy.bearings.bearing_designs.rolling.HeightSeries
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_2373.HeightSeries":
        """mastapy.bearings.bearing_designs.rolling.HeightSeries
