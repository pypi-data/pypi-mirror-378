...
class Overridable_ISOToleranceStandard(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _425.ISOToleranceStandard
        """
        return _425.ISOToleranceStandard
    ...
    def implicit_type(cls: "Type[Overridable_ISOToleranceStandard]") -> "Any":
        ...
        Returns:
            Any
        """
        return _425.ISOToleranceStandard.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_425.ISOToleranceStandard":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_425.ISOToleranceStandard":
        """mastapy.gears.ISOToleranceStandard
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_425.ISOToleranceStandard":
        """mastapy.gears.ISOToleranceStandard
