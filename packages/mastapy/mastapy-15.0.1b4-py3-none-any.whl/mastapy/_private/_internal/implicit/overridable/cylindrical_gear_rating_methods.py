...
class Overridable_CylindricalGearRatingMethods(mixins.OverridableMixin, Enum):
    ...
    @property
    @exception_bridge
    def value(self: "Self") -> "_339.CylindricalGearRatingMethods":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_339.CylindricalGearRatingMethods":
        """mastapy.materials.CylindricalGearRatingMethods
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_339.CylindricalGearRatingMethods":
        """mastapy.materials.CylindricalGearRatingMethods
