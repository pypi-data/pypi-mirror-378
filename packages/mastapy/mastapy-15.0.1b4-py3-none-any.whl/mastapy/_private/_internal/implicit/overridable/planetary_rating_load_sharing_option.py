...
class Overridable_PlanetaryRatingLoadSharingOption(mixins.OverridableMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _432.PlanetaryRatingLoadSharingOption
        """
        return _432.PlanetaryRatingLoadSharingOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _432.PlanetaryRatingLoadSharingOption.type_()

    @property
    @exception_bridge
    def value(self: "Self") -> "_432.PlanetaryRatingLoadSharingOption":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_432.PlanetaryRatingLoadSharingOption":
        """mastapy.gears.PlanetaryRatingLoadSharingOption
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_432.PlanetaryRatingLoadSharingOption":
        """mastapy.gears.PlanetaryRatingLoadSharingOption
