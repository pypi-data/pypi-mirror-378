...
class Overridable_GearMeshEfficiencyRatingMethod(mixins.OverridableMixin, Enum):
    ...
    @property
    @exception_bridge
    def value(self: "Self") -> "_451.GearMeshEfficiencyRatingMethod":
    ...
    @property
    @exception_bridge
    def override_value(self: "Self") -> "_451.GearMeshEfficiencyRatingMethod":
        """mastapy.gears.rating.GearMeshEfficiencyRatingMethod
    ...
    @property
    @exception_bridge
    def calculated_value(self: "Self") -> "_451.GearMeshEfficiencyRatingMethod":
        """mastapy.gears.rating.GearMeshEfficiencyRatingMethod
