...
class EnumWithSelectedValue_FEExportFormat(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_FEExportFormat]") -> "Any":
        ...
        Returns:
            Any
        """
        return _247.FEExportFormat.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_247.FEExportFormat":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_247.FEExportFormat]":
