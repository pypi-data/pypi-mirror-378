...
from mastapy._private.utility.enums import _2022
...
class EnumWithSelectedValue_PropertySpecificationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_PropertySpecificationMethod]",
    ) -> "_2022.PropertySpecificationMethod":
        ...
        Returns:
            _2022.PropertySpecificationMethod
        """
        return _2022.PropertySpecificationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2022.PropertySpecificationMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2022.PropertySpecificationMethod":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2022.PropertySpecificationMethod]":
