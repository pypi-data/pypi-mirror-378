...
class EnumWithSelectedValue_RaceRadialMountingType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2175.RaceRadialMountingType
        """
        return _2175.RaceRadialMountingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2175.RaceRadialMountingType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2175.RaceRadialMountingType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2175.RaceRadialMountingType]":
