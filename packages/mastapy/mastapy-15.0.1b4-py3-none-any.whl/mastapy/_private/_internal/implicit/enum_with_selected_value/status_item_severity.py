...
from mastapy._private.utility.model_validation import _1995
...
class EnumWithSelectedValue_StatusItemSeverity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1995.StatusItemSeverity
        """
        return _1995.StatusItemSeverity
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_StatusItemSeverity]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1995.StatusItemSeverity.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1995.StatusItemSeverity":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1995.StatusItemSeverity]":
