...
class EnumWithSelectedValue_ExcitationAnalysisViewOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ExcitationAnalysisViewOption]",
    ) -> "_2488.ExcitationAnalysisViewOption":
        ...
        Returns:
            _2488.ExcitationAnalysisViewOption
        """
        return _2488.ExcitationAnalysisViewOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2488.ExcitationAnalysisViewOption.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2488.ExcitationAnalysisViewOption":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2488.ExcitationAnalysisViewOption]":
