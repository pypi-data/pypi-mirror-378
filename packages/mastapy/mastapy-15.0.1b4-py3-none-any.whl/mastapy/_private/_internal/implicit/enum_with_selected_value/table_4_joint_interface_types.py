...
from mastapy._private.detailed_rigid_connectors.interference_fits import _1633
...
class EnumWithSelectedValue_Table4JointInterfaceTypes(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_Table4JointInterfaceTypes]",
    ) -> "_1633.Table4JointInterfaceTypes":
        ...
        Returns:
            _1633.Table4JointInterfaceTypes
        """
        return _1633.Table4JointInterfaceTypes
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1633.Table4JointInterfaceTypes.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1633.Table4JointInterfaceTypes":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1633.Table4JointInterfaceTypes]":
