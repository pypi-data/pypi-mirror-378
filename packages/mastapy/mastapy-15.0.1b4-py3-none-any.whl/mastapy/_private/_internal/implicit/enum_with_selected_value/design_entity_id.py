...
class EnumWithSelectedValue_DesignEntityId(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DesignEntityId]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2420.DesignEntityId.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2420.DesignEntityId":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2420.DesignEntityId]":
