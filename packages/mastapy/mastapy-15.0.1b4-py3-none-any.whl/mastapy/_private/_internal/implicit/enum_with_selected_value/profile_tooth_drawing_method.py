...
class EnumWithSelectedValue_ProfileToothDrawingMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ProfileToothDrawingMethod]",
    ) -> "_2785.ProfileToothDrawingMethod":
        ...
        Returns:
            _2785.ProfileToothDrawingMethod
        """
        return _2785.ProfileToothDrawingMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2785.ProfileToothDrawingMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2785.ProfileToothDrawingMethod":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2785.ProfileToothDrawingMethod]":
