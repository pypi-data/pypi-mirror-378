...
from mastapy._private.system_model.fe import _2628
...
class EnumWithSelectedValue_LinkNodeSource(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_LinkNodeSource]") -> "Any":
        ...
        Returns:
            Any
        """
        return _2628.LinkNodeSource.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2628.LinkNodeSource":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2628.LinkNodeSource]":
