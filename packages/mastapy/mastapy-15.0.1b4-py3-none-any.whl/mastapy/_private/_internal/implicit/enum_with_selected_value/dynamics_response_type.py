...
class EnumWithSelectedValue_DynamicsResponseType(
    ...
    def wrapped_type(
        ...
        Returns:
            _4902.DynamicsResponseType
        """
        return _4902.DynamicsResponseType
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_DynamicsResponseType]") -> "Any":
        ...
        Returns:
            Any
        """
        return _4902.DynamicsResponseType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_4902.DynamicsResponseType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_4902.DynamicsResponseType]":
