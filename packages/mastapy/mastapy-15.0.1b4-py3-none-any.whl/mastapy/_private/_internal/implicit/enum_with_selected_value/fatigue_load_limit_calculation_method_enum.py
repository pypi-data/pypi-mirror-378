...
from mastapy._private.bearings.bearing_designs.rolling import _2367
...
class EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum]",
    ) -> "_2367.FatigueLoadLimitCalculationMethodEnum":
        ...
        Returns:
            _2367.FatigueLoadLimitCalculationMethodEnum
        """
        return _2367.FatigueLoadLimitCalculationMethodEnum
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2367.FatigueLoadLimitCalculationMethodEnum.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2367.FatigueLoadLimitCalculationMethodEnum":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2367.FatigueLoadLimitCalculationMethodEnum]":
