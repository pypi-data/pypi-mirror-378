...
class EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod]",
    ) -> "_2433.PowerLoadInputTorqueSpecificationMethod":
        ...
        Returns:
            _2433.PowerLoadInputTorqueSpecificationMethod
        """
        return _2433.PowerLoadInputTorqueSpecificationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2433.PowerLoadInputTorqueSpecificationMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2433.PowerLoadInputTorqueSpecificationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2433.PowerLoadInputTorqueSpecificationMethod]":
