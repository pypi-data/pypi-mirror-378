...
from mastapy._private.gears.micro_geometry import _668
...
class EnumWithSelectedValue_LocationOfTipReliefEvaluation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfTipReliefEvaluation]",
    ) -> "_668.LocationOfTipReliefEvaluation":
        ...
        Returns:
            _668.LocationOfTipReliefEvaluation
        """
        return _668.LocationOfTipReliefEvaluation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _668.LocationOfTipReliefEvaluation.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_668.LocationOfTipReliefEvaluation":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_668.LocationOfTipReliefEvaluation]":
