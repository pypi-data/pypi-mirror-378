...
from mastapy._private.bearings.bearing_results import _2174
...
class EnumWithSelectedValue_RaceAxialMountingType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2174.RaceAxialMountingType
        """
        return _2174.RaceAxialMountingType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2174.RaceAxialMountingType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2174.RaceAxialMountingType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2174.RaceAxialMountingType]":
