...
class EnumWithSelectedValue_ScuffingFlashTemperatureRatingMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _573.ScuffingFlashTemperatureRatingMethod
        """
        return _573.ScuffingFlashTemperatureRatingMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _573.ScuffingFlashTemperatureRatingMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_573.ScuffingFlashTemperatureRatingMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_573.ScuffingFlashTemperatureRatingMethod]":
