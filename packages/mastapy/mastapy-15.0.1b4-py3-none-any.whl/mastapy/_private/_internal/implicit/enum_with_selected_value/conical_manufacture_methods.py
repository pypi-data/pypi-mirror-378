...
class EnumWithSelectedValue_ConicalManufactureMethods(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ConicalManufactureMethods]",
    ) -> "_1278.ConicalManufactureMethods":
        ...
        Returns:
            _1278.ConicalManufactureMethods
        """
        return _1278.ConicalManufactureMethods
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1278.ConicalManufactureMethods.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1278.ConicalManufactureMethods":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1278.ConicalManufactureMethods]":
