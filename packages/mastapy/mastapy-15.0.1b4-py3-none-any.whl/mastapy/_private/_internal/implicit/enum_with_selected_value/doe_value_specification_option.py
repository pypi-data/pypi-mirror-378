...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DoeValueSpecificationOption]",
    ) -> "_4619.DoeValueSpecificationOption":
        ...
        Returns:
            _4619.DoeValueSpecificationOption
        """
        return _4619.DoeValueSpecificationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _4619.DoeValueSpecificationOption.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_4619.DoeValueSpecificationOption":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_4619.DoeValueSpecificationOption]":
