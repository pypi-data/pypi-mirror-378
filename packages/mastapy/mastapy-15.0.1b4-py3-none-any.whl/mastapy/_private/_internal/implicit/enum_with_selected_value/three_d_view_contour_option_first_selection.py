...
from mastapy._private.utility.enums import _2025
...
class EnumWithSelectedValue_ThreeDViewContourOptionFirstSelection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ThreeDViewContourOptionFirstSelection]",
    ) -> "_2025.ThreeDViewContourOptionFirstSelection":
        ...
        Returns:
            _2025.ThreeDViewContourOptionFirstSelection
        """
        return _2025.ThreeDViewContourOptionFirstSelection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2025.ThreeDViewContourOptionFirstSelection.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2025.ThreeDViewContourOptionFirstSelection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2025.ThreeDViewContourOptionFirstSelection]":
