...
class EnumWithSelectedValue_LubricantViscosityClassISO(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LubricantViscosityClassISO]",
    ) -> "_355.LubricantViscosityClassISO":
        ...
        Returns:
            _355.LubricantViscosityClassISO
        """
        return _355.LubricantViscosityClassISO
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _355.LubricantViscosityClassISO.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_355.LubricantViscosityClassISO":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_355.LubricantViscosityClassISO]":
