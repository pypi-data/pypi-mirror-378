...
class EnumWithSelectedValue_ResultOptionsFor3DVector(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_ResultOptionsFor3DVector]",
    ) -> "_1716.ResultOptionsFor3DVector":
        ...
        Returns:
            _1716.ResultOptionsFor3DVector
        """
        return _1716.ResultOptionsFor3DVector
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1716.ResultOptionsFor3DVector.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1716.ResultOptionsFor3DVector":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1716.ResultOptionsFor3DVector]":
