...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _6086
...
class EnumWithSelectedValue_ModalCorrectionMethod(
    ...
    def wrapped_type(
        ...
        Returns:
            _6086.ModalCorrectionMethod
        """
        return _6086.ModalCorrectionMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _6086.ModalCorrectionMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_6086.ModalCorrectionMethod":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_6086.ModalCorrectionMethod]":
