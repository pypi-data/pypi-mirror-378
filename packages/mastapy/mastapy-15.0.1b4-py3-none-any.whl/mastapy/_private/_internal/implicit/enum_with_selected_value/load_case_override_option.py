...
class EnumWithSelectedValue_LoadCaseOverrideOption(
    ...
    def wrapped_type(
        ...
        Returns:
            _1786.LoadCaseOverrideOption
        """
        return _1786.LoadCaseOverrideOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1786.LoadCaseOverrideOption.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1786.LoadCaseOverrideOption":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1786.LoadCaseOverrideOption]":
