...
class EnumWithSelectedValue_TorqueSpecificationForSystemDeflection(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueSpecificationForSystemDeflection]",
    ) -> "_7854.TorqueSpecificationForSystemDeflection":
        ...
        Returns:
            _7854.TorqueSpecificationForSystemDeflection
        """
        return _7854.TorqueSpecificationForSystemDeflection
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7854.TorqueSpecificationForSystemDeflection.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_7854.TorqueSpecificationForSystemDeflection":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_7854.TorqueSpecificationForSystemDeflection]":
