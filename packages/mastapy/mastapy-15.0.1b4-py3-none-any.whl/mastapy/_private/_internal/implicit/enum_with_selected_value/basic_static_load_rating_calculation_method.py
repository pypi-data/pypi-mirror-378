...
from mastapy._private.bearings import _2079
...
class EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod]",
    ) -> "_2079.BasicStaticLoadRatingCalculationMethod":
        ...
        Returns:
            _2079.BasicStaticLoadRatingCalculationMethod
        """
        return _2079.BasicStaticLoadRatingCalculationMethod
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2079.BasicStaticLoadRatingCalculationMethod.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2079.BasicStaticLoadRatingCalculationMethod":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_2079.BasicStaticLoadRatingCalculationMethod]":
