...
class EnumWithSelectedValue_MicroGeometryDefinitionType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_MicroGeometryDefinitionType]",
    ) -> "_750.MicroGeometryDefinitionType":
        ...
        Returns:
            _750.MicroGeometryDefinitionType
        """
        return _750.MicroGeometryDefinitionType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _750.MicroGeometryDefinitionType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_750.MicroGeometryDefinitionType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_750.MicroGeometryDefinitionType]":
