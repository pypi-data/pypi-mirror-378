...
from mastapy._private.bearings import _2103
...
class EnumWithSelectedValue_RollingBearingRaceType(
    ...
    def wrapped_type(
        ...
        Returns:
            _2103.RollingBearingRaceType
        """
        return _2103.RollingBearingRaceType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2103.RollingBearingRaceType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_2103.RollingBearingRaceType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_2103.RollingBearingRaceType]":
