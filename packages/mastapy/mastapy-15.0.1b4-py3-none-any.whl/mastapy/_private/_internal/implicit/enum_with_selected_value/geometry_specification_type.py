...
class EnumWithSelectedValue_GeometrySpecificationType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_GeometrySpecificationType]",
    ) -> "_1160.GeometrySpecificationType":
        ...
        Returns:
            _1160.GeometrySpecificationType
        """
        return _1160.GeometrySpecificationType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _1160.GeometrySpecificationType.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1160.GeometrySpecificationType":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1160.GeometrySpecificationType]":
