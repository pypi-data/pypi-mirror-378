...
class EnumWithSelectedValue_LocationOfRootReliefEvaluation(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_LocationOfRootReliefEvaluation]",
    ) -> "_667.LocationOfRootReliefEvaluation":
        ...
        Returns:
            _667.LocationOfRootReliefEvaluation
        """
        return _667.LocationOfRootReliefEvaluation
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _667.LocationOfRootReliefEvaluation.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_667.LocationOfRootReliefEvaluation":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_667.LocationOfRootReliefEvaluation]":
