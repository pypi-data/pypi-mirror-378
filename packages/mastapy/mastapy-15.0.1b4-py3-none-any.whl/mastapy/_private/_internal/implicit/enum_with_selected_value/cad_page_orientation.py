...
class EnumWithSelectedValue_CadPageOrientation(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    def wrapped_type(
        ...
        Returns:
            _1945.CadPageOrientation
        """
        return _1945.CadPageOrientation
    ...
    def implicit_type(cls: "Type[EnumWithSelectedValue_CadPageOrientation]") -> "Any":
        ...
        Returns:
            Any
        """
        return _1945.CadPageOrientation.type_()

    @property
    @exception_bridge
    def selected_value(self: "Self") -> "_1945.CadPageOrientation":
    ...
    @property
    @exception_bridge
    def available_values(self: "Self") -> "List[_1945.CadPageOrientation]":
