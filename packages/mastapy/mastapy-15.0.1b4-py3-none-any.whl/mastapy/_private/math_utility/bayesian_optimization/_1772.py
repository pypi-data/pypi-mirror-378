...
_OPTIMIZATION_DATA = python_net_import(
    "SMT.MastaAPI.MathUtility.BayesianOptimization", "OptimizationData"
)

if TYPE_CHECKING:
    from typing import Any, Type, TypeVar

    from mastapy._private.math_utility.bayesian_optimization import _1774
...
class OptimizationData(_0.APIBase):
    ...
    @property
    @exception_bridge
    def stage(self: "Self") -> "_1774.OptimizationStage":
