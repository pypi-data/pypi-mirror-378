...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_set_pareto_optimiser import _1005
...
class _Cast_ParetoOptimisationStrategyBars:
    ...
    @property
    def bar_for_pareto(self: "CastSelf") -> "_1005.BarForPareto":
        from mastapy._private.gears.gear_set_pareto_optimiser import _1005

        return self.__parent__._cast(_1005.BarForPareto)
