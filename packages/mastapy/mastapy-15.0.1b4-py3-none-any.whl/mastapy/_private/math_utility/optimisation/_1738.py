...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1736, _1737, _1740
...
class ParetoOptimisationStrategy(_2033.NamedDatabaseItem):
    """ParetoOptimisationStrategy
    ...
    def charts(
        self: "Self",
    ) -> "List[_1740.ParetoOptimisationStrategyChartInformation]":
    ...
    @property
    @exception_bridge
    def inputs(self: "Self") -> "List[_1736.ParetoOptimisationInput]":
    ...
    @property
    @exception_bridge
    def outputs(self: "Self") -> "List[_1737.ParetoOptimisationOutput]":
