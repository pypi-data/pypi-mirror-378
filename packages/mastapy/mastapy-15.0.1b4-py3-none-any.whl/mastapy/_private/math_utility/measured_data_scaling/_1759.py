...
from mastapy._private.math_utility.measured_data_scaling import _1760
...
class _Cast_DataScalingReferenceValues:
    ...
    def data_scaling_reference_values_base(
        self: "CastSelf",
    ) -> "_1760.DataScalingReferenceValuesBase":
        return self.__parent__._cast(_1760.DataScalingReferenceValuesBase)
...
class DataScalingReferenceValues(
    _1760.DataScalingReferenceValuesBase, Generic[TMeasurement]
):
    """DataScalingReferenceValues
