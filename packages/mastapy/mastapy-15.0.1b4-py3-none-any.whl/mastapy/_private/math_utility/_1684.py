...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility import _1683, _1685, _1686, _1717
...
class CoordinateSystemEditor(_0.APIBase):
    ...
    @property
    @exception_bridge
    def rotation_axis(self: "Self") -> "_1717.RotationAxis":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1717", "RotationAxis"
        )(value)

    @rotation_axis.setter
    @exception_bridge
    @enforce_parameter_types
    def rotation_axis(self: "Self", value: "_1717.RotationAxis") -> None:
