...
class OnedimensionalFunctionLookupTable(
    _1755.LookupTableBase["OnedimensionalFunctionLookupTable"]
):
    """OnedimensionalFunctionLookupTable
    ...
    @property
    @exception_bridge
    def lookup_table(self: "Self") -> "_1723.Vector2DListAccessor":
    ...
    def lookup_table(self: "Self", value: "_1723.Vector2DListAccessor") -> None:
