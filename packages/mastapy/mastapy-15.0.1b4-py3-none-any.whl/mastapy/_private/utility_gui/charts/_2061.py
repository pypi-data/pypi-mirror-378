...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility_gui.charts import _2066, _2072
...
class _Cast_ConstantLine:
    ...
    @property
    def mode_constant_line(self: "CastSelf") -> "_2066.ModeConstantLine":
        from mastapy._private.utility_gui.charts import _2066

        return self.__parent__._cast(_2066.ModeConstantLine)
...
class ConstantLine(_0.APIBase):
    ...
    @property
    @exception_bridge
    def axis(self: "Self") -> "_2072.SMTAxis":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility_gui.charts._2072", "SMTAxis"
        )(value)
