...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.optimisation import _1729, _1735, _1738
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    @exception_bridge
    def filters(self: "Self") -> "List[_1735.ParetoOptimisationFilter]":
    ...
    @property
    @exception_bridge
    def input_setters(self: "Self") -> "List[_1729.InputSetter[TAnalysis]]":
