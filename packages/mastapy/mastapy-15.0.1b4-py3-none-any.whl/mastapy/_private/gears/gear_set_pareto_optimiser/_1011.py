...
class FaceGearSetParetoOptimiser(_1015.GearSetParetoOptimiser):
    """FaceGearSetParetoOptimiser
    ...
    @property
    @exception_bridge
    def selected_candidate_geometry(self: "Self") -> "_1099.FaceGearSetDesign":
    ...
    @property
    @exception_bridge
    def all_candidate_gear_sets(self: "Self") -> "List[_1099.FaceGearSetDesign]":
    ...
    @property
    @exception_bridge
    def candidate_gear_sets(self: "Self") -> "List[_1099.FaceGearSetDesign]":
        """List[mastapy.gears.gear_designs.face.FaceGearSetDesign]
