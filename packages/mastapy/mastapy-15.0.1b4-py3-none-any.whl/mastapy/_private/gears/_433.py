...
from mastapy._private.math_utility import _1695
...
class PocketingPowerLossCoefficients(_2033.NamedDatabaseItem):
    """PocketingPowerLossCoefficients
    ...
    def extrapolation_options(
        self: "Self", value: "_1695.ExtrapolationOptions"
    ) -> None:
    ...
    def specifications_for_the_effect_of_oil_kinematic_viscosity(
        self: "Self",
    ) -> "List[_437.SpecificationForTheEffectOfOilKinematicViscosity]":
