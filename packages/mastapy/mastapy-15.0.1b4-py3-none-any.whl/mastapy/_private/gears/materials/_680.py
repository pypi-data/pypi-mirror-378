...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.materials import _678, _712
...
class BevelGearMaterial(_689.GearMaterial):
    """BevelGearMaterial
    ...
    @property
    @exception_bridge
    def sn_curve_definition(self: "Self") -> "_712.SNCurveDefinition":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.materials._712", "SNCurveDefinition"
        )(value)

    @sn_curve_definition.setter
    @exception_bridge
    @enforce_parameter_types
    def sn_curve_definition(self: "Self", value: "_712.SNCurveDefinition") -> None:
