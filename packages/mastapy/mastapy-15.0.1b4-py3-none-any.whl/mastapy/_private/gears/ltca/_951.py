...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _937, _939
    from mastapy._private.gears.ltca.conical import _966, _968
    from mastapy._private.gears.ltca.cylindrical import _955, _957
...
class _Cast_GearStiffness:
    ...
    @property
    def gear_bending_stiffness(self: "CastSelf") -> "_937.GearBendingStiffness":
        from mastapy._private.gears.ltca import _937

        return self.__parent__._cast(_937.GearBendingStiffness)

    @property
    def gear_contact_stiffness(self: "CastSelf") -> "_939.GearContactStiffness":
        from mastapy._private.gears.ltca import _939

        return self.__parent__._cast(_939.GearContactStiffness)
    ...
    def cylindrical_gear_contact_stiffness(
        self: "CastSelf",
    ) -> "_957.CylindricalGearContactStiffness":
        from mastapy._private.gears.ltca.cylindrical import _957

        return self.__parent__._cast(_957.CylindricalGearContactStiffness)
