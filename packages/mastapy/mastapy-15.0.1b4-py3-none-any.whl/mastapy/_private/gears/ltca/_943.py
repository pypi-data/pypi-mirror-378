...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _934, _941
...
class _Cast_GearFilletNodeStressResultsRow:
    ...
    def cylindrical_gear_fillet_node_stress_results_row(
        self: "CastSelf",
    ) -> "_934.CylindricalGearFilletNodeStressResultsRow":
        from mastapy._private.gears.ltca import _934

        return self.__parent__._cast(_934.CylindricalGearFilletNodeStressResultsRow)
...
class GearFilletNodeStressResultsRow(_0.APIBase):
    ...
    @property
    @exception_bridge
    def node_results(self: "Self") -> "List[_941.GearFilletNodeStressResults]":
