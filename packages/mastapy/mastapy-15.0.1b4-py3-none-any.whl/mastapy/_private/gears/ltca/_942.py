...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _933, _941
...
class _Cast_GearFilletNodeStressResultsColumn:
    ...
    def cylindrical_gear_fillet_node_stress_results_column(
        self: "CastSelf",
    ) -> "_933.CylindricalGearFilletNodeStressResultsColumn":
        from mastapy._private.gears.ltca import _933

        return self.__parent__._cast(_933.CylindricalGearFilletNodeStressResultsColumn)
