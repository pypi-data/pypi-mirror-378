...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _930, _935, _942, _943
...
class _Cast_GearRootFilletStressResults:
    ...
    def conical_gear_root_fillet_stress_results(
        self: "CastSelf",
    ) -> "_930.ConicalGearRootFilletStressResults":
        from mastapy._private.gears.ltca import _930

        return self.__parent__._cast(_930.ConicalGearRootFilletStressResults)

    @property
    def cylindrical_gear_root_fillet_stress_results(
        self: "CastSelf",
    ) -> "_935.CylindricalGearRootFilletStressResults":
        from mastapy._private.gears.ltca import _935

        return self.__parent__._cast(_935.CylindricalGearRootFilletStressResults)
...
class GearRootFilletStressResults(_0.APIBase):
    ...
    @property
    @exception_bridge
    def columns(self: "Self") -> "List[_942.GearFilletNodeStressResultsColumn]":
    ...
    @property
    @exception_bridge
    def rows(self: "Self") -> "List[_943.GearFilletNodeStressResultsRow]":
