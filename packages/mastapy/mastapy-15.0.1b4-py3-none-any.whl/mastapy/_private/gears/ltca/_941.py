...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.ltca import _929, _932
...
class _Cast_GearFilletNodeStressResults:
    ...
    def conical_gear_fillet_stress_results(
        self: "CastSelf",
    ) -> "_929.ConicalGearFilletStressResults":
        from mastapy._private.gears.ltca import _929

        return self.__parent__._cast(_929.ConicalGearFilletStressResults)

    @property
    def cylindrical_gear_fillet_node_stress_results(
        self: "CastSelf",
    ) -> "_932.CylindricalGearFilletNodeStressResults":
        from mastapy._private.gears.ltca import _932

        return self.__parent__._cast(_932.CylindricalGearFilletNodeStressResults)
