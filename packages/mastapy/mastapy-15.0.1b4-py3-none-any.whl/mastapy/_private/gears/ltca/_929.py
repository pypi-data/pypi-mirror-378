...
from mastapy._private.gears.ltca import _941
...
class _Cast_ConicalGearFilletStressResults:
    ...
    def gear_fillet_node_stress_results(
        self: "CastSelf",
    ) -> "_941.GearFilletNodeStressResults":
        return self.__parent__._cast(_941.GearFilletNodeStressResults)
...
class ConicalGearFilletStressResults(_941.GearFilletNodeStressResults):
    """ConicalGearFilletStressResults
