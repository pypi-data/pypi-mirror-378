...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.iso6336 import _600, _601, _607, _609
...
class ISO63362006GearSingleFlankRating(_611.ISO6336AbstractMetalGearSingleFlankRating):
    """ISO63362006GearSingleFlankRating
    ...
    def tooth_fatigue_fracture_results(
        self: "Self",
    ) -> "_600.CylindricalGearToothFatigueFractureResults":
    ...
    def tooth_fatigue_fracture_results_according_to_french_proposal(
        self: "Self",
    ) -> "_601.CylindricalGearToothFatigueFractureResultsN1457":
