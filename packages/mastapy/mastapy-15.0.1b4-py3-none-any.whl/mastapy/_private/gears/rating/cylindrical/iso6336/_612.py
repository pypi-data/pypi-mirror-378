...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical import _551, _559, _568, _573, _574
    from mastapy._private.gears.rating.cylindrical.din3990 import _625
    from mastapy._private.gears.rating.cylindrical.iso6336 import _604, _606, _608, _611
...
class ISO6336AbstractMetalMeshSingleFlankRating(
    ...
    def sorted_micro_pitting_results(
        self: "Self",
    ) -> "_551.CylindricalGearMicroPittingResults":
    ...
    def isodin_cylindrical_gear_single_flank_ratings(
        self: "Self",
    ) -> "List[_611.ISO6336AbstractMetalGearSingleFlankRating]":
