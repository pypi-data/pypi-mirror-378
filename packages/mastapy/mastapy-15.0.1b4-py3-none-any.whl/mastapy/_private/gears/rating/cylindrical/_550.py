...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _413, _432
    ...
    from mastapy._private.gears.rating.cylindrical import _552, _556, _559
...
class CylindricalGearMeshRating(_452.GearMeshRating):
    """CylindricalGearMeshRating
    ...
    @property
    @exception_bridge
    def gear_set_rating(self: "Self") -> "_556.CylindricalGearSetRating":
    ...
    def vdi_cylindrical_gear_single_flank_rating(
        self: "Self",
    ) -> "_581.VDI2737InternalGearSingleFlankRating":
