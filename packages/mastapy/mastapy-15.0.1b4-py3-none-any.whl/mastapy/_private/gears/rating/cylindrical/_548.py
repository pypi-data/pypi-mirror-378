...
class _Cast_CylindricalGearFlankDutyCycleRating:
    ...
    @property
    def gear_flank_rating(self: "CastSelf") -> "_450.GearFlankRating":
        return self.__parent__._cast(_450.GearFlankRating)
...
class CylindricalGearFlankDutyCycleRating(_450.GearFlankRating):
    """CylindricalGearFlankDutyCycleRating
