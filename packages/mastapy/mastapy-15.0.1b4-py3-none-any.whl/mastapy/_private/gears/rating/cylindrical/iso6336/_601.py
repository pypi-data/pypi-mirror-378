...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.iso6336 import _619, _622
...
class CylindricalGearToothFatigueFractureResultsN1457(_0.APIBase):
    ...
    @property
    @exception_bridge
    def fatigue_damage_chart(self: "Self") -> "_2073.ThreeDChartDefinition":
    ...
    @property
    @exception_bridge
    def critical_section(self: "Self") -> "_622.ToothFlankFractureAnalysisRowN1457":
    ...
    def mesh_contact_point_ab_section(
        self: "Self",
    ) -> "_619.ToothFlankFractureAnalysisContactPointN1457":
    ...
    @property
    @exception_bridge
    def analysis_rows(self: "Self") -> "List[_622.ToothFlankFractureAnalysisRowN1457]":
    ...
    def contact_points(
        self: "Self",
    ) -> "List[_619.ToothFlankFractureAnalysisContactPointN1457]":
