...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating import _460
...
class _Cast_SafetyFactorOptimisationStepResult:
    ...
    def safety_factor_optimisation_step_result_angle(
        ...
        return self.__parent__._cast(_597.SafetyFactorOptimisationStepResultAngle)
    ...
    def safety_factor_optimisation_step_result_number(
        ...
        return self.__parent__._cast(_598.SafetyFactorOptimisationStepResultNumber)

    @property
    def safety_factor_optimisation_step_result_short_length(
        self: "CastSelf",
    ) -> "_599.SafetyFactorOptimisationStepResultShortLength":
        from mastapy._private.gears.rating.cylindrical.optimisation import _599

        return self.__parent__._cast(_599.SafetyFactorOptimisationStepResultShortLength)
...
class SafetyFactorOptimisationStepResult(_0.APIBase):
    ...
    @property
    @exception_bridge
    def normalised_safety_factors(self: "Self") -> "_460.SafetyFactorResults":
    ...
    @property
    @exception_bridge
    def safety_factors(self: "Self") -> "_460.SafetyFactorResults":
        """mastapy.gears.rating.SafetyFactorResults
