...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.optimisation import _595, _596
...
T = TypeVar("T", bound="_596.SafetyFactorOptimisationStepResult")
...
class OptimisationResultsPair(_0.APIBase, Generic[T]):
    ...
    @property
    @exception_bridge
    def results(self: "Self") -> "_595.SafetyFactorOptimisationResults[T]":
    ...
    def results_without_warnings(
        self: "Self",
    ) -> "_595.SafetyFactorOptimisationResults[T]":
        """mastapy.gears.rating.cylindrical.optimisation.SafetyFactorOptimisationResults[T]
