...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.cylindrical.agma import _626, _629
...
class AGMA2101MeshSingleFlankRating(_559.CylindricalMeshSingleFlankRating):
    """AGMA2101MeshSingleFlankRating
    ...
    def thermal_reduction_factor_factors_and_exponents(
        self: "Self",
    ) -> "_629.ThermalReductionFactorFactorsAndExponents":
    ...
    def gear_single_flank_ratings(
        self: "Self",
    ) -> "List[_626.AGMA2101GearSingleFlankRating]":
