...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.klingelnberg_conical.kn3030 import _510, _511
...
class KlingelnbergConicalMeshSingleFlankRating(_458.MeshSingleFlankRating):
    """KlingelnbergConicalMeshSingleFlankRating
