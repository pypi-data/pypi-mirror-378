...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _413, _414
...
class CylindricalMeshLoadCase(_978.MeshLoadCase):
    ...
    @property
    @exception_bridge
    def misalignment_source(self: "Self") -> "_414.CylindricalMisalignmentDataSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._414", "CylindricalMisalignmentDataSource"
        )(value)
    ...
    def misalignment_source(
        self: "Self", value: "_414.CylindricalMisalignmentDataSource"
    ) -> None:
