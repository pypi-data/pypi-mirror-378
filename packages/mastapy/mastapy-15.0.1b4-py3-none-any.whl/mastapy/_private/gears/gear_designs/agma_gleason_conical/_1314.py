...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.rating.iso_10300 import _513, _526, _528, _529
...
class AGMAGleasonConicalGearMeshDesign(_1275.ConicalGearMeshDesign):
    ...
    def iso10300_gear_set_finishing_methods(
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._513", "Iso10300FinishingMethods"
        )(value)
    ...
    @enforce_parameter_types
    def iso10300_gear_set_finishing_methods(
        self: "Self", value: "_513.Iso10300FinishingMethods"
    ) -> None:
    ...
    def mounting_conditions_of_pinion_and_wheel(
        self: "Self",
    ) -> "_526.MountingConditionsOfPinionAndWheel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._526", "MountingConditionsOfPinionAndWheel"
        )(value)
    ...
    @enforce_parameter_types
    def mounting_conditions_of_pinion_and_wheel(
        self: "Self", value: "_526.MountingConditionsOfPinionAndWheel"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Iso10300.MountingConditionsOfPinionAndWheel",
    ...
    @property
    @exception_bridge
    def profile_crowning_setting(self: "Self") -> "_528.ProfileCrowningSetting":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._528", "ProfileCrowningSetting"
        )(value)
    ...
    def profile_crowning_setting(
        self: "Self", value: "_528.ProfileCrowningSetting"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def verification_of_contact_pattern(
        self: "Self",
    ) -> "_529.VerificationOfContactPattern":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.rating._529", "VerificationOfContactPattern"
        )(value)
    ...
    @enforce_parameter_types
    def verification_of_contact_pattern(
        self: "Self", value: "_529.VerificationOfContactPattern"
    ) -> None:
        value = conversion.mp_to_pn_enum(
