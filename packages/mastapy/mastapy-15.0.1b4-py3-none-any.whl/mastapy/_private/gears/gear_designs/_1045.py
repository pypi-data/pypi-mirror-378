...
class BevelHypoidGearDesignSettingsItem(_2033.NamedDatabaseItem):
    """BevelHypoidGearDesignSettingsItem
    ...
    @property
    @exception_bridge
    def quality_grade_type(self: "Self") -> "_435.QualityGradeTypes":
    ...
    @exception_bridge
    @enforce_parameter_types
    def quality_grade_type(self: "Self", value: "_435.QualityGradeTypes") -> None:
