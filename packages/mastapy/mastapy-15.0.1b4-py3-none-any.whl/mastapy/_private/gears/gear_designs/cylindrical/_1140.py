...
class _Cast_CylindricalGearSetMacroGeometryOptimiser:
    ...
    @property
    def gear_set_optimiser(self: "CastSelf") -> "_422.GearSetOptimiser":
        return self.__parent__._cast(_422.GearSetOptimiser)
...
class CylindricalGearSetMacroGeometryOptimiser(_422.GearSetOptimiser):
    """CylindricalGearSetMacroGeometryOptimiser
