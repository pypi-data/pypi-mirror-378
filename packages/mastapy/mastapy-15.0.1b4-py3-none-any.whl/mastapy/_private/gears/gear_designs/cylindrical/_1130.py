...
class CylindricalGearMicroGeometrySettings(
    _1784.IndependentReportablePropertiesBase["CylindricalGearMicroGeometrySettings"]
):
    """CylindricalGearMicroGeometrySettings
    ...
    @property
    @exception_bridge
    def flank_side_with_zero_face_width(self: "Self") -> "_663.FlankSide":
    ...
    def flank_side_with_zero_face_width(self: "Self", value: "_663.FlankSide") -> None:
