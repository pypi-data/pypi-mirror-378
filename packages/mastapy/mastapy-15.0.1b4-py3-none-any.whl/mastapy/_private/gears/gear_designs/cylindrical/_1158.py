...
from mastapy._private.gears.manufacturing.cylindrical import _727, _728
...
class GearManufacturingConfigSetupViewModel(_0.APIBase):
    ...
    @enforce_parameter_types
    def finishing_method(
        self: "Self", value: "_727.CylindricalMftFinishingMethods"
    ) -> None:
    ...
    @enforce_parameter_types
    def roughing_method(
        self: "Self", value: "_728.CylindricalMftRoughingMethods"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
