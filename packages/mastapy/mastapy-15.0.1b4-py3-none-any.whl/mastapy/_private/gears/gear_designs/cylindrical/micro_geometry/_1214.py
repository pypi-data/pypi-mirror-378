...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1122, _1135
...
class CylindricalGearMicroGeometryBase(_1341.GearImplementationDetail):
    """CylindricalGearMicroGeometryBase
    ...
    @property
    @exception_bridge
    def lead_form_chart(self: "Self") -> "_1986.SimpleChartDefinition":
    ...
    @property
    @exception_bridge
    def lead_slope_chart(self: "Self") -> "_1986.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    @property
    @exception_bridge
    def lead_total_nominal_chart(self: "Self") -> "_1986.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    @property
    @exception_bridge
    def lead_total_chart(self: "Self") -> "_1986.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    @property
    @exception_bridge
    def profile_form_10_percent_chart(self: "Self") -> "_1986.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    @property
    @exception_bridge
    def profile_form_50_percent_chart(self: "Self") -> "_1986.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    @property
    @exception_bridge
    def profile_form_90_percent_chart(self: "Self") -> "_1986.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    @property
    @exception_bridge
    def profile_form_chart(self: "Self") -> "_1986.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    @property
    @exception_bridge
    def profile_total_nominal_chart(self: "Self") -> "_1986.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    @property
    @exception_bridge
    def profile_total_chart(self: "Self") -> "_1986.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    def common_micro_geometry_of_left_flank(
        self: "Self",
    ) -> "_1207.CylindricalGearCommonFlankMicroGeometry":
    ...
    def common_micro_geometries_of_flanks(
        self: "Self",
    ) -> "List[_1207.CylindricalGearCommonFlankMicroGeometry]":
    ...
    def tooth_micro_geometries(
        self: "Self",
    ) -> "List[_1222.CylindricalGearToothMicroGeometry]":
