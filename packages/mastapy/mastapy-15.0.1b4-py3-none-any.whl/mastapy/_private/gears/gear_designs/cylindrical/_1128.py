...
class CylindricalGearMeshDesign(_1053.GearMeshDesign):
    ...
    def centre_distance_change_method(
        self: "Self",
    ) -> "_408.CentreDistanceChangeMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._408", "CentreDistanceChangeMethod"
        )(value)
    ...
    @enforce_parameter_types
    def centre_distance_change_method(
        self: "Self", value: "_408.CentreDistanceChangeMethod"
    ) -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def lubrication_method(self: "Self", value: "_426.LubricationMethods") -> None:
