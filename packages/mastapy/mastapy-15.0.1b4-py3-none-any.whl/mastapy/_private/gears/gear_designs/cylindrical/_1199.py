...
from mastapy._private.utility.units_and_measurements.measurements import _1865, _1886
...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    def chordal_span(
        self: "Self",
    ) -> "_1146.CylindricalGearToothThicknessSpecification[_1865.LengthShort]":
    ...
    def profile_shift_coefficient(
        self: "Self",
    ) -> "_1146.CylindricalGearToothThicknessSpecification[_1886.Number]":
    ...
    def tooth_thickness(
        self: "Self",
    ) -> "List[_1146.CylindricalGearToothThicknessSpecification[_1865.LengthShort]]":
