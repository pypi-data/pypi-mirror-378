...
class Usage(_1784.IndependentReportablePropertiesBase["Usage"]):
    """Usage
    ...
    @property
    @exception_bridge
    def safety_requirement(self: "Self") -> "_436.SafetyRequirementsAGMA":
    ...
    @exception_bridge
    @enforce_parameter_types
    def safety_requirement(self: "Self", value: "_436.SafetyRequirementsAGMA") -> None:
    ...
    @property
    @exception_bridge
    def spur_gear_load_sharing_code(self: "Self") -> "_1188.SpurGearLoadSharingCodes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.gear_designs.cylindrical._1188",
    ...
    def spur_gear_load_sharing_code(
        self: "Self", value: "_1188.SpurGearLoadSharingCodes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
