...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.gear_designs.cylindrical import _1122, _1128, _1149
...
class CylindricalMeshedGear(_0.APIBase):
    ...
    @property
    @exception_bridge
    def left_flank(self: "Self") -> "_1149.CylindricalMeshedGearFlank":
    ...
    @property
    @exception_bridge
    def right_flank(self: "Self") -> "_1149.CylindricalMeshedGearFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalMeshedGearFlank
    ...
    @property
    @exception_bridge
    def flanks(self: "Self") -> "List[_1149.CylindricalMeshedGearFlank]":
    ...
    @property
    @exception_bridge
    def both_flanks(self: "Self") -> "_1149.CylindricalMeshedGearFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalMeshedGearFlank
    ...
    @property
    @exception_bridge
    def mesh(self: "Self") -> "_1128.CylindricalGearMeshDesign":
