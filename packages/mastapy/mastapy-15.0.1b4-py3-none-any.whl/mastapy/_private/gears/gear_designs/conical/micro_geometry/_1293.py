...
class ConicalGearFlankMicroGeometry(_662.FlankMicroGeometry):
    """ConicalGearFlankMicroGeometry
    ...
    @property
    @exception_bridge
    def micro_geometry_input_type(self: "Self") -> "_427.MicroGeometryInputTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._427", "MicroGeometryInputTypes"
        )(value)
    ...
    def micro_geometry_input_type(
        self: "Self", value: "_427.MicroGeometryInputTypes"
    ) -> None:
    ...
    @property
    @exception_bridge
    def bias(self: "Self") -> "_1292.ConicalGearBiasModification":
    ...
    @property
    @exception_bridge
    def lead_relief(self: "Self") -> "_1294.ConicalGearLeadModification":
    ...
    @property
    @exception_bridge
    def profile_relief(self: "Self") -> "_1295.ConicalGearProfileModification":
    ...
    @property
    @exception_bridge
    def gear_design(self: "Self") -> "_1274.ConicalGearDesign":
