...
class _Cast_ProcessSimulationInput:
    ...
    def hobbing_process_simulation_input(
        self: "CastSelf",
    ) -> "_776.HobbingProcessSimulationInput":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _776,
        )

        return self.__parent__._cast(_776.HobbingProcessSimulationInput)

    @property
    def worm_grinding_process_simulation_input(
        self: "CastSelf",
    ) -> "_803.WormGrindingProcessSimulationInput":
        from mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new import (
            _803,
        )

        return self.__parent__._cast(_803.WormGrindingProcessSimulationInput)
...
class ProcessSimulationInput(_0.APIBase):
    ...
    @property
    @exception_bridge
    def analysis_setting(self: "Self") -> "_763.AnalysisMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new._763",
            "AnalysisMethod",
        )(value)
    ...
    def analysis_setting(self: "Self", value: "_763.AnalysisMethod") -> None:
    ...
    def centre_distance_offset_specification_method(
        self: "Self",
    ) -> "_767.CentreDistanceOffsetMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.manufacturing.cylindrical.hobbing_process_simulation_new._767",
    ...
    @enforce_parameter_types
    def centre_distance_offset_specification_method(
        self: "Self", value: "_767.CentreDistanceOffsetMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Manufacturing.Cylindrical.HobbingProcessSimulationNew.CentreDistanceOffsetMethod",
    ...
    @property
    @exception_bridge
    def cutter_head_slide_error(self: "Self") -> "_768.CutterHeadSlideError":
    ...
    @property
    @exception_bridge
    def cutter_mounting_error(self: "Self") -> "_794.RackMountingError":
    ...
    @property
    @exception_bridge
    def gear_mounting_error(self: "Self") -> "_769.GearMountingError":
