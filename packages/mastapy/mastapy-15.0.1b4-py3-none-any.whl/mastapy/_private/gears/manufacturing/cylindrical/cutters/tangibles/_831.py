...
class _Cast_CylindricalGearShaverTangible:
    ...
    @property
    def cutter_shape_definition(self: "CastSelf") -> "_827.CutterShapeDefinition":
        return self.__parent__._cast(_827.CutterShapeDefinition)
...
class CylindricalGearShaverTangible(_827.CutterShapeDefinition):
    """CylindricalGearShaverTangible
    ...
    @property
    @exception_bridge
    def design(self: "Self") -> "_819.CylindricalGearShaver":
