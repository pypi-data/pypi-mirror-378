...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _829
...
class HobSimulationCalculator(_847.RackSimulationCalculator):
    """HobSimulationCalculator
    ...
    @property
    @exception_bridge
    def hob(self: "Self") -> "_829.CylindricalGearHobShape":
