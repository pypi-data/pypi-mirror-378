...
class ShavingDynamicsConfiguration(_0.APIBase):
    ...
    def conventional_shaving_dynamics(
        self: "Self",
    ) -> "_870.ShavingDynamicsCalculation[_855.ConventionalShavingDynamics]":
    ...
    def plunge_shaving_dynamics(
        self: "Self",
    ) -> "_870.ShavingDynamicsCalculation[_859.PlungeShaverDynamics]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_859.PlungeShaverDynamics](
            temp
        )
