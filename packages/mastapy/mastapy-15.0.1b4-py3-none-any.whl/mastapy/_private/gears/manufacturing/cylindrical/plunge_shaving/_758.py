...
from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _755
...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.plunge_shaving import _749
...
class _Cast_RealPlungeShaverOutputs:
    ...
    @property
    def plunge_shaver_outputs(self: "CastSelf") -> "_755.PlungeShaverOutputs":
        return self.__parent__._cast(_755.PlungeShaverOutputs)
...
class RealPlungeShaverOutputs(_755.PlungeShaverOutputs):
    """RealPlungeShaverOutputs
    ...
    @property
    @exception_bridge
    def lead_measurement_method(self: "Self") -> "_749.MicroGeometryDefinitionMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.manufacturing.cylindrical.plunge_shaving._749",
    ...
    def lead_measurement_method(
        self: "Self", value: "_749.MicroGeometryDefinitionMethod"
    ) -> None:
    ...
    def profile_measurement_method(
        self: "Self",
    ) -> "_749.MicroGeometryDefinitionMethod":
        """mastapy.gears.manufacturing.cylindrical.plunge_shaving.MicroGeometryDefinitionMethod"""
    ...
    def left_flank_micro_geometry(
        self: "Self",
    ) -> "_717.CylindricalGearSpecifiedMicroGeometry":
    ...
    @property
    @exception_bridge
    def shaver(self: "Self") -> "_814.CylindricalGearPlungeShaver":
    ...
    def micro_geometry(
        self: "Self",
    ) -> "List[_717.CylindricalGearSpecifiedMicroGeometry]":
