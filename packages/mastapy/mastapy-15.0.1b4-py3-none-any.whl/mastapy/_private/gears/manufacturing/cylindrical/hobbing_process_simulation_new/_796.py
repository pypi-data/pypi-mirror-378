...
class WormGrindingCutterCalculation(_798.WormGrindingProcessCalculation):
    """WormGrindingCutterCalculation
    ...
    @property
    @exception_bridge
    def grinder_tooth_shape_chart(self: "Self") -> "_2075.TwoDChartDefinition":
    ...
    @property
    @exception_bridge
    def input_gear_point_of_interest(self: "Self") -> "_757.PointOfInterest":
