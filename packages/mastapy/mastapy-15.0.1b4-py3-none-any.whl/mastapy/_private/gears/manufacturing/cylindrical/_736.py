...
from mastapy._private.gears.manufacturing.cylindrical import _740
...
class _Cast_LeadModificationSegment:
    ...
    @property
    def modification_segment(self: "CastSelf") -> "_740.ModificationSegment":
        return self.__parent__._cast(_740.ModificationSegment)
...
class LeadModificationSegment(_740.ModificationSegment):
    """LeadModificationSegment
