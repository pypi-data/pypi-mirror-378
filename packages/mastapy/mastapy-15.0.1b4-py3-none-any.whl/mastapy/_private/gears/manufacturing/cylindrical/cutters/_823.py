...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters import _824, _825
...
class _Cast_MutableCommon:
    ...
    @property
    def curve_in_linked_list(self: "CastSelf") -> "_807.CurveInLinkedList":
        return self.__parent__._cast(_807.CurveInLinkedList)

    @property
    def mutable_curve(self: "CastSelf") -> "_824.MutableCurve":
        from mastapy._private.gears.manufacturing.cylindrical.cutters import _824

        return self.__parent__._cast(_824.MutableCurve)

    @property
    def mutable_fillet(self: "CastSelf") -> "_825.MutableFillet":
        from mastapy._private.gears.manufacturing.cylindrical.cutters import _825

        return self.__parent__._cast(_825.MutableFillet)
...
class MutableCommon(_807.CurveInLinkedList):
    """MutableCommon
    ...
    @exception_bridge
    @enforce_parameter_types
    def section(self: "Self", value: "_713.CutterFlankSections") -> None:
