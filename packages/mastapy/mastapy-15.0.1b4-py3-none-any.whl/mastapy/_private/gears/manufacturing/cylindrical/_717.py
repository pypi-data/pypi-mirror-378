...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical import _738, _739
...
class CylindricalGearSpecifiedMicroGeometry(_0.APIBase):
    ...
    @property
    @exception_bridge
    def lead_micro_geometry(self: "Self") -> "_738.MicroGeometryInputsLead":
    ...
    @property
    @exception_bridge
    def profile_micro_geometry(self: "Self") -> "List[_739.MicroGeometryInputsProfile]":
