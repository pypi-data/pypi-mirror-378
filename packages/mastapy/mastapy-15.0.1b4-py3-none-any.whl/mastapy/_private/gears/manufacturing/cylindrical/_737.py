...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical import _738, _739, _740
...
T = TypeVar("T", bound="_740.ModificationSegment")
...
class _Cast_MicroGeometryInputs:
    ...
    @property
    def micro_geometry_inputs_lead(self: "CastSelf") -> "_738.MicroGeometryInputsLead":
        from mastapy._private.gears.manufacturing.cylindrical import _738

        return self.__parent__._cast(_738.MicroGeometryInputsLead)

    @property
    def micro_geometry_inputs_profile(
        self: "CastSelf",
    ) -> "_739.MicroGeometryInputsProfile":
        from mastapy._private.gears.manufacturing.cylindrical import _739

        return self.__parent__._cast(_739.MicroGeometryInputsProfile)
