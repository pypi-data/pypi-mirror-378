...
class _Cast_ConventionalShavingDynamics:
    ...
    @property
    def shaving_dynamics(self: "CastSelf") -> "_869.ShavingDynamics":
        return self.__parent__._cast(_869.ShavingDynamics)
...
class ConventionalShavingDynamics(_869.ShavingDynamics):
    """ConventionalShavingDynamics
