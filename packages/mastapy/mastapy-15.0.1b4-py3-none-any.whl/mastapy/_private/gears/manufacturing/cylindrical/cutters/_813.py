...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.cylindrical.cutters import _810, _817
...
class CylindricalGearHobDesign(_816.CylindricalGearRackDesign):
    """CylindricalGearHobDesign
    ...
    @property
    @exception_bridge
    def hob_edge_type(self: "Self") -> "_735.HobEdgeTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.manufacturing.cylindrical._735", "HobEdgeTypes"
        )(value)

    @hob_edge_type.setter
    @exception_bridge
    @enforce_parameter_types
    def hob_edge_type(self: "Self", value: "_735.HobEdgeTypes") -> None:
    ...
    @property
    @exception_bridge
    def maximum_hob_material_shape(self: "Self") -> "_829.CylindricalGearHobShape":
    ...
    @property
    @exception_bridge
    def minimum_hob_material_shape(self: "Self") -> "_829.CylindricalGearHobShape":
        """mastapy.gears.manufacturing.cylindrical.cutters.tangibles.CylindricalGearHobShape
    ...
    @property
    @exception_bridge
    def nominal_hob_shape(self: "Self") -> "_829.CylindricalGearHobShape":
        """mastapy.gears.manufacturing.cylindrical.cutters.tangibles.CylindricalGearHobShape
    ...
    @property
    @exception_bridge
    def nominal_rack_shape(self: "Self") -> "_834.RackShape":
