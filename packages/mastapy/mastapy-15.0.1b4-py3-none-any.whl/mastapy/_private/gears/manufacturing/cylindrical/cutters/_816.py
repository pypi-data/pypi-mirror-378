...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears import _424, _442
    from mastapy._private.gears.manufacturing.cylindrical.cutters import (
        _810,
        _812,
        _813,
    )
    from mastapy._private.gears.manufacturing.cylindrical.cutters.tangibles import _834
...
class CylindricalGearRackDesign(_817.CylindricalGearRealCutterDesign):
    """CylindricalGearRackDesign
