...
class BevelMachineSettingOptimizationResult(_0.APIBase):
    ...
    def calculated_deviations_concave(
        self: "Self",
    ) -> "_878.ConicalFlankDeviationsData":
    ...
    @property
    @exception_bridge
    def calculated_deviations_convex(self: "Self") -> "_878.ConicalFlankDeviationsData":
        """mastapy.gears.manufacturing.bevel.ConicalFlankDeviationsData
    ...
    @property
    @exception_bridge
    def imported_deviations_concave(self: "Self") -> "_878.ConicalFlankDeviationsData":
        """mastapy.gears.manufacturing.bevel.ConicalFlankDeviationsData
    ...
    @property
    @exception_bridge
    def imported_deviations_convex(self: "Self") -> "_878.ConicalFlankDeviationsData":
        """mastapy.gears.manufacturing.bevel.ConicalFlankDeviationsData
