...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel import _883, _899
...
class ConicalMeshManufacturingAnalysis(_1343.GearMeshImplementationAnalysis):
    """ConicalMeshManufacturingAnalysis
    ...
    @property
    @exception_bridge
    def tca(self: "Self") -> "_899.EaseOffBasedTCA":
    ...
    def meshed_gears(
        self: "Self",
    ) -> "List[_883.ConicalMeshedGearManufacturingAnalysis]":
