...
class _Cast_ConicalGearManufacturingControlParameters:
    ...
    def conical_manufacturing_sgm_control_parameters(
        self: "CastSelf",
    ) -> "_922.ConicalManufacturingSGMControlParameters":
        from mastapy._private.gears.manufacturing.bevel.control_parameters import _922

        return self.__parent__._cast(_922.ConicalManufacturingSGMControlParameters)

    @property
    def conical_manufacturing_sgt_control_parameters(
        self: "CastSelf",
    ) -> "_923.ConicalManufacturingSGTControlParameters":
        from mastapy._private.gears.manufacturing.bevel.control_parameters import _923

        return self.__parent__._cast(_923.ConicalManufacturingSGTControlParameters)

    @property
    def conical_manufacturing_smt_control_parameters(
        self: "CastSelf",
    ) -> "_924.ConicalManufacturingSMTControlParameters":
        from mastapy._private.gears.manufacturing.bevel.control_parameters import _924

        return self.__parent__._cast(_924.ConicalManufacturingSMTControlParameters)
