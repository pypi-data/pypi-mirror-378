...
if TYPE_CHECKING:
    ...
    from mastapy._private.gears.manufacturing.bevel.control_parameters import _921
...
class _Cast_ConicalMeshFlankManufacturingConfig:
    ...
    def conical_mesh_flank_micro_geometry_config(
        self: "CastSelf",
    ) -> "_886.ConicalMeshFlankMicroGeometryConfig":
        return self.__parent__._cast(_886.ConicalMeshFlankMicroGeometryConfig)
...
class ConicalMeshFlankManufacturingConfig(_886.ConicalMeshFlankMicroGeometryConfig):
    """ConicalMeshFlankManufacturingConfig
    ...
    def control_parameters(
        self: "Self",
    ) -> "_921.ConicalGearManufacturingControlParameters":
    ...
    def specified_cradle_style_machine_settings(
        self: "Self",
    ) -> "_928.CradleStyleConicalMachineSettingsGenerated":
    ...
    def specified_phoenix_style_machine_settings(
        self: "Self",
    ) -> "_927.BasicConicalGearMachineSettingsGenerated":
