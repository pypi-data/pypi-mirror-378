...
class _Cast_ElmerResultsFromElectromagneticAnalysis:
    ...
    @property
    def elmer_results(self: "CastSelf") -> "_252.ElmerResults":
        return self.__parent__._cast(_252.ElmerResults)
...
class ElmerResultsFromElectromagneticAnalysis(_252.ElmerResults):
    """ElmerResultsFromElectromagneticAnalysis
