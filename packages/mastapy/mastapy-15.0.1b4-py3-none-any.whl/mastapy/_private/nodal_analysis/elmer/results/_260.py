...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.elmer.results import _261, _262
...
class _Cast_Data:
    ...
    @property
    def data_1d(self: "CastSelf") -> "_261.Data1D":
        from mastapy._private.nodal_analysis.elmer.results import _261

        return self.__parent__._cast(_261.Data1D)

    @property
    def data_3d(self: "CastSelf") -> "_262.Data3D":
        from mastapy._private.nodal_analysis.elmer.results import _262

        return self.__parent__._cast(_262.Data3D)
