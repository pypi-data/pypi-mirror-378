...
from mastapy._private.nodal_analysis.elmer.results import _260
...
class _Cast_Data3D:
    ...
    @property
    def data(self: "CastSelf") -> "_260.Data":
        return self.__parent__._cast(_260.Data)
