...
from mastapy._private.nodal_analysis.dev_tools_analyses import _276, _282, _283, _288
...
class DrawStyleForFE(_0.APIBase):
    ...
    def draw_condensation_node_connections(
        self: "Self", value: "_288.NoneSelectedAllOption"
    ) -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def draw_search_regions(self: "Self", value: "_288.NoneSelectedAllOption") -> None:
        generic_type = list_with_selected_item_and_image.ListWithSelectedItemAndImage_NoneSelectedAllOption.implicit_type()
        value = promote_to_list_with_selected_item(value)
        value = conversion.mp_to_pn_smt_list_with_selected_item(
            self, value, generic_type
    ...
    @exception_bridge
    @enforce_parameter_types
    def model_setup_view_type(self: "Self", value: "_276.FEModelSetupViewType") -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def surface(self: "Self", value: "_283.FESurfaceDrawingOption") -> None:
    ...
    @enforce_parameter_types
    def surface_and_non_deformed_surface(
        self: "Self", value: "_282.FESurfaceAndNonDeformedDrawingOption"
    ) -> None:
