...
class AbstractVaryingInputComponent(_0.APIBase):
    ...
    @property
    @exception_bridge
    def value_vs_angle(self: "Self") -> "_1723.Vector2DListAccessor":
    ...
    @exception_bridge
    @enforce_parameter_types
    def value_vs_angle(self: "Self", value: "_1723.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "ValueVsAngle", value.wrapped)

    @property
    @exception_bridge
    def value_vs_angle_and_speed(self: "Self") -> "_1754.GriddedSurfaceAccessor":
    ...
    @property
    @exception_bridge
    def value_vs_position(self: "Self") -> "_1723.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @exception_bridge
    @enforce_parameter_types
    def value_vs_position(self: "Self", value: "_1723.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "ValueVsPosition", value.wrapped)

    @property
    @exception_bridge
    def value_vs_time(self: "Self") -> "_1723.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @exception_bridge
    @enforce_parameter_types
    def value_vs_time(self: "Self", value: "_1723.Vector2DListAccessor") -> None:
