...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.component_mode_synthesis import _316, _317
...
class ModalCMSResults(_320.RealCMSResults):
    """ModalCMSResults
    ...
    @property
    @exception_bridge
    def fe_results_per_section(self: "Self") -> "List[_317.FESectionResults]":
