...
if TYPE_CHECKING:
    ...
    from mastapy._private.fe_tools.vfx_tools import _1359
    from mastapy._private.math_utility import _1687
    from mastapy._private.nodal_analysis.dev_tools_analyses import _264, _284
...
class CMSOptions(_0.APIBase):
    ...
    @property
    @exception_bridge
    def mass_matrix_type(self: "Self") -> "_284.MassMatrixType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.dev_tools_analyses._284", "MassMatrixType"
        )(value)

    @mass_matrix_type.setter
    @exception_bridge
    @enforce_parameter_types
    def mass_matrix_type(self: "Self", value: "_284.MassMatrixType") -> None:
    ...
    @property
    @exception_bridge
    def precision_when_saving_expansion_vectors(self: "Self") -> "_1687.DataPrecision":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility._1687", "DataPrecision"
        )(value)
    ...
    def precision_when_saving_expansion_vectors(
        self: "Self", value: "_1687.DataPrecision"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def internal_mode_options(self: "Self") -> "_264.EigenvalueOptions":
    ...
    @property
    @exception_bridge
    def solver_options(self: "Self") -> "_1359.ProSolveOptions":
