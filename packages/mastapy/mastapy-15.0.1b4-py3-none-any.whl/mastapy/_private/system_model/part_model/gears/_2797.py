...
class ZerolBevelGearSet(_2762.BevelGearSet):
    """ZerolBevelGearSet
    ...
    @property
    @exception_bridge
    def zerol_bevel_gears(self: "Self") -> "List[_2796.ZerolBevelGear]":
    ...
    @property
    @exception_bridge
    def zerol_bevel_meshes(self: "Self") -> "List[_2557.ZerolBevelGearMesh]":
