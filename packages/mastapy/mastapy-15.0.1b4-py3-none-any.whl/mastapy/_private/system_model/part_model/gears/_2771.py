...
class FaceGearSet(_2774.GearSet):
    """FaceGearSet
    ...
    @property
    @exception_bridge
    def active_gear_set_design(self: "Self") -> "_1099.FaceGearSetDesign":
    ...
    @property
    @exception_bridge
    def face_gear_set_design(self: "Self") -> "_1099.FaceGearSetDesign":
        """mastapy.gears.gear_designs.face.FaceGearSetDesign
    ...
    @property
    @exception_bridge
    def face_gears(self: "Self") -> "List[_2770.FaceGear]":
    ...
    @property
    @exception_bridge
    def face_meshes(self: "Self") -> "List[_2537.FaceGearMesh]":
