...
class _Cast_InnerBearingRaceMountingOptions:
    ...
    def bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2671.BearingRaceMountingOptions":
        return self.__parent__._cast(_2671.BearingRaceMountingOptions)
...
class InnerBearingRaceMountingOptions(_2671.BearingRaceMountingOptions):
    """InnerBearingRaceMountingOptions
