...
from mastapy._private.bearings.bearing_results import _2174, _2175
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2690, _2702
...
class _Cast_BearingRaceMountingOptions:
    ...
    def inner_bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2690.InnerBearingRaceMountingOptions":
        from mastapy._private.system_model.part_model import _2690

        return self.__parent__._cast(_2690.InnerBearingRaceMountingOptions)

    @property
    def outer_bearing_race_mounting_options(
        self: "CastSelf",
    ) -> "_2702.OuterBearingRaceMountingOptions":
        from mastapy._private.system_model.part_model import _2702

        return self.__parent__._cast(_2702.OuterBearingRaceMountingOptions)
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    def axial_mounting(self: "Self", value: "_2174.RaceAxialMountingType") -> None:
    ...
    @enforce_parameter_types
    def simple_radial_mounting(
        self: "Self", value: "_2175.RaceRadialMountingType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    @exception_bridge
    def mounting_sleeve_material(self: "Self") -> "_333.BearingMaterial":
