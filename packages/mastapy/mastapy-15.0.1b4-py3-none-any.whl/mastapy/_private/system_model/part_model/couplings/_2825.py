...
class ConceptCoupling(_2828.Coupling):
    """ConceptCoupling
    ...
    @property
    @exception_bridge
    def efficiency_vs_speed_ratio(self: "Self") -> "_1723.Vector2DListAccessor":
    ...
    @property
    @exception_bridge
    def half_positioning(self: "Self") -> "_2827.ConceptCouplingHalfPositioning":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.couplings._2827",
    ...
    def half_positioning(
        self: "Self", value: "_2827.ConceptCouplingHalfPositioning"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.ConceptCouplingHalfPositioning",
