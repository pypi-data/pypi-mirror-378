...
from mastapy._private.system_model.part_model.couplings import _2838, _2841, _2842
...
class ShaftHubConnection(_2678.Connector):
    """ShaftHubConnection
    ...
    @enforce_parameter_types
    def stiffness_type(
        self: "Self", value: "_2838.RigidConnectorStiffnessType"
    ) -> None:
    ...
    @property
    @exception_bridge
    def tilt_stiffness_type(self: "Self") -> "_2839.RigidConnectorTiltStiffnessTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.part_model.couplings._2839",
    ...
    def tilt_stiffness_type(
        self: "Self", value: "_2839.RigidConnectorTiltStiffnessTypes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.RigidConnectorTiltStiffnessTypes",
    ...
    @enforce_parameter_types
    def tooth_spacing_type(
        self: "Self", value: "_2841.RigidConnectorToothSpacingType"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @exception_bridge
    @enforce_parameter_types
    def type_(self: "Self", value: "_2842.RigidConnectorTypes") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    @exception_bridge
    def left_flank_lead_relief(self: "Self") -> "_2848.SplineLeadRelief":
    ...
    @property
    @exception_bridge
    def major_fit_options(self: "Self") -> "_2846.SplineFitOptions":
    ...
    @property
    @exception_bridge
    def minor_fit_options(self: "Self") -> "_2846.SplineFitOptions":
        """mastapy.system_model.part_model.couplings.SplineFitOptions
    ...
    @property
    @exception_bridge
    def right_flank_lead_relief(self: "Self") -> "_2848.SplineLeadRelief":
        """mastapy.system_model.part_model.couplings.SplineLeadRelief
    ...
    @property
    @exception_bridge
    def spline_pitch_error_options(self: "Self") -> "_2850.SplinePitchErrorOptions":
    ...
    @property
    @exception_bridge
    def fit_options(self: "Self") -> "List[_2846.SplineFitOptions]":
    ...
    @property
    @exception_bridge
    def lead_reliefs(self: "Self") -> "List[_2848.SplineLeadRelief]":
    ...
    def spline_half_manufacturing_errors(
        self: "Self",
    ) -> "List[_2847.SplineHalfManufacturingError]":
    ...
    def tooth_locations_external_spline_half(
        self: "Self",
    ) -> "List[_2840.RigidConnectorToothLocation]":
