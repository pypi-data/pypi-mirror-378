...
class FEPart(_2666.AbstractShaftOrHousing):
    """FEPart
    ...
    @exception_bridge
    @enforce_parameter_types
    def default_fe_substructure(self: "Self", value: "_2610.FESubstructure") -> None:
        generic_type = (
    ...
    @exception_bridge
    def create_fe_substructure(self: "Self") -> "_2610.FESubstructure":
    ...
    def remove_fe_substructure(
        self: "Self", fe_substructure: "_2610.FESubstructure"
    ) -> "bool":
        """bool
