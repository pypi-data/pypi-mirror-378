...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2881, _2882, _2890
...
T = TypeVar("T", bound="_2890.ResultSurfaceOptions")
...
class _Cast_MeshedResultSurface:
    ...
    @property
    def meshed_result_plane(self: "CastSelf") -> "_2881.MeshedResultPlane":
        from mastapy._private.system_model.part_model.acoustics import _2881

        return self.__parent__._cast(_2881.MeshedResultPlane)

    @property
    def meshed_result_sphere(self: "CastSelf") -> "_2882.MeshedResultSphere":
        from mastapy._private.system_model.part_model.acoustics import _2882

        return self.__parent__._cast(_2882.MeshedResultSphere)
...
class MeshedResultSurface(_2884.MeshedResultSurfaceBase, Generic[T]):
    """MeshedResultSurface
