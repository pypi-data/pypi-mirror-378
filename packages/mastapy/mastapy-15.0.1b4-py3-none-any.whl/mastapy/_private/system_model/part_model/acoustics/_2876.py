...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2878, _2880
...
class AcousticInputSurfaceOptions(_0.APIBase):
    ...
    @property
    @exception_bridge
    def fe_part_options(self: "Self") -> "List[_2878.FEPartInputSurfaceOptions]":
    ...
    @property
    @exception_bridge
    def hole_meshes(self: "Self") -> "List[_2880.HoleInFaceGroup]":
