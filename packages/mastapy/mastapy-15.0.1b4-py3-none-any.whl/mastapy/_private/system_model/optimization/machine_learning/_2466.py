...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.bayesian_optimization import _1770, _1771, _1774
...
class ML1MicroGeometryOptimiser(_0.APIBase):
    ...
    @property
    @exception_bridge
    def scatter_chart(self: "Self") -> "_2070.ScatterChartDefinition":
    ...
    @property
    @exception_bridge
    def settings(self: "Self") -> "_1771.ML1OptimizerSettings":
    ...
    @property
    @exception_bridge
    def constraints(self: "Self") -> "List[_2463.LoadCaseConstraint]":
    ...
    def flank_parameter_selections(
        self: "Self",
    ) -> "List[_2462.GearFlankParameterSelection]":
    ...
    @property
    @exception_bridge
    def snapshots(self: "Self") -> "List[_1770.ML1OptimiserSnapshot]":
    ...
    @property
    @exception_bridge
    def targets(self: "Self") -> "List[_2465.LoadCaseTarget]":
