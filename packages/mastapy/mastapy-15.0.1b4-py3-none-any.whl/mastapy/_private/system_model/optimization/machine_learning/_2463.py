...
from mastapy._private.system_model.optimization.machine_learning import _2464
...
class _Cast_LoadCaseConstraint:
    ...
    @property
    def load_case_settings(self: "CastSelf") -> "_2464.LoadCaseSettings":
        return self.__parent__._cast(_2464.LoadCaseSettings)
...
class LoadCaseConstraint(_2464.LoadCaseSettings):
    """LoadCaseConstraint
