...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.optimization import _2443, _2446, _2448
...
class _Cast_OptimizationStep:
    ...
    def conical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2443.ConicalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2443

        return self.__parent__._cast(_2443.ConicalGearOptimizationStep)

    @property
    def cylindrical_gear_optimization_step(
        self: "CastSelf",
    ) -> "_2446.CylindricalGearOptimizationStep":
        from mastapy._private.system_model.optimization import _2446

        return self.__parent__._cast(_2446.CylindricalGearOptimizationStep)
...
class OptimizationStep(_0.APIBase):
    ...
    @property
    @exception_bridge
    def optimisation_target(self: "Self") -> "_2448.MicroGeometryOptimisationTarget":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.optimization._2448",
    ...
    def optimisation_target(
        self: "Self", value: "_2448.MicroGeometryOptimisationTarget"
    ) -> None:
