...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.drawing import _2472, _2475, _2477
...
class _Cast_DynamicAnalysisViewable:
    ...
    def harmonic_analysis_viewable(
        self: "CastSelf",
    ) -> "_2475.HarmonicAnalysisViewable":
        from mastapy._private.system_model.drawing import _2475

        return self.__parent__._cast(_2475.HarmonicAnalysisViewable)

    @property
    def modal_analysis_viewable(self: "CastSelf") -> "_2477.ModalAnalysisViewable":
        from mastapy._private.system_model.drawing import _2477

        return self.__parent__._cast(_2477.ModalAnalysisViewable)
...
class DynamicAnalysisViewable(_2479.PartAnalysisCaseWithContourViewable):
    """DynamicAnalysisViewable
    ...
    @property
    @exception_bridge
    def contour_draw_style(self: "Self") -> "_2472.ContourDrawStyle":
    ...
    @property
    @exception_bridge
    def dynamic_analysis_draw_style(self: "Self") -> "_6647.DynamicAnalysisDrawStyle":
