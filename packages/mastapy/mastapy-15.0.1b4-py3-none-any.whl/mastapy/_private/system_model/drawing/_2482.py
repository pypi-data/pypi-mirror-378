...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.measured_vectors import _1749
...
class ShaftDeflectionDrawingNodeItem(_0.APIBase):
    ...
    @property
    @exception_bridge
    def node_detail(self: "Self") -> "_1749.ForceAndDisplacementResults":
    ...
    @property
    @exception_bridge
    def section_to_the_left_side(self: "Self") -> "_3051.ShaftSectionSystemDeflection":
    ...
    @property
    @exception_bridge
    def section_to_the_right_side(self: "Self") -> "_3051.ShaftSectionSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSectionSystemDeflection
