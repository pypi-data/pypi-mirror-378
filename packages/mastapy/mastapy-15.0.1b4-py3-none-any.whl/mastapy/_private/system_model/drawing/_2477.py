...
class _Cast_ModalAnalysisViewable:
    ...
    @property
    def dynamic_analysis_viewable(self: "CastSelf") -> "_2474.DynamicAnalysisViewable":
        return self.__parent__._cast(_2474.DynamicAnalysisViewable)
...
class ModalAnalysisViewable(_2474.DynamicAnalysisViewable):
    """ModalAnalysisViewable
