...
from mastapy._private.utility.enums import _2025, _2026
...
class PartAnalysisCaseWithContourViewable(_0.APIBase):
    ...
    def contour(
        self: "Self", value: "_2025.ThreeDViewContourOptionFirstSelection"
    ) -> None:
    ...
    @enforce_parameter_types
    def contour_secondary(
        self: "Self", value: "_2026.ThreeDViewContourOptionSecondSelection"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
