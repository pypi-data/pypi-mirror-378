...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.drawing import _2473, _2483, _2484
...
class _Cast_RotorDynamicsViewable:
    ...
    def critical_speed_analysis_viewable(
        self: "CastSelf",
    ) -> "_2473.CriticalSpeedAnalysisViewable":
        from mastapy._private.system_model.drawing import _2473

        return self.__parent__._cast(_2473.CriticalSpeedAnalysisViewable)

    @property
    def stability_analysis_viewable(
        self: "CastSelf",
    ) -> "_2483.StabilityAnalysisViewable":
        from mastapy._private.system_model.drawing import _2483

        return self.__parent__._cast(_2483.StabilityAnalysisViewable)

    @property
    def steady_state_synchronous_response_viewable(
        self: "CastSelf",
    ) -> "_2484.SteadyStateSynchronousResponseViewable":
        from mastapy._private.system_model.drawing import _2484

        return self.__parent__._cast(_2484.SteadyStateSynchronousResponseViewable)
...
class RotorDynamicsViewable(_0.APIBase):
    ...
    @property
    @exception_bridge
    def rotor_dynamics(self: "Self") -> "_4292.RotorDynamicsDrawStyle":
