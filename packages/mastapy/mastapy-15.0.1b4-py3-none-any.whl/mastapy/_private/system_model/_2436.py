...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2437
...
T = TypeVar("T", bound="_2675.Component")
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    @exception_bridge
    def axial_offset(self: "Self") -> "_2437.RelativeOffsetOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2437", "RelativeOffsetOption"
        )(value)

    @axial_offset.setter
    @exception_bridge
    @enforce_parameter_types
    def axial_offset(self: "Self", value: "_2437.RelativeOffsetOption") -> None:
        value = conversion.mp_to_pn_enum(
