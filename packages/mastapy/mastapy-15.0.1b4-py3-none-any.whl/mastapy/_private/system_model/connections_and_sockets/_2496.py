...
class _Cast_ComponentConnection:
    ...
    @property
    def component_measurer(self: "CastSelf") -> "_2497.ComponentMeasurer":
        return self.__parent__._cast(_2497.ComponentMeasurer)
...
class ComponentConnection(_2497.ComponentMeasurer):
    """ComponentConnection
    ...
    @property
    @exception_bridge
    def connected_component(self: "Self") -> "_2675.Component":
