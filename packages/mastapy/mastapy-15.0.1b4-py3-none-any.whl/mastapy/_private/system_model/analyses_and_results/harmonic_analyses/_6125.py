...
class StraightBevelGearSetHarmonicAnalysis(_5992.BevelGearSetHarmonicAnalysis):
    """StraightBevelGearSetHarmonicAnalysis
    ...
    def bevel_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_6123.StraightBevelGearHarmonicAnalysis]":
    ...
    def bevel_meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_6124.StraightBevelGearMeshHarmonicAnalysis]":
