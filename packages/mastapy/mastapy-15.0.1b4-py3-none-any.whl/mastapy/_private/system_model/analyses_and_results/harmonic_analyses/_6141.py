...
class WormGearSetHarmonicAnalysis(_6054.GearSetHarmonicAnalysis):
    """WormGearSetHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def gears_harmonic_analysis(self: "Self") -> "List[_6139.WormGearHarmonicAnalysis]":
    ...
    def worm_gears_harmonic_analysis(
        self: "Self",
    ) -> "List[_6139.WormGearHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.WormGearHarmonicAnalysis]
    ...
    def meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_6140.WormGearMeshHarmonicAnalysis]":
