...
class RootAssemblyHarmonicAnalysis(
    _5981.AssemblyHarmonicAnalysis, _2901.IHaveRootHarmonicAnalysisResults
):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def export(self: "Self") -> "_6065.HarmonicAnalysisRootAssemblyExportOptions":
    ...
    @property
    @exception_bridge
    def harmonic_analysis_inputs(self: "Self") -> "_6057.HarmonicAnalysis":
