...
class _Cast_ResultsForOrderIncludingGroups:
    ...
    @property
    def results_for_order(self: "CastSelf") -> "_6180.ResultsForOrder":
        return self.__parent__._cast(_6180.ResultsForOrder)
...
class ResultsForOrderIncludingGroups(_6180.ResultsForOrder):
    """ResultsForOrderIncludingGroups
