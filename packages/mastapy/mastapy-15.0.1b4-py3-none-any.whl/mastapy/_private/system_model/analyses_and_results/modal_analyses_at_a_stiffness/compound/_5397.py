...
class WormGearSetCompoundModalAnalysisAtAStiffness(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5266.WormGearSetModalAnalysisAtAStiffness]":
    ...
    def worm_gears_compound_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_5395.WormGearCompoundModalAnalysisAtAStiffness]":
    ...
    def worm_meshes_compound_modal_analysis_at_a_stiffness(
        self: "Self",
    ) -> "List[_5396.WormGearMeshCompoundModalAnalysisAtAStiffness]":
