...
class PartCompoundParametricStudyTool(_7893.PartCompoundAnalysis):
    """PartCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4666.PartParametricStudyTool]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4666.PartParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.PartParametricStudyTool]
