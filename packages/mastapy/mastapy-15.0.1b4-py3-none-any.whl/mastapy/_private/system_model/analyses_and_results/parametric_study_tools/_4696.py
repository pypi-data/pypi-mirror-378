...
class StraightBevelGearParametricStudyTool(_4583.BevelGearParametricStudyTool):
    """StraightBevelGearParametricStudyTool
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7838.StraightBevelGearLoadCase":
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_3066.StraightBevelGearSystemDeflection]":
