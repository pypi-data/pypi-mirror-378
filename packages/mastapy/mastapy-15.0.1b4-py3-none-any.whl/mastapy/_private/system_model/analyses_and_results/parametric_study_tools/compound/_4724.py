...
class BearingCompoundParametricStudyTool(_4752.ConnectorCompoundParametricStudyTool):
    """BearingCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def bearing_duty_cycle_results(self: "Self") -> "_2159.LoadedBearingDutyCycle":
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7693.BearingLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4574.BearingParametricStudyTool]":
