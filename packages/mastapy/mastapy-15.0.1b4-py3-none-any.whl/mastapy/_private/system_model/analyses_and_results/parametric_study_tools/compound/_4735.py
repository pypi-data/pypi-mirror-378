...
class BoltCompoundParametricStudyTool(_4741.ComponentCompoundParametricStudyTool):
    """BoltCompoundParametricStudyTool
    ...
    @property
    @exception_bridge
    def properties_changing_all_load_cases(self: "Self") -> "_7705.BoltLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4586.BoltParametricStudyTool]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4586.BoltParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.BoltParametricStudyTool]
