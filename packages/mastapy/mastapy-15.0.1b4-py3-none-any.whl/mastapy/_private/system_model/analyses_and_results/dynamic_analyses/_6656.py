...
class GearSetDynamicAnalysis(_6696.SpecialisedAssemblyDynamicAnalysis):
    """GearSetDynamicAnalysis
    ...
    @property
    @exception_bridge
    def gears_dynamic_analysis(self: "Self") -> "List[_6654.GearDynamicAnalysis]":
    ...
    @property
    @exception_bridge
    def meshes_dynamic_analysis(self: "Self") -> "List[_6655.GearMeshDynamicAnalysis]":
