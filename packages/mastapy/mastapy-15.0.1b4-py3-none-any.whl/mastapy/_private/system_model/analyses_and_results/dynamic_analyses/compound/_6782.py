...
class FaceGearSetCompoundDynamicAnalysis(_6787.GearSetCompoundDynamicAnalysis):
    """FaceGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6651.FaceGearSetDynamicAnalysis]":
    ...
    def face_gears_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6780.FaceGearCompoundDynamicAnalysis]":
    ...
    def face_meshes_compound_dynamic_analysis(
        self: "Self",
    ) -> "List[_6781.FaceGearMeshCompoundDynamicAnalysis]":
