...
class GearSetCompoundDynamicAnalysis(_6827.SpecialisedAssemblyCompoundDynamicAnalysis):
    """GearSetCompoundDynamicAnalysis
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_6656.GearSetDynamicAnalysis]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6656.GearSetDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.GearSetDynamicAnalysis]
