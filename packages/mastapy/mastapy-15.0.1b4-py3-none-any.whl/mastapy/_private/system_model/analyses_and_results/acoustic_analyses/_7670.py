...
class HarmonicAcousticAnalysis(_0.APIBase):
    ...
    @property
    @exception_bridge
    def analysis_run_type(self: "Self") -> "_7666.AcousticAnalysisRunType":
    ...
    def analysis_run_type(self: "Self", value: "_7666.AcousticAnalysisRunType") -> None:
    ...
    def excitation_details_to_run(
        self: "Self",
    ) -> "List[_7675.SingleExcitationDetails]":
