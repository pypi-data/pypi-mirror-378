...
class HypoidGearModalAnalysis(_4852.AGMAGleasonConicalGearModalAnalysis):
    """HypoidGearModalAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7779.HypoidGearLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3011.HypoidGearSystemDeflection":
