...
class ConnectorCompoundModalAnalysis(_5085.MountableComponentCompoundModalAnalysis):
    """ConnectorCompoundModalAnalysis
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4883.ConnectorModalAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4883.ConnectorModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ConnectorModalAnalysis]
