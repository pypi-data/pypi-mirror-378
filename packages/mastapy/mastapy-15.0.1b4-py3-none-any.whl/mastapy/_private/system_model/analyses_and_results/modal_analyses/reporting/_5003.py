...
class _Cast_ShaftPerModeResult:
    ...
    @property
    def component_per_mode_result(self: "CastSelf") -> "_4996.ComponentPerModeResult":
        return self.__parent__._cast(_4996.ComponentPerModeResult)
...
class ShaftPerModeResult(_4996.ComponentPerModeResult):
    """ShaftPerModeResult
