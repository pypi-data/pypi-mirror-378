...
class FaceGearSetModalAnalysis(_4912.GearSetModalAnalysis):
    """FaceGearSetModalAnalysis
    ...
    @property
    @exception_bridge
    def gears_modal_analysis(self: "Self") -> "List[_4905.FaceGearModalAnalysis]":
    ...
    @property
    @exception_bridge
    def face_gears_modal_analysis(self: "Self") -> "List[_4905.FaceGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearModalAnalysis]
    ...
    @property
    @exception_bridge
    def meshes_modal_analysis(self: "Self") -> "List[_4904.FaceGearMeshModalAnalysis]":
    ...
    def face_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4904.FaceGearMeshModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearMeshModalAnalysis]
