...
class DatumCompoundModalAnalysis(_5031.ComponentCompoundModalAnalysis):
    """DatumCompoundModalAnalysis
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4899.DatumModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.DatumModalAnalysis]
