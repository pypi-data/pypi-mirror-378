...
class GearSetCompoundModalAnalysis(_5106.SpecialisedAssemblyCompoundModalAnalysis):
    """GearSetCompoundModalAnalysis
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4912.GearSetModalAnalysis]":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4912.GearSetModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.GearSetModalAnalysis]
