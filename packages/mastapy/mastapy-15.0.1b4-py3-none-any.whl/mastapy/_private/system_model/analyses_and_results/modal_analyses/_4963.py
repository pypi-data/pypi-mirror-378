...
class SpiralBevelGearSetModalAnalysis(_4865.BevelGearSetModalAnalysis):
    """SpiralBevelGearSetModalAnalysis
    ...
    def bevel_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4962.SpiralBevelGearModalAnalysis]":
    ...
    def bevel_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4961.SpiralBevelGearMeshModalAnalysis]":
