...
class MassDiscModalAnalysis(_4984.VirtualComponentModalAnalysis):
    """MassDiscModalAnalysis
    ...
    @property
    @exception_bridge
    def component_load_case(self: "Self") -> "_7795.MassDiscLoadCase":
    ...
    @property
    @exception_bridge
    def system_deflection_results(self: "Self") -> "_3025.MassDiscSystemDeflection":
