...
TReal = TypeVar("TReal", bound="_2675.Component")
TComponentStaticLoad = TypeVar("TComponentStaticLoad", bound="_7711.ComponentLoadCase")
...
class ComponentStaticLoadCaseGroup(
    _5972.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]
):
    """ComponentStaticLoadCaseGroup
