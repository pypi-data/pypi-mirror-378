...
class DutyCycle(_5955.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    def duty_cycle_design_states(
        self: "Self",
    ) -> "List[_5962.SubGroupInSingleDesignState]":
    ...
    @property
    @exception_bridge
    def time_series_importer(self: "Self") -> "_7878.TimeSeriesImporter":
    ...
    def add_static_load(self: "Self", static_load: "_7679.StaticLoadCase") -> None:
        """Method does not return.
    ...
    def remove_design_state_sub_group(
        self: "Self", sub_group: "_5962.SubGroupInSingleDesignState"
    ) -> None:
        """Method does not return.
