...
class ConceptGearSetCriticalSpeedAnalysis(_6927.GearSetCriticalSpeedAnalysis):
    """ConceptGearSetCriticalSpeedAnalysis
    ...
    def gears_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6893.ConceptGearCriticalSpeedAnalysis]":
    ...
    def meshes_critical_speed_analysis(
        self: "Self",
    ) -> "List[_6894.ConceptGearMeshCriticalSpeedAnalysis]":
