...
class BevelDifferentialGearSetCompoundPowerFlow(_4453.BevelGearSetCompoundPowerFlow):
    """BevelDifferentialGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4311.BevelDifferentialGearSetPowerFlow]":
    ...
    def bevel_differential_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4446.BevelDifferentialGearCompoundPowerFlow]":
    ...
    def bevel_differential_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4447.BevelDifferentialGearMeshCompoundPowerFlow]":
