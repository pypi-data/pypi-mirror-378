...
class CylindricalGearSetCompoundPowerFlow(_4495.GearSetCompoundPowerFlow):
    """CylindricalGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4348.CylindricalGearSetPowerFlow]":
    ...
    def cylindrical_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4482.CylindricalGearCompoundPowerFlow]":
    ...
    def cylindrical_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4483.CylindricalGearMeshCompoundPowerFlow]":
    ...
    def ratings_for_all_designs(
        self: "Self",
    ) -> "List[_555.CylindricalGearSetDutyCycleRating]":
