...
class ZerolBevelGearSetPowerFlow(_4316.BevelGearSetPowerFlow):
    """ZerolBevelGearSetPowerFlow
    ...
    @property
    @exception_bridge
    def bevel_gears_power_flow(self: "Self") -> "List[_4433.ZerolBevelGearPowerFlow]":
    ...
    def zerol_bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4433.ZerolBevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ZerolBevelGearPowerFlow]
