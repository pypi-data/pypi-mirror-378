...
class StraightBevelGearSetCompoundPowerFlow(_4453.BevelGearSetCompoundPowerFlow):
    """StraightBevelGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4415.StraightBevelGearSetPowerFlow]":
    ...
    def straight_bevel_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4545.StraightBevelGearCompoundPowerFlow]":
    ...
    def straight_bevel_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4546.StraightBevelGearMeshCompoundPowerFlow]":
