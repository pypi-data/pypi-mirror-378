...
class PlanetCarrierCompoundPowerFlow(_4514.MountableComponentCompoundPowerFlow):
    """PlanetCarrierCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4388.PlanetCarrierPowerFlow]":
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4388.PlanetCarrierPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PlanetCarrierPowerFlow]
