...
class WormGearSetPowerFlow(_4361.GearSetPowerFlow):
    """WormGearSetPowerFlow
    ...
    @property
    @exception_bridge
    def rating(self: "Self") -> "_468.WormGearSetRating":
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_468.WormGearSetRating":
        """mastapy.gears.rating.worm.WormGearSetRating
    ...
    @property
    @exception_bridge
    def gears_power_flow(self: "Self") -> "List[_4430.WormGearPowerFlow]":
    ...
    @property
    @exception_bridge
    def worm_gears_power_flow(self: "Self") -> "List[_4430.WormGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearPowerFlow]
    ...
    @property
    @exception_bridge
    def meshes_power_flow(self: "Self") -> "List[_4429.WormGearMeshPowerFlow]":
    ...
    @property
    @exception_bridge
    def worm_meshes_power_flow(self: "Self") -> "List[_4429.WormGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearMeshPowerFlow]
