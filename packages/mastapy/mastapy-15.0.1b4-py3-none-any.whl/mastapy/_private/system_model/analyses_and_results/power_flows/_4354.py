...
class FaceGearSetPowerFlow(_4361.GearSetPowerFlow):
    """FaceGearSetPowerFlow
    ...
    @property
    @exception_bridge
    def rating(self: "Self") -> "_542.FaceGearSetRating":
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_542.FaceGearSetRating":
        """mastapy.gears.rating.face.FaceGearSetRating
    ...
    @property
    @exception_bridge
    def gears_power_flow(self: "Self") -> "List[_4353.FaceGearPowerFlow]":
    ...
    @property
    @exception_bridge
    def face_gears_power_flow(self: "Self") -> "List[_4353.FaceGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearPowerFlow]
    ...
    @property
    @exception_bridge
    def meshes_power_flow(self: "Self") -> "List[_4352.FaceGearMeshPowerFlow]":
    ...
    @property
    @exception_bridge
    def face_meshes_power_flow(self: "Self") -> "List[_4352.FaceGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearMeshPowerFlow]
