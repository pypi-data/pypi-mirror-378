...
class StraightBevelDiffGearSetCompoundPowerFlow(_4453.BevelGearSetCompoundPowerFlow):
    """StraightBevelDiffGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4412.StraightBevelDiffGearSetPowerFlow]":
    ...
    def straight_bevel_diff_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4542.StraightBevelDiffGearCompoundPowerFlow]":
    ...
    def straight_bevel_diff_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4543.StraightBevelDiffGearMeshCompoundPowerFlow]":
