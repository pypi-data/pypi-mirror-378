...
class BevelGearMeshCompoundPowerFlow(_4440.AGMAGleasonConicalGearMeshCompoundPowerFlow):
    """BevelGearMeshCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def connection_analysis_cases(self: "Self") -> "List[_4314.BevelGearMeshPowerFlow]":
