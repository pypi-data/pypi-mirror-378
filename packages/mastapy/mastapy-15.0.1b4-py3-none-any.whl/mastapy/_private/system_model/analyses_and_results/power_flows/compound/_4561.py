...
class WormGearMeshCompoundPowerFlow(_4494.GearMeshCompoundPowerFlow):
    """WormGearMeshCompoundPowerFlow
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4429.WormGearMeshPowerFlow]":
    ...
    @property
    @exception_bridge
    def connection_analysis_cases(self: "Self") -> "List[_4429.WormGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearMeshPowerFlow]
