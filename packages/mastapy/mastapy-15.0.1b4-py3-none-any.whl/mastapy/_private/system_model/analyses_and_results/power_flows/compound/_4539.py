...
class SpringDamperCompoundPowerFlow(_4472.CouplingCompoundPowerFlow):
    """SpringDamperCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_design(self: "Self") -> "_2851.SpringDamper":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4409.SpringDamperPowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4409.SpringDamperPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SpringDamperPowerFlow]
