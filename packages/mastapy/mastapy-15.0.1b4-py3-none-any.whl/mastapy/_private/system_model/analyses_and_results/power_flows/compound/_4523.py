...
class PointLoadCompoundPowerFlow(_4559.VirtualComponentCompoundPowerFlow):
    """PointLoadCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_4389.PointLoadPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PointLoadPowerFlow]
