...
class BeltDriveCompoundPowerFlow(_4535.SpecialisedAssemblyCompoundPowerFlow):
    """BeltDriveCompoundPowerFlow
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4308.BeltDrivePowerFlow]":
    ...
    @property
    @exception_bridge
    def assembly_analysis_cases(self: "Self") -> "List[_4308.BeltDrivePowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BeltDrivePowerFlow]
