...
class AdvancedSystemDeflectionOptions(_0.APIBase):
    ...
    @exception_bridge
    @enforce_parameter_types
    def specified_gear_set(self: "Self", value: "_2774.GearSet") -> None:
        generic_type = (
    ...
    @property
    @exception_bridge
    def use_advanced_ltca(self: "Self") -> "_954.UseAdvancedLTCAOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears.ltca._954", "UseAdvancedLTCAOptions"
        )(value)

    @use_advanced_ltca.setter
    @exception_bridge
    @enforce_parameter_types
    def use_advanced_ltca(self: "Self", value: "_954.UseAdvancedLTCAOptions") -> None:
