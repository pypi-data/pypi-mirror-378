...
class ZerolBevelGearSetAdvancedSystemDeflection(
    ...
    @property
    @exception_bridge
    def rating(self: "Self") -> "_463.ZerolBevelGearSetRating":
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_463.ZerolBevelGearSetRating":
        """mastapy.gears.rating.zerol_bevel.ZerolBevelGearSetRating
    ...
    def bevel_gears_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7532.ZerolBevelGearAdvancedSystemDeflection]":
    ...
    def bevel_meshes_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7533.ZerolBevelGearMeshAdvancedSystemDeflection]":
