...
class StraightBevelDiffGearSetAdvancedSystemDeflection(
    ...
    @property
    @exception_bridge
    def rating(self: "Self") -> "_492.StraightBevelDiffGearSetRating":
    ...
    def bevel_gears_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7510.StraightBevelDiffGearAdvancedSystemDeflection]":
    ...
    def bevel_meshes_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7511.StraightBevelDiffGearMeshAdvancedSystemDeflection]":
