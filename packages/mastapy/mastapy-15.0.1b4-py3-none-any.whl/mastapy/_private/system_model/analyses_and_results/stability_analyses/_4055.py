...
class ConceptGearSetStabilityAnalysis(_4086.GearSetStabilityAnalysis):
    """ConceptGearSetStabilityAnalysis
    ...
    def gears_stability_analysis(
        self: "Self",
    ) -> "List[_4056.ConceptGearStabilityAnalysis]":
    ...
    def meshes_stability_analysis(
        self: "Self",
    ) -> "List[_4054.ConceptGearMeshStabilityAnalysis]":
