...
class ConceptGearSetCompoundStabilityAnalysis(_4221.GearSetCompoundStabilityAnalysis):
    """ConceptGearSetCompoundStabilityAnalysis
    ...
    def concept_gears_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4190.ConceptGearCompoundStabilityAnalysis]":
    ...
    def concept_meshes_compound_stability_analysis(
        self: "Self",
    ) -> "List[_4191.ConceptGearMeshCompoundStabilityAnalysis]":
