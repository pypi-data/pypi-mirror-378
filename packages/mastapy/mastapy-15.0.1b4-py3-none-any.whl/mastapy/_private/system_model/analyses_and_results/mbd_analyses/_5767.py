...
class PulleyMultibodyDynamicsAnalysis(_5706.CouplingHalfMultibodyDynamicsAnalysis):
    """PulleyMultibodyDynamicsAnalysis
    ...
    @property
    @exception_bridge
    def peak_pulley_torque(self: "Self") -> "List[_5818.DynamicTorqueResultAtTime]":
