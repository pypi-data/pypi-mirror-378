...
class GearMultibodyDynamicsAnalysis(_5755.MountableComponentMultibodyDynamicsAnalysis):
    """GearMultibodyDynamicsAnalysis
    ...
    @property
    @exception_bridge
    def peak_gear_torque(self: "Self") -> "List[_5818.DynamicTorqueResultAtTime]":
