...
class MBDRunUpAnalysisOptions(_7883.AbstractAnalysisOptions[_7848.TimeSeriesLoadCase]):
    """MBDRunUpAnalysisOptions
    ...
    def input_velocity_processing_type(
        self: "Self",
    ) -> "_5737.InputVelocityForRunUpProcessingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5737",
    ...
    @enforce_parameter_types
    def input_velocity_processing_type(
        self: "Self", value: "_5737.InputVelocityForRunUpProcessingType"
    ) -> None:
    ...
    @property
    @exception_bridge
    def run_up_driving_mode(self: "Self") -> "_5774.RunUpDrivingMode":
    ...
    @exception_bridge
    @enforce_parameter_types
    def run_up_driving_mode(self: "Self", value: "_5774.RunUpDrivingMode") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.RunUpDrivingMode",
        )
    ...
    @property
    @exception_bridge
    def run_up_speed_profile(self: "Self") -> "_2075.TwoDChartDefinition":
    ...
    def shape_of_initial_acceleration_period(
        self: "Self",
    ) -> "_5779.ShapeOfInitialAccelerationPeriodForRunUp":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5779",
    ...
    @enforce_parameter_types
    def shape_of_initial_acceleration_period(
        self: "Self", value: "_5779.ShapeOfInitialAccelerationPeriodForRunUp"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ShapeOfInitialAccelerationPeriodForRunUp",
