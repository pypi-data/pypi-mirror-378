...
class ZerolBevelGearMeshModalAnalysisAtASpeed(_5417.BevelGearMeshModalAnalysisAtASpeed):
    """ZerolBevelGearMeshModalAnalysisAtASpeed
    ...
    @property
    @exception_bridge
    def connection_load_case(self: "Self") -> "_7863.ZerolBevelGearMeshLoadCase":
