...
class FEPartLoadCase(_7682.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    @exception_bridge
    def angle_source(self: "Self") -> "_2585.AngleSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2585", "AngleSource"
        )(value)
    ...
    def surfaces_for_data_logging(
        self: "Self",
    ) -> "List[_7709.CMSElementFaceGroupWithSelectionOption]":
