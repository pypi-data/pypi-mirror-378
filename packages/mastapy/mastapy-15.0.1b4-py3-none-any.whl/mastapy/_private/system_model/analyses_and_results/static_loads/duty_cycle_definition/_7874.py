...
class PointLoadInputOptions(_2055.ColumnInputOptions):
    """PointLoadInputOptions
    ...
    @property
    @exception_bridge
    def conversion_to_load_case(self: "Self") -> "_7865.AdditionalForcesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads.duty_cycle_definition._7865",
    ...
    def conversion_to_load_case(
        self: "Self", value: "_7865.AdditionalForcesObtainedFrom"
    ) -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def point_load(self: "Self", value: "_2707.PointLoad") -> None:
        generic_type = (
