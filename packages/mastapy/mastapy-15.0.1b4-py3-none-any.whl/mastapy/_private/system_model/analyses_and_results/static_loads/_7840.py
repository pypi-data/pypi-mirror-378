...
class StraightBevelGearSetLoadCase(_7703.BevelGearSetLoadCase):
    """StraightBevelGearSetLoadCase
    ...
    @property
    @exception_bridge
    def bevel_gears_load_case(self: "Self") -> "List[_7838.StraightBevelGearLoadCase]":
    ...
    def straight_bevel_gears_load_case(
        self: "Self",
    ) -> "List[_7838.StraightBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.StraightBevelGearLoadCase]
    ...
    def bevel_meshes_load_case(
        self: "Self",
    ) -> "List[_7839.StraightBevelGearMeshLoadCase]":
