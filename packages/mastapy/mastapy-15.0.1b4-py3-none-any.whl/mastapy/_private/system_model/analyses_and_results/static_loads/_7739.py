...
from mastapy._private.gears import _409, _428, _432
...
class CylindricalGearSetLoadCase(_7769.GearSetLoadCase):
    """CylindricalGearSetLoadCase
    ...
    def efficiency_rating_method(
        self: "Self",
        value: "Union[_451.GearMeshEfficiencyRatingMethod, Tuple[_451.GearMeshEfficiencyRatingMethod, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    def planetary_rating_load_sharing_method(
        self: "Self",
        value: "Union[_432.PlanetaryRatingLoadSharingOption, Tuple[_432.PlanetaryRatingLoadSharingOption, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    @property
    @exception_bridge
    def reset_micro_geometry(self: "Self") -> "_7817.ResetMicroGeometryOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7817",
    ...
    def reset_micro_geometry(
        self: "Self", value: "_7817.ResetMicroGeometryOptions"
    ) -> None:
    ...
    @property
    @exception_bridge
    def gears_load_case(self: "Self") -> "List[_7735.CylindricalGearLoadCase]":
    ...
    def cylindrical_gears_load_case(
        self: "Self",
    ) -> "List[_7735.CylindricalGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.CylindricalGearLoadCase]
    ...
    @property
    @exception_bridge
    def meshes_load_case(self: "Self") -> "List[_7737.CylindricalGearMeshLoadCase]":
    ...
    def cylindrical_meshes_load_case(
        self: "Self",
    ) -> "List[_7737.CylindricalGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.CylindricalGearMeshLoadCase]
