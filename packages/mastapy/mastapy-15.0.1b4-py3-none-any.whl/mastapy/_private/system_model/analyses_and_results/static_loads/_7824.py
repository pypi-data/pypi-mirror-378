...
class RootAssemblyLoadCase(_7692.AssemblyLoadCase):
    """RootAssemblyLoadCase
    ...
    @property
    @exception_bridge
    def drive_cycle_pid_control_settings(self: "Self") -> "_1766.PIDControlSettings":
    ...
    @property
    @exception_bridge
    def load_case(self: "Self") -> "_7679.StaticLoadCase":
    ...
    def supercharger_rotor_sets(
        self: "Self",
    ) -> "List[_7739.CylindricalGearSetLoadCase]":
