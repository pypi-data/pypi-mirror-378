...
from mastapy._private.bearings.bearing_results.rolling import _2177, _2178, _2184, _2282
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling.dysla import _2328
    from mastapy._private.bearings.tolerances import _2124, _2128
    ...
    from mastapy._private.system_model.part_model import _2669, _2710
...
class BearingLoadCase(_7724.ConnectorLoadCase):
    """BearingLoadCase
    ...
    @enforce_parameter_types
    def ball_bearing_analysis_method(
        self: "Self", value: "_2177.BallBearingAnalysisMethod"
    ) -> None:
    ...
    def ball_bearing_contact_calculation(
        self: "Self",
        value: "Union[_2178.BallBearingContactCalculation, Tuple[_2178.BallBearingContactCalculation, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    def ball_bearing_friction_model_for_gyroscopic_moment(
        self: "Self",
        value: "Union[_2184.FrictionModelForGyroscopicMoment, Tuple[_2184.FrictionModelForGyroscopicMoment, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    def bearing_element_orbit_model(
        self: "Self",
        value: "Union[_5673.BearingElementOrbitModel, Tuple[_5673.BearingElementOrbitModel, bool]]",
    ) -> None:
    ...
    @property
    @exception_bridge
    def bearing_stiffness_model(self: "Self") -> "_5675.BearingStiffnessModel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5675",
    ...
    def bearing_stiffness_model(
        self: "Self", value: "_5675.BearingStiffnessModel"
    ) -> None:
    ...
    def force_at_zero_displacement_input_method(
        self: "Self",
        value: "Union[_2670.BearingF0InputMethod, Tuple[_2670.BearingF0InputMethod, bool]]",
    ) -> None:
    ...
    @enforce_parameter_types
    def hertzian_contact_deflection_calculation_method(
        self: "Self", value: "_1763.HertzianContactDeflectionCalculationMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    @exception_bridge
    def include_ring_ovality(self: "Self") -> "_1786.LoadCaseOverrideOption":
    ...
    def roller_analysis_method(
        self: "Self",
        value: "Union[_2282.RollerAnalysisMethod, Tuple[_2282.RollerAnalysisMethod, bool]]",
    ) -> None:
    ...
    @property
    @exception_bridge
    def dynamic_analysis_options(self: "Self") -> "_2328.DynamicBearingAnalysisOptions":
    ...
    @property
    @exception_bridge
    def inner_ring_detail(self: "Self") -> "_2124.RingDetail":
    ...
    @property
    @exception_bridge
    def left_ring_detail(self: "Self") -> "_2124.RingDetail":
        """mastapy.bearings.tolerances.RingDetail
    ...
    @property
    @exception_bridge
    def outer_ring_detail(self: "Self") -> "_2124.RingDetail":
        """mastapy.bearings.tolerances.RingDetail
    ...
    @property
    @exception_bridge
    def right_ring_detail(self: "Self") -> "_2124.RingDetail":
        """mastapy.bearings.tolerances.RingDetail
    ...
    @property
    @exception_bridge
    def elements(self: "Self") -> "List[_2710.RollingBearingElementLoadCase]":
