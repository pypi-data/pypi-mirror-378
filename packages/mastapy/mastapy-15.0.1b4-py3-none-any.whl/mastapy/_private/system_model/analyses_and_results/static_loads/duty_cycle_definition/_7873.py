...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.file_access_helpers import _2020
...
class MultiTimeSeriesDataInputFileOptions(_2056.DataInputFileOptions):
    """MultiTimeSeriesDataInputFileOptions
    ...
    @property
    @exception_bridge
    def delimiter_options(self: "Self") -> "_2020.TextFileDelimiterOptions":
