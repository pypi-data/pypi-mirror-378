...
class _Cast_GearSetHarmonicLoadData:
    ...
    def conical_gear_set_harmonic_load_data(
        ...
        return self.__parent__._cast(_7721.ConicalGearSetHarmonicLoadData)
    ...
    def cylindrical_gear_set_harmonic_load_data(
        ...
        return self.__parent__._cast(_7738.CylindricalGearSetHarmonicLoadData)
...
class GearSetHarmonicLoadData(_1564.HarmonicLoadDataBase):
    ...
    @property
    @exception_bridge
    def gear_mesh_te_order_type(self: "Self") -> "_7767.GearMeshTEOrderType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7767",
            "GearMeshTEOrderType",
        )(value)
    ...
    def gear_mesh_te_order_type(
        self: "Self", value: "_7767.GearMeshTEOrderType"
    ) -> None:
    ...
    @property
    @exception_bridge
    def excitations(self: "Self") -> "List[_1698.FourierSeries]":
