...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2896, _2929
...
class StaticLoadCase(_7678.LoadCase):
    """StaticLoadCase
    ...
    def default_planetary_rating_load_sharing_method(
        self: "Self",
    ) -> "_432.PlanetaryRatingLoadSharingOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.gears._432", "PlanetaryRatingLoadSharingOption"
        )(value)
    ...
    @enforce_parameter_types
    def default_planetary_rating_load_sharing_method(
        self: "Self", value: "_432.PlanetaryRatingLoadSharingOption"
    ) -> None:
    ...
    def unbalanced_mass_inclusion(
        self: "Self",
        value: "Union[_2715.UnbalancedMassInclusionOption, Tuple[_2715.UnbalancedMassInclusionOption, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    def te_set_up_for_dynamic_analyses_options(
        self: "Self",
    ) -> "_2929.TESetUpForDynamicAnalysisOptions":
    ...
    @property
    @exception_bridge
    def clutch_engagements(self: "Self") -> "List[_5956.ClutchEngagementStatus]":
    ...
    @property
    @exception_bridge
    def design_state_load_case_group(self: "Self") -> "_5958.DesignState":
    ...
    @enforce_parameter_types
    def duplicate(
        self: "Self", new_design_state_group: "_5958.DesignState", name: "str" = "None"
    ) -> "StaticLoadCase":
