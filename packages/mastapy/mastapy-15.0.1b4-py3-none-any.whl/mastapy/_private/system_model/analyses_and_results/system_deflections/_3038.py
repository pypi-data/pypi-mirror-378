...
class PlanetCarrierSystemDeflection(_3030.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4388.PlanetCarrierPowerFlow":
    ...
    @property
    @exception_bridge
    def windup(self: "Self") -> "List[_3094.PlanetCarrierWindup]":
