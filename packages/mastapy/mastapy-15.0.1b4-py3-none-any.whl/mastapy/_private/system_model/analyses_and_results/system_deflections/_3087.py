...
class ZerolBevelGearMeshSystemDeflection(_2952.BevelGearMeshSystemDeflection):
    """ZerolBevelGearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def rating(self: "Self") -> "_461.ZerolBevelGearMeshRating":
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_461.ZerolBevelGearMeshRating":
        """mastapy.gears.rating.zerol_bevel.ZerolBevelGearMeshRating
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4432.ZerolBevelGearMeshPowerFlow":
