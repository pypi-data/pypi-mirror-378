...
class _Cast_RigidlyConnectedComponentGroupSystemDeflection:
    ...
    def design_entity_group_analysis(
        self: "CastSelf",
    ) -> "_2898.DesignEntityGroupAnalysis":
        return self.__parent__._cast(_2898.DesignEntityGroupAnalysis)
...
class RigidlyConnectedComponentGroupSystemDeflection(_2898.DesignEntityGroupAnalysis):
    """RigidlyConnectedComponentGroupSystemDeflection
    ...
    @property
    @exception_bridge
    def mass_properties(self: "Self") -> "_1703.MassProperties":
    ...
    @property
    @exception_bridge
    def components(self: "Self") -> "List[_2961.ComponentSystemDeflection]":
