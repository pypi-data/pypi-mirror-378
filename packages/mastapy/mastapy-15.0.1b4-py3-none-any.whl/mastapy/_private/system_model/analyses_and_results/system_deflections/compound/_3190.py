...
class PulleyCompoundSystemDeflection(_3138.CouplingHalfCompoundSystemDeflection):
    """PulleyCompoundSystemDeflection
    ...
    @property
    @exception_bridge
    def component_analysis_cases(self: "Self") -> "List[_3041.PulleySystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.PulleySystemDeflection]
