...
class WormGearCompoundSystemDeflection(_3158.GearCompoundSystemDeflection):
    """WormGearCompoundSystemDeflection
    ...
    @property
    @exception_bridge
    def duty_cycle_rating(self: "Self") -> "_464.WormGearDutyCycleRating":
    ...
    @property
    @exception_bridge
    def worm_duty_cycle_rating(self: "Self") -> "_464.WormGearDutyCycleRating":
        """mastapy.gears.rating.worm.WormGearDutyCycleRating
