...
class FaceGearSetSystemDeflection(_3006.GearSetSystemDeflection):
    """FaceGearSetSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4354.FaceGearSetPowerFlow":
    ...
    @property
    @exception_bridge
    def gears_system_deflection(self: "Self") -> "List[_3002.FaceGearSystemDeflection]":
    ...
    def face_gears_system_deflection(
        self: "Self",
    ) -> "List[_3002.FaceGearSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.FaceGearSystemDeflection]
