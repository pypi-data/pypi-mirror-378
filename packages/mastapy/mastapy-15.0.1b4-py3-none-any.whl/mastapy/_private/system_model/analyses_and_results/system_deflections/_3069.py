...
from mastapy._private.system_model.analyses_and_results.system_deflections import _3070
...
class SynchroniserHalfSystemDeflection(_3070.SynchroniserPartSystemDeflection):
    """SynchroniserHalfSystemDeflection
    ...
    @property
    @exception_bridge
    def clutch_connection(self: "Self") -> "_2957.ClutchConnectionSystemDeflection":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4418.SynchroniserHalfPowerFlow":
