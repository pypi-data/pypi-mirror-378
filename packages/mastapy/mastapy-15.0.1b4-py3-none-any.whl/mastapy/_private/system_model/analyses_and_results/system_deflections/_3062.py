...
class StraightBevelDiffGearSetSystemDeflection(_2953.BevelGearSetSystemDeflection):
    """StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4412.StraightBevelDiffGearSetPowerFlow":
