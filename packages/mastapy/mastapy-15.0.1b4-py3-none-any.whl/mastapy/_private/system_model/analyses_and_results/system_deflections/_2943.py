...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling.dysla import _2329
...
class BearingDynamicResultsUIWrapper(_0.APIBase):
    ...
    @property
    @exception_bridge
    def revolutions_type(self: "Self") -> "_2329.RevolutionsType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_results.rolling.dysla._2329",
            "RevolutionsType",
        )(value)
    ...
    @exception_bridge
    @enforce_parameter_types
    def revolutions_type(self: "Self", value: "_2329.RevolutionsType") -> None:
    ...
    @property
    @exception_bridge
    def bearing_system_deflection(self: "Self") -> "_2944.BearingSystemDeflection":
    ...
    def bearing_results(
        self: "Self",
    ) -> "List[_2942.BearingDynamicResultsPropertyWrapper]":
    ...
    def element_results(
        self: "Self",
    ) -> "List[_2940.BearingDynamicElementPropertyWrapper]":
    ...
    def post_analysis_results(
        self: "Self",
    ) -> "List[_2941.BearingDynamicPostAnalysisResultWrapper]":
