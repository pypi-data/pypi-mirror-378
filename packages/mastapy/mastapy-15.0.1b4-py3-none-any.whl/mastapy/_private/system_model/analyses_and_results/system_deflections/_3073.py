...
class SystemDeflection(_7891.FEAnalysis):
    """SystemDeflection
    ...
    @property
    @exception_bridge
    def analysis_options(self: "Self") -> "_3075.SystemDeflectionOptions":
    ...
    def overall_efficiency_results(
        self: "Self",
    ) -> "_3023.LoadCaseOverallEfficiencyResult":
