...
class WormGearSetSystemDeflection(_3006.GearSetSystemDeflection):
    """WormGearSetSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4431.WormGearSetPowerFlow":
    ...
    @property
    @exception_bridge
    def gears_system_deflection(self: "Self") -> "List[_3086.WormGearSystemDeflection]":
