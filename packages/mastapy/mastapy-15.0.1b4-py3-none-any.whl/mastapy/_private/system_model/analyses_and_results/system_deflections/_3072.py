...
class SynchroniserSystemDeflection(_3054.SpecialisedAssemblySystemDeflection):
    """SynchroniserSystemDeflection
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4420.SynchroniserPowerFlow":
    ...
    @property
    @exception_bridge
    def cones(self: "Self") -> "List[_3069.SynchroniserHalfSystemDeflection]":
