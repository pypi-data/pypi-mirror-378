...
class SpiralBevelGearSetSystemDeflection(_2953.BevelGearSetSystemDeflection):
    """SpiralBevelGearSetSystemDeflection
    ...
    @property
    @exception_bridge
    def rating(self: "Self") -> "_496.SpiralBevelGearSetRating":
    ...
    @property
    @exception_bridge
    def component_detailed_analysis(self: "Self") -> "_496.SpiralBevelGearSetRating":
        """mastapy.gears.rating.spiral_bevel.SpiralBevelGearSetRating
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4406.SpiralBevelGearSetPowerFlow":
    ...
    def bevel_gears_system_deflection(
        self: "Self",
    ) -> "List[_3057.SpiralBevelGearSystemDeflection]":
