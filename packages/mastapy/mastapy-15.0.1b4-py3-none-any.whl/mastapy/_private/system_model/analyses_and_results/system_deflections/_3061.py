...
class StraightBevelDiffGearMeshSystemDeflection(_2952.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    @exception_bridge
    def rating(self: "Self") -> "_490.StraightBevelDiffGearMeshRating":
    ...
    @property
    @exception_bridge
    def power_flow_results(self: "Self") -> "_4410.StraightBevelDiffGearMeshPowerFlow":
