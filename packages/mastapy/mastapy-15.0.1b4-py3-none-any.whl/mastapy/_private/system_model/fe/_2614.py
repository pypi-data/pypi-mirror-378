...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2612, _2613
...
class FESubstructureNodeModeShapes(_0.APIBase):
    ...
    @property
    @exception_bridge
    def condensation_node(self: "Self") -> "_2612.FESubstructureNode":
    ...
    def mode_shapes_at_condensation_node(
        self: "Self",
    ) -> "List[_2613.FESubstructureNodeModeShape]":
