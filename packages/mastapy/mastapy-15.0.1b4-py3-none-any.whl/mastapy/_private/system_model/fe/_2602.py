...
from mastapy._private.fe_tools.vis_tools_global import _1354
from mastapy._private.nodal_analysis.component_mode_synthesis import _311
from mastapy._private.system_model.fe import _2604
...
class _Cast_ElementFaceGroupWithSelection:
    ...
    def fe_entity_group_with_selection(
        self: "CastSelf",
    ) -> "_2604.FEEntityGroupWithSelection":
        return self.__parent__._cast(_2604.FEEntityGroupWithSelection)
...
class ElementFaceGroupWithSelection(
    _2604.FEEntityGroupWithSelection[_311.CMSElementFaceGroup, _1354.ElementFace]
):
    """ElementFaceGroupWithSelection
