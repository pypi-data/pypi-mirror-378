...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe.version_comparer import _2642, _2646
...
class FESubstructureVersionComparer(_0.APIBase):
    ...
    @property
    @exception_bridge
    def load_cases_to_run(self: "Self") -> "_2646.LoadCasesToRun":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe.version_comparer._2646", "LoadCasesToRun"
        )(value)

    @load_cases_to_run.setter
    @exception_bridge
    @enforce_parameter_types
    def load_cases_to_run(self: "Self", value: "_2646.LoadCasesToRun") -> None:
    ...
    @property
    @exception_bridge
    def design_results(self: "Self") -> "List[_2642.DesignResults]":
