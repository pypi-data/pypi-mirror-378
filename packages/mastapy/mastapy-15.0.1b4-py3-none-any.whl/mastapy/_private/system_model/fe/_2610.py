...
from mastapy._private.system_model.fe import _2615, _2641
from mastapy._private.system_model.part_model import _2675, _2679
...
if TYPE_CHECKING:
    ...
    from mastapy._private.materials import _325, _373
    from mastapy._private.math_utility import _1683, _1711
    from mastapy._private.math_utility.measured_vectors import _1753
    from mastapy._private.nodal_analysis import _63, _73, _91
    from mastapy._private.nodal_analysis.component_mode_synthesis import _313, _321
    from mastapy._private.nodal_analysis.fe_export_utility import _247
    from mastapy._private.nodal_analysis.geometry_modeller_link import _234, _236
    from mastapy._private.system_model import _2436
...
class FESubstructure(_69.FEStiffness):
    ...
    @property
    @exception_bridge
    def alignment_method(self: "Self") -> "_2582.AlignmentMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2582", "AlignmentMethod"
        )(value)

    @alignment_method.setter
    @exception_bridge
    @enforce_parameter_types
    def alignment_method(self: "Self", value: "_2582.AlignmentMethod") -> None:
    ...
    @property
    @exception_bridge
    def bearing_node_alignment(self: "Self") -> "_2588.BearingNodeAlignmentOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2588", "BearingNodeAlignmentOption"
        )(value)
    ...
    def bearing_node_alignment(
        self: "Self", value: "_2588.BearingNodeAlignmentOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @exception_bridge
    @enforce_parameter_types
    def component_to_align_to(self: "Self", value: "_2675.Component") -> None:
        generic_type = (
    ...
    @exception_bridge
    @enforce_parameter_types
    def distance_display_unit(self: "Self", value: "_1807.Unit") -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def force_display_unit(self: "Self", value: "_1807.Unit") -> None:
        generic_type = list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        value = promote_to_list_with_selected_item(value)
        value = conversion.mp_to_pn_smt_list_with_selected_item(
            self, value, generic_type
    ...
    @property
    @exception_bridge
    def reduction_mode_type(self: "Self") -> "_321.ReductionModeType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.component_mode_synthesis._321",
            "ReductionModeType",
        )(value)
    ...
    @exception_bridge
    @enforce_parameter_types
    def reduction_mode_type(self: "Self", value: "_321.ReductionModeType") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def thermal_expansion_option(
        self: "Self", value: "_2641.ThermalExpansionOption"
    ) -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def type_(self: "Self", value: "_2615.FESubstructureType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def acoustic_radiation_efficiency(
        self: "Self",
    ) -> "_325.AcousticRadiationEfficiency":
    ...
    def alignment_using_axial_node_positions(
        self: "Self",
    ) -> "_2584.AlignmentUsingAxialNodePositions":
    ...
    def alignment_to_component(
        self: "Self",
    ) -> "_2436.RelativeComponentAlignment[_2675.Component]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2675.Component](temp)

    @property
    @exception_bridge
    def cms_model(self: "Self") -> "_313.CMSModel":
    ...
    @property
    @exception_bridge
    def export(self: "Self") -> "_2611.FESubstructureExportOptions":
    ...
    @property
    @exception_bridge
    def fe_part(self: "Self") -> "_2685.FEPart":
    ...
    def geometry_modeller_design_information(
        self: "Self",
    ) -> "_234.GeometryModellerDesignInformation":
    ...
    @property
    @exception_bridge
    def geometry_modeller_dimensions(self: "Self") -> "_236.GeometryModellerDimensions":
    ...
    @property
    @exception_bridge
    def named_selections(self: "Self") -> "_1711.NamedSelections":
    ...
    @property
    @exception_bridge
    def sound_pressure_enclosure(self: "Self") -> "_373.SoundPressureEnclosure":
    ...
    @property
    @exception_bridge
    def gear_meshing_options(self: "Self") -> "List[_2622.GearMeshingOptions]":
    ...
    @property
    @exception_bridge
    def geometries(self: "Self") -> "List[_2608.FEStiffnessGeometry]":
    ...
    def independent_masta_created_condensation_nodes(
        self: "Self",
    ) -> "List[_2623.IndependentMASTACreatedCondensationNode]":
    ...
    def independent_masta_created_rigid_nodes(
        self: "Self",
    ) -> "List[_2626.IndependentMASTACreatedRigidlyConnectedNodeGroup]":
    ...
    @property
    @exception_bridge
    def links(self: "Self") -> "List[_2648.FELink]":
    ...
    @property
    @exception_bridge
    def nodes(self: "Self") -> "List[_2612.FESubstructureNode]":
    ...
    @property
    @exception_bridge
    def replaced_shafts(self: "Self") -> "List[_2719.Shaft]":
    ...
    def shafts_that_can_be_replaced(
        self: "Self",
    ) -> "List[_2639.ReplacedShaftSelectionHelper]":
    ...
    def create_fe_substructure_with_selection_components(
        self: "Self",
    ) -> "_2618.FESubstructureWithSelectionComponents":
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(
        self: "Self",
    ) -> "_2619.FESubstructureWithSelectionForHarmonicAnalysis":
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(
        self: "Self",
    ) -> "_2620.FESubstructureWithSelectionForModalAnalysis":
    ...
    def create_fe_substructure_with_selection_for_static_analysis(
        self: "Self",
    ) -> "_2621.FESubstructureWithSelectionForStaticAnalysis":
    ...
    def import_fe_mesh(
        self: "Self",
        file_path: "PathLike",
        format_: "_247.FEExportFormat",
        length_scale: "float" = 1.0,
        force_scale: "float" = 1.0,
        progress: Optional["_7906.TaskProgress"] = None,
    ) -> None:
        """Method does not return.
    ...
    def import_node_positions(
        self: "Self", file_name: "PathLike", distance_unit: "_1807.Unit"
    ) -> None:
        """Method does not return.
    ...
    def import_reduced_stiffness(
        self: "Self",
        file_name: "PathLike",
        distance_unit: "_1807.Unit",
        force_unit: "_1807.Unit",
    ) -> None:
        """Method does not return.
    ...
    @enforce_parameter_types
    def links_for(
        self: "Self", node: "_2612.FESubstructureNode"
    ) -> "List[_2648.FELink]":
        """List[mastapy.system_model.fe.links.FELink]
    ...
    def load_existing_masta_fe_file_with_progress(
        self: "Self", file_name: "PathLike", progress: "_7906.TaskProgress"
    ) -> None:
        """Method does not return.
    ...
    def load_stl_geometry(
        self: "Self", length_unit: "_1807.Unit", file_path: "PathLike"
    ) -> None:
        """Method does not return.
