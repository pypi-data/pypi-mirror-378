...
class FESubstructureWithSelectionComponents(_2617.FESubstructureWithSelection):
    """FESubstructureWithSelectionComponents
    ...
    @property
    @exception_bridge
    def manual_alignment(self: "Self") -> "_1684.CoordinateSystemEditor":
    ...
    def beam_element_properties(
        self: "Self",
    ) -> "List[_2603.ElementPropertiesWithSelection[_296.ElementPropertiesBeam]]":
    ...
    @property
    @exception_bridge
    def component_links(self: "Self") -> "List[_2650.FELinkWithSelection]":
    ...
    @property
    @exception_bridge
    def contact_pairs(self: "Self") -> "List[_2593.ContactPairWithSelection]":
    ...
    @property
    @exception_bridge
    def coordinate_systems(self: "Self") -> "List[_2594.CoordinateSystemWithSelection]":
    ...
    def independent_masta_created_rigid_nodes(
        self: "Self",
    ) -> "List[_2625.IndependentMASTACreatedConstrainedNodesWithSelectionComponents]":
    ...
    def interface_element_properties(
        self: "Self",
    ) -> "List[_2603.ElementPropertiesWithSelection[_297.ElementPropertiesInterface]]":
    ...
    @property
    @exception_bridge
    def links_for_electric_machine(self: "Self") -> "List[_2650.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    @property
    @exception_bridge
    def links_for_selected_component(self: "Self") -> "List[_2650.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    def mass_element_properties(
        self: "Self",
    ) -> "List[_2603.ElementPropertiesWithSelection[_298.ElementPropertiesMass]]":
    ...
    @property
    @exception_bridge
    def materials(self: "Self") -> "List[_2629.MaterialPropertiesWithSelection]":
    ...
    def other_element_properties(
        self: "Self",
    ) -> "List[_2603.ElementPropertiesWithSelection[_295.ElementPropertiesBase]]":
    ...
    def rigid_element_properties(
        self: "Self",
    ) -> "List[_2603.ElementPropertiesWithSelection[_299.ElementPropertiesRigid]]":
    ...
    def shell_element_properties(
        self: "Self",
    ) -> "List[_2603.ElementPropertiesWithSelection[_300.ElementPropertiesShell]]":
    ...
    def solid_element_properties(
        self: "Self",
    ) -> "List[_2603.ElementPropertiesWithSelection[_301.ElementPropertiesSolid]]":
    ...
    def spring_dashpot_element_properties(
        self: "Self",
    ) -> "List[_2603.ElementPropertiesWithSelection[_302.ElementPropertiesSpringDashpot]]":
