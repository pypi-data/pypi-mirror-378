...
from mastapy._private.system_model.fe import _2589, _2612, _2628, _2632
...
class _Cast_FELink:
    ...
    @property
    def single_node_fe_link(self: "CastSelf") -> "_2662.SingleNodeFELink":
        from mastapy._private.system_model.fe.links import _2662

        return self.__parent__._cast(_2662.SingleNodeFELink)
...
class FELink(_0.APIBase):
    ...
    @enforce_parameter_types
    def bearing_node_link_option(
        self: "Self", value: "_2589.BearingNodeOption"
    ) -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def link_node_source(self: "Self", value: "_2628.LinkNodeSource") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def node_selection_depth(
        self: "Self",
        value: "Union[_2632.NodeSelectionDepthOption, Tuple[_2632.NodeSelectionDepthOption, bool]]",
    ) -> None:
    ...
    def alignment_in_component_coordinate_system(
        self: "Self",
    ) -> "_2627.LinkComponentAxialPositionErrorReporter":
    ...
    @property
    @exception_bridge
    def component(self: "Self") -> "_2698.MountableComponent":
    ...
    @property
    @exception_bridge
    def socket(self: "Self") -> "_2522.Socket":
    ...
    @property
    @exception_bridge
    def support_material(self: "Self") -> "_359.Material":
    ...
    def nodes_grouped_by_angle(
        self: "Self",
    ) -> "OrderedDict[float, List[_2612.FESubstructureNode]]":
    ...
    @exception_bridge
    @enforce_parameter_types
    def add_or_replace_node(self: "Self", node: "_2612.FESubstructureNode") -> None:
