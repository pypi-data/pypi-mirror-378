...
class FESubstructureWithSelectionForHarmonicAnalysis(_2617.FESubstructureWithSelection):
    """FESubstructureWithSelectionForHarmonicAnalysis
    ...
    @property
    @exception_bridge
    def harmonic_draw_style(self: "Self") -> "_272.FEModelHarmonicAnalysisDrawStyle":
