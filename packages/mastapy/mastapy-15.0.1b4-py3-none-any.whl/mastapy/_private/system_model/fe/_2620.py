...
if TYPE_CHECKING:
    ...
    from mastapy._private.nodal_analysis.dev_tools_analyses import _264, _274
    from mastapy._private.system_model.fe import _2586, _2614
...
class FESubstructureWithSelectionForModalAnalysis(_2617.FESubstructureWithSelection):
    """FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    @exception_bridge
    def eigenvalue_options(self: "Self") -> "_264.EigenvalueOptions":
    ...
    @property
    @exception_bridge
    def modal_draw_style(self: "Self") -> "_274.FEModelModalAnalysisDrawStyle":
    ...
    def full_fe_mode_shapes_at_condensation_nodes(
        self: "Self",
    ) -> "List[_2614.FESubstructureNodeModeShapes]":
