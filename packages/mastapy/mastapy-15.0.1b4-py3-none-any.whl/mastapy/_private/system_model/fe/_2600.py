...
class ElectricMachineDataSet(_0.APIBase):
    ...
    @exception_bridge
    @enforce_parameter_types
    def node_for_first_tooth(self: "Self", value: "_2612.FESubstructureNode") -> None:
    ...
    @property
    @exception_bridge
    def torque_ripple_input_type(self: "Self") -> "_7853.TorqueRippleInputType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.static_loads._7853",
    ...
    def torque_ripple_input_type(
        self: "Self", value: "_7853.TorqueRippleInputType"
    ) -> None:
    ...
    def add_or_replace_excitation_data_with_amplitudes_phases_and_fe_node(
        ...
        fourier_series_measurement_type: "_7908.MeasurementType",
    ) -> None:
