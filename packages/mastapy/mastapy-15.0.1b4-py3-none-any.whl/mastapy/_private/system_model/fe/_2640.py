...
from mastapy._private.nodal_analysis.fe_export_utility import _246, _247
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2634, _2635
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def default_type_of_result_to_export(
        self: "Self", value: "_246.BoundaryConditionType"
    ) -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def fe_export_format(self: "Self", value: "_247.FEExportFormat") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    @exception_bridge
    def links(self: "Self") -> "List[_2634.PerLinkExportOptions]":
    ...
    @property
    @exception_bridge
    def nodes(self: "Self") -> "List[_2635.PerNodeExportOptions]":
