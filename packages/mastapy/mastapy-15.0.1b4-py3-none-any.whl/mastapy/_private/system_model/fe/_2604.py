...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.fe import _2602, _2631
...
class _Cast_FEEntityGroupWithSelection:
    ...
    def element_face_group_with_selection(
        self: "CastSelf",
    ) -> "_2602.ElementFaceGroupWithSelection":
        from mastapy._private.system_model.fe import _2602

        return self.__parent__._cast(_2602.ElementFaceGroupWithSelection)

    @property
    def node_group_with_selection(self: "CastSelf") -> "_2631.NodeGroupWithSelection":
        from mastapy._private.system_model.fe import _2631

        return self.__parent__._cast(_2631.NodeGroupWithSelection)
