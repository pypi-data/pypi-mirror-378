...
class DesignSettings(_0.APIBase, _1783.IHaveAllSettings):
    """DesignSettings
    ...
    @property
    @exception_bridge
    def bearing_settings(self: "Self") -> "_2089.BearingSettingsItem":
    ...
    @property
    @exception_bridge
    def materials_settings(self: "Self") -> "_363.MaterialsSettingsItem":
