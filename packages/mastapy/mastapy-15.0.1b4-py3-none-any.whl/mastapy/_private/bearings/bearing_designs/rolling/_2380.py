...
from mastapy._private.bearings import _2078, _2079, _2100, _2103
from mastapy._private.bearings.bearing_designs import _2346
from mastapy._private.bearings.bearing_designs.rolling import _2366, _2367, _2373, _2391
...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2077, _2080, _2085
...
class RollingBearing(_2346.DetailedBearing):
    """RollingBearing
    ...
    @exception_bridge
    @enforce_parameter_types
    def arrangement(self: "Self", value: "_2100.RollingBearingArrangement") -> None:
    ...
    @enforce_parameter_types
    def basic_dynamic_load_rating_calculation(
        self: "Self", value: "_2078.BasicDynamicLoadRatingCalculationMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @enforce_parameter_types
    def basic_static_load_rating_calculation(
        self: "Self", value: "_2079.BasicStaticLoadRatingCalculationMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    @exception_bridge
    def cage_bridge_shape(self: "Self") -> "_2362.CageBridgeShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_designs.rolling._2362", "CageBridgeShape"
        )(value)

    @cage_bridge_shape.setter
    @exception_bridge
    @enforce_parameter_types
    def cage_bridge_shape(self: "Self", value: "_2362.CageBridgeShape") -> None:
    ...
    @property
    @exception_bridge
    def cage_material(self: "Self") -> "_2080.BearingCageMaterial":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2080", "BearingCageMaterial"
        )(value)

    @cage_material.setter
    @exception_bridge
    @enforce_parameter_types
    def cage_material(self: "Self", value: "_2080.BearingCageMaterial") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def catalogue(self: "Self") -> "_2077.BearingCatalog":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2077", "BearingCatalog"
        )(value)
    ...
    def diameter_series(
        self: "Self",
        value: "Union[_2366.DiameterSeries, Tuple[_2366.DiameterSeries, bool]]",
    ) -> None:
    ...
    @enforce_parameter_types
    def fatigue_load_limit_calculation_method(
        self: "Self", value: "_2367.FatigueLoadLimitCalculationMethodEnum"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def height_series(
        self: "Self",
        value: "Union[_2373.HeightSeries, Tuple[_2373.HeightSeries, bool]]",
    ) -> None:
    ...
    @exception_bridge
    @enforce_parameter_types
    def inner_ring_type(self: "Self", value: "_2103.RollingBearingRaceType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @exception_bridge
    @enforce_parameter_types
    def outer_ring_type(self: "Self", value: "_2103.RollingBearingRaceType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = enum_with_selected_value.EnumWithSelectedValue_RollingBearingRaceType.implicit_type()
        value = conversion.mp_to_pn_enum(value, enclosed_type)
        value = wrapper_type[enclosed_type](value)
    ...
    @property
    @exception_bridge
    def sleeve_type(self: "Self") -> "_2384.SleeveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_designs.rolling._2384", "SleeveType"
        )(value)
    ...
    @property
    @exception_bridge
    def type_information(self: "Self") -> "_2361.BearingTypeExtraInformation":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_designs.rolling._2361",
    ...
    @enforce_parameter_types
    def width_series(
        self: "Self", value: "Union[_2391.WidthSeries, Tuple[_2391.WidthSeries, bool]]"
    ) -> None:
    ...
    @property
    @exception_bridge
    def element_material(self: "Self") -> "_333.BearingMaterial":
    ...
    @property
    @exception_bridge
    def geometric_constants(self: "Self") -> "_2370.GeometricConstants":
    ...
    @property
    @exception_bridge
    def iso153122018(self: "Self") -> "_2189.ISO153122018Results":
    ...
    @property
    @exception_bridge
    def inner_ring_material(self: "Self") -> "_333.BearingMaterial":
        """mastapy.materials.BearingMaterial
    ...
    @property
    @exception_bridge
    def outer_ring_material(self: "Self") -> "_333.BearingMaterial":
        """mastapy.materials.BearingMaterial
    ...
    @property
    @exception_bridge
    def protection(self: "Self") -> "_2358.BearingProtection":
    ...
    def skf_seal_frictional_moment_constants(
        self: "Self",
    ) -> "_2383.SKFSealFrictionalMomentConstants":
    ...
    @property
    @exception_bridge
    def elements(self: "Self") -> "List[_2381.RollingBearingElement]":
