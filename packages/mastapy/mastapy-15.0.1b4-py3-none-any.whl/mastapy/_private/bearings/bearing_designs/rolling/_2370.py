...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.rolling import _2371, _2372
...
class GeometricConstants(_0.APIBase):
    ...
    def geometric_constants_for_rolling_frictional_moments(
        self: "Self",
    ) -> "_2371.GeometricConstantsForRollingFrictionalMoments":
    ...
    def geometric_constants_for_sliding_frictional_moments(
        self: "Self",
    ) -> "_2372.GeometricConstantsForSlidingFrictionalMoments":
