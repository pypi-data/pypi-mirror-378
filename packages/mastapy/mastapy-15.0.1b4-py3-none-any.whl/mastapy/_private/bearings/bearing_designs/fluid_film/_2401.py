...
from mastapy._private.bearings.bearing_designs.fluid_film import _2408
...
class _Cast_CylindricalHousingJournalBearing:
    ...
    @property
    def plain_journal_housing(self: "CastSelf") -> "_2408.PlainJournalHousing":
        return self.__parent__._cast(_2408.PlainJournalHousing)
...
class CylindricalHousingJournalBearing(_2408.PlainJournalHousing):
    """CylindricalHousingJournalBearing
