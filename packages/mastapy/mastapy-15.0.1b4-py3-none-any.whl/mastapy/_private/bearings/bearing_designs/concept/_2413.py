...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_designs.concept import _2412
...
class ConceptAxialClearanceBearing(_2414.ConceptClearanceBearing):
    """ConceptAxialClearanceBearing
    ...
    @property
    @exception_bridge
    def node_position(self: "Self") -> "_2412.BearingNodePosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.bearing_designs.concept._2412",
            "BearingNodePosition",
        )(value)
    ...
    @exception_bridge
    @enforce_parameter_types
    def node_position(self: "Self", value: "_2412.BearingNodePosition") -> None:
