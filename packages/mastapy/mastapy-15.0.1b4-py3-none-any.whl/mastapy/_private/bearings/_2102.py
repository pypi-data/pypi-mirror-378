...
from mastapy._private.utility.databases import _2030
...
class _Cast_RollingBearingKey:
    ...
    @property
    def database_key(self: "CastSelf") -> "_2030.DatabaseKey":
        return self.__parent__._cast(_2030.DatabaseKey)
...
class RollingBearingKey(_2030.DatabaseKey):
    """RollingBearingKey
