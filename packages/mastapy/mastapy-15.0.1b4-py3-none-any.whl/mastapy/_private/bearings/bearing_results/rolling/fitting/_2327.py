...
class _Cast_RingFittingThermalResults:
    ...
    def inner_ring_fitting_thermal_results(
        ...
        from mastapy._private.bearings.bearing_results.rolling.fitting import _2324

        return self.__parent__._cast(_2324.InnerRingFittingThermalResults)

    @property
    def outer_ring_fitting_thermal_results(
        self: "CastSelf",
    ) -> "_2326.OuterRingFittingThermalResults":
        from mastapy._private.bearings.bearing_results.rolling.fitting import _2326

        return self.__parent__._cast(_2326.OuterRingFittingThermalResults)
...
class RingFittingThermalResults(_0.APIBase):
    ...
    @property
    @exception_bridge
    def interference_values(self: "Self") -> "List[_2325.InterferenceComponents]":
