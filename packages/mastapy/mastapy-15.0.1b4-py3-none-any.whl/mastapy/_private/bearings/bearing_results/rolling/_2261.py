...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2242, _2246
...
class LoadedTaperRollerBearingResults(_2237.LoadedNonBarrelRollerBearingResults):
    """LoadedTaperRollerBearingResults
