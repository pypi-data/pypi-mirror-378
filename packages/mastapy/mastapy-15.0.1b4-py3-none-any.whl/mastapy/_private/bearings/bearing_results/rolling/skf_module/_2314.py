...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling.skf_module import _2306
...
class Viscosities(_2310.SKFCalculationResult):
    """Viscosities
    ...
    @property
    @exception_bridge
    def operating_viscosity(self: "Self") -> "_2306.OperatingViscosity":
