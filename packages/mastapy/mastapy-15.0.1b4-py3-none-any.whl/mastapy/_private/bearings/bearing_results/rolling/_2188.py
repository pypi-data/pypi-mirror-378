...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2104
...
class ISO14179SettingsPerBearingType(
    _1784.IndependentReportablePropertiesBase["ISO14179SettingsPerBearingType"]
):
    """ISO14179SettingsPerBearingType
    ...
    @property
    @exception_bridge
    def rolling_bearing_type(self: "Self") -> "_2104.RollingBearingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2104", "RollingBearingType"
        )(value)

    @property
    @exception_bridge
    def iso14179_settings(self: "Self") -> "_2186.ISO14179Settings":
