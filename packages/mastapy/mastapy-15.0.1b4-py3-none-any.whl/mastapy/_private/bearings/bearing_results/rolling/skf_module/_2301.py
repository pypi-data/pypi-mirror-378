...
class GreaseLifeAndRelubricationInterval(_2310.SKFCalculationResult):
    """GreaseLifeAndRelubricationInterval
    ...
    @property
    @exception_bridge
    def grease(self: "Self") -> "_2300.Grease":
    ...
    @property
    @exception_bridge
    def grease_quantity(self: "Self") -> "_2302.GreaseQuantity":
    ...
    @property
    @exception_bridge
    def initial_fill(self: "Self") -> "_2303.InitialFill":
