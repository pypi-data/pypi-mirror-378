...
class _Cast_ThreePointContactInternalClearance:
    ...
    @property
    def internal_clearance(self: "CastSelf") -> "_2185.InternalClearance":
        return self.__parent__._cast(_2185.InternalClearance)
...
class ThreePointContactInternalClearance(_2185.InternalClearance):
    """ThreePointContactInternalClearance
