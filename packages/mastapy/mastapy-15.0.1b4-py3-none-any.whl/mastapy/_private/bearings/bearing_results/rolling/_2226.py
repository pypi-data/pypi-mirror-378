...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.bearing_results.rolling import _2225, _2247
...
class LoadedDeepGrooveBallBearingRow(_2216.LoadedBallBearingRow):
    """LoadedDeepGrooveBallBearingRow
    ...
    @property
    @exception_bridge
    def loaded_bearing(self: "Self") -> "_2225.LoadedDeepGrooveBallBearingResults":
