...
class LoadedBallBearingElement(_2227.LoadedElement):
    """LoadedBallBearingElement
    ...
    @property
    @exception_bridge
    def contact_patch_sliding_speed_inner(self: "Self") -> "_2043.PlaneScalarFieldData":
        """mastapy.utility.vectors.PlaneScalarFieldData
    ...
    @property
    @exception_bridge
    def contact_patch_sliding_speed_outer(self: "Self") -> "_2043.PlaneScalarFieldData":
        """mastapy.utility.vectors.PlaneScalarFieldData
    ...
    def inner_race_contact_geometries(
        self: "Self",
    ) -> "List[_2179.BallBearingRaceContactGeometry]":
