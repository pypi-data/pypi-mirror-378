...
class _Cast_LoadedPlainOilFedJournalBearingRow:
    ...
    def loaded_plain_journal_bearing_row(
        self: "CastSelf",
    ) -> "_2338.LoadedPlainJournalBearingRow":
        return self.__parent__._cast(_2338.LoadedPlainJournalBearingRow)
...
class LoadedPlainOilFedJournalBearingRow(_2338.LoadedPlainJournalBearingRow):
    """LoadedPlainOilFedJournalBearingRow
