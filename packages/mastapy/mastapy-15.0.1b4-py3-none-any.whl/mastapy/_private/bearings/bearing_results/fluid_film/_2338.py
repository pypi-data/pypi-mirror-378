...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings import _2086
    from mastapy._private.bearings.bearing_results.fluid_film import _2340
...
class _Cast_LoadedPlainJournalBearingRow:
    ...
    def loaded_plain_oil_fed_journal_bearing_row(
        self: "CastSelf",
    ) -> "_2340.LoadedPlainOilFedJournalBearingRow":
        from mastapy._private.bearings.bearing_results.fluid_film import _2340

        return self.__parent__._cast(_2340.LoadedPlainOilFedJournalBearingRow)
...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    @property
    @exception_bridge
    def row(self: "Self") -> "_2086.BearingRow":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings._2086", "BearingRow"
        )(value)
