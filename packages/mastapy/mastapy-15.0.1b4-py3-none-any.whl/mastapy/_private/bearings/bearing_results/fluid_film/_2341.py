...
class _Cast_LoadedTiltingJournalPad:
    ...
    def loaded_fluid_film_bearing_pad(
        self: "CastSelf",
    ) -> "_2333.LoadedFluidFilmBearingPad":
        return self.__parent__._cast(_2333.LoadedFluidFilmBearingPad)
...
class LoadedTiltingJournalPad(_2333.LoadedFluidFilmBearingPad):
    """LoadedTiltingJournalPad
