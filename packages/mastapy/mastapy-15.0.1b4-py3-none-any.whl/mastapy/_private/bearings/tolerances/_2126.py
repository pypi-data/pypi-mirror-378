...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.tolerances import _2122, _2127, _2133
...
class RoundnessSpecification(
    _1784.IndependentReportablePropertiesBase["RoundnessSpecification"]
):
    """RoundnessSpecification
    ...
    @property
    @exception_bridge
    def specification_type(self: "Self") -> "_2127.RoundnessSpecificationType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.tolerances._2127", "RoundnessSpecificationType"
        )(value)
    ...
    def specification_type(
        self: "Self", value: "_2127.RoundnessSpecificationType"
    ) -> None:
    ...
    @property
    @exception_bridge
    def type_of_fit(self: "Self") -> "_2133.TypeOfFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.tolerances._2133", "TypeOfFit"
        )(value)

    @type_of_fit.setter
    @exception_bridge
    @enforce_parameter_types
    def type_of_fit(self: "Self", value: "_2133.TypeOfFit") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def user_specified_deviation(self: "Self") -> "_1723.Vector2DListAccessor":
    ...
    @property
    @exception_bridge
    def roundness_distribution(self: "Self") -> "List[_2122.RaceRoundnessAtAngle]":
