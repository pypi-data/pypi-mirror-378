...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.roller_bearing_profiles import _2135, _2137, _2150
...
class RollerBearingUserSpecifiedProfile(_2146.RollerBearingProfile):
    """RollerBearingUserSpecifiedProfile
    ...
    @property
    @exception_bridge
    def data_to_use(self: "Self") -> "_2135.ProfileDataToUse":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.roller_bearing_profiles._2135",
            "ProfileDataToUse",
        )(value)
    ...
    def data_to_use(self: "Self", value: "_2135.ProfileDataToUse") -> None:
    ...
    @property
    @exception_bridge
    def profile_to_fit(self: "Self") -> "_2137.ProfileToFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.bearings.roller_bearing_profiles._2137", "ProfileToFit"
        )(value)

    @profile_to_fit.setter
    @exception_bridge
    @enforce_parameter_types
    def profile_to_fit(self: "Self", value: "_2137.ProfileToFit") -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    @exception_bridge
    def points(self: "Self") -> "List[_2150.UserSpecifiedProfilePoint]":
