...
if TYPE_CHECKING:
    ...
    from mastapy._private.bearings.roller_bearing_profiles import _2151
...
class _Cast_RollerRaceProfilePoint:
    ...
    def user_specified_roller_race_profile_point(
        self: "CastSelf",
    ) -> "_2151.UserSpecifiedRollerRaceProfilePoint":
        from mastapy._private.bearings.roller_bearing_profiles import _2151

        return self.__parent__._cast(_2151.UserSpecifiedRollerRaceProfilePoint)
