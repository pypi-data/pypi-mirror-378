...
class CustomReportChartItem(_1973.CustomReportPropertyItem):
    """CustomReportChartItem
    ...
    @property
    @exception_bridge
    def point_shape(self: "Self") -> "_1949.SMTChartPointShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.report._1949", "SMTChartPointShape"
        )(value)

    @point_shape.setter
    @exception_bridge
    @enforce_parameter_types
    def point_shape(self: "Self", value: "_1949.SMTChartPointShape") -> None:
