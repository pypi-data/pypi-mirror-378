...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.cad_export import _2041
...
class CustomReportCadDrawing(_1971.CustomReportNameableItem):
    """CustomReportCadDrawing
    ...
    @property
    @exception_bridge
    def stock_drawing(self: "Self") -> "_2041.StockDrawings":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.cad_export._2041", "StockDrawings"
        )(value)

    @stock_drawing.setter
    @exception_bridge
    @enforce_parameter_types
    def stock_drawing(self: "Self", value: "_2041.StockDrawings") -> None:
