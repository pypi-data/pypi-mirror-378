...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.report import _1973, _1985
...
class UserTextRow(_1978.CustomRow):
    """UserTextRow
    ...
    @property
    @exception_bridge
    def heading_size(self: "Self") -> "_1985.HeadingSize":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.utility.report._1985", "HeadingSize"
        )(value)

    @heading_size.setter
    @exception_bridge
    @enforce_parameter_types
    def heading_size(self: "Self", value: "_1985.HeadingSize") -> None:
