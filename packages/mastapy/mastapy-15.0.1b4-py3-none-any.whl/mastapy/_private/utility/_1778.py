...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility import _1777, _1790
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    @exception_bridge
    def current_culture(self: "Self") -> "_1790.NumberFormatInfoSummary":
    ...
    @property
    @exception_bridge
    def dispatchers(self: "Self") -> "List[_1777.DispatcherHelper]":
