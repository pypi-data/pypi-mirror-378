...
from mastapy._private.utility.modal_analysis.gears import _2004
...
class _Cast_GearMeshForTE:
    ...
    @property
    def order_for_te(self: "CastSelf") -> "_2004.OrderForTE":
        return self.__parent__._cast(_2004.OrderForTE)
...
class GearMeshForTE(_2004.OrderForTE):
    """GearMeshForTE
    ...
    @property
    @exception_bridge
    def attached_gears(self: "Self") -> "List[_2000.GearOrderForTE]":
