...
class LengthShort(_1802.MeasurementBase):
    """LengthShort
    ...
    @property
    @exception_bridge
    def inches(self: "Self") -> "_1807.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    @exception_bridge
    def metres(self: "Self") -> "_1807.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    @exception_bridge
    def micrometres(self: "Self") -> "_1807.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    @exception_bridge
    def millimetres(self: "Self") -> "_1807.Unit":
        """mastapy.utility.units_and_measurements.Unit
    ...
    @property
    @exception_bridge
    def thousandths_of_an_inch(self: "Self") -> "_1807.Unit":
        """mastapy.utility.units_and_measurements.Unit
