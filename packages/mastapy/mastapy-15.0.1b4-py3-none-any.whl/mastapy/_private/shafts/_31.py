...
class _Cast_ShaftProfileFromImport:
    ...
    @property
    def profile_from_import(self: "CastSelf") -> "_244.ProfileFromImport":
        return self.__parent__._cast(_244.ProfileFromImport)
...
class ShaftProfileFromImport(_244.ProfileFromImport):
    """ShaftProfileFromImport
