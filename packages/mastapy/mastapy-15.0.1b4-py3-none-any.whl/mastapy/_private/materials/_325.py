...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    @exception_bridge
    def input_type(self: "Self") -> "_326.AcousticRadiationEfficiencyInputType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.materials._326", "AcousticRadiationEfficiencyInputType"
        )(value)
    ...
    def input_type(
        self: "Self", value: "_326.AcousticRadiationEfficiencyInputType"
    ) -> None:
    ...
    @property
    @exception_bridge
    def radiation_efficiency_curve(self: "Self") -> "_1723.Vector2DListAccessor":
