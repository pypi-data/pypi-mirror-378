...
T = TypeVar("T", bound="_1802.MeasurementBase")
...
class TemperatureDependentProperty(
    _1784.IndependentReportablePropertiesBase["TemperatureDependentProperty"[T]]
):
    """TemperatureDependentProperty
    ...
    @exception_bridge
    @enforce_parameter_types
    def extrapolation(self: "Self", value: "_1695.ExtrapolationOptions") -> None:
    ...
    @property
    @exception_bridge
    def vs_temperature(self: "Self") -> "_1723.Vector2DListAccessor":
    ...
    @exception_bridge
    @enforce_parameter_types
    def vs_temperature(self: "Self", value: "_1723.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "VsTemperature", value.wrapped)

    @property
    @exception_bridge
    def vs_temperature_plot(self: "Self") -> "_2075.TwoDChartDefinition":
