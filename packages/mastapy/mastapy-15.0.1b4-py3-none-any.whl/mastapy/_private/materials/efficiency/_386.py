...
from mastapy._private.materials.efficiency import _393
...
class _Cast_IndependentResistiveTorque:
    ...
    @property
    def resistive_torque(self: "CastSelf") -> "_393.ResistiveTorque":
        return self.__parent__._cast(_393.ResistiveTorque)
...
class IndependentResistiveTorque(_393.ResistiveTorque):
    """IndependentResistiveTorque
