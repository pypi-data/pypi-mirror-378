...
class Fluid(_2033.NamedDatabaseItem):
    """Fluid
    ...
    def density_vs_temperature(
        self: "Self",
    ) -> "_377.TemperatureDependentProperty[_1829.Density]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1829.Density](temp)

    @property
    @exception_bridge
    def heat_conductivity_vs_temperature(
        self: "Self",
    ) -> "_377.TemperatureDependentProperty[_1850.HeatConductivity]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1850.HeatConductivity](
            temp
        )
    ...
    def kinematic_viscosity_vs_temperature(
        self: "Self",
    ) -> "_377.TemperatureDependentProperty[_1861.KinematicViscosity]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1861.KinematicViscosity](
            temp
        )
    ...
    def specific_heat_capacity_vs_temperature(
        self: "Self",
    ) -> "_377.TemperatureDependentProperty[_1910.SpecificHeat]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1910.SpecificHeat](temp)
