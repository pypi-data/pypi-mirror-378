...
if TYPE_CHECKING:
    ...
    from mastapy._private.licensing import _7920, _7921, _7922
...
class LicenceServer:
    ...
    @exception_bridge
    @enforce_parameter_types
    def update_server_settings(server_details: "_7920.LicenceServerDetails") -> None:
    ...
    @staticmethod
    @exception_bridge
    def get_server_settings() -> "_7920.LicenceServerDetails":
    ...
    @staticmethod
    @exception_bridge
    def get_licensed_module_details() -> "Iterable[_7921.ModuleDetails]":
    ...
    @staticmethod
    @exception_bridge
    def get_available_module_details() -> "Iterable[_7921.ModuleDetails]":
        """Iterable[mastapy.licensing.ModuleDetails]"""
        return conversion.pn_to_mp_objects_in_iterable(
    ...
    @staticmethod
    @exception_bridge
    def get_requested_module_statuses() -> "Iterable[_7922.ModuleLicenceStatus]":
