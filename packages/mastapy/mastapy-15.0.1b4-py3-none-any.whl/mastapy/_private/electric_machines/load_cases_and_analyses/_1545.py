...
class ElectricMachineMechanicalLoadCase(_1543.ElectricMachineLoadCaseBase):
    """ElectricMachineMechanicalLoadCase
    ...
    @property
    @exception_bridge
    def solver_type(self: "Self") -> "_258.MechanicalSolverType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.nodal_analysis.elmer._258", "MechanicalSolverType"
        )(value)

    @solver_type.setter
    @exception_bridge
    @enforce_parameter_types
    def solver_type(self: "Self", value: "_258.MechanicalSolverType") -> None:
