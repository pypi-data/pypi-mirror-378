...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines import _1371, _1416
...
class _Cast_MagnetDesign:
    ...
    @property
    def cad_magnets_for_layer(self: "CastSelf") -> "_1371.CADMagnetsForLayer":
        from mastapy._private.electric_machines import _1371

        return self.__parent__._cast(_1371.CADMagnetsForLayer)

    @property
    def magnet_for_layer(self: "CastSelf") -> "_1416.MagnetForLayer":
        from mastapy._private.electric_machines import _1416

        return self.__parent__._cast(_1416.MagnetForLayer)
