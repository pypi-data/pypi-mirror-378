...
async def test_whisper_cpp() -> None:
    # whisper.cpp works in 16kHz, 1 channel natively

    for filename in [
        "turn_on_the_living_room_lamp-44100Hz-2ch-s16le.wav",
        "turn_on_the_living_room_lamp-44100Hz-1ch-s16le.wav",
        "turn_on_the_living_room_lamp-16000Hz-2ch-s16le.wav",
        "turn_on_the_living_room_lamp-16000Hz-1ch-s16le.wav",
    ]:
        ...
        # Test known WAV
        with wave.open(str(_DIR / filename), "rb") as example_wav:
