from tau_trait.types import Action, Task
...
TASKS = [
    ...
    Task(
        ...
        actions=[
            Action(name="get_reservation_details", kwargs={"reservation_id": "ZL9P2X"}),
            Action(
                name="update_reservation_flights",
                kwargs={
                    "reservation_id": "ZL9P2X",
                    "flights": [{"flight_number": "HAT234", "date": "2024-06-12"}],
                    "cabin": "economy",
                    "payment_id": "credit_card_9182334",
                },
            ),
            Action(name="cancel_reservation", kwargs={"reservation_id": "ZL9P2X"}),
        ],
        outputs=[],
    ),
    Task(
        ...
        actions=[
            Action(name="get_reservation_details", kwargs={"reservation_id": "8NDQ3A"}),
            Action(
                name="update_reservation_baggage",
                kwargs={"reservation_id": "8NDQ3A", "extra_suitcases": 2},
            ),
            Action(name="calculate", kwargs={"expression": "2 + 2"}),  # example: gold member default + added
        ],
        outputs=["4"],
    ),
    Task(
        ...
        actions=[
            Action(name="get_reservation_details", kwargs={"reservation_id": "5TUK9C"}),
            Action(
                name="update_reservation_flights",
                kwargs={
                    "reservation_id": "5TUK9C",
                    "cabin": "business",
                    "flights": [{"flight_number": "HAT501", "date": "2024-07-18"}],
    ...
    Task(
        ...
        actions=[
            Action(name="get_user_details", kwargs={"user_id": "elena_martinez_8032"}),
            Action(name="get_reservation_details", kwargs={"reservation_id": "VZL7H2"}),
            Action(
                name="send_certificate",
                kwargs={"user_id": "elena_martinez_8032", "amount": 100},
            ),
        ],
        outputs=[],
    ),
    Task(
        ...
        actions=[
            Action(name="get_user_details", kwargs={"user_id": "max_chen_6115"}),
            Action(name="get_reservation_details", kwargs={"reservation_id": "TT7Q29"}),
            Action(name="cancel_reservation", kwargs={"reservation_id": "TT7Q29"}),
            Action(name="get_reservation_details", kwargs={"reservation_id": "YM22QS"}),
            Action(name="cancel_reservation", kwargs={"reservation_id": "YM22QS"}),
        ],
        outputs=[],
    ),
    Task(
        ...
        actions=[
            Action(name="get_reservation_details", kwargs={"reservation_id": "J4X2QW"}),
            Action(
                name="update_reservation_passengers",
                kwargs={
                    "reservation_id": "J4X2QW",
                    "passengers": [
                        {"first_name": "Sofia", "last_name": "Davis", "dob": "1993-07-16"}
                    ],
                },
            ),
        ],
    ...
    Task(
        ...
        actions=[
            Action(name="get_user_details", kwargs={"user_id": "isabella_singh_9154"}),
            Action(name="get_reservation_details", kwargs={"reservation_id": "9QT7X1"}),
            Action(name="get_reservation_details", kwargs={"reservation_id": "3PL5V8"}),
            Action(name="calculate", kwargs={"expression": "240 + 315"}),
        ],
        outputs=["555"],
    ),
    Task(
        ...
        instruction="".join(
            (
                "You are Carlos Rodriguez (user id is carlos_rodriguez_7891).",
                "You are traveling with your family from Miami to Los Angeles on June 15th, 2024 for a family reunion.",
                "You want to book a round-trip flight returning on June 22nd, 2024.",
                "You need 4 passengers total (yourself, your wife Maria, and two children - Sofia age 8 and Diego age 12).",
                "Your birthday is June 10th, 1980, your wife's birthday is August 25th, 1982, Sofia's birthday is January 10th, 2016, and Diego's birthday is May 18th, 2012.",
                "You prefer basic economy class but are willing to upgrade to economy if the price difference is reasonable (under $200 per person).",
                "You want to use your gift card first, then pay the rest with your credit card ending in 3456.",
                "You need 2 checked bags and want travel insurance for the whole family.",
                "You are patient but want to make sure you get the best deal possible.",
            )
        ),
        actions=[
            Action(
                name="search_direct_flight",
                kwargs={"origin": "MIA", "destination": "LAX", "date": "2024-06-15"},
            ),
            Action(
                name="search_direct_flight", 
                kwargs={"origin": "LAX", "destination": "MIA", "date": "2024-06-22"},
            ),
            Action(
                name="book_reservation",
                kwargs={
                    ...
                    "cabin": "economy",
                    "flights": [
                        {"flight_number": "HAT185", "date": "2024-06-15"},
                        {"flight_number": "HAT092", "date": "2024-06-22"},
                    ],
                    "passengers": [
                        {"first_name": "Carlos", "last_name": "Rodriguez", "dob": "1985-03-12"},
                        {"first_name": "Maria", "last_name": "Rodriguez", "dob": "1987-08-25"},
                        {"first_name": "Sofia", "last_name": "Rodriguez", "dob": "2016-01-10"},
                        {"first_name": "Diego", "last_name": "Rodriguez", "dob": "2012-05-18"},
                    ],
                    "payment_methods": [
                        {"payment_id": "gift_card_9847362", "amount": 500},
                        {"payment_id": "credit_card_8293456", "amount": 1200},
                    ],
                    "total_baggages": 2,
                    "nonfree_baggages": 2,
                    "insurance": "yes",
    ...
    # Task(
    #     annotator="4", 
    #     user_id="jennifer_wong_4523",
    #     instruction="You are Jennifer Wong (user id is jennifer_wong_4523). You are a business traveler who needs to change your existing reservation (ID: BW8X7K) from Boston to Seattle. Your current flight is scheduled for May 30th, but you need to move it to May 28th due to an important client meeting that was moved up. You want to upgrade from economy to business class since it's a work trip and your company will reimburse you. You also want to add 1 checked bag for your presentation materials. You are professional but somewhat urgent since the meeting is critical for your company. You prefer to pay with your corporate credit card ending in 9876. If the change fee is over $300, you need to get approval from your manager first.",
    #     actions=[
    #         Action(name="get_reservation_details", kwargs={"reservation_id": "BW8X7K"}),
    #         Action(
    #             name="search_direct_flight",
    #             kwargs={"origin": "BOS", "destination": "SEA", "date": "2024-05-28"},
    #         ),
    #         Action(
    #             name="update_reservation_flights",
    #             kwargs={
    #                 "reservation_id": "BW8X7K",
    #                 "cabin": "business",
    #                 "flights": [
    #                     {"flight_number": "HAT156", "date": "2024-05-28"},
    #                 ],
    #                 "payment_id": "credit_card_7439876",
    #             },
    #         ),
    #         Action(
    #             name="update_reservation_baggages",
        ...
        actions=[
            Action(
                ...
                kwargs={
                    ...
                    "passengers": [
                        {"first_name": "Mei", "last_name": "Hernandez", "dob": "1981-01-11"}
                    ],
                    "payment_methods": [
                        {"payment_id": "certificate_7502997", "amount": 137},
                    ],
                    "total_baggages": 2,
                    "nonfree_baggages": 0,
                    "insurance": "no",
    ...
    actions=[
        Action(
            ...
            kwargs={
                ...
                "cabin": "business",
                "flights": [
                    {"flight_number": "HAT005", "date": "2024-05-22"},  # LAS to ATL, departs 1:00pm # 267
                    {"flight_number": "HAT004", "date": "2024-05-24"},  # ATL to DFW, departs 2:00pm  # 450
                    {"flight_number": "HAT008", "date": "2024-05-28"},  # MIA to LAX, departs 11:00am # 417
                ],
                "passengers": [
                    {"first_name": "Liam", "last_name": "Santos", "dob": "1998-03-11"},
                    {"first_name": "Omar", "last_name": "Davis", "dob": "1991-03-04"}
                ],
                "payment_methods": [
                    {"payment_id": "certificate_1680540", "amount": 500},
                    {"payment_id": "credit_card_1835044", "amount": 1828},  # $2,328 total - $500 certificate = $1,828
                ],
                "total_baggages": 4,  # 2 checked bags per passenger
                "nonfree_baggages": 0, 
                "insurance": "yes",
            },
        )
