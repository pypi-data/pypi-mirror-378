...
class TestCLIIntegration:
    ...
    def test_full_account_workflow(self, runner, mock_boto3_session):
        ...
        with patch("ai_org.core.aws_client.boto3.Session") as mock_session:
            ...
            mock_boto3_session["orgs"].create_account.return_value = {
                "CreateAccountStatus": {
                    "Id": "car-example456",
            ...
            mock_boto3_session["orgs"].describe_account.return_value = {
                "Account": {
                    "Id": "456789012345",
    ...
    def test_sso_and_account_integration(self, runner, mock_boto3_session):
        ...
        with patch("ai_org.core.aws_client.boto3.Session") as mock_session:
            ...
            mock_boto3_session["sso"].create_account_assignment.return_value = {
...
""")
            ...
            mock_boto3_session["cf"].list_stack_instances.return_value = {
                "Summaries": [
                    {
