...
EPISODIC_EDGE_SAVE = """
    ...
    SET e = {uuid: $uuid, group_id: $group_id, agent_id: $agent_id, created_at: $created_at}
...
EPISODIC_EDGE_SAVE_BULK = """
    ...
    SET e = {uuid: edge.uuid, group_id: edge.group_id, agent_id: edge.agent_id, created_at: edge.created_at}
    RETURN e.uuid AS uuid
"""
...
def get_entity_edge_save_bulk_query(provider: GraphProvider) -> str:
    if provider == GraphProvider.FALKORDB:
        return """
            ...
            SET r = {uuid: edge.uuid, name: edge.name, group_id: edge.group_id, agent_id: edge.agent_id, fact: edge.fact, episodes: edge.episodes,
