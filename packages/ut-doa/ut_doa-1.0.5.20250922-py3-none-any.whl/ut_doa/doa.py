...
class DoA:
    ...
    @staticmethod
    def union_distinct_set_by_keys(doa: TyDoA, keys: TnKeys) -> TyArr:
        _aoa: TyAoA = Dic.sh_values_by_keys(doa, keys)
        _arr: TyArr = AoA.union_distinct_set(_aoa)
        return _arr

    @staticmethod
    def union_distinct_set(doa: TyDoA) -> TyArr:
        _aoa: TyAoA = list(doa.values())
        _arr: TyArr = AoA.union_distinct_set(_aoa)
        return _arr
