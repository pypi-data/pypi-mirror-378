...
from hummingbot.core.data_type.trade_fee import DeductedFromReturnsTradeFee,AddedToCostTradeFee, TokenAmount, TradeFeeBase
...
class VindaxExchange(ExchangePyBase):
    ...
    async def _place_order(self,
        ...
        try:
            ...
            # self.logger().info(f"Order placement response: {order_result}")
    ...
    async def _user_stream_event_listener(self):
        ...
        while True:
            try:
                ...
                # TODO: parse và xử lý event_message (update balance, fill, v.v.)
            except Exception as e:
    ...
    async def _request_order_status(self, tracked_order: InFlightOrder) -> OrderUpdate:
        ...
        self.logger().info("Resulf _request_order_status updated_order_data: {updated_order_data} of trading_pair: {trading_pair}, new_state: {new_state} ")
        order_update = OrderUpdate(
            client_order_id=tracked_order.client_order_id,
