"""https://www.zabbix.com/documentation/7.2/en/manual/api/reference/userdirectory/object"""
...
class UserDirectorySAMLEncryptNameId(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/userdirectory/object#user-directory
...
class UserDirectoryMediaTypeMappingsActive(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/userdirectory/object#media-type-mappings
