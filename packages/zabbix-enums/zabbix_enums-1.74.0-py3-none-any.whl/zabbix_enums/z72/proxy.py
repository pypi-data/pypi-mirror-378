"""https://www.zabbix.com/documentation/7.2/en/manual/api/reference/proxy/object"""
from zabbix_enums import _ZabbixEnum


class ProxyOperatingMode(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/proxy/object#proxy
...
class ProxyState(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/proxy/object#proxy-interface
