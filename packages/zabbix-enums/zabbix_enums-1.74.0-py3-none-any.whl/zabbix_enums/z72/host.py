"""https://www.zabbix.com/documentation/7.2/en/manual/api/reference/host/object"""
from zabbix_enums import _ZabbixEnum


class HostFlag(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/host/object#host
...
class HostInventoryProperty(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/host/object#host-inventory
...
class HostHostTagAutomatic(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/host/object#host-tag
