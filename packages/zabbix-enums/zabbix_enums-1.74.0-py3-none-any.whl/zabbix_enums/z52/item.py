"""https://www.zabbix.com/documentation/5.2/en/manual/api/reference/item/object"""
from zabbix_enums import _ZabbixEnum


class ItemType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/item/object#item
...
class ItemPreprocessingType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/item/object#item-preprocessing
