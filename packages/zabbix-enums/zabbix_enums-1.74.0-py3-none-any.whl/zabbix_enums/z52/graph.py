"""https://www.zabbix.com/documentation/5.2/en/manual/api/reference/graph/object"""
from zabbix_enums import _ZabbixEnum


class GraphFlag(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/graph/object#graph
