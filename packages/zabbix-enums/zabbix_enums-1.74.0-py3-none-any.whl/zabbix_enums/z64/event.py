"""https://www.zabbix.com/documentation/6.4/en/manual/api/reference/event/object"""
from zabbix_enums import _ZabbixEnum


class EventSource(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/event/object#event
