"""https://www.zabbix.com/documentation/6.4/en/manual/api/reference/action/object"""
from zabbix_enums import _ZabbixEnum


class ActionStatus(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/action/object#action
...
class ActionPauseSymptoms(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/action/object#action
...
class ActionOperationType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/action/object#action-operation
...
class ActionOperationMessageDefault(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/action/object#action-operation-message
...
class ActionOperationConditionType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/action/object#action-operation-condition
...
class ActionRecoveryOperationTypeTrigger(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/action/object#action-recovery-operation
...
class ActionUpdateOperationTypeTrigger(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/action/object#action-update-operation
...
class ActionFilterEvalType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/action/object#action-filter
...
class ActionFilterCondidtionTypeTrigger(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/action/object#action-filter-condition
