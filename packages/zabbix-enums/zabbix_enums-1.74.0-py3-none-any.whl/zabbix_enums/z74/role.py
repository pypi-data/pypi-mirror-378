"""https://www.zabbix.com/documentation/7.4/en/manual/api/reference/role/object"""
from zabbix_enums import _ZabbixEnum


class RoleType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/role/object#role
...
class RoleRulesUIDefaultAccess(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/role/object#role-rules
...
class UIElementStatus(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/role/object#ui-element
...
class ModuleStatus(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/role/object#module
...
class ActionStatus(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/role/object#action
