"""https://www.zabbix.com/documentation/7.4/en/manual/api/reference/mediatype/object"""
from zabbix_enums import _ZabbixEnum


class MediaTypeType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/mediatype/object#media-type
...
class MediaTypeTokenStatus(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/mediatype/object#media-type

    Bit mask on tokens' status.
    """
    BOTH_TOKENS_INVALID = 0
...
class MessageTemplateEventSource(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/mediatype/object#message-template
