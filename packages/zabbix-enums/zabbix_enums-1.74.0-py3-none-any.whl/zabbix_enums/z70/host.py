...
class HostInventoryProperty(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.0/en/manual/api/reference/host/object#host-inventory
...
class HostHostTagAutomatic(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.0/en/manual/api/reference/host/object#host-tag
