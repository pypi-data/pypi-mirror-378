"""https://www.zabbix.com/documentation/7.0/en/manual/api/reference/service/object"""
from zabbix_enums import _ZabbixEnum


class ServiceAlgorithm(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.0/en/manual/api/reference/service/object#service
...
class StatusRuleType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.0/en/manual/api/reference/service/object#status-rule
...
class ProblemTagOperator(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.0/en/manual/api/reference/service/object#problem-tag
