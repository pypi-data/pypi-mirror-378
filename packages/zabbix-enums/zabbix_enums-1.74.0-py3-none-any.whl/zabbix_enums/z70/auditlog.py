"""https://www.zabbix.com/documentation/7.0/en/manual/api/reference/auditlog/object"""
from zabbix_enums import _ZabbixEnum


class AuditLogAction(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.0/en/manual/api/reference/auditlog/object#audit-log
