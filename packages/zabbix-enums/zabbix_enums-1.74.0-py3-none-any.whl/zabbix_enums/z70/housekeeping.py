"""https://www.zabbix.com/documentation/7.0/en/manual/api/reference/housekeeping/object"""
from zabbix_enums import _ZabbixEnum


class HousekeepingHKEventsMode(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.0/en/manual/api/reference/housekeeping/object#housekeeping
