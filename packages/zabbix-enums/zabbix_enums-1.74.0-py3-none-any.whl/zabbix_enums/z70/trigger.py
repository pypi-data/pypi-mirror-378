"""https://www.zabbix.com/documentation/7.0/en/manual/api/reference/trigger/object"""
from zabbix_enums import _ZabbixEnum


class TriggerFlag(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.0/en/manual/api/reference/trigger/object#trigger
