"""https://www.zabbix.com/documentation/5.4/en/manual/api/reference/httptest/object"""
from zabbix_enums import _ZabbixEnum


class WebScenarioAuthentication(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.4/en/manual/api/reference/httptest/object#web-scenario
...
class ScenarioStepFollowredirects(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.4/en/manual/api/reference/httptest/object#scenario-step
