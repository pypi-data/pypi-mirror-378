"""https://www.zabbix.com/documentation/5.2/en/manual/api/reference/graphitem/object"""
from zabbix_enums import _ZabbixEnum


class GraphItemCalcFnc(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.2/en/manual/api/reference/graphitem/object#graph-item
