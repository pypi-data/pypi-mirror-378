"""https://www.zabbix.com/documentation/5.4/en/manual/api/reference/authentication/object"""
from zabbix_enums import _ZabbixEnum


class AuthenticationType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.4/en/manual/api/reference/authentication/object#authentication
