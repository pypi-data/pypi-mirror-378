"""https://www.zabbix.com/documentation/6.4/en/manual/api/reference/problem/object"""
from zabbix_enums import _ZabbixEnum


class ProblemSource(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.4/en/manual/api/reference/problem/object#problem-object
