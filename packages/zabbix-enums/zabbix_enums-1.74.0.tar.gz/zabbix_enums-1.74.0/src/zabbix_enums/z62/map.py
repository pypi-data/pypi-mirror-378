"""https://www.zabbix.com/documentation/6.2/en/manual/api/reference/map/object"""
from zabbix_enums import _ZabbixEnum


class MapExpandMacro(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.2/en/manual/api/reference/map/object#map
