"""https://www.zabbix.com/documentation/6.2/en/manual/api/reference/mediatype/object"""
from zabbix_enums import _ZabbixEnum


class MediaTypeType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.2/en/manual/api/reference/mediatype/object#media-type
...
class MessageTemplateEventSource(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.2/en/manual/api/reference/mediatype/object#message-template
