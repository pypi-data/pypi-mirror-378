"""https://www.zabbix.com/documentation/6.2/en/manual/api/reference/settings/object"""
from zabbix_enums import _ZabbixEnum


class SettingsServerCheckInterval(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/6.2/en/manual/api/reference/settings/object#settings
