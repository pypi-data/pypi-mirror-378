"""https://www.zabbix.com/documentation/7.4/en/manual/api/reference/triggerprototype/object"""
from zabbix_enums import _ZabbixEnum


class TriggerPrototypePriority(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/triggerprototype/object#trigger-prototype
