"""https://www.zabbix.com/documentation/7.4/en/manual/api/reference/hostprototype/object"""
from zabbix_enums import _ZabbixEnum


class HostPrototypeStatus(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/hostprototype/object#host-prototype
...
class CustomInterfaceMain(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/hostprototype/object#custom-interface
...
class CustomInterfaceDetailsVersion(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/hostprototype/object#custom-interface-details
