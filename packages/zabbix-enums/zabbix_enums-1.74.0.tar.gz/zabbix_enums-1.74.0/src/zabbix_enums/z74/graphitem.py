"""https://www.zabbix.com/documentation/7.4/en/manual/api/reference/graphitem/object"""
from zabbix_enums import _ZabbixEnum


class GraphItemCalcFnc(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.4/en/manual/api/reference/graphitem/object#graph-item
