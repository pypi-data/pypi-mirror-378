...
class ServiceAlgorithm(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/service/object#service
...
class StatusRuleType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/service/object#status-rule
...
class ProblemTagOperator(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/service/object#problem-tag
