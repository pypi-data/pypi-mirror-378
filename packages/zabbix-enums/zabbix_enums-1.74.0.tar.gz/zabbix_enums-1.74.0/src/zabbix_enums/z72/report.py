"""https://www.zabbix.com/documentation/7.2/en/manual/api/reference/report/object"""
from zabbix_enums import _ZabbixEnum


class ReportPeriod(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/report/object#report
...
class UsersExclude(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/report/object#users
