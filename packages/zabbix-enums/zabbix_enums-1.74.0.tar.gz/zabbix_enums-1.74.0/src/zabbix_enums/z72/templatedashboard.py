"""https://www.zabbix.com/documentation/7.2/en/manual/api/reference/templatedashboard/object"""
...
class TemplateDashboardAutoStart(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/templatedashboard/object#template-dashboard
...
class TemplateDashboardWidgetType(str, Enum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/templatedashboard/object#template-dashboard-widget
...
class DashboardWidgetFieldType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/templatedashboard/object#template-dashboard-widget-field
