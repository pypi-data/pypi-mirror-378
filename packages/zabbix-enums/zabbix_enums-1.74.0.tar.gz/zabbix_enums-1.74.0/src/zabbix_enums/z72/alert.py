"""https://www.zabbix.com/documentation/7.2/en/manual/api/reference/alert/object"""
from zabbix_enums import _ZabbixEnum


class AlertType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.2/en/manual/api/reference/alert/object#alert
