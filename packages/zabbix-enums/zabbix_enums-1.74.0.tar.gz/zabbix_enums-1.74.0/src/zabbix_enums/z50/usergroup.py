"""https://www.zabbix.com/documentation/5.0/en/manual/api/reference/usergroup/object"""
from zabbix_enums import _ZabbixEnum


class UserGroupDebugMode(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.0/en/manual/api/reference/usergroup/object#user-group
...
class Permission(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.0/en/manual/api/reference/usergroup/object#permission
