"""https://www.zabbix.com/documentation/5.0/en/manual/api/reference/host/object"""
from zabbix_enums import _ZabbixEnum


class HostAvailable(_ZabbixEnum):
    """
...
class HostIPMIAvailable(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.0/en/manual/api/reference/host/object#host

    [Readonly]
    Availability of IPMI agent.
    """
    UNKNOWN = 0
    AVAILABLE = 1
    UNAVAILABLE = 2
...
class HostJMXAvailable(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.0/en/manual/api/reference/host/object#host

    [Readonly]
    Availability of JMX agent.
    """
    UNKNOWN = 0
    AVAILABLE = 1
    UNAVAILABLE = 2
...
class HostSNMPAvailable(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.0/en/manual/api/reference/host/object#host

    [Readonly]
    Availability of SNMP agent.
    """
    UNKNOWN = 0
    AVAILABLE = 1
    UNAVAILABLE = 2
...
class HostInventoryProperty(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.0/en/manual/api/reference/host/object#host-inventory
