...
class MediaTypeType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.0/en/manual/api/reference/mediatype/object#media-type
...
class MessageTemplateEventSource(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.0/en/manual/api/reference/mediatype/object#message-template
