"""https://www.zabbix.com/documentation/5.0/en/manual/api/reference/itemprototype/object"""
from zabbix_enums import _ZabbixEnum


class ItemPrototypeType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.0/en/manual/api/reference/itemprototype/object#item-prototype
...
class ItemPrototypePrototypeDiscover(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.0/en/manual/api/reference/itemprototype/object#item-prototype-prototype
...
class ItemPrototypePreprocessingType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/5.0/en/manual/api/reference/itemprototype/object#item-prototype-preprocessing
