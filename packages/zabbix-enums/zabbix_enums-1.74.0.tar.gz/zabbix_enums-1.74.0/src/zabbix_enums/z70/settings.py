"""https://www.zabbix.com/documentation/7.0/en/manual/api/reference/settings/object"""
from zabbix_enums import _ZabbixEnum


class SettingsServerCheckInterval(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.0/en/manual/api/reference/settings/object#settings
...
class SettingsAuditlogEnabled(_ZabbixEnum):
    ...
    Whether to enable audit logging of low-level discovery, network discovery and autoregistration activities performed by the server (System user).
    """
    NO = 0
    DISABLED = 0
    YES = 1
...
SettingsAuditlogMode = SettingsAuditlogEnabled
