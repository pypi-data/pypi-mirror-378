"""https://www.zabbix.com/documentation/7.0/en/manual/api/reference/graphprototype/object"""
from zabbix_enums import _ZabbixEnum


class GraphPrototypeType(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.0/en/manual/api/reference/graphprototype/object#graph-prototype
...
class GrapPrototypeDiscover(_ZabbixEnum):
    """
    https://www.zabbix.com/documentation/7.0/en/manual/api/reference/graphprototype/object#graph-prototype-prototype
