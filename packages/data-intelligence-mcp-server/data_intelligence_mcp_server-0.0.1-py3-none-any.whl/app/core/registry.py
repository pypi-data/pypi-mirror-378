...
from app.shared.utils.wxo_mode import transform_tool_name_for_wxo
...
class ServiceRegistry:
    ...
    def register_all(self, mcp_instance):
        ...
        for tool in self._tools:
            ...
            # Transform tool name for WXO mode if enabled
            tool_name = transform_tool_name_for_wxo(tool.name)
