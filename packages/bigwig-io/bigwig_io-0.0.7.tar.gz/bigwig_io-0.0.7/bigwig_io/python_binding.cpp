...
public:
    ...
    py::array_t<float> read_values(
        ...
        auto values = reader->read_values(
            chr_ids, starts, span, resolution, default_value, binning, zoom, progress_callback
        );
    ...
    py::array_t<float> quantify(
        ...
        auto values = reader->quantify(
            chr_ids, starts, span, resolution, default_value, reduce, zoom, progress_callback
        );
    ...
    py::array_t<float> profile(
        ...
        auto values = reader->profile(
            chr_ids, starts, span, resolution, default_value, binning, reduce, zoom, progress_callback
        );
