...
class GmailTransport(BaseTransportLayer):
    ...
    def test(self, test_data: str = "test123", cleanup: bool = True) -> Optional[str]:
        ...
        try:
            ...
            if success:
                ...
                return f"https://mail.google.com/mail/?authuser={urllib.parse.quote(self.email)}#search/{encoded_query}"
            else:
