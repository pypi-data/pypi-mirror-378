...
template_path = (
    Path(__file__).parent.parent / "polymodel/sql/_expression_select_gen.py.jinja2"
)
destiny_path = Path(__file__).parent.parent / "polymodel/sql/_expression_select_gen.py"
...
if current_content != result and os.getenv("CHECK_JINJA"):
    raise RuntimeError(
        "polymodel/sql/expression.py content not update with Jinja2 template"
    )
