...
def collate(
        expression: Union[_ColumnExpressionArgument[str], str],
        collation: str
...
def extract(
        field: str,
        expr: Union[_ColumnExpressionArgument[Any], Any]
) -> Extract:
...
def funcfilter(
        ...
        *criterion: Union[_ColumnExpressionArgument[bool], bool]
) -> FunctionFilter[_T]:
...
def within_group(
        element: FunctionElement[_T],
        *order_by: Union[_ColumnExpressionArgument[Any], Any]
) -> WithinGroup[_T]:
