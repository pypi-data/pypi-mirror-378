...
#
# This file is part of PolyModel and is distributed under the MIT License.
# See the root LICENSE file for full text.
...
class Model(BaseModel, metaclass=SQLModelMetaclass, registry=default_registry):
