...
This module mirrors a subset of the Python API in pyballistic.trajectory_data:
...
from pyballistic_exts.v3d cimport V3dT, set
from pyballistic_exts.trajectory_data cimport TrajFlag_t

from pyballistic.vector import Vector
import pyballistic.unit as pyunit
