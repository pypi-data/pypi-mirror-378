...
print(to_datetime('2025-08-14 12:53:00.053', default_tz='+07:00'))
print(to_datetime_str('2025-08-14 12:53:00.053', default_tz='+07:00'))
...
def get_log_msg(contents: dict,
    ...
    for k in ['_time_', 'time', '__time___0']:
        if k in contents and contents[k] != 'null':
            _time_ = to_datetime_str(contents[k], tz=tz)
            break
    level = None
