...
def to_datetime(
        ...
        default_tz: Union[str, timezone] = 'UTC+8'  # 默认时区为 UTC+8
...
def to_datetime_str(s: Any = None,
                    ...
                    tz: Optional[Union[str, timezone]] = None) -> datetime | str:
    """
    ...
    :return: 转换后的 float 值
    """
    r_s = to_datetime(s, pattern=pattern, tz=tz, r_str=False)
    return r_s.isoformat() if pattern_str is None else r_s.strftime(pattern_str)
