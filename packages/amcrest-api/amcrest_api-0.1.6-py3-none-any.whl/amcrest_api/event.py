...
class EventMessageType(StrEnum):
    ...
    VideoAbnormalDetection = "VideoAbnormalDetection"
    FaceDetection = "FaceDetection"
    VideoUnFocus = "VideoUnFocus"
    ...
    HeatImagingTemper = "HeatImagingTemper"
    CrowdDetection = "CrowdDetection"
    FireWarning = "FireWarning"
    FireWarningInfo = "FireWarningInfo"
    ObjectPlacementDetection = "ObjectPlacementDetection"
