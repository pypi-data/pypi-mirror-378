...
setup(**{
    ...
    'install_requires': (
        'aiodocker==0.24.0',
        'aiotools~=1.9.0',
        """backend.ai-agent==25.14.4
""",
        """backend.ai-cli==25.14.4
""",
        """backend.ai-common==25.14.4
""",
        """backend.ai-kernel-binary==25.14.4
""",
        """backend.ai-kernel-helper==25.14.4
""",
        """backend.ai-logging==25.14.4
""",
        """backend.ai-plugin==25.14.4
""",
    ),
    'license': 'LGPLv3',
