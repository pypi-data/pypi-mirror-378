...
ACTUAL_DOCUMENTATION_URL = dsl_reader.DOCUMENTATION_URL
...
class TestDslReader(TestCase):
    ...
    def assert_messages_and_models(self,
        ...
        assert dsl_reader.DOCUMENTATION_URL == ACTUAL_DOCUMENTATION_URL
        dsl_reader.DOCUMENTATION_URL = TEST_DOCUMENTATION_URL
        try:
            reader = dsl_reader.DslReader(textwrap.dedent(src).strip(), silent=True)
            ...
            dsl_reader.DOCUMENTATION_URL = ACTUAL_DOCUMENTATION_URL
