...
class ElementSpecification:
    def __init__(self,
        ...
        self.metatype = metatype
        self.metatype_sources = metatype_sources
        self.metatype_infos = metatype_infos
        
        self.source_by_attribute_name = source_by_attribute_name
        self.message_by_skipped_attribute_name = message_by_skipped_attribute_name
        self._member_qnames = None
