...
def test(searchPath):
    ...
    template.executeTemplate(config, searchPath, useAdaptiveDuration=False, useAdaptiveSize=False, printLog=False, useHardwareEncode=False, useHardwareDecode=False)
    img_success = False
    ...
    template.generateTemplate(os.path.join(test_template_dir, "param.config"), tp_dir, searchPath, printLog=False, useHardwareEncode=False, useHardwareDecode=False)
