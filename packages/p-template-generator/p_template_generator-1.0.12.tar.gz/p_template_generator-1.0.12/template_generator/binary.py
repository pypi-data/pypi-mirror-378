...
def updateBin(rootDir):
    ...
    if sys.platform == "win32":
        asset_md5 = "97289EA3F63AADCDB6BBF36A5BCB1C0C"
        asset_url = "https://oss.zjtemplate.com/windows/TemplateProcess/templateprocess_1.13_20250921_153055.zip"
    elif sys.platform == "linux":
        asset_md5 = "08DDD2B8B5EFDECEB3C4B689C7C43CCB"
        asset_url = "https://oss.zjtemplate.com/linux/TemplateProcess/templateprocess_1.13_20250921_153055.zip"
    elif sys.platform == "darwin":
        asset_md5 = "DCDD1853192191B9D4111D3D813B294B"
        asset_url = "https://oss.zjtemplate.com/macos/TemplateProcess/templateprocess_1.13_20250921_153055.zip"
