...
class ActivityLogHandler(MemoryHandler):
    def __init__(self, endpoint, token, client, timeout=10, verify=True, max_retries=3, interval = 10, *args, **kwargs):
    ...
    async def _periodic_upload_loop(self):
        """Background task that uploads logs every interval seconds."""
        try:
    ...
    async def close(self):
        ...
        # Cancel and wait for periodic task to complete
