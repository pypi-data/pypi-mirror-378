...
class SapiensModel():
    def __init__(self, model_path='', hur_context_size=None, show_errors=False):
        try:
            ...
            try:
                ...
                def get_hur_model(model_path=''):
                    for file in listdir(model_path):
                        if file.endswith('.safetensors') or file.endswith('.ben'): return model_path
                    for file in listdir(model_path):
            ...
            self.__system, self.__model, self.__max_new_tokens, self.__original_model_path, self.MGT_STRING = NAME065, model, 500, original_model_path, NAME066
        except Exception as error:
    ...
    def __extract_before_user(self, text=''):
        ...
        return text.strip()
    def __token_generator(self, inputs=None, image_inputs=None, temperature=0.5, max_new_tokens=200):
        try:
    ...
    def generate_template_text(self, system='', prompt='', temperature=0.5, max_new_tokens=None, stream=False):
        try:
            ...
            prompt = self.__get_mgt(prompt=prompt)
            ...
            elif not system: system = system_value
        ...
        try:
            ...
            if messages:
                ...
                if _role == 'user':
                    ...
                    _prompt = self.__get_mgt(prompt=_prompt)
