...
class AcousticField(ABC):
    ...
    def show(self, use_dB=False, reference=1e6):
        """
        ...
        try:
            ...
            if use_dB:
                ...
                vmax = 0  # 0 dB correspond au niveau de référence
                ...
                unit_label = 'MPa'
                vmax = np.max(envelope_amplitude_mpa)
            ...
            plt.imshow(data_to_show.max(axis=0),
                    ...
                    aspect='equal', cmap='jet', vmin=0, vmax=0.7*vmax)
