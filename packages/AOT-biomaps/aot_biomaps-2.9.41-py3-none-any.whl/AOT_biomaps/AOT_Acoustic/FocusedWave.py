...
class FocusedWave(AcousticField):
    ...
    def _generate_2Dacoustic_field_KWAVE(self, isGPU=True if config.get_process() == 'gpu' else False, show_log=True):
        ...
        try:
            ...
            element_positions = np.arange(self.params['Xrange'][0], self.params['Xrange'][1], dx)
            ...
            active_list = element_positions[selected_indices]
            ...
            if delayedSignal.shape[0] % self.params['num_elements'] != 0:
