...
# Conditional imports for Jama functionality
try:
...
def generate_report(
    ...
    # Check Jama availability for Jama-specific operations
    if (create_jama_ut or push_ut_test_results) and not JAMA_AVAILABLE:
        typer.echo("❌ Error: Jama functionality is not available. Please install with: pip install lupin-sw-ut-report[jama]", err=True)
        raise typer.Exit(code=1)
