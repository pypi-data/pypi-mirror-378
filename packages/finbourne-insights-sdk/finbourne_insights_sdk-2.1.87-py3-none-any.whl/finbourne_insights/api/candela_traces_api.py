...
class CandelaTracesApi:
    ...
    @overload
    async def get_trace_log(self, trace_id : Annotated[StrictStr, Field(..., description="The identifier of the request to obtain the log for.")], scope : Annotated[StrictStr, Field(..., description="")], **kwargs) -> TraceLog:  # noqa: E501
        ...

    @overload
    def get_trace_log(self, trace_id : Annotated[StrictStr, Field(..., description="The identifier of the request to obtain the log for.")], scope : Annotated[StrictStr, Field(..., description="")], async_req: Optional[bool]=True, **kwargs) -> TraceLog:  # noqa: E501
        ...

    @validate_arguments
    def get_trace_log(self, trace_id : Annotated[StrictStr, Field(..., description="The identifier of the request to obtain the log for.")], scope : Annotated[StrictStr, Field(..., description="")], async_req: Optional[bool]=None, **kwargs) -> Union[TraceLog, Awaitable[TraceLog]]:  # noqa: E501
        """[EXPERIMENTAL] GetTraceLog: Get the log for a specific trace.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_trace_log(trace_id, scope, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_trace_log_with_http_info(trace_id, scope, **kwargs)  # noqa: E501

    @validate_arguments
    def get_trace_log_with_http_info(self, trace_id : Annotated[StrictStr, Field(..., description="The identifier of the request to obtain the log for.")], scope : Annotated[StrictStr, Field(..., description="")], **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] GetTraceLog: Get the log for a specific trace.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_trace_log_with_http_info(trace_id, scope, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/candelatraces/{scope}/{traceId}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @overload
    async def list_trace_event_logs(self, trace_id : Annotated[StrictStr, Field(..., description="The identifier of the request to obtain the log for.")], scope : Annotated[StrictStr, Field(..., description="")], page : Annotated[Optional[StrictStr], Field( description="")] = None, **kwargs) -> ResourceListOfTraceEventLog:  # noqa: E501
        ...

    @overload
    def list_trace_event_logs(self, trace_id : Annotated[StrictStr, Field(..., description="The identifier of the request to obtain the log for.")], scope : Annotated[StrictStr, Field(..., description="")], page : Annotated[Optional[StrictStr], Field( description="")] = None, async_req: Optional[bool]=True, **kwargs) -> ResourceListOfTraceEventLog:  # noqa: E501
        ...

    @validate_arguments
    def list_trace_event_logs(self, trace_id : Annotated[StrictStr, Field(..., description="The identifier of the request to obtain the log for.")], scope : Annotated[StrictStr, Field(..., description="")], page : Annotated[Optional[StrictStr], Field( description="")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ResourceListOfTraceEventLog, Awaitable[ResourceListOfTraceEventLog]]:  # noqa: E501
        """[EXPERIMENTAL] ListTraceEventLogs: Get the trace event logs for a specific trace.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_trace_event_logs(trace_id, scope, page, async_req=True)
        >>> result = thread.get()
        ...
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.list_trace_event_logs_with_http_info(trace_id, scope, page, **kwargs)  # noqa: E501

    @validate_arguments
    def list_trace_event_logs_with_http_info(self, trace_id : Annotated[StrictStr, Field(..., description="The identifier of the request to obtain the log for.")], scope : Annotated[StrictStr, Field(..., description="")], page : Annotated[Optional[StrictStr], Field( description="")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """[EXPERIMENTAL] ListTraceEventLogs: Get the trace event logs for a specific trace.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_trace_event_logs_with_http_info(trace_id, scope, page, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/api/candelatraces/{scope}/{traceId}/events', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
