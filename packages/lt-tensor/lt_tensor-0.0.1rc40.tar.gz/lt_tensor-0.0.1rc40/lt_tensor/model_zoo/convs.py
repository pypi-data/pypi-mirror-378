...
from lt_utils.misc_utils import default, filter_kwargs
...
def get_conv(
    ...
    *,
    ...
    if groups > 1:
        groups = min(groups, math.gcd(in_channels, out_ch))
        if groups % in_channels != 0 or groups % out_ch != 0:
            groups = 1
