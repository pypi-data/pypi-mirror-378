...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/API/attachments.ipynb.

# %% auto 0
__all__ = ['Color', 'Field', 'Attachment']

# %% ../nbs/API/attachments.ipynb 3
...
from .utils import coerce_to_list, is_hex

# %% ../nbs/API/attachments.ipynb 4
class Color(Enum):
    """
    Color is a utility class for use with the Slack secondary attachments API.

    Pass these to the `color` argument of
        [`Attachment`](/moreblocks/latest/reference/attachments/#attachments.Attachment).
    ...
    def __repr__(self) -> str:
        return f"<moreblocks Color {self.name}: {self.value}>"
