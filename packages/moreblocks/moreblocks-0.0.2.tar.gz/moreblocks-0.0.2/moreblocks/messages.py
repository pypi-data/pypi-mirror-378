...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/API/messages.ipynb.

# %% auto 0
__all__ = ['ResponseType', 'BaseMessage', 'Message', 'MessageResponse', 'WebhookMessage']

# %% ../nbs/API/messages.ipynb 3
...
class Message(BaseMessage):
    ...
    Args:
        ...
        blocks: a list of [`Blocks`](/moreblocks/latest/reference/blocks) to form the contents
            of the message instead of the contents of `text`.
        attachments: a list of
            [`Attachments`](/moreblocks/latest/reference/attachments/#attachments.Attachment)
    ...
    Throws:
        InvalidUsageException: in the event that the items passed to `blocks`
            are not valid [`Blocks`](/moreblocks/latest/reference/blocks).
    """
