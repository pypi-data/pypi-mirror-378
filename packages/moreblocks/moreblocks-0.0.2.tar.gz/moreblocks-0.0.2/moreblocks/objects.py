...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/API/objects.ipynb.

# %% auto 0
__all__ = ['TextLike', 'ALLOWABLE_TRIGGERS', 'CompositionObjectType', 'CompositionObject', 'TextType', 'Text',
           'ConfirmationDialogue', 'Confirm', 'Option', 'OptionGroup', 'DispatchActionConfiguration',
           'ConversationFilter', 'InputParameter', 'SlackFile', 'Trigger', 'Workflow', 'RawText', 'ColumnSettings']

# %% ../nbs/API/objects.ipynb 3
...
class Confirm(ConfirmationDialogue):
    ...
    See:
        [`ConfirmationDialogue`](/moreblocks/latest/reference/objects/#objects.ConfirmationDialogue).
    """
