...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/API/views.ipynb.

# %% auto 0
__all__ = ['ViewType', 'View', 'ModalView', 'HomeTabView']

# %% ../nbs/API/views.ipynb 3
from enum import Enum
from json import dumps
from typing import Any, Dict, List, Optional, Union

from .blocks import Block
from .objects import Text, TextLike
from .utils import coerce_to_list, validate_string


# %% ../nbs/API/views.ipynb 4
class ViewType(Enum):
    MODAL = "modal"
    HOME = "home"
