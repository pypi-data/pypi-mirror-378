...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/API/blocks.ipynb.

# %% auto 0
__all__ = ['ALLOWED_INPUT_ELEMENTS', 'TableCell', 'BlockType', 'Block', 'ActionsBlock', 'ContextBlock', 'DividerBlock',
           'FileBlock', 'HeaderBlock', 'ImageBlock', 'InputBlock', 'RichTextBlock', 'SectionBlock', 'TableBlock']

# %% ../nbs/API/blocks.ipynb 3
...
from .utils import coerce_to_list, coerce_to_list_nonnull, validate_string

# %% ../nbs/API/blocks.ipynb 4
...
class InputBlock(Block):
    ...
    Args:
        ...
        element: an interactive [Element](/moreblocks/latest/reference/elements)
            (e.g. a text field).
        dispatch_action: whether the [Element](/moreblocks/latest/reference/elements)
...
class RichTextBlock(Block):
    ...
    A RichTextBlock is used to provide easier rich text formatting
        ...
        [`SectionBlock`](/moreblocks/latest/reference/blocks/#blocks.SectionBlock))
        ...
        you can include [here](/moreblocks/latest/reference/rich_text).
...
class SectionBlock(Block):
    ...
    [Elements](/moreblocks/latest/reference/elements).
    ...
    Args:
        ...
        accessory: an optional [Element](/moreblocks/latest/reference/elements) object
