...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/API/elements.ipynb.

# %% auto 0
__all__ = ['ButtonStyleLike', 'ElementType', 'Element', 'Button', 'CheckboxGroup', 'DatePicker', 'DateTimePicker', 'EmailInput',
           'FileInput', 'Image', 'StaticMultiSelectMenu', 'ExternalMultiSelectMenu', 'UserMultiSelectMenu',
           'ConversationMultiSelectMenu', 'ChannelMultiSelectMenu', 'NumberInput', 'OverflowMenu', 'PlainTextInput',
           'RadioButtonGroup', 'StaticSelectMenu', 'ExternalSelectMenu', 'UserSelectMenu', 'ConversationSelectMenu',
           'ChannelSelectMenu', 'TimePicker', 'URLInput', 'ButtonStyle', 'WorkflowButton', 'RichTextInput']

# %% ../nbs/API/elements.ipynb 3
...
class CheckboxGroup(Element):
    ...
    Args:
        action_id: an identifier so the source of the action can be known.
        options: a list of
            [`Option`](/moreblocks/latest/reference/objects/#objects.Option) objects that will form
            the content of the checkbox group.
        initial_options: a list of
            [`Option`](/moreblocks/latest/reference/objects/#objects.Option) objects that will be
...
class Image(Element):
    ...
    Args:
        ...
        slack_file: a [`SlackFile`](/moreblocks/latest/reference/objects/#objects.SlackFile)
...
class StaticMultiSelectMenu(Element):
    ...
    Args:
        action_id: an identifier so the source of the action can be known.
        options: a list of [`Options`](/moreblocks/latest/reference/objects/#objects.Option)
            (max 100). Only one of `options` or `option_groups` must be
            provided.
        option_groups: a list of
            [`OptionGroups`](/moreblocks/latest/reference/objects/#objects.OptionGroup)
            (max 100). Only one of `options` or `option_groups` can be
            provided.
        initial_options: the [`Options`](/moreblocks/latest/reference/objects/#objects.Option)
...
class ConversationMultiSelectMenu(Element):
    ...
    Args:
        ...
        max_selected_items: the maximum number of items that can be selected
            in the menu.
        filter: a [`Filter`](/moreblocks/latest/reference/objects/#objects.ConversationFilter)
...
class RadioButtonGroup(Element):
    ...
    Args:
        ...
        initial_option: an
            [`Option`](/moreblocks/latest/reference/objects/#objects.Option) object that will be
            initially selected when first presented to the user.
        confirm: a `ConfirmationDialogue` object that will be presented when an
            option in the overflow menu is selected.
        focus_on_load: whether or not the input will be set to autofocus
...
class ExternalSelectMenu(Element):
    ...
    See:
        <https://api.slack.com/moreblocks/latest/reference/block-kit/block-elements#external_select>. # noqa: E501
...
class WorkflowButton(Element):
    ...
    Args:
        ...
        workflow: a [`Workflow`](/moreblocks/latest/reference/objects/#objects.Workflow) object
