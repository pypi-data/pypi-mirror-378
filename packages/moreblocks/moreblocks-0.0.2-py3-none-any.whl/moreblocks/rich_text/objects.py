...
from moreblocks.rich_text.elements import (
    RichText,
    RichTextChannel,
    RichTextElement,
    RichTextEmoji,
...
from moreblocks.utils import coerce_to_list, validate_int
...
class RichTextCodeBlock(RichTextObject):
    ...
    Args:
        elements: one or more rich text primitive objexts
            (e.g. [`RichText`](/moreblocks/latest/reference/rich_text/#rich_text.RichText)).
