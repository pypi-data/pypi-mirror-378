...
Rich text elements are the primitive elements used to populate the rich
    ...
    [`RichTextBlock`](/moreblocks/latest/reference/blocks/#blocks.RichTextBlock).
"""
...
from moreblocks.utils import validate_string
...
class RichTextElement(ABC):
    ...
    the [`RichTextBlock`](/moreblocks/latest/reference/blocks/#blocks.RichTextBlock).
    """
...
class RichTextUser(RichTextElement):
    ...
    Rich text element for representing users in
        [`RichTextBlocks`](/moreblocks/latest/reference/blocks/#blocks.RichTextBlock).
