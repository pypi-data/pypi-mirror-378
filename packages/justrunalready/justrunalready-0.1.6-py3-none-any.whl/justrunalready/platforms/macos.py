...
class MacOSPlatform(PlatformBase):
    ...
    def bundle(
        ...
        *,
        ...
        for plugin in plugins:
            asset_patterns.extend(list(plugin.asset_seeds(stage_root=str(staging_root))))
        ...
        for src, dst in file_mappings.items():
            ...
            if dst.suffix in (".dylib", "") or ".framework" in dst.name or dst == exe_path:
        ...
        self.process_copy_mappings(cfg, staging_root, app_path, actions, default_dest="Contents/Resources")
