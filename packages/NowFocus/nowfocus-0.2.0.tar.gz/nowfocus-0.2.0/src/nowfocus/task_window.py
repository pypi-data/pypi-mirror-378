...
class TaskWindow(Gtk.Window):
            ...
            if todo['status']:
                try:
                    ...
                    if openable not in openables:  
                        ...
                        lamb
                        openable_button.connect("clicked", lambda todo: openable(todo)) # Doesn't work because of passing widget as first argument
                    ...
                    dbg("error adding todo connector open() to task window ",e)


                # Old get_connector_openable version
    ...
    def add_task_to_list(self,t,search_str = ''):
