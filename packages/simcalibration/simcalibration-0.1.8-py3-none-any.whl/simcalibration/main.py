...
from simcalibration.utils.Andes_Dag import *
...
def run_metasimulation(
    n_train=200,
    n_test=200,
    n_true_repetitions=1000,
    n_practitioner_repetitions=10,
    n_sl_repetitions=500,
    kfolds=2
):
    starttime = time.time()
    ########################################################################################################################
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_true_repetitions", type=int, default=1000)
    parser.add_argument("--n_practitioner_repetitions", type=int, default=10)
    parser.add_argument("--n_sl_repetitions", type=int, default=500)
