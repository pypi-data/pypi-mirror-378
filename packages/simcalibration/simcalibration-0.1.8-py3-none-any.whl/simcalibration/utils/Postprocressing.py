...
class Postprocessing():
    ...
    def meta_simulation_visualise(self, results: list):
        ...
        output_pd_cv.to_csv(os.path.join(os.getcwd(), figuredirname, "meta_simulation_cv_performance_per_repetition.csv"))
        ...
        performance_diff_avgmean_table.to_csv(
            os.path.join(os.getcwd(), figuredirname, "meta_simulation_cv_performance_difference_avgmean_table.csv")
        )
        performance_diff_true_table = output_pd_cv.pivot_table(index='SL', columns='ML_method', values='est-true',aggfunc='mean')
        performance_diff_true_table.to_csv(
            os.path.join(os.getcwd(), figuredirname, "meta_simulation_cv_performance_difference_true_table.csv")
        )
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname, "interworld_benchmarks_boxplot_all_ml_methods_cv_diff_to_true_xaxis_ordered.png"))
        plt.show()
        ...
        plt.xticks(rotation=90)
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname, 'interworld_benchmarks_boxplot_all_ml_methods_cv_diff_to_avg_ml_performance.png'))
        plt.show()
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname, 'interworld_benchmarks_scatterplot_every_practitioner_repetition_cv_accuracies_all_methods.png'))
        plt.show()

        scatter_cv_df = pd.DataFrame(scatter_cv_data, columns=['True_CV_Accuracy', 'Estimated_CV_Accuracy', 'Strategy'])
        scatter_cv_df.to_csv(
            os.path.join(os.getcwd(), figuredirname,
        ...
        variance_table.to_csv(
            os.path.join(os.getcwd(), figuredirname, "meta_simulation_cv_variance_table.csv"))
        ...
        plt.xticks(rotation=90)
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname, 'interworld_benchmarks_barplot_all_ml_methods_learner_cv_variance.png'))
        plt.show()
        ...
        pd.DataFrame(pairwise_variance_test_results).to_csv(
            os.path.join(os.getcwd(), figuredirname, "meta_simulation_cv_pairwise_variance_test_results.csv"),
            index=False
        )

        pd.DataFrame(ci_results_var_diff).to_csv(
            os.path.join(os.getcwd(), figuredirname, "meta_simulation_cv_ci_results_variance.csv"),
            index=False
        )
        ...
        output_pd.to_csv(os.path.join(os.getcwd(), figuredirname, "meta_simulation_performance_per_repetition.csv"))
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname, 'interworld_benchmarks_barplot_proportion_matches_max_method.png'))
        plt.show()
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname, 'interworld_benchmarks_scatterplot_every_practitioner_repetition_accuracies_all_methods.png'))
        plt.show()

        scatter_df = pd.DataFrame(scatter_data, columns=['True_Accuracy','Estimated_Accuracy', 'Strategy'])
        scatter_df.to_csv(
            os.path.join(os.getcwd(), figuredirname,
                         'interworld_benchmarks_scatterplot_true_est_accuracies_all_methods_table.csv'),
            index=False
        )
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname,'interworld_benchmarks_barplot_all_ml_methods_learner_var.png'))
        plt.show()
        ...
        ax.tick_params(labelrotation=90)
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname,'interworld_benchmarks_barplot_all_ml_methods_learner_std.png'))
        plt.show()

        sl_differences_var.to_csv(os.path.join(os.getcwd(), figuredirname,"meta_simulation_variance_per_ml_method.csv"))
        ...
        # Exporting Results
        pd.DataFrame(pairwise_variance_test_results).to_csv(
            os.path.join(os.getcwd(), figuredirname, "meta_simulation_pairwise_variance_test_results.csv"),
            index=False
        )

        pd.DataFrame(ci_results_var_diff).to_csv(
            os.path.join(os.getcwd(), figuredirname, "meta_simulation_ci_results_variance.csv"),
            index=False
        )
        plt.figure(figsize=(10, 10), dpi=300)
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname, 'interworld_benchmarks_boxplot_all_ml_methods_diff_to_true.png'))
        plt.show()
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname, 'interworld_benchmarks_boxplot_all_ml_methods_diff_to_true_xaxis_ordered.png'))
        plt.show()
        ...
        ax.set_xticklabels(added_methods, rotation=90)
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname, 'interworld_benchmarks_boxplot_all_ml_methods_diff_to_true_xaxis_ordered_fliers.png'))
        plt.show()
        ...
        ax.set_xticklabels(ml_labels, rotation=90)
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname, 'interworld_benchmarks_boxplot_all_ml_methods_diff_to_avg_ml_performance.png'))
        plt.show()
        ...
        ax.set_xticklabels(added_methods, rotation=90)
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname, 'interworld_benchmarks_boxplot_all_ml_methods_diff_to_avg_ml_performance_xaxis_ordered.png'))
        plt.show()
        ...
        ax.set_xticklabels(added_methods, rotation=90)
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname, 'interworld_benchmarks_boxplot_all_ml_methods_diff_to_avg_ml_performance_xaxis_ordered_fliers.png'))
        plt.show()
        ...
        for ml in self.ml_models:
            ...
            plt.tight_layout()
            plt.savefig(os.path.join(os.getcwd(), figuredirname, 'interworld_benchmarks_kdeplot_performance_'+ml.name+'by_sl.png'))
            plt.show()
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname, 'interworld_benchmarks_violinplot_every_repetition_rank_all_methods_composite.png'))
        plt.show()
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname, "dag_fidelity_shd_boxplot.png"))
        plt.show()
        ...
        plt.xticks(rotation=45)
        plt.tight_layout()
        plt.savefig(os.path.join(os.getcwd(), figuredirname, "distribution_fidelity_barplot.png"))
        plt.show()
