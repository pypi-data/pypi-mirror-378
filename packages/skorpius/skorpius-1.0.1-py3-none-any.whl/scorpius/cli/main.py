...
def scan(target, output, format, report, print_pdf, print_html, severity, confidence, verbose, recursive):
    ...
    Examples:
        skorpius scan contract.sol
        skorpius scan contracts/ --report pdf
        skorpius scan contracts/ --print-pdf
        skorpius scan contracts/ --format json --output results.json
        skorpius scan . --recursive --severity High
    """
...
async def show_interactive_menu():
    ...
    console.print("\n🎯 Welcome to Skorpius! What would you like to do today?", style="bold cyan")
