...
class BulkModelSerializer(serializers.ModelSerializer):
    ...
    def get_fields(self):
        ...
        # Fields explicitly declared on the subclass should never be removed
        ...
        for model_field in model._meta.get_fields():
            ...
            # Optionally remove auto-generated relation field to ensure no relation access,
            # but never remove fields explicitly declared by the user (e.g., SlugRelatedField)
