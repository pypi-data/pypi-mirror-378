...
class LogbookApi:
    ...
    def logbook_session_id_event_count_get(
        ...
        tags: Annotated[Optional[StrictStr], Field(description="comma-separated list of tag names. Example system,calibration")] = None,
        ...
        :type var_date: str
        :param tags: comma-separated list of tag names. Example system,calibration
        :type tags: str
