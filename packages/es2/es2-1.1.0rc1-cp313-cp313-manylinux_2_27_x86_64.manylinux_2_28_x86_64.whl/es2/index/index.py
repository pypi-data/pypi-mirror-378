...
class IndexConfig:
    ...
    def deepcopy(
        ...
        new_config = IndexConfig(
            ...
            metadata_encryption=self.key_param.metadata_encryption
            if metadata_encryption is None
            else metadata_encryption,
        )
        return new_config
...
class Index:
    ...
    def get_topk_metadata_results(self, result, top_k: int, output_fields: List[str] = None):
        ...
        >>> print(top_k_results)
        """
        return self._multiquery_get_topk_metadata_results(results=[result], top_k=top_k, output_fields=output_fields)[0]
    ...
    def decrypt_score(
        ...
        return self.cipher.decrypt_score(
            result_ctxt,
