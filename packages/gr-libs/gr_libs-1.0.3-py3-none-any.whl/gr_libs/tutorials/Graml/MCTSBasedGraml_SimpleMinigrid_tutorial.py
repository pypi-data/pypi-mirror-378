from gr_libs import MCTSBasedGraml
...
def run_MCTSBasedGraml_SimpleMinigrid_tutorial():
    recognizer = MCTSBasedGraml(
    ...
    recognizer.goals_adaptation_phase(
        dynamic_goals=[(11, 5), (11, 3), (1, 7)], save_fig=True
    )
    ...
    closest_goal = recognizer.inference_phase(partial_sequence, (11, 3), 0.5)
    print(
        f"closest_goal returned by GRAML: {closest_goal}\nactual goal actor aimed towards: (11, 3)"
    )
