...
class CodeToolsClient:
    ...
    def _start_docker_server(self) -> bool:
        ...
        try:
            ...
            cmd_string = f'pip install aicodetools && python -m aicodetools.server --host 0.0.0.0 --port 8080'
            run_cmd = [
            ...
            exact_cmd = f"docker run -d --name aicodetools-container -p {self.port}:8080 {self.docker_image} bash -c \"{cmd_string}\""
