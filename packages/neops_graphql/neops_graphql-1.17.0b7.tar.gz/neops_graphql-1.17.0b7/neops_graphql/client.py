...
class Client(AsyncBaseClient):
    ...
    async def get_and_lock_resources(
        ...
        **kwargs: Any
        ...
        query = gql(
            """
            mutation getAndLockResources($reference: String!, $deviceGroupIds: [ID], $deviceIds: [ID], $interfaceIds: [ID], $deviceGroupQueries: [String], $deviceQueries: [String], $interfaceQueries: [String]) {
              getAndLockResources(
                reference: $reference
