...
class MarginSummaryItem(BaseModel, TimestampFields, IdFields):
    ...
    rzrq_balance: Optional[int] = Field(None, description="融资融券余额(分)")
    ...
    rq_repay_amount: Optional[int] = Field(None, description="融券偿还额(分)")
    rz_net_buy_amount: Optional[int] = Field(None, description="融资净买入额(分)")
    rq_net_sell_amount: Optional[int] = Field(None, description="融券净卖出额(分)")
