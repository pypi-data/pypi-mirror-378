...
class MarginSummaryClient:
    ...
    def page_list(
        ...
        Returns:
            Dict containing paginated margin market summary data
        """
    ...
    def list(
        ...
        Returns:
            Dict containing margin market summary data
        """
        params: Dict[str, Any] = {}
        if start_date:
            params["start_date"] = start_date
        ...
        return self._client._request("GET", "/api/v1/margin_summary/list", params=params)