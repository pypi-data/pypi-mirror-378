...
class MarginDetailItem(BaseModel, TimestampFields, IdFields):
    ...
    rz_balance: Optional[int] = Field(None, description="融资余额(分)")
    rq_balance: Optional[int] = Field(None, description="融券余额(分)")
    rq_volume: Optional[int] = Field(None, description="融券余量(股)")
    rz_buy_amount: Optional[int] = Field(None, description="融资买入额(分)")
    rq_sell_amount: Optional[int] = Field(None, description="融券卖出额(分)")
    rz_repay_amount: Optional[int] = Field(None, description="融资偿还额(分)")
    rq_repay_volume: Optional[int] = Field(None, description="融券偿还量(股)")
    rz_net_buy_amount: Optional[int] = Field(None, description="融资净买入额(分)")
