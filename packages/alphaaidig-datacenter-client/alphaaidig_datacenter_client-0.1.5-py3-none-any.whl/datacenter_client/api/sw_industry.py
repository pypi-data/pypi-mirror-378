...
class SWIndustryClient:
    ...
    def page_list(
        ...
        """
        Get a paginated list of SW-industries.
        Corresponds to GET /sw_industry/page_list
        """
        ...
        return self._client._request("GET", "/api/v1/sw_industry/page_list", params=params)
    ...
    def list(
        ...
        """
        Get a list of SW-industries without pagination.
        Corresponds to GET /sw_industry/list
        """
        params: Dict[str, Any] = {}
        if industry_code:
            params["industry_code"] = industry_code
        ...
        return self._client._request("GET", "/api/v1/sw_industry/list", params=params)