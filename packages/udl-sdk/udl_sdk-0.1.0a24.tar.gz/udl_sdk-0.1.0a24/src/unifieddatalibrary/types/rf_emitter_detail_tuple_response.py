...
__all__ = [
    ...
    "RfEmitterDetailTupleResponseItemAmplifier",
    "RfEmitterDetailTupleResponseItemAntenna",
    "RfEmitterDetailTupleResponseItemAntennaFeed",
    "RfEmitterDetailTupleResponseItemAntennaReceiverChannel",
    "RfEmitterDetailTupleResponseItemAntennaTransmitChannel",
    "RfEmitterDetailTupleResponseItemPowerOffset",
    "RfEmitterDetailTupleResponseItemService",
    "RfEmitterDetailTupleResponseItemTtp",
    "RfEmitterDetailTupleResponseItemTtpTechniqueDefinition",
    "RfEmitterDetailTupleResponseItemTtpTechniqueDefinitionParamDefinition",
]


class RfEmitterDetailTupleResponseItemAmplifier(BaseModel):
...
class RfEmitterDetailTupleResponseItemAntennaFeed(BaseModel):
...
class RfEmitterDetailTupleResponseItemAntennaReceiverChannel(BaseModel):
...
class RfEmitterDetailTupleResponseItemAntennaTransmitChannel(BaseModel):
    power: float
...
class RfEmitterDetailTupleResponseItemAntenna(BaseModel):
    ...
    feeds: Optional[List[RfEmitterDetailTupleResponseItemAntennaFeed]] = None
    ...
    receiver_channels: Optional[List[RfEmitterDetailTupleResponseItemAntennaReceiverChannel]] = FieldInfo(
        alias="receiverChannels", default=None
    )
    """The set of receiver channels for this antenna."""

    transmit_channels: Optional[List[RfEmitterDetailTupleResponseItemAntennaTransmitChannel]] = FieldInfo(
        alias="transmitChannels", default=None
    )
    """The set of transmit channels for this antenna."""


class RfEmitterDetailTupleResponseItemPowerOffset(BaseModel):
...
class RfEmitterDetailTupleResponseItemService(BaseModel):
    name: Optional[str] = None
...
class RfEmitterDetailTupleResponseItemTtpTechniqueDefinitionParamDefinition(BaseModel):
...
class RfEmitterDetailTupleResponseItemTtpTechniqueDefinition(BaseModel):
    name: Optional[str] = None
    """The EW Emitter system technique name."""

    param_definitions: Optional[List[RfEmitterDetailTupleResponseItemTtpTechniqueDefinitionParamDefinition]] = (
        FieldInfo(alias="paramDefinitions", default=None)
    )
    """The set of required/optional parameters for this technique."""


class RfEmitterDetailTupleResponseItemTtp(BaseModel):
    output_signal_name: Optional[str] = FieldInfo(alias="outputSignalName", default=None)
    """The name of the output signal."""

    technique_definitions: Optional[List[RfEmitterDetailTupleResponseItemTtpTechniqueDefinition]] = FieldInfo(
...
class RfEmitterDetailTupleResponseItem(BaseModel):
    ...
    amplifier: Optional[RfEmitterDetailTupleResponseItemAmplifier] = None
    """An RF Amplifier associated with an RF Emitter Details."""

    antennas: Optional[List[RfEmitterDetailTupleResponseItemAntenna]] = None
    ...
    power_offsets: Optional[List[RfEmitterDetailTupleResponseItemPowerOffset]] = FieldInfo(
    ...
    services: Optional[List[RfEmitterDetailTupleResponseItemService]] = None
    ...
    ttps: Optional[List[RfEmitterDetailTupleResponseItemTtp]] = None
