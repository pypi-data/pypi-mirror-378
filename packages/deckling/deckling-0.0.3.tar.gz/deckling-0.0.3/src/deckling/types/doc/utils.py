...
from deckling.types.doc.tokens import _LOC_PREFIX, DocumentToken, TableToken

if TYPE_CHECKING:
    from deckling.types.doc.document import TableCell, TableData
...
def otsl_parse_texts(
    ...
    from deckling.types.doc.document import TableCell
...
def parse_otsl_table_content(otsl_content: str) -> "TableData":
    ...
    from deckling.types.doc.document import TableData
