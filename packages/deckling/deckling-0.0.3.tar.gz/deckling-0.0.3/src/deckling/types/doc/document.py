...
from deckling.types.base import _JSON_POINTER_REGEX
from deckling.types.doc import BoundingBox, Size
from deckling.types.doc.base import (
    CoordOrigin,
    ImageRefMode,
    PydanticSerCtxKey,
    round_pydantic_float,
)
from deckling.types.doc.labels import (
    CodeLanguageLabel,
    DocItemLabel,
    GraphCellLabel,
    GraphLinkLabel,
...
from deckling.types.doc.tokens import DocumentToken, TableToken
from deckling.types.doc.utils import parse_otsl_table_content, relative_path
...
class RichTableCell(TableCell):
    ...
    @override
    def _get_text(self, doc: Optional["DoclingDocument"] = None, **kwargs: Any) -> str:
        from deckling.transforms.serializer.markdown import MarkdownDocSerializer
...
class TextItem(DocItem):
    ...
    def export_to_doctags(
        ...
        """
        from deckling.transforms.serializer.doctags import (
...
class PictureItem(FloatingItem):
    ...
    def export_to_html(
        ...
        from deckling.transforms.serializer.html import (
            HTMLDocSerializer,
            HTMLParams,
        )
...
class TableItem(FloatingItem):
    ...
    def export_to_html(
        ...
        if doc is not None:
            from deckling.transforms.serializer.html import HTMLDocSerializer
    ...
    def export_to_otsl(
        ...
        **kwargs: Any,
        ...
        from deckling.transforms.serializer.doctags import DocTagsDocSerializer
...
class DoclingDocument(BaseModel):
    ...
    def get_visualization(
        ...
        from deckling.transforms.visualizer.key_value_visualizer import (
            KeyValueVisualizer,
        )
        from deckling.transforms.visualizer.layout_visualizer import (
            LayoutVisualizer,
        )
        from deckling.transforms.visualizer.reading_order_visualizer import (
