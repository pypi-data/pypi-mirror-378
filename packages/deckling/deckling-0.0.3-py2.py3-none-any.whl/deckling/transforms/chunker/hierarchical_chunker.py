...
from deckling.search.package import VERSION_PATTERN
from deckling.transforms.chunker import BaseChunk, BaseChunker, BaseMeta
from deckling.transforms.serializer.base import (
    BaseDocSerializer,
    BaseSerializerProvider,
    BaseTableSerializer,
    SerializationResult,
)
from deckling.transforms.serializer.common import create_ser_result
from deckling.transforms.serializer.markdown import (
    MarkdownDocSerializer,
    MarkdownParams,
)
from deckling.types import DoclingDocument as DLDocument
from deckling.types.doc.base import ImageRefMode
from deckling.types.doc.document import (
    DocItem,
    DoclingDocument,
    DocumentOrigin,
    InlineGroup,
...
class DocMeta(BaseMeta):
    ...
    schema_name: Literal["deckling.transforms.chunker.DocMeta"] = Field(
        default="deckling.transforms.chunker.DocMeta",
