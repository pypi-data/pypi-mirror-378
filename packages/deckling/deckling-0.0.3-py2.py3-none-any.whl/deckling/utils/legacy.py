...
from deckling.types.doc import (
    BoundingBox,
    CoordOrigin,
    DocItem,
    DocItemLabel,
...
from deckling.types.doc.document import ContentLayer, GroupItem, ListItem, TableData
from deckling.types.legacy_doc.base import (
    BaseCell,
    BaseText,
    Figure,
    GlmTableCell,
...
from deckling.types.legacy_doc.base import Table as DsSchemaTable
from deckling.types.legacy_doc.base import TableCell as DsTableCell
from deckling.types.legacy_doc.document import (
    CCSDocumentDescription as DsDocumentDescription,
)
from deckling.types.legacy_doc.document import CCSFileInfoObject as DsFileInfoObject
from deckling.types.legacy_doc.document import ExportedCCSDocument as DsDocument
