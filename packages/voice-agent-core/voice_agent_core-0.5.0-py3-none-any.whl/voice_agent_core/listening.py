...
def listen_for_wake_word():
    ...
    try:
        ...
        # Cleanly release all audio resources
...
def listen_for_command():
    ...
    # CRITICAL FIX: Make the agent more patient.
    # It will now wait for 2 seconds of silence before considering the phrase complete.
