...
class ECProfinet(BaseEC):
    ...
    def get_profinet_int_input(self, addr: int, length: int) -> List[int]:
        ...
        return self.send_CMD(
            "get_profinet_int_input_registers", {"addr": addr, "length": length}
        )
    ...
    def get_profinet_float_input(self, addr: int, length: int) -> List[float]:
        ...
        """
        return self.send_CMD(
            "get_profinet_float_input_registers", {"addr": addr, "length": length}
        )
    ...
    def get_profinet_int_output(self, addr: int, length: int) -> List[int]:
        ...
        """
        return self.send_CMD(
            "get_profinet_int_output_registers", {"addr": addr, "length": length}
        )

    def set_profinet_int_output(
        self, addr: int, length: int, values: List[int]
    ) -> bool:
        ...
        return self.send_CMD(
            ...
            {"addr": addr, "length": length, "value": values},
        )
    ...
    def get_profinet_float_output(self, addr: int, length: int) -> List[float]:
        ...
        """
        return self.send_CMD(
            "get_profinet_float_output_registers", {"addr": addr, "length": length}
        )

    def set_profinet_float_output(
        self, addr: int, length: int, values: List[float]
    ) -> bool:
