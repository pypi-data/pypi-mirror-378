...
handles database integration, caching, and provides a unified interface for all microservices.
"""
...
from ..providers import LLMProviderFactory, get_llm_provider
        ...
        **kwargs: Any,
        ...
        try:
            ...
            response_data = LLMResponseCreate(
                ...
                usage=LLMUsage(**provider_response.usage)
            ...
            self.logger.info(
                ...
                extra={
                    ...
                    "tokens_used": provider_response.usage.get("total_tokens", 0)
                    if provider_response.usage
                    else 0,
                    "tenant_id": tenant_id,
                    "service_name": service_name,
