...
Current features:
* Jinja2-based HTML templating with theme registry.
* Automatic omission of empty sections (core + extra).
* Optional WeasyPrint HTML->PDF conversion when installed.
* Fallback minimal PDF builder if WeasyPrint unavailable.
"""
