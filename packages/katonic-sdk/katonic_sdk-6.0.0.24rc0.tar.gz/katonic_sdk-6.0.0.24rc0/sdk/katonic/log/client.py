...
class MLClient:
    ...
    def __init__(
        ...
        # Logger removedinfo("MLClient successfully instantiated")
    ...
    def set_model_tags(self, run_id):
        ...
        # Logger removedinfo(f"logged tags: {tags.keys()}")
        try:
        ...
        # Logger removedinfo(f"logged artifacts: {self.artifact_paths.keys()}")
        try:
            [
