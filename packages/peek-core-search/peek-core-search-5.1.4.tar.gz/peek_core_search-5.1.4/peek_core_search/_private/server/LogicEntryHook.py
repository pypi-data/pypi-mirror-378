...
from peek_core_search._private.storage.Setting import KEYWORD_COMPILER_ENABLED
from peek_core_search._private.storage.Setting import OBJECT_COMPILER_ENABLED
from peek_core_search._private.storage.Setting import globalProperties
...
from .controller.SearchObjectImportController import (
...
class LogicEntryHook(
    ...
    def start(self):
        ...
        self._loadedObjects += ClientChunkLoadRpc(
        ...
        clientSearchIndexChunkUpdateHandler = (
            ClientSearchIndexChunkUpdateHandler(self.dbSessionCreator)
        )
        ...
        clientSearchObjectChunkUpdateHandler = (
            ClientSearchObjectChunkUpdateHandler(self.dbSessionCreator)
        )
