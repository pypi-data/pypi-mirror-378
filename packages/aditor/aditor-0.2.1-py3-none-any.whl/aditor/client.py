...
class Aditor:
    ...
    def __init__(self, base_url: str = "http://localhost:8888", memory_file: str = "aditor_memory.json"):
        """
        初始化客户端
    ...
    def login(self, phone: str, secret: str) -> bool:
        """
        用户登录
    ...
    def run(self, 
        ...
        Returns:
            dict: {"success": bool, "answer": str|None, "token": float|None}
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                try:
                    ...
                    token_used = None
                logger.info("API调用成功")
                return {"success": True, "answer": answer, "token": token_used}
                ...
                return {"success": False, "answer": None, "token": None}
    ...
    def export_memories(self, export_file: str) -> bool:
        ...
        try:
            ...
            with open(export_path, 'w', encoding='utf-8') as f:
                f.write(f"Aditor 记忆导出\n")
                f.write(f"导出时间: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n")
                f.write(f"记忆总数: {len(self.memory_data)}\n")
                f.write("=" * 50 + "\n\n")
