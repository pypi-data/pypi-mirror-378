...
class AsyncInstructionsAdmin:
    ...
    async def get_instruction_by_id(self, instruction_id: str, integration_name: str = None) -> Instruction | None:
        """
    ...
    async def remove_ai_config(
        self, instruction_id: str, model_alias: str, integration_name: str = None
    ) -> Instruction:
        """
        Remove AI Config.
