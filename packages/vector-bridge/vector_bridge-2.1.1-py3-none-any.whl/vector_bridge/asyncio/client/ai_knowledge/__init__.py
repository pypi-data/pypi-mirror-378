...
from vector_bridge.asyncio.client.ai_knowledge.database import \
    AsyncDatabaseAIKnowledge
from vector_bridge.asyncio.client.ai_knowledge.file_storage import \
...
class AsyncAIKnowledge:
    ...
    def __init__(self, client: AsyncVectorBridgeClient):
        ...
        self.database = AsyncDatabaseAIKnowledge(client)
