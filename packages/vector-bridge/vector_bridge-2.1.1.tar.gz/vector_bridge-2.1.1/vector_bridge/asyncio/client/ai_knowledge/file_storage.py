...
class AsyncFileStorageAIKnowledge:
    ...
    async def create_files_reference(
        ...
        url = f"{self.client.base_url}/v1/admin/ai-knowledge/file/create-reference"
        params = {
            "from_uuid": from_uuid,
            "to_uuid": to_uuid,
            "metadata": metadata,
    ...
    async def delete_files_reference(
        ...
        url = f"{self.client.base_url}/v1/admin/ai-knowledge/file/delete-reference"
        params = {
            "from_uuid": from_uuid,
            "to_uuid": to_uuid,
            "integration_name": integration_name,
    ...
    async def execute_files_and_folders_list_query(
        ...
        **kwargs,
        ...
        url = f"{self.client.base_url}/v1/admin/ai-knowledge/files-system-item/list-query"
        params = {"integration_name": integration_name}
