...
class FunctionClient:
    ...
    def get_function_by_name(self, function_name: str, integration_name: str = None) -> Function | None:
        """
    ...
    def get_function_by_id(self, function_id: str, integration_name: str = None) -> Function | None:
        """
