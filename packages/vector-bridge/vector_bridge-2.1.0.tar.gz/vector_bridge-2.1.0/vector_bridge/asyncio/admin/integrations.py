...
from vector_bridge.schema.helpers.enums import MessageStorageMode, WeaviateKey
...
class AsyncIntegrationsAdmin:
    ...
    async def get_integration_by_name(self, integration_name: str = None) -> Integration | None:
        """
