...
result = client.functions.run_function(
    ...
    function_args={"a": 10, "b": 5, "operation": "multiply"}
)
...
class ReportWorkflow(Workflow):
    ...
    def generate(self, data):
        return client.functions.run_function("generate_pdf", {"markdown_content": "..."})
...
class AsyncReportWorkflow(AsyncWorkflow):
    ...
    async def generate(self, data):
        return await client.functions.run_function("generate_pdf", {"markdown_content": "..."})
...
res = client.functions.run_function("calculator", {"a": 2, "b": 8, "operation": "mul"})

# Async
# res = await client.functions.run_function("calculator", {"a": 2, "b": 8, "operation": "mul"})
```
