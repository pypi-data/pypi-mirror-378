...
def setup_test_environment(output_dir: Path) -> None:
    ...
    # Copy comprehensive_config.json from examples (if it exists)
    comprehensive_config_src = examples_src_root / "comprehensive_config.json"
    if comprehensive_config_src.exists():
        shutil.copy2(comprehensive_config_src, output_dir)
        print("✅ Copied comprehensive_config.json")
