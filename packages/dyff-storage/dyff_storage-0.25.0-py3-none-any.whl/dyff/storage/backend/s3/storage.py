...
class S3StorageBackend(StorageBackend):
    ...
    def signed_url_for_artifact_upload(
        ...
        *,
        ...
        file = File(mediaType=artifact.kind, path=artifact.path, digest=artifact.digest)
        return self.signed_url_for_file_upload(
            self,
            file,
            storage_path,
