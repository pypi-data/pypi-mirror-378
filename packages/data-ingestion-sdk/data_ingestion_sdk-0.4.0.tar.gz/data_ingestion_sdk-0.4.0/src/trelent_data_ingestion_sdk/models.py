...
class S3CreateKeysInput(BaseModel):
    type: Literal["s3"]
    bucket_name: str = Field(..., description="The name of the bucket to connect to")
    object_keys: list[str] = Field(..., description="The keys of the objects to connect to")


class S3CreatePrefixInput(BaseModel):
    type: Literal["s3_prefix"]
    bucket_name: str = Field(..., description="The name of the bucket to connect to")
    prefix: str = Field(..., description="The prefix of the objects to connect to")
