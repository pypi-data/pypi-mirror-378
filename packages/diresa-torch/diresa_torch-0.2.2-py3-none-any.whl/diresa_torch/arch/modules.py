...
class DistanceLayer(nn.Module):
    ...
    def forward(self, x1, x2, y1, y2):
        ...
        dist1 = torch.sum(torch.reshape(dist1, [dist1.shape[0], -1]), dim=1)  # sum over all dims, except 0
        dist2 = torch.sum(torch.reshape(dist2, [dist2.shape[0], -1]), dim=1)  # sum over all dims, except 0
