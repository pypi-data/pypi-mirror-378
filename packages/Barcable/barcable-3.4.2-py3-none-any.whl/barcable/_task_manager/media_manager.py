...
from Barcable._client.environment_variables import BARCABLE_MEDIA_UPLOAD_ENABLED
from Barcable._utils import _get_timestamp
from Barcable.api import GetMediaUploadUrlRequest, PatchMediaBody
from Barcable.api.client import FernBarcable
from Barcable.api.core import ApiError
from Barcable.api.resources.media.types.media_content_type import MediaContentType
    ...
    def _find_and_process_media(
        ...
        *,
        ...
        def _process_data_recursively(data: Any, level: int) -> Any:
            ...
            if isinstance(data, BarcableMedia):
                self._process_media(
                    media=data,
                    trace_id=trace_id,
