"""Barcable experiment functionality for running and evaluating tasks on datasets.

This module provides the core experiment functionality for the Barcable Python SDK,
...
from Barcable.api import ScoreDataType

if TYPE_CHECKING:
    from Barcable._client.datasets import DatasetItemClient


class LocalExperimentItem(TypedDict, total=False):
    """Structure for local experiment data items (not from Barcable datasets).

    This TypedDict defines the structure for experiment items when using local data
    rather than Barcable-hosted datasets. All fields are optional to provide
...
- DatasetItemClient: Items from Barcable datasets with .input, .expected_output, .metadata attributes
"""
...
- List[DatasetItemClient]: Items from a Barcable dataset (typically from dataset.items)
"""
...
class Evaluation:
    ...
    Attributes:
        ...
        comment: Optional human-readable explanation of the evaluation result.
            ...
            special conditions. Displayed in Barcable UI for interpretability.
        ...
        config_id: Optional Barcable score config ID.

    Examples:
        Basic accuracy evaluation:
        ```python
        from Barcable import Evaluation
...
class ExperimentItemResult:
    ...
    Attributes:
        item: The original experiment item that was processed. Can be either
            ...
            or a DatasetItemClient from Barcable datasets.
        ...
        trace_id: Optional Barcable trace ID for this item's execution. Used
            to link the experiment result with the detailed trace in Barcable UI.
        dataset_run_id: Optional dataset run ID if this item was part of a
            Barcable dataset. None for local experiments.
    ...
    Examples:
        ...
        # Barcable dataset item (object with attributes)
        else:
            input_data = item_result.item.input
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            trace_id: Optional Barcable trace ID for this item's execution.
            dataset_run_id: Optional dataset run ID if this item was part of a Barcable dataset.
...
class ExperimentResult:
    ...
    Attributes:
        ...
        dataset_run_id: Optional ID of the dataset run in Barcable (when using Barcable datasets).
        dataset_run_url: Optional direct URL to view the experiment results in Barcable UI.
    ...
    Examples:
        ...
        Usage with Barcable datasets:
        ```python
        dataset = Barcable.get_dataset("qa-eval-set")
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            dataset_run_id: Optional ID of the dataset run (for Barcable datasets).
            dataset_run_url: Optional URL to view results in Barcable UI.
        """
        self.name = name
    ...
    def format(self, *, include_item_results: bool = False) -> str:
        ...
        - Links to view detailed results in Barcable UI (when available)
        ...
        Returns:
            ...
            - Dataset run URL for viewing in Barcable UI (if applicable)
        ...
        **kwargs: Dict[str, Any],
        ...
        Args:
            item: The experiment item to process. Can be either:
                ...
                - Barcable DatasetItem object with .input, .expected_output attributes
        ...
        Returns:
            ...
            - Traced automatically in Barcable for observability
        ...
        **kwargs: Dict[str, Any],
        ...
        Args:
            item_results: List of results from all successfully processed experiment items.
                ...
                - trace_id: Barcable trace ID for this execution
                - dataset_run_id: Dataset run ID (if using Barcable datasets)
...
async def _run_evaluator(
    ...
    try:
        ...
        logging.getLogger("Barcable").error(f"Evaluator {evaluator_name} failed: {e}")
        return []
...
def create_evaluator_from_autoevals(
    ...
    """Create a Barcable evaluator from an autoevals evaluator.
    ...
    Returns:
        A Barcable-compatible evaluator function
    """

    def Barcable_evaluator(
        *,
        input: Any,
        output: Any,
        expected_output: Any,
        metadata: Optional[Dict[str, Any]],
        **Barcable_kwargs: Dict[str, Any],
    ) -> Evaluation:
