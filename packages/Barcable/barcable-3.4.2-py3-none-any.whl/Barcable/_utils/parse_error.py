...
# our own api errors
from Barcable._utils.request import APIError, APIErrors
from Barcable.api.core import ApiError

# fern api errors
from Barcable.api.resources.commons.errors import (
    AccessDeniedError,
    Error,
...
from Barcable.api.resources.health.errors import ServiceUnavailableError

SUPPORT_URL = "https://Barcable.com/support"
API_DOCS_URL = "https://api.reference.Barcable.com"
RBAC_DOCS_URL = "https://Barcable.com/docs/rbac"
INSTALLATION_DOCS_URL = "https://Barcable.com/docs/sdk/typescript/guide"
RATE_LIMITS_URL = "https://Barcable.com/faq/all/api-limits"
PYPI_PACKAGE_URL = "https://pypi.org/project/Barcable/"
