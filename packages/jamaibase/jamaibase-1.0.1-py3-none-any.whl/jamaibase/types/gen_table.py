...
class LLMGenConfig(ChatRequestBase):
    ...
    #     False,
    #     description="Set `True` to enable agent mode with web search and code interpreter tools. "
    #     "Whether tools are actually used depends on the prompt and agent reasoning.",
    # )
...
# GenConfig = LLMGenConfig | EmbedGenConfig | CodeGenConfig | PythonGenConfig
GenConfig = LLMGenConfig | EmbedGenConfig | PythonGenConfig
