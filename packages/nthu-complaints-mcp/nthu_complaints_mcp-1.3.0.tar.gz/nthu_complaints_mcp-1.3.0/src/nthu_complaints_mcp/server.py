...
def create_server() -> FastMCP:
    ...
    def mcp_submit_complaint(
        ...
        return submit_complaint(
            session_token, title, description, category, department,
            priority, anonymous, contact_info
        )
    ...
    def mcp_server_status() -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "project_id": firebase_client._app.project_id if firebase_client._app else None
            }
