...
class Shell:
    ...
    def get_preferred_encoding(self) -> str:
        ...
        This is used for decoding subprocess output or files
    ...
    def get_locale_encoding(self) -> str:
        """
        Returns the system locale encoding.
    ...
    def get_filesystem_encoding(self) -> str:
        """
        Returns the encoding used to convert between str filenames and bytes
        filenames inside Python.
        """
        return FS_ENCODING
