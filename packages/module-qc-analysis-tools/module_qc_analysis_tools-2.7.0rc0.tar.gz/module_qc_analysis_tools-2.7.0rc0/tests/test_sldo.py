...
def test_sldo_lin_fit_min_Iin():
    """import the linear function used in the sldo analysis used to determine the min Iin to pass Ishunt QC criteria and test its functionality"""
    ...
    assert (
        (intersections, chi2) == ([-999, 2.5], [-999, 0.58212])
