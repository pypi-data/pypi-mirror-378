...
setup(
    ...
    description="A comprehensive Python package for collecting real estate data from various sources",
    ...
    keywords="real estate, zillow, data collection, web scraping, property data, real estate api",
