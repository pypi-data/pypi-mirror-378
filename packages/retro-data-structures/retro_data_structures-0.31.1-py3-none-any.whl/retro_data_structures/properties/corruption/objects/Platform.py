...
if typing.TYPE_CHECKING:
    class PlatformJson(typing_extensions.TypedDict):
        ...
        unknown_0x6b5e87a7: float
        look_at_velocity: float
...
class Platform(BaseObjectType):
    ...
    unknown_0x6b5e87a7: float = dataclasses.field(default=1800.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x6b5e87a7, original_name='Unknown'
        ),
    })
    look_at_velocity: float = dataclasses.field(default=30.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x3dc75733, original_name='LookAtVelocity'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, collision_box, collision_offset, model, animation, actor_information, collision_model, health, vulnerability, x_ray_transparency, maximum_splashes, splash_generation_rate, render_rain_splashes, unknown_0xf203bc81, motion_properties, unknown_0x24fdeea1, random_animation_offset, orbit_offset_local, orbit_offset, unknown_0x6b5e87a7, look_at_velocity)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            unknown_0x6b5e87a7=json_data['unknown_0x6b5e87a7'],
            look_at_velocity=json_data['look_at_velocity'],
        )
...
def _decode_unknown_0x6b5e87a7(data: typing.BinaryIO, property_size: int) -> float:
    return struct.unpack('>f', data.read(4))[0]


def _decode_look_at_velocity(data: typing.BinaryIO, property_size: int) -> float:
    return struct.unpack('>f', data.read(4))[0]
