...
if typing.TYPE_CHECKING:
    class ContextActionWeldingJson(typing_extensions.TypedDict):
...
class ContextActionWelding(BaseObjectType):
    ...
    unknown_struct24: UnknownStruct24 = dataclasses.field(default_factory=UnknownStruct24, metadata={
        'reflection': FieldReflection[UnknownStruct24](
            UnknownStruct24, id=0x2f74dc89, original_name='UnknownStruct24', from_json=UnknownStruct24.from_json, to_json=UnknownStruct24.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, actor_information, unknown_struct24)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("ContextActionWeldingJson", data)
        return cls(
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x2f74dc89: ('unknown_struct24', UnknownStruct24.from_stream),
}
