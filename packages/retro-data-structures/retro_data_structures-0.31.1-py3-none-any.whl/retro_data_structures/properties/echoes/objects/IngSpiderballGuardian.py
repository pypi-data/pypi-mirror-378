...
class IngSpiderballGuardian(BaseObjectType):
    ...
    unknown_struct31: UnknownStruct31 = dataclasses.field(default_factory=UnknownStruct31, metadata={
        'reflection': FieldReflection[UnknownStruct31](
            UnknownStruct31, id=0xa1389799, original_name='UnknownStruct31', from_json=UnknownStruct31.from_json, to_json=UnknownStruct31.to_json
        ),
    })
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xa1389799: ('unknown_struct31', UnknownStruct31.from_stream),
}
