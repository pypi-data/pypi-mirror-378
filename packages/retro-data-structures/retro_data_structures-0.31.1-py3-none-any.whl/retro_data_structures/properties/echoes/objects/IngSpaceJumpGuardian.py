...
if typing.TYPE_CHECKING:
    ...
    class IngSpaceJumpGuardianJson(typing_extensions.TypedDict):
...
class IngSpaceJumpGuardian(BaseObjectType):
    ...
    unknown_struct32: UnknownStruct32 = dataclasses.field(default_factory=UnknownStruct32, metadata={
        'reflection': FieldReflection[UnknownStruct32](
            UnknownStruct32, id=0xf9837ab3, original_name='UnknownStruct32', from_json=UnknownStruct32.from_json, to_json=UnknownStruct32.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, patterned, actor_information, unknown_struct32)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("IngSpaceJumpGuardianJson", data)
        return cls(
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            (self.unknown_struct32.dependencies_for, "unknown_struct32", "UnknownStruct32"),
        ]:
            try:
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xf9837ab3: ('unknown_struct32', UnknownStruct32.from_stream),
}
