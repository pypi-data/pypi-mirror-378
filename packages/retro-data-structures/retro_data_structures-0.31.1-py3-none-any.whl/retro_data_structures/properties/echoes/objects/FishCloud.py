...
class FishCloud(BaseObjectType):
    ...
    fish_count: float = dataclasses.field(default=20.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0xf1c07275, original_name='FishCount'
        ),
    })
    ...
    death_sound: int = dataclasses.field(default=0, metadata={
        'sound': True, 'reflection': FieldReflection[int](
            int, id=0x3de26fc8, original_name='DeathSound'
        ),
    })
    ...
    def _dependencies_for_fish_model(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        yield from asset_manager.get_dependencies_for_asset(self.fish_model)

    def _dependencies_for_death_effect0(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        yield from asset_manager.get_dependencies_for_asset(self.death_effect0)

    def _dependencies_for_death_effect1(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        yield from asset_manager.get_dependencies_for_asset(self.death_effect1)

    def _dependencies_for_death_effect2(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        yield from asset_manager.get_dependencies_for_asset(self.death_effect2)

    def _dependencies_for_death_effect3(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
...
def _decode_fish_count(data: typing.BinaryIO, property_size: int) -> float:
...
def _decode_death_sound(data: typing.BinaryIO, property_size: int) -> int:
    return struct.unpack('>l', data.read(4))[0]
