...
class BallTrigger(BaseObjectType):
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, trigger, attraction_force, attraction_angle, attraction_distance, attraction_direction, no_ball_movement, bounds_size_multiplier)
