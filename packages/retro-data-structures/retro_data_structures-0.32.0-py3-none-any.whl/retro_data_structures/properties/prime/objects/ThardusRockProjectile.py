...
class ThardusRockProjectile(BaseObjectType):
    ...
    model: AssetId = dataclasses.field(default=default_asset_id, metadata={
        'asset_types': ['CMDL'], 'reflection': FieldReflection[AssetId](
            AssetId, id=0x00000009, original_name='Model'
        ),
    })
    afsm: AssetId = dataclasses.field(default=default_asset_id, metadata={
        'asset_types': ['AFSM'], 'reflection': FieldReflection[AssetId](
            AssetId, id=0x0000000a, original_name='AFSM'
        ),
    })
    ...
    def _dependencies_for_afsm(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
