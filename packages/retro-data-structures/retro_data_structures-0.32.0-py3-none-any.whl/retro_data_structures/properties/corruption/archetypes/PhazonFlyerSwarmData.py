...
if typing.TYPE_CHECKING:
    class PhazonFlyerSwarmDataJson(typing_extensions.TypedDict):
        unknown: float
...
class PhazonFlyerSwarmData(BaseProperty):
    unknown: float = dataclasses.field(default=4.0, metadata={
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("PhazonFlyerSwarmDataJson", data)
        return cls(
