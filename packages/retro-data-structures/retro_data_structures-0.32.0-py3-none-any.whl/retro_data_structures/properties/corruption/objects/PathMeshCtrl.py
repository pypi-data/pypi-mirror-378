...
if typing.TYPE_CHECKING:
    class PathMeshCtrlJson(typing_extensions.TypedDict):
...
class PathMeshCtrl(BaseObjectType):
    ...
    initial_count: int = dataclasses.field(default=1, metadata={
        'reflection': FieldReflection[int](
            int, id=0x7a6e0de9, original_name='InitialCount'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, type, initial_count)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("PathMeshCtrlJson", data)
        return cls(
