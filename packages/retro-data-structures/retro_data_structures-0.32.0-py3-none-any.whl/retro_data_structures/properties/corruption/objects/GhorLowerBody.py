...
if typing.TYPE_CHECKING:
    class GhorLowerBodyJson(typing_extensions.TypedDict):
...
class GhorLowerBody(BaseObjectType):
    ...
    unknown_struct36: UnknownStruct36 = dataclasses.field(default_factory=UnknownStruct36, metadata={
        'reflection': FieldReflection[UnknownStruct36](
            UnknownStruct36, id=0x99fd196f, original_name='UnknownStruct36', from_json=UnknownStruct36.from_json, to_json=UnknownStruct36.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, actor_information, patterned, ai_difficulty_settings, unknown_struct36)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("GhorLowerBodyJson", data)
        return cls(
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x99fd196f: ('unknown_struct36', UnknownStruct36.from_stream),
}
