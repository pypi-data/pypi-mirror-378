...
class RoomAcoustics(BaseObjectType):
    ...
    priority: Priority = dataclasses.field(default=Priority.Unknown2, metadata={
        'reflection': FieldReflection[Priority](
            Priority, id=0x0be7ca9e, original_name='Priority', from_json=Priority.from_json, to_json=Priority.to_json
        ),
    })
    unknown_struct54: UnknownStruct54 = dataclasses.field(default_factory=UnknownStruct54, metadata={
        'reflection': FieldReflection[UnknownStruct54](
            UnknownStruct54, id=0x555b055e, original_name='UnknownStruct54', from_json=UnknownStruct54.from_json, to_json=UnknownStruct54.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        priority = Priority.from_stream(data)
...
def _decode_priority(data: typing.BinaryIO, property_size: int) -> Priority:
    return Priority.from_stream(data)


_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    0x255a4580: ('editor_properties', EditorProperties.from_stream),
    0xbe7ca9e: ('priority', _decode_priority),
    0x555b055e: ('unknown_struct54', UnknownStruct54.from_stream),
}
