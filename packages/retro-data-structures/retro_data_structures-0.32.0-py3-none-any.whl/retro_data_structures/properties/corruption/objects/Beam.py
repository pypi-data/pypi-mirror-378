...
if typing.TYPE_CHECKING:
    class BeamJson(typing_extensions.TypedDict):
...
class Beam(BaseObjectType):
    ...
    unknown_struct15: UnknownStruct15 = dataclasses.field(default_factory=UnknownStruct15, metadata={
        'reflection': FieldReflection[UnknownStruct15](
            UnknownStruct15, id=0xed3c4f85, original_name='UnknownStruct15', from_json=UnknownStruct15.from_json, to_json=UnknownStruct15.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, unknown_struct15)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("BeamJson", data)
        return cls(
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xed3c4f85: ('unknown_struct15', UnknownStruct15.from_stream),
}
