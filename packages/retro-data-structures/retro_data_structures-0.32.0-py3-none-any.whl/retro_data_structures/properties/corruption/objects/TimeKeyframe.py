...
if typing.TYPE_CHECKING:
    class TimeKeyframeJson(typing_extensions.TypedDict):
...
class TimeKeyframe(BaseObjectType):
    ...
    time: float = dataclasses.field(default=1.0, metadata={
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, time)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("TimeKeyframeJson", data)
        return cls(
