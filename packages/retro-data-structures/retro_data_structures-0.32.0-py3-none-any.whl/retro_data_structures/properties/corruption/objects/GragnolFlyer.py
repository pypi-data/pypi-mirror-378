...
if typing.TYPE_CHECKING:
    class GragnolFlyerJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        patterned: json_util.JsonObject
        actor_information: json_util.JsonObject
        gragnol_flyer_properties: json_util.JsonObject
...
class GragnolFlyer(BaseObjectType):
    ...
    gragnol_flyer_properties: GragnolFlyerData = dataclasses.field(default_factory=GragnolFlyerData, metadata={
        'reflection': FieldReflection[GragnolFlyerData](
            GragnolFlyerData, id=0x47ed32f2, original_name='GragnolFlyerProperties', from_json=GragnolFlyerData.from_json, to_json=GragnolFlyerData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, patterned, actor_information, gragnol_flyer_properties)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("GragnolFlyerJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            patterned=PatternedAITypedef.from_json(json_data['patterned']),
            actor_information=ActorParameters.from_json(json_data['actor_information']),
            gragnol_flyer_properties=GragnolFlyerData.from_json(json_data['gragnol_flyer_properties']),
        )
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x47ed32f2: ('gragnol_flyer_properties', GragnolFlyerData.from_stream),
}
