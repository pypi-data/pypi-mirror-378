...
if typing.TYPE_CHECKING:
    class GellSacJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        patterned: json_util.JsonObject
        actor_information: json_util.JsonObject
        wall_crawler_data: json_util.JsonObject
        unknown_struct43: json_util.JsonObject
...
class GellSac(BaseObjectType):
    ...
    unknown_struct43: UnknownStruct43 = dataclasses.field(default_factory=UnknownStruct43, metadata={
        'reflection': FieldReflection[UnknownStruct43](
            UnknownStruct43, id=0x2766cd96, original_name='UnknownStruct43', from_json=UnknownStruct43.from_json, to_json=UnknownStruct43.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, patterned, actor_information, wall_crawler_data, unknown_struct43)
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x2766cd96: ('unknown_struct43', UnknownStruct43.from_stream),
}
