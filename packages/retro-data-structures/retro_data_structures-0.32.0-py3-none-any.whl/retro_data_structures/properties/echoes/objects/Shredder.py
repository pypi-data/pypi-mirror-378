...
if typing.TYPE_CHECKING:
    ...
    class ShredderJson(typing_extensions.TypedDict):
...
class Shredder(BaseObjectType):
    ...
    data: UnknownStruct39 = dataclasses.field(default_factory=UnknownStruct39, metadata={
        'reflection': FieldReflection[UnknownStruct39](
            UnknownStruct39, id=0xab24a926, original_name='Data', from_json=UnknownStruct39.from_json, to_json=UnknownStruct39.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        data_ = UnknownStruct39.from_stream(data, property_size)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("ShredderJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            patterned=PatternedAITypedef.from_json(json_data['patterned']),
            actor_information=ActorParameters.from_json(json_data['actor_information']),
            data=UnknownStruct39.from_json(json_data['data']),
        )
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            (self.data.dependencies_for, "data", "UnknownStruct39"),
        ]:
            try:
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xab24a926: ('data', UnknownStruct39.from_stream),
}
