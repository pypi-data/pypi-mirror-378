...
class Ripper(BaseObjectType):
    ...
    grapple_info: GrappleParameters = dataclasses.field(default_factory=GrappleParameters, metadata={
        'reflection': FieldReflection[GrappleParameters](
            GrappleParameters, id=0x6a2872d8, original_name='GrappleInfo', from_json=GrappleParameters.from_json, to_json=GrappleParameters.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, flavor, patterned, actor_information, grapple_info)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            grapple_info=GrappleParameters.from_json(json_data['grapple_info']),
        )
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            (self.grapple_info.dependencies_for, "grapple_info", "GrappleParameters"),
        ]:
            try:
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x6a2872d8: ('grapple_info', GrappleParameters.from_stream),
}
