...
if typing.TYPE_CHECKING:
    ...
    class IngPuddleJson(typing_extensions.TypedDict):
...
class IngPuddle(BaseObjectType):
    ...
    unknown_struct30: UnknownStruct30 = dataclasses.field(default_factory=UnknownStruct30, metadata={
        'reflection': FieldReflection[UnknownStruct30](
            UnknownStruct30, id=0xd520975d, original_name='UnknownStruct30', from_json=UnknownStruct30.from_json, to_json=UnknownStruct30.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        property_id, property_size = struct.unpack(">LH", data.read(6))
        assert property_id == 0xd520975d
        unknown_struct30 = UnknownStruct30.from_stream(data, property_size)
    
        return cls(editor_properties, actor_information, unknown_struct30)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("IngPuddleJson", data)
        return cls(
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            (self.unknown_struct30.dependencies_for, "unknown_struct30", "UnknownStruct30"),
        ]:
            try:
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xd520975d: ('unknown_struct30', UnknownStruct30.from_stream),
}
