...
if typing.TYPE_CHECKING:
    ...
    class RubiksPuzzleJson(typing_extensions.TypedDict):
...
class RubiksPuzzle(BaseObjectType):
    ...
    unknown_struct35: UnknownStruct35 = dataclasses.field(default_factory=UnknownStruct35, metadata={
        'reflection': FieldReflection[UnknownStruct35](
            UnknownStruct35, id=0x9fcd4e38, original_name='UnknownStruct35', from_json=UnknownStruct35.from_json, to_json=UnknownStruct35.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, unknown_struct35)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("RubiksPuzzleJson", data)
        return cls(
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            (self.unknown_struct35.dependencies_for, "unknown_struct35", "UnknownStruct35"),
        ]:
            try:
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x9fcd4e38: ('unknown_struct35', UnknownStruct35.from_stream),
}
