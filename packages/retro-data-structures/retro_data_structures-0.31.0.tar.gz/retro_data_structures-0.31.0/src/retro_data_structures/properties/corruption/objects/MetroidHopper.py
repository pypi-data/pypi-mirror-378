...
if typing.TYPE_CHECKING:
    class MetroidHopperJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        patterned: json_util.JsonObject
        actor_information: json_util.JsonObject
        metroid_hopper_data: json_util.JsonObject
...
class MetroidHopper(BaseObjectType):
    ...
    metroid_hopper_data: MetroidHopperData = dataclasses.field(default_factory=MetroidHopperData, metadata={
        'reflection': FieldReflection[MetroidHopperData](
            MetroidHopperData, id=0xd9488fbd, original_name='MetroidHopperData', from_json=MetroidHopperData.from_json, to_json=MetroidHopperData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, patterned, actor_information, metroid_hopper_data)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("MetroidHopperJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            patterned=PatternedAITypedef.from_json(json_data['patterned']),
            actor_information=ActorParameters.from_json(json_data['actor_information']),
            metroid_hopper_data=MetroidHopperData.from_json(json_data['metroid_hopper_data']),
        )
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xd9488fbd: ('metroid_hopper_data', MetroidHopperData.from_stream),
}
