...
if typing.TYPE_CHECKING:
    class NoseTurretJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        ptc_nose_turret_data: json_util.JsonObject
...
class NoseTurret(BaseObjectType):
    ...
    ptc_nose_turret_data: PTCNoseTurretData = dataclasses.field(default_factory=PTCNoseTurretData, metadata={
        'reflection': FieldReflection[PTCNoseTurretData](
            PTCNoseTurretData, id=0x3e5dd208, original_name='PTCNoseTurretData', from_json=PTCNoseTurretData.from_json, to_json=PTCNoseTurretData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, ptc_nose_turret_data, patterned, actor_information)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("NoseTurretJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            ptc_nose_turret_data=PTCNoseTurretData.from_json(json_data['ptc_nose_turret_data']),
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x3e5dd208: ('ptc_nose_turret_data', PTCNoseTurretData.from_stream),
