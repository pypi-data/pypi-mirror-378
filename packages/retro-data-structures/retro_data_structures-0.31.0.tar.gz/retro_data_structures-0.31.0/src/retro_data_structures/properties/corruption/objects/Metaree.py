...
if typing.TYPE_CHECKING:
    class MetareeJson(typing_extensions.TypedDict):
        ...
        unknown_struct47: json_util.JsonObject
...
class Metaree(BaseObjectType):
    ...
    unknown_struct47: UnknownStruct47 = dataclasses.field(default_factory=UnknownStruct47, metadata={
        'reflection': FieldReflection[UnknownStruct47](
            UnknownStruct47, id=0xe99c264a, original_name='UnknownStruct47', from_json=UnknownStruct47.from_json, to_json=UnknownStruct47.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, patterned, actor_information, unknown_struct47)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            unknown_struct47=UnknownStruct47.from_json(json_data['unknown_struct47']),
        )
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xe99c264a: ('unknown_struct47', UnknownStruct47.from_stream),
}
