...
if typing.TYPE_CHECKING:
    class MinorIngJson(typing_extensions.TypedDict):
        ...
        unknown_struct45: json_util.JsonObject
...
class MinorIng(BaseObjectType):
    ...
    unknown_struct45: UnknownStruct45 = dataclasses.field(default_factory=UnknownStruct45, metadata={
        'reflection': FieldReflection[UnknownStruct45](
            UnknownStruct45, id=0xa3a2ac3f, original_name='UnknownStruct45', from_json=UnknownStruct45.from_json, to_json=UnknownStruct45.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, patterned, actor_information, unknown_struct45)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            unknown_struct45=UnknownStruct45.from_json(json_data['unknown_struct45']),
        )
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xa3a2ac3f: ('unknown_struct45', UnknownStruct45.from_stream),
}
