...
if typing.TYPE_CHECKING:
    class GhorUpperBodyJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        actor_information: json_util.JsonObject
        patterned: json_util.JsonObject
        ai_difficulty_settings: json_util.JsonObject
...
class GhorUpperBody(BaseObjectType):
    ...
    ai_difficulty_settings: AiDifficultySettings = dataclasses.field(default_factory=AiDifficultySettings, metadata={
        'reflection': FieldReflection[AiDifficultySettings](
            AiDifficultySettings, id=0x42691490, original_name='AiDifficultySettings', from_json=AiDifficultySettings.from_json, to_json=AiDifficultySettings.to_json
        ),
    })
    unknown_struct42: UnknownStruct42 = dataclasses.field(default_factory=UnknownStruct42, metadata={
        'reflection': FieldReflection[UnknownStruct42](
            UnknownStruct42, id=0xfc135e9b, original_name='UnknownStruct42', from_json=UnknownStruct42.from_json, to_json=UnknownStruct42.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, actor_information, patterned, ai_difficulty_settings, unknown_struct42)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("GhorUpperBodyJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            actor_information=ActorParameters.from_json(json_data['actor_information']),
            patterned=PatternedAITypedef.from_json(json_data['patterned']),
            ai_difficulty_settings=AiDifficultySettings.from_json(json_data['ai_difficulty_settings']),
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x42691490: ('ai_difficulty_settings', AiDifficultySettings.from_stream),
    0xfc135e9b: ('unknown_struct42', UnknownStruct42.from_stream),
}
