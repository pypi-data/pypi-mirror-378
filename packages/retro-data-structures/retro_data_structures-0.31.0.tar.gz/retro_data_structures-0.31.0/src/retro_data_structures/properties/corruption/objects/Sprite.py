...
if typing.TYPE_CHECKING:
    class SpriteJson(typing_extensions.TypedDict):
...
class Sprite(BaseObjectType):
    ...
    unknown_struct64: UnknownStruct64 = dataclasses.field(default_factory=UnknownStruct64, metadata={
        'reflection': FieldReflection[UnknownStruct64](
            UnknownStruct64, id=0xd42b76ff, original_name='UnknownStruct64', from_json=UnknownStruct64.from_json, to_json=UnknownStruct64.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, unknown_struct64, patterned, actor_information)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("SpriteJson", data)
        return cls(
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xd42b76ff: ('unknown_struct64', UnknownStruct64.from_stream),
