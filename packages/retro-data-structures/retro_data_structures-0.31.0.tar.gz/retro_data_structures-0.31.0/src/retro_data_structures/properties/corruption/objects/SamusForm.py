...
if typing.TYPE_CHECKING:
    class SamusFormJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        actor_information: json_util.JsonObject
        patterned: json_util.JsonObject
        unknown_struct57: json_util.JsonObject
...
class SamusForm(BaseObjectType):
    ...
    unknown_struct57: UnknownStruct57 = dataclasses.field(default_factory=UnknownStruct57, metadata={
        'reflection': FieldReflection[UnknownStruct57](
            UnknownStruct57, id=0x7efc051a, original_name='UnknownStruct57', from_json=UnknownStruct57.from_json, to_json=UnknownStruct57.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, actor_information, patterned, unknown_struct57)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("SamusFormJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            actor_information=ActorParameters.from_json(json_data['actor_information']),
            patterned=PatternedAITypedef.from_json(json_data['patterned']),
            unknown_struct57=UnknownStruct57.from_json(json_data['unknown_struct57']),
        )
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x7efc051a: ('unknown_struct57', UnknownStruct57.from_stream),
}
