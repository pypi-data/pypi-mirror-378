...
if typing.TYPE_CHECKING:
    class SteamDroneJson(typing_extensions.TypedDict):
...
class SteamDrone(BaseObjectType):
    ...
    unknown_struct61: UnknownStruct61 = dataclasses.field(default_factory=UnknownStruct61, metadata={
        'reflection': FieldReflection[UnknownStruct61](
            UnknownStruct61, id=0xa23f161c, original_name='UnknownStruct61', from_json=UnknownStruct61.from_json, to_json=UnknownStruct61.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, patterned, actor_information, unknown_struct61)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("SteamDroneJson", data)
        return cls(
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xa23f161c: ('unknown_struct61', UnknownStruct61.from_stream),
}
