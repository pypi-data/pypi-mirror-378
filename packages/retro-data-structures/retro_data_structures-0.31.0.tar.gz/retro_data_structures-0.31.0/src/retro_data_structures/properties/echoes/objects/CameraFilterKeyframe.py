...
class CameraFilterKeyframe(BaseObjectType):
    ...
    filter_shape: FilterShape = dataclasses.field(default=FilterShape.FullScreen, metadata={
        'reflection': FieldReflection[FilterShape](
            FilterShape, id=0x6a3e9a3d, original_name='FilterShape', from_json=FilterShape.from_json, to_json=FilterShape.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, filter_type, filter_shape, filter_stage, which_filter_group, color, interpolate_in_time, interpolate_out_time, texture)
