...
if typing.TYPE_CHECKING:
    ...
    class SandBossJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        patterned: json_util.JsonObject
        actor_information: json_util.JsonObject
        sand_boss_data: json_util.JsonObject
...
class SandBoss(BaseObjectType):
    ...
    sand_boss_data: SandBossData = dataclasses.field(default_factory=SandBossData, metadata={
        'reflection': FieldReflection[SandBossData](
            SandBossData, id=0x91e88d81, original_name='SandBossData', from_json=SandBossData.from_json, to_json=SandBossData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, patterned, actor_information, sand_boss_data)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("SandBossJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            patterned=PatternedAITypedef.from_json(json_data['patterned']),
            actor_information=ActorParameters.from_json(json_data['actor_information']),
            sand_boss_data=SandBossData.from_json(json_data['sand_boss_data']),
        )
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            (self.sand_boss_data.dependencies_for, "sand_boss_data", "SandBossData"),
        ]:
            try:
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x91e88d81: ('sand_boss_data', SandBossData.from_stream),
}
