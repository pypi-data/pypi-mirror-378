...
class Magdolite(BaseObjectType):
    ...
    cskr: AssetId = dataclasses.field(default=default_asset_id, metadata={
        'asset_types': ['CSKR'], 'reflection': FieldReflection[AssetId](
            AssetId, id=0x0000000d, original_name='CSKR'
        ),
    })
    unknown_3: float = dataclasses.field(default=0.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x0000000e, original_name='Unknown 3'
        ),
    })
    ...
    unknown_6: float = dataclasses.field(default=0.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x00000011, original_name='Unknown 6'
        ),
    })
    unnamed_0x00000012: MagdoliteStruct = dataclasses.field(default_factory=MagdoliteStruct, metadata={
        'reflection': FieldReflection[MagdoliteStruct](
            MagdoliteStruct, id=0x00000012, original_name='18', from_json=MagdoliteStruct.from_json, to_json=MagdoliteStruct.to_json
        ),
    })
    unknown_12: float = dataclasses.field(default=0.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x00000013, original_name='Unknown 12'
        ),
    })
    unknown_13: float = dataclasses.field(default=0.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x00000014, original_name='Unknown 13'
        ),
    })
    unknown_14: float = dataclasses.field(default=0.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x00000015, original_name='Unknown 14'
        ),
    })
