...
if typing.TYPE_CHECKING:
    class GunTurretBaseJson(typing_extensions.TypedDict):
        ...
        gun_turret_base_data: json_util.JsonObject
...
class GunTurretBase(BaseObjectType):
    ...
    gun_turret_base_data: GunTurretBaseData = dataclasses.field(default_factory=GunTurretBaseData, metadata={
        'reflection': FieldReflection[GunTurretBaseData](
            GunTurretBaseData, id=0x34a8fc8e, original_name='GunTurretBaseData', from_json=GunTurretBaseData.from_json, to_json=GunTurretBaseData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, gun_turret_base_data, patterned, actor_information)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            gun_turret_base_data=GunTurretBaseData.from_json(json_data['gun_turret_base_data']),
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x34a8fc8e: ('gun_turret_base_data', GunTurretBaseData.from_stream),
