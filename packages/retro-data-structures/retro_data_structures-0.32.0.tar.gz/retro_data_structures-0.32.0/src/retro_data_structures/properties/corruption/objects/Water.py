...
if typing.TYPE_CHECKING:
    class WaterJson(typing_extensions.TypedDict):
        ...
        fluid_properties: json_util.JsonObject
...
class Water(BaseObjectType):
    ...
    fluid_properties: FluidProperties = dataclasses.field(default_factory=FluidProperties, metadata={
        'reflection': FieldReflection[FluidProperties](
            FluidProperties, id=0x274d1e54, original_name='FluidProperties', from_json=FluidProperties.from_json, to_json=FluidProperties.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, trigger_properties, fluid_properties)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            fluid_properties=FluidProperties.from_json(json_data['fluid_properties']),
        )
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x274d1e54: ('fluid_properties', FluidProperties.from_stream),
}
