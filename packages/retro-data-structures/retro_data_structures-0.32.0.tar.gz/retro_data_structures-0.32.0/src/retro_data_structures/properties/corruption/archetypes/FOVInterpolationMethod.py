...
class FOVInterpolationMethod(BaseProperty):
    fov_type: FOVType = dataclasses.field(default=FOVType.Unknown1, metadata={
        'reflection': FieldReflection[FOVType](
            FOVType, id=0x19ea151b, original_name='FOVType', from_json=FOVType.from_json, to_json=FOVType.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        fov_type = FOVType.from_stream(data)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            fov_type=FOVType.from_json(json_data['fov_type']),
...
def _decode_fov_type(data: typing.BinaryIO, property_size: int) -> FOVType:
    return FOVType.from_stream(data)
