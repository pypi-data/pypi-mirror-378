...
class StreamedAudio(BaseObjectType):
    ...
    audio_file: str = dataclasses.field(default='', metadata={
        'reflection': FieldReflection[str](
            str, id=0x00000002, original_name='Audio file'
        ),
    })
    unknown_2: bool = dataclasses.field(default=False, metadata={
        'reflection': FieldReflection[bool](
            bool, id=0x00000003, original_name='Unknown 2'
        ),
    })
    ...
    unknown_6: int = dataclasses.field(default=0, metadata={
        'reflection': FieldReflection[int](
            int, id=0x00000007, original_name='Unknown 6'
        ),
    })
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            audio_file=json_data['audio_file'],
