...
class SpecialFunction(BaseObjectType):
    ...
    function: Function = dataclasses.field(default=Function.What, metadata={
        'reflection': FieldReflection[Function](
            Function, id=0x95f8d644, original_name='Function', from_json=Function.from_json, to_json=Function.to_json
        ),
    })
    ...
    sound1: int = dataclasses.field(default=0, metadata={
        'sound': True, 'reflection': FieldReflection[int](
            int, id=0xa4ee16bf, original_name='Sound1'
        ),
    })
    sound2: int = dataclasses.field(default=0, metadata={
        'sound': True, 'reflection': FieldReflection[int](
            int, id=0x227a6411, original_name='Sound2'
        ),
    })
    sound3: int = dataclasses.field(default=0, metadata={
        'sound': True, 'reflection': FieldReflection[int](
            int, id=0xe926b7b4, original_name='Sound3'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, function, string_parm, value_parm, value_parm2, value_parm3, value_parm4, int_parm1, int_parm2, inventory_item_parm, sound1, sound2, sound3)
    ...
    def _dependencies_for_sound1(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        yield from asset_manager.get_audio_group_dependency(self.sound1)

    def _dependencies_for_sound2(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        yield from asset_manager.get_audio_group_dependency(self.sound2)

    def _dependencies_for_sound3(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
...
def _decode_sound1(data: typing.BinaryIO, property_size: int) -> int:
    return struct.unpack('>l', data.read(4))[0]


def _decode_sound2(data: typing.BinaryIO, property_size: int) -> int:
    return struct.unpack('>l', data.read(4))[0]


def _decode_sound3(data: typing.BinaryIO, property_size: int) -> int:
    return struct.unpack('>l', data.read(4))[0]
