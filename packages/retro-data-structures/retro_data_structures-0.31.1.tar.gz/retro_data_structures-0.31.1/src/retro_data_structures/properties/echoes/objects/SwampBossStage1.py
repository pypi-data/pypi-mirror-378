...
if typing.TYPE_CHECKING:
    ...
    class SwampBossStage1Json(typing_extensions.TypedDict):
...
class SwampBossStage1(BaseObjectType):
    ...
    unknown_struct37: UnknownStruct37 = dataclasses.field(default_factory=UnknownStruct37, metadata={
        'reflection': FieldReflection[UnknownStruct37](
            UnknownStruct37, id=0xb01a28d5, original_name='UnknownStruct37', from_json=UnknownStruct37.from_json, to_json=UnknownStruct37.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, patterned, actor_information, unknown_struct37)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("SwampBossStage1Json", data)
        return cls(
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            (self.unknown_struct37.dependencies_for, "unknown_struct37", "UnknownStruct37"),
        ]:
            try:
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xb01a28d5: ('unknown_struct37', UnknownStruct37.from_stream),
}
