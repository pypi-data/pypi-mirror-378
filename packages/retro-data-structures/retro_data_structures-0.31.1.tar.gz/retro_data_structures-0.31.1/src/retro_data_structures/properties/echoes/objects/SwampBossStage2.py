...
if typing.TYPE_CHECKING:
    ...
    class SwampBossStage2Json(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        patterned: json_util.JsonObject
        actor_information: json_util.JsonObject
        ing_possession_data: json_util.JsonObject
        swamp_boss_stage2_data: json_util.JsonObject
...
class SwampBossStage2(BaseObjectType):
    ...
    swamp_boss_stage2_data: SwampBossStage2Data = dataclasses.field(default_factory=SwampBossStage2Data, metadata={
        'reflection': FieldReflection[SwampBossStage2Data](
            SwampBossStage2Data, id=0xb31b771d, original_name='SwampBossStage2Data', from_json=SwampBossStage2Data.from_json, to_json=SwampBossStage2Data.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, patterned, actor_information, ing_possession_data, swamp_boss_stage2_data)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("SwampBossStage2Json", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            patterned=PatternedAITypedef.from_json(json_data['patterned']),
            actor_information=ActorParameters.from_json(json_data['actor_information']),
            ing_possession_data=IngPossessionData.from_json(json_data['ing_possession_data']),
            swamp_boss_stage2_data=SwampBossStage2Data.from_json(json_data['swamp_boss_stage2_data']),
        )
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            (self.swamp_boss_stage2_data.dependencies_for, "swamp_boss_stage2_data", "SwampBossStage2Data"),
        ]:
            try:
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xb31b771d: ('swamp_boss_stage2_data', SwampBossStage2Data.from_stream),
}
