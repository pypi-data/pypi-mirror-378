...
if typing.TYPE_CHECKING:
    class VolGroupJson(typing_extensions.TypedDict):
...
class VolGroup(BaseObjectType):
    ...
    group_name: str = dataclasses.field(default='', metadata={
        'reflection': FieldReflection[str](
            str, id=0x6fe8333d, original_name='GroupName'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, group_name, volume)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("VolGroupJson", data)
        return cls(
...
def _decode_group_name(data: typing.BinaryIO, property_size: int) -> str:
