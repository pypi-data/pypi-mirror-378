...
if typing.TYPE_CHECKING:
    class GunTurretTopJson(typing_extensions.TypedDict):
        ...
        gun_turret_top_data: json_util.JsonObject
...
class GunTurretTop(BaseObjectType):
    ...
    gun_turret_top_data: GunTurretTopData = dataclasses.field(default_factory=GunTurretTopData, metadata={
        'reflection': FieldReflection[GunTurretTopData](
            GunTurretTopData, id=0xa858f4e7, original_name='GunTurretTopData', from_json=GunTurretTopData.from_json, to_json=GunTurretTopData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, gun_turret_top_data, patterned, actor_information)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            gun_turret_top_data=GunTurretTopData.from_json(json_data['gun_turret_top_data']),
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xa858f4e7: ('gun_turret_top_data', GunTurretTopData.from_stream),
