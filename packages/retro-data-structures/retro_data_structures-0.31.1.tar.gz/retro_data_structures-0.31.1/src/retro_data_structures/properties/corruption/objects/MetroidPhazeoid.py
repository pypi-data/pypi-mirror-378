...
if typing.TYPE_CHECKING:
    class MetroidPhazeoidJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        metroid_phazeoid_data: json_util.JsonObject
...
class MetroidPhazeoid(BaseObjectType):
    ...
    metroid_phazeoid_data: MetroidPhazeoidData = dataclasses.field(default_factory=MetroidPhazeoidData, metadata={
        'reflection': FieldReflection[MetroidPhazeoidData](
            MetroidPhazeoidData, id=0xe58a4113, original_name='MetroidPhazeoidData', from_json=MetroidPhazeoidData.from_json, to_json=MetroidPhazeoidData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, metroid_phazeoid_data, patterned, actor_information)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("MetroidPhazeoidJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            metroid_phazeoid_data=MetroidPhazeoidData.from_json(json_data['metroid_phazeoid_data']),
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xe58a4113: ('metroid_phazeoid_data', MetroidPhazeoidData.from_stream),
