...
if typing.TYPE_CHECKING:
    class ShellBugJson(typing_extensions.TypedDict):
        editor_properties: json_util.JsonObject
        shell_bug_data: json_util.JsonObject
...
class ShellBug(BaseObjectType):
    ...
    shell_bug_data: ShellBugData = dataclasses.field(default_factory=ShellBugData, metadata={
        'reflection': FieldReflection[ShellBugData](
            ShellBugData, id=0xb9ffa928, original_name='ShellBugData', from_json=ShellBugData.from_json, to_json=ShellBugData.to_json
        ),
    })
    wall_crawler_properties: WallCrawlerData = dataclasses.field(default_factory=WallCrawlerData, metadata={
        'reflection': FieldReflection[WallCrawlerData](
            WallCrawlerData, id=0xb718b831, original_name='WallCrawlerProperties', from_json=WallCrawlerData.from_json, to_json=WallCrawlerData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, shell_bug_data, wall_crawler_properties, patterned, actor_information)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("ShellBugJson", data)
        return cls(
            editor_properties=EditorProperties.from_json(json_data['editor_properties']),
            shell_bug_data=ShellBugData.from_json(json_data['shell_bug_data']),
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xb9ffa928: ('shell_bug_data', ShellBugData.from_stream),
    0xb718b831: ('wall_crawler_properties', WallCrawlerData.from_stream),
