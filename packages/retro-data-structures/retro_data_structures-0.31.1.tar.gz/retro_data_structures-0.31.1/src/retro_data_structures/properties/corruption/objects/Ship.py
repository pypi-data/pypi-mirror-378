...
if typing.TYPE_CHECKING:
    class ShipJson(typing_extensions.TypedDict):
        ...
        ship_data: json_util.JsonObject
...
class Ship(BaseObjectType):
    ...
    ship_data: ShipData = dataclasses.field(default_factory=ShipData, metadata={
        'reflection': FieldReflection[ShipData](
            ShipData, id=0xc854d4a6, original_name='ShipData', from_json=ShipData.from_json, to_json=ShipData.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, patterned, actor_information, ship_data)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            ship_data=ShipData.from_json(json_data['ship_data']),
        )
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xc854d4a6: ('ship_data', ShipData.from_stream),
}
