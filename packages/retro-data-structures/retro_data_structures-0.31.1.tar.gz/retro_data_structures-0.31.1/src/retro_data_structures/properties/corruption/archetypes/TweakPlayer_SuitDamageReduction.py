...
class TweakPlayer_SuitDamageReduction(BaseProperty):
    hazard: float = dataclasses.field(default=0.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x580f155f, original_name='Hazard'
        ),
    })
...
def _decode_hazard(data: typing.BinaryIO, property_size: int) -> float:
