...
class Oculus(BaseObjectType):
    ...
    unnamed_0x0000000c: DamageVulnerability = dataclasses.field(default_factory=DamageVulnerability, metadata={
        'reflection': FieldReflection[DamageVulnerability](
            DamageVulnerability, id=0x0000000c, original_name='12', from_json=DamageVulnerability.from_json, to_json=DamageVulnerability.to_json
        ),
    })
    ...
    unnamed_0x0000000e: DamageInfo = dataclasses.field(default_factory=DamageInfo, metadata={
        'reflection': FieldReflection[DamageInfo](
            DamageInfo, id=0x0000000e, original_name='14', from_json=DamageInfo.from_json, to_json=DamageInfo.to_json
        ),
    })
    ...
    def dependencies_for(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
        for method, field_name, field_type in [
            ...
            (self.unnamed_0x0000000c.dependencies_for, "unnamed_0x0000000c", "DamageVulnerability"),
            (self.unnamed_0x0000000e.dependencies_for, "unnamed_0x0000000e", "DamageInfo"),
        ]:
            try:
