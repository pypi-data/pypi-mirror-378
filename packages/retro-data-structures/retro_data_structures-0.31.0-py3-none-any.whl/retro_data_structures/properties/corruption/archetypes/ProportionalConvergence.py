...
class ProportionalConvergence(BaseProperty):
    velocity: float = dataclasses.field(default=0.0, metadata={
        'reflection': FieldReflection[float](
            float, id=0x02f01683, original_name='Velocity'
        ),
    })
    dampening_control: Spline = dataclasses.field(default_factory=Spline, metadata={
        'reflection': FieldReflection[Spline](
            Spline, id=0xf7fba2bf, original_name='DampeningControl', from_json=Spline.from_json, to_json=Spline.to_json
        ),
    })
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0xf7fba2bf: ('dampening_control', Spline.from_stream),
}
