...
class PointOfInterest(BaseObjectType):
    ...
    scan_offset: Vector = dataclasses.field(default_factory=lambda: Vector(x=0.0, y=0.0, z=0.0), metadata={
        'reflection': FieldReflection[Vector](
            Vector, id=0x863c16e3, original_name='ScanOffset', from_json=Vector.from_json, to_json=Vector.to_json
        ),
    })
    ...
    scan_offset_local: bool = dataclasses.field(default=True, metadata={
        'reflection': FieldReflection[bool](
            bool, id=0x91351b69, original_name='ScanOffsetLocal'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, scan_info, scan_offset, look_at_poi, scan_offset_local)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            ...
            scan_offset_local=json_data['scan_offset_local'],
        )
...
def _decode_scan_offset(data: typing.BinaryIO, property_size: int) -> Vector:
...
def _decode_scan_offset_local(data: typing.BinaryIO, property_size: int) -> bool:
    return struct.unpack('>?', data.read(1))[0]
