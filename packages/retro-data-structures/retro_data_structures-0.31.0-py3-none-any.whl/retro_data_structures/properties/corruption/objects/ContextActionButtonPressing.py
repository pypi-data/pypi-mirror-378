...
if typing.TYPE_CHECKING:
    class ContextActionButtonPressingJson(typing_extensions.TypedDict):
...
class ContextActionButtonPressing(BaseObjectType):
    ...
    unknown_struct22: UnknownStruct22 = dataclasses.field(default_factory=UnknownStruct22, metadata={
        'reflection': FieldReflection[UnknownStruct22](
            UnknownStruct22, id=0x3907300e, original_name='UnknownStruct22', from_json=UnknownStruct22.from_json, to_json=UnknownStruct22.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, unknown_struct22, animation_information)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        json_data = typing.cast("ContextActionButtonPressingJson", data)
        return cls(
...
_property_decoder: dict[int, tuple[str, typing.Callable[[typing.BinaryIO, int], typing.Any]]] = {
    ...
    0x3907300e: ('unknown_struct22', UnknownStruct22.from_stream),
