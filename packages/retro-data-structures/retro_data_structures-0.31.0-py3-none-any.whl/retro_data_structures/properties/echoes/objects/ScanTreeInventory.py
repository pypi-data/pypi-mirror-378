...
class ScanTreeInventory(BaseObjectType):
    ...
    inventory_slot: enums.InventorySlotEnum = dataclasses.field(default=enums.InventorySlotEnum.PowerBeam, metadata={
        'reflection': FieldReflection[enums.InventorySlotEnum](
            enums.InventorySlotEnum, id=0x3d326f90, original_name='Inventory Slot', from_json=enums.InventorySlotEnum.from_json, to_json=enums.InventorySlotEnum.to_json
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        inventory_slot = enums.InventorySlotEnum.from_stream(data)
...
def _decode_inventory_slot(data: typing.BinaryIO, property_size: int) -> enums.InventorySlotEnum:
    return enums.InventorySlotEnum.from_stream(data)
