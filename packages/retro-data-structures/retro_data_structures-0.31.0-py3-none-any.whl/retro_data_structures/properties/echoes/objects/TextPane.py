...
class TextPane(BaseObjectType):
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(editor_properties, gui_label, text_properties, japan_text_properties, pivot_offset, default_string, default_string_name, blend_mode, fade_in_time, fade_out_time, depth_compare, depth_update, depth_backwards)
    ...
    def _dependencies_for_default_string(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
