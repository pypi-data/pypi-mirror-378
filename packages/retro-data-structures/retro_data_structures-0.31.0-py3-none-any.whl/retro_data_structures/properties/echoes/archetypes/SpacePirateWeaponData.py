...
if typing.TYPE_CHECKING:
    ...
    class SpacePirateWeaponDataJson(typing_extensions.TypedDict):
        unknown_0x647670ac: int
        grenade_launcher: int
        unknown_0xa95a025b: int
...
class SpacePirateWeaponData(BaseProperty):
    unknown_0x647670ac: int = dataclasses.field(default=0, metadata={
        'reflection': FieldReflection[int](
            int, id=0x647670ac, original_name='Unknown'
        ),
    })
    grenade_launcher: AssetId = dataclasses.field(default=default_asset_id, metadata={
        'asset_types': ['CMDL'], 'reflection': FieldReflection[AssetId](
            AssetId, id=0xa79bb82e, original_name='GrenadeLauncher'
        ),
    })
    unknown_0xa95a025b: int = dataclasses.field(default=3, metadata={
        'reflection': FieldReflection[int](
            int, id=0xa95a025b, original_name='Unknown'
        ),
    })
    ...
    def _fast_decode(cls, data: typing.BinaryIO, property_count: int) -> typing_extensions.Self | None:
        ...
        return cls(unknown_0x647670ac, grenade_launcher, unknown_0xa95a025b, unknown_0x25f822c4, unknown_0x765e3a20, grenade_damage, grenade_explosion, grenade_effect, grenade_trail, grenade_mass, unknown_0xed086ce0, unknown_0x00fc6646, unknown_0xa7c8e63f, unknown_0x454f16b1, sound_grenade_bounce, sound_grenade_explode)
    ...
    def from_json(cls, data: json_util.JsonValue) -> typing_extensions.Self:
        ...
        return cls(
            unknown_0x647670ac=json_data['unknown_0x647670ac'],
            grenade_launcher=json_data['grenade_launcher'],
            unknown_0xa95a025b=json_data['unknown_0xa95a025b'],
    ...
    def _dependencies_for_grenade_launcher(self, asset_manager: AssetManager) -> typing.Iterator[Dependency]:
...
def _decode_unknown_0x647670ac(data: typing.BinaryIO, property_size: int) -> int:
    return struct.unpack('>l', data.read(4))[0]


def _decode_grenade_launcher(data: typing.BinaryIO, property_size: int) -> AssetId:
    return struct.unpack(">L", data.read(4))[0]


def _decode_unknown_0xa95a025b(data: typing.BinaryIO, property_size: int) -> int:
    return struct.unpack('>l', data.read(4))[0]
