...
class IntegrationInventory(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "externalId", "owner", "tenants"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IntegrationInventory from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IntegrationInventory from a dict"""
        if obj is None:
            return None
