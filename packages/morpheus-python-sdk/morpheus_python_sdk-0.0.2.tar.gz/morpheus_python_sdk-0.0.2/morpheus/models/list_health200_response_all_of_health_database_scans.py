...
class ListHealth200ResponseAllOfHealthDatabaseScans(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Handler_read_first", "Handler_read_key", "Handler_read_last", "Handler_read_next", "Handler_read_prev", "Handler_read_rnd", "Handler_read_rnd_next"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListHealth200ResponseAllOfHealthDatabaseScans from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListHealth200ResponseAllOfHealthDatabaseScans from a dict"""
        if obj is None:
            return None
