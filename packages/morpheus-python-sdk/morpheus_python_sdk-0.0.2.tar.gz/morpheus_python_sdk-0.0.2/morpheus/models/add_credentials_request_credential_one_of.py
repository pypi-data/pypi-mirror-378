...
class AddCredentialsRequestCredentialOneOf(BaseModel):
    """
    ...
    username: StrictStr = Field(description="Access Key")
    password: StrictStr = Field(description="Secret Key")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['access-key-secret']):
            raise ValueError("must be one of enum values ('access-key-secret')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddCredentialsRequestCredentialOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddCredentialsRequestCredentialOneOf from a dict"""
        if obj is None:
            return None
