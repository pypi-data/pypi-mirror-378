...
class AddBlueprint200Response(BaseModel):
    """
    AddBlueprint200Response
    """ # noqa: E501
    blueprint: Optional[AddBlueprint200ResponseAllOfBlueprint] = None
    ...
    __properties: ClassVar[List[str]] = ["blueprint", "msg", "errors", "errorCode", "inProgress", "success"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddBlueprint200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddBlueprint200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "blueprint": AddBlueprint200ResponseAllOfBlueprint.from_dict(obj["blueprint"]) if obj.get("blueprint") is not None else None,
            "msg": obj.get("msg"),
