...
class AddCatalogOrder200ResponseAllOfOrderItemsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "quantity", "price", "currency", "unit", "valid", "status", "dateCreated", "lastUpdated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddCatalogOrder200ResponseAllOfOrderItemsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddCatalogOrder200ResponseAllOfOrderItemsInner from a dict"""
        if obj is None:
            return None
