...
class GetAlerts200Response(BaseModel):
    ...
    """ # noqa: E501
    alert: Optional[ListAlerts200ResponseAllOfAlertsInner] = None
    ...
    apps: Optional[List[GetAlerts200ResponseAllOfAppsInner]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["alert", "checks", "checkGroups", "apps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alert": ListAlerts200ResponseAllOfAlertsInner.from_dict(obj["alert"]) if obj.get("alert") is not None else None,
            ...
            "apps": [GetAlerts200ResponseAllOfAppsInner.from_dict(_item) for _item in obj["apps"]] if obj.get("apps") is not None else None
        })
