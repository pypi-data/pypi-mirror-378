...
class GuidanceAzureReservations(BaseModel):
    """
    ...
    action_plan_id: Optional[StrictStr] = Field(default=None, alias="actionPlanId")
    ...
    config: Optional[ListGuidances200ResponseAllOfDiscoveriesInnerAnyOf1Config] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "dateCreated", "lastUpdated", "actionCategory", "actionMessage", "actionTitle", "actionType", "actionValue", "actionValueType", "actionPlanId", "statusMessage", "accountId", "userId", "siteId", "zone", "state", "stateMessage", "severity", "resolved", "resolvedMessage", "refType", "refId", "refName", "type", "savings", "config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GuidanceAzureReservations from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if action_plan_id (nullable) is None
        # and model_fields_set contains the field
        if self.action_plan_id is None and "action_plan_id" in self.model_fields_set:
            _dict['actionPlanId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GuidanceAzureReservations from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": ListGuidances200ResponseAllOfDiscoveriesInnerAnyOf1Config.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
