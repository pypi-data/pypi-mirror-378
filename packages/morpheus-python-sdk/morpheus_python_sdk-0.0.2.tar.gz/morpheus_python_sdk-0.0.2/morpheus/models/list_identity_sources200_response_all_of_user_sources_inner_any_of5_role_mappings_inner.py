...
class ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf5RoleMappingsInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf5RoleMappingsInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if source_role_fqn (nullable) is None
        # and model_fields_set contains the field
        if self.source_role_fqn is None and "source_role_fqn" in self.model_fields_set:
            _dict['sourceRoleFqn'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf5RoleMappingsInner from a dict"""
        if obj is None:
            return None
