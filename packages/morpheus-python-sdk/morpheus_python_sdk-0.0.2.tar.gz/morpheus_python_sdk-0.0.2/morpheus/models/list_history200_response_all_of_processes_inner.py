...
class ListHistory200ResponseAllOfProcessesInner(BaseModel):
    """
    ...
    events: Optional[List[ListHistory200ResponseAllOfProcessesInnerEventsInner]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "accountId", "uniqueId", "processType", "displayName", "description", "subType", "subId", "zoneId", "integrationId", "appId", "instanceId", "containerId", "serverId", "containerName", "status", "reason", "percent", "statusEta", "message", "output", "error", "startDate", "endDate", "duration", "resultType", "resultId", "dateCreated", "lastUpdated", "createdBy", "updatedBy", "events"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListHistory200ResponseAllOfProcessesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListHistory200ResponseAllOfProcessesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "events": [ListHistory200ResponseAllOfProcessesInnerEventsInner.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None
        })
