...
class BackupServerHost(BaseModel):
    """
    BackupServerHost
    """ # noqa: E501
    location_type: StrictStr = Field(alias="locationType")
    name: StrictStr = Field(description="A name for the backup")
    server_id: Optional[StrictInt] = Field(default=None, description="The ID of the server to backup", alias="serverId")
    ...
    __properties: ClassVar[List[str]] = ["locationType", "name", "serverId", "backupType", "jobAction", "jobId", "jobName", "jobSchedule", "retentionCount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BackupServerHost from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BackupServerHost from a dict"""
        if obj is None:
            return None
