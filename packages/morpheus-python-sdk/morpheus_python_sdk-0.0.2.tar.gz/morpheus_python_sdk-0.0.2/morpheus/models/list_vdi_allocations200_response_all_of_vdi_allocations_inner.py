...
class ListVDIAllocations200ResponseAllOfVdiAllocationsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "pool", "instance", "user", "localUserCreated", "persistent", "status", "dateCreated", "lastUpdated", "lastReserved", "releaseDate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListVDIAllocations200ResponseAllOfVdiAllocationsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListVDIAllocations200ResponseAllOfVdiAllocationsInner from a dict"""
        if obj is None:
            return None
