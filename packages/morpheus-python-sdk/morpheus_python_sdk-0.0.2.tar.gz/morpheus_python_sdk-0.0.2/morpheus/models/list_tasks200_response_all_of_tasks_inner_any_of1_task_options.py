...
class ListTasks200ResponseAllOfTasksInnerAnyOf1TaskOptions(BaseModel):
    """
    ...
    ansible_tower_git_ref: Optional[StrictStr] = Field(default=None, alias="ansibleTowerGitRef")
    ...
    ansible_group: Optional[StrictStr] = Field(default=None, alias="ansibleGroup")
    ansible_tower_execute_mode: Optional[StrictStr] = Field(default=None, alias="ansibleTowerExecuteMode")
    local_script_git_ref: Optional[StrictStr] = Field(default=None, alias="localScriptGitRef")
    port: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["password", "passwordHash", "ansibleTowerGitRef", "localScriptGitId", "host", "username", "sshKey", "ansibleGroup", "ansibleTowerExecuteMode", "localScriptGitRef", "port"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf1TaskOptions from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if ansible_tower_git_ref (nullable) is None
        # and model_fields_set contains the field
        if self.ansible_tower_git_ref is None and "ansible_tower_git_ref" in self.model_fields_set:
            _dict['ansibleTowerGitRef'] = None
        ...
        # set to None if ansible_group (nullable) is None
        # and model_fields_set contains the field
        if self.ansible_group is None and "ansible_group" in self.model_fields_set:
            _dict['ansibleGroup'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf1TaskOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "ansibleTowerGitRef": obj.get("ansibleTowerGitRef"),
            "localScriptGitId": obj.get("localScriptGitId"),
            "host": obj.get("host"),
            "username": obj.get("username"),
            "sshKey": obj.get("sshKey"),
            "ansibleGroup": obj.get("ansibleGroup"),
            "ansibleTowerExecuteMode": obj.get("ansibleTowerExecuteMode"),
