...
class TaskGroovyConfig(BaseModel):
    """
    TaskGroovyConfig
    """ # noqa: E501
    ...
    task_type: Optional[ListTasks200ResponseAllOfTasksInnerAnyOf4TaskType] = Field(default=None, alias="taskType")
    labels: Optional[List[StrictStr]] = None
    visibility: Optional[StrictStr] = None
    task_options: Optional[ListTasks200ResponseAllOfTasksInnerAnyOf4TaskOptions] = Field(default=None, alias="taskOptions")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TaskGroovyConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TaskGroovyConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "code": obj.get("code"),
            "taskType": ListTasks200ResponseAllOfTasksInnerAnyOf4TaskType.from_dict(obj["taskType"]) if obj.get("taskType") is not None else None,
            "labels": obj.get("labels"),
            "visibility": obj.get("visibility"),
            "taskOptions": ListTasks200ResponseAllOfTasksInnerAnyOf4TaskOptions.from_dict(obj["taskOptions"]) if obj.get("taskOptions") is not None else None,
