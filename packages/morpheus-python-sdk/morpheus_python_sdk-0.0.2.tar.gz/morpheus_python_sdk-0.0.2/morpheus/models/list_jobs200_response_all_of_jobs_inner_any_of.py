...
class ListJobs200ResponseAllOfJobsInnerAnyOf(BaseModel):
    """
    ...
    workflow: Optional[ListJobs200ResponseAllOfJobsInnerAnyOfWorkflow] = None
    task: Optional[ListJobs200ResponseAllOfJobsInnerAnyOfTask] = None
    security_package: Optional[ListJobs200ResponseAllOfJobsInnerAnyOfSecurityPackage] = Field(default=None, alias="securityPackage")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "labels", "type", "workflow", "task", "securityPackage", "jobSummary", "scheduleMode", "dateTime", "status", "namespace", "category", "description", "enabled", "dateCreated", "lastUpdated", "lastRun", "lastResult", "createdBy", "targetType", "targets", "scanPath", "securityProfile", "customConfig", "customOptions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListJobs200ResponseAllOfJobsInnerAnyOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListJobs200ResponseAllOfJobsInnerAnyOf from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "workflow": ListJobs200ResponseAllOfJobsInnerAnyOfWorkflow.from_dict(obj["workflow"]) if obj.get("workflow") is not None else None,
            "task": ListJobs200ResponseAllOfJobsInnerAnyOfTask.from_dict(obj["task"]) if obj.get("task") is not None else None,
            "securityPackage": ListJobs200ResponseAllOfJobsInnerAnyOfSecurityPackage.from_dict(obj["securityPackage"]) if obj.get("securityPackage") is not None else None,
