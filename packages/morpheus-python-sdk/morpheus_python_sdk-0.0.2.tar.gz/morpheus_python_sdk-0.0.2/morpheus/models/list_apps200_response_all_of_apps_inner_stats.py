...
class ListApps200ResponseAllOfAppsInnerStats(BaseModel):
    """
    ...
    instance_day_count: Optional[List[StrictInt]] = Field(default=None, alias="instanceDayCount")
    instance_day_count_total: Optional[StrictInt] = Field(default=None, alias="instanceDayCountTotal")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["usedMemory", "maxMemory", "usedStorage", "maxStorage", "running", "total", "cpuUsage", "instanceCount", "instanceDayCount", "instanceDayCountTotal"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListApps200ResponseAllOfAppsInnerStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListApps200ResponseAllOfAppsInnerStats from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "instanceDayCount": obj.get("instanceDayCount"),
            "instanceDayCountTotal": obj.get("instanceDayCountTotal")
        })
