...
class AddVDIPoolsRequestVdiPoolOneOf1(BaseModel):
    """
    AddVDIPoolsRequestVdiPoolOneOf1
    """ # noqa: E501
    name: StrictStr = Field(description="Virtual Desktop name")
    ...
    max_pool_size: Union[StrictFloat, StrictInt] = Field(description="Max limit on number of allocations and instances within the pool. ", alias="maxPoolSize")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddVDIPoolsRequestVdiPoolOneOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddVDIPoolsRequestVdiPoolOneOf1 from a dict"""
        if obj is None:
            return None
