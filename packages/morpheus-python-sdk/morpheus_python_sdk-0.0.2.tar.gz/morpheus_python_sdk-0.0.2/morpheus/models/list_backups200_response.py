...
class ListBackups200Response(BaseModel):
    ...
    """ # noqa: E501
    backups: Optional[List[ListBackups200ResponseAllOfBackupsInner]] = None
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["backups", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "backups": [ListBackups200ResponseAllOfBackupsInner.from_dict(_item) for _item in obj["backups"]] if obj.get("backups") is not None else None,
