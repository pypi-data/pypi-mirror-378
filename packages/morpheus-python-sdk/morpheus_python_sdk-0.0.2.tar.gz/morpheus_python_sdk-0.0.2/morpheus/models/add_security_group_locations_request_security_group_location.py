...
class AddSecurityGroupLocationsRequestSecurityGroupLocation(BaseModel):
    """
    AddSecurityGroupLocationsRequestSecurityGroupLocation
    """ # noqa: E501
    zone_id: StrictInt = Field(description="The ID of the Zone (Cloud)", alias="zoneId")
    custom_options: AddSecurityGroupsRequestSecurityGroupCustomOptions = Field(alias="customOptions")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["zoneId", "customOptions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddSecurityGroupLocationsRequestSecurityGroupLocation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddSecurityGroupLocationsRequestSecurityGroupLocation from a dict"""
        if obj is None:
            return None
