...
class RolePermissionDefaultCloud(BaseModel):
    """
    RolePermissionDefaultCloud
    """ # noqa: E501
    permission_code: StrictStr = Field(description="`ComputeZone` is the code for Default Cloud Access", alias="permissionCode")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RolePermissionDefaultCloud from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RolePermissionDefaultCloud from a dict"""
        if obj is None:
            return None
