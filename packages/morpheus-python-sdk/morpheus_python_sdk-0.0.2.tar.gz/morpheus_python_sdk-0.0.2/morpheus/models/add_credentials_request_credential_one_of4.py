...
class AddCredentialsRequestCredentialOneOf4(BaseModel):
    """
    ...
    password: StrictStr = Field(description="API Key")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['username-api-key']):
            raise ValueError("must be one of enum values ('username-api-key')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddCredentialsRequestCredentialOneOf4 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddCredentialsRequestCredentialOneOf4 from a dict"""
        if obj is None:
            return None
