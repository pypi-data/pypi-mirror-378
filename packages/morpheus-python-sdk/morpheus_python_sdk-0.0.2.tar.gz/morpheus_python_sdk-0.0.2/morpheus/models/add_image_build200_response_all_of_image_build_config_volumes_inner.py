...
class AddImageBuild200ResponseAllOfImageBuildConfigVolumesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "size", "maxIOPS", "name", "rootVolume", "storageType", "datastoreId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddImageBuild200ResponseAllOfImageBuildConfigVolumesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddImageBuild200ResponseAllOfImageBuildConfigVolumesInner from a dict"""
        if obj is None:
            return None
