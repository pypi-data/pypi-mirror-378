...
class ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf1(BaseModel):
    """
    ...
    config: Optional[ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf1Config] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf1Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
