...
class GetReportTypes200ResponseReportTypesInnerOptionTypesInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetReportTypes200ResponseReportTypesInnerOptionTypesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetReportTypes200ResponseReportTypesInnerOptionTypesInner from a dict"""
        if obj is None:
            return None
