...
class UpdateGroups200ResponseGroup(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "uuid", "name", "code", "labels", "location", "accountId", "active", "config", "dateCreated", "lastUpdated", "zones", "stats", "serverCount", "success"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateGroups200ResponseGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateGroups200ResponseGroup from a dict"""
        if obj is None:
            return None
