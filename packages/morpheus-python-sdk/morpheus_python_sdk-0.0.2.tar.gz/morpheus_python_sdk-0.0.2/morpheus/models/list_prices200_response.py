...
class ListPrices200Response(BaseModel):
    """
    ListPrices200Response
    """ # noqa: E501
    prices: Optional[List[ListPrices200ResponseAllOfPricesInner]] = None
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["prices", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prices": [ListPrices200ResponseAllOfPricesInner.from_dict(_item) for _item in obj["prices"]] if obj.get("prices") is not None else None,
