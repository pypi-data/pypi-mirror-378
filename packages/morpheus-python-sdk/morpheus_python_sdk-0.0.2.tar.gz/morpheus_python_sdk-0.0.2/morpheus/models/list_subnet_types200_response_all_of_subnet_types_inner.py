...
class ListSubnetTypes200ResponseAllOfSubnetTypesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "code", "name", "description", "creatable", "deletable", "dhcpServerEditable", "canAssignPool", "optionTypes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListSubnetTypes200ResponseAllOfSubnetTypesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListSubnetTypes200ResponseAllOfSubnetTypesInner from a dict"""
        if obj is None:
            return None
