...
class InstanceTypeLayoutCreate(BaseModel):
    """
    InstanceTypeLayoutCreate
    """ # noqa: E501
    name: StrictStr = Field(description="Layout name")
    labels: Optional[List[StrictStr]] = None
    instance_version: StrictStr = Field(description="Version of the layout", alias="instanceVersion")
    ...
    provision_type_code: StrictStr = Field(description="Provision type code", alias="provisionTypeCode")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstanceTypeLayoutCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstanceTypeLayoutCreate from a dict"""
        if obj is None:
            return None
