...
class AddChecksRequestCheckOneOf3(BaseModel):
    """
    ...
    check_type: Optional[AddChecksRequestCheckOneOf3CheckType] = Field(default=None, alias="checkType")
    ...
    config: Optional[AddChecksRequestCheckOneOf3Config] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddChecksRequestCheckOneOf3 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddChecksRequestCheckOneOf3 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "checkType": AddChecksRequestCheckOneOf3CheckType.from_dict(obj["checkType"]) if obj.get("checkType") is not None else None,
            ...
            "config": AddChecksRequestCheckOneOf3Config.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
