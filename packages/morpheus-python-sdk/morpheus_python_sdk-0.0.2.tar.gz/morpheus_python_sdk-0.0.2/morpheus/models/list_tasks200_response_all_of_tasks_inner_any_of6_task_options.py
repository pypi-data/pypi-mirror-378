...
class ListTasks200ResponseAllOfTasksInnerAnyOf6TaskOptions(BaseModel):
    """
    ListTasks200ResponseAllOfTasksInnerAnyOf6TaskOptions
    """ # noqa: E501
    username: Optional[StrictStr] = None
    port: Optional[StrictStr] = None
    js_script: Optional[StrictStr] = Field(default=None, alias="jsScript")
    ...
    __properties: ClassVar[List[str]] = ["username", "port", "jsScript", "host", "localScriptGitRef", "password", "passwordHash", "sshKey", "localScriptGitId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf6TaskOptions from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if js_script (nullable) is None
        # and model_fields_set contains the field
        if self.js_script is None and "js_script" in self.model_fields_set:
            _dict['jsScript'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf6TaskOptions from a dict"""
        if obj is None:
            return None
