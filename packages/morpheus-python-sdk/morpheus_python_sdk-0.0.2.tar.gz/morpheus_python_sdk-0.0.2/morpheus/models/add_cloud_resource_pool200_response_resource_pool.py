...
class AddCloudResourcePool200ResponseResourcePool(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "description", "zone", "parent", "type", "externalId", "regionCode", "iacId", "visibility", "readOnly", "defaultPool", "active", "status", "inventory", "config", "name", "displayName", "tenants", "resourcePermission", "depth", "success"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddCloudResourcePool200ResponseResourcePool from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddCloudResourcePool200ResponseResourcePool from a dict"""
        if obj is None:
            return None
