...
class ListCloudFolders200ResponseAllOfFoldersInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "zone", "parent", "type", "externalId", "visibility", "readOnly", "defaultFolder", "defaultStore", "active", "tenants", "resourcePermissions", "depth"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListCloudFolders200ResponseAllOfFoldersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListCloudFolders200ResponseAllOfFoldersInner from a dict"""
        if obj is None:
            return None
