...
class ListSecurityPackages200ResponseAllOfSecurityPackagesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "labels", "description", "type", "enabled", "url", "uuid", "dateCreated", "lastUpdated", "config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListSecurityPackages200ResponseAllOfSecurityPackagesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListSecurityPackages200ResponseAllOfSecurityPackagesInner from a dict"""
        if obj is None:
            return None
