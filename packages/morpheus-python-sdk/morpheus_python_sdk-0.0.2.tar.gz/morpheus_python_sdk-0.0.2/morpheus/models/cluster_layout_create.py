...
class ClusterLayoutCreate(BaseModel):
    """
    ClusterLayoutCreate
    """ # noqa: E501
    name: StrictStr = Field(description="Cluster layout name")
    description: Optional[StrictStr] = Field(default=None, description="Cluster layout description")
    labels: Optional[List[StrictStr]] = None
    compute_version: StrictStr = Field(description="Version of the cluster layout", alias="computeVersion")
    ...
    group_type: AddClusterLayoutsRequestLayoutGroupType = Field(alias="groupType")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterLayoutCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterLayoutCreate from a dict"""
        if obj is None:
            return None
