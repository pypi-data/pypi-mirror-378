...
class AddPowerScheduleInstances200Response(BaseModel):
    """
    A response object
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["success", "msg", "errors"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddPowerScheduleInstances200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddPowerScheduleInstances200Response from a dict"""
        if obj is None:
            return None
