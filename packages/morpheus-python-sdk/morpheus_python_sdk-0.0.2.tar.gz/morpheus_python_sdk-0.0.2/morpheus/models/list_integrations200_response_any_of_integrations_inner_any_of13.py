...
class ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf13(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['amazonDns']):
            raise ValueError("must be one of enum values ('amazonDns')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf13 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf13 from a dict"""
        if obj is None:
            return None
