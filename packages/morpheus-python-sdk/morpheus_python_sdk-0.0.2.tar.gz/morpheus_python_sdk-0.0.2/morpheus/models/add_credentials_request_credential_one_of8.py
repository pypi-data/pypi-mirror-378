...
class AddCredentialsRequestCredentialOneOf8(BaseModel):
    """
    ...
    config: AddCredentialsRequestCredentialOneOf8Config
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "name", "description", "enabled", "integration", "username", "password", "config"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddCredentialsRequestCredentialOneOf8 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddCredentialsRequestCredentialOneOf8 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": AddCredentialsRequestCredentialOneOf8Config.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
