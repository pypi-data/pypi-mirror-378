...
class UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf2(BaseModel):
    """
    ...
    workflow: Optional[GetAlerts200ResponseAllOfChecksInnerAccount] = None
    context: Optional[StrictStr] = Field(default=None, description="Context for running the workflow, determines if a target resource must be selected.")
    workflow_config: Optional[StrictStr] = Field(default=None, description="Configuration object that contains settings for the workflow.", alias="workflowConfig")
    ...
    __properties: ClassVar[List[str]] = ["name", "code", "category", "description", "labels", "type", "visibility", "layoutCode", "iconPath", "enabled", "featured", "allowQuantity", "workflow", "context", "workflowConfig", "formType", "form", "optionTypes", "content"]
    ...
    def context_validate_enum(cls, value):
        ...
        if value not in set(['instance', 'server', 'appliance']):
            raise ValueError("must be one of enum values ('instance', 'server', 'appliance')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateCatalogItemTypeRequestCatalogItemTypeAnyOf2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "workflow": GetAlerts200ResponseAllOfChecksInnerAccount.from_dict(obj["workflow"]) if obj.get("workflow") is not None else None,
