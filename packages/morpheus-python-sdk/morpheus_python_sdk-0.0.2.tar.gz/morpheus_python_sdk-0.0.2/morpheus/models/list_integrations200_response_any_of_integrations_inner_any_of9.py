...
class ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf9(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "enabled", "type", "integrationType", "url", "serviceFlag", "isPlugin", "config", "status", "statusDate", "statusMessage", "lastSync", "lastSyncDuration", "credential"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['microsoft.dns']):
            raise ValueError("must be one of enum values ('microsoft.dns')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf9 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf9 from a dict"""
        if obj is None:
            return None
