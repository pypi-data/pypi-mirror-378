...
class AddCredentialsRequestCredentialOneOf5(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "name", "description", "enabled", "integration", "username", "authKey"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['username-keypair']):
            raise ValueError("must be one of enum values ('username-keypair')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddCredentialsRequestCredentialOneOf5 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddCredentialsRequestCredentialOneOf5 from a dict"""
        if obj is None:
            return None
