...
class ListTasks200ResponseAllOfTasksInnerAnyOf11TaskOptions(BaseModel):
    """
    ...
    puppet_environment: Optional[StrictStr] = Field(default=None, alias="puppetEnvironment")
    puppet_node_name: Optional[StrictStr] = Field(default=None, alias="puppetNodeName")
    ...
    __properties: ClassVar[List[str]] = ["port", "host", "username", "puppetEnvironment", "puppetNodeName", "sshKey", "localScriptGitId", "localScriptGitRef", "password", "passwordHash"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf11TaskOptions from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if puppet_environment (nullable) is None
        # and model_fields_set contains the field
        if self.puppet_environment is None and "puppet_environment" in self.model_fields_set:
            _dict['puppetEnvironment'] = None

        # set to None if puppet_node_name (nullable) is None
        # and model_fields_set contains the field
        if self.puppet_node_name is None and "puppet_node_name" in self.model_fields_set:
            _dict['puppetNodeName'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf11TaskOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "puppetEnvironment": obj.get("puppetEnvironment"),
            "puppetNodeName": obj.get("puppetNodeName"),
