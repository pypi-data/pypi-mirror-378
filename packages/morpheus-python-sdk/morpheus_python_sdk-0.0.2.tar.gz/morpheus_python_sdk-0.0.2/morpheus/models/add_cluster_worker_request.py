...
class AddClusterWorkerRequest(BaseModel):
    """
    AddClusterWorkerRequest
    """ # noqa: E501
    server: Optional[AddClusterRequestClusterServer] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddClusterWorkerRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddClusterWorkerRequest from a dict"""
        if obj is None:
            return None
