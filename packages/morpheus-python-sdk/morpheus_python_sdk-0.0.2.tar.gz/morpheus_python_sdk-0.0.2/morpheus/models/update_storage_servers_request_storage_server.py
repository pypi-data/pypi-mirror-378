...
class UpdateStorageServersRequestStorageServer(BaseModel):
    """
    UpdateStorageServersRequestStorageServer
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name")
    type: Optional[StrictStr] = Field(default=None, description="The `Storage Type` Code or ID")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateStorageServersRequestStorageServer from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateStorageServersRequestStorageServer from a dict"""
        if obj is None:
            return None
