...
class ListJobs200ResponseAllOfJobsInnerAnyOf2(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "labels", "type", "workflow", "jobSummary", "scheduleMode", "dateTime", "status", "namespace", "category", "description", "enabled", "dateCreated", "lastUpdated", "lastRun", "lastResult", "createdBy", "targetType", "targets", "customConfig", "customOptions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListJobs200ResponseAllOfJobsInnerAnyOf2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListJobs200ResponseAllOfJobsInnerAnyOf2 from a dict"""
        if obj is None:
            return None
