...
class IntegrationAnsible(BaseModel):
    """
    IntegrationAnsible
    """ # noqa: E501
    ...
    config: Optional[ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOfConfig] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "enabled", "type", "integrationType", "url", "serviceKey", "isPlugin", "config", "status", "statusDate", "statusMessage", "lastSync", "lastSyncDuration", "credential"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IntegrationAnsible from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IntegrationAnsible from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOfConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
