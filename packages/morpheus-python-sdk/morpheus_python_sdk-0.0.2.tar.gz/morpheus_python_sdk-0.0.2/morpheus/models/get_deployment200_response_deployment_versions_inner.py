...
class GetDeployment200ResponseDeploymentVersionsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "deployType", "fetchUrl", "gitUrl", "gitRef", "userVersion", "version", "status", "dateCreated", "lastUpdated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDeployment200ResponseDeploymentVersionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDeployment200ResponseDeploymentVersionsInner from a dict"""
        if obj is None:
            return None
