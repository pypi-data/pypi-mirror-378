...
class NetworkPoolServerCreateBluecat(BaseModel):
    """
    NetworkPoolServerCreateBluecat
    """ # noqa: E501
    type: StrictStr = Field(description="Type Code (Bluecat)")
    ...
    __properties: ClassVar[List[str]] = ["type", "name", "enabled", "serviceUrl", "serviceUsername", "servicePassword", "serviceThrottleRate", "ignoreSsl", "networkFilter", "config", "credential"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['bluecat']):
            raise ValueError("must be one of enum values ('bluecat')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NetworkPoolServerCreateBluecat from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NetworkPoolServerCreateBluecat from a dict"""
        if obj is None:
            return None
