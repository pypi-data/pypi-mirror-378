...
class ListBillingServers200ResponseAllOfBillingInfoServersInner(BaseModel):
    """
    ...
    usages: Optional[List[ListBillingServers200ResponseAllOfBillingInfoServersInnerUsagesInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListBillingServers200ResponseAllOfBillingInfoServersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListBillingServers200ResponseAllOfBillingInfoServersInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "usages": [ListBillingServers200ResponseAllOfBillingInfoServersInnerUsagesInner.from_dict(_item) for _item in obj["usages"]] if obj.get("usages") is not None else None,
