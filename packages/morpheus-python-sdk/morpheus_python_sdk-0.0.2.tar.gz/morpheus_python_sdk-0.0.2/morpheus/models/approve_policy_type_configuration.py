...
class ApprovePolicyTypeConfiguration(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accountIntegrationId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApprovePolicyTypeConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApprovePolicyTypeConfiguration from a dict"""
        if obj is None:
            return None
