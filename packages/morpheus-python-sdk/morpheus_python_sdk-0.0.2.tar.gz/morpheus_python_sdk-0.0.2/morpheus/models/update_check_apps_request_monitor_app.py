...
class UpdateCheckAppsRequestMonitorApp(BaseModel):
    """
    Payload for creating a new monitoring check app
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Unique name scoped to your account for the check app")
    ...
    severity: Optional[StrictStr] = Field(default='critical', description="Severity level of incidents that are created when this check fails")
    active: Optional[StrictBool] = Field(default=True, description="Used to determine if check app is active")
    checks: Optional[List[StrictInt]] = None
    check_groups: Optional[List[StrictInt]] = Field(default=None, alias="checkGroups")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "description", "inUptime", "severity", "active", "checks", "checkGroups"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateCheckAppsRequestMonitorApp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateCheckAppsRequestMonitorApp from a dict"""
        if obj is None:
            return None
