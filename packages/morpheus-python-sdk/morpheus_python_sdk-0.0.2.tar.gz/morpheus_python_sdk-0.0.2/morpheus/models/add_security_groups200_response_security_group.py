...
class AddSecurityGroups200ResponseSecurityGroup(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "accountId", "groupSource", "externalId", "enabled", "syncSource", "visibility", "active", "zone", "locations", "rules", "tenants", "resourcePermission", "success"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddSecurityGroups200ResponseSecurityGroup from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddSecurityGroups200ResponseSecurityGroup from a dict"""
        if obj is None:
            return None
