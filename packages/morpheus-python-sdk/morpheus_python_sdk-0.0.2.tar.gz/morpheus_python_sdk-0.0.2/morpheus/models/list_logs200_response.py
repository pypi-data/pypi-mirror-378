...
class ListLogs200Response(BaseModel):
    """
    ListLogs200Response
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["sort", "offset", "start", "end", "data", "max", "grandTotal", "total", "success", "count", "meta"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListLogs200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListLogs200Response from a dict"""
        if obj is None:
            return None
