...
class AddPolicies200ResponseAllOfPolicy(BaseModel):
    """
    ...
    role: Optional[AddPolicies200ResponseAllOfPolicyRole] = None
    ...
    config: Optional[AddPolicies200ResponseAllOfPolicyConfig] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddPolicies200ResponseAllOfPolicy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddPolicies200ResponseAllOfPolicy from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "role": AddPolicies200ResponseAllOfPolicyRole.from_dict(obj["role"]) if obj.get("role") is not None else None,
            "refType": obj.get("refType"),
            "refId": obj.get("refId"),
            "eachUser": obj.get("eachUser"),
            "config": AddPolicies200ResponseAllOfPolicyConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
