...
class StorageType(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "code", "name", "displayOrder", "defaultType", "customLabel", "customSize", "customSizeOptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StorageType from a dict"""
        if obj is None:
            return None
