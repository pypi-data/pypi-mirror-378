...
class MessageOfTheDayPolicyTypeConfiguration(BaseModel):
    """
    Configuration settings for the following policy types: - Message of the Day 
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageOfTheDayPolicyTypeConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageOfTheDayPolicyTypeConfiguration from a dict"""
        if obj is None:
            return None
