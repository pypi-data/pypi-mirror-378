...
class ListCatalogItemTypes200ResponseAllOfCatalogItemTypesInnerOptionTypesInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListCatalogItemTypes200ResponseAllOfCatalogItemTypesInnerOptionTypesInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if contextual_default (nullable) is None
        # and model_fields_set contains the field
        if self.contextual_default is None and "contextual_default" in self.model_fields_set:
            _dict['contextualDefault'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListCatalogItemTypes200ResponseAllOfCatalogItemTypesInnerOptionTypesInner from a dict"""
        if obj is None:
            return None
