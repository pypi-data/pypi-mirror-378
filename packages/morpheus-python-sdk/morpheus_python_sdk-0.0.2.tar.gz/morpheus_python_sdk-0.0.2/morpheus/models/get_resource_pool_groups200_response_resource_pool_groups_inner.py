...
class GetResourcePoolGroups200ResponseResourcePoolGroupsInner(BaseModel):
    """
    ...
    pools: Optional[List[StrictInt]] = Field(default=None, description="Array of Resource Pool IDs")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "visibility", "mode", "pools", "tenants", "resourcePermission"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetResourcePoolGroups200ResponseResourcePoolGroupsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetResourcePoolGroups200ResponseResourcePoolGroupsInner from a dict"""
        if obj is None:
            return None
