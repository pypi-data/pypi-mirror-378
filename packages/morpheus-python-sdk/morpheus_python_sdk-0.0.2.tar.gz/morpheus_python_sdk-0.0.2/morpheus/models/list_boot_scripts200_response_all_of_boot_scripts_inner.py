...
class ListBootScripts200ResponseAllOfBootScriptsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "account", "fileName", "description", "content", "createdBy", "visibility"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListBootScripts200ResponseAllOfBootScriptsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListBootScripts200ResponseAllOfBootScriptsInner from a dict"""
        if obj is None:
            return None
