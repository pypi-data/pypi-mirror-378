...
class AddScaleThresholdsRequestScaleThreshold(BaseModel):
    """
    AddScaleThresholdsRequestScaleThreshold
    """ # noqa: E501
    name: StrictStr = Field(description="A name for the scale threshold")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddScaleThresholdsRequestScaleThreshold from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddScaleThresholdsRequestScaleThreshold from a dict"""
        if obj is None:
            return None
