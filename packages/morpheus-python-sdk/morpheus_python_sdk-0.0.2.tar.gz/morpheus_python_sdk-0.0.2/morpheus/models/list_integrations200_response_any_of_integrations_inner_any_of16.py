...
class ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf16(BaseModel):
    """
    ...
    auth_id: Optional[StrictStr] = Field(default=None, alias="authId")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "enabled", "type", "integrationType", "url", "token", "tokenHash", "authType", "authId", "isPlugin", "config", "status", "statusDate", "statusMessage", "lastSync", "lastSyncDuration", "credential"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['vro']):
            raise ValueError("must be one of enum values ('vro')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf16 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf16 from a dict"""
        if obj is None:
            return None
