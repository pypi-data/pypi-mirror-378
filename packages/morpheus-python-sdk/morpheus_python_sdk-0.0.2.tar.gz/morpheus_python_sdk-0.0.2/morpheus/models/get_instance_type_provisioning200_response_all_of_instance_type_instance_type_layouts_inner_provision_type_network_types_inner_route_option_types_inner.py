...
class GetInstanceTypeProvisioning200ResponseAllOfInstanceTypeInstanceTypeLayoutsInnerProvisionTypeNetworkTypesInnerRouteOptionTypesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "code", "fieldName", "fieldLabel", "fieldCode", "fieldContext", "fieldGroup", "fieldClass", "fieldAddOn", "fieldComponent", "fieldInput", "placeHolder", "verifyPattern", "helpBlock", "helpBlockFieldCode", "defaultValue", "optionSource", "optionSourceType", "optionList", "type", "advanced", "required", "exportMeta", "editable", "creatable", "config", "displayOrder", "wrapperClass", "enabled", "noBlank", "dependsOnCode", "visibleOnCode", "requireOnCode", "contextualDefault", "displayValueOnDetails", "showOnCreate", "showOnEdit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetInstanceTypeProvisioning200ResponseAllOfInstanceTypeInstanceTypeLayoutsInnerProvisionTypeNetworkTypesInnerRouteOptionTypesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetInstanceTypeProvisioning200ResponseAllOfInstanceTypeInstanceTypeLayoutsInnerProvisionTypeNetworkTypesInnerRouteOptionTypesInner from a dict"""
        if obj is None:
            return None
