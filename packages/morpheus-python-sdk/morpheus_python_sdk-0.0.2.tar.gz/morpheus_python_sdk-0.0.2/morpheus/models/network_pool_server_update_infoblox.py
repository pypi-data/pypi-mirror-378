...
class NetworkPoolServerUpdateInfoblox(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "enabled", "serviceUrl", "serviceUsername", "servicePassword", "serviceThrottleRate", "ignoreSsl", "networkFilter", "zoneFilter", "tenantMatch", "serviceMode", "config", "credential"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NetworkPoolServerUpdateInfoblox from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NetworkPoolServerUpdateInfoblox from a dict"""
        if obj is None:
            return None
