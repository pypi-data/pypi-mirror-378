...
class AddFileTemplateRequestContainerTemplate(BaseModel):
    """
    AddFileTemplateRequestContainerTemplate
    """ # noqa: E501
    name: StrictStr = Field(description="File template name")
    labels: Optional[List[StrictStr]] = Field(default=None, description="Array of label strings, can be used for filtering.")
    file_name: StrictStr = Field(description="Filename for the file template", alias="fileName")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddFileTemplateRequestContainerTemplate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddFileTemplateRequestContainerTemplate from a dict"""
        if obj is None:
            return None
