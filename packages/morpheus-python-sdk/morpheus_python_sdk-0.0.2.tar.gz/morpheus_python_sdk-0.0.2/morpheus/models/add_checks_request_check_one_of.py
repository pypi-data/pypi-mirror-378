...
class AddChecksRequestCheckOneOf(BaseModel):
    """
    ...
    check_type: Optional[AddChecksRequestCheckOneOfCheckType] = Field(default=None, alias="checkType")
    ...
    config: Optional[AddChecksRequestCheckOneOfConfig] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddChecksRequestCheckOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddChecksRequestCheckOneOf from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "checkType": AddChecksRequestCheckOneOfCheckType.from_dict(obj["checkType"]) if obj.get("checkType") is not None else None,
            ...
            "config": AddChecksRequestCheckOneOfConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
