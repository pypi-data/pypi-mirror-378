...
class IntegrationBindDNS(BaseModel):
    """
    IntegrationBindDNS
    """ # noqa: E501
    ...
    config: Optional[ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf2Config] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "enabled", "type", "integrationType", "host", "isPlugin", "config", "status", "statusDate", "statusMessage", "lastSync", "lastSyncDuration", "credential"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['bindDns']):
            raise ValueError("must be one of enum values ('bindDns')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IntegrationBindDNS from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IntegrationBindDNS from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf2Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
