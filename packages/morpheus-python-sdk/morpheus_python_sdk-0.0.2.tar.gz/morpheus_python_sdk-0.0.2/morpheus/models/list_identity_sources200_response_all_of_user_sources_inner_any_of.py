...
class ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf(BaseModel):
    """
    ...
    config: Optional[ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOfConfig] = None
    role_mappings: Optional[List[ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOfRoleMappingsInner]] = Field(default=None, alias="roleMappings")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOfConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "roleMappings": [ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOfRoleMappingsInner.from_dict(_item) for _item in obj["roleMappings"]] if obj.get("roleMappings") is not None else None,
