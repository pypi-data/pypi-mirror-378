...
class ClientsApi:
    ...
    def add_client(
        self,
        add_client_request: Optional[AddClientRequest] = None,
        ...
        :param add_client_request:
        :type add_client_request: AddClientRequest
    ...
    def add_client_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddClient200Response]:
        """Create an Oauth Client
    ...
    def _add_client_serialize(
        ...
        if add_client_request is not None:
            _body_params = add_client_request
    ...
    def list_clients(
        ...
        phrase: Annotated[Optional[StrictStr], Field(description="Search phrase for partial matches on clientId")] = None,
        client_id: Annotated[Optional[StrictStr], Field(description="Search phrase for partial matches on clientId")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type direction: str
        :param phrase: Search phrase for partial matches on clientId
        :type phrase: str
        :param client_id: Search phrase for partial matches on clientId
        :type client_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def remove_clients(
        ...
        _param = self._remove_clients_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def remove_clients_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def remove_clients_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        _request_timeout: Union[
            None,
    ...
    def update_clients(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        update_clients_request: Optional[UpdateClientsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Morpheus ID of the Object being referenced (required)
        :type id: int
        :param update_clients_request:
        :type update_clients_request: UpdateClientsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_clients_serialize(
            id=id,
    ...
    @validate_call
    def update_clients_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        update_clients_request: Optional[UpdateClientsRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_clients_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        update_clients_request: Optional[UpdateClientsRequest] = None,
        _request_timeout: Union[
    ...
    def _update_clients_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_clients_request is not None:
            _body_params = update_clients_request
