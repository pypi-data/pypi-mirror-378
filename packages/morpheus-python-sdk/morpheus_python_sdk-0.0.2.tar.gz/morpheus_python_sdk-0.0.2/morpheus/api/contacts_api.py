...
class ContactsApi:
    ...
    def add_contacts(
        self,
        add_contacts_request: Optional[AddContactsRequest] = None,
        ...
        :param add_contacts_request:
        :type add_contacts_request: AddContactsRequest
        ...
        _param = self._add_contacts_serialize(
    ...
    @validate_call
    def add_contacts_with_http_info(
        self,
        add_contacts_request: Optional[AddContactsRequest] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddContacts200Response]:
        """Create a New Contact
    ...
    @validate_call
    def add_contacts_without_preload_content(
        self,
        add_contacts_request: Optional[AddContactsRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _add_contacts_serialize(
        ...
        if add_contacts_request is not None:
            _body_params = add_contacts_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/monitoring/contacts',
    ...
    def _delete_contacts_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/monitoring/contacts/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_contacts(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        update_contacts_request: Optional[UpdateContactsRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Morpheus ID of the Object being referenced (required)
        :type id: int
        :param update_contacts_request:
        :type update_contacts_request: UpdateContactsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _update_contacts_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_contacts_request is not None:
            _body_params = update_contacts_request
