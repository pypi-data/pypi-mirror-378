...
class TestAddClusterRequest(unittest.TestCase):
    """AddClusterRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddClusterRequest:
        """Test AddClusterRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddClusterRequest`
        """
        model = AddClusterRequest()
        if include_optional:
            return AddClusterRequest(
                cluster = morpheus.models.add_cluster_request_cluster.addCluster_request_cluster(
                    type = null, 
                    name = '', 
                    description = '', 
                    labels = [
    ...
    def testAddClusterRequest(self):
        """Test AddClusterRequest"""
