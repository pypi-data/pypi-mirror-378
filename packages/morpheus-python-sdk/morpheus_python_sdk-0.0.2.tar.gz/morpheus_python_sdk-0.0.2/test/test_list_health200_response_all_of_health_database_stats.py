...
class TestListHealth200ResponseAllOfHealthDatabaseStats(unittest.TestCase):
    """ListHealth200ResponseAllOfHealthDatabaseStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListHealth200ResponseAllOfHealthDatabaseStats:
        """Test ListHealth200ResponseAllOfHealthDatabaseStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListHealth200ResponseAllOfHealthDatabaseStats`
        """
        model = ListHealth200ResponseAllOfHealthDatabaseStats()
        if include_optional:
            return ListHealth200ResponseAllOfHealthDatabaseStats(
                aborted_clients = '',
                aborted_connects = '',
    ...
    def testListHealth200ResponseAllOfHealthDatabaseStats(self):
        """Test ListHealth200ResponseAllOfHealthDatabaseStats"""
