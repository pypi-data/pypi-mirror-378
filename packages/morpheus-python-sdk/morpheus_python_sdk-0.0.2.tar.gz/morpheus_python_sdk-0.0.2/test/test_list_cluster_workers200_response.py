...
class TestListClusterWorkers200Response(unittest.TestCase):
    """ListClusterWorkers200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListClusterWorkers200Response:
        """Test ListClusterWorkers200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListClusterWorkers200Response`
        """
        model = ListClusterWorkers200Response()
        if include_optional:
            return ListClusterWorkers200Response(
                workers = [
                    morpheus.models.get_cluster_masters_200_response_masters_inner.getClusterMasters_200_response_masters_inner(
                        id = 56, 
                        uuid = '', 
                        external_id = '', 
                        internal_id = '', 
                        ...
                        stats = morpheus.models.get_cluster_masters_200_response_masters_inner_stats.getClusterMasters_200_response_masters_inner_stats(
                            used_storage = 56, 
                            reserved_storage = 56, 
                            max_storage = 56, 
                            used_memory = 56, 
                        ...
                        server_os = '', 
                        volumes = [
                            morpheus.models.get_cluster_masters_200_response_masters_inner_volumes_inner.getClusterMasters_200_response_masters_inner_volumes_inner(
                                id = 56, 
                                name = '', 
                                controller_id = '', 
                        ...
                        interfaces = [
                            morpheus.models.get_cluster_masters_200_response_masters_inner_interfaces_inner.getClusterMasters_200_response_masters_inner_interfaces_inner(
                                id = 56, 
                                ref_type = '', 
                                ref_id = '', 
                                name = '', 
    ...
    def testListClusterWorkers200Response(self):
        """Test ListClusterWorkers200Response"""
