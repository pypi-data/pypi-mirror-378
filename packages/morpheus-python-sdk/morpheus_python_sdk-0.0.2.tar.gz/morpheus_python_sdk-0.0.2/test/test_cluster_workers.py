...
class TestClusterWorkers(unittest.TestCase):
    """ClusterWorkers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterWorkers:
        """Test ClusterWorkers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterWorkers`
        """
        model = ClusterWorkers()
        if include_optional:
