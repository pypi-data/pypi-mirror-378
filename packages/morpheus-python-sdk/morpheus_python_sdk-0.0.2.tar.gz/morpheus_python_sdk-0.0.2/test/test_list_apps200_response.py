...
class TestListApps200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListApps200Response:
        ...
        """
        model = ListApps200Response()
        if include_optional:
            return ListApps200Response(
                apps = [
                    morpheus.models.list_apps_200_response_all_of_apps_inner.listApps_200_response_allOf_apps_inner(
                        id = 56, 
                        name = '', 
                        description = '', 
                        labels = [
