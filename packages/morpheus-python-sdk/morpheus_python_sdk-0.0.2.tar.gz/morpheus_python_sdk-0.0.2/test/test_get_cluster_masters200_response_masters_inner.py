...
class TestGetClusterMasters200ResponseMastersInner(unittest.TestCase):
    """GetClusterMasters200ResponseMastersInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetClusterMasters200ResponseMastersInner:
        """Test GetClusterMasters200ResponseMastersInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetClusterMasters200ResponseMastersInner`
        """
        model = GetClusterMasters200ResponseMastersInner()
        if include_optional:
            return GetClusterMasters200ResponseMastersInner(
                id = 56,
                uuid = '',
                external_id = '',
                internal_id = '',
    ...
    def testGetClusterMasters200ResponseMastersInner(self):
        """Test GetClusterMasters200ResponseMastersInner"""
