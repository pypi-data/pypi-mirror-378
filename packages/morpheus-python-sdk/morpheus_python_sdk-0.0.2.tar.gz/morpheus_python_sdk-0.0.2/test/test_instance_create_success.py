...
class TestInstanceCreateSuccess(unittest.TestCase):
    """InstanceCreateSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InstanceCreateSuccess:
        """Test InstanceCreateSuccess
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InstanceCreateSuccess`
        """
        model = InstanceCreateSuccess()
        if include_optional:
            return InstanceCreateSuccess(
    ...
    def testInstanceCreateSuccess(self):
        """Test InstanceCreateSuccess"""
