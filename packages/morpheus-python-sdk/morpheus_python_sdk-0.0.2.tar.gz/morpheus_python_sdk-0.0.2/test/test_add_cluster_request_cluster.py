...
class TestAddClusterRequestCluster(unittest.TestCase):
    """AddClusterRequestCluster unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddClusterRequestCluster:
        """Test AddClusterRequestCluster
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddClusterRequestCluster`
        """
        model = AddClusterRequestCluster()
        if include_optional:
            return AddClusterRequestCluster(
                type = None,
                name = '',
                description = '',
                labels = [
    ...
    def testAddClusterRequestCluster(self):
        """Test AddClusterRequestCluster"""
