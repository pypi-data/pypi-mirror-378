...
class TestClusterServerCreate(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClusterServerCreate:
        """Test ClusterServerCreate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterServerCreate`
        """
        model = ClusterServerCreate()
        if include_optional:
            return ClusterServerCreate(
