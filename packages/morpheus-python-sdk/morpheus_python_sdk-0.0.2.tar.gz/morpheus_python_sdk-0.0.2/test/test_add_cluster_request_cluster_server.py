...
class TestAddClusterRequestClusterServer(unittest.TestCase):
    """AddClusterRequestClusterServer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddClusterRequestClusterServer:
        """Test AddClusterRequestClusterServer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddClusterRequestClusterServer`
        """
        model = AddClusterRequestClusterServer()
        if include_optional:
            return AddClusterRequestClusterServer(
    ...
    def testAddClusterRequestClusterServer(self):
        """Test AddClusterRequestClusterServer"""
