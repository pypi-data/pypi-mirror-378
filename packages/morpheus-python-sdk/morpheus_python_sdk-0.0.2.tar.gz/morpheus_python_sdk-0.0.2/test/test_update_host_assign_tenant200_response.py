...
class TestUpdateHostAssignTenant200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateHostAssignTenant200Response:
        """Test UpdateHostAssignTenant200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateHostAssignTenant200Response`
        """
        model = UpdateHostAssignTenant200Response()
        if include_optional:
            return UpdateHostAssignTenant200Response(
                server = morpheus.models.list_hosts_200_response_all_of_servers_inner.listHosts_200_response_allOf_servers_inner(
                    id = 56, 
                    uuid = '', 
                    external_id = '', 
                    internal_id = '', 
