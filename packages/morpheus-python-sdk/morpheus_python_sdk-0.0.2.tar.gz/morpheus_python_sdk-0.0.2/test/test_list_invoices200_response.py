    ...
    def make_instance(self, include_optional) -> ListInvoices200Response:
        ...
        if include_optional:
            return ListInvoices200Response(
                invoices = [
                    morpheus.models.list_invoices_200_response_all_of_invoices_inner.listInvoices_200_response_allOf_invoices_inner(
                        id = 56, 
                        owner_id = 56, 
                        account = morpheus.models.get_alerts_200_response_all_of_check_groups_inner_instance.getAlerts_200_response_allOf_checkGroups_inner_instance(
                            id = 56, 
                            name = '', ), 
                        group = morpheus.models.config.config(), 
                        cloud = morpheus.models.list_invoices_200_response_all_of_invoices_inner_cloud.listInvoices_200_response_allOf_invoices_inner_cloud(
                            ...
                            name = '', 
                            uuid = '', ), 
                        instance = morpheus.models.config.config(), 
                        server = '', 
                        cluster = '', 
                        user = morpheus.models.config.config(), 
                        plan = morpheus.models.config.config(), 
                        tags = [
                            None
                            ], 
                        project = '', 
