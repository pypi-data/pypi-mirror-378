...
class TestListClusterVolumes200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ListClusterVolumes200Response:
        """Test ListClusterVolumes200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListClusterVolumes200Response`
        """
        model = ListClusterVolumes200Response()
        if include_optional:
