...
class TestAddClusterWorkerRequest(unittest.TestCase):
    """AddClusterWorkerRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddClusterWorkerRequest:
        """Test AddClusterWorkerRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddClusterWorkerRequest`
        """
        model = AddClusterWorkerRequest()
        if include_optional:
            return AddClusterWorkerRequest(
    ...
    def testAddClusterWorkerRequest(self):
        """Test AddClusterWorkerRequest"""
