...
class GroupsApi:
    ...
    def add_groups(
        self,
        add_groups_request: Optional[AddGroupsRequest] = None,
        ...
        :param add_groups_request:
        :type add_groups_request: AddGroupsRequest
        ...
        _param = self._add_groups_serialize(
            add_groups_request=add_groups_request,
    ...
    def add_groups_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AddGroups200Response]:
        """Creates a Group
    ...
    @validate_call
    def add_groups_without_preload_content(
        self,
        add_groups_request: Optional[AddGroupsRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _add_groups_serialize(
        ...
        if add_groups_request is not None:
            _body_params = add_groups_request
    ...
    def remove_groups(
        ...
        _param = self._remove_groups_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def remove_groups_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def remove_groups_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        _request_timeout: Union[
            None,
    ...
    def update_groups_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateGroups200Response]:
        """Updates a Group
    ...
    def update_groups_zones(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        update_groups_zones_request: Optional[UpdateGroupsZonesRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Morpheus ID of the Object being referenced (required)
        :type id: int
        :param update_groups_zones_request:
        :type update_groups_zones_request: UpdateGroupsZonesRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_groups_zones_serialize(
            id=id,
            update_groups_zones_request=update_groups_zones_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_groups_zones_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        update_groups_zones_request: Optional[UpdateGroupsZonesRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_groups_zones_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Morpheus ID of the Object being referenced")],
        update_groups_zones_request: Optional[UpdateGroupsZonesRequest] = None,
        _request_timeout: Union[
    ...
    def _update_groups_zones_serialize(
        self,
        id,
        ...
        # process the form parameters
        # process the body parameter
        if update_groups_zones_request is not None:
            _body_params = update_groups_zones_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/groups/{id}/update-zones',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
