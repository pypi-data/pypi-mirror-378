...
class ListTasks200ResponseAllOfTasksInnerAnyOf16TaskOptions(BaseModel):
    """
    ...
    write_attributes_attributes: Optional[StrictStr] = Field(default=None, alias="writeAttributes.attributes")
    username: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["host", "sshKey", "localScriptGitRef", "port", "localScriptGitId", "password", "passwordHash", "writeAttributes.attributes", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf16TaskOptions from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if write_attributes_attributes (nullable) is None
        # and model_fields_set contains the field
        if self.write_attributes_attributes is None and "write_attributes_attributes" in self.model_fields_set:
            _dict['writeAttributes.attributes'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf16TaskOptions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "writeAttributes.attributes": obj.get("writeAttributes.attributes"),
