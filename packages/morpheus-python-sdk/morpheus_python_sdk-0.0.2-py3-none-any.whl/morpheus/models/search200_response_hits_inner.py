...
class Search200ResponseHitsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "uuid", "name", "description", "type", "dateCreated", "score"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Search200ResponseHitsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Search200ResponseHitsInner from a dict"""
        if obj is None:
            return None
