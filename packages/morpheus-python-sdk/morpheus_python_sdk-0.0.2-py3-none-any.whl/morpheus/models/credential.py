...
class Credential(BaseModel):
    ...
    config: Optional[AddCredentials200ResponseAllOfCredentialConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": AddCredentials200ResponseAllOfCredentialConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
