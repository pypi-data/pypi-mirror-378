...
class GetStaticRoutes200ResponseNetworkRoutesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "code", "description", "priority", "routeType", "source", "sourceType", "destination", "destinationType", "defaultRoute", "networkMtu", "externalInterface", "internalId", "uniqueId", "externalType", "enabled", "visible"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetStaticRoutes200ResponseNetworkRoutesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetStaticRoutes200ResponseNetworkRoutesInner from a dict"""
        if obj is None:
            return None
