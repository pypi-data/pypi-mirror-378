...
class GetNetworkRouters200ResponseNetworkRoutersInnerType(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "code", "name", "description", "enabled", "creatable", "selectable", "hasFirewall", "hasDhcp", "hasRouting", "hasNetworkServer", "optionTypes", "ruleOptionTypes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetNetworkRouters200ResponseNetworkRoutersInnerType from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetNetworkRouters200ResponseNetworkRoutersInnerType from a dict"""
        if obj is None:
            return None
