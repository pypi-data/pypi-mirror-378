...
class ListClusterSecrets200Response(BaseModel):
    """
    ListClusterSecrets200Response
    """ # noqa: E501
    secrets: Optional[List[ListClusterNetworkEndpoints200ResponseAllOfEndpointsInner]] = None
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["secrets", "meta"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListClusterSecrets200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListClusterSecrets200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "secrets": [ListClusterNetworkEndpoints200ResponseAllOfEndpointsInner.from_dict(_item) for _item in obj["secrets"]] if obj.get("secrets") is not None else None,
