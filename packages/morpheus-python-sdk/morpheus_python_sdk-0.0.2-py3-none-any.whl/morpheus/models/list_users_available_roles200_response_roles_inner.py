...
class ListUsersAvailableRoles200ResponseRolesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "authority", "description", "roleType", "owner"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListUsersAvailableRoles200ResponseRolesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListUsersAvailableRoles200ResponseRolesInner from a dict"""
        if obj is None:
            return None
