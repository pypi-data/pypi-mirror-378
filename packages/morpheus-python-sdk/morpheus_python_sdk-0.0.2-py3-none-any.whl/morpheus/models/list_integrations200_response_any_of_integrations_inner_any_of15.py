...
class ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf15(BaseModel):
    """
    ...
    config: Optional[ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf15Config] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "enabled", "type", "integrationType", "url", "isPlugin", "config", "status", "statusDate", "statusMessage", "lastSync", "lastSyncDuration", "credential"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf15 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf15 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf15Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
