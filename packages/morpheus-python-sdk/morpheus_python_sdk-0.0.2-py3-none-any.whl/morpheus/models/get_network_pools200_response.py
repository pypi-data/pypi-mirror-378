...
class GetNetworkPools200Response(BaseModel):
    """
    GetNetworkPools200Response
    """ # noqa: E501
    network_pools: Optional[Any] = Field(default=None, alias="networkPools")
    network_pool_count: Optional[StrictInt] = Field(default=None, alias="networkPoolCount")
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["networkPools", "networkPoolCount", "meta"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetNetworkPools200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetNetworkPools200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "networkPoolCount": obj.get("networkPoolCount"),
