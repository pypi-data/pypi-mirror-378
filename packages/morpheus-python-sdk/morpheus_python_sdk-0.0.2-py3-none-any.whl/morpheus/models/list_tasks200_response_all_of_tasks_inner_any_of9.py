...
class ListTasks200ResponseAllOfTasksInnerAnyOf9(BaseModel):
    """
    ...
    task_type: Optional[ListTasks200ResponseAllOfTasksInnerAnyOf9TaskType] = Field(default=None, alias="taskType")
    labels: Optional[List[StrictStr]] = None
    visibility: Optional[StrictStr] = None
    task_options: Optional[ListTasks200ResponseAllOfTasksInnerAnyOf9TaskOptions] = Field(default=None, alias="taskOptions")
    ...
    __properties: ClassVar[List[str]] = ["id", "accountId", "name", "code", "taskType", "labels", "visibility", "taskOptions", "resultType", "executeTarget", "retryable", "retryCount", "retryDelaySeconds", "allowCustomConfig", "credential", "dateCreated", "lastUpdated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf9 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf9 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "code": obj.get("code"),
            "taskType": ListTasks200ResponseAllOfTasksInnerAnyOf9TaskType.from_dict(obj["taskType"]) if obj.get("taskType") is not None else None,
            "labels": obj.get("labels"),
            "visibility": obj.get("visibility"),
            "taskOptions": ListTasks200ResponseAllOfTasksInnerAnyOf9TaskOptions.from_dict(obj["taskOptions"]) if obj.get("taskOptions") is not None else None,
