...
class ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf7(BaseModel):
    """
    ...
    config: Optional[ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf7Config] = None
    role_mappings: Optional[List[Dict[str, Any]]] = Field(default=None, alias="roleMappings")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf7 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf7 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": ListIdentitySources200ResponseAllOfUserSourcesInnerAnyOf7Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "roleMappings": obj.get("roleMappings"),
