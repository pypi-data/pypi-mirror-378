...
class ListClusterDatastores200ResponseAllOfDatastoresInner(BaseModel):
    """
    ...
    locations: Optional[List[ListClusterDatastores200ResponseAllOfDatastoresInnerLocationsInner]] = None
    resource_permissions: Optional[ListClusterDatastores200ResponseAllOfDatastoresInnerResourcePermissions] = Field(default=None, alias="resourcePermissions")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "code", "type", "visibility", "storageSize", "freeSpace", "drsEnabled", "active", "allowWrite", "defaultStore", "online", "allowRead", "allowProvision", "refType", "refId", "externalId", "status", "statusMessage", "zone", "zonePool", "owner", "tenants", "datastores", "locations", "resourcePermissions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListClusterDatastores200ResponseAllOfDatastoresInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListClusterDatastores200ResponseAllOfDatastoresInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "locations": [ListClusterDatastores200ResponseAllOfDatastoresInnerLocationsInner.from_dict(_item) for _item in obj["locations"]] if obj.get("locations") is not None else None,
            "resourcePermissions": ListClusterDatastores200ResponseAllOfDatastoresInnerResourcePermissions.from_dict(obj["resourcePermissions"]) if obj.get("resourcePermissions") is not None else None
        })
