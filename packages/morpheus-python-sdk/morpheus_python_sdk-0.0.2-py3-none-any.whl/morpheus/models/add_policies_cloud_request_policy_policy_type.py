...
class AddPoliciesCloudRequestPolicyPolicyType(BaseModel):
    """
    AddPoliciesCloudRequestPolicyPolicyType
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="The policy type")
    config: Optional[AddPoliciesGroupRequestPolicyPolicyTypeConfig] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddPoliciesCloudRequestPolicyPolicyType from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddPoliciesCloudRequestPolicyPolicyType from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "config": AddPoliciesGroupRequestPolicyPolicyTypeConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
