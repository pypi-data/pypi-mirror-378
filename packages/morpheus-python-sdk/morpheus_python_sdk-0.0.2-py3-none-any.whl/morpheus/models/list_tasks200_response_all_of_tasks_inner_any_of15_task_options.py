...
class ListTasks200ResponseAllOfTasksInnerAnyOf15TaskOptions(BaseModel):
    """
    ...
    vro_body: Optional[StrictStr] = Field(default=None, alias="vroBody")
    ...
    __properties: ClassVar[List[str]] = ["sshKey", "localScriptGitRef", "port", "vroBody", "password", "passwordHash", "host", "localScriptGitId", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf15TaskOptions from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if vro_body (nullable) is None
        # and model_fields_set contains the field
        if self.vro_body is None and "vro_body" in self.model_fields_set:
            _dict['vroBody'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf15TaskOptions from a dict"""
        if obj is None:
            return None
