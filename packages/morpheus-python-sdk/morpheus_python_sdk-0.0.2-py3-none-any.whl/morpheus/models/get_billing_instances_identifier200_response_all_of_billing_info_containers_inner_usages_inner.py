...
class GetBillingInstancesIdentifier200ResponseAllOfBillingInfoContainersInnerUsagesInner(BaseModel):
    """
    ...
    applicable_prices: Optional[List[GetBillingInstancesIdentifier200ResponseAllOfBillingInfoContainersInnerUsagesInnerApplicablePricesInner]] = Field(default=None, alias="applicablePrices")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetBillingInstancesIdentifier200ResponseAllOfBillingInfoContainersInnerUsagesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetBillingInstancesIdentifier200ResponseAllOfBillingInfoContainersInnerUsagesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "applicablePrices": [GetBillingInstancesIdentifier200ResponseAllOfBillingInfoContainersInnerUsagesInnerApplicablePricesInner.from_dict(_item) for _item in obj["applicablePrices"]] if obj.get("applicablePrices") is not None else None,
