...
class ListInstances200Response(BaseModel):
    ...
    """ # noqa: E501
    instances: Optional[List[ListInstances200ResponseAllOfInstancesInner]] = None
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["instances", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "instances": [ListInstances200ResponseAllOfInstancesInner.from_dict(_item) for _item in obj["instances"]] if obj.get("instances") is not None else None,
