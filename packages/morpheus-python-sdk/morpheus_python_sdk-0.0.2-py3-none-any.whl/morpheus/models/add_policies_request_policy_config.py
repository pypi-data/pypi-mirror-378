...
ADDPOLICIESREQUESTPOLICYCONFIG_ANY_OF_SCHEMAS = ["ApprovePolicyTypeConfiguration", "BackupCreationPolicyTypeConfiguration", "BackupTargetsPolicyTypeConfiguration", "BudgetPolicyTypeConfiguration", "ClusterResourceNamePolicyTypeConfiguration", "CypherAccessPolicyTypeConfiguration", "DelayedDeletePolicyTypeConfiguration", "ExpirationPolicyTypeConfiguration", "FileShareStorageQuotaPolicyTypeConfiguration", "HostnamePolicyTypeConfiguration", "InstanceNamePolicyTypeConfiguration", "MaxContainersPolicyTypeConfiguration", "MaxCoresPolicyTypeConfiguration", "MaxHostsPolicyTypeConfiguration", "MaxLoadBalancerPoolsPolicyTypeConfiguration", "MaxMemoryPolicyTypeConfiguration", "MaxPoolMembersPolicyTypeConfiguration", "MaxStorageAndObjectStorageQuotaPolicyTypeConfiguration", "MaxVMsPolicyTypeConfiguration", "MaxVirtualServersPolicyTypeConfiguration", "MessageOfTheDayPolicyTypeConfiguration", "NetworkQuotaPolicyTypeConfiguration", "PowerSchedulePolicyTypeConfiguration", "RouterQuotaPolicyTypeConfiguration", "ShutdownPolicyTypeConfiguration", "StorageServerStorageQuotaPolicyTypeConfiguration", "TagsPolicyTypeConfiguration", "UserCreationPolicyTypeConfiguration", "UserGroupCreationPolicyTypeConfiguration", "WorkflowPolicyTypeConfiguration"]

class AddPoliciesRequestPolicyConfig(BaseModel):
    """
    ...
    # data type: MaxCoresPolicyTypeConfiguration
    anyof_schema_13_validator: Optional[MaxCoresPolicyTypeConfiguration] = None
    ...
    # data type: MaxMemoryPolicyTypeConfiguration
    anyof_schema_16_validator: Optional[MaxMemoryPolicyTypeConfiguration] = None
    ...
    # data type: MaxStorageAndObjectStorageQuotaPolicyTypeConfiguration
    anyof_schema_18_validator: Optional[MaxStorageAndObjectStorageQuotaPolicyTypeConfiguration] = None
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = AddPoliciesRequestPolicyConfig.model_construct()
        error_messages = []
        ...
        # validate data type: MaxCoresPolicyTypeConfiguration
        if not isinstance(v, MaxCoresPolicyTypeConfiguration):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MaxCoresPolicyTypeConfiguration`")
        else:
            return v
        ...
        # validate data type: MaxMemoryPolicyTypeConfiguration
        if not isinstance(v, MaxMemoryPolicyTypeConfiguration):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MaxMemoryPolicyTypeConfiguration`")
        else:
            return v
        ...
        # validate data type: MaxStorageAndObjectStorageQuotaPolicyTypeConfiguration
        if not isinstance(v, MaxStorageAndObjectStorageQuotaPolicyTypeConfiguration):
            error_messages.append(f"Error! Input type `{type(v)}` is not `MaxStorageAndObjectStorageQuotaPolicyTypeConfiguration`")
        else:
            return v
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in AddPoliciesRequestPolicyConfig with anyOf schemas: ApprovePolicyTypeConfiguration, BackupCreationPolicyTypeConfiguration, BackupTargetsPolicyTypeConfiguration, BudgetPolicyTypeConfiguration, ClusterResourceNamePolicyTypeConfiguration, CypherAccessPolicyTypeConfiguration, DelayedDeletePolicyTypeConfiguration, ExpirationPolicyTypeConfiguration, FileShareStorageQuotaPolicyTypeConfiguration, HostnamePolicyTypeConfiguration, InstanceNamePolicyTypeConfiguration, MaxContainersPolicyTypeConfiguration, MaxCoresPolicyTypeConfiguration, MaxHostsPolicyTypeConfiguration, MaxLoadBalancerPoolsPolicyTypeConfiguration, MaxMemoryPolicyTypeConfiguration, MaxPoolMembersPolicyTypeConfiguration, MaxStorageAndObjectStorageQuotaPolicyTypeConfiguration, MaxVMsPolicyTypeConfiguration, MaxVirtualServersPolicyTypeConfiguration, MessageOfTheDayPolicyTypeConfiguration, NetworkQuotaPolicyTypeConfiguration, PowerSchedulePolicyTypeConfiguration, RouterQuotaPolicyTypeConfiguration, ShutdownPolicyTypeConfiguration, StorageServerStorageQuotaPolicyTypeConfiguration, TagsPolicyTypeConfiguration, UserCreationPolicyTypeConfiguration, UserGroupCreationPolicyTypeConfiguration, WorkflowPolicyTypeConfiguration. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_13_validator: Optional[MaxCoresPolicyTypeConfiguration] = None
        try:
            instance.actual_instance = MaxCoresPolicyTypeConfiguration.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_14_validator: Optional[MaxHostsPolicyTypeConfiguration] = None
        ...
        # anyof_schema_16_validator: Optional[MaxMemoryPolicyTypeConfiguration] = None
        try:
            instance.actual_instance = MaxMemoryPolicyTypeConfiguration.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_17_validator: Optional[MaxPoolMembersPolicyTypeConfiguration] = None
        ...
        # anyof_schema_18_validator: Optional[MaxStorageAndObjectStorageQuotaPolicyTypeConfiguration] = None
        try:
            instance.actual_instance = MaxStorageAndObjectStorageQuotaPolicyTypeConfiguration.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_19_validator: Optional[MaxVirtualServersPolicyTypeConfiguration] = None
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into AddPoliciesRequestPolicyConfig with anyOf schemas: ApprovePolicyTypeConfiguration, BackupCreationPolicyTypeConfiguration, BackupTargetsPolicyTypeConfiguration, BudgetPolicyTypeConfiguration, ClusterResourceNamePolicyTypeConfiguration, CypherAccessPolicyTypeConfiguration, DelayedDeletePolicyTypeConfiguration, ExpirationPolicyTypeConfiguration, FileShareStorageQuotaPolicyTypeConfiguration, HostnamePolicyTypeConfiguration, InstanceNamePolicyTypeConfiguration, MaxContainersPolicyTypeConfiguration, MaxCoresPolicyTypeConfiguration, MaxHostsPolicyTypeConfiguration, MaxLoadBalancerPoolsPolicyTypeConfiguration, MaxMemoryPolicyTypeConfiguration, MaxPoolMembersPolicyTypeConfiguration, MaxStorageAndObjectStorageQuotaPolicyTypeConfiguration, MaxVMsPolicyTypeConfiguration, MaxVirtualServersPolicyTypeConfiguration, MessageOfTheDayPolicyTypeConfiguration, NetworkQuotaPolicyTypeConfiguration, PowerSchedulePolicyTypeConfiguration, RouterQuotaPolicyTypeConfiguration, ShutdownPolicyTypeConfiguration, StorageServerStorageQuotaPolicyTypeConfiguration, TagsPolicyTypeConfiguration, UserCreationPolicyTypeConfiguration, UserGroupCreationPolicyTypeConfiguration, WorkflowPolicyTypeConfiguration. Details: " + ", ".join(error_messages))
        else:
            return instance
