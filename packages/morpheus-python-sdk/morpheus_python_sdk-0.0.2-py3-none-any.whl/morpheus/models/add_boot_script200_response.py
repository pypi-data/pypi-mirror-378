...
class AddBootScript200Response(BaseModel):
    """
    AddBootScript200Response
    """ # noqa: E501
    boot_script: Optional[ListBootScripts200ResponseAllOfBootScriptsInner] = Field(default=None, alias="bootScript")
    ...
    __properties: ClassVar[List[str]] = ["bootScript", "errorCode", "inProgress", "success", "msg", "errors"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddBootScript200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddBootScript200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "bootScript": ListBootScripts200ResponseAllOfBootScriptsInner.from_dict(obj["bootScript"]) if obj.get("bootScript") is not None else None,
