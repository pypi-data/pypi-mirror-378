...
class UpdateCloudResourcePoolRequestResourcePool(BaseModel):
    """
    ...
    inventory: Optional[StrictBool] = Field(default=None, description="Enable `True` or disable `False` inventory sync for resource pool during cloud refresh")
    ...
    __properties: ClassVar[List[str]] = ["active", "visibility", "displayName", "inventory", "tenantPermissions", "resourcePermissions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateCloudResourcePoolRequestResourcePool from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateCloudResourcePoolRequestResourcePool from a dict"""
        if obj is None:
            return None
