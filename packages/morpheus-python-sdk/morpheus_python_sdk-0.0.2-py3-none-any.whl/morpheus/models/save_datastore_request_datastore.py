...
class SaveDatastoreRequestDatastore(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "datastoreType", "refType", "refId", "storageServer", "visibility", "active", "defaultStore", "tenants", "resourcePermissions", "datastores"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SaveDatastoreRequestDatastore from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SaveDatastoreRequestDatastore from a dict"""
        if obj is None:
            return None
