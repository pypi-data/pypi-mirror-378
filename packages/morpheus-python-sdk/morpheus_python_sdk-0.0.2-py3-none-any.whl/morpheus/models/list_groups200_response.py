...
class ListGroups200Response(BaseModel):
    ...
    """ # noqa: E501
    groups: Optional[List[ListGroups200ResponseAllOfGroupsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [ListGroups200ResponseAllOfGroupsInner.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
