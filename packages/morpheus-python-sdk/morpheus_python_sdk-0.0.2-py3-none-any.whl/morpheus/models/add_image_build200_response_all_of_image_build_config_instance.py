...
class AddImageBuild200ResponseAllOfImageBuildConfigInstance(BaseModel):
    """
    ...
    user_group: Optional[ListClouds200ResponseAllOfZonesInnerConfigAnyOfNetworkServer] = Field(default=None, alias="userGroup")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["layout", "type", "userGroup"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddImageBuild200ResponseAllOfImageBuildConfigInstance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddImageBuild200ResponseAllOfImageBuildConfigInstance from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "userGroup": ListClouds200ResponseAllOfZonesInnerConfigAnyOfNetworkServer.from_dict(obj["userGroup"]) if obj.get("userGroup") is not None else None
        })
