...
class BackupStorageProvider(BaseModel):
    """
    BackupStorageProvider
    """ # noqa: E501
    location_type: StrictStr = Field(alias="locationType")
    name: StrictStr = Field(description="A name for the backup")
    source_provider_id: Optional[StrictInt] = Field(default=None, description="Source Object Store. The ID of the storage provider (bucket) to be backed up.", alias="sourceProviderId")
    storage_provider_id: Optional[StrictInt] = Field(default=None, description="Target Object Store. The ID of the storage provider (bucket) the backup will be copied to.", alias="storageProviderId")
    ...
    __properties: ClassVar[List[str]] = ["locationType", "name", "sourceProviderId", "storageProviderId", "backupType", "jobAction", "jobId", "jobName", "jobSchedule", "retentionCount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BackupStorageProvider from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BackupStorageProvider from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "sourceProviderId": obj.get("sourceProviderId"),
            "storageProviderId": obj.get("storageProviderId"),
