...
class AddInstance200ResponseAllOfOneOfInstanceVolumesInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddInstance200ResponseAllOfOneOfInstanceVolumesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddInstance200ResponseAllOfOneOfInstanceVolumesInner from a dict"""
        if obj is None:
            return None
