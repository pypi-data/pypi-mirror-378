...
class ListApprovals200Response(BaseModel):
    ...
    """ # noqa: E501
    approvals: Optional[List[ListApprovals200ResponseAllOfApprovalsInner]] = None
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["approvals", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "approvals": [ListApprovals200ResponseAllOfApprovalsInner.from_dict(_item) for _item in obj["approvals"]] if obj.get("approvals") is not None else None,
