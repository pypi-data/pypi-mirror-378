...
class ListApps200ResponseAllOfAppsInner(BaseModel):
    """
    ...
    stats: Optional[ListApps200ResponseAllOfAppsInnerStats] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "description", "labels", "environment", "accountId", "account", "owner", "siteId", "group", "blueprint", "type", "dateCreated", "lastUpdated", "removalDate", "appContext", "status", "appStatus", "instanceCount", "containerCount", "appTiers", "instances", "stats"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListApps200ResponseAllOfAppsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListApps200ResponseAllOfAppsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "stats": ListApps200ResponseAllOfAppsInnerStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None
        })
