...
class ListClusterNetworkEndpoints200Response(BaseModel):
    """
    ListClusterNetworkEndpoints200Response
    """ # noqa: E501
    endpoints: Optional[List[ListClusterNetworkEndpoints200ResponseAllOfEndpointsInner]] = None
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["endpoints", "meta"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListClusterNetworkEndpoints200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListClusterNetworkEndpoints200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "endpoints": [ListClusterNetworkEndpoints200ResponseAllOfEndpointsInner.from_dict(_item) for _item in obj["endpoints"]] if obj.get("endpoints") is not None else None,
