...
class ListRoles200Response(BaseModel):
    ...
    """ # noqa: E501
    roles: Optional[List[ListRoles200ResponseAllOfRolesInner]] = None
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["roles", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roles": [ListRoles200ResponseAllOfRolesInner.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None,
