...
class ListSecurityPackageTypes200ResponseAllOfSecurityPackageTypesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "code", "name", "description", "enabled", "optionTypes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListSecurityPackageTypes200ResponseAllOfSecurityPackageTypesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListSecurityPackageTypes200ResponseAllOfSecurityPackageTypesInner from a dict"""
        if obj is None:
            return None
