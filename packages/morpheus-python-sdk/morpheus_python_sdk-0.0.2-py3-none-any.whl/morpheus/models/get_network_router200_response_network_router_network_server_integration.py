...
class GetNetworkRouter200ResponseNetworkRouterNetworkServerIntegration(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "enabled", "type", "integrationType", "url", "port", "username", "password", "refType", "refId", "isPlugin", "config", "status", "statusDate", "statusMessage", "lastSync", "lastSyncDuration"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetNetworkRouter200ResponseNetworkRouterNetworkServerIntegration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetNetworkRouter200ResponseNetworkRouterNetworkServerIntegration from a dict"""
        if obj is None:
            return None
