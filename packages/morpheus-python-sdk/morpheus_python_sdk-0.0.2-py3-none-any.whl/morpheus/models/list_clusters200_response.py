...
class ListClusters200Response(BaseModel):
    ...
    """ # noqa: E501
    clusters: Optional[List[ListClusters200ResponseAllOfClustersInner]] = None
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["clusters", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clusters": [ListClusters200ResponseAllOfClustersInner.from_dict(_item) for _item in obj["clusters"]] if obj.get("clusters") is not None else None,
