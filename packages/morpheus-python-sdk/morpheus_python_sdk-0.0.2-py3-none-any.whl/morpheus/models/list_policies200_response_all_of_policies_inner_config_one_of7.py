...
class ListPolicies200ResponseAllOfPoliciesInnerConfigOneOf7(BaseModel):
    """
    - Expiration 
    """ # noqa: E501
    lifecycle_type: StrictStr = Field(alias="lifecycleType")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListPolicies200ResponseAllOfPoliciesInnerConfigOneOf7 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListPolicies200ResponseAllOfPoliciesInnerConfigOneOf7 from a dict"""
        if obj is None:
            return None
