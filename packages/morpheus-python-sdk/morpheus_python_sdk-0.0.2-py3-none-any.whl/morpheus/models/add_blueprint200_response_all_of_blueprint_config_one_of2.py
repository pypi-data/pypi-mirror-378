...
class AddBlueprint200ResponseAllOfBlueprintConfigOneOf2(BaseModel):
    """
    ...
    helm: Optional[AddBlueprintRequestOneOf2Helm] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "image", "type", "helm", "visibility", "resourcePermission", "owner", "tenant"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['helm']):
            raise ValueError("must be one of enum values ('helm')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddBlueprint200ResponseAllOfBlueprintConfigOneOf2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddBlueprint200ResponseAllOfBlueprintConfigOneOf2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "image": obj.get("image"),
            "type": obj.get("type"),
            "helm": AddBlueprintRequestOneOf2Helm.from_dict(obj["helm"]) if obj.get("helm") is not None else None,
