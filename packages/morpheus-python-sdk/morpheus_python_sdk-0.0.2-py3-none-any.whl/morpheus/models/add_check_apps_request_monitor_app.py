...
class AddCheckAppsRequestMonitorApp(BaseModel):
    """
    Payload for creating a new monitoring check app
    """ # noqa: E501
    name: StrictStr = Field(description="Unique name scoped to your account for the check app")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddCheckAppsRequestMonitorApp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddCheckAppsRequestMonitorApp from a dict"""
        if obj is None:
            return None
