...
class UpdateCloudDatastoresRequestDatastore(BaseModel):
    """
    UpdateCloudDatastoresRequestDatastore
    """ # noqa: E501
    active: Optional[StrictBool] = Field(default=None, description="Activate `true` or disable `false` the datastore")
    ...
    __properties: ClassVar[List[str]] = ["active", "visibility", "tenantPermissions", "resourcePermissions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateCloudDatastoresRequestDatastore from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateCloudDatastoresRequestDatastore from a dict"""
        if obj is None:
            return None
