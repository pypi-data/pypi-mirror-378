...
class ListInvoices200Response(BaseModel):
    ...
    """ # noqa: E501
    invoices: Optional[List[ListInvoices200ResponseAllOfInvoicesInner]] = None
    master_account: Optional[StrictBool] = Field(default=None, alias="masterAccount")
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["invoices", "masterAccount", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "invoices": [ListInvoices200ResponseAllOfInvoicesInner.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None,
            "masterAccount": obj.get("masterAccount"),
