...
class BlueprintMorpheusCreateSuccess(BaseModel):
    """
    ...
    config: Optional[AddBlueprint200ResponseAllOfBlueprintConfigOneOf4Config] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "type", "config", "visibility", "resourcePermission", "owner", "tenant"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['morpheus']):
            raise ValueError("must be one of enum values ('morpheus')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BlueprintMorpheusCreateSuccess from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BlueprintMorpheusCreateSuccess from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "type": obj.get("type"),
            "config": AddBlueprint200ResponseAllOfBlueprintConfigOneOf4Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
