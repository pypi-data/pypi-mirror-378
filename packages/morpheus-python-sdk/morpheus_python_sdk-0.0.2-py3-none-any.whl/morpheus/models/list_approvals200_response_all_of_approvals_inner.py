...
class ListApprovals200ResponseAllOfApprovalsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "internalId", "externalId", "externalName", "requestType", "account", "approver", "accountIntegration", "status", "errorMessage", "dateCreated", "lastUpdated", "requestBy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListApprovals200ResponseAllOfApprovalsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListApprovals200ResponseAllOfApprovalsInner from a dict"""
        if obj is None:
            return None
