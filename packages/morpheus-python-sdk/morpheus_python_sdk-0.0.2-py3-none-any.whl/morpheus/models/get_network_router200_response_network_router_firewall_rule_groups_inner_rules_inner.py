...
class GetNetworkRouter200ResponseNetworkRouterFirewallRuleGroupsInnerRulesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "code", "enabled", "groupName", "direction", "ruleType", "policy", "source", "sourceType", "destination", "destinationType", "profiles", "protocol", "application", "applicationType", "portRange", "sourcePortRange", "destinationPortRange", "sourceGroup", "sourceTier", "applications"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetNetworkRouter200ResponseNetworkRouterFirewallRuleGroupsInnerRulesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetNetworkRouter200ResponseNetworkRouterFirewallRuleGroupsInnerRulesInner from a dict"""
        if obj is None:
            return None
