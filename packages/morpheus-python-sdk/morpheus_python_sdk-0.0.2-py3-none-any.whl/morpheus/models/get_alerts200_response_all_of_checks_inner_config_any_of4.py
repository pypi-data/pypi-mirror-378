...
class GetAlerts200ResponseAllOfChecksInnerConfigAnyOf4(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["containerName", "externalId", "checkUser", "textCheckOn", "checkPassword", "webTextMatch", "checkPasswordHash", "tunnelOn", "sshHost", "sshPort", "sshUser", "sshPassword"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAlerts200ResponseAllOfChecksInnerConfigAnyOf4 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAlerts200ResponseAllOfChecksInnerConfigAnyOf4 from a dict"""
        if obj is None:
            return None
