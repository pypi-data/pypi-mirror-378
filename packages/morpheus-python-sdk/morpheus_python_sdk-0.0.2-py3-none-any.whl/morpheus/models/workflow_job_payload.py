...
class WorkflowJobPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "labels", "enabled", "task", "workflow", "targetType", "targets", "instanceLabel", "serverLabel", "scheduleMode", "customOptions", "customConfig", "dateTime", "run"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowJobPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowJobPayload from a dict"""
        if obj is None:
            return None
