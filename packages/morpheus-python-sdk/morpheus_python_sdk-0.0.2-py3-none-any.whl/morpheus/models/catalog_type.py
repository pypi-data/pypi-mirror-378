...
class CatalogType(BaseModel):
    ...
    form: Optional[GetCatalogType200ResponseAllOfCatalogItemTypesInnerForm] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "type", "context", "featured", "allowQuantity", "imagePath", "darkImagePath", "formType", "form", "optionTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CatalogType from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "form": GetCatalogType200ResponseAllOfCatalogItemTypesInnerForm.from_dict(obj["form"]) if obj.get("form") is not None else None,
