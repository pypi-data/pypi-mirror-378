...
class ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf12(BaseModel):
    """
    ...
    config: Optional[ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf12Config] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "enabled", "type", "integrationType", "url", "username", "password", "passwordHash", "isPlugin", "config", "status", "statusDate", "statusMessage", "lastSync", "lastSyncDuration", "credential"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['remedy']):
            raise ValueError("must be one of enum values ('remedy')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf12 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf12 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf12Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
