...
class ControllerType(BaseModel):
    """
    ControllerType
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "displayOrder", "category", "enabled", "creatable", "maxDevices"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ControllerType from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ControllerType from a dict"""
        if obj is None:
            return None
