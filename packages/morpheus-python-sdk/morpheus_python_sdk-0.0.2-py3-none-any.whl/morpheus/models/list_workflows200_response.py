...
class ListWorkflows200Response(BaseModel):
    ...
    """ # noqa: E501
    task_sets: Optional[List[ListWorkflows200ResponseAllOfTaskSetsInner]] = Field(default=None, alias="taskSets")
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["taskSets", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "taskSets": [ListWorkflows200ResponseAllOfTaskSetsInner.from_dict(_item) for _item in obj["taskSets"]] if obj.get("taskSets") is not None else None,
