...
class ListTasks200ResponseAllOfTasksInnerAnyOf14TaskOptions(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["localScriptGitRef", "port", "password", "passwordHash", "username", "host", "sshKey", "localScriptGitId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf14TaskOptions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListTasks200ResponseAllOfTasksInnerAnyOf14TaskOptions from a dict"""
        if obj is None:
            return None
