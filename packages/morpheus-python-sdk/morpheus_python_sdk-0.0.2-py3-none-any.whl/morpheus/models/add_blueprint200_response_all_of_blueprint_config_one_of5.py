...
class AddBlueprint200ResponseAllOfBlueprintConfigOneOf5(BaseModel):
    """
    ...
    terraform: Optional[AddBlueprintRequestOneOf5Terraform] = None
    config: Optional[AddBlueprintRequestOneOf5Config] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "image", "type", "terraform", "config", "visibility", "resourcePermission", "owner", "tenant"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['terraform']):
            raise ValueError("must be one of enum values ('terraform')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddBlueprint200ResponseAllOfBlueprintConfigOneOf5 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddBlueprint200ResponseAllOfBlueprintConfigOneOf5 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "image": obj.get("image"),
            "type": obj.get("type"),
            "terraform": AddBlueprintRequestOneOf5Terraform.from_dict(obj["terraform"]) if obj.get("terraform") is not None else None,
            "config": AddBlueprintRequestOneOf5Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
