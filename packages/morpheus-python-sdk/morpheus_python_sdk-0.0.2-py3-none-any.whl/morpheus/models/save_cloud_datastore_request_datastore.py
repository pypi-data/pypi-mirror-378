...
class SaveCloudDatastoreRequestDatastore(BaseModel):
    """
    SaveCloudDatastoreRequestDatastore
    """ # noqa: E501
    name: Optional[StrictStr] = None
    datastore_type: Optional[StrictStr] = Field(default=None, description="The code of the datatoreType", alias="datastoreType")
    ...
    __properties: ClassVar[List[str]] = ["name", "datastoreType", "storageServer", "visibility", "active", "defaultStore", "tenants", "resourcePermissions", "datastores"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SaveCloudDatastoreRequestDatastore from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SaveCloudDatastoreRequestDatastore from a dict"""
        if obj is None:
            return None
