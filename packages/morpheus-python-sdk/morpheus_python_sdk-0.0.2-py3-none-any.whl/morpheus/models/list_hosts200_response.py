...
class ListHosts200Response(BaseModel):
    """
    ListHosts200Response
    """ # noqa: E501
    servers: Optional[List[ListHosts200ResponseAllOfServersInner]] = None
    stats: Optional[Dict[str, Any]] = None
    multitenant: Optional[StrictBool] = None
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["servers", "stats", "multitenant", "meta"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListHosts200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListHosts200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "servers": [ListHosts200ResponseAllOfServersInner.from_dict(_item) for _item in obj["servers"]] if obj.get("servers") is not None else None,
            "stats": obj.get("stats"),
