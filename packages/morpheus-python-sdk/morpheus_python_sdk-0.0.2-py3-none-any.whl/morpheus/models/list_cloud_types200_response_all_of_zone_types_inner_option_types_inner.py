...
class ListCloudTypes200ResponseAllOfZoneTypesInnerOptionTypesInner(BaseModel):
    """
    ...
    config: Optional[ListCloudTypes200ResponseAllOfZoneTypesInnerOptionTypesInnerConfig] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListCloudTypes200ResponseAllOfZoneTypesInnerOptionTypesInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if field_label (nullable) is None
        # and model_fields_set contains the field
        if self.field_label is None and "field_label" in self.model_fields_set:
            _dict['fieldLabel'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListCloudTypes200ResponseAllOfZoneTypesInnerOptionTypesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": ListCloudTypes200ResponseAllOfZoneTypesInnerOptionTypesInnerConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
