...
class ListStorageBuckets200ResponseAllOfStorageBucketsInnerConfig(BaseModel):
    """
    ...
    use_host_credentials: Optional[StrictBool] = Field(default=None, alias="useHostCredentials")
    endpoint: Optional[StrictStr] = None
    secret_key_hash: Optional[StrictStr] = Field(default=None, alias="secretKeyHash")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["accessKey", "secretKey", "stsAssumeRole", "useHostCredentials", "endpoint", "secretKeyHash"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListStorageBuckets200ResponseAllOfStorageBucketsInnerConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListStorageBuckets200ResponseAllOfStorageBucketsInnerConfig from a dict"""
        if obj is None:
            return None
