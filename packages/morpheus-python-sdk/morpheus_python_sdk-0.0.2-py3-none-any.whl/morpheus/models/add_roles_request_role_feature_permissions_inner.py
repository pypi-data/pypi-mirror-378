...
class AddRolesRequestRoleFeaturePermissionsInner(BaseModel):
    """
    AddRolesRequestRoleFeaturePermissionsInner
    """ # noqa: E501
    code: StrictStr = Field(description="`code` of the feature permission")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddRolesRequestRoleFeaturePermissionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddRolesRequestRoleFeaturePermissionsInner from a dict"""
        if obj is None:
            return None
