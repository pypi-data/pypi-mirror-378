...
class ListTasks200Response(BaseModel):
    ...
    """ # noqa: E501
    tasks: Optional[List[ListTasks200ResponseAllOfTasksInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tasks": [ListTasks200ResponseAllOfTasksInner.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None,
