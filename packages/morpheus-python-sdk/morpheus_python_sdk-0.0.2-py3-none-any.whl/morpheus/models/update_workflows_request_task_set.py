...
class UpdateWorkflowsRequestTaskSet(BaseModel):
    """
    UpdateWorkflowsRequestTaskSet
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="A unique name for the workflow")
    ...
    tasks: Optional[UpdateWorkflowsRequestTaskSetTasks] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "description", "labels", "type", "optionTypes", "tasks"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateWorkflowsRequestTaskSet from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateWorkflowsRequestTaskSet from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "tasks": UpdateWorkflowsRequestTaskSetTasks.from_dict(obj["tasks"]) if obj.get("tasks") is not None else None
        })
