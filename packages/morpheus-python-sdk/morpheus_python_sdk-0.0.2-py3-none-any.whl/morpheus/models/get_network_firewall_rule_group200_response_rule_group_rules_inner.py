...
class GetNetworkFirewallRuleGroup200ResponseRuleGroupRulesInner(BaseModel):
    """
    ...
    rule_group: Optional[GetAlerts200ResponseAllOfCheckGroupsInnerInstance] = Field(default=None, alias="ruleGroup")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetNetworkFirewallRuleGroup200ResponseRuleGroupRulesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetNetworkFirewallRuleGroup200ResponseRuleGroupRulesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "ruleGroup": GetAlerts200ResponseAllOfCheckGroupsInnerInstance.from_dict(obj["ruleGroup"]) if obj.get("ruleGroup") is not None else None,
