...
class IntegrationChef(BaseModel):
    """
    IntegrationChef
    """ # noqa: E501
    ...
    config: Optional[ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3Config] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['chef']):
            raise ValueError("must be one of enum values ('chef')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IntegrationChef from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IntegrationChef from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "config": ListIntegrations200ResponseAnyOfIntegrationsInnerAnyOf3Config.from_dict(obj["config"]) if obj.get("config") is not None else None,
