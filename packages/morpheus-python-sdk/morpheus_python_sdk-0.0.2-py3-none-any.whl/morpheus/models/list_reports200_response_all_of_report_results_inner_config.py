...
class ListReports200ResponseAllOfReportResultsInnerConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["reportType", "startDate", "endDate", "cloudId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListReports200ResponseAllOfReportResultsInnerConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListReports200ResponseAllOfReportResultsInnerConfig from a dict"""
        if obj is None:
            return None
