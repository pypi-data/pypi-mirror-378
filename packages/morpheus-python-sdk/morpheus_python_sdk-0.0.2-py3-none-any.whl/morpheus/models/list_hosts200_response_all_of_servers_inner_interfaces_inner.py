...
class ListHosts200ResponseAllOfServersInnerInterfacesInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListHosts200ResponseAllOfServersInnerInterfacesInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if ip_mode (nullable) is None
        # and model_fields_set contains the field
        if self.ip_mode is None and "ip_mode" in self.model_fields_set:
            _dict['ipMode'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListHosts200ResponseAllOfServersInnerInterfacesInner from a dict"""
        if obj is None:
            return None
