...
class ListContacts200Response(BaseModel):
    ...
    """ # noqa: E501
    contacts: Optional[List[ListContacts200ResponseAllOfContactsInner]] = None
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["contacts", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contacts": [ListContacts200ResponseAllOfContactsInner.from_dict(_item) for _item in obj["contacts"]] if obj.get("contacts") is not None else None,
