...
class ListExecuteSchedules200ResponseAllOfSchedulesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "visibility", "enabled", "scheduleType", "scheduleTimezone", "cron", "dateCreated", "lastUpdated"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListExecuteSchedules200ResponseAllOfSchedulesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListExecuteSchedules200ResponseAllOfSchedulesInner from a dict"""
        if obj is None:
            return None
