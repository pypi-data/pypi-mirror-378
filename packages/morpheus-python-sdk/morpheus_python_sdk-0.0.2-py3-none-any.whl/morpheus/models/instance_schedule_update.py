...
class InstanceScheduleUpdate(BaseModel):
    ...
    threshold: Optional[UpdateInstanceScheduleRequestInstanceScheduleThreshold] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InstanceScheduleUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InstanceScheduleUpdate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "threshold": UpdateInstanceScheduleRequestInstanceScheduleThreshold.from_dict(obj["threshold"]) if obj.get("threshold") is not None else None
        })
