...
class ClusterNamespaces(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "regionCode", "externalId", "status", "visibility", "active"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterNamespaces from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterNamespaces from a dict"""
        if obj is None:
            return None
