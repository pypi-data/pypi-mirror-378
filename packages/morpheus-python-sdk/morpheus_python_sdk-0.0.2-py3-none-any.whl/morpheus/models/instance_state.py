...
class InstanceState(BaseModel):
    ...
    input: Optional[GetStateInstance200ResponseAllOfInstanceInput] = None
    output: Optional[GetAppState200ResponseAllOfOutput] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["workloads", "iacDrift", "planResources", "specs", "stateData", "planData", "input", "output"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "input": GetStateInstance200ResponseAllOfInstanceInput.from_dict(obj["input"]) if obj.get("input") is not None else None,
