...
class ListJobs200Response(BaseModel):
    ...
    ListJobs200Response
    """ # noqa: E501
    jobs: Optional[List[ListJobs200ResponseAllOfJobsInner]] = None
    meta: Optional[ListActivity200ResponseAllOfMeta] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["jobs", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobs": [ListJobs200ResponseAllOfJobsInner.from_dict(_item) for _item in obj["jobs"]] if obj.get("jobs") is not None else None,
