...
class CatalogItemTypeBlueprintUpdate(BaseModel):
    """
    ...
    blueprint: Optional[AddCatalogItemTypeRequestCatalogItemTypeOneOf1Blueprint] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "code", "category", "description", "labels", "type", "visibility", "layoutCode", "iconPath", "enabled", "featured", "allowQuantity", "blueprint", "appSpec", "formType", "form", "optionTypes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CatalogItemTypeBlueprintUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CatalogItemTypeBlueprintUpdate from a dict"""
        if obj is None:
            return None
