...
class Page1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["viewers_must_be_team_members", "country", "language", "css_button_color", "css_button_border_color", "css_spinner_color", "css_body_background_color", "support_url", "css_greens", "css_yellows", "allow_incident_subscribers", "city", "company_logo", "notifications_from_email", "css_oranges", "css_no_data", "transactional_logo", "headline", "allow_email_subscribers", "allow_webhook_subscribers", "time_zone", "page_description", "url", "template_id", "notifications_email_footer", "state", "hero_cover", "css_button_text_color", "allow_sms_subscribers", "css_font_color", "css_border_color", "domain", "favicon_logo", "css_reds", "css_link_color", "template", "css_button_hover_color", "created_at", "updated_at", "ip_restrictions", "css_blues", "allow_rss_atom_feeds", "css_graph_color", "id", "css_light_font_color", "email_logo", "activity_score", "hidden_from_search", "name", "organization_id", "allow_page_subscribers", "subdomain"]
