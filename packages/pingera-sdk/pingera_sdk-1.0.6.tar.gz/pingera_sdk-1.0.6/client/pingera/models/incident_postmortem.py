...
class IncidentPostmortem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["body_updated_at", "body_draft", "notify_subscribers", "created_at", "updated_at", "body", "published_at", "body_draft_updated_at", "incident_id", "id", "preview_key"]
