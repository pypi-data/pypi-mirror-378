...
class HeartbeatCheckDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["last_ping_at", "ping_url", "grace_seconds", "status", "next_expected_ping", "created_at", "updated_at", "recent_pings", "period_seconds", "name", "active", "id"]
