...
class LabelingViewlet(ViewletBase):
    ...
    @property
    def can_edit(self):
        return self.mtool.checkPermission('collective.labels: Change Labels', self.context)

    @property
    def can_personal_edit(self):
        return self.mtool.checkPermission('collective.labels: Change Personal Labels', self.context)
