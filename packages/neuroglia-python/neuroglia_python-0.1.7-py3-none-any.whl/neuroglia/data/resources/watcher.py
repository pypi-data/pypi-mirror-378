...
class ResourceWatcherBase(Generic[TResourceSpec, TResourceStatus],
                          ResourceWatcher[TResourceSpec, TResourceStatus],
                          ABC):
    ...
    async def watch(self,
        ...
        self._watch_task = asyncio.create_task(
            self._watch_loop(namespace, label_selector)
        )
    ...
    async def _list_resources(self,
                             namespace: Optional[str] = None,
                             label_selector: Optional[Dict[str, str]] = None) -> List[Resource[TResourceSpec, TResourceStatus]]:
    ...
    def _detect_changes(self,
                       current_resources: Dict[str, Resource[TResourceSpec, TResourceStatus]]) -> List[ResourceChangeEvent[TResourceSpec, TResourceStatus]]:
    ...
    def _has_status_changed(self,
                           ...
                           cached: Resource[TResourceSpec, TResourceStatus]) -> bool:
