"""
PyGremlinBox AGPL-2.0 - Supply chain security testing module.

This package is licenced under the Affero General Public License v2.0 (AGPL-2.0).
...
maintaining compliance with AGPL-2.0 requirements.
"""

__version__ = "1.0.0"
__licence__ = "AGPL-2.0"
...
def get_package_metadata():
    ...
    """
    return {
        "name": "pygremlinbox-agpl-2.0",
        "version": __version__,
        "licence": __licence__,
        "description": "Supply chain security testing module with AGPL-2.0 licence",
        "spdx_licence_id": "AGPL-2.0"
    }
