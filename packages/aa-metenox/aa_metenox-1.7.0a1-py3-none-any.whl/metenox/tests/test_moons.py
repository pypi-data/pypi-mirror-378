...
class TestMoons(NoSocketsTestCase):
    ...
    @patch("metenox.models.get_eve_type_price")
    def test_integrity_error_on_updating_existing_moon(self, get_price_mock):
        """
        Integrity error issue when running an update on an already existing moon
        """
        get_price_mock.return_value = 0.0
