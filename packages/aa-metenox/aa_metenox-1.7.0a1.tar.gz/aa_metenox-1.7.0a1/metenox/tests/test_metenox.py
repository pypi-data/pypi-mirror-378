...
from metenox.models import HoldingCorporation, MetenoxStoredMoonMaterials, MetenoxTag
...
class TestMetenoxes(TestCase):
    ...
    def test_total_stored_value(self):
        ...
        TypePrice.objects.create(
            type_id=hydrocarbon.id, sell_price=2000, split_price=2000, buy_price=2000
        )
        TypePrice.objects.create(
            type_id=atmospheric_gases.id,
            sell_price=1000,
            split_price=1000,
            buy_price=1000,
        )
    ...
    def test_check_moon_material_bay(self):
        ...
        scandium_price = TypePrice.objects.create(
            type_id=scandium.id, sell_price=100, buy_price=100, split_price=100
        )
        ...
        # value shouldn't ping
        scandium_price.sell_price = 0
        scandium_price.split_price = 0
        scandium_price.buy_price = 0
        scandium_price.save()
