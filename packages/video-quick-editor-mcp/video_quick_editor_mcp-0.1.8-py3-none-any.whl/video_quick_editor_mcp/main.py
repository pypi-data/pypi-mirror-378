...
def _resolve_binary(path_dir: str | None, base_name: str) -> str:
    if path_dir:
...
FFMPEG_BIN = _resolve_binary(FFMPEG_PATH_DIR, 'ffmpeg')
FFPROBE_BIN = _resolve_binary(FFMPEG_PATH_DIR, 'ffprobe')
