...
def all_different(*args: Any) -> i.Aggregate:
    return i.Aggregate(i.Relationship.builtins["all_different"], *args)

def implies(left, right) -> i.Expression:
    return i.Expression(i.Relationship.builtins["implies"], left, right)
