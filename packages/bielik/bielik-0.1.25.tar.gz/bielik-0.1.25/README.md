...
## 🐍 **Recommended: Conda Installation** (Fastest & Most Reliable) ⭐
...
# 3. After setup completes, activate the environment and start Bielik
...
# 2. Create and activate environment from file
...
# 4. Start Bielik with optimized settings
bielik
```
...
conda install -c conda-forge cmake make gcc gxx_linux-64 gcc_linux-64 -y

# 3. Install Bielik with local model support
pip install 'bielik[local]' --upgrade

# 4. Start Bielik with optimized settings
BIELIK_OPTIMIZED=1 bielik
```

## 🚀 **Alternative: Quick Install (pip)**

For users who prefer pip:
...
# Windows (PowerShell)
irm https://raw.githubusercontent.com/tom-sapletta-com/bielik/main/quick-install.ps1 | iex
```
