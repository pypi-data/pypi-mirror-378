...
from eigeningenuity.util import force_list, time_to_epoch_millis, EigenException, \
        merge_tags_from_response, update_keys, _do_historian_multi_request, format_output
...
class HistorianMulti (object):
   ...
   #SECTION Read Requests
    ...
    def createTag(self, tag:str, description:str=None, units:str=None, stepped:bool=False, update_existing:bool=False):
        ...
        for key, value in [("description", description), ("units", units), ("stepped", stepped)]:
        ...
        body = {
            ...
            "updateIfExists": update_existing
        }
    ...
    def updateTag(self, tag:str, description:str=None, units:str=None, stepped:bool=False, create_missing:bool=False):
        ...
        body = {
            ...
            "createIfMissing": create_missing
        }
    ...
    def createAndPopulateTag(self, tag:str, points: Union[dict, list], description:str=None, units:str=None, stepped:bool=False, update_existing:bool=True):
        ...
        return {"success": createSuccess and writeSuccess, "createTag": {"success": createSuccess, "errors": createResp["errors"]}, "writePoints": {"success": writeSuccess, "message": message}}
