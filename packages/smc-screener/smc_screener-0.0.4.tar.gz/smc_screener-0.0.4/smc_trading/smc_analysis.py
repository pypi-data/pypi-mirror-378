...
async def main(
    ...
    use_colab: bool = False  # Toggle for Colab vs Local
):
    if not stock_codes:
    ...
    # ---------------- Google Sheets setup ----------------
    spreadsheet_url, summary_worksheet, levels_worksheet = None, None, None
    gspread_client, summary_rows, levels_rows = None, [], []
    summary_headers, levels_headers = None, None
            ...
            if use_colab:
                try:
                    ...
                    if SERVICE_ACCOUNT_CREDS:
                        ...
                        print("⚠️ SERVICE_ACCOUNT_CREDS not found in Colab secrets. Falling back to CSV output.")
                except ImportError:
                ...
                if success:
                    ...
                    if output_format in ["google_sheets", "both"] and gspread_client:
                        if summary_data:
                            ...
                            if len(normalized_summary) == len(summary_headers):
                        ...
                        if levels_data:
                            ...
                            for level in levels_data:
                                ...
                                if len(normalized_level) == len(levels_headers):
