...
Welcome to `netlistx` contributor's guide.
...
If you experience bugs or general issues with `netlistx`, please have a look
...
You can help improve `netlistx` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`netlistx` documentation uses [Sphinx] as its main documentation compiler.
...
```
conda create -n netlistx python=3 six virtualenv pytest pytest-cov
conda activate netlistx
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/netlistx.git
   cd netlistx
   ```
...
5. Install [pre-commit]:
   ...
   `netlistx` comes with a lot of hooks configured to automatically help the
