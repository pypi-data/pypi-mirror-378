...
class HyperspaceApi(object):
    ...
    def msearch(self, body, size, collection_name, **kwargs):  # noqa: E501
        """Run multiple DSL queries in a single request  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.msearch(body, size, collection_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.msearch_with_http_info(body, size, collection_name, **kwargs)  # noqa: E501
        else:
            (data) = self.msearch_with_http_info(body, size, collection_name, **kwargs)  # noqa: E501
            return data

    def msearch_with_http_info(self, body, size, collection_name, **kwargs):  # noqa: E501
        """Run multiple DSL queries in a single request  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.msearch_with_http_info(body, size, collection_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'size', 'collection_name', 'source']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('size' not in params or
                params['size'] is None):
            raise ValueError("Missing the required parameter `size` when calling `msearch`")  # noqa: E501
        # verify the required parameter 'collection_name' is set
        if ('collection_name' not in params or
                params['collection_name'] is None):
