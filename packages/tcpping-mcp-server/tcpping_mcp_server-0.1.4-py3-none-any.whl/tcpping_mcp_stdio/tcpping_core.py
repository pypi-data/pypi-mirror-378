    ...
    while attempt <= retries:
        ...
        try:
            async with async_playwright() as p:
                ...
                # Fallback summary metrics pattern search if all missing
                ...
                # Debug artifacts if requested and no probe rows
                ...
                # Heuristic fallback scan for probe rows (structure changes)
                if not probes:
                    try:
