...
from .trello import TrelloCard, WekanCard  # noqa
...
def months_between(inici, final):
    """Calcula els mesos entre dues dates."""
    return (final.year - inici.year) * 12 + (final.month - inici.month) - (final.day < inici.day)  # noqa
