...
from thesis_py.research.events.observation.evaluation import (
...
from thesis_py.research.events.observation.planner_mcp import (
    PlanObservation,
)
from thesis_py.research.events.observation.playwright_mcp import (
