...
class TestOpenAIAgents:
    ...
    async def test_async_completion_non_streaming_success(
        ...
        expected = {
            "model": {
                "name": GPT_5_AGENT.model.name,
                "display_name": GPT_5_AGENT.model.display_name,
                "version": GPT_5_AGENT.model.version,
            },
            "provider": {
                "name": GPT_5_AGENT.provider.name,
                "url": GPT_5_AGENT.provider.url,
            },
            ...
            "cost": {
                "prompt_cost": 150 * GPT_5_AGENT.input_token_cost,
                "completion_cost": 200 * GPT_5_AGENT.output_token_cost,
                "total_cost": (
                    150 * GPT_5_AGENT.input_token_cost
                    + 200 * GPT_5_AGENT.output_token_cost
                ),
            },
            "streaming": False,
        }
        ...
        expected = [
            {
                ...
                "raw": None,
                "reasoning": "Reasoning tokens are not available for `GPT 5`...",
                "streaming": True,
                "tool_calls": [],
                "usage": {
                    "completion_tokens": 0,
    ...
    async def test_async_completion_streaming_reasoning_and_tools_only(
        ...
        expected = [
            ...
            },
            {
                "content": None,
                "cost": {
                    "completion_cost": 0.00045000000000000004,
        ...
        expected = [
            ...
            },
            {
                ...
                "cost": {
                    ...
                    "prompt_cost": 9.375e-05,
                    "total_cost": 0.00024375000000000002,
                },
                "error": {
                    "error_message": None,
                    "error_status": 0,
