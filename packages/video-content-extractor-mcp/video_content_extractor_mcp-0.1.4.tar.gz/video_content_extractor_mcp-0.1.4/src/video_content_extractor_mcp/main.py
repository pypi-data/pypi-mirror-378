...
def extract_audio_from_video(video_path: str, output_audio_path: str, audio_codec: str = 'mp3') -> str:
    ...
    """
    # Get context from MCP framework
    ctx = mcp.request_context
...
def trim_video(video_path: str, output_video_path: str, start_time: str, end_time: str) -> str:
    ...
    try:
        ...
        _ffmpeg_run_with_progress(output_stream, operation_name="视频裁剪")
        ...
        try:
            ...
            _ffmpeg_run_with_progress(output_stream_recode, operation_name="视频裁剪")
...
def extract_video_frames(
    ...
    try:
        ...
        if interval_seconds and interval_seconds > 0:
            ...
            _ffmpeg_run_with_progress(ffmpeg.output(v, pattern, vsync="vfr"), operation_name="间隔帧提取")
