...
class SaveSearchParent(object):
    ...
    def __init__(self, type=None, id=None):  # noqa: E501
        """SaveSearchParent - a model defined in Swagger"""
        super(SaveSearchParent, self).__init__()
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this SaveSearchParent.
    ...
    def id(self):
        ...
        :return: The id of this SaveSearchParent.
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this SaveSearchParent.


        :param id: The id of this SaveSearchParent.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SaveSearchParent):
            return False
