...
class UserInput(object):
    ...
    def __init__(self, id=None, firstname=None, lastname=None, email=None, password=None, roles=None, disabled=None, avatar=None, root=None, central_user_id=None, central_revision=None):  # noqa: E501
