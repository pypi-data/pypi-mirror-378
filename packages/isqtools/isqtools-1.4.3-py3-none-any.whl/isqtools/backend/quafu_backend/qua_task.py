...
try:
    ...
    from quafu.exceptions import CircuitError, UserError, validate_server_resp
    ...
    QuantumCircuit = None
    CircuitError = UserError = validate_server_resp = None
    ExecResult = merge_measure = None
    User = ClientWrapper = None
    Response = None
...
class Task:
    ...
    def send(
    ...
    ) -> tuple[ExecResult, str]:  # type: ignore[return-value]  # noqa: E501
        """
        ...
        return self._post_send(response, group=group), task_id
