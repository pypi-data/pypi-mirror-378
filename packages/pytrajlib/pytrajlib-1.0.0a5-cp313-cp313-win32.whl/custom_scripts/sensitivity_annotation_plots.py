...
run_0_params = utils.get_run_params("input/run_0.toml")

# generate the x-axis values
x = np.logspace(-1, 1, 7)

name = run_0_params["run_name"]
...
run_2_params = utils.get_run_params("input/run_2.toml")

# generate the x-axis values
x = np.logspace(-1, 1, 7)

name = run_2_params["run_name"]
print("Plotting sensitivity data for " + name + "...")
...
run_3_params = utils.get_run_params("input/run_3.toml")

# generate the x-axis values
x = np.logspace(-1, 1, 7)

name = run_3_params["run_name"]
print("Plotting sensitivity data for " + name + "...")
