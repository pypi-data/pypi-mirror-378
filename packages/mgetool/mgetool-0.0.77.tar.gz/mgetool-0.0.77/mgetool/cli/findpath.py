...
def run(args, parser):
    ...
    if args.suffix is None and\
       ...
       args.file_exclude is None and args.return_files is False:
...
class CLICommand:
    ...
    def add_arguments(parser):
        ...
        parser.add_argument('-f', '--return_files', help='return files instead of dirs.', action="store_true")
