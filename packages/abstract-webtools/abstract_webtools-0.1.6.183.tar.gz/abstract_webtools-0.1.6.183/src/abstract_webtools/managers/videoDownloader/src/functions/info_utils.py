...
class infoRegistry(metaclass=SingletonMeta):
    ...
    def __init__(self, video_directory=None, envPath=None, info_directory=None,temp_directory=None,data_directory=None):
    ...
    def get_video_info(self, url=None, video_id=None, force_refresh=False,download=False):
        ...
        return self._get_cached_info(self,url=url,video_id=video_id)
    def edit_info(self,data,url=None,video_id=None, force_refresh=False,download=False):
        ...
        self._save_to_info_path(self,data=video_info,url=url,video_id=video_id)
        return video_info
