...
from imandra.u.agents.code_logician.imandrax import DecomposeRes, RegionStr
...
class DecomposeReqData(BaseModel):
    ...
    basis: list[str] | None = Field(default=None)
    rule_specs: list[str] | None = Field(default=None)
    prune: bool | None = Field(default=True)
    ctx_simp: bool | None = Field(default=True)
    lift_bool: Any | None = Field(default=None)
    timeout: float | None = Field(default=None)
    str_: bool | None = Field(default=True, validation_alias="str")
