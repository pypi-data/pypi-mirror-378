...
if posix_or_nt() == 'nt':
    ...
    UNICODE_PATH_ENTRIES = [
        path_entry
        for path_entry in seqtok(UNICODE_ENVIRONMENT_VARIABLES_DICTIONARY[u'PATH'], {u';'})
    ]

    UNICODE_PATH_EXTENSIONS = [
        path_extension
        for path_extension in seqtok(UNICODE_ENVIRONMENT_VARIABLES_DICTIONARY[u'PATHEXT'], {u';'})
    ]
