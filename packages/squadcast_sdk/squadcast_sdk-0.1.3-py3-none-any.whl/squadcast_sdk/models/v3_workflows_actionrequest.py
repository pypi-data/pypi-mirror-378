...
V3WorkflowsActionRequestName = Literal["sq_attach_runbooks"]


class V3WorkflowsActionRequestDataTypedDict(TypedDict):
    runbooks: List[str]


class V3WorkflowsActionRequestData(BaseModel):
    runbooks: List[str]


class V3WorkflowsActionRequestSqAttachRunbooksTypedDict(TypedDict):
    name: V3WorkflowsActionRequestName
    data: V3WorkflowsActionRequestDataTypedDict


class V3WorkflowsActionRequestSqAttachRunbooks(BaseModel):
    name: V3WorkflowsActionRequestName

    data: V3WorkflowsActionRequestData


V3WorkflowsActionRequestTypedDict = TypeAliasType(
...
V3WorkflowsActionRequest = TypeAliasType(
