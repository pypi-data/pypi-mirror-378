...
#         self.token_pattern = token_pattern
    ...
    def fit(self, sentences, word_tokenizer_func=None):
        ...
        for sentence in sentences:
            ...
            unique_ngrams_in_sentence = set(ngrams_in_sentence) # Count only once per sentence for ISF
        ...
        for term, count in term_sentence_counts.items():
            self.isf_scores[term] = math.log((self.num_sentences_in_corpus + 1) / (count + 1)) + 1
