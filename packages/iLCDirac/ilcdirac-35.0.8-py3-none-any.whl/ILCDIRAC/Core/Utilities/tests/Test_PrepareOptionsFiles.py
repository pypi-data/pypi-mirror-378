...
<marlin xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://ilcsoft.desy.de/marlin/marlin.xsd">
 ...
 <!--Automated analysis-->
  ...
  @patch("%s.Operations.getValue" % MODULE_NAME, new=Mock(return_value=['firstlocation', 'secondlocation']))
  @patch("builtins.open", mock_open(read_data="content"))
  def test_cardFinder(self, isfile_side_effects, code):
    with patch("%s.os.path.isfile" % MODULE_NAME, new=Mock(side_effect=isfile_side_effects)):
      res = PrepareOptionFiles.cardFinder('cardname', 'confoption')
    if code:
      self.assertEqual('content', res['Value'])
    else:
      self.assertEqual('Card not found', res['Message'])
