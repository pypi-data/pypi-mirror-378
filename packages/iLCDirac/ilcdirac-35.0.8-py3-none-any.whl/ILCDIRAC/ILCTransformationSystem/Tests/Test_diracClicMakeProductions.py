...
THE_SCRIPT = "ILCDIRAC.ILCTransformationSystem.scripts.dirac_clic_make_productions"
theScript = importlib.import_module(THE_SCRIPT)
SCP = "ILCDIRAC.ILCTransformationSystem.scripts.dirac_clic_make_productions.six.moves.configparser.ConfigParser"
__RCSID__ = "$Id$"
...
def test_createTaskDict_none(theChain):
  ...
  taskDict = theChain.createTaskDict(123456, 'ee_qq', 5000, 333, genFile='file.sin', nbTasks=222,
...
def test_createTaskDict_gen(theChain):
  ...
  taskDict = theChain.createTaskDict(123456, 'ee_qq', 5000, 333, genFile='file.sin', nbTasks=222,
                                     eventsPerBaseFile=None, taskName='')
  assert len(taskDict['GEN']) == 1
  assert taskDict['GEN'][0].genFile == 'file.sin'
...
def test_createTaskDict_sim(theChain):
  """Test createTaskDict function."""
  theChain._flags._sim = True
  taskDict = theChain.createTaskDict(123456, 'ee_qqqq', 5000, 333, genFile=None,
                                     nbTasks=None, eventsPerBaseFile=None, taskName='')
  assert len(taskDict['SIM']) == 1
  assert taskDict['SIM'][0].genFile is None
...
def test_createTaskDict_sim_split(theChain):
  ...
  # no need to split
  taskDict = theChain.createTaskDict(123456, 'ee_qqqq', 5000, 25, genFile=None, nbTasks=None,
