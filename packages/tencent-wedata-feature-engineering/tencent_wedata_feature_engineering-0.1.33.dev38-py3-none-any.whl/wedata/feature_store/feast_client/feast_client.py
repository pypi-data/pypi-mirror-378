...
class FeastClient:
    ...
    def remove_offline_table(self, table_name: str):
        database_name, sub_table_name = table_name.split(".")
        feature_view = self._client.get_feature_view(sub_table_name)
        self._client.apply(objects_to_delete=feature_view)
