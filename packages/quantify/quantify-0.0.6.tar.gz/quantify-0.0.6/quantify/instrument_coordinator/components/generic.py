...
class GenericInstrumentCoordinatorComponent(base.InstrumentCoordinatorComponentBase):
    ...
    # these methods are needed otherwise
    # TypeError: Can't instantiate abstract class GenericInstrumentCoordinatorComponent
    # without an implementation for abstract methods 'get_hardware_log',
    # 'retrieve_acquisition', 'wait_done'
