...
try:
    ...
    __core_version__ = version("quantify")
    __scheduler_version__ = version("quantify")
except Exception:
    __core_version__ = "unknown"
    __scheduler_version__ = "unknown"
from quantify.data.handling import get_datadir, snapshot
