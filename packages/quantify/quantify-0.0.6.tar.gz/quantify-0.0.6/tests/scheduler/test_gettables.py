...
from quantify.gettables_profiled import ProfiledScheduleGettable
from quantify.helpers.schedule import (
...
from quantify.schedules.trace_schedules import trace_schedule
...
@patch("quantify.backends.graph_compilation.SerialCompiler.compile")
