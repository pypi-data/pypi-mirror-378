...
def test_prepare(
    ...
    # Act
    instructions = {"dev0": {"foo": 0}, "dev1": {"foo": 1}}
    compiled_sched = CompiledSchedule.initialize_from_instructions(
        name="Test schedule", compiled_instructions=instructions
    )
    ...
    component1.prepare.assert_called_with(instructions["dev0"])
    component2.prepare.assert_called_with(instructions["dev1"])
