...
def apply_mixer_skewness_corrections(
    ...
    def skew_real(_waveform: ComplexArray, alpha: float, phi: float) -> np.ndarray:
    ...
    def skew_imag(_waveform: ComplexArray, alpha: float, phi: float) -> np.ndarray:
...
def normalize_waveform_data(data: ComplexArray) -> tuple[np.ndarray, float, float]:
    """
