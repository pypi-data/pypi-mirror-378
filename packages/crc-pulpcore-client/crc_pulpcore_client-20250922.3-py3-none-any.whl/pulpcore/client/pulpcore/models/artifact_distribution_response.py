...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_last_updated", "pulp_href", "name", "base_path", "prn", "pulp_labels", "content_guard", "no_content_change_since", "base_url", "hidden", "pulp_created"]
