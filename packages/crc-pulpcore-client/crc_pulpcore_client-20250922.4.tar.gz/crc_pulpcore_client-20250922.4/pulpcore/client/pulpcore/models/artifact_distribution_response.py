...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prn", "base_path", "pulp_href", "pulp_last_updated", "hidden", "pulp_labels", "name", "no_content_change_since", "pulp_created", "base_url", "content_guard"]
