...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content_guard", "base_url", "no_content_change_since", "pulp_last_updated", "pulp_href", "hidden", "pulp_labels", "name", "prn", "base_path", "pulp_created"]
