...
from . import contacts, users, stickers, channels, payments, photos, account, auth, messages, stories, chatlists, langpack, premium, help, updates, folders, phone, smsjobs, bots, stats, upload, fragment
