        ...
        with hub.use(convert_log):
            if gedcom5x:
                ...
                for source in gedcom5x.sources:
                    ...
                    self.gedcomx.add_source_description(gx_obj)
                log.debug(f"Primed {len(self.gedcomx.sourceDescriptions)-olen} SourceDescriptions from GEDCOM5 Objects")
