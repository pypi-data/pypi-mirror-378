                ...
                "properties": {
                    "component": {
                        ...
                        "properties": {
                            ...
                            "codetype": {"enum": CODETYPES},
                            "codetypes": {
                                "type": "array",
                                "items": {"enum": CODETYPES},
                                "minItems": 1,
                                "uniqueItems": True,
                            },
                    ...
                    "newDistroVersion": {"type": "string", "maxLength": 255},
                    "newDistro": {"type": "string", "maxLength": 255},
                    "forceDistro": {"type": "boolean"},
                },
                "required": ["component"],
                "anyOf": [
                    {"required": ["newVersion"]},
                    {"required": ["newDistro"]},
                    {"required": ["newDistroVersion"]},
                ],
            },
        },
            ...
            "items": {
                ...
                "properties": {
                    "component": {
                        ...
                        "oneOf": [
                            {"required": ["purl"]},
                            {"required": ["name", "codetype", "version", "vendor"]},
                        ],
                    },
                    "triages": {
                        "type": "array",
        ...
        "componentAdditions": {
            ...
            "items": {
                ...
                "properties": {
                    "component": {
                        "type": "object",
                        "properties": {"purl": {"type": "string", "maxLength": 255}},
                        "required": ["purl"],
                        "additionalProperties": False,
                    }
                },
    ...
    def friendly(err: ValidationError) -> str:
        ...
        if err.validator == "additionalProperties":
            ...
            if ".componentAdditions" in str(err.absolute_path):
                return f"componentAdditions.component only allows 'purl'; additional properties are not permitted: {err.message}"
            return err.message
        return err.message
