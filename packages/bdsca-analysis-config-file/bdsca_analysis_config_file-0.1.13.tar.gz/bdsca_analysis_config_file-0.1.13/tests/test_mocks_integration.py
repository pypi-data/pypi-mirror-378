...
from bdsca_analysis_config_file.blackduck_remediate_vuln import BlackDuckRemediator
...
def test_vulnerability_remediation_flow() -> None:
    ...
    remediator._BlackDuckRemediator__get_project_versions = (  # type: ignore[attr-defined]
        lambda project, version_name: {"items": [{"_meta": {"href": base_version_href}}]}
    )
