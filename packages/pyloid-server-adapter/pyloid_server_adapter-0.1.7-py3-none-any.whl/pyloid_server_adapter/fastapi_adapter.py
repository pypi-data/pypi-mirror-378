...
from typing import Callable, TYPE_CHECKING, Annotated
...
class FastAPIAdapter(BaseAdapter):
    ...
    def __init__(self, app: FastAPI, start_function: Callable):
        """
        ...
        self.start_function = lambda: start_function(app, self.host, self.port)
