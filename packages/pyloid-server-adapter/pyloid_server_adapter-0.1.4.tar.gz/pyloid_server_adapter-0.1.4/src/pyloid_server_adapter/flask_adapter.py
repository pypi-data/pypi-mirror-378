...
class PyloidContext:
    """
    Context class for Flask server integration with Pyloid applications.

    This class encapsulates the Pyloid application instance and the current browser
    window context, making them easily accessible within Flask route handlers.
...
class FlaskAdapter:
    ...
    def __init__(self, app: Flask, start_function: Callable[[Flask, str, int], None]):
        """
