    ...
    def pyloid_context(self, func: Callable) -> Callable:
        ...
        async def wrapper(*args, **kwargs):
            ...
            **kwargs
            ...
            # If 'ctx' parameter exists in the original function signature, ensure it's injected
            if has_ctx_param and 'ctx' in kwargs:
                # Override the ctx parameter with our injected context
                kwargs['ctx'] = ctx
