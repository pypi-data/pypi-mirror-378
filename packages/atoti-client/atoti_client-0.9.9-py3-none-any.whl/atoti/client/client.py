...
class Client:
    ...
    def __init__(
        ...
        *,
        ...
        self.__http_client: Final = http_client
    ...
    def _graphql_client(self) -> GraphqlClient | None:
        if not has_compatible_server_api(self._server_versions):
            return None

        return GraphqlClient(
            # Uncomment next line and delete the following one when adding server side support for data model transactions.
            # Otherwise it causes issues such as https://activeviam.atlassian.net/browse/PYTHON-690.
