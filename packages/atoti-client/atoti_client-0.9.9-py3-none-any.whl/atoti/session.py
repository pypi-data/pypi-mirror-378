...
class Session(AbstractContextManager["Session"]):
    ...
    def __init__(
        ...
        *,
        ...
        self._endpoint_server: Final = self._exit_stack.push(
            EndpointServer(session_url=client._url),
        )
    ...
    def connect(
        ...
        * Minimal capabilities
        ...
        Example:
            ...
            The target session must require authentication:
    ...
    def ready(self) -> bool:
        ...
        """
        return self.client._require_py4j_client().get_readiness()
    ...
    def _reset(self) -> None:
        ...
        graphql_client = self.client._graphql_client
