...
from ..client._has_compatible_server_api import (
...
def connected_session_client(
    ...
    *,
    ...
    with ExitStack() as exit_stack:
        ...
        if has_compatible_server_api(client._server_versions):
            ...
            if py4j_configuration is not None:
                ...
                client._py4j_client = exit_stack.enter_context(  # type: ignore[misc] # pyright: ignore[reportAttributeAccessIssue]
                    Py4jClient.create(
                        ...
                        is_batching_mutations=lambda: client._require_graphql_client().mutation_batcher._batching,  # pylint: disable=protected-access
