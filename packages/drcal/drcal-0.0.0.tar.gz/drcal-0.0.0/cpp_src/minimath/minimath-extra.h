...
__attribute__((unused)) static int index_sym33(
    int i,
    int j
) {
    ...
    if (i <= j) {
        ...
        return (N * 2 - j - 1) * j / 2 + i;
    }
}
__attribute__((unused)) static int index_sym33_assume_upper(
    int i,
    int j
) {
    const int N = 3;
...
// Upper triangle is stored, in the usual row-major order.
__attribute__((unused)) static int index_sym66(
    int i,
    int j
) {
    // In the top-right triangle I have i<=j, and
...
__attribute__((unused)) static int index_sym66_assume_upper(
    int i,
    int j
) {
    const int N = 6;
...
__attribute__((unused)) static void mul_gen33_gen33insym66(
    // output
    double* restrict P,
    int P_strideelems0,
    int P_strideelems1,
...
__attribute__((unused)) static void mul_gen33_gen33_into33insym66_accum(
    // output
    double* restrict Psym66,
    int P_i0,
    int P_j0,
    // input
    const double* A,
...
__attribute__((unused)) static void set_gen33_from_gen33insym66(
    // output
    double* restrict P,
    int P_strideelems0,
    int P_strideelems1,
...
// Assumes the output is symmetric, and only computes the upper triangle
__attribute__((unused)) static void set_33insym66_from_gen33_accum(
    // output
    double* restrict Psym66,
    int P_i0,
    int P_j0,
...
__attribute__((unused)) static double cofactors_sym6(
    const double* restrict m,
    double* restrict c
) {
    /*
Just like in libminimath; adding 6x6 version. I use the maxima result verbatim,
except:
...
Test program:
    ...
    {
        const double a[] =
            { 1.9826929 , 0.49539104, 1.21536243,
0.98610923, 1.68623959, 1.0331091 , 1.96643809, 1.42962549, 0.9336305
, 1.96542156, 0.6086516 , 0.81542249, 0.74012536, 0.83940333, 1.58604071,
                                                  0.1338364 , 1.03314221,
0.44817192, 1.97146512, 0.27591278, 1.51474051 };
    ...
    c[0] = (-m[7] * ((-m[12] * ((-m[16] * (m[20] * m[9] - m[10] * m[19])) +
                                m[17] * (m[19] * m[9] - m[10] * m[18]) +
                                (m[18] * m[20] - m[19] * m[19]) * m[8])) +
                     m[13] * ((-m[15] * (m[20] * m[9] - m[10] * m[19])) +
                              m[17] * (m[17] * m[9] - m[10] * m[16]) +
                              (m[16] * m[20] - m[17] * m[19]) * m[8]) -
                     m[14] * ((-m[15] * (m[19] * m[9] - m[10] * m[18])) +
                              m[16] * (m[17] * m[9] - m[10] * m[16]) +
                              (m[16] * m[19] - m[17] * m[18]) * m[8]) +
                     (m[15] * (m[18] * m[20] - m[19] * m[19]) -
                      m[16] * (m[16] * m[20] - m[17] * m[19]) +
                      m[17] * (m[16] * m[19] - m[17] * m[18])) *
                         m[7])) +
           m[8] * ((-m[11] * ((-m[16] * (m[20] * m[9] - m[10] * m[19])) +
                              m[17] * (m[19] * m[9] - m[10] * m[18]) +
                              (m[18] * m[20] - m[19] * m[19]) * m[8])) +
                   m[13] * ((-m[12] * (m[20] * m[9] - m[10] * m[19])) +
                            m[17] * (m[14] * m[9] - m[10] * m[13]) +
                            (m[13] * m[20] - m[14] * m[19]) * m[8]) -
                   m[14] * ((-m[12] * (m[19] * m[9] - m[10] * m[18])) +
                            m[16] * (m[14] * m[9] - m[10] * m[13]) +
                            (m[13] * m[19] - m[14] * m[18]) * m[8]) +
                   (m[12] * (m[18] * m[20] - m[19] * m[19]) -
                    m[16] * (m[13] * m[20] - m[14] * m[19]) +
                    m[17] * (m[13] * m[19] - m[14] * m[18])) *
                       m[7]) -
           m[9] * ((-m[11] * ((-m[15] * (m[20] * m[9] - m[10] * m[19])) +
                              m[17] * (m[17] * m[9] - m[10] * m[16]) +
                              (m[16] * m[20] - m[17] * m[19]) * m[8])) +
                   m[12] * ((-m[12] * (m[20] * m[9] - m[10] * m[19])) +
                            m[17] * (m[14] * m[9] - m[10] * m[13]) +
                            (m[13] * m[20] - m[14] * m[19]) * m[8]) -
                   m[14] * ((-m[12] * (m[17] * m[9] - m[10] * m[16])) +
                            m[15] * (m[14] * m[9] - m[10] * m[13]) +
                            (m[13] * m[17] - m[14] * m[16]) * m[8]) +
                   (m[12] * (m[16] * m[20] - m[17] * m[19]) -
                    m[15] * (m[13] * m[20] - m[14] * m[19]) +
                    m[17] * (m[13] * m[17] - m[14] * m[16])) *
                       m[7]) +
           m[10] * ((-m[11] * ((-m[15] * (m[19] * m[9] - m[10] * m[18])) +
                               m[16] * (m[17] * m[9] - m[10] * m[16]) +
                               (m[16] * m[19] - m[17] * m[18]) * m[8])) +
                    m[12] * ((-m[12] * (m[19] * m[9] - m[10] * m[18])) +
                             m[16] * (m[14] * m[9] - m[10] * m[13]) +
                             (m[13] * m[19] - m[14] * m[18]) * m[8]) -
                    m[13] * ((-m[12] * (m[17] * m[9] - m[10] * m[16])) +
                             m[15] * (m[14] * m[9] - m[10] * m[13]) +
                             (m[13] * m[17] - m[14] * m[16]) * m[8]) +
                    (m[12] * (m[16] * m[19] - m[17] * m[18]) -
                     m[15] * (m[13] * m[19] - m[14] * m[18]) +
                     m[16] * (m[13] * m[17] - m[14] * m[16])) *
                        m[7]) +
           (m[11] * (m[15] * (m[18] * m[20] - m[19] * m[19]) -
                     m[16] * (m[16] * m[20] - m[17] * m[19]) +
                     m[17] * (m[16] * m[19] - m[17] * m[18])) -
            m[12] * (m[12] * (m[18] * m[20] - m[19] * m[19]) -
                     m[16] * (m[13] * m[20] - m[14] * m[19]) +
                     m[17] * (m[13] * m[19] - m[14] * m[18])) +
            m[13] * (m[12] * (m[16] * m[20] - m[17] * m[19]) -
                     m[15] * (m[13] * m[20] - m[14] * m[19]) +
                     m[17] * (m[13] * m[17] - m[14] * m[16])) -
            m[14] * (m[12] * (m[16] * m[19] - m[17] * m[18]) -
                     m[15] * (m[13] * m[19] - m[14] * m[18]) +
                     m[16] * (m[13] * m[17] - m[14] * m[16]))) *
               m[6];
    c[1] = m[2] * ((-m[12] * ((-m[16] * (m[20] * m[9] - m[10] * m[19])) +
                              m[17] * (m[19] * m[9] - m[10] * m[18]) +
                              (m[18] * m[20] - m[19] * m[19]) * m[8])) +
                   m[13] * ((-m[15] * (m[20] * m[9] - m[10] * m[19])) +
                            m[17] * (m[17] * m[9] - m[10] * m[16]) +
                   ...
                   (m[15] * (m[18] * m[20] - m[19] * m[19]) -
                    ...
                    m[17] * (m[16] * m[19] - m[17] * m[18])) *
                       m[7]) -
           m[3] * ((-m[11] * ((-m[16] * (m[20] * m[9] - m[10] * m[19])) +
                              m[17] * (m[19] * m[9] - m[10] * m[18]) +
                              (m[18] * m[20] - m[19] * m[19]) * m[8])) +
                   m[13] * ((-m[12] * (m[20] * m[9] - m[10] * m[19])) +
                            m[17] * (m[14] * m[9] - m[10] * m[13]) +
                   ...
                   (m[12] * (m[18] * m[20] - m[19] * m[19]) -
                    ...
                    m[17] * (m[13] * m[19] - m[14] * m[18])) *
                       m[7]) +
           m[4] * ((-m[11] * ((-m[15] * (m[20] * m[9] - m[10] * m[19])) +
                              m[17] * (m[17] * m[9] - m[10] * m[16]) +
                              (m[16] * m[20] - m[17] * m[19]) * m[8])) +
                   m[12] * ((-m[12] * (m[20] * m[9] - m[10] * m[19])) +
                            m[17] * (m[14] * m[9] - m[10] * m[13]) +
                   ...
                   (m[12] * (m[16] * m[20] - m[17] * m[19]) -
                    ...
                    m[17] * (m[13] * m[17] - m[14] * m[16])) *
                       m[7]) -
           m[5] * ((-m[11] * ((-m[15] * (m[19] * m[9] - m[10] * m[18])) +
                              m[16] * (m[17] * m[9] - m[10] * m[16]) +
                              (m[16] * m[19] - m[17] * m[18]) * m[8])) +
                   m[12] * ((-m[12] * (m[19] * m[9] - m[10] * m[18])) +
                            m[16] * (m[14] * m[9] - m[10] * m[13]) +
                   ...
                   (m[12] * (m[16] * m[19] - m[17] * m[18]) -
                    ...
                    m[16] * (m[13] * m[17] - m[14] * m[16])) *
                       m[7]) -
           m[1] * (m[11] * (m[15] * (m[18] * m[20] - m[19] * m[19]) -
                            m[16] * (m[16] * m[20] - m[17] * m[19]) +
                            m[17] * (m[16] * m[19] - m[17] * m[18])) -
                   m[12] * (m[12] * (m[18] * m[20] - m[19] * m[19]) -
                            m[16] * (m[13] * m[20] - m[14] * m[19]) +
                   ...
                   m[14] * (m[12] * (m[16] * m[19] - m[17] * m[18]) -
                            m[15] * (m[13] * m[19] - m[14] * m[18]) +
                            m[16] * (m[13] * m[17] - m[14] * m[16])));
    c[2] = (-m[2] * ((-m[8] * ((-m[16] * (m[20] * m[9] - m[10] * m[19])) +
                               m[17] * (m[19] * m[9] - m[10] * m[18]) +
                               (m[18] * m[20] - m[19] * m[19]) * m[8])) +
                     m[9] * ((-m[15] * (m[20] * m[9] - m[10] * m[19])) +
                             m[17] * (m[17] * m[9] - m[10] * m[16]) +
                             (m[16] * m[20] - m[17] * m[19]) * m[8]) -
                     m[10] * ((-m[15] * (m[19] * m[9] - m[10] * m[18])) +
                              m[16] * (m[17] * m[9] - m[10] * m[16]) +
                              (m[16] * m[19] - m[17] * m[18]) * m[8]) +
                     (m[15] * (m[18] * m[20] - m[19] * m[19]) -
                      m[16] * (m[16] * m[20] - m[17] * m[19]) +
                      m[17] * (m[16] * m[19] - m[17] * m[18])) *
                         m[6])) +
           m[3] * ((-m[7] * ((-m[16] * (m[20] * m[9] - m[10] * m[19])) +
                             m[17] * (m[19] * m[9] - m[10] * m[18]) +
                             (m[18] * m[20] - m[19] * m[19]) * m[8])) +
                   m[9] * ((-m[12] * (m[20] * m[9] - m[10] * m[19])) +
                           m[17] * (m[14] * m[9] - m[10] * m[13]) +
                           (m[13] * m[20] - m[14] * m[19]) * m[8]) -
                   m[10] * ((-m[12] * (m[19] * m[9] - m[10] * m[18])) +
                            m[16] * (m[14] * m[9] - m[10] * m[13]) +
                            (m[13] * m[19] - m[14] * m[18]) * m[8]) +
                   (m[12] * (m[18] * m[20] - m[19] * m[19]) -
                    m[16] * (m[13] * m[20] - m[14] * m[19]) +
                    m[17] * (m[13] * m[19] - m[14] * m[18])) *
                       m[6]) -
           m[4] * ((-m[7] * ((-m[15] * (m[20] * m[9] - m[10] * m[19])) +
                             m[17] * (m[17] * m[9] - m[10] * m[16]) +
                             (m[16] * m[20] - m[17] * m[19]) * m[8])) +
                   m[8] * ((-m[12] * (m[20] * m[9] - m[10] * m[19])) +
                           m[17] * (m[14] * m[9] - m[10] * m[13]) +
                           (m[13] * m[20] - m[14] * m[19]) * m[8]) -
                   m[10] * ((-m[12] * (m[17] * m[9] - m[10] * m[16])) +
                            m[15] * (m[14] * m[9] - m[10] * m[13]) +
                            (m[13] * m[17] - m[14] * m[16]) * m[8]) +
                   (m[12] * (m[16] * m[20] - m[17] * m[19]) -
                    m[15] * (m[13] * m[20] - m[14] * m[19]) +
                    m[17] * (m[13] * m[17] - m[14] * m[16])) *
                       m[6]) +
           m[5] * ((-m[7] * ((-m[15] * (m[19] * m[9] - m[10] * m[18])) +
                             m[16] * (m[17] * m[9] - m[10] * m[16]) +
                             (m[16] * m[19] - m[17] * m[18]) * m[8])) +
                   m[8] * ((-m[12] * (m[19] * m[9] - m[10] * m[18])) +
                           m[16] * (m[14] * m[9] - m[10] * m[13]) +
                           (m[13] * m[19] - m[14] * m[18]) * m[8]) -
                   m[9] * ((-m[12] * (m[17] * m[9] - m[10] * m[16])) +
                           m[15] * (m[14] * m[9] - m[10] * m[13]) +
                           (m[13] * m[17] - m[14] * m[16]) * m[8]) +
                   (m[12] * (m[16] * m[19] - m[17] * m[18]) -
                    m[15] * (m[13] * m[19] - m[14] * m[18]) +
           ...
           m[1] * ((m[12] * (m[16] * m[20] - m[17] * m[19]) -
                   ...
                   (m[15] * (m[18] * m[20] - m[19] * m[19]) -
                    ...
                    m[17] * (m[16] * m[19] - m[17] * m[18])) *
                       m[7] -
                   m[10] * (m[12] * (m[16] * m[19] - m[17] * m[18]) -
                            m[15] * (m[13] * m[19] - m[14] * m[18]) +
                            m[16] * (m[13] * m[17] - m[14] * m[16])));
    c[3] = m[2] * ((-m[8] * ((-m[13] * (m[20] * m[9] - m[10] * m[19])) +
                             m[14] * (m[19] * m[9] - m[10] * m[18]) +
                             (m[18] * m[20] - m[19] * m[19]) * m[7])) +
                   m[9] * ((-m[12] * (m[20] * m[9] - m[10] * m[19])) +
                           m[14] * (m[17] * m[9] - m[10] * m[16]) +
                           (m[16] * m[20] - m[17] * m[19]) * m[7]) -
                   m[10] * ((-m[12] * (m[19] * m[9] - m[10] * m[18])) +
                            m[13] * (m[17] * m[9] - m[10] * m[16]) +
                            (m[16] * m[19] - m[17] * m[18]) * m[7]) +
                   (m[12] * (m[18] * m[20] - m[19] * m[19]) -
                    m[13] * (m[16] * m[20] - m[17] * m[19]) +
                    m[14] * (m[16] * m[19] - m[17] * m[18])) *
                       m[6]) -
           m[3] * ((-m[7] * ((-m[13] * (m[20] * m[9] - m[10] * m[19])) +
                             m[14] * (m[19] * m[9] - m[10] * m[18]) +
                             (m[18] * m[20] - m[19] * m[19]) * m[7])) +
                   m[9] * ((-m[11] * (m[20] * m[9] - m[10] * m[19])) +
                           m[14] * (m[14] * m[9] - m[10] * m[13]) +
                           (m[13] * m[20] - m[14] * m[19]) * m[7]) -
                   m[10] * ((-m[11] * (m[19] * m[9] - m[10] * m[18])) +
                            m[13] * (m[14] * m[9] - m[10] * m[13]) +
                            (m[13] * m[19] - m[14] * m[18]) * m[7]) +
                   (m[11] * (m[18] * m[20] - m[19] * m[19]) -
                    m[13] * (m[13] * m[20] - m[14] * m[19]) +
                    m[14] * (m[13] * m[19] - m[14] * m[18])) *
                       m[6]) +
           m[4] * ((-m[7] * ((-m[12] * (m[20] * m[9] - m[10] * m[19])) +
                             m[14] * (m[17] * m[9] - m[10] * m[16]) +
                             (m[16] * m[20] - m[17] * m[19]) * m[7])) +
                   m[8] * ((-m[11] * (m[20] * m[9] - m[10] * m[19])) +
                           m[14] * (m[14] * m[9] - m[10] * m[13]) +
                           (m[13] * m[20] - m[14] * m[19]) * m[7]) -
                   m[10] * ((-m[11] * (m[17] * m[9] - m[10] * m[16])) +
                            m[12] * (m[14] * m[9] - m[10] * m[13]) +
                            (m[13] * m[17] - m[14] * m[16]) * m[7]) +
                   (m[11] * (m[16] * m[20] - m[17] * m[19]) -
                    m[12] * (m[13] * m[20] - m[14] * m[19]) +
                    m[14] * (m[13] * m[17] - m[14] * m[16])) *
                       m[6]) -
           m[5] * ((-m[7] * ((-m[12] * (m[19] * m[9] - m[10] * m[18])) +
                             m[13] * (m[17] * m[9] - m[10] * m[16]) +
                             (m[16] * m[19] - m[17] * m[18]) * m[7])) +
                   m[8] * ((-m[11] * (m[19] * m[9] - m[10] * m[18])) +
                           m[13] * (m[14] * m[9] - m[10] * m[13]) +
                           (m[13] * m[19] - m[14] * m[18]) * m[7]) -
                   m[9] * ((-m[11] * (m[17] * m[9] - m[10] * m[16])) +
                           m[12] * (m[14] * m[9] - m[10] * m[13]) +
                           (m[13] * m[17] - m[14] * m[16]) * m[7]) +
                   (m[11] * (m[16] * m[19] - m[17] * m[18]) -
                    m[12] * (m[13] * m[19] - m[14] * m[18]) +
                    m[13] * (m[13] * m[17] - m[14] * m[16])) *
                       m[6]) -
           m[1] * ((m[11] * (m[16] * m[20] - m[17] * m[19]) -
                    m[12] * (m[13] * m[20] - m[14] * m[19]) +
                    m[14] * (m[13] * m[17] - m[14] * m[16])) *
                       m[9] -
                   (m[11] * (m[18] * m[20] - m[19] * m[19]) -
                   ...
                   (m[12] * (m[18] * m[20] - m[19] * m[19]) -
                    ...
                    m[14] * (m[16] * m[19] - m[17] * m[18])) *
                       m[7] -
                   m[10] * (m[11] * (m[16] * m[19] - m[17] * m[18]) -
                            m[12] * (m[13] * m[19] - m[14] * m[18]) +
                            m[13] * (m[13] * m[17] - m[14] * m[16])));
    c[4] = (-m[2] * (((-m[12] * (m[20] * m[8] - m[10] * m[17])) +
                      m[14] * (m[17] * m[8] - m[10] * m[15]) +
                      (m[15] * m[20] - m[17] * m[17]) * m[7]) *
                         m[9] -
                     m[8] * ((-m[13] * (m[20] * m[8] - m[10] * m[17])) +
                             m[14] * (m[19] * m[8] - m[10] * m[16]) +
                             (m[16] * m[20] - m[17] * m[19]) * m[7]) -
                     m[10] * ((-m[12] * (m[19] * m[8] - m[10] * m[16])) +
                              m[13] * (m[17] * m[8] - m[10] * m[15]) +
                              (m[15] * m[19] - m[16] * m[17]) * m[7]) +
                     (m[12] * (m[16] * m[20] - m[17] * m[19]) -
                      m[13] * (m[15] * m[20] - m[17] * m[17]) +
                      m[14] * (m[15] * m[19] - m[16] * m[17])) *
                         m[6])) +
           m[3] * (((-m[11] * (m[20] * m[8] - m[10] * m[17])) +
                    m[14] * (m[14] * m[8] - m[10] * m[12]) +
                    (m[12] * m[20] - m[14] * m[17]) * m[7]) *
                       m[9] -
                   m[7] * ((-m[13] * (m[20] * m[8] - m[10] * m[17])) +
                           m[14] * (m[19] * m[8] - m[10] * m[16]) +
                           (m[16] * m[20] - m[17] * m[19]) * m[7]) -
                   m[10] * ((-m[11] * (m[19] * m[8] - m[10] * m[16])) +
                            m[13] * (m[14] * m[8] - m[10] * m[12]) +
                            (m[12] * m[19] - m[14] * m[16]) * m[7]) +
                   (m[11] * (m[16] * m[20] - m[17] * m[19]) -
                    m[13] * (m[12] * m[20] - m[14] * m[17]) +
                    m[14] * (m[12] * m[19] - m[14] * m[16])) *
                       m[6]) +
           m[5] * ((-((-m[11] * (m[17] * m[8] - m[10] * m[15])) +
                      m[12] * (m[14] * m[8] - m[10] * m[12]) +
                      (m[12] * m[17] - m[14] * m[15]) * m[7]) *
                    m[9]) -
                   m[7] * ((-m[12] * (m[19] * m[8] - m[10] * m[16])) +
                           m[13] * (m[17] * m[8] - m[10] * m[15]) +
                           (m[15] * m[19] - m[16] * m[17]) * m[7]) +
                   m[8] * ((-m[11] * (m[19] * m[8] - m[10] * m[16])) +
                           m[13] * (m[14] * m[8] - m[10] * m[12]) +
                           (m[12] * m[19] - m[14] * m[16]) * m[7]) +
                   (m[11] * (m[15] * m[19] - m[16] * m[17]) -
                    m[12] * (m[12] * m[19] - m[14] * m[16]) +
                    m[13] * (m[12] * m[17] - m[14] * m[15])) *
                       m[6]) +
           m[1] * ((m[11] * (m[15] * m[20] - m[17] * m[17]) -
                    m[12] * (m[12] * m[20] - m[14] * m[17]) +
                    m[14] * (m[12] * m[17] - m[14] * m[15])) *
                       m[9] -
                   (m[11] * (m[16] * m[20] - m[17] * m[19]) -
                    m[13] * (m[12] * m[20] - m[14] * m[17]) +
                    m[14] * (m[12] * m[19] - m[14] * m[16])) *
                   ...
                   (m[12] * (m[16] * m[20] - m[17] * m[19]) -
                    ...
                    m[14] * (m[15] * m[19] - m[16] * m[17])) *
                       m[7] -
                   m[10] * (m[11] * (m[15] * m[19] - m[16] * m[17]) -
                            m[12] * (m[12] * m[19] - m[14] * m[16]) +
                            m[13] * (m[12] * m[17] - m[14] * m[15]))) -
           m[4] * ((-m[7] * ((-m[12] * (m[20] * m[8] - m[10] * m[17])) +
                             m[14] * (m[17] * m[8] - m[10] * m[15]) +
                             (m[15] * m[20] - m[17] * m[17]) * m[7])) +
                   m[8] * ((-m[11] * (m[20] * m[8] - m[10] * m[17])) +
                           m[14] * (m[14] * m[8] - m[10] * m[12]) +
                           (m[12] * m[20] - m[14] * m[17]) * m[7]) -
                   m[10] * ((-m[11] * (m[17] * m[8] - m[10] * m[15])) +
                            m[12] * (m[14] * m[8] - m[10] * m[12]) +
                            (m[12] * m[17] - m[14] * m[15]) * m[7]) +
                   (m[11] * (m[15] * m[20] - m[17] * m[17]) -
                    m[12] * (m[12] * m[20] - m[14] * m[17]) +
                    m[14] * (m[12] * m[17] - m[14] * m[15])) *
                       m[6]);
    c[5] = m[2] * ((-m[8] * ((-m[13] * (m[19] * m[8] - m[17] * m[9])) +
                             m[14] * (m[18] * m[8] - m[16] * m[9]) +
                             (m[16] * m[19] - m[17] * m[18]) * m[7])) +
                   m[9] * ((-m[12] * (m[19] * m[8] - m[17] * m[9])) +
                           m[14] * (m[16] * m[8] - m[15] * m[9]) +
                           (m[15] * m[19] - m[16] * m[17]) * m[7]) -
                   m[10] * ((-m[12] * (m[18] * m[8] - m[16] * m[9])) +
                            m[13] * (m[16] * m[8] - m[15] * m[9]) +
                            (m[15] * m[18] - m[16] * m[16]) * m[7]) +
                   (m[12] * (m[16] * m[19] - m[17] * m[18]) -
                    m[13] * (m[15] * m[19] - m[16] * m[17]) +
                    m[14] * (m[15] * m[18] - m[16] * m[16])) *
                       m[6]) -
           m[3] * ((-m[7] * ((-m[13] * (m[19] * m[8] - m[17] * m[9])) +
                             m[14] * (m[18] * m[8] - m[16] * m[9]) +
                             (m[16] * m[19] - m[17] * m[18]) * m[7])) +
                   m[9] * ((-m[11] * (m[19] * m[8] - m[17] * m[9])) +
                           m[14] * (m[13] * m[8] - m[12] * m[9]) +
                           (m[12] * m[19] - m[13] * m[17]) * m[7]) -
                   m[10] * ((-m[11] * (m[18] * m[8] - m[16] * m[9])) +
                            m[13] * (m[13] * m[8] - m[12] * m[9]) +
                            (m[12] * m[18] - m[13] * m[16]) * m[7]) +
                   (m[11] * (m[16] * m[19] - m[17] * m[18]) -
                    m[13] * (m[12] * m[19] - m[13] * m[17]) +
                    m[14] * (m[12] * m[18] - m[13] * m[16])) *
                       m[6]) +
           m[4] * ((-m[7] * ((-m[12] * (m[19] * m[8] - m[17] * m[9])) +
                             m[14] * (m[16] * m[8] - m[15] * m[9]) +
                             (m[15] * m[19] - m[16] * m[17]) * m[7])) +
                   m[8] * ((-m[11] * (m[19] * m[8] - m[17] * m[9])) +
                           m[14] * (m[13] * m[8] - m[12] * m[9]) +
                           (m[12] * m[19] - m[13] * m[17]) * m[7]) -
                   m[10] * ((-m[11] * (m[16] * m[8] - m[15] * m[9])) +
                            m[12] * (m[13] * m[8] - m[12] * m[9]) +
                            (m[12] * m[16] - m[13] * m[15]) * m[7]) +
                   (m[11] * (m[15] * m[19] - m[16] * m[17]) -
                    m[12] * (m[12] * m[19] - m[13] * m[17]) +
                    m[14] * (m[12] * m[16] - m[13] * m[15])) *
                       m[6]) -
           m[5] * ((-m[7] * ((-m[12] * (m[18] * m[8] - m[16] * m[9])) +
                             m[13] * (m[16] * m[8] - m[15] * m[9]) +
                             (m[15] * m[18] - m[16] * m[16]) * m[7])) +
                   m[8] * ((-m[11] * (m[18] * m[8] - m[16] * m[9])) +
                           m[13] * (m[13] * m[8] - m[12] * m[9]) +
                           (m[12] * m[18] - m[13] * m[16]) * m[7]) -
                   m[9] * ((-m[11] * (m[16] * m[8] - m[15] * m[9])) +
                           m[12] * (m[13] * m[8] - m[12] * m[9]) +
                           (m[12] * m[16] - m[13] * m[15]) * m[7]) +
                   (m[11] * (m[15] * m[18] - m[16] * m[16]) -
                    m[12] * (m[12] * m[18] - m[13] * m[16]) +
                    m[13] * (m[12] * m[16] - m[13] * m[15])) *
                       m[6]) -
           m[1] * ((m[11] * (m[15] * m[19] - m[16] * m[17]) -
                    m[12] * (m[12] * m[19] - m[13] * m[17]) +
                    m[14] * (m[12] * m[16] - m[13] * m[15])) *
                       m[9] -
                   (m[11] * (m[16] * m[19] - m[17] * m[18]) -
                   ...
                   (m[12] * (m[16] * m[19] - m[17] * m[18]) -
                    ...
                    m[14] * (m[15] * m[18] - m[16] * m[16])) *
                       m[7] -
                   m[10] * (m[11] * (m[15] * m[18] - m[16] * m[16]) -
                            m[12] * (m[12] * m[18] - m[13] * m[16]) +
                            m[13] * (m[12] * m[16] - m[13] * m[15])));
    c[6] = (-m[2] * ((-m[12] * ((-m[16] * (m[20] * m[4] - m[19] * m[5])) +
                                m[17] * (m[19] * m[4] - m[18] * m[5]) +
                                (m[18] * m[20] - m[19] * m[19]) * m[3])) +
                     m[13] * ((-m[15] * (m[20] * m[4] - m[19] * m[5])) +
                              m[17] * (m[17] * m[4] - m[16] * m[5]) +
                              (m[16] * m[20] - m[17] * m[19]) * m[3]) -
                     m[14] * ((-m[15] * (m[19] * m[4] - m[18] * m[5])) +
                              m[16] * (m[17] * m[4] - m[16] * m[5]) +
                              (m[16] * m[19] - m[17] * m[18]) * m[3]) +
                     m[2] * (m[15] * (m[18] * m[20] - m[19] * m[19]) -
                             m[16] * (m[16] * m[20] - m[17] * m[19]) +
                             m[17] * (m[16] * m[19] - m[17] * m[18])))) +
           m[3] * ((-m[11] * ((-m[16] * (m[20] * m[4] - m[19] * m[5])) +
                              m[17] * (m[19] * m[4] - m[18] * m[5]) +
                              (m[18] * m[20] - m[19] * m[19]) * m[3])) +
                   m[13] * ((-m[12] * (m[20] * m[4] - m[19] * m[5])) +
                            m[17] * (m[14] * m[4] - m[13] * m[5]) +
                            (m[13] * m[20] - m[14] * m[19]) * m[3]) -
                   m[14] * ((-m[12] * (m[19] * m[4] - m[18] * m[5])) +
                            m[16] * (m[14] * m[4] - m[13] * m[5]) +
                            (m[13] * m[19] - m[14] * m[18]) * m[3]) +
                   m[2] * (m[12] * (m[18] * m[20] - m[19] * m[19]) -
                           m[16] * (m[13] * m[20] - m[14] * m[19]) +
                           m[17] * (m[13] * m[19] - m[14] * m[18]))) -
           m[4] * ((-m[11] * ((-m[15] * (m[20] * m[4] - m[19] * m[5])) +
                              m[17] * (m[17] * m[4] - m[16] * m[5]) +
                              (m[16] * m[20] - m[17] * m[19]) * m[3])) +
                   m[12] * ((-m[12] * (m[20] * m[4] - m[19] * m[5])) +
                            m[17] * (m[14] * m[4] - m[13] * m[5]) +
                            (m[13] * m[20] - m[14] * m[19]) * m[3]) -
                   m[14] * ((-m[12] * (m[17] * m[4] - m[16] * m[5])) +
                            m[15] * (m[14] * m[4] - m[13] * m[5]) +
                            (m[13] * m[17] - m[14] * m[16]) * m[3]) +
                   m[2] * (m[12] * (m[16] * m[20] - m[17] * m[19]) -
                           m[15] * (m[13] * m[20] - m[14] * m[19]) +
                           m[17] * (m[13] * m[17] - m[14] * m[16]))) +
           m[5] * ((-m[11] * ((-m[15] * (m[19] * m[4] - m[18] * m[5])) +
                              m[16] * (m[17] * m[4] - m[16] * m[5]) +
                              (m[16] * m[19] - m[17] * m[18]) * m[3])) +
                   m[12] * ((-m[12] * (m[19] * m[4] - m[18] * m[5])) +
                            m[16] * (m[14] * m[4] - m[13] * m[5]) +
                            (m[13] * m[19] - m[14] * m[18]) * m[3]) -
                   m[13] * ((-m[12] * (m[17] * m[4] - m[16] * m[5])) +
                            m[15] * (m[14] * m[4] - m[13] * m[5]) +
                            (m[13] * m[17] - m[14] * m[16]) * m[3]) +
                   (m[12] * (m[16] * m[19] - m[17] * m[18]) -
                    m[15] * (m[13] * m[19] - m[14] * m[18]) +
                    m[16] * (m[13] * m[17] - m[14] * m[16])) *
                       m[2]) +
           m[0] * (m[11] * (m[15] * (m[18] * m[20] - m[19] * m[19]) -
                            m[16] * (m[16] * m[20] - m[17] * m[19]) +
                            m[17] * (m[16] * m[19] - m[17] * m[18])) -
                   m[12] * (m[12] * (m[18] * m[20] - m[19] * m[19]) -
                            m[16] * (m[13] * m[20] - m[14] * m[19]) +
                   ...
                   m[14] * (m[12] * (m[16] * m[19] - m[17] * m[18]) -
                            m[15] * (m[13] * m[19] - m[14] * m[18]) +
                            m[16] * (m[13] * m[17] - m[14] * m[16])));
    c[7] = m[2] * (((-m[15] * (m[20] * m[4] - m[19] * m[5])) +
                    m[17] * (m[17] * m[4] - m[16] * m[5]) +
                    (m[16] * m[20] - m[17] * m[19]) * m[3]) *
                       m[9] -
                   ((-m[16] * (m[20] * m[4] - m[19] * m[5])) +
                    m[17] * (m[19] * m[4] - m[18] * m[5]) +
                    (m[18] * m[20] - m[19] * m[19]) * m[3]) *
                       m[8] -
                   m[10] * ((-m[15] * (m[19] * m[4] - m[18] * m[5])) +
                            m[16] * (m[17] * m[4] - m[16] * m[5]) +
                            (m[16] * m[19] - m[17] * m[18]) * m[3]) +
                   m[1] * (m[15] * (m[18] * m[20] - m[19] * m[19]) -
                           m[16] * (m[16] * m[20] - m[17] * m[19]) +
                           m[17] * (m[16] * m[19] - m[17] * m[18]))) -
           m[3] * (((-m[12] * (m[20] * m[4] - m[19] * m[5])) +
                    m[17] * (m[14] * m[4] - m[13] * m[5]) +
                    (m[13] * m[20] - m[14] * m[19]) * m[3]) *
                       m[9] -
                   ((-m[16] * (m[20] * m[4] - m[19] * m[5])) +
                    ...
                    (m[18] * m[20] - m[19] * m[19]) * m[3]) *
                       m[7] -
                   m[10] * ((-m[12] * (m[19] * m[4] - m[18] * m[5])) +
                            m[16] * (m[14] * m[4] - m[13] * m[5]) +
                            (m[13] * m[19] - m[14] * m[18]) * m[3]) +
                   m[1] * (m[12] * (m[18] * m[20] - m[19] * m[19]) -
                           m[16] * (m[13] * m[20] - m[14] * m[19]) +
                           m[17] * (m[13] * m[19] - m[14] * m[18]))) -
           m[5] * ((-((-m[12] * (m[17] * m[4] - m[16] * m[5])) +
                      m[15] * (m[14] * m[4] - m[13] * m[5]) +
                      (m[13] * m[17] - m[14] * m[16]) * m[3]) *
                    m[9]) +
                   ((-m[12] * (m[19] * m[4] - m[18] * m[5])) +
                    m[16] * (m[14] * m[4] - m[13] * m[5]) +
                    (m[13] * m[19] - m[14] * m[18]) * m[3]) *
                       m[8] -
                   ((-m[15] * (m[19] * m[4] - m[18] * m[5])) +
                    m[16] * (m[17] * m[4] - m[16] * m[5]) +
                    (m[16] * m[19] - m[17] * m[18]) * m[3]) *
                       m[7] +
                   m[1] * (m[12] * (m[16] * m[19] - m[17] * m[18]) -
                           m[15] * (m[13] * m[19] - m[14] * m[18]) +
                           m[16] * (m[13] * m[17] - m[14] * m[16]))) -
           m[0] * ((m[12] * (m[16] * m[20] - m[17] * m[19]) -
                    m[15] * (m[13] * m[20] - m[14] * m[19]) +
                    m[17] * (m[13] * m[17] - m[14] * m[16])) *
                       m[9] -
                   (m[12] * (m[18] * m[20] - m[19] * m[19]) -
                   ...
                   m[10] * (m[12] * (m[16] * m[19] - m[17] * m[18]) -
                            m[15] * (m[13] * m[19] - m[14] * m[18]) +
                            m[16] * (m[13] * m[17] - m[14] * m[16]))) +
           m[4] * (((-m[12] * (m[20] * m[4] - m[19] * m[5])) +
                    m[17] * (m[14] * m[4] - m[13] * m[5]) +
                    (m[13] * m[20] - m[14] * m[19]) * m[3]) *
                       m[8] -
                   ((-m[15] * (m[20] * m[4] - m[19] * m[5])) +
                    m[17] * (m[17] * m[4] - m[16] * m[5]) +
                    (m[16] * m[20] - m[17] * m[19]) * m[3]) *
                       m[7] -
                   m[10] * ((-m[12] * (m[17] * m[4] - m[16] * m[5])) +
                            m[15] * (m[14] * m[4] - m[13] * m[5]) +
                            (m[13] * m[17] - m[14] * m[16]) * m[3]) +
                   m[1] * (m[12] * (m[16] * m[20] - m[17] * m[19]) -
                           m[15] * (m[13] * m[20] - m[14] * m[19]) +
                           m[17] * (m[13] * m[17] - m[14] * m[16])));
    c[8] = (-m[2] * (((-m[12] * (m[20] * m[4] - m[19] * m[5])) +
                      m[14] * (m[17] * m[4] - m[16] * m[5]) +
                      m[2] * (m[16] * m[20] - m[17] * m[19])) *
                         m[9] -
                     ((-m[13] * (m[20] * m[4] - m[19] * m[5])) +
                      m[14] * (m[19] * m[4] - m[18] * m[5]) +
                      m[2] * (m[18] * m[20] - m[19] * m[19])) *
                         m[8] -
                     m[10] * ((-m[12] * (m[19] * m[4] - m[18] * m[5])) +
                              m[13] * (m[17] * m[4] - m[16] * m[5]) +
                              (m[16] * m[19] - m[17] * m[18]) * m[2]) +
                     m[1] * (m[12] * (m[18] * m[20] - m[19] * m[19]) -
                             m[13] * (m[16] * m[20] - m[17] * m[19]) +
                             m[14] * (m[16] * m[19] - m[17] * m[18])))) +
           m[3] * (((-m[11] * (m[20] * m[4] - m[19] * m[5])) +
                    m[14] * (m[14] * m[4] - m[13] * m[5]) +
                    m[2] * (m[13] * m[20] - m[14] * m[19])) *
                       m[9] -
                   ((-m[13] * (m[20] * m[4] - m[19] * m[5])) +
                    m[14] * (m[19] * m[4] - m[18] * m[5]) +
                    m[2] * (m[18] * m[20] - m[19] * m[19])) *
                       m[7] -
                   m[10] * ((-m[11] * (m[19] * m[4] - m[18] * m[5])) +
                            m[13] * (m[14] * m[4] - m[13] * m[5]) +
                            (m[13] * m[19] - m[14] * m[18]) * m[2]) +
                   m[1] * (m[11] * (m[18] * m[20] - m[19] * m[19]) -
                           m[13] * (m[13] * m[20] - m[14] * m[19]) +
                           m[14] * (m[13] * m[19] - m[14] * m[18]))) +
           m[5] * ((-((-m[11] * (m[17] * m[4] - m[16] * m[5])) +
                      m[12] * (m[14] * m[4] - m[13] * m[5]) +
                      (m[13] * m[17] - m[14] * m[16]) * m[2]) *
                    m[9]) +
                   ((-m[11] * (m[19] * m[4] - m[18] * m[5])) +
                    m[13] * (m[14] * m[4] - m[13] * m[5]) +
                    (m[13] * m[19] - m[14] * m[18]) * m[2]) *
                       m[8] -
                   ((-m[12] * (m[19] * m[4] - m[18] * m[5])) +
                    ...
                    (m[16] * m[19] - m[17] * m[18]) * m[2]) *
                       m[7] +
                   m[1] * (m[11] * (m[16] * m[19] - m[17] * m[18]) -
                           m[12] * (m[13] * m[19] - m[14] * m[18]) +
                           m[13] * (m[13] * m[17] - m[14] * m[16]))) +
           m[0] * ((m[11] * (m[16] * m[20] - m[17] * m[19]) -
                    m[12] * (m[13] * m[20] - m[14] * m[19]) +
                    m[14] * (m[13] * m[17] - m[14] * m[16])) *
                       m[9] -
                   (m[11] * (m[18] * m[20] - m[19] * m[19]) -
                   ...
                   m[10] * (m[11] * (m[16] * m[19] - m[17] * m[18]) -
                            m[12] * (m[13] * m[19] - m[14] * m[18]) +
                            m[13] * (m[13] * m[17] - m[14] * m[16]))) -
           m[4] * (((-m[11] * (m[20] * m[4] - m[19] * m[5])) +
                    m[14] * (m[14] * m[4] - m[13] * m[5]) +
                    m[2] * (m[13] * m[20] - m[14] * m[19])) *
                       m[8] -
                   ((-m[12] * (m[20] * m[4] - m[19] * m[5])) +
                    m[14] * (m[17] * m[4] - m[16] * m[5]) +
                    m[2] * (m[16] * m[20] - m[17] * m[19])) *
                       m[7] -
                   m[10] * ((-m[11] * (m[17] * m[4] - m[16] * m[5])) +
                            m[12] * (m[14] * m[4] - m[13] * m[5]) +
                            (m[13] * m[17] - m[14] * m[16]) * m[2]) +
                   m[1] * (m[11] * (m[16] * m[20] - m[17] * m[19]) -
                           m[12] * (m[13] * m[20] - m[14] * m[19]) +
                           m[14] * (m[13] * m[17] - m[14] * m[16])));
    c[9] = m[2] * (((-m[12] * (m[20] * m[3] - m[17] * m[5])) +
                    m[14] * (m[17] * m[3] - m[15] * m[5]) +
                    m[2] * (m[15] * m[20] - m[17] * m[17])) *
                       m[9] -
                   ((-m[13] * (m[20] * m[3] - m[17] * m[5])) +
                    m[14] * (m[19] * m[3] - m[16] * m[5]) +
                    m[2] * (m[16] * m[20] - m[17] * m[19])) *
                       m[8] -
                   m[10] * ((-m[12] * (m[19] * m[3] - m[16] * m[5])) +
                            m[13] * (m[17] * m[3] - m[15] * m[5]) +
                            (m[15] * m[19] - m[16] * m[17]) * m[2]) +
                   m[1] * (m[12] * (m[16] * m[20] - m[17] * m[19]) -
                           m[13] * (m[15] * m[20] - m[17] * m[17]) +
                           m[14] * (m[15] * m[19] - m[16] * m[17]))) -
           m[3] * (((-m[11] * (m[20] * m[3] - m[17] * m[5])) +
                    m[14] * (m[14] * m[3] - m[12] * m[5]) +
                    m[2] * (m[12] * m[20] - m[14] * m[17])) *
                       m[9] -
                   ((-m[13] * (m[20] * m[3] - m[17] * m[5])) +
                    m[14] * (m[19] * m[3] - m[16] * m[5]) +
                    m[2] * (m[16] * m[20] - m[17] * m[19])) *
                       m[7] -
                   m[10] * ((-m[11] * (m[19] * m[3] - m[16] * m[5])) +
                            m[13] * (m[14] * m[3] - m[12] * m[5]) +
                            (m[12] * m[19] - m[14] * m[16]) * m[2]) +
                   m[1] * (m[11] * (m[16] * m[20] - m[17] * m[19]) -
                           m[13] * (m[12] * m[20] - m[14] * m[17]) +
                           m[14] * (m[12] * m[19] - m[14] * m[16]))) -
           m[5] * ((-((-m[11] * (m[17] * m[3] - m[15] * m[5])) +
                      m[12] * (m[14] * m[3] - m[12] * m[5]) +
                      (m[12] * m[17] - m[14] * m[15]) * m[2]) *
                    m[9]) +
                   ((-m[11] * (m[19] * m[3] - m[16] * m[5])) +
                    m[13] * (m[14] * m[3] - m[12] * m[5]) +
                    (m[12] * m[19] - m[14] * m[16]) * m[2]) *
                       m[8] -
                   ((-m[12] * (m[19] * m[3] - m[16] * m[5])) +
                    m[13] * (m[17] * m[3] - m[15] * m[5]) +
                    (m[15] * m[19] - m[16] * m[17]) * m[2]) *
                       m[7] +
                   m[1] * (m[11] * (m[15] * m[19] - m[16] * m[17]) -
           ...
           m[0] * ((m[11] * (m[15] * m[20] - m[17] * m[17]) -
                   ...
                   m[10] * (m[11] * (m[15] * m[19] - m[16] * m[17]) -
                            m[12] * (m[12] * m[19] - m[14] * m[16]) +
                            m[13] * (m[12] * m[17] - m[14] * m[15]))) +
           m[4] * (((-m[11] * (m[20] * m[3] - m[17] * m[5])) +
                    m[14] * (m[14] * m[3] - m[12] * m[5]) +
                    m[2] * (m[12] * m[20] - m[14] * m[17])) *
                       m[8] -
                   ((-m[12] * (m[20] * m[3] - m[17] * m[5])) +
                    m[14] * (m[17] * m[3] - m[15] * m[5]) +
                    m[2] * (m[15] * m[20] - m[17] * m[17])) *
                       m[7] -
                   m[10] * ((-m[11] * (m[17] * m[3] - m[15] * m[5])) +
                            m[12] * (m[14] * m[3] - m[12] * m[5]) +
                            (m[12] * m[17] - m[14] * m[15]) * m[2]) +
                   m[1] * (m[11] * (m[15] * m[20] - m[17] * m[17]) -
                           m[12] * (m[12] * m[20] - m[14] * m[17]) +
                           m[14] * (m[12] * m[17] - m[14] * m[15])));
    c[10] = (-m[2] * (((-m[12] * (m[19] * m[3] - m[17] * m[4])) +
                       m[14] * (m[16] * m[3] - m[15] * m[4]) +
                       (m[15] * m[19] - m[16] * m[17]) * m[2]) *
                          m[9] -
                      ((-m[13] * (m[19] * m[3] - m[17] * m[4])) +
                       m[14] * (m[18] * m[3] - m[16] * m[4]) +
                       (m[16] * m[19] - m[17] * m[18]) * m[2]) *
                          m[8] -
                      m[10] * ((-m[12] * (m[18] * m[3] - m[16] * m[4])) +
                               m[13] * (m[16] * m[3] - m[15] * m[4]) +
                               (m[15] * m[18] - m[16] * m[16]) * m[2]) +
                      m[1] * (m[12] * (m[16] * m[19] - m[17] * m[18]) -
                              m[13] * (m[15] * m[19] - m[16] * m[17]) +
                              m[14] * (m[15] * m[18] - m[16] * m[16])))) +
            m[3] * (((-m[11] * (m[19] * m[3] - m[17] * m[4])) +
                     m[14] * (m[13] * m[3] - m[12] * m[4]) +
                     (m[12] * m[19] - m[13] * m[17]) * m[2]) *
                        m[9] -
                    ((-m[13] * (m[19] * m[3] - m[17] * m[4])) +
                     m[14] * (m[18] * m[3] - m[16] * m[4]) +
                     (m[16] * m[19] - m[17] * m[18]) * m[2]) *
                        m[7] -
                    m[10] * ((-m[11] * (m[18] * m[3] - m[16] * m[4])) +
                             m[13] * (m[13] * m[3] - m[12] * m[4]) +
                             (m[12] * m[18] - m[13] * m[16]) * m[2]) +
                    m[1] * (m[11] * (m[16] * m[19] - m[17] * m[18]) -
                            m[13] * (m[12] * m[19] - m[13] * m[17]) +
                            m[14] * (m[12] * m[18] - m[13] * m[16]))) +
            m[5] * ((-((-m[11] * (m[16] * m[3] - m[15] * m[4])) +
                       m[12] * (m[13] * m[3] - m[12] * m[4]) +
                       (m[12] * m[16] - m[13] * m[15]) * m[2]) *
                     m[9]) +
                    ((-m[11] * (m[18] * m[3] - m[16] * m[4])) +
                     m[13] * (m[13] * m[3] - m[12] * m[4]) +
                     (m[12] * m[18] - m[13] * m[16]) * m[2]) *
                        m[8] -
                    ((-m[12] * (m[18] * m[3] - m[16] * m[4])) +
                     m[13] * (m[16] * m[3] - m[15] * m[4]) +
                     (m[15] * m[18] - m[16] * m[16]) * m[2]) *
                        m[7] +
                    m[1] * (m[11] * (m[15] * m[18] - m[16] * m[16]) -
                            m[12] * (m[12] * m[18] - m[13] * m[16]) +
                            m[13] * (m[12] * m[16] - m[13] * m[15]))) +
            m[0] * ((m[11] * (m[15] * m[19] - m[16] * m[17]) -
                     m[12] * (m[12] * m[19] - m[13] * m[17]) +
                     m[14] * (m[12] * m[16] - m[13] * m[15])) *
                        m[9] -
                    (m[11] * (m[16] * m[19] - m[17] * m[18]) -
                    ...
                    m[10] * (m[11] * (m[15] * m[18] - m[16] * m[16]) -
                             m[12] * (m[12] * m[18] - m[13] * m[16]) +
                             m[13] * (m[12] * m[16] - m[13] * m[15]))) -
            m[4] * (((-m[11] * (m[19] * m[3] - m[17] * m[4])) +
                     m[14] * (m[13] * m[3] - m[12] * m[4]) +
                     (m[12] * m[19] - m[13] * m[17]) * m[2]) *
                        m[8] -
                    ((-m[12] * (m[19] * m[3] - m[17] * m[4])) +
                     m[14] * (m[16] * m[3] - m[15] * m[4]) +
                     (m[15] * m[19] - m[16] * m[17]) * m[2]) *
                        m[7] -
                    m[10] * ((-m[11] * (m[16] * m[3] - m[15] * m[4])) +
                             m[12] * (m[13] * m[3] - m[12] * m[4]) +
                             (m[12] * m[16] - m[13] * m[15]) * m[2]) +
                    m[1] * (m[11] * (m[15] * m[19] - m[16] * m[17]) -
                            m[12] * (m[12] * m[19] - m[13] * m[17]) +
                            m[14] * (m[12] * m[16] - m[13] * m[15])));
    c[11] = m[3] * (m[9] * (m[17] * (m[10] * m[4] - m[5] * m[9]) +
                            m[3] * (m[20] * m[9] - m[10] * m[19]) -
                            (m[20] * m[4] - m[19] * m[5]) * m[8]) -
                    m[10] * (m[16] * (m[10] * m[4] - m[5] * m[9]) +
                             m[3] * (m[19] * m[9] - m[10] * m[18]) -
                             (m[19] * m[4] - m[18] * m[5]) * m[8]) +
                    m[1] * ((-m[16] * (m[20] * m[9] - m[10] * m[19])) +
                            m[17] * (m[19] * m[9] - m[10] * m[18]) +
                            (m[18] * m[20] - m[19] * m[19]) * m[8]) -
                    ((-m[16] * (m[20] * m[4] - m[19] * m[5])) +
                     m[17] * (m[19] * m[4] - m[18] * m[5]) +
                     (m[18] * m[20] - m[19] * m[19]) * m[3]) *
                        m[6]) -
            m[4] * (m[8] * (m[17] * (m[10] * m[4] - m[5] * m[9]) +
                            m[3] * (m[20] * m[9] - m[10] * m[19]) -
                            (m[20] * m[4] - m[19] * m[5]) * m[8]) -
                    m[10] * (m[15] * (m[10] * m[4] - m[5] * m[9]) +
                             m[3] * (m[17] * m[9] - m[10] * m[16]) -
                             (m[17] * m[4] - m[16] * m[5]) * m[8]) +
                    m[1] * ((-m[15] * (m[20] * m[9] - m[10] * m[19])) +
                            m[17] * (m[17] * m[9] - m[10] * m[16]) +
                            (m[16] * m[20] - m[17] * m[19]) * m[8]) -
                    ((-m[15] * (m[20] * m[4] - m[19] * m[5])) +
                     m[17] * (m[17] * m[4] - m[16] * m[5]) +
                     (m[16] * m[20] - m[17] * m[19]) * m[3]) *
                        m[6]) +
            m[5] * (m[8] * (m[16] * (m[10] * m[4] - m[5] * m[9]) +
                            m[3] * (m[19] * m[9] - m[10] * m[18]) -
                            (m[19] * m[4] - m[18] * m[5]) * m[8]) -
                    m[9] * (m[15] * (m[10] * m[4] - m[5] * m[9]) +
                            m[3] * (m[17] * m[9] - m[10] * m[16]) -
                            (m[17] * m[4] - m[16] * m[5]) * m[8]) +
                    m[1] * ((-m[15] * (m[19] * m[9] - m[10] * m[18])) +
                            m[16] * (m[17] * m[9] - m[10] * m[16]) +
                            (m[16] * m[19] - m[17] * m[18]) * m[8]) -
                    ((-m[15] * (m[19] * m[4] - m[18] * m[5])) +
                     m[16] * (m[17] * m[4] - m[16] * m[5]) +
                     (m[16] * m[19] - m[17] * m[18]) * m[3]) *
                        m[6]) +
            m[0] * ((-m[8] * ((-m[16] * (m[20] * m[9] - m[10] * m[19])) +
                              m[17] * (m[19] * m[9] - m[10] * m[18]) +
                              (m[18] * m[20] - m[19] * m[19]) * m[8])) +
                    m[9] * ((-m[15] * (m[20] * m[9] - m[10] * m[19])) +
                            m[17] * (m[17] * m[9] - m[10] * m[16]) +
            ...
            m[1] * (((-m[15] * (m[20] * m[4] - m[19] * m[5])) +
                    ...
                    m[1] * (m[15] * (m[18] * m[20] - m[19] * m[19]) -
                            m[16] * (m[16] * m[20] - m[17] * m[19]) +
                            m[17] * (m[16] * m[19] - m[17] * m[18])));
    c[12] = (-m[3] * (m[9] * (m[14] * (m[10] * m[4] - m[5] * m[9]) +
                              m[2] * (m[20] * m[9] - m[10] * m[19]) -
                              (m[20] * m[4] - m[19] * m[5]) * m[7]) -
                      m[10] * (m[13] * (m[10] * m[4] - m[5] * m[9]) +
                               m[2] * (m[19] * m[9] - m[10] * m[18]) -
                               (m[19] * m[4] - m[18] * m[5]) * m[7]) +
                      m[1] * ((-m[13] * (m[20] * m[9] - m[10] * m[19])) +
                              m[14] * (m[19] * m[9] - m[10] * m[18]) +
                              (m[18] * m[20] - m[19] * m[19]) * m[7]) -
                      ((-m[13] * (m[20] * m[4] - m[19] * m[5])) +
                       m[14] * (m[19] * m[4] - m[18] * m[5]) +
                       m[2] * (m[18] * m[20] - m[19] * m[19])) *
                          m[6])) +
            m[4] * (m[8] * (m[14] * (m[10] * m[4] - m[5] * m[9]) +
                            m[2] * (m[20] * m[9] - m[10] * m[19]) -
                            (m[20] * m[4] - m[19] * m[5]) * m[7]) -
                    m[10] * (m[12] * (m[10] * m[4] - m[5] * m[9]) +
                             m[2] * (m[17] * m[9] - m[10] * m[16]) -
                             (m[17] * m[4] - m[16] * m[5]) * m[7]) +
                    m[1] * ((-m[12] * (m[20] * m[9] - m[10] * m[19])) +
                            m[14] * (m[17] * m[9] - m[10] * m[16]) +
                            (m[16] * m[20] - m[17] * m[19]) * m[7]) -
                    ((-m[12] * (m[20] * m[4] - m[19] * m[5])) +
                     m[14] * (m[17] * m[4] - m[16] * m[5]) +
                     m[2] * (m[16] * m[20] - m[17] * m[19])) *
                        m[6]) -
            m[5] * (m[8] * (m[13] * (m[10] * m[4] - m[5] * m[9]) +
                            m[2] * (m[19] * m[9] - m[10] * m[18]) -
                            (m[19] * m[4] - m[18] * m[5]) * m[7]) -
                    m[9] * (m[12] * (m[10] * m[4] - m[5] * m[9]) +
                            m[2] * (m[17] * m[9] - m[10] * m[16]) -
                            (m[17] * m[4] - m[16] * m[5]) * m[7]) +
                    m[1] * ((-m[12] * (m[19] * m[9] - m[10] * m[18])) +
                            m[13] * (m[17] * m[9] - m[10] * m[16]) +
                            (m[16] * m[19] - m[17] * m[18]) * m[7]) -
                    ((-m[12] * (m[19] * m[4] - m[18] * m[5])) +
                     m[13] * (m[17] * m[4] - m[16] * m[5]) +
                     (m[16] * m[19] - m[17] * m[18]) * m[2]) *
                        m[6]) -
            m[0] * ((-m[8] * ((-m[13] * (m[20] * m[9] - m[10] * m[19])) +
                              m[14] * (m[19] * m[9] - m[10] * m[18]) +
                              (m[18] * m[20] - m[19] * m[19]) * m[7])) +
                    m[9] * ((-m[12] * (m[20] * m[9] - m[10] * m[19])) +
                            m[14] * (m[17] * m[9] - m[10] * m[16]) +
            ...
            m[1] * (((-m[12] * (m[20] * m[4] - m[19] * m[5])) +
                    ...
                    m[1] * (m[12] * (m[18] * m[20] - m[19] * m[19]) -
                            m[13] * (m[16] * m[20] - m[17] * m[19]) +
                            m[14] * (m[16] * m[19] - m[17] * m[18])));
    c[13] = m[3] * ((m[14] * (m[10] * m[3] - m[5] * m[8]) +
                     m[2] * (m[20] * m[8] - m[10] * m[17]) -
                     (m[20] * m[3] - m[17] * m[5]) * m[7]) *
                        m[9] -
                    m[10] * (m[13] * (m[10] * m[3] - m[5] * m[8]) +
                             m[2] * (m[19] * m[8] - m[10] * m[16]) -
                             (m[19] * m[3] - m[16] * m[5]) * m[7]) +
                    m[1] * ((-m[13] * (m[20] * m[8] - m[10] * m[17])) +
                            m[14] * (m[19] * m[8] - m[10] * m[16]) +
                            (m[16] * m[20] - m[17] * m[19]) * m[7]) -
                    ((-m[13] * (m[20] * m[3] - m[17] * m[5])) +
                     m[14] * (m[19] * m[3] - m[16] * m[5]) +
                     m[2] * (m[16] * m[20] - m[17] * m[19])) *
                        m[6]) +
            m[5] * ((-(m[12] * (m[10] * m[3] - m[5] * m[8]) +
                       m[2] * (m[17] * m[8] - m[10] * m[15]) -
                       (m[17] * m[3] - m[15] * m[5]) * m[7]) *
                     m[9]) +
                    m[8] * (m[13] * (m[10] * m[3] - m[5] * m[8]) +
                            m[2] * (m[19] * m[8] - m[10] * m[16]) -
                            (m[19] * m[3] - m[16] * m[5]) * m[7]) +
                    m[1] * ((-m[12] * (m[19] * m[8] - m[10] * m[16])) +
                            m[13] * (m[17] * m[8] - m[10] * m[15]) +
                            (m[15] * m[19] - m[16] * m[17]) * m[7]) -
                    ((-m[12] * (m[19] * m[3] - m[16] * m[5])) +
                     m[13] * (m[17] * m[3] - m[15] * m[5]) +
            ...
            m[1] * (((-m[12] * (m[20] * m[3] - m[17] * m[5])) +
                    ...
                    m[1] * (m[12] * (m[16] * m[20] - m[17] * m[19]) -
                            m[13] * (m[15] * m[20] - m[17] * m[17]) +
                            m[14] * (m[15] * m[19] - m[16] * m[17]))) -
            m[4] * (m[8] * (m[14] * (m[10] * m[3] - m[5] * m[8]) +
                            m[2] * (m[20] * m[8] - m[10] * m[17]) -
                            (m[20] * m[3] - m[17] * m[5]) * m[7]) -
                    m[10] * (m[12] * (m[10] * m[3] - m[5] * m[8]) +
                             m[2] * (m[17] * m[8] - m[10] * m[15]) -
                             (m[17] * m[3] - m[15] * m[5]) * m[7]) +
                    m[1] * ((-m[12] * (m[20] * m[8] - m[10] * m[17])) +
                            m[14] * (m[17] * m[8] - m[10] * m[15]) +
                            (m[15] * m[20] - m[17] * m[17]) * m[7]) -
                    ((-m[12] * (m[20] * m[3] - m[17] * m[5])) +
                     m[14] * (m[17] * m[3] - m[15] * m[5]) +
                     m[2] * (m[15] * m[20] - m[17] * m[17])) *
                        m[6]);
    c[14] = (-m[3] * (m[9] * (m[14] * (m[3] * m[9] - m[4] * m[8]) +
                              m[2] * (m[19] * m[8] - m[17] * m[9]) -
                              (m[19] * m[3] - m[17] * m[4]) * m[7]) -
                      m[10] * (m[13] * (m[3] * m[9] - m[4] * m[8]) +
                               m[2] * (m[18] * m[8] - m[16] * m[9]) -
                               (m[18] * m[3] - m[16] * m[4]) * m[7]) +
                      m[1] * ((-m[13] * (m[19] * m[8] - m[17] * m[9])) +
                              m[14] * (m[18] * m[8] - m[16] * m[9]) +
                              (m[16] * m[19] - m[17] * m[18]) * m[7]) -
                      ((-m[13] * (m[19] * m[3] - m[17] * m[4])) +
                       m[14] * (m[18] * m[3] - m[16] * m[4]) +
                       (m[16] * m[19] - m[17] * m[18]) * m[2]) *
                          m[6])) +
            m[4] * (m[8] * (m[14] * (m[3] * m[9] - m[4] * m[8]) +
                            m[2] * (m[19] * m[8] - m[17] * m[9]) -
                            (m[19] * m[3] - m[17] * m[4]) * m[7]) -
                    m[10] * (m[12] * (m[3] * m[9] - m[4] * m[8]) +
                             m[2] * (m[16] * m[8] - m[15] * m[9]) -
                             (m[16] * m[3] - m[15] * m[4]) * m[7]) +
                    m[1] * ((-m[12] * (m[19] * m[8] - m[17] * m[9])) +
                            m[14] * (m[16] * m[8] - m[15] * m[9]) +
                            (m[15] * m[19] - m[16] * m[17]) * m[7]) -
                    ((-m[12] * (m[19] * m[3] - m[17] * m[4])) +
                     m[14] * (m[16] * m[3] - m[15] * m[4]) +
                     (m[15] * m[19] - m[16] * m[17]) * m[2]) *
                        m[6]) -
            m[5] * (m[8] * (m[13] * (m[3] * m[9] - m[4] * m[8]) +
                            m[2] * (m[18] * m[8] - m[16] * m[9]) -
                            (m[18] * m[3] - m[16] * m[4]) * m[7]) -
                    m[9] * (m[12] * (m[3] * m[9] - m[4] * m[8]) +
                            m[2] * (m[16] * m[8] - m[15] * m[9]) -
                            (m[16] * m[3] - m[15] * m[4]) * m[7]) +
                    m[1] * ((-m[12] * (m[18] * m[8] - m[16] * m[9])) +
                            m[13] * (m[16] * m[8] - m[15] * m[9]) +
                            (m[15] * m[18] - m[16] * m[16]) * m[7]) -
                    ((-m[12] * (m[18] * m[3] - m[16] * m[4])) +
                     m[13] * (m[16] * m[3] - m[15] * m[4]) +
                     (m[15] * m[18] - m[16] * m[16]) * m[2]) *
                        m[6]) -
            m[0] * ((-m[8] * ((-m[13] * (m[19] * m[8] - m[17] * m[9])) +
                              m[14] * (m[18] * m[8] - m[16] * m[9]) +
                              (m[16] * m[19] - m[17] * m[18]) * m[7])) +
                    m[9] * ((-m[12] * (m[19] * m[8] - m[17] * m[9])) +
                            m[14] * (m[16] * m[8] - m[15] * m[9]) +
            ...
            m[1] * (((-m[12] * (m[19] * m[3] - m[17] * m[4])) +
                    ...
                    m[1] * (m[12] * (m[16] * m[19] - m[17] * m[18]) -
                            m[13] * (m[15] * m[19] - m[16] * m[17]) +
                            m[14] * (m[15] * m[18] - m[16] * m[16])));
    c[15] = m[2] * (m[9] * (m[14] * (m[10] * m[4] - m[5] * m[9]) +
                            m[2] * (m[20] * m[9] - m[10] * m[19]) -
                            (m[20] * m[4] - m[19] * m[5]) * m[7]) -
                    m[10] * (m[13] * (m[10] * m[4] - m[5] * m[9]) +
                             m[2] * (m[19] * m[9] - m[10] * m[18]) -
                    ...
                    ((-m[13] * (m[20] * m[4] - m[19] * m[5])) +
                     ...
                     m[2] * (m[18] * m[20] - m[19] * m[19])) *
                        m[6]) -
            m[4] * (m[7] * (m[14] * (m[10] * m[4] - m[5] * m[9]) +
                            m[2] * (m[20] * m[9] - m[10] * m[19]) -
                            (m[20] * m[4] - m[19] * m[5]) * m[7]) -
                    m[10] * (m[11] * (m[10] * m[4] - m[5] * m[9]) +
                             m[2] * (m[14] * m[9] - m[10] * m[13]) -
                             (m[14] * m[4] - m[13] * m[5]) * m[7]) +
                    m[1] * ((-m[11] * (m[20] * m[9] - m[10] * m[19])) +
                            m[14] * (m[14] * m[9] - m[10] * m[13]) +
                            (m[13] * m[20] - m[14] * m[19]) * m[7]) -
                    ((-m[11] * (m[20] * m[4] - m[19] * m[5])) +
                     m[14] * (m[14] * m[4] - m[13] * m[5]) +
                     m[2] * (m[13] * m[20] - m[14] * m[19])) *
                        m[6]) +
            m[5] * (m[7] * (m[13] * (m[10] * m[4] - m[5] * m[9]) +
                            m[2] * (m[19] * m[9] - m[10] * m[18]) -
                            (m[19] * m[4] - m[18] * m[5]) * m[7]) -
                    m[9] * (m[11] * (m[10] * m[4] - m[5] * m[9]) +
                            m[2] * (m[14] * m[9] - m[10] * m[13]) -
                            (m[14] * m[4] - m[13] * m[5]) * m[7]) +
                    m[1] * ((-m[11] * (m[19] * m[9] - m[10] * m[18])) +
                            m[13] * (m[14] * m[9] - m[10] * m[13]) +
                            (m[13] * m[19] - m[14] * m[18]) * m[7]) -
                    ((-m[11] * (m[19] * m[4] - m[18] * m[5])) +
                     m[13] * (m[14] * m[4] - m[13] * m[5]) +
                     (m[13] * m[19] - m[14] * m[18]) * m[2]) *
                        m[6]) +
            m[0] * ((-m[7] * ((-m[13] * (m[20] * m[9] - m[10] * m[19])) +
                              m[14] * (m[19] * m[9] - m[10] * m[18]) +
                              (m[18] * m[20] - m[19] * m[19]) * m[7])) +
                    m[9] * ((-m[11] * (m[20] * m[9] - m[10] * m[19])) +
                            m[14] * (m[14] * m[9] - m[10] * m[13]) +
            ...
            m[1] * (((-m[11] * (m[20] * m[4] - m[19] * m[5])) +
                    ...
                    m[1] * (m[11] * (m[18] * m[20] - m[19] * m[19]) -
                            m[13] * (m[13] * m[20] - m[14] * m[19]) +
                            m[14] * (m[13] * m[19] - m[14] * m[18])));
    c[16] = (-m[2] * ((m[14] * (m[10] * m[3] - m[5] * m[8]) +
                       m[2] * (m[20] * m[8] - m[10] * m[17]) -
                       (m[20] * m[3] - m[17] * m[5]) * m[7]) *
                          m[9] -
                      m[10] * (m[13] * (m[10] * m[3] - m[5] * m[8]) +
                      ...
                      ((-m[13] * (m[20] * m[3] - m[17] * m[5])) +
                       ...
                       m[2] * (m[16] * m[20] - m[17] * m[19])) *
                          m[6])) -
            m[5] * ((-(m[11] * (m[10] * m[3] - m[5] * m[8]) +
                       m[2] * (m[14] * m[8] - m[10] * m[12]) -
                       (m[14] * m[3] - m[12] * m[5]) * m[7]) *
                     m[9]) +
                    m[7] * (m[13] * (m[10] * m[3] - m[5] * m[8]) +
                            m[2] * (m[19] * m[8] - m[10] * m[16]) -
                            (m[19] * m[3] - m[16] * m[5]) * m[7]) +
                    m[1] * ((-m[11] * (m[19] * m[8] - m[10] * m[16])) +
                            m[13] * (m[14] * m[8] - m[10] * m[12]) +
                            (m[12] * m[19] - m[14] * m[16]) * m[7]) -
                    ((-m[11] * (m[19] * m[3] - m[16] * m[5])) +
                     m[13] * (m[14] * m[3] - m[12] * m[5]) +
            ...
            m[1] * (((-m[11] * (m[20] * m[3] - m[17] * m[5])) +
                    ...
                    m[1] * (m[11] * (m[16] * m[20] - m[17] * m[19]) -
                            m[13] * (m[12] * m[20] - m[14] * m[17]) +
                            m[14] * (m[12] * m[19] - m[14] * m[16]))) +
            m[4] * (m[7] * (m[14] * (m[10] * m[3] - m[5] * m[8]) +
                            m[2] * (m[20] * m[8] - m[10] * m[17]) -
                            (m[20] * m[3] - m[17] * m[5]) * m[7]) -
                    m[10] * (m[11] * (m[10] * m[3] - m[5] * m[8]) +
                             m[2] * (m[14] * m[8] - m[10] * m[12]) -
                             (m[14] * m[3] - m[12] * m[5]) * m[7]) +
                    m[1] * ((-m[11] * (m[20] * m[8] - m[10] * m[17])) +
                            m[14] * (m[14] * m[8] - m[10] * m[12]) +
                            (m[12] * m[20] - m[14] * m[17]) * m[7]) -
                    ((-m[11] * (m[20] * m[3] - m[17] * m[5])) +
                     m[14] * (m[14] * m[3] - m[12] * m[5]) +
                     m[2] * (m[12] * m[20] - m[14] * m[17])) *
                        m[6]);
    c[17] = m[2] * (m[9] * (m[14] * (m[3] * m[9] - m[4] * m[8]) +
                            m[2] * (m[19] * m[8] - m[17] * m[9]) -
                            (m[19] * m[3] - m[17] * m[4]) * m[7]) -
                    m[10] * (m[13] * (m[3] * m[9] - m[4] * m[8]) +
                             m[2] * (m[18] * m[8] - m[16] * m[9]) -
                    ...
                    ((-m[13] * (m[19] * m[3] - m[17] * m[4])) +
                     ...
                     (m[16] * m[19] - m[17] * m[18]) * m[2]) *
                        m[6]) -
            m[4] * (m[7] * (m[14] * (m[3] * m[9] - m[4] * m[8]) +
                            m[2] * (m[19] * m[8] - m[17] * m[9]) -
                            (m[19] * m[3] - m[17] * m[4]) * m[7]) -
                    m[10] * (m[11] * (m[3] * m[9] - m[4] * m[8]) +
                             m[2] * (m[13] * m[8] - m[12] * m[9]) -
                             (m[13] * m[3] - m[12] * m[4]) * m[7]) +
                    m[1] * ((-m[11] * (m[19] * m[8] - m[17] * m[9])) +
                            m[14] * (m[13] * m[8] - m[12] * m[9]) +
                            (m[12] * m[19] - m[13] * m[17]) * m[7]) -
                    ((-m[11] * (m[19] * m[3] - m[17] * m[4])) +
                     m[14] * (m[13] * m[3] - m[12] * m[4]) +
                     (m[12] * m[19] - m[13] * m[17]) * m[2]) *
                        m[6]) +
            m[5] * (m[7] * (m[13] * (m[3] * m[9] - m[4] * m[8]) +
                            m[2] * (m[18] * m[8] - m[16] * m[9]) -
                            (m[18] * m[3] - m[16] * m[4]) * m[7]) -
                    m[9] * (m[11] * (m[3] * m[9] - m[4] * m[8]) +
                            m[2] * (m[13] * m[8] - m[12] * m[9]) -
                            (m[13] * m[3] - m[12] * m[4]) * m[7]) +
                    m[1] * ((-m[11] * (m[18] * m[8] - m[16] * m[9])) +
                            m[13] * (m[13] * m[8] - m[12] * m[9]) +
                            (m[12] * m[18] - m[13] * m[16]) * m[7]) -
                    ((-m[11] * (m[18] * m[3] - m[16] * m[4])) +
                     m[13] * (m[13] * m[3] - m[12] * m[4]) +
                     (m[12] * m[18] - m[13] * m[16]) * m[2]) *
                        m[6]) +
            m[0] * ((-m[7] * ((-m[13] * (m[19] * m[8] - m[17] * m[9])) +
                              m[14] * (m[18] * m[8] - m[16] * m[9]) +
                              (m[16] * m[19] - m[17] * m[18]) * m[7])) +
                    m[9] * ((-m[11] * (m[19] * m[8] - m[17] * m[9])) +
                            m[14] * (m[13] * m[8] - m[12] * m[9]) +
            ...
            m[1] * (((-m[11] * (m[19] * m[3] - m[17] * m[4])) +
                    ...
                    m[1] * (m[11] * (m[16] * m[19] - m[17] * m[18]) -
                            m[13] * (m[12] * m[19] - m[13] * m[17]) +
                            m[14] * (m[12] * m[18] - m[13] * m[16])));
    c[18] = m[2] * (m[8] * (m[14] * (m[10] * m[3] - m[5] * m[8]) +
                            m[2] * (m[20] * m[8] - m[10] * m[17]) -
                            (m[20] * m[3] - m[17] * m[5]) * m[7]) -
                    m[10] * (m[12] * (m[10] * m[3] - m[5] * m[8]) +
                             m[2] * (m[17] * m[8] - m[10] * m[15]) -
            ...
            m[3] * (m[7] * (m[14] * (m[10] * m[3] - m[5] * m[8]) +
                    ...
                    ((-m[11] * (m[20] * m[3] - m[17] * m[5])) +
                     ...
                     m[2] * (m[12] * m[20] - m[14] * m[17])) *
                        m[6]) +
            m[5] * (m[7] * (m[12] * (m[10] * m[3] - m[5] * m[8]) +
                            m[2] * (m[17] * m[8] - m[10] * m[15]) -
                            (m[17] * m[3] - m[15] * m[5]) * m[7]) -
                    m[8] * (m[11] * (m[10] * m[3] - m[5] * m[8]) +
                            m[2] * (m[14] * m[8] - m[10] * m[12]) -
                            (m[14] * m[3] - m[12] * m[5]) * m[7]) +
                    m[1] * ((-m[11] * (m[17] * m[8] - m[10] * m[15])) +
                            m[12] * (m[14] * m[8] - m[10] * m[12]) +
                            (m[12] * m[17] - m[14] * m[15]) * m[7]) -
                    ((-m[11] * (m[17] * m[3] - m[15] * m[5])) +
                     m[12] * (m[14] * m[3] - m[12] * m[5]) +
                     (m[12] * m[17] - m[14] * m[15]) * m[2]) *
                        m[6]) +
            m[0] * ((-m[7] * ((-m[12] * (m[20] * m[8] - m[10] * m[17])) +
                              m[14] * (m[17] * m[8] - m[10] * m[15]) +
                              (m[15] * m[20] - m[17] * m[17]) * m[7])) +
                    m[8] * ((-m[11] * (m[20] * m[8] - m[10] * m[17])) +
                            m[14] * (m[14] * m[8] - m[10] * m[12]) +
            ...
            m[1] * (((-m[11] * (m[20] * m[3] - m[17] * m[5])) +
                    ...
                    m[1] * (m[11] * (m[15] * m[20] - m[17] * m[17]) -
                            m[12] * (m[12] * m[20] - m[14] * m[17]) +
                            m[14] * (m[12] * m[17] - m[14] * m[15])));
    c[19] = (-m[2] * (m[8] * (m[14] * (m[3] * m[9] - m[4] * m[8]) +
                              m[2] * (m[19] * m[8] - m[17] * m[9]) -
                              (m[19] * m[3] - m[17] * m[4]) * m[7]) -
                      m[10] * (m[12] * (m[3] * m[9] - m[4] * m[8]) +
                               m[2] * (m[16] * m[8] - m[15] * m[9]) -
            ...
            m[3] * (m[7] * (m[14] * (m[3] * m[9] - m[4] * m[8]) +
                    ...
                    ((-m[11] * (m[19] * m[3] - m[17] * m[4])) +
                     ...
                     (m[12] * m[19] - m[13] * m[17]) * m[2]) *
                        m[6]) -
            m[5] * (m[7] * (m[12] * (m[3] * m[9] - m[4] * m[8]) +
                            m[2] * (m[16] * m[8] - m[15] * m[9]) -
                            (m[16] * m[3] - m[15] * m[4]) * m[7]) -
                    m[8] * (m[11] * (m[3] * m[9] - m[4] * m[8]) +
                            m[2] * (m[13] * m[8] - m[12] * m[9]) -
                            (m[13] * m[3] - m[12] * m[4]) * m[7]) +
                    m[1] * ((-m[11] * (m[16] * m[8] - m[15] * m[9])) +
                            m[12] * (m[13] * m[8] - m[12] * m[9]) +
                            (m[12] * m[16] - m[13] * m[15]) * m[7]) -
                    ((-m[11] * (m[16] * m[3] - m[15] * m[4])) +
                     m[12] * (m[13] * m[3] - m[12] * m[4]) +
                     (m[12] * m[16] - m[13] * m[15]) * m[2]) *
                        m[6]) -
            m[0] * ((-m[7] * ((-m[12] * (m[19] * m[8] - m[17] * m[9])) +
                              m[14] * (m[16] * m[8] - m[15] * m[9]) +
                              (m[15] * m[19] - m[16] * m[17]) * m[7])) +
                    m[8] * ((-m[11] * (m[19] * m[8] - m[17] * m[9])) +
                            m[14] * (m[13] * m[8] - m[12] * m[9]) +
            ...
            m[1] * (((-m[11] * (m[19] * m[3] - m[17] * m[4])) +
                    ...
                    m[1] * (m[11] * (m[15] * m[19] - m[16] * m[17]) -
                            m[12] * (m[12] * m[19] - m[13] * m[17]) +
                            m[14] * (m[12] * m[16] - m[13] * m[15])));
    c[20] = m[2] * (m[8] * (m[13] * (m[3] * m[9] - m[4] * m[8]) +
                            m[2] * (m[18] * m[8] - m[16] * m[9]) -
                            (m[18] * m[3] - m[16] * m[4]) * m[7]) -
                    m[9] * (m[12] * (m[3] * m[9] - m[4] * m[8]) +
                            m[2] * (m[16] * m[8] - m[15] * m[9]) -
            ...
            m[4] * (m[7] * (m[12] * (m[3] * m[9] - m[4] * m[8]) +
                    ...
                    ((-m[11] * (m[16] * m[3] - m[15] * m[4])) +
                     ...
                     (m[12] * m[16] - m[13] * m[15]) * m[2]) *
                        m[6]) +
            m[0] * ((-m[7] * ((-m[12] * (m[18] * m[8] - m[16] * m[9])) +
                              m[13] * (m[16] * m[8] - m[15] * m[9]) +
                              (m[15] * m[18] - m[16] * m[16]) * m[7])) +
                    m[8] * ((-m[11] * (m[18] * m[8] - m[16] * m[9])) +
                            m[13] * (m[13] * m[8] - m[12] * m[9]) +
...
#define _MUL_CORE(doreset)                                                     \
    do {                                                                       \
        for (int iout = 0; iout < N; iout++) {                                 \
            for (int jout = 0; jout < L; jout++) {                             \
                if (doreset)                                                   \
                    P[iout * P_strideelems0 + jout * P_strideelems1] = 0.0;    \
                for (int k = 0; k < M; k++)                                    \
                    P[iout * P_strideelems0 + jout * P_strideelems1] +=        \
                        A[iout * A_strideelems0 + k * A_strideelems1] *        \
                        B[k * B_strideelems0 + jout * B_strideelems1] * scale; \
...
__attribute__((unused)) static void mul_genNM_genML(
    // output
    double* restrict P,
    int P_strideelems0,
    int P_strideelems1,
...
__attribute__((unused)) static void mul_genNM_genML_accum(
    // output
    double* restrict P,
    int P_strideelems0,
    int P_strideelems1,
...
#define mul_gen23_gen33(P, A, B, scale, ACCUM) \
    mul_genNM_genML##ACCUM(P, 3, 1, 2, 3, 3, A, 3, 1, B, 3, 1, scale)
#define mul_gen33_gen33(P, A, B, scale, ACCUM) \
    mul_genNM_genML##ACCUM(P, 3, 1, 3, 3, 3, A, 3, 1, B, 3, 1, scale)
#define mul_gen33t_gen33(P, A, B, scale, ACCUM) \
    mul_genNM_genML##ACCUM(P, 3, 1, 3, 3, 3, A, 1, 3, B, 3, 1, scale)
#define mul_gen33_gen33t(P, A, B, scale, ACCUM) \
    mul_genNM_genML##ACCUM(P, 3, 1, 3, 3, 3, A, 3, 1, B, 1, 3, scale)
#define mul_gen33_vec3(P, A, v, scale, ACCUM) \
    mul_genNM_genML##ACCUM(P, 1, 1, 3, 3, 1, A, 3, 1, v, 1, 1, scale)
#define mul_gen33t_vec3(P, A, v, scale, ACCUM) \
    mul_genNM_genML##ACCUM(P, 1, 1, 3, 3, 1, A, 1, 3, v, 1, 1, scale)
#define mul_vec3t_gen33(P, v, A, scale, ACCUM) \
    mul_genNM_genML##ACCUM(P, 3, 1, 1, 3, 3, v, 3, 1, A, 3, 1, scale)
#define mul_vec3t_gen33t(P, v, A, scale, ACCUM) \
    mul_genNM_genML##ACCUM(P, 3, 1, 1, 3, 3, v, 3, 1, A, 1, 3, scale)

__attribute__((unused)) static inline void mul_vec6_sym66_scaled_strided(
    double* restrict v,
    int v_strideelems,
    ...
    v[0 * v_strideelems] =
        (s[0] * t[0] + s[1] * t[1] + s[2] * t[2] + s[3] * t[3] + s[4] * t[4] +
         s[5] * v[5 * v_strideelems]) *
        scale;
    v[1 * v_strideelems] =
        (s[1] * t[0] + s[6] * t[1] + s[7] * t[2] + s[8] * t[3] + s[9] * t[4] +
         s[10] * v[5 * v_strideelems]) *
        scale;
    v[2 * v_strideelems] =
        (s[2] * t[0] + s[7] * t[1] + s[11] * t[2] + s[12] * t[3] +
         s[13] * t[4] + s[14] * v[5 * v_strideelems]) *
        scale;
    v[3 * v_strideelems] =
        (s[3] * t[0] + s[8] * t[1] + s[12] * t[2] + s[15] * t[3] +
         s[16] * t[4] + s[17] * v[5 * v_strideelems]) *
        scale;
    v[4 * v_strideelems] =
        (s[4] * t[0] + s[9] * t[1] + s[13] * t[2] + s[16] * t[3] +
         s[18] * t[4] + s[19] * v[5 * v_strideelems]) *
        scale;
    v[5 * v_strideelems] =
        (s[5] * t[0] + s[10] * t[1] + s[14] * t[2] + s[17] * t[3] +
         s[19] * t[4] + s[20] * v[5 * v_strideelems]) *
        scale;
}

__attribute__((unused)) static inline void mul_genN6_sym66_scaled_strided(
    int n,
    double* restrict v,
    int v_strideelems0,
    int v_strideelems1,
