...
(shape (6,Nstate)). Its transpose, for convenience;
  ...
  J_packedfpcw_t Jcross (shape=(Nstate,6)) =
    [ 0 ] <- intrinsics [ 0 ] <- extrinsics [ J0_packedf0_t J0_packedf0   Dinv
drt_rf0__drt_rrp                                     ] [ J1_packedf0_t
J1_packedf0   Dinv drt_rf0__drt_rrp                                     ] [ ...
] [ J3_packedf1_t J3_packedf1   Dinv drt_rf1__drt_rrp ] [ J4_packedf1_t
J4_packedf1   Dinv drt_rf1__drt_rrp                                     ] <-
frames [                         ... ] [ J6_packedf2_t J0_packede0   Dinv
drt_cr0__drt_rrp                                     ] [ J7_packedf2_t
J1_packede0   Dinv drt_cr0__drt_rrp                                     ] [ ...
] [ J9_packedp0_t  J9_packedp0  Dinv dp0__drt_rrp ] <- points [ J10_packedp0_t
J10_packedp0 Dinv dp0__drt_rrp                                         ] [ ... ]
...
static void accumulate_frame(
    ...
    //
    // where drtrfp_drtrrp = d(compose_rt(rt_ref_ref*,rt_ref_frame)) /
    // drt_ref_ref*
    //
    // Jcross_t Jcross = sum(outer(jcross, jcross))
    ...
    //
    // In the above expressions I have drtrfp_drtrrp_t S for some matrix S.
    // Expanded:
    //
    //   drtrfp_drtrrp_t S = [dr/dr_t skew_t1] [ S00 S01 ] = [ dr/dr_t S00 +
    //   skew_t1 S10    dr/dr_t S01 + skew_t1 S11]
    //                       [ 0      I      ] [ S10 S11 ]   [ S10 S11 ]
    //
    ...
    {
        mul_gen33_gen33insym66(
            Af,
            Jcross_t__Jpackedf_stride0_elems,
            1,
        ...
        mul_genNM_genML_accum(  // transposed
            ...
            3,
            // transposed
            &sum_outer_jpackedf_jpackedcw[0 * 2 + 0],
            1,
            2,
            drrfp_drrrp,
            3,
        ...
        for (int j = 0; j < 3; j++) {
            ...
            Af[i * Jcross_t__Jpackedf_stride0_elems + j] +=
                (
                    /*skew[i*3 + 0]   + (
                       0)*sum_outer_jpackedf_jpackedf[index_sym66(0+3,j)] */
                    /*skew[i*3 + 1]*/ +(-t2) *
                        sum_outer_jpackedf_jpackedf[index_sym66(1 + 3, j)]
                    /*skew[i*3 + 2]*/
                    + (t1)*sum_outer_jpackedf_jpackedf[index_sym66(2 + 3, j)]
                ) /
            ...
            Af[i * Jcross_t__Jpackedf_stride0_elems + j] +=
                (
                    /*skew[i*3 + 0]*/ +(t2
                    )*sum_outer_jpackedf_jpackedf[index_sym66(0 + 3, j)]
                    /*skew[i*3 + 1]   + (
                       0)*sum_outer_jpackedf_jpackedf[index_sym66(1+3,j)] */
                    /*skew[i*3 + 2]*/
                    + (-t0) * sum_outer_jpackedf_jpackedf[index_sym66(2 + 3, j)]
                ) /
                SCALE_TRANSLATION_FRAME;
            ...
            Af[i * Jcross_t__Jpackedf_stride0_elems + j] +=
                (
                    /*skew[i*3 + 0]*/ +(-t1) *
                        sum_outer_jpackedf_jpackedf[index_sym66(0 + 3, j)]
                    /*skew[i*3 + 1]*/
                    + (t0)*sum_outer_jpackedf_jpackedf[index_sym66(1 + 3, j)]
                    /*skew[i*3 + 2]   + (
                       0)*sum_outer_jpackedf_jpackedf[index_sym66(2+3,j)] */
                ) /
                SCALE_TRANSLATION_FRAME;
            ...
            if (j < 2) {
                ...
                Acw[i * Jcross_t__Jpackedcw_stride0_elems + j] +=
                    (
                        /*skew[i*3 + 0]   + (
                           0)*sum_outer_jpackedf_jpackedcw[(0+3)*2 + j] */
                        /*skew[i*3 + 1]*/ +(-t2) *
                            sum_outer_jpackedf_jpackedcw[(1 + 3) * 2 + j]
                        /*skew[i*3 + 2]*/
                        + (t1)*sum_outer_jpackedf_jpackedcw[(2 + 3) * 2 + j]
                    ) /
                    SCALE_TRANSLATION_FRAME;
                ...
                Acw[i * Jcross_t__Jpackedcw_stride0_elems + j] +=
                    (
                        /*skew[i*3 + 0]*/ +(t2
                        )*sum_outer_jpackedf_jpackedcw[(0 + 3) * 2 + j]
                        /*skew[i*3 + 1]   + (
                           0)*sum_outer_jpackedf_jpackedcw[(1+3)*2 + j] */
                        /*skew[i*3 + 2]*/
                        + (-t0) * sum_outer_jpackedf_jpackedcw[(2 + 3) * 2 + j]
                    ) /
                    SCALE_TRANSLATION_FRAME;
                ...
                Acw[i * Jcross_t__Jpackedcw_stride0_elems + j] +=
                    (
                        /*skew[i*3 + 0]*/ +(-t1) *
                            sum_outer_jpackedf_jpackedcw[(0 + 3) * 2 + j]
                        /*skew[i*3 + 1]*/
                        + (t0)*sum_outer_jpackedf_jpackedcw[(1 + 3) * 2 + j]
                        /*skew[i*3 + 2]   + (
                           0)*sum_outer_jpackedf_jpackedcw[(2+3)*2 + j] */
                    ) /
                    SCALE_TRANSLATION_FRAME;
            }
        }
    ...
    // Bf <- dr/dr_t sum_outer[:3,3:] + skew_t1 sum_outer[3:,3:]
    {
        ...
        for (int j = 0; j < 3; j++) {
            ...
            Bf[i * Jcross_t__Jpackedf_stride0_elems + j] +=
                (
                    /*skew[i*3 + 0]   + (
                       0)*sum_outer_jpackedf_jpackedf[index_sym66(0+3,j+3)] */
                    /*skew[i*3 + 1]*/ +(-t2) *
                        sum_outer_jpackedf_jpackedf[index_sym66(1 + 3, j + 3)]
                    /*skew[i*3 + 2]*/
                    +
                    (t1)*sum_outer_jpackedf_jpackedf[index_sym66(2 + 3, j + 3)]
                ) /
                SCALE_TRANSLATION_FRAME;
            ...
            Bf[i * Jcross_t__Jpackedf_stride0_elems + j] +=
                (
                    /*skew[i*3 + 0]*/ +(t2
                    )*sum_outer_jpackedf_jpackedf[index_sym66(0 + 3, j + 3)]
                    /*skew[i*3 + 1]   + (
                       0)*sum_outer_jpackedf_jpackedf[index_sym66(1+3,j+3)] */
                    /*skew[i*3 + 2]*/
                    + (-t0) *
                          sum_outer_jpackedf_jpackedf[index_sym66(2 + 3, j + 3)]
                ) /
                SCALE_TRANSLATION_FRAME;
            ...
            Bf[i * Jcross_t__Jpackedf_stride0_elems + j] +=
                (
                    ...
                    /*skew[i*3 + 1]*/
                    +
                    (t0)*sum_outer_jpackedf_jpackedf[index_sym66(1 + 3, j + 3)]
                    /*skew[i*3 + 2]   + (
                       0)*sum_outer_jpackedf_jpackedf[index_sym66(2+3,j+3)] */
                ) /
                SCALE_TRANSLATION_FRAME;
        }
    }
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 2; j++) {
                Ccw[i * Jcross_t__Jpackedcw_stride0_elems + j] +=
                    sum_outer_jpackedf_jpackedcw[(3 + i) * 2 + j] /
                    SCALE_TRANSLATION_FRAME;
            }
        }
    }
    ...
    {
        mul_gen33_gen33_into33insym66_accum(
            Jcross_t__Jcross,
            0,
            0,
            Af,
            ...
            for (int j = i; j < 3; j++, ivalue++) {
                if (j == 0) {
                    Jcross_t__Jcross[ivalue] -=
                        (
                            /*skew[j + 0*3]   +
                               Bf[i*Jcross_t__Jpackedf_stride0_elems+0]*(  0) */
                            /*skew[j + 1*3]*/ +Bf
                                    [i * Jcross_t__Jpackedf_stride0_elems + 1] *
                                (t2)
                            /*skew[j + 2*3]*/
                            +
                            Bf[i * Jcross_t__Jpackedf_stride0_elems + 2] * (-t1)
                        ) /
                        SCALE_TRANSLATION_FRAME;
                }
                ...
                if (j == 1) {
                    Jcross_t__Jcross[ivalue] -=
                        (
                            /*skew[j + 0*3]*/ +Bf
                                    [i * Jcross_t__Jpackedf_stride0_elems + 0] *
                                (-t2)
                            /*skew[j + 1*3]   +
                               Bf[i*Jcross_t__Jpackedf_stride0_elems+1]*(  0) */
                            /*skew[j + 2*3]*/
                            +
                            Bf[i * Jcross_t__Jpackedf_stride0_elems + 2] * (t0)
                        ) /
                        SCALE_TRANSLATION_FRAME;
                }
                ...
                if (j == 2) {
                    Jcross_t__Jcross[ivalue] -=
                        (
                            ...
                            /*skew[j + 1*3]*/
                            +
                            Bf[i * Jcross_t__Jpackedf_stride0_elems + 1] * (-t0)
                            /*skew[j + 2*3]   +
                               Bf[i*Jcross_t__Jpackedf_stride0_elems+2]*(  0) */
                        ) /
                        SCALE_TRANSLATION_FRAME;
                }
            }
    ...
    {
        set_33insym66_from_gen33_accum(
            Jcross_t__Jcross,
            0,
            3,
            Bf,
    ...
    // A <- skew_p sum_outer_jpackedp_jpackedp /SCALE
    {
        ...
        for (int j = 0; j < 3; j++) {
            ...
            A[i * Jcross_t__Jpackedp_stride0_elems + j] += (
                /*skew[i*3 + 0]   + (
                   0)*sum_outer_jpackedp_jpackedp[index_sym33(0,j)] */
                /*skew[i*3 + 1]*/ +(-ppacked[2]) *
                    sum_outer_jpackedp_jpackedp[index_sym33(1, j)]
                /*skew[i*3 + 2]*/
                + (ppacked[1]) * sum_outer_jpackedp_jpackedp[index_sym33(2, j)]
            );

            i = 1;
            A[i * Jcross_t__Jpackedp_stride0_elems + j] += (
                /*skew[i*3 + 0]*/ +(ppacked[2]) *
                    sum_outer_jpackedp_jpackedp[index_sym33(0, j)]
                /*skew[i*3 + 1]   + (
                   0)*sum_outer_jpackedp_jpackedp[index_sym33(1,j)] */
                /*skew[i*3 + 2]*/
                + (-ppacked[0]) * sum_outer_jpackedp_jpackedp[index_sym33(2, j)]
            );

            i = 2;
            A[i * Jcross_t__Jpackedp_stride0_elems + j] += (
                /*skew[i*3 + 0]*/ +(-ppacked[1]) *
                    sum_outer_jpackedp_jpackedp[index_sym33(0, j)]
                /*skew[i*3 + 1]*/
                + (ppacked[0]) * sum_outer_jpackedp_jpackedp[index_sym33(1, j)]
                /*skew[i*3 + 2]   + (
                   0)*sum_outer_jpackedp_jpackedp[index_sym33(2,j)] */
            );
        }
    }
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = i; j < 3; j++, ivalue++) {
                if (j == 0) {
                    Jcross_t__Jcross[ivalue] -= (
                        /*skew[j + 0*3]   +
                           A[i*Jcross_t__Jpackedp_stride0_elems+0]*( 0) */
                        /*skew[j + 1*3]*/ +A
                                [i * Jcross_t__Jpackedp_stride0_elems + 1] *
                            (ppacked[2])
                        /*skew[j + 2*3]*/
                        + A[i * Jcross_t__Jpackedp_stride0_elems + 2] *
                              (-ppacked[1])
                    );
                }
                ...
                if (j == 1) {
                    Jcross_t__Jcross[ivalue] -= (
                        /*skew[j + 0*3]*/ +A
                                [i * Jcross_t__Jpackedp_stride0_elems + 0] *
                            (-ppacked[2])
                        /*skew[j + 1*3]   +
                           A[i*Jcross_t__Jpackedp_stride0_elems+1]*( 0) */
                        /*skew[j + 2*3]*/
                        + A[i * Jcross_t__Jpackedp_stride0_elems + 2] *
                              (ppacked[0])
                    );
                ...
                if (j == 2) {
                    Jcross_t__Jcross[ivalue] -= (
                        /*skew[j + 0*3]*/ +A
                            ...
                            (ppacked[1])
                        /*skew[j + 1*3]*/
                        + A[i * Jcross_t__Jpackedp_stride0_elems + 1] *
                              (-ppacked[0])
                        /*skew[j + 2*3]   +
                           A[i*Jcross_t__Jpackedp_stride0_elems+2]*( 0) */
                    );
                }
            }
            ivalue += 3;
...
bool _mrcal_drt_ref_refperturbed__dbpacked(
    ...
    int Nframes,
    int Npoints,
    int Npoints_fixed,  // at the end of points[]
...
#warning Do I need this? Where do I assume it?
    if (state_index_frame0 >= 0 && state_index_calobject_warp0 >= 0 &&
        !(state_index_calobject_warp0 == state_index_frame0 + Nstate_frames)) {
        MSG("I assume that the calobject_warp state variables follow the frame "
            "state variables immediately");
        return false;
    }

#warning Do I need this? Where do I assume it?
    if (state_index_calobject_warp0 >= 0 && !(Nstate_calobject_warp == 2)) {
        MSG("I assume that the calobject_warp has exactly 2 state variables");
        return false;
    }

    if (buffer_size_b_packed != Nstate * (int)sizeof(double)) {
        MSG("The buffer b_packed has the wrong size. Needed exactly %d bytes, "
            "but got %d bytes",
            Nstate * (int)sizeof(double),
            buffer_size_b_packed);
        return false;
    }
    ...
    if (state_index_frame0 < 0 && state_index_point0 < 0) {
        MSG("Neither board poses nor points are being optimized. Cannot "
            "compute uncertainty if we're not optimizing any observations");
        return false;
    }
...
#define INIT_ARRAY(Kpacked, N)                                               \
    ...
    if (Kpacked != NULL) {                                                   \
        if (Kpacked##_stride0_elems * (int)sizeof(double) !=                 \
            Kpacked##_stride0) {                                             \
            MSG("Currently the implementation assumes that " #Kpacked        \
                "_stride0 is a multiple of sizeof(double): all elements of " \
                "Kpacked are aligned. Got Kpacked ## _stride0 = %d",         \
                Kpacked##_stride0);                                          \
            return false;                                                    \
        }                                                                    \
                                                                             \
        if (Kpacked##_stride1 == sizeof(double)) {                           \
            ...
            if (Kpacked##_stride0 == (int)sizeof(double) * N)                \
                /* each column is stored densely as well. I can memset() the \
                 * whole */                                                  \
                /* block of memory */                                        \
                ...
                for (int i = 0; i < 6; i++)                                  \
                    memset(                                                  \
                        &Kpacked[i * Kpacked##_stride0_elems],               \
                        0,                                                   \
                        N * sizeof(double)                                   \
                    );                                                       \
        } else {                                                             \
            MSG("Currently the implementation assumes that Kpacked has "     \
                "densely-stored rows: " #Kpacked                             \
                "_stride1 must be sizeof(double). Instead I got Kpacked ## " \
                "_stride1 = %d",                                             \
                Kpacked##_stride1);                                          \
            return false;                                                    \
        }                                                                    \
...
#warning linear search
        ...
        if (state_index_frame0 <= icol &&
            ...
            if (icol < state_index_frame_current) {
                MSG("Unexpected jacobian structure. I'm assuming "
                    "non-decreasing frame references. The Jcross_t__Jcross "
                    "computation uses chunks of Kpackedf; it assumes that once "
                    "the chunk is computed, it is DONE, and never revisited. "
                    "Non-monotonic frame indices break that");
                return false;
            }
            ...
            // sum(outer(dx/drt_ref_frame,dx/drt_ref_frame)) into
            // sum_outer_jpackedf_jpackedf
            ...
            if (!(ival < Jrowptr[imeas + 1])) {
                ...
                // calobject_warp
                if (Kpackedcw != NULL) {
                    MSG("Unexpected jacobian structure. There's no "
                        "calobject_warp gradient in measurement %d, but the "
                        "user asked for it",
                        imeas);
                    return false;
                }
            ...
            if (!(icol >= state_index_calobject_warp0 &&
                ...
                MSG("Unexpected jacobian structure. I'm assuming frame "
                    "jacobians to be followed immediately by calobject_warp "
                    "jacobians");
                return false;
            }
            ...
            // calobject_warp
            if (Kpackedcw == NULL) {
                MSG("Unexpected jacobian structure. There's a calobject_warp "
                    "gradient in measurement %d, but the user didn't ask for "
                    "it",
                    imeas);
                return false;
            }
            ...
            if (ival < Jrowptr[imeas + 1]) {
                MSG("Unexpected jacobian structure. The calobject_warp "
                    "jacobians should be the last gradient for each measurement"
                );
                return false;
            }
        }
        ...
        if (state_index_point0 <= icol &&
            ...
            if (icol < state_index_point_current) {
                MSG("Unexpected jacobian structure. I'm assuming "
                    "non-decreasing point references. The Jcross_t__Jcross "
                    "computation uses chunks of Kpackedp; it assumes that once "
                    "the chunk is computed, it is DONE, and never revisited. "
                    "Non-monotonic point indices break that");
                return false;
            }
            ...
            if (ival < Jrowptr[imeas + 1]) {
                MSG("Unexpected jacobian structure. The point jacobians should "
                    "be the last gradient for each measurement");
                return false;
            }
        }
    }
...
#define SOLVE_SYM66_WITH_CRAMERS_RULE 1
    ...
    const double det = cofactors_sym6(Jcross_t__Jcross, inv_JcrosstJcross_det);

    // Overwrite Kpacked in place
#define FINALIZE(Kpacked, N)        \
    if (Kpacked)                    \
    mul_genN6_sym66_scaled_strided( \
        N,                          \
        Kpacked,                    \
        1,                          \
        Kpacked##_stride0_elems,    \
...
#error not yet done
    ...
    int info;
    dpptrf_(&(char){'L'}, &(int){6}, Jcross_t__Jcross, &info, 1);
    if (info != 0) {
