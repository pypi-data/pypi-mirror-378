...
from biblemate.uba.search import search_data
...
encyclopedia_file = os.path.join(os.path.expanduser("~"), "UniqueBible", "marvelData", "data", "encyclopedia.data")
