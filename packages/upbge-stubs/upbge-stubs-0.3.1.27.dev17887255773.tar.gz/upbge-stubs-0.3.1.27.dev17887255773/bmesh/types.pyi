...
explicitly free the data.
  ...
  def from_mesh(self, mesh: Mesh, *args, face_normals: bool = True, vertex_normals: bool = True, use_shape_key: bool = False, shape_key_index: int = 0) -> None:
...
Further calls will copy custom-data to matching layers, layers missing on the target mesh won't be added.
  ...
  def from_object(self, object: Object, depsgraph: Depsgraph, *args, cage: bool = False, face_normals: bool = True, vertex_normals: bool = True) -> None:
