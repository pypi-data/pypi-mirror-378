...
class MixClient:
    ...
    Usage:
        ...
        # API key authentication (workspace auto-determined from key)
    ...
    Note:
        API keys are workspace-specific, so workspace_name should not be provided
    ...
    def get_routing_engine(self, config_id: Optional[int] = None, version: Optional[int] = None) -> Optional[Dict[str, Any]]:
        ...
        Returns:
            Active routing engine dict or None if no active engine
        """
        if config_id:
