        ...
        operations = [
            migrations.CreateModel(
                ...
                fields=[
                    ...
                    ('claimed_by', models.ForeignKey(on_delete=models.CASCADE, related_name='verification_keys', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ],
                options={
                    'ordering': ('-pub_date',),
                    'abstract': False,
            ...
            migrations.AddField(
                model_name='key',
                name='group',
                field=models.ForeignKey(on_delete=models.CASCADE, to='verification.KeyGroup'),
