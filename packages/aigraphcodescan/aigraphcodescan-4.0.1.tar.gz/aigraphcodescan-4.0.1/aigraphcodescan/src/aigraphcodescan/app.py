...
def main():
    """Main function to parse arguments, run the analysis, and push results."""
    # 1. Argument Parsing
    ...
    # Use a finally block to ensure the driver is always closed
    try:
        ...
        # 7. Query GraphRAG and Push to Neo4j
