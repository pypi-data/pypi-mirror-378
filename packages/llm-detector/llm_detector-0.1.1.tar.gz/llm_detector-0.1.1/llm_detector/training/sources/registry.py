...
from .formal import LegalDocumentsSource, ScientificPapersSource, TechnicalDocsSource
...
from .social_media import MultiPlatformSocialSource, RedditRecentSource, TwitterSource
...
def register_default_sources(registry: SourceRegistry | None = None) -> SourceRegistry:
    ...
    definitions = [
        ...
        SourceDefinition(
            name="reddit_recent",
            category=SourceCategory.HUMAN,
            factory=lambda: RedditRecentSource(
        ...
        SourceDefinition(
            ...
            category=SourceCategory.HUMAN,
            factory=lambda: ScientificPapersSource(
                min_length=100,
                max_length=10000,
            ),
        ...
        SourceDefinition(
            ...
            enabled=False,  # Older GPT-3.5, disable in favor of newer models
        ),
