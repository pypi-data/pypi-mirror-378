...
T = TypeVar("T", bound="PaginatedV1BrandList")


@_attrs_define
class PaginatedV1BrandList:
    """
    Attributes:
        ...
        results (list['V1Brand']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = V1Brand.from_dict(results_item_data)
        ...
        paginated_v1_brand_list.additional_properties = d
        return paginated_v1_brand_list
