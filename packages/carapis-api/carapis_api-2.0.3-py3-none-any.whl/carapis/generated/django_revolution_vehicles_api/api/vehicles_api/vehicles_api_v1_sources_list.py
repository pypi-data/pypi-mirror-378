...
from ...models.paginated_v1_source_list import PaginatedV1SourceList
from ...models.vehicles_api_v1_sources_list_default_currency import check_vehicles_api_v1_sources_list_default_currency
from ...models.vehicles_api_v1_sources_list_default_currency import VehiclesApiV1SourcesListDefaultCurrency
...
def _get_kwargs(
    *,
    ...
    currency: Union[Unset, VehiclesApiV1SourcesListDefaultCurrency] = UNSET,
...
) -> Optional[PaginatedV1SourceList]:
    if response.status_code == 200:
        response_200 = PaginatedV1SourceList.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[PaginatedV1SourceList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        currency (Union[Unset, VehiclesApiV1SourcesListDefaultCurrency]):
