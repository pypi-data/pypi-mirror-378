...
T = TypeVar("T", bound="PaginatedV1VehicleModelList")


@_attrs_define
class PaginatedV1VehicleModelList:
    """
    Attributes:
        ...
        results (list['V1VehicleModel']): Array of items for current page
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = V1VehicleModel.from_dict(results_item_data)
        ...
        paginated_v1_vehicle_model_list = cls(
            count=count,
            page=page,
            pages=pages,
            page_size=page_size,
        ...
        paginated_v1_vehicle_model_list.additional_properties = d
        return paginated_v1_vehicle_model_list
